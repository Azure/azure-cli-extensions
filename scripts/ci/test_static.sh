...
pylint ./src/*/azext_*/ --ignore=models,operations,service_bus_management_client,subscription_client --ignore-patterns=[a-zA-Z_]+_management_client.py --rcfile=./pylintrc -j $proc_number

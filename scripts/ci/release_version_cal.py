...
def add_label_hint_message(comment_message):
    ...
    comment_message.append("Major/minor/patch/pre increment of version number is generated by pull request code changes"
                           " automatically. If needed, please add `major`/`minor`/`patch`/`pre` label to adjust it.")

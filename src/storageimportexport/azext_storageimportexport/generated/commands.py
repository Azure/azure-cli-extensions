...
def load_command_table(self, _):
    ...
    storageimportexport_location = CliCommandType(
        operations_tmpl='azext_storageimportexport.vendored_sdks.storageimportexport.operations._locations_operations#L'
        'ocationsOperations.{}',
    ...
    storageimportexport_job = CliCommandType(
        operations_tmpl='azext_storageimportexport.vendored_sdks.storageimportexport.operations._jobs_operations#JobsOp'
        'erations.{}',
    ...
    storageimportexport_bit_locker_key = CliCommandType(
        operations_tmpl='azext_storageimportexport.vendored_sdks.storageimportexport.operations._bit_locker_keys_operat'
    ...
    with self.command_group('storageimportexport', is_experimental=True):
        pass

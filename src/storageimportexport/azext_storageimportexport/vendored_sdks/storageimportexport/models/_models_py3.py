...
class JobDetails(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'blob_listblob_path': {'key': 'export.blobListblobPath', 'type': 'str'},
        'blob_path': {'key': 'export.blobList.blobPath', 'type': '[str]'},
        'blob_path_prefix': {'key': 'export.blobList.blobPathPrefix', 'type': '[str]'},
    }
...
class PutJobParameters(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'blob_listblob_path': {'key': 'properties.export.blobListblobPath', 'type': 'str'},
        'blob_path': {'key': 'properties.export.blobList.blobPath', 'type': '[str]'},
        'blob_path_prefix': {'key': 'properties.export.blobList.blobPathPrefix', 'type': '[str]'},
    }

...
class AzureManagementGroupsScenarioTest(ScenarioTest):
    ...
    def test_show_managementgroup(self):
        managementgroup_get = self.cmd(
            'account management-group show --group-name testGroup123').get_output_in_json()
        ...
        self.assertIsNotNone(
            managementgroup_get["details"]["parent"]["parentId"])
        self.assertTrue(managementgroup_get["details"]["parent"]["parentId"].startswith(
            "/providers/Microsoft.Management/managementGroups/"))
    ...
    def test_show_managementgroup_with_expand(self):
        managementgroup_get = self.cmd(
            'account management-group show --group-name testGroup123 --expand').get_output_in_json()
        self.assertIsNotNone(managementgroup_get)
        self.assertIsNotNone(managementgroup_get["details"])
        self.assertIsNotNone(
            managementgroup_get["details"]["parent"]["displayName"])
    ...
    def test_show_managementgroup_with_expand_and_recurse(self):
        managementgroup_get = self.cmd(
            'account management-group show --group-name testGroup123 --expand --recurse').get_output_in_json()
        self.assertIsNotNone(managementgroup_get)
        self.assertIsNotNone(managementgroup_get["details"])
        self.assertIsNotNone(
            managementgroup_get["details"]["parent"]["displayName"])
        ...
        self.assertIsNotNone(managementgroup_get["children"][0]["displayName"])
        self.assertIsNotNone(
            managementgroup_get["children"][0]["children"][0]["childId"])
        self.assertIsNotNone(
            managementgroup_get["children"][0]["children"][0]["childType"])
        self.assertIsNotNone(
    ...
    def test_create_managementgroup(self):
        ...
        self.assertIsNotNone(
            managementgroup_create["details"]["parent"]["parentId"])
        self.assertTrue(managementgroup_create["details"]["parent"]["parentId"].startswith(
            "/providers/Microsoft.Management/managementGroups/"))
    ...
    def test_update_managementgroup_with_displayname(self):
        ...
        self.assertIsNotNone(
            managementgroup_update["details"]["parent"]["parentId"])
        self.assertTrue(managementgroup_update["details"]["parent"]["parentId"].startswith(
            "/providers/Microsoft.Management/managementGroups/"))
    ...
    def test_add_remove_subscription_managementgroup(self):
        self.cmd(
            'account management-group subscription add --group-name testGroup123 --subscription "Pay-As-You-Go"')
        self.cmd('account management-group subscription remove --group-name testGroup123 --subscription "2a418b54-7643-4d8f-982c-d0802205d12c"')

    def test_create_delete_group_managementgroup(self):
        self.cmd('account management-group create --group-name testclirandgroup')
        self.cmd('account management-group delete --group-name testclirandgroup')

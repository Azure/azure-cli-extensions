...
class MoveResource(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'existing_target_id': {'key': 'properties.existingTargetId', 'type': 'str'},
        'resource_settings': {'key': 'properties.resourceSettings', 'type': 'ResourceSettings'},
        'source_resource_settings': {'key': 'properties.sourceResourceSettings', 'type': 'ResourceSettings'},
        'move_status': {'key': 'properties.moveStatus', 'type': 'MoveResourceStatus'},
        'depends_on': {'key': 'properties.dependsOn', 'type': '[MoveResourceDependency]'},
        'depends_on_overrides': {'key': 'properties.dependsOnOverrides', 'type': '[MoveResourceDependencyOverride]'},
        'errors': {'key': 'properties.errors', 'type': 'MoveResourceError'},
    }

...
class MoveResourceOperations:
    """MoveResourceOperations async operations.
    ...
    async def _create_initial(
        ...
        resource_settings: Optional["models.ResourceSettings"] = None,
        depends_on_overrides: Optional[List["models.MoveResourceDependencyOverride"]] = None,
        **kwargs
        ...
        body = models.MoveResource(source_id=source_id, existing_target_id=existing_target_id, resource_settings=resource_settings, depends_on_overrides=depends_on_overrides)
        api_version = "2019-10-01-preview"
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :param source_id: Gets or sets the Source ARM Id of the resource.
        :type source_id: str
        ...
        :type depends_on_overrides: list[~resource_mover_service_api.models.MoveResourceDependencyOverride]
        :keyword callable cls: A custom type or function that will be passed the direct response

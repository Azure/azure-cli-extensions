...
class MoveCollectionOperations:
    """MoveCollectionOperations async operations.
    ...
    async def create(
        ...
        properties: Optional["models.MoveCollectionProperties"] = None,
        **kwargs
    ...
    async def _prepare_initial(
        ...
        move_resource_input_type: Optional[Union[str, "models.MoveResourceInputType"]] = None,
        **kwargs
    ) -> Optional["models.OperationStatus"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
        error_map = {
    ...
    async def _resolve_dependency_initial(
        self,
        resource_group_name: str,
        move_collection_name: str,
        **kwargs
    ...
    async def begin_resolve_dependency(
        self,
        resource_group_name: str,
        move_collection_name: str,
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._resolve_dependency_initial(
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                cls=lambda x,y,z: x,
                **kwargs

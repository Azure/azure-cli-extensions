...
class MoveCollectionOperations(object):
    ...
    def create(
        ...
        properties=None,  # type: Optional["models.MoveCollectionProperties"]
        **kwargs  # type: Any
    ):
        ...
        body = models.MoveCollection(tags=tags, location=location, identity=identity, properties=properties)
    ...
    def _prepare_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        validate_only=None,  # type: Optional[bool]
        move_resources=None,  # type: Optional[List[str]]
        move_resource_input_type=None,  # type: Optional[Union[str, "models.MoveResourceInputType"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
        ...
        body = models.PrepareRequest(validate_only=validate_only, move_resources=move_resources, move_resource_input_type=move_resource_input_type)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def begin_prepare(
        ...
        **kwargs  # type: Any
        ...
        :param move_resource_input_type: Defines the move resource input type.
    ...
    def _initiate_move_initial(
        ...
        **kwargs  # type: Any
        ...
        body = models.ResourceMoveRequest(validate_only=validate_only, move_resources=move_resources, move_resource_input_type=move_resource_input_type)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _commit_initial(
        ...
        **kwargs  # type: Any
        ...
        body = models.CommitRequest(validate_only=validate_only, move_resources=move_resources, move_resource_input_type=move_resource_input_type)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _discard_initial(
        ...
        **kwargs  # type: Any
        ...
        body = models.DiscardRequest(validate_only=validate_only, move_resources=move_resources, move_resource_input_type=move_resource_input_type)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _resolve_dependency_initial(
        self,
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._resolve_dependency_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'moveCollectionName': self._serialize.url("move_collection_name", move_collection_name, 'str'),
        ...
        return deserialized
    _resolve_dependency_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/resolveDependencies'}  # type: ignore

    def begin_resolve_dependency(
        self,
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._resolve_dependency_initial(
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                cls=lambda x,y,z: x,
                **kwargs
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_resolve_dependency.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/resolveDependencies'}  # type: ignore
    ...
    def _bulk_remove_initial(
        ...
        **kwargs  # type: Any
        ...
        body = models.BulkRemoveRequest(validate_only=validate_only, move_resources=move_resources, move_resource_input_type=move_resource_input_type)
        api_version = "2019-10-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def list_move_collection_by_subscription(
        self,
        **kwargs  # type: Any
    ):
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_move_collection_by_subscription.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_move_collection_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Migrate/moveCollections'}  # type: ignore

    def list_move_collection_by_resource_group(
        self,
        resource_group_name,  # type: str
        **kwargs  # type: Any
    ):
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_move_collection_by_resource_group.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                }
    ...
    list_move_collection_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections'}  # type: ignore

...
class MoveResourceOperations(object):
    """MoveResourceOperations operations.
    ...
    def _create_initial(
        ...
        existing_target_id=None,  # type: Optional[str]
        resource_settings=None,  # type: Optional["models.ResourceSettings"]
        depends_on_overrides=None,  # type: Optional[List["models.MoveResourceDependencyOverride"]]
        **kwargs  # type: Any
    ):

...
def load_command_table(self, _):
    ...
    with self.command_group('connectedvmware vcenter', client_factory=cf_vcenter) as g:
        ...
        g.custom_command('show_command', 'show_vcenter')
    ...
    with self.command_group(
        ...
        g.custom_command('show_command', 'show_resource_pool')
    ...
    with self.command_group(
        ...
        g.custom_command('show_command', 'show_virtual_network')
    ...
    with self.command_group(
        ...
        g.custom_command('show_command', 'show_vm_template')
    ...
    with self.command_group(
        ...
        g.custom_command('show_command', 'show_vm')
    ...
    with self.command_group(
        ...
        g.custom_command('show_command', 'show_nic')

...
from ...operations._inventory_items_operations import build_create_request, build_delete_request, build_get_request, build_list_by_v_center_request
T = TypeVar('T')
...
class InventoryItemsOperations:
    ...
    def list_by_v_center(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.connectedvmware.models.InventoryItemsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-10-01-preview")  # type: str

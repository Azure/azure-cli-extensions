...
class ResourcePoolsOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either ResourcePool or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure_arc_vmware_management_service_api.models.ResourcePool]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure_arc_vmware_management_service_api.models.ResourcePoolsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-03-01-preview")  # type: str

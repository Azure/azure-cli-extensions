...
def build_create_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters/{vcenterName}")  # pylint: disable=line-too-long
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
    }
...
# fmt: on
class VCentersOperations(object):
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        vcenter_name,  # type: str
        body=None,  # type: Optional["_models.VCenter"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VCenter"
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VCenter"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure_arc_vmware_management_service_api.models.VCenter]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure_arc_vmware_management_service_api.models.VCenter
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VCenter"]
        error_map = {
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VCentersList"]
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure_arc_vmware_management_service_api.models.VCentersList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-03-01-preview")  # type: str

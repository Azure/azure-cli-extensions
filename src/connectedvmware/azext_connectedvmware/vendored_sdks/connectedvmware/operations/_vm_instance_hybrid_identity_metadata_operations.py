...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata/default")  # pylint: disable=line-too-long
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, 'str', skip_quote=True),
    }
...
# fmt: on
class VmInstanceHybridIdentityMetadataOperations(object):
    """VmInstanceHybridIdentityMetadataOperations operations.
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.VmInstanceHybridIdentityMetadata"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either VmInstanceHybridIdentityMetadataList or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure_arc_vmware_management_service_api.models.VmInstanceHybridIdentityMetadataList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-03-01-preview")  # type: str

...
class HybridIdentityMetadataOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            ...
            'metadataName': self._serialize.url("metadata_name", metadata_name, 'str'),
        }
        ...
        if body is not None:
            body_content = self._serialize.body(body, 'HybridIdentityMetadata')
        else:
            body_content = None
    ...
    def list_by_vm(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_arc_vmware_management_service_api.models.HybridIdentityMetadataList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

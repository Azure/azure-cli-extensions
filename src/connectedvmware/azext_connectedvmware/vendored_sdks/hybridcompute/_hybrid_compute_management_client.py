...
class HybridComputeManagementClient(HybridComputeManagementClientOperationsMixin):    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2023-04-25-preview". Note that
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        self.extension_metadata = ExtensionMetadataOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.machine_run_commands = MachineRunCommandsOperations(self._client, self._config, self._serialize, self._deserialize)

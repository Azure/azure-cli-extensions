...
class AgentVersionsList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["AgentVersion"]] = None,
...
class ErrorResponseAutoGenerated(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        error: Optional["ErrorDetailAutoGenerated"] = None,
        **kwargs
    ):
        """
        :keyword error: The error object.
...
class Machine(TrackedResource):
    ...
    def __init__(
        ...
        *,
        ...
        kind: Optional[Union[str, "PrivateCloudKind"]] = None,
        ...
        agent_upgrade: Optional["AgentUpgrade"] = None,
...
class MachineAssessPatchesResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        available_patch_count_by_classification: Optional["AvailablePatchCountByClassification"] = None,
        **kwargs
    ):
        """
...
class MachineRunCommand(TrackedResource):
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        source: Optional["MachineRunCommandScriptSource"] = None,
        ...
        output_blob_managed_identity: Optional["RunCommandManagedIdentity"] = None,
        error_blob_managed_identity: Optional["RunCommandManagedIdentity"] = None,
        **kwargs
    ):
        """
        :keyword tags: A set of tags. Resource tags.
        ...
        :paramtype error_blob_managed_identity:
         ~azure.mgmt.hybridcompute.models.RunCommandManagedIdentity
        """
        super(MachineRunCommand, self).__init__(tags=tags, location=location, **kwargs)
        self.source = source
...
class MachineRunCommandInstanceView(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        name: Optional[str] = None,
        status: Optional["MachineRunCommandInstanceViewStatus"] = None,
        **kwargs
    ):
        """
...
class MachineRunCommandScriptSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        script_uri_managed_identity: Optional["RunCommandManagedIdentity"] = None,
        **kwargs
    ):
        """
...
class MachineRunCommandsListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["MachineRunCommand"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class MachineRunCommandUpdate(ResourceUpdate):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype tags: dict[str, str]
        """
        super(MachineRunCommandUpdate, self).__init__(tags=tags, **kwargs)

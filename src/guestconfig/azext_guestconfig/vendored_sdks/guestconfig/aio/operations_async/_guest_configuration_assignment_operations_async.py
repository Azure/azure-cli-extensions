...
class GuestConfigurationAssignmentOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        _parameters = models.GuestConfigurationAssignment(name=name, location=location, context=context, name_properties_guest_configuration_name=guest_configuration_navigation_name, version=version, configuration_parameter=configuration_parameter, configuration_setting=configuration_setting)
        api_version = "2018-11-20"
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{guestConfigurationAssignmentName}'}
    ...
    async def create_or_update(
     ...
     Policy.
        ...
        :return: An instance of LROPoller that returns GuestConfigurationAssignment
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.guestconfig.models.GuestConfigurationAssignment]
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{guestConfigurationAssignmentName}'}
    ...
    async def get(
        ...
        **kwargs
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{guestConfigurationAssignmentName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{guestConfigurationAssignmentName}'}
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/{guestConfigurationAssignmentName}'}
    ...
    def list(
        ...
        vm_name: str,
        **kwargs
    ) -> "models.GuestConfigurationAssignmentList":
        ...
        :type vm_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestConfigurationAssignmentList or the result of cls(response)
        :rtype: ~azure.mgmt.guestconfig.models.GuestConfigurationAssignmentList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments'}

...
@register_command(
    "weights-and-biases instance list",
)
class List(AAZCommand):
    """List InstanceResource resources by subscription ID

    :example: Instances_ListBySubscription - generated by [MaximumSet] rule
        az weights-and-biases instance list --resource-group jawt-rg
    """

    _aaz_info = {
        "version": "2024-09-18-preview",
        "resources": [
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.InstancesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.InstancesListByResourceGroup(ctx=self.ctx)()
    ...
    class InstancesListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.WeightsAndBiases/instances",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            partner_properties.region = AAZStrType(
                flags={"required": True},
            )
            partner_properties.subdomain = AAZStrType(
                flags={"required": True},
            )
    ...
    class InstancesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.WeightsAndBiases/instances",
                **self.url_parameters
            )

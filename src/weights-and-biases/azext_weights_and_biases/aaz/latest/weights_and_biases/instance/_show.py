...
@register_command(
    "weights-and-biases instance show",
)
class Show(AAZCommand):
    """Get a InstanceResource

    :example: Instances_Get - generated by [MaximumSet] rule
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.instancename = AAZStrArg(
            options=["-n", "--name", "--instancename"],
            help="Name of the Instance resource",
            required=True,
            id_part="name",
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.InstancesGet(ctx=self.ctx)()
    ...
    class InstancesGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.WeightsAndBiases/instances/{instancename}",
                **self.url_parameters
            )
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "instancename", self.ctx.args.instancename,
                    required=True,
                ),
                **self.serialize_url_param(

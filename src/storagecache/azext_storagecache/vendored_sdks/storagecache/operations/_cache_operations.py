...
class CacheOperations(object):
    ...
    def _create_or_update_initial(
        ...
        root_squash=None,  # type: Optional[bool]
        key_encryption_key=None,  # type: Optional["models.KeyVaultKeyReference"]
        ...
        **kwargs  # type: Any
        ...
        cache = models.Cache(tags=tags, location=location, cache_size_gb=cache_size_gb, provisioning_state=provisioning_state, subnet=subnet, upgrade_status=upgrade_status, root_squash=root_squash, key_encryption_key=key_encryption_key, mtu=mtu, name_sku_name=name, type_identity_type=type)
        api_version = "2020-03-01"

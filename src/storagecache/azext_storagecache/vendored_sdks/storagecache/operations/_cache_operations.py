...
class CacheOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        _cache = models.Cache(tags=tags, location=location, name_sku_name=name, cache_size_gb=cache_size_gb, provisioning_state=provisioning_state, subnet=subnet, upgrade_status=upgrade_status, network_settings=network_settings, encryption_settings=encryption_settings, security_settings=security_settings, type_identity_type=type)
        api_version = "2020-03-01"

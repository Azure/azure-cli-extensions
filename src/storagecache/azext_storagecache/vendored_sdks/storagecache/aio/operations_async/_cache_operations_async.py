...
class CacheOperations:
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}'}  # type: ignore
    ...
    async def _create_or_update_initial(
        ...
        network_settings: Optional["models.CacheNetworkSettings"] = None,
        encryption_settings: Optional["models.CacheEncryptionSettings"] = None,
        security_settings: Optional["models.CacheSecuritySettings"] = None,
    ...
    async def create_or_update(
     ...
     manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}'}  # type: ignore
    ...
    async def flush(
     ...
     in list of [-0-9a-zA-Z_] char class.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    flush.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/flush'}  # type: ignore
    ...
    async def start(
     ...
     in list of [-0-9a-zA-Z_] char class.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    start.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/start'}  # type: ignore
    ...
    async def upgrade_firmware(
     ...
     in list of [-0-9a-zA-Z_] char class.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    upgrade_firmware.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/upgrade'}  # type: ignore

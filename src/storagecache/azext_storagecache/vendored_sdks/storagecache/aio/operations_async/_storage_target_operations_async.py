...
class StorageTargetOperations:
    ...
    def list_by_cache(
     ...
     in list of [-0-9a-zA-Z_] char class.
        ...
        :return: StorageTargetsResult or the result of cls(response)
        :rtype: ~azure.mgmt.storagecache.models.StorageTargetsResult
    ...
    async def _delete_initial(
        ...
        **kwargs
        ...
        return deserialized
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/storageTargets/{storageTargetName}'}
    ...
    async def _create_or_update_initial(
        ...
        cache_name: str,
        storage_target_name: str,
        target_base_type: Optional[Union[str, "models.StorageTargetType"]] = None,
        ...
        clfs: Optional["models.ClfsTarget"] = None,
        unknown: Optional["models.UnknownTarget"] = None,
        **kwargs
    ) -> "models.StorageTarget":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageTarget"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _storagetarget = models.StorageTarget(target_base_type=target_base_type, junctions=junctions, target_type=target_type, provisioning_state=provisioning_state, nfs3=nfs3, clfs=clfs, unknown=unknown)
        api_version = "2020-03-01"
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/storageTargets/{storageTargetName}'}
    ...
    async def create_or_update(
     ...
     80 and chars must be in list of [-0-9a-zA-Z_] char class.
        :type storage_target_name: str
        :param target_base_type: Type of the Storage Target.
        :type target_base_type: str or ~azure.mgmt.storagecache.models.StorageTargetType
     ...
     manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property.
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns StorageTarget

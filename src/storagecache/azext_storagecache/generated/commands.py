...
def load_command_table(self, _):
    ...
    from azext_storagecache.generated._client_factory import cf_asc_operation
    storagecache_asc_operation = CliCommandType(
        operations_tmpl='azext_storagecache.vendored_sdks.storagecache.operations._asc_operation_operations#AscOperatio'
        'nOperations.{}',
        client_factory=cf_asc_operation)
    with self.command_group('storagecache asc-operation', storagecache_asc_operation, client_factory=cf_asc_operation,
                            is_experimental=True) as g:

...
helps['storagecache storage-target create'] = """
    type: command
    short-summary: "Create or update a Storage Target. This operation is allowed at any time, but if the Cache is down \
    ...
    parameters:
      ...
      - name: --nfs3
        ...
        long-summary: |
            ...
            usage-model: Identifies the primary usage model to be used for this Storage Target. Get choices from \
.../usageModels
      - name: --clfs
...
--junctions namespace-path="/path/on/cache" nfs-export="exp1" target-path="/path/on/exp1" --junctions \

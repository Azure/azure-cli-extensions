...
def load_arguments(self, _):
    ...
    with self.argument_context('storagecache cache create') as c:
        ...
        c.argument('network_settings', action=AddNetworkSettings, nargs='*', help='Specifies network settings of the '
                   'cache.')
        c.argument('encryption_settings', type=validate_file_or_dict, help='Specifies encryption settings of the '
                   'cache. Expected value: json-string/@json-file.')
        c.argument('security_settings', action=AddSecuritySettings, nargs='*', help='Specifies security settings of '
                   'the cache.')
    ...
    with self.argument_context('storagecache storage-target create') as c:
        ...
        c.argument('unknown', type=validate_file_or_dict, help='Properties when targetType is unknown. Expected value: '

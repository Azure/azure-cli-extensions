...
|**--identity**|object|The identity of the cache, if configured.|identity|
|**--sku**|object|SKU for the Cache.|sku|
...
|**--upgrade-status**|object|Upgrade status of the Cache.|upgrade_status|
...
|**--target-base-type**|choice|Type of the Storage Target.|target_base_type|
|**--junctions**|array|List of Cache namespace junctions to target for namespace associations.|junctions|
|**--target-type**|string|Type of the Storage Target.|target_type|
|**--provisioning-state**|choice|ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property|provisioning_state|

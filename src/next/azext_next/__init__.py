...
class NextCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        # But cli_ctx.invocation.commands_loader.load_command_table(args) will not only reload a new object of NextCommandsLoader,
        # but also recursively calls load_command_table() again, and fall into infinite nested call
        # So NextCommandsLoader is designed as a singleton, and _has_reload_command_table is used to avoid infinite nested calls

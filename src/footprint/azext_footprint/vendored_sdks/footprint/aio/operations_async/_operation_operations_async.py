...
class OperationOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~footprint_monitoring_management_client.models.ResourceProviderOperationList]
    ...
    list.metadata = {'url': '/providers/Microsoft.FootprintMonitoring/operations'}  # type: ignore

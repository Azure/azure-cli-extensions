...
from azext_devcenter.action import AddRepo, AddImageReference, AddSku
...
def load_arguments(self, _):
    ...
    with self.argument_context("devcenter dev project list") as c:
        c.argument(
            "dev_center",
            options_list=["--dev-center-name", "--dev-center", "-dc"],
            type=str,
            required=True,
    ...
    with self.argument_context("devcenter dev pool show") as c:
        ...
        c.argument(
            ...
            type=str,
            help="The DNS suffix used as the base for all devcenter " "requests.",
        )
        c.argument(
            "project_name",
            options_list=[
    ...
    with self.argument_context("devcenter dev environment create") as c:
        ...
        c.argument(
            "owner", type=str, help="Identifier of the owner of this Environment."
        )
    ...
    with self.argument_context("devcenter admin attached-network create") as c:
        ...
        c.argument(
            ...
            type=str,
            required=True,
            help="The resource ID of the NetworkConnection you want "
    ...
    with self.argument_context("devcenter admin attached-network update") as c:
        ...
        c.argument(
            "network_connection_resource_id",
            type=str,
    ...
    with self.argument_context("devcenter admin pool create") as c:
        ...
        c.argument(
            ...
            options_list=["--network-connection-name", "-nc"],
            type=str,

...
class ShowLog(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.image_build_log_id = AAZUuidArg(
            options=["-i", "--image-build-log-id"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesGetImagingTaskLog(ctx=self.ctx)()
    ...
    class DevBoxesGetImagingTaskLog(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/projects/{projectName}/imageBuildLogs/{imageBuildLogId}",
                **self.url_parameters
            )
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "imageBuildLogId", self.ctx.args.image_build_log_id,
                    required=True,
                ),
                **self.serialize_url_param(
...
class _ShowLogHelper:
    """Helper class for ShowLog"""

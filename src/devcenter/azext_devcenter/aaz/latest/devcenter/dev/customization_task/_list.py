...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/customizationtasks", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesListCustomizationTaskDefinitionsByProject(ctx=self.ctx)()
    ...
    class DevBoxesListCustomizationTaskDefinitionsByProject(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            parameters = cls._schema_on_200.value.Element.parameters
            parameters.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.parameters.Element
            ...
            allowed = cls._schema_on_200.value.Element.parameters.Element.allowed

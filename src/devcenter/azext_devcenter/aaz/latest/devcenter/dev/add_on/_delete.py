...
class Delete(AAZCommand):
    ...
    :example: Delete
        az devcenter dev add-on delete --project-name "myProject" --user-id "me" --dev-box-name "myDevBox" --add-on-name "devboxtunnel-sys-default"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevBoxesDeleteDevBoxAddOn(ctx=self.ctx)()
    ...
    class DevBoxesDeleteDevBoxAddOn(AAZHttpOperation):

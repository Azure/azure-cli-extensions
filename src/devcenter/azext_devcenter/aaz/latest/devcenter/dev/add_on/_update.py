...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.DevBoxesCreateOrReplaceDevBoxAddOn(ctx=self.ctx)()
    ...
    class DevBoxesGetDevBoxAddon(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_dev_box_add_on_read(cls._schema_on_200)

            return cls._schema_on_200

    class DevBoxesCreateOrReplaceDevBoxAddOn(AAZHttpOperation):
        CLIENT_TYPE = "AAZMicrosoftDevcenterDataPlaneClient_devcenter"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_dev_box_add_on_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_dev_box_add_on_read = None

    @classmethod
    def _build_schema_dev_box_add_on_read(cls, _schema):
        if cls._schema_dev_box_add_on_read is not None:
            _schema.action_state = cls._schema_dev_box_add_on_read.action_state
            _schema.error = cls._schema_dev_box_add_on_read.error
            _schema.kind = cls._schema_dev_box_add_on_read.kind
            _schema.name = cls._schema_dev_box_add_on_read.name
            _schema.provisioning_state = cls._schema_dev_box_add_on_read.provisioning_state
            _schema.discriminate_by(
                "kind",
                "DevBoxTunnel",
                cls._schema_dev_box_add_on_read.discriminate_by(
                    "kind",
                    "DevBoxTunnel",
                )
            )
        ...
        cls._schema_dev_box_add_on_read = _schema_dev_box_add_on_read = AAZObjectType()

        dev_box_add_on_read = _schema_dev_box_add_on_read
        dev_box_add_on_read.action_state = AAZStrType(
            serialized_name="actionState",
            flags={"read_only": True},
        )
        dev_box_add_on_read.error = AAZObjectType(
            flags={"read_only": True},
        )
        cls._build_schema_azure_core_foundations_error_read(dev_box_add_on_read.error)
        dev_box_add_on_read.kind = AAZStrType(
            flags={"required": True},
        )
        dev_box_add_on_read.name = AAZStrType(
            flags={"read_only": True},
        )
        dev_box_add_on_read.provisioning_state = AAZStrType(
            serialized_name="provisioningState",
            flags={"read_only": True},
        )

        disc_dev_box_tunnel = _schema_dev_box_add_on_read.discriminate_by("kind", "DevBoxTunnel")

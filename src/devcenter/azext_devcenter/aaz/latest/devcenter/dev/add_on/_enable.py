...
class Enable(AAZCommand):
    ...
    :example: Enable
        az devcenter dev add-on enable --project-name "myProject" --user-id "me" --dev-box-name "myDevBox" --add-on-name "devboxtunnel-sys-default"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevBoxesEnableDevBoxAddOn(ctx=self.ctx)()
    ...
    class DevBoxesEnableDevBoxAddOn(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/projects/{projectName}/users/{userId}/devboxes/{devBoxName}/addons/{addOnName}:enable",
                **self.url_parameters
            )

...
class Create(AAZCommand):
    ...
    :example: Create
        az devcenter dev add-on create --project-name "myProject" --user-id "me" --dev-box-name "myDevBox" --add-on-name "devboxtunnel-sys-default" --endpoint "https://8a40af38-3b4c-4672-a6a4-5e964b1870ed-contosodevcenter.centralus.devcenter.azure.com/"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.dev_box_tunnel = AAZObjectArg(
            options=["--dev-box-tunnel"],
            arg_group="Body",
            help="Dev box tunnel properties",
        )

        dev_box_tunnel = cls._args_schema.dev_box_tunnel
        dev_box_tunnel.hosting_resource_name = AAZStrArg(
            options=["hosting-resource-name"],
    ...
    class DevBoxesCreateOrReplaceDevBoxAddOn(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_const("kind", "DevBoxTunnel", AAZStrType, ".dev_box_tunnel", typ_kwargs={"flags": {"required": True}})
            _builder.discriminate_by("kind", "DevBoxTunnel")

            disc_dev_box_tunnel = _builder.get("{kind:DevBoxTunnel}")
            if disc_dev_box_tunnel is not None:
                disc_dev_box_tunnel.set_prop("hostingResourceName", AAZStrType, ".dev_box_tunnel.hosting_resource_name")
        ...
        def _build_schema_on_200_201(cls):
            ...
            disc_dev_box_tunnel = cls._schema_on_200_201.discriminate_by("kind", "DevBoxTunnel")

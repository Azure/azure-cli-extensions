...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/environmenttypes", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsListEnvironmentTypes(ctx=self.ctx)()
    ...
    class EnvironmentsListEnvironmentTypes(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.deployment_target_id = AAZStrType(

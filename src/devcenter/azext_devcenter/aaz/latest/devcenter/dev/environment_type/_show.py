...
class Show(AAZCommand):
    ...
    :example: Get an environment type configured for a project.
        az devcenter dev environment-type show --endpoint "https://8a40af38-3b4c-4672-a6a4-5e964b1870ed-contosodevcenter.centralus.devcenter.azure.com/" --project-name "DevProject" --environment-type-name "dev"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetEnvironmentTypes(ctx=self.ctx)()
    ...
    class EnvironmentsGetEnvironmentTypes(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.deployment_target_id = AAZStrType(

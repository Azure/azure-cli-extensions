  ...
  task information unless specified via the include parameter.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.include = AAZStrArg(
            options=["--include"],
            help="Optional query parameter to specify what properties should be included in the response.",
            enum={"tasks": "tasks"},
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesListCustomizationGroups(ctx=self.ctx)()
    ...
    class DevBoxesListCustomizationGroups(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            tasks = cls._schema_on_200.value.Element.tasks
            tasks.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.tasks.Element
            ...
            parameters = cls._schema_on_200.value.Element.tasks.Element.parameters

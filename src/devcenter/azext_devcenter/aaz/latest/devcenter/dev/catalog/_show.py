...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/catalogs/{}", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetCatalog(ctx=self.ctx)()
    ...
    class EnvironmentsGetCatalog(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevCenterListProjects(ctx=self.ctx)()
    ...
    class DevCenterListProjects(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.max_dev_boxes_per_user = AAZIntType(

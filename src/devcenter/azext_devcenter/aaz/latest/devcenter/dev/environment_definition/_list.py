...
class List(AAZCommand):
    ...
    :example: List by project
        az az devcenter dev environment-definition list --endpoint "https://8a40af38-3b4c-4672-a6a4-5e964b1870ed-contosodevcenter.centralus.devcenter.azure.com/" --project-name "DevProject"

    :example: List by project and catalog
    ...
    def _execute_operations(self):
        self.pre_operations()
        condition_0 = has_value(self.ctx.args.catalog_name) and has_value(self.ctx.args.project_name)
        condition_1 = has_value(self.ctx.args.project_name) and has_value(self.ctx.args.catalog_name) is not True
        if condition_0:
            self.EnvironmentsListEnvironmentDefinitionsByCatalog(ctx=self.ctx)()
        if condition_1:
            self.EnvironmentsListEnvironmentDefinitionsByProject(ctx=self.ctx)()
    ...
    class EnvironmentsListEnvironmentDefinitionsByCatalog(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.parameters_schema = AAZStrType(
                serialized_name="parametersSchema",
            )
            _element.template_path = AAZStrType(
    ...
    class EnvironmentsListEnvironmentDefinitionsByProject(AAZHttpOperation):
        CLIENT_TYPE = "AAZMicrosoftDevcenterDataPlaneClient_devcenter"

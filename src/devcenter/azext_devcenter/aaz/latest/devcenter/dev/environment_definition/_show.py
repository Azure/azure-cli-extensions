...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/catalogs/{}/environmentdefinitions/{}", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetEnvironmentDefinition(ctx=self.ctx)()
    ...
    class EnvironmentsGetEnvironmentDefinition(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.parameters = AAZListType()
            _schema_on_200.parameters_schema = AAZStrType(
                serialized_name="parametersSchema",
            )
            _schema_on_200.template_path = AAZStrType(

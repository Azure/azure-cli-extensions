...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/pools/{}/schedules/{}", "2025-08-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.schedule_name = AAZStrArg(
            ...
            help="Display name for the Schedule.",
            required=True,
            default="default",
            fmt=AAZStrArgFormat(
                pattern="^[a-zA-Z0-9][a-zA-Z0-9-_.]{2,62}$",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesGetScheduleByPool(ctx=self.ctx)()
    ...
    class DevBoxesGetScheduleByPool(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.frequency = AAZStrType(
                flags={"required": True},
            )
            ...
            _schema_on_200.time = AAZStrType(
                flags={"required": True},
            )
            _schema_on_200.time_zone = AAZStrType(

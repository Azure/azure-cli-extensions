...
class ListOperation(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesListOperations(ctx=self.ctx)()
    ...
    class DevBoxesListOperations(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.created_by_object_id = AAZStrType(
            ...
            _ListOperationHelper._build_schema_azure._core._foundations._error_read(_element.error)
            ...
            disc_repair = cls._schema_on_200.value.Element.discriminate_by("kind", "Repair")
            disc_repair.result = AAZObjectType()

            result = cls._schema_on_200.value.Element.discriminate_by("kind", "Repair").result
            ...
            disc_restore_snapshot = cls._schema_on_200.value.Element.discriminate_by("kind", "RestoreSnapshot")

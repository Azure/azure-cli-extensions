...
class RestoreSnapshot(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevBoxesRestoreSnapshot(ctx=self.ctx)()
    ...
    class DevBoxesRestoreSnapshot(AAZHttpOperation):
...
class _RestoreSnapshotHelper:
    """Helper class for RestoreSnapshot"""


__all__ = ["RestoreSnapshot"]

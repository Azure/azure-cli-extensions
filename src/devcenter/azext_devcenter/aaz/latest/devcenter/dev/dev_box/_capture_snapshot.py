...
class CaptureSnapshot(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevBoxesCaptureSnapshot(ctx=self.ctx)()
    ...
    class DevBoxesCaptureSnapshot(AAZHttpOperation):
...
class _CaptureSnapshotHelper:
    """Helper class for CaptureSnapshot"""


__all__ = ["CaptureSnapshot"]

...
class ListSnapshot(AAZCommand):
    """List snapshots for this Dev Box.

    :example: List
        az devcenter dev dev-box list-snapshot--endpoint "https://8a40af38-3b4c-4672-a6a4-5e964b1870ed-contosodevcenter.centralus.devcenter.azure.com/" --project-name "DevProject" --name "myDevBox" --user-id "00000000-0000-0000-0000-000000000000"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevBoxesListSnapshots(ctx=self.ctx)()
    ...
    class DevBoxesListSnapshots(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/projects/{projectName}/users/{userId}/devboxes/{devBoxName}/snapshots",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _element.expiration_time = AAZStrType(
                serialized_name="expirationTime",
                flags={"read_only": True},
            )
            _element.snapshot_id = AAZStrType(
                serialized_name="snapshotId",
                flags={"read_only": True},
            )
            _element.snapshot_type = AAZStrType(
...
class _ListSnapshotHelper:
    """Helper class for ListSnapshot"""


__all__ = ["ListSnapshot"]

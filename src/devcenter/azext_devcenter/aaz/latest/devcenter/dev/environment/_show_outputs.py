...
class ShowOutputs(AAZCommand):
    ...
    class EnvironmentsGetOutputs(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.outputs = AAZDictType()

            outputs = cls._schema_on_200.outputs
            outputs.Element = AAZObjectType()

            _element = cls._schema_on_200.outputs.Element
            _element.sensitive = AAZBoolType()
            _element.type = AAZStrType()
            _element.value = AAZFreeFormDictType()

            return cls._schema_on_200


class _ShowOutputsHelper:
    """Helper class for ShowOutputs"""

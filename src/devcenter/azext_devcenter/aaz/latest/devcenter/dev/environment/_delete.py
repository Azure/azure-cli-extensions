...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.force = AAZBoolArg(
            options=["--force"],
            help="The query option to force environment deletion even if the environment definition does not exist. This is a best-effort delete, and anything custom that forces resource creation beyond the associated resource group may not be deleted.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.EnvironmentsDeleteEnvironment(ctx=self.ctx)()

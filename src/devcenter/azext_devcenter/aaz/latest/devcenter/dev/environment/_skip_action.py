...
class SkipAction(AAZCommand):
    """Skips an occurrence of an action.

    :example: Skip an action
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/users/{}/environments/{}/actions/{}:skip", "2025-04-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.action_name = AAZStrArg(
            options=["--action-name"],
            help="Uniquely identifies the action.",
            required=True,
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsSkipAction(ctx=self.ctx)()
    ...
    class EnvironmentsSkipAction(AAZHttpOperation):
...
class _SkipActionHelper:
    """Helper class for SkipAction"""

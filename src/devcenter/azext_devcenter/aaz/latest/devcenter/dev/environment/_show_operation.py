...
class ShowOperation(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.operation_id = AAZUuidArg(
            ...
            help="Unique identifier for the environment operation.",
            required=True,
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetOperation(ctx=self.ctx)()
    ...
    class EnvironmentsGetOperation(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.environment_parameters = AAZFreeFormDictType(
                serialized_name="environmentParameters",
            )

...
class DelayAction(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.until = AAZDateTimeArg(
            options=["--until"],
            help="The time to delay the Environment action until, in RFC3339 format.",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsDelayAction(ctx=self.ctx)()
    ...
    class EnvironmentsDelayAction(AAZHttpOperation):

...
class ListAction(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["data-plane:microsoft.devcenter", "/projects/{}/users/{}/environments/{}/actions", "2025-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsListActions(ctx=self.ctx)()
    ...
    class EnvironmentsListActions(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.last_modified_by = AAZStrType(
            ...
            _element.next = AAZObjectType()
            _element.uri = AAZStrType(
                flags={"read_only": True},
            )

            next = cls._schema_on_200.value.Element.next
...
class _ListActionHelper:
    """Helper class for ListAction"""

...
class UpdateExpirationDate(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsPatchEnvironment(ctx=self.ctx)()
    ...
    class EnvironmentsPatchEnvironment(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateExpirationDateHelper._build_schema_azure._core._foundations._error_read(_schema_on_200.error)
...
class _UpdateExpirationDateHelper:
    """Helper class for UpdateExpirationDate"""

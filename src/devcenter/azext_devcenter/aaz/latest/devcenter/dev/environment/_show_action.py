...
class ShowAction(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetAction(ctx=self.ctx)()
    ...
    class EnvironmentsGetAction(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.last_modified_by = AAZStrType(
...
class _ShowActionHelper:
    """Helper class for ShowAction"""

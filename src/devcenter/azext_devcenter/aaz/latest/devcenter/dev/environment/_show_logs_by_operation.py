...
class ShowLogsByOperation(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.operation_id = AAZStrArg(
            ...
            help="The id of the operation on an environment.",
            required=True,
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentsGetLogsByOperation(ctx=self.ctx)()
    ...
    class EnvironmentsGetLogsByOperation(AAZHttpOperation):
...
class _ShowLogsByOperationHelper:
    """Helper class for ShowLogsByOperation"""


__all__ = ["ShowLogsByOperation"]

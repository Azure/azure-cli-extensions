...
@register_command(
    "devcenter admin project-catalog connect",
)
class Connect(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/catalogs/{}/connect", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ProjectCatalogsConnect(ctx=self.ctx)()
    ...
    class ProjectCatalogsConnect(AAZHttpOperation):

...
@register_command(
    "devcenter admin project-catalog update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProjectCatalogsGet(ctx=self.ctx)()
        self.pre_instance_update(self.ctx.vars.instance)
        self.InstanceUpdateByJson(ctx=self.ctx)()
        self.InstanceUpdateByGeneric(ctx=self.ctx)()
        self.post_instance_update(self.ctx.vars.instance)
        yield self.ProjectCatalogsCreateOrUpdate(ctx=self.ctx)()
    ...
    class ProjectCatalogsGet(AAZHttpOperation):
    ...
    class ProjectCatalogsCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

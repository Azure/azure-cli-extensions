...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/devcenters/{}/environmenttypes", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentTypesListByDevCenter(ctx=self.ctx)()
    ...
    class EnvironmentTypesListByDevCenter(AAZHttpOperation):

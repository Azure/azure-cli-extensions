...
@register_command(
    "devcenter admin project-image show",
)
class Show(AAZCommand):
    """Get a project image.

    :example: Get
        az devcenter admin project-image show --project-name "DevProject" --name "ContosoBaseImage" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2025-10-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/images/{}", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ImagesGetByProject(ctx=self.ctx)()
    ...
    class ImagesGetByProject(AAZHttpOperation):

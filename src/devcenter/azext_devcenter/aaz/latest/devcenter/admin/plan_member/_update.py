...
@register_command(
    "devcenter admin plan-member update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    :example: Update
        az devcenter admin plan-member update --name "d702f662-b3f2-4796-9e8c-13c22378ced3" --plan-name "ContosoPlan" --resource-group "rg1" --tags CostCode="12345"
    """
...
class _UpdateHelper:
    ...
    def _build_schema_dev_center_plan_member_read(cls, _schema):
        ...
        sync_status = _schema_dev_center_plan_member_read.properties.sync_status
        sync_status.last_sync_error = AAZObjectType(
            serialized_name="lastSyncError",
        )
        cls._build_schema_error_detail_read(sync_status.last_sync_error)

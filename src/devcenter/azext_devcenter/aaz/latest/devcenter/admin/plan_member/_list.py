...
@register_command(
    "devcenter admin plan-member list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: List by plan
        az devcenter admin plan-member list  --plan-name "ContosoPlan" --resource-group "rg1"
    """
    ...
    class PlanMembersList(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevCenter/plans/{planName}/members",
                **self.url_parameters
            )

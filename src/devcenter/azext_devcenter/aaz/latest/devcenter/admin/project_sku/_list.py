...
@register_command(
    "devcenter admin project-sku list",
)
class List(AAZCommand):
    """Lists SKUs available to the project

    :example: List
        az devcenter admin project-sku list --project-name "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2025-10-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/listskus", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SkusListByProject(ctx=self.ctx)()
    ...
    class SkusListByProject(AAZHttpOperation):

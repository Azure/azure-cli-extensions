...
@register_command(
    "devcenter admin project-environment-definition show",
)
class Show(AAZCommand):
    """Get an environment definition from the catalog.

    :example: Get
        az devcenter admin environment-definition show --catalog-name "myCatalog" --project "ContosoProject" --environment-definition-name "myEnvironmentDefinition" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2025-10-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/catalogs/{}/environmentdefinitions/{}", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentDefinitionsGetByProjectCatalog(ctx=self.ctx)()
    ...
    class EnvironmentDefinitionsGetByProjectCatalog(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.template_path = AAZStrType(
                serialized_name="templatePath",
                flags={"read_only": True},
            )

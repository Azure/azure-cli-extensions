...
@register_command(
    "devcenter admin catalog-devbox-definition get-error-detail",
)
class GetErrorDetail(AAZCommand):
    """Gets catalog dev box definition error details.

    :example: Get error detail
        az devcenter admin catalog-devbox-definition get-error-detail --catalog-name "CentralCatalog" --dev-center-name "Contoso" --resource-group "rg1" --devbox-definition-name "WebDevBox"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CatalogDevBoxDefinitionsGetErrorDetails(ctx=self.ctx)()
    ...
    class CatalogDevBoxDefinitionsGetErrorDetails(AAZHttpOperation):

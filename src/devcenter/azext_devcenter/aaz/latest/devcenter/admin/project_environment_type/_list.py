...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/environmenttypes", "2025-10-01-preview"],
        ]
    }
    ...
    class ProjectEnvironmentTypesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            creator_role_assignment = cls._schema_on_200.value.Element.properties.creator_role_assignment
            creator_role_assignment.roles = AAZDictType()

            roles = cls._schema_on_200.value.Element.properties.creator_role_assignment.roles
            roles.Element = AAZObjectType()
            _ListHelper._build_schema_environment_role_read(roles.Element)

            user_role_assignments = cls._schema_on_200.value.Element.properties.user_role_assignments
            user_role_assignments.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.user_role_assignments.Element
            _element.roles = AAZDictType()

            roles = cls._schema_on_200.value.Element.properties.user_role_assignments.Element.roles
            roles.Element = AAZObjectType()
            _ListHelper._build_schema_environment_role_read(roles.Element)

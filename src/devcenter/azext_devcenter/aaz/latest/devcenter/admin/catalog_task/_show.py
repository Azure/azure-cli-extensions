...
@register_command(
    "devcenter admin catalog-task show",
)
class Show(AAZCommand):
    """Get a task from the catalog.

    :example: Get
        az devcenter admin catalog-task show --catalog-name "CentralCatalog" --task-name "SampleTask" --dev-center-name "Contoso" --resource-group "rg1"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomizationTasksGet(ctx=self.ctx)()
    ...
    class CustomizationTasksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            inputs = cls._schema_on_200.properties.inputs
            inputs.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.inputs.Element

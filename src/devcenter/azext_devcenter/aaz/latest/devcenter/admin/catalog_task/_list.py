...
@register_command(
    "devcenter admin catalog-task list",
)
class List(AAZCommand):
    """List tasks in the catalog.

    :example: List
        az devcenter admin catalog-task list --catalog-name "CentralCatalog" --dev-center-name "Contoso" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2025-10-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/devcenters/{}/catalogs/{}/tasks", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomizationTasksListByCatalog(ctx=self.ctx)()
    ...
    class CustomizationTasksListByCatalog(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            inputs = cls._schema_on_200.value.Element.properties.inputs
            inputs.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.inputs.Element

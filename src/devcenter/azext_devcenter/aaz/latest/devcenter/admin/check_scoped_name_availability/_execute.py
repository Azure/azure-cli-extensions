...
@register_command(
    "devcenter admin check-scoped-name-availability execute",
)
class Execute(AAZCommand):
    """Check the availability of name for resource

    :example: Checked scoped name availability of project catalog
    ...
    :example: Checked scoped name availability of dev center catalog
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.devcenter/checkscopednameavailability", "2025-10-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.scope = AAZStrArg(
            options=["--scope"],
            arg_group="NameAvailabilityRequest",
            help="The resource id to scope the name check.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CheckScopedNameAvailabilityExecute(ctx=self.ctx)()
    ...
    class CheckScopedNameAvailabilityExecute(AAZHttpOperation):

...
@register_command(
    "devcenter admin project-image-version show",
)
class Show(AAZCommand):
    """Get a project image version.

    :example: Get
        az devcenter admin project-image-version show --project-name "DevProject" --image-name "Win11" --resource-group "rg1" --version-name "1.0.0"
    """

    _aaz_info = {
        "version": "2025-10-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/images/{}/versions/{}", "2025-10-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ImageVersionsGetByProject(ctx=self.ctx)()
    ...
    class ImageVersionsGetByProject(AAZHttpOperation):

...
@register_command(
    "devcenter admin project-image-version list",
)
class List(AAZCommand):
    """List versions for a project image.

    :example: List
        az devcenter admin project-image-version list --project-name "DevProject" --image-name "Win11" --resource-group "rg1"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ImageVersionsListByProject(ctx=self.ctx)()
    ...
    class ImageVersionsListByProject(AAZHttpOperation):

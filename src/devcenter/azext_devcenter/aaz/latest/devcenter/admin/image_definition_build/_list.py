...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevCenterCatalogImageDefinitionBuildsListByImageDefinition(ctx=self.ctx)()
    ...
    class DevCenterCatalogImageDefinitionBuildsListByImageDefinition(AAZHttpOperation):

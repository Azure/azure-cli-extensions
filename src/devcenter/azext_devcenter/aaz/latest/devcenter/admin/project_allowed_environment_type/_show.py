...
class Show(AAZCommand):
    ...
    :example: Show
        az devcenter admin project-allowed-environment-type show --environment-type-name "{environmentTypeName}" --project-name "Contoso" --resource-group "rg1"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProjectAllowedEnvironmentTypesGet(ctx=self.ctx)()
    ...
    class ProjectAllowedEnvironmentTypesGet(AAZHttpOperation):

...
def devcenter_schedule_list_dp(
    ...
    return cf_dataplane.dev_boxes.list_schedules(project_name=project_name, pool_name=pool_name)
...
def devcenter_dev_box_list(
    ...
    if project_name is not None and user_id is not None:
        return cf_dataplane.dev_boxes.list_dev_boxes(project_name=project_name, user_id=user_id)
...
def devcenter_dev_box_list_action(
    ...
    return cf_dataplane.dev_boxes.list_actions(project_name=project_name, user_id=user_id, dev_box_name=dev_box_name)
...
def devcenter_dev_box_list_operation(
    ...
    return cf_dataplane.dev_boxes.list_operations(project_name=project_name, user_id=user_id, dev_box_name=dev_box_name)
...
def devcenter_environment_list(
    ...
    if user_id is not None:
        return cf_dataplane.deployment_environments.list_all_environments(project_name=project_name, user_id=user_id)
    return cf_dataplane.deployment_environments.list_environments(project_name=project_name)
...
def devcenter_environment_create(
    ...
    body["expirationDate"] = datetime.strptime(expiration_date, "%Y-%m-%dT%H:%M:%S.%fZ")
    return sdk_no_wait(
        no_wait,
...
def devcenter_catalog_show_dp(
    ...
    return cf_dataplane.deployment_environments.get_catalog(project_name=project_name, catalog_name=catalog_name)
...
def devcenter_environment_definition_list_dp(
    ...
    return cf_dataplane.deployment_environments.list_environment_definitions(project_name=project_name)
...
def devcenter_environment_definition_show_dp(
    ...
    return cf_dataplane.deployment_environments.get_environment_definition(
        project_name=project_name, catalog_name=catalog_name, definition_name=definition_name
    )
...
def devcenter_environment_type_list_dp(
    ...
    return cf_dataplane.deployment_environments.list_environment_types(project_name=project_name)
...
def devcenter_environment_operation_list(
    ...
    return cf_dataplane.environments.list_operations(project_name=project_name,
                                                                   environment_name=environment_name, user_id=user_id)
...
def devcenter_environment_operation_show_action(
    cmd, project_name, environment_name, action_name, user_id="me", dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(
        cmd.cli_ctx, endpoint, dev_center, project_name
    )
    ...
    return cf_dataplane.environments.get_action(
        project_name=project_name, user_id=user_id, action_name=action_name, environment_name=environment_name
    )
...
def devcenter_environment_operation_delay_action(
    cmd, project_name, environment_name, action_name, until, user_id="me", dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(
        cmd.cli_ctx, endpoint, dev_center, project_name
    )
    ...
    return cf_dataplane.environments.delay_action(
        project_name=project_name, action_name=action_name, user_id=user_id, until=until, environment_name=environment_name
    )
...
def devcenter_environment_operation_skip_action(
    ...
    return cf_dataplane.environments.skip_action(
        project_name=project_name, action_name=action_name, user_id=user_id, environment_name=environment_name
    )
...
def devcenter_environment_operation_update_environment(
    cmd, project_name, environment_name, user_id="me", dev_center=None, endpoint=None, expiration_date=None,
):
    cf_dataplane = cf_devcenter_dataplane(
        cmd.cli_ctx, endpoint, dev_center, project_name
    )
    ...
    return cf_dataplane.environments.patch_environment(
        project_name=project_name, user_id=user_id, environment_name=environment_name, body=body
    )

...
class DevCenter(object):
    ...
    :vartype project: dev_center.aio.operations.ProjectOperations
    :ivar pool: PoolOperations operations
    :vartype pool: dev_center.aio.operations.PoolOperations
    :ivar schedule: ScheduleOperations operations
    :vartype schedule: dev_center.aio.operations.ScheduleOperations
    :ivar dev_box: DevBoxOperations operations
    :vartype dev_box: dev_center.aio.operations.DevBoxOperations
    :ivar environments: EnvironmentsOperations operations
    :vartype environments: dev_center.aio.operations.EnvironmentsOperations
    :ivar actions: ActionsOperations operations
    :vartype actions: dev_center.aio.operations.ActionsOperations
    :ivar artifacts: ArtifactsOperations operations
    :vartype artifacts: dev_center.aio.operations.ArtifactsOperations
    :ivar catalog_item: CatalogItemOperations operations
    :vartype catalog_item: dev_center.aio.operations.CatalogItemOperations
    :ivar catalog_items: CatalogItemsOperations operations
    :vartype catalog_items: dev_center.aio.operations.CatalogItemsOperations
    :ivar catalog_item_versions: CatalogItemVersionsOperations operations
    :vartype catalog_item_versions: dev_center.aio.operations.CatalogItemVersionsOperations
    :ivar environment_type: EnvironmentTypeOperations operations
    :vartype environment_type: dev_center.aio.operations.EnvironmentTypeOperations

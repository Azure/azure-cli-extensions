...
class AllowedEnvironmentType(Resource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AllowedEnvironmentType, self).__init__(**kwargs)
        self.provisioning_state = None


class AllowedEnvironmentTypeListResult(msrest.serialization.Model):
    """Result of the allowed environment type list operation.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value: Current page of results.
    :vartype value: list[~dev_center.models.AllowedEnvironmentType]
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AllowedEnvironmentTypeListResult, self).__init__(**kwargs)
        self.value = None
        self.next_link = None

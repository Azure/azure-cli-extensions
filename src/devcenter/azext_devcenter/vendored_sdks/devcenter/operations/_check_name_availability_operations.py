...
class CheckNameAvailabilityOperations(object):
    ...
    def execute(
        self,
        name_availability_request,  # type: "models.CheckNameAvailabilityRequest"
        **kwargs  # type: Any
    ):
        ...
        :param name_availability_request: The required parameters for checking if resource name is
         available.
        :type name_availability_request: ~dev_center.models.CheckNameAvailabilityRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResponse, or the result of cls(response)
        :rtype: ~dev_center.models.CheckNameAvailabilityResponse
        ...
        body_content = self._serialize.body(name_availability_request, 'CheckNameAvailabilityRequest')

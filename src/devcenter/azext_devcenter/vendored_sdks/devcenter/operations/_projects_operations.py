...
class ProjectsOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~dev_center.models.ProjectListResult]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~dev_center.models.Project
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~dev_center.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.Project"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.Project"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~dev_center.models.ProjectUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy

...
class NetworkConnectionsOperations(object):
    """NetworkConnectionsOperations operations.
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.NetworkConnectionListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~dev_center.models.NetworkConnectionListResult]
    ...
    def get(
        self,
        resource_group_name,  # type: str
        network_connection_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NetworkConnection"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        network_connection_name,  # type: str
        body,  # type: "models.NetworkConnection"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NetworkConnection"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkConnection"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.NetworkConnection"]
        ...
        :return: An instance of LROPoller that returns either NetworkConnection or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~dev_center.models.NetworkConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        network_connection_name,  # type: str
        body,  # type: "models.NetworkConnectionUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.NetworkConnection"]
    ...
    def list_health_details(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~dev_center.models.HealthCheckStatusDetailsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

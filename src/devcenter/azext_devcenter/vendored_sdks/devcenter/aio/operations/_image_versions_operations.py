...
class ImageVersionsOperations:
    """ImageVersionsOperations async operations.
    ...
    def list_by_image(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either ImageVersionListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~dev_center.models.ImageVersionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ImageVersionListResult"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~dev_center.models.ImageVersion
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ImageVersion"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        path_format_arguments = {
            ...
            'galleryName': self._serialize.url("gallery_name", gallery_name, 'str'),
            'imageName': self._serialize.url("image_name", image_name, 'str'),
            'versionName': self._serialize.url("version_name", version_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)

...
class Operations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~dev_center.models.OperationListResult]
    ...
    list.metadata = {'url': '/providers/Microsoft.DevCenter/operations'}  # type: ignore

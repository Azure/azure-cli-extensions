...
class DevBoxDefinitionsOperations:
    ...
    def list_by_dev_center(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~dev_center.models.DevBoxDefinitionListResult]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~dev_center.models.DevBoxDefinition
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :type body: ~dev_center.models.DevBoxDefinition
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~dev_center.models.DevBoxDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        **kwargs
    ) -> Optional["models.DevBoxDefinition"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DevBoxDefinition"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type dev_box_definition_name: str
        :param body: Represents a Dev Box definition.
        :type body: ~dev_center.models.DevBoxDefinitionUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy

...
class ScheduledQueryRulesOperations(object):
    ...
    :type models: ~$(python-base-namespace).v2021_02_preview.models
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResourceCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ScheduledQueryRuleResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResourcePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ScheduledQueryRuleResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_02_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError

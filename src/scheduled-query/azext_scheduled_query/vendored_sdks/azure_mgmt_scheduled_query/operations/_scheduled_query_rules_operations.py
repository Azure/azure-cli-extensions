...
class ScheduledQueryRulesOperations(object):
    ...
    :type models: ~$(python-base-namespace).v2021_02_01_preview.models
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ScheduledQueryRuleResourceCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResourceCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ScheduledQueryRuleResource"
        ...
        :rtype: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        rule_name,  # type: str
        parameters,  # type: "_models.ScheduledQueryRuleResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScheduledQueryRuleResource"
        ...
        :type parameters: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ScheduledQueryRuleResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        resource_group_name,  # type: str
        rule_name,  # type: str
        parameters,  # type: "_models.ScheduledQueryRuleResourcePatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScheduledQueryRuleResource"
        ...
        :type parameters: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResourcePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ScheduledQueryRuleResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResource
        :raises: ~azure.core.exceptions.HttpResponseError

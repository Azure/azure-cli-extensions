...
class Condition(msrest.serialization.Model):
    ...
    :type query: str
    :param time_aggregation: Required. Aggregation type. Relevant and required only for rules of
     the kind LogAlert. Possible values include: "Count", "Average", "Minimum", "Maximum", "Total".
    :type time_aggregation: str or
     ~$(python-base-namespace).v2021_02_01_preview.models.TimeAggregation
    :param metric_measure_column: The column containing the metric measure number. Relevant only
    ...
    :type dimensions: list[~$(python-base-namespace).v2021_02_01_preview.models.Dimension]
    :param operator: Required. The criteria operator. Relevant and required only for rules of the
     kind LogAlert. Possible values include: "Equals", "GreaterThan", "GreaterThanOrEqual",
     "LessThan", "LessThanOrEqual".
    :type operator: str or ~$(python-base-namespace).v2021_02_01_preview.models.ConditionOperator
    :param threshold: Required. the criteria threshold value that activates the alert. Relevant and
    ...
    :type failing_periods:
     ~$(python-base-namespace).v2021_02_01_preview.models.ConditionFailingPeriods
    :param metric_name: The name of the metric to be sent. Relevant and required only for rules of
...
class Dimension(msrest.serialization.Model):
    ...
    :param operator: Required. Operator for dimension values. Possible values include: "Include",
     "Exclude".
    :type operator: str or ~$(python-base-namespace).v2021_02_01_preview.models.DimensionOperator
...
class ErrorContract(msrest.serialization.Model):
    ...
    :type error: ~$(python-base-namespace).v2021_02_01_preview.models.ErrorResponse
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :vartype details: list[~$(python-base-namespace).v2021_02_01_preview.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~$(python-base-namespace).v2021_02_01_preview.models.ErrorAdditionalInfo]
    """
...
class ScheduledQueryRuleCriteria(msrest.serialization.Model):
    ...
    :type all_of: list[~$(python-base-namespace).v2021_02_01_preview.models.Condition]
    """
...
class ScheduledQueryRuleResource(TrackedResource):
    ...
    :param location: Required. The geo-location where the resource lives.
    :type location: str
    :param kind: Indicates the type of scheduled query rule. The default is LogAlert. Possible
     values include: "LogAlert", "LogToMetric".
    :type kind: str or ~$(python-base-namespace).v2021_02_01_preview.models.Kind
    ...
    :vartype system_data: ~$(python-base-namespace).v2021_02_01_preview.models.SystemData
    ...
    :param severity: Severity of the alert. Should be an integer between [0-4]. Value of 0 is
     ...
     0, 1, 2, 3, 4.
    :type severity: str or ~$(python-base-namespace).v2021_02_01_preview.models.AlertSeverity
    ...
    :type criteria: ~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleCriteria
    ...
    :type actions: list[~$(python-base-namespace).v2021_02_01_preview.models.Action]
    ...
    :param check_workspace_alerts_storage_configured: The flag which indicates whether this
    ...
    :param skip_query_validation: The flag which indicates whether the provided query should be
     validated or not. The default is false. Relevant only for rules of the kind LogAlert.
    :type skip_query_validation: bool
...
class ScheduledQueryRuleResourceCollection(msrest.serialization.Model):
    ...
    :type value:
     list[~$(python-base-namespace).v2021_02_01_preview.models.ScheduledQueryRuleResource]
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or
     ~$(python-base-namespace).v2021_02_01_preview.models.CreatedByType

...
class MonitorManagementClient:
    ...
    :vartype scheduled_query_rules:
     $(python-base-namespace).v2021_08_01.aio.operations.ScheduledQueryRulesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.scheduled_query_rules = ScheduledQueryRulesOperations(self._client, self._config, self._serialize, self._deserialize)

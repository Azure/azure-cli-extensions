...
@register_command(
    "billing-benefits savings-plan-order savings-plan list",
)
class List(AAZCommand):
    """List savings plans in an order.

    :example: List savings plans in an order
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SavingsPlanList(ctx=self.ctx)()
    ...
    class SavingsPlanList(AAZHttpOperation):

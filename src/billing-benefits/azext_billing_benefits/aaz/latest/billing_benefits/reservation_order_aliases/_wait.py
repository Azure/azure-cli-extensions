...
@register_command(
    "billing-benefits reservation-order-aliases wait",
)
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReservationOrderAliasGet(ctx=self.ctx)()
    ...
    class ReservationOrderAliasGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            reserved_resource_properties = cls._schema_on_200.properties.reserved_resource_properties

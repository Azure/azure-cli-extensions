...
class VirtualMachineImageOperations:
    """VirtualMachineImageOperations async operations.
    ...
    def list(
        ...
        location: str,
        **kwargs
    ) -> AsyncIterable["models.VirtualMachineImageListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~swiftlet_management_client.models.VirtualMachineImageListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

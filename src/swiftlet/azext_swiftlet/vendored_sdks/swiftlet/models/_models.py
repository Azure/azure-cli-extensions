...
class VirtualMachineCreateParameters(TrackedResourceCreateParameters):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VirtualMachineCreateParameters, self).__init__(**kwargs)
        self.bundle_sku = kwargs.get('bundle_sku', None)
...
class VirtualMachineSnapshot(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VirtualMachineSnapshot, self).__init__(**kwargs)
...
class VirtualMachineSnapshotCreateParameters(TrackedResourceCreateParameters):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VirtualMachineSnapshotCreateParameters, self).__init__(**kwargs)
        self.virtual_machine_id = kwargs['virtual_machine_id']
...
class VirtualMachineSnapshotUpdate(UpdateResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VirtualMachineSnapshotUpdate, self).__init__(**kwargs)

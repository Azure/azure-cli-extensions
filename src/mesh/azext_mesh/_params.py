...
def load_arguments(self, _):
    ...
    with self.argument_context('mesh deployment create') as c:
        ...
        c.argument('input_yaml_file_paths', options_list=['--input-yaml-file-paths'], help="List of comma seperated yaml files or a directory which contains all the yaml files")

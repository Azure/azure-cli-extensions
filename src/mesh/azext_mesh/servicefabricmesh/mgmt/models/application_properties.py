...
class ApplicationProperties(Model):
    ...
    :param status: Status of the application. Possible values include:
    ...
    def __init__(self, description=None, services=None, diagnostics=None, debug_params=None, status=None):

...
class SeaBreezeManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('azure-seabreeze/{}'.format(VERSION))
...
class SeaBreezeManagementClient(object):
    ...
    :vartype application: azure.seabreeze.operations.ApplicationOperations
    :ivar service: Service operations
    :vartype service: azure.seabreeze.operations.ServiceOperations
    :ivar replica: Replica operations
    :vartype replica: azure.seabreeze.operations.ReplicaOperations
    :ivar code_package: CodePackage operations
    :vartype code_package: azure.seabreeze.operations.CodePackageOperations
    :ivar operations: Operations operations
    :vartype operations: azure.seabreeze.operations.Operations
    :ivar network: Network operations
    :vartype network: azure.seabreeze.operations.NetworkOperations
    :ivar volume: Volume operations
    :vartype volume: azure.seabreeze.operations.VolumeOperations

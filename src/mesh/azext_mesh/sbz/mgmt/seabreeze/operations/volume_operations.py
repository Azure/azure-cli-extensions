...
class VolumeOperations(object):
    ...
    def create(
        ...
        :rtype: ~azure.seabreeze.models.VolumeResourceDescription or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.seabreeze.models.VolumeResourceDescriptionPaged[~azure.seabreeze.models.VolumeResourceDescription]
        :raises:
         :class:`ErrorModelException<azure.seabreeze.models.ErrorModelException>`
        """

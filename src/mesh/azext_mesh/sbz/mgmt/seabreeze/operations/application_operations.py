...
class ApplicationOperations(object):
    ...
    def create(
        ...
        :return: ApplicationResourceDescription or ClientRawResponse if
         raw=true
        :rtype: ~azure.seabreeze.models.ApplicationResourceDescription or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.seabreeze.models.ApplicationResourceDescriptionPaged[~azure.seabreeze.models.ApplicationResourceDescription]
        :raises:
         :class:`ErrorModelException<azure.seabreeze.models.ErrorModelException>`
        """

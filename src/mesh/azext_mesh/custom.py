...
def _deploy_arm_template_core(cli_ctx, resource_group_name,  # pylint: disable=too-many-arguments
                              template_file=None, template_uri=None, input_yaml_files_path=None, deployment_name=None,
    ...
    if template_uri:
        ...
        if os.path.isdir(input_yaml_files_path):
            for root, _, files in os.walk(input_yaml_files_path):
...
def deploy_arm_template(cmd, resource_group_name,
    ...
    return _deploy_arm_template_core(cmd.cli_ctx, resource_group_name, template_file, template_uri,
                                     input_yaml_files_path, deployment_name, parameters, mode, no_wait=no_wait)

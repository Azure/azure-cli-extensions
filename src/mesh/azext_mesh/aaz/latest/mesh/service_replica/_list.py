...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServiceReplicaList(ctx=self.ctx)()
    ...
    class ServiceReplicaList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_service_fabric_volume_disk = cls._schema_on_200.value.Element.code_packages.Element.volumes.Element.creation_parameters.discriminate_by("kind", "ServiceFabricVolumeDisk")

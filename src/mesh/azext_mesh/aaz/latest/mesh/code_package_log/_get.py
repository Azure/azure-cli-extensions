...
class Get(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.code_package_name = AAZStrArg(
            options=["--code-package-name"],
            help="The name of code package of the service.",
            required=True,
            id_part="child_name_3",
        )
        _args_schema.replica_name = AAZStrArg(
            options=["--replica-name"],
            help="Service Fabric replica name.",
            required=True,
        ...
        _args_schema.tail = AAZIntArg(
            options=["--tail"],
            help="Number of lines to show from the end of the logs. Default is 100.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.CodePackageGetContainerLogs(ctx=self.ctx)()

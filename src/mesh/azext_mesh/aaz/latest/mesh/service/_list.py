...
class List(AAZCommand):
    ...
    class ServiceList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_add_remove_replica = cls._schema_on_200.value.Element.properties.auto_scaling_policies.Element.mechanism.discriminate_by("kind", "AddRemoveReplica")
            ...
            disc_average_load = cls._schema_on_200.value.Element.properties.auto_scaling_policies.Element.trigger.discriminate_by("kind", "AverageLoad")
            ...
            metric = cls._schema_on_200.value.Element.properties.auto_scaling_policies.Element.trigger.discriminate_by("kind", "AverageLoad").metric
            metric.kind = AAZStrType(
                flags={"required": True},
            )

            disc_resource = cls._schema_on_200.value.Element.properties.auto_scaling_policies.Element.trigger.discriminate_by("kind", "AverageLoad").metric.discriminate_by("kind", "Resource")
            ...
            disc_service_fabric_volume_disk = cls._schema_on_200.value.Element.properties.code_packages.Element.volumes.Element.creation_parameters.discriminate_by("kind", "ServiceFabricVolumeDisk")

...
def load_command_table(self, _):
    ...
    with self.command_group('custom-providers custom-resource-provider', custom_providers_custom_resource_provider, client_factory=cf_custom_resource_provider) as g:
        g.custom_command('create', 'create_custom_providers_custom_resource_provider')
        g.custom_command('update', 'update_custom_providers_custom_resource_provider')
        g.custom_command('delete', 'delete_custom_providers_custom_resource_provider')

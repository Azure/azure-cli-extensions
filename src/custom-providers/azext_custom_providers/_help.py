...
helps['custom-providers resource-provider create'] = """
    ...
    examples:
      - name: Create or update the custom resource provider
        text: |-
               az custom-providers resource-provider create --resource-group "testRG" --name \\
...
helps['custom-providers resource-provider update'] = """
    ...
    examples:
      - name: Update a custom resource provider
        text: |-
               az custom-providers resource-provider update --resource-group "testRG" --name \\
               "newrp"
"""
...
helps['custom-providers resource-provider delete'] = """
    ...
    examples:
      - name: Delete a custom resource provider
        text: |-
               az custom-providers resource-provider delete --resource-group "testRG" --name \\
               "newrp"
"""
...
helps['custom-providers resource-provider show'] = """
    ...
    examples:
      - name: Get a custom resource provider
        text: |-
               az custom-providers resource-provider show --resource-group "testRG" --name \\
               "newrp"
"""
...
helps['custom-providers resource-provider list'] = """
    ...
    examples:
      - name: List all custom resource providers on the resourceGroup
        text: |-
               az custom-providers resource-provider list --resource-group "testRG"

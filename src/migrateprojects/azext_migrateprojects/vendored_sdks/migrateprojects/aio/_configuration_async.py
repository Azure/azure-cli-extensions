...
class AzureMigrateHubConfiguration(Configuration):
    """Configuration for AzureMigrateHub.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(AzureMigrateHubConfiguration, self).__init__(**kwargs)

        self.credential = credential
        self.subscription_id = subscription_id
        self.accept_language = accept_language
        self.api_version = "2018-09-01-preview"
        kwargs.setdefault('sdk_moniker', 'azure-mgmt-migrateprojects/{}'.format(VERSION))

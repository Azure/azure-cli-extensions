...
class MachineOperations:
    ...
    async def enumerate_machine(
        ...
        **kwargs
        ...
        :return: MachineCollection or the result of cls(response)
        :rtype: ~azure_migrate_hub.models.MachineCollection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MachineCollection"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        api_version = "2018-09-01-preview"

        # Construct URL
        url = self.enumerate_machine.metadata['url']
        ...
        deserialized = self._deserialize('MachineCollection', pipeline_response)

        if cls:
          return cls(pipeline_response, deserialized, {})

        return deserialized
    enumerate_machine.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines'}
    ...
    async def get_machine(
        ...
        **kwargs
        ...
        :rtype: ~azure_migrate_hub.models.Machine
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        # Construct URL
        url = self.get_machine.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'migrateProjectName': self._serialize.url("migrate_project_name", migrate_project_name, 'str'),
        ...
        return deserialized
    get_machine.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines/{machineName}'}

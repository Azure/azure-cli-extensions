...
@register_command(
    "workload-manager workload-space runtime-binding show",
)
class Show(AAZCommand):
    """Get a runtime binding.

    :example: Get a runtime binding
        az workload-manager workload-space runtime-binding show --resource-group rg-workload --space-name managed-agents-prod --binding-name kubernetes-default
    """

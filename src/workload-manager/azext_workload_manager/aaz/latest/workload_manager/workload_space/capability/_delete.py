...
@register_command(
    "workload-manager workload-space capability delete",
...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.capability_name = AAZStrArg(
            options=["-n", "--name", "--capability-name"],
            help="The name of the Capability",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CapabilitiesDelete(ctx=self.ctx)()
    ...
    class CapabilitiesDelete(AAZHttpOperation):

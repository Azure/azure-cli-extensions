...
@register_command(
    "workload-manager workload-space capability create",
)
class Create(AAZCommand):
    """Create a capability.

    :example: Enable the Agent Sandbox capability
        az workload-manager workload-space capability create --resource-group rg-workload --space-name managed-agents-prod --capability-name agentSandbox --location eastus2 --kind AgentSandbox --version-policy ServiceManaged
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.kind = AAZStrArg(
            ...
            enum={"AgentSandbox": "AgentSandbox"},
            fmt=AAZStrArgFormat(
                pattern="^[-\\w\\._,\\(\\\\\\)]+$",
            ),
        )

...
@register_command(
    "workload-manager workload-space capability show",
)
class Show(AAZCommand):
    """Get a capability.

    :example: Get the Agent Sandbox capability
        az workload-manager workload-space capability show --resource-group rg-workload --space-name managed-agents-prod --capability-name agentSandbox
    """

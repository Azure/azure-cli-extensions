...
helps['stream-analytics job list'] = """
    type: command
    short-summary: "Lists all of the streaming jobs in the specified resource group. And Lists all of the streaming \
...
helps['stream-analytics job create'] = """
    ...
    parameters:
      - name: --identity
        short-summary: "Describes the system-assigned managed identity assigned to this job that can be used to \
authenticate with inputs and outputs."
      ...
      - name: --transformation
        short-summary: "Indicates the query and the number of streaming units to use for the streaming job. The name \
...
helps['stream-analytics job update'] = """
    type: command
    short-summary: "Updates an existing streaming job. This can be used to partially update (ie. update one or two \
...
helps['stream-analytics job scale'] = """
    type: command
    short-summary: "Scales a streaming job when the job is running."
    examples:
...
helps['stream-analytics job start'] = """
    type: command
    short-summary: "Starts a streaming job. Once a job is started it will start processing input events and produce \
output."
    examples:
...
helps['stream-analytics job stop'] = """
    type: command
    short-summary: "Stops a running streaming job. This will cause a running streaming job to stop processing input \
...
helps['stream-analytics input update'] = """
    type: command
    short-summary: "Updates an existing input under an existing streaming job. This can be used to partially update \
...
helps['stream-analytics input test'] = """
    type: command
    short-summary: "Tests whether an input’s datasource is reachable and usable by the Azure Stream Analytics \
service."
    examples:
...
helps['stream-analytics output update'] = """
    type: command
    short-summary: "Updates an existing output under an existing streaming job. This can be used to partially update \
...
helps['stream-analytics output test'] = """
    type: command
    short-summary: "Tests whether an output’s datasource is reachable and usable by the Azure Stream Analytics \
service."
    examples:
...
helps['stream-analytics transformation create'] = """
    type: command
    short-summary: "Creates a transformation or replaces an already existing transformation under an existing \
streaming job."
    examples:
...
helps['stream-analytics transformation update'] = """
    type: command
    short-summary: "Updates an existing transformation under an existing streaming job. This can be used to partially \
...
helps['stream-analytics function update'] = """
    type: command
    short-summary: "Updates an existing function under an existing streaming job. This can be used to partially update \
...
helps['stream-analytics function test'] = """
    type: command
    short-summary: "Tests if the information provided for a function is valid. This can range from testing the \
...
helps['stream-analytics subscription inspect'] = """
    type: command
    short-summary: "Retrieves the subscription's current quota information in a particular region."
    examples:
...
helps['stream-analytics cluster list'] = """
    type: command
    short-summary: "Lists all of the clusters in the given resource group. And Lists all of the clusters in the given \
subscription."
    examples:
...
helps['stream-analytics cluster show'] = """
    type: command
    short-summary: "Gets information about the specified cluster."
    examples:
      - name: Get a cluster
        text: |-
...
helps['stream-analytics cluster create'] = """
    type: command
    short-summary: "Creates a Stream Analytics Cluster or replaces an already existing cluster."
    parameters:
      - name: --sku
...
helps['stream-analytics cluster update'] = """
    type: command
    short-summary: "Updates an existing cluster. This can be used to partially update (ie. update one or two \
...
helps['stream-analytics cluster delete'] = """
    type: command
    short-summary: "Deletes the specified cluster."
    examples:
...
helps['stream-analytics cluster list-streaming-job'] = """
    type: command
    short-summary: "Lists all of the streaming jobs in the given cluster."
    examples:
...
helps['stream-analytics private-endpoint list'] = """
    type: command
    short-summary: "Lists the private endpoints in the cluster."
    examples:
...
helps['stream-analytics private-endpoint show'] = """
    type: command
    short-summary: "Gets information about the specified Private Endpoint."
    examples:
...
helps['stream-analytics private-endpoint create'] = """
    type: command
    short-summary: "Creates a Stream Analytics Private Endpoint or replaces an already existing Private Endpoint."
    examples:

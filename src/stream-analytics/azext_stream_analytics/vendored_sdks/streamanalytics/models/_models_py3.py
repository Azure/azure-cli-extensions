...
class AzureMachineLearningWebServiceFunctionBinding(FunctionBinding):
    ...
    :param endpoint: The Request-Response execute endpoint of the Azure Machine Learning web
     service. Find out more here: https://learn.microsoft.com/en-us/azure/machine-learning/machine-
    ...
    :type inputs: ~stream_analytics_management_client.models.AzureMachineLearningWebServiceInputs
...
class AzureMachineLearningWebServiceFunctionRetrieveDefaultDefinitionParameters(FunctionRetrieveDefaultDefinitionParameters):
    ...
    :param execute_endpoint: The Request-Response execute endpoint of the Azure Machine Learning
     web service. Find out more here: https://learn.microsoft.com/en-us/azure/machine-
...
class AzureSqlDatabaseDataSourceProperties(msrest.serialization.Model):
    ...
    :param max_writer_count: Max Writer count, currently only 1(single writer) and 0(based on query
...
class AzureSqlReferenceInputDataSource(ReferenceInputDataSource):
    ...
    :type table: str
    :param refresh_type: Indicates the type of data refresh option. Possible values include:
     "Static", "RefreshPeriodicallyWithFull", "RefreshPeriodicallyWithDelta".
    :type refresh_type: str or ~stream_analytics_management_client.models.RefreshType
...
class Compression(msrest.serialization.Model):
    ...
    :param type: Required. Indicates the type of compression that the input uses. Required on PUT
     (CreateOrReplace) requests. Possible values include: "None", "GZip", "Deflate".
    :type type: str or ~stream_analytics_management_client.models.CompressionType
    """
...
class CsvSerialization(Serialization):
    ...
    :param field_delimiter: Specifies the delimiter that will be used to separate comma-separated
     value (CSV) records. See https://learn.microsoft.com/en-us/rest/api/streamanalytics/stream-
     analytics-input or https://learn.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-
...
class EventHubOutputDataSource(OutputDataSource):
    ...
    :param partition_key: The key/column that is used to determine to which partition to send event
     data.
    :type partition_key: str
    :param property_columns: The properties associated with this Event Hub output.
...
class Identity(msrest.serialization.Model):
    ...
    :param tenant_id: The identity tenantId.
    :type tenant_id: str
    :param principal_id: The identity principal ID.
...
class Output(SubResource):
    ...
    :param time_window: The time frame for filtering Stream Analytics job outputs.
    :type time_window: str
    :param size_window: The size window to constrain a Stream Analytics output to.
...
class ScaleStreamingJobParameters(msrest.serialization.Model):
    ...
    :param streaming_units: Specifies the number of streaming units that the streaming job will
     scale to.
...
class ServiceBusQueueOutputDataSource(OutputDataSource):
    ...
    :type property_columns: list[str]
    :param system_property_columns: The system properties associated with the Service Bus Queue.
    ...
    :type system_property_columns: object
    """
    ...
    def __init__(
        ...
        *,
        ...
        property_columns: Optional[List[str]] = None,
        system_property_columns: Optional[object] = None,
        **kwargs
    ):
...
class ServiceBusTopicOutputDataSource(OutputDataSource):
    ...
    :param property_columns: A string array of the names of output columns to be attached to
     Service Bus messages as custom properties.
    :type property_columns: list[str]
    :param system_property_columns: The system properties associated with the Service Bus Topic
...
class Sku(msrest.serialization.Model):
    ...
    :param name: The name of the SKU. Required on PUT (CreateOrReplace) requests. Possible values
     include: "Standard".
    :type name: str or ~stream_analytics_management_client.models.SkuName
    """
...
class StreamingJob(TrackedResource):
    ...
    :type sku: ~stream_analytics_management_client.models.Sku
...
class Transformation(SubResource):
    ...
    :type streaming_units: int
    :param valid_streaming_units: Specifies the valid streaming units a streaming job can scale to.
    :type valid_streaming_units: list[int]

...
def load_command_table(self, _):
    ...
    diskpool_disk_pool = CliCommandType(
        operations_tmpl='azext_diskpool.vendored_sdks.storagepool.operations._disk_pool_operations#DiskPoolOperations.{'
        '}',
    ...
    diskpool_iscsi_target = CliCommandType(
        operations_tmpl='azext_diskpool.vendored_sdks.storagepool.operations._iscsi_target_operations#IscsiTargetOperat'
        'ions.{}',
        client_factory=cf_iscsi_target)
    with self.command_group('disk-pool iscsi-target', diskpool_iscsi_target, client_factory=cf_iscsi_target,

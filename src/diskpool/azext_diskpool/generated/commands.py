...
def load_command_table(self, _):
    ...
    with self.command_group('disk-pool', diskpool_disk_pool, client_factory=cf_disk_pool) as g:
        ...
        g.custom_command('deallocate', 'disk_pool_deallocate', supports_no_wait=True)
    ...
    from azext_diskpool.generated._client_factory import cf_disk_pool_zone
    diskpool_disk_pool_zone = CliCommandType(
        operations_tmpl='azext_diskpool.vendored_sdks.storagepool.operations._disk_pool_zones_operations#DiskPoolZonesO'
        'perations.{}',
        client_factory=cf_disk_pool_zone)
    with self.command_group('disk-pool-zone', diskpool_disk_pool_zone, client_factory=cf_disk_pool_zone) as g:
        g.custom_command('list', 'disk_pool_zone_list')

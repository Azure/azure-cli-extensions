...
@register_command(
    "workload-orchestration schema dynamic-schema version delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DynamicSchemaVersionsDelete(ctx=self.ctx)()
    ...
    class DynamicSchemaVersionsDelete(AAZHttpOperation):

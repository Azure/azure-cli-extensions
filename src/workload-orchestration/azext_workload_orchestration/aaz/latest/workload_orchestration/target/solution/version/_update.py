...
@register_command(
    "workload-orchestration target solution version update",
)
...
class _UpdateHelper:
    ...
    def _build_schema_solution_version_read(cls, _schema):
        if cls._schema_solution_version_read is not None:
            _schema.e_tag = cls._schema_solution_version_read.e_tag
            _schema.extended_location = cls._schema_solution_version_read.extended_location
        ...
        solution_version_read.e_tag = AAZStrType(
            serialized_name="eTag",
            flags={"read_only": True},
        )
        solution_version_read.extended_location = AAZObjectType(
        ...
        solution_version_read.properties = AAZObjectType()
        ...
        extended_location = _schema_solution_version_read.extended_location
        ...
        properties = _schema_solution_version_read.properties
        ...
        solution_dependencies = _schema_solution_version_read.properties.solution_dependencies
        solution_dependencies.Element = AAZObjectType()
        cls._build_schema_solution_dependency_read(solution_dependencies.Element)

...
@register_command(
    "workload-orchestration target config set",
)
class Set(AAZCommand):
    ...
    class DynamicConfigurationVersionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _SetHelper._build_schema_dynamic_configuration_version_read(cls._schema_on_200)
    ...
    class DynamicConfigurationVersionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _SetHelper._build_schema_dynamic_configuration_version_read(cls._schema_on_200_201)

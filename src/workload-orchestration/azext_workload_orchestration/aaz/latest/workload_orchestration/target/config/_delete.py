...
@register_command(
    "workload-orchestration target config delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DynamicConfigurationVersionsDelete(ctx=self.ctx)()
    ...
    class DynamicConfigurationVersionsDelete(AAZHttpOperation):

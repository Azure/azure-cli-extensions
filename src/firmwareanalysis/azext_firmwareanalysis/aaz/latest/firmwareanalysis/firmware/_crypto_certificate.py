...
@register_command(
    "firmwareanalysis firmware crypto-certificate",
)
class CryptoCertificate(AAZCommand):
    """List cryptographic certificate analysis results found in a firmware.

    :example: List cryptographic certificate analysis results found in a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CryptoCertificatesListByFirmware(ctx=self.ctx)()
    ...
    class CryptoCertificatesListByFirmware(AAZHttpOperation):

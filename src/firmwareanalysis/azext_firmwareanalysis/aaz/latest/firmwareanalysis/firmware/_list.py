...
@register_command(
    "firmwareanalysis firmware list",
    is_preview=True,
)
class List(AAZCommand):
    """List all the firmware images inside a workspace.

    :example: List all the firmware Images inside a workspace
        az firmwareanalysis firmware list --resource-group {resourceGroupName} --workspace-name {workspaceName}
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirmwareListByWorkspace(ctx=self.ctx)()
    ...
    class FirmwareListByWorkspace(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            status_messages = cls._schema_on_200.value.Element.properties.status_messages
            status_messages.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.status_messages.Element

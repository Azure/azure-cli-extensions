...
@register_command(
    "firmwareanalysis firmware generate-download-url",
    is_preview=True,
)
class GenerateDownloadUrl(AAZCommand):
    """Get a url for file download.

    :example: Get a url for file download.
        az firmwareanalysis firmware generate-download-url --resource-group {resourceGroupName} --workspace-name {workspaceName} --firmware-id {firmwareId}
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirmwareGenerateDownloadUrl(ctx=self.ctx)()
    ...
    class FirmwareGenerateDownloadUrl(AAZHttpOperation):
...
class _GenerateDownloadUrlHelper:
    """Helper class for GenerateDownloadUrl"""


__all__ = ["GenerateDownloadUrl"]

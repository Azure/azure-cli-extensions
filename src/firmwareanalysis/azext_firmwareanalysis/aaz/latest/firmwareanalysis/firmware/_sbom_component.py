...
@register_command(
    "firmwareanalysis firmware sbom-component",
    is_preview=True,
)
class SbomComponent(AAZCommand):
    """List all the sbom analysis results for a firmware.

    :example: List all the sbom analysis results for a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SbomComponentsListByFirmware(ctx=self.ctx)()
    ...
    class SbomComponentsListByFirmware(AAZHttpOperation):
...
class _SbomComponentHelper:
    """Helper class for SbomComponent"""


__all__ = ["SbomComponent"]

...
@register_command(
    "firmwareanalysis firmware show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a firmware.

    :example: Get a firmware
    ...
    class FirmwareGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            status_messages = cls._schema_on_200.properties.status_messages
            status_messages.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.status_messages.Element

...
@register_command(
    "firmwareanalysis firmware update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirmwaresGet(ctx=self.ctx)()
    ...
    class FirmwaresGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_firmware_read(cls._schema_on_200)
    ...
    class FirmwaresCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_firmware_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_firmware_read = None

    @classmethod
    def _build_schema_firmware_read(cls, _schema):
        if cls._schema_firmware_read is not None:
            _schema.id = cls._schema_firmware_read.id
            _schema.name = cls._schema_firmware_read.name
            _schema.properties = cls._schema_firmware_read.properties
            _schema.system_data = cls._schema_firmware_read.system_data
            _schema.type = cls._schema_firmware_read.type
            return

        cls._schema_firmware_read = _schema_firmware_read = AAZObjectType()

        firmware_read = _schema_firmware_read
        firmware_read.id = AAZStrType(
            flags={"read_only": True},
        )
        firmware_read.name = AAZStrType(
            flags={"read_only": True},
        )
        firmware_read.properties = AAZObjectType()
        firmware_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        firmware_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_firmware_read.properties
        ...
        status_messages = _schema_firmware_read.properties.status_messages
        status_messages.Element = AAZObjectType()

        _element = _schema_firmware_read.properties.status_messages.Element
        _element.error_code = AAZIntType(
            serialized_name="errorCode",
        )
        _element.message = AAZStrType()

        system_data = _schema_firmware_read.system_data

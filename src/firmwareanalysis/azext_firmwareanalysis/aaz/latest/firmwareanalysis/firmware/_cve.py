...
@register_command(
    "firmwareanalysis firmware cve",
    is_preview=True,
)
class Cve(AAZCommand):
    """List all the cve analysis results for a firmware.

    :example: List all the cve analysis results for a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CvesListByFirmware(ctx=self.ctx)()
    ...
    class CvesListByFirmware(AAZHttpOperation):

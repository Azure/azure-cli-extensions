...
@register_command(
    "firmwareanalysis firmware password-hash",
    is_preview=True,
)
class PasswordHash(AAZCommand):
    """List all the password hash analysis results for a firmware.

    :example: List all the password hash analysis results for a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PasswordHashesListByFirmware(ctx=self.ctx)()
    ...
    class PasswordHashesListByFirmware(AAZHttpOperation):
...
class _PasswordHashHelper:
    """Helper class for PasswordHash"""

...
class Create(AAZCommand):
    ...
    :example: Create a firmware.
        az firmwareanalysis firmware create --resource-group {resourceGroupName} --workspace-name {workspaceName} --file-name {fileName} --vendor {vendorName} --file-size {fileSize} --model {modelName} --version {version} --status {status} --status-message [<string>]
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirmwareCreate(ctx=self.ctx)()
    ...
    class FirmwareCreate(AAZHttpOperation):

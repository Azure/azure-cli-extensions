...
@register_command(
    "firmwareanalysis firmware binary-hardening",
    is_preview=True,
)
class BinaryHardening(AAZCommand):
    """List all the binary hardening analysis results for a firmware.

    :example: List all the binary hardening analysis results for a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BinaryHardeningListByFirmware(ctx=self.ctx)()
    ...
    class BinaryHardeningListByFirmware(AAZHttpOperation):
...
class _BinaryHardeningHelper:
    """Helper class for BinaryHardening"""


__all__ = ["BinaryHardening"]

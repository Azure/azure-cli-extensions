...
@register_command(
    "firmwareanalysis firmware crypto-key",
)
class CryptoKey(AAZCommand):
    """List cryptographic key analysis results found in a firmware.

    :example: List cryptographic key analysis results found in a firmware.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CryptoKeysListByFirmware(ctx=self.ctx)()
    ...
    class CryptoKeysListByFirmware(AAZHttpOperation):
...
class _CryptoKeyHelper:
    """Helper class for CryptoKey"""

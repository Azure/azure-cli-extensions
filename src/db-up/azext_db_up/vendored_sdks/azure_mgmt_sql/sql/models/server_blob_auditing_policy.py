...
class ServerBlobAuditingPolicy(ProxyResource):
    ...
    :param audit_actions_and_groups: Specifies the Actions-Groups and Actions
     ...
     Groups](https://learn.microsoft.com/sql/relational-databases/security/auditing/sql-server-audit-action-groups-and-actions#database-level-audit-action-groups).
     ...
     Actions](https://learn.microsoft.com/sql/relational-databases/security/auditing/sql-server-audit-action-groups-and-actions#database-level-audit-actions)

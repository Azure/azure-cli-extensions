...
class Delete(AAZCommand):
    ...
    :example: StoragePools_Delete
        az pscloud pool delete --resource-group rgpurestorage --storage-pool-name storagePoolname
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StoragePoolsDelete(ctx=self.ctx)()
    ...
    class StoragePoolsDelete(AAZHttpOperation):

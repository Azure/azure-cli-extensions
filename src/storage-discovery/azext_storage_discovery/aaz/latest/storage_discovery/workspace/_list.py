...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.StorageDiscoveryWorkspacesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.StorageDiscoveryWorkspacesListByResourceGroup(ctx=self.ctx)()
    ...
    class StorageDiscoveryWorkspacesListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.scopes.Element
            ...
            resource_types = cls._schema_on_200.value.Element.properties.scopes.Element.resource_types
            resource_types.Element = AAZStrType()

            tag_keys_only = cls._schema_on_200.value.Element.properties.scopes.Element.tag_keys_only
            tag_keys_only.Element = AAZStrType()

            tags = cls._schema_on_200.value.Element.properties.scopes.Element.tags
            tags.Element = AAZStrType()

            workspace_roots = cls._schema_on_200.value.Element.properties.workspace_roots
    ...
    class StorageDiscoveryWorkspacesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

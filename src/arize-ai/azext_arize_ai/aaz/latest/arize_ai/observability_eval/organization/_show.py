...
@register_command(
    "arize-ai observability-eval organization show",
)
class Show(AAZCommand):
    """Get a OrganizationResource

    :example: Get a Organization
        az arize-ai observability-eval organization show --resource-group yashika-rg-arize --organizationname test-org-1
    """
    ...
    class OrganizationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            partner_properties.description = AAZStrType(
                flags={"required": True},
            )

...
@register_command(
    "arize-ai observability-eval organization delete",
...
class Delete(AAZCommand):
    ...
    :example: Delete a Organization
        az arize-ai observability-eval organization delete --resource-group yashika-rg-arize --organizationname test-org-1
    """

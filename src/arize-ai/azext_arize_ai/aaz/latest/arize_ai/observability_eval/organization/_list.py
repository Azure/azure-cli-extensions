...
@register_command(
    "arize-ai observability-eval organization list",
)
class List(AAZCommand):
    """List OrganizationResource resources by resource group

    :example: Organizations_ListBySubscription - generated by [MaximumSet] rule
        az arize-ai observability-eval organization list --resource-group QM_clitest_qumulo2_eastus
    """
    ...
    class OrganizationsListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/ArizeAi.ObservabilityEval/organizations",
                **self.url_parameters
            )
    ...
    class OrganizationsListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/ArizeAi.ObservabilityEval/organizations",
                **self.url_parameters
            )

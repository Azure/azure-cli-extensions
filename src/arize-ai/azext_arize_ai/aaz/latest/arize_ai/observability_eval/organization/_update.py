...
@register_command(
    "arize-ai observability-eval organization update",
)
class Update(AAZCommand):
    """Update a OrganizationResource

    :example: Update a Organization
        az arize-ai observability-eval organization update --resource-group yashika-rg-arize --organizationname test-org-1 --tags key1=value1
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        partner_properties.description = AAZStrArg(
            options=["description"],
            help="Description of the Organization's purpose",
            fmt=AAZStrArgFormat(
                pattern="^[a-zA-Z0-9_\\-.:\\/ ]*$",
                max_length=200,
            ),
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if partner_properties is not None:
                partner_properties.set_prop("description", AAZStrType, ".description", typ_kwargs={"flags": {"required": True}})

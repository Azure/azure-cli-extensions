...
class List(AAZCommand):
    ...
    :example: List all AzureBareMetalStorage instances in a subscription
        az baremetalstorageinstance list

    :example: List all AzureBareMetalStorage instances in a subscription and resource group
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.AzureBareMetalStorageInstancesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.AzureBareMetalStorageInstancesListBySubscription(ctx=self.ctx)()
    ...
    class AzureBareMetalStorageInstancesListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            storage_properties = cls._schema_on_200.value.Element.properties.storage_properties
            ...
            storage_billing_properties = cls._schema_on_200.value.Element.properties.storage_properties.storage_billing_properties
    ...
    class AzureBareMetalStorageInstancesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
class Shutdown(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureBareMetalInstancesShutdown(ctx=self.ctx)()
    ...
    class AzureBareMetalInstancesShutdown(AAZHttpOperation):

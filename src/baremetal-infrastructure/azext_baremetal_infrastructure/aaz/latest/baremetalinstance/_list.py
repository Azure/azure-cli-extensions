...
class List(AAZCommand):
    ...
    :example: List all Azure Bare Metal Instances in a subscription
        az baremetalinstance list

    :example: List all Azure Bare Metal Instances in a subscription and resource group
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.AzureBareMetalInstancesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.AzureBareMetalInstancesListBySubscription(ctx=self.ctx)()
    ...
    class AzureBareMetalInstancesListByResourceGroup(AAZHttpOperation):
    ...
    class AzureBareMetalInstancesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

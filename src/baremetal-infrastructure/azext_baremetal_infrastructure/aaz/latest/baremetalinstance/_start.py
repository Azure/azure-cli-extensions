...
class Start(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureBareMetalInstancesStart(ctx=self.ctx)()
    ...
    class AzureBareMetalInstancesStart(AAZHttpOperation):

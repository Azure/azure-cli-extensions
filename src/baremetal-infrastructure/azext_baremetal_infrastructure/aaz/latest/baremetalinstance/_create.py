...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.hw_revision = AAZStrArg(
            options=["--hw-revision"],
            arg_group="Properties",
            help="Hardware revision of an Azure Bare Metal Instance",
        )
        _args_schema.network_profile = AAZObjectArg(
            options=["--network-profile"],
            arg_group="Properties",
            help="Specifies the network settings for the Azure Bare Metal Instance.",
        )
        ...
        network_profile.network_interfaces = AAZListArg(
            ...
            help="Specifies the network interfaces for the Azure Bare Metal Instance.",
        )
        ...
        os_profile.computer_name = AAZStrArg(
            ...
            help="Specifies the host OS name of the Azure Bare Metal instance.",
        )
        ...
        storage_profile.os_disks = AAZListArg(
            options=["os-disks"],
            help="Specifies information about the operating system disk used by bare metal instance.",
        )

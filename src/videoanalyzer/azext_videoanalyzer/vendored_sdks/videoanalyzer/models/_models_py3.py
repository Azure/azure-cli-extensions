...
from ._azure_video_analyzer_enums import *
...
class AccessPolicyEntity(Resource):
    ...
    :vartype system_data: ~azure_video_analyzer.models.SystemData
    :param role: Defines the access level granted by this policy. Possible values include:
     "Reader".
    :type role: str or ~azure_video_analyzer.models.AccessPolicyRole
    :param authentication: Authentication method to be used when validating client API access.
    :type authentication: ~azure_video_analyzer.models.AuthenticationBase
    """
...
class AccessPolicyEntityCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure_video_analyzer.models.AccessPolicyEntity]
...
class AccountEncryption(msrest.serialization.Model):
    ...
    :type type: str or ~azure_video_analyzer.models.AccountEncryptionKeyType
    :param key_vault_properties: The properties of the key used to encrypt the account.
    :type key_vault_properties: ~azure_video_analyzer.models.KeyVaultProperties
    :param identity: The Key Vault identity.
    :type identity: ~azure_video_analyzer.models.ResourceIdentity
...
class CheckNameAvailabilityResponse(msrest.serialization.Model):
    ...
    :type reason: str or ~azure_video_analyzer.models.CheckNameAvailabilityReason
...
class EccTokenKey(TokenKey):
    ...
    :type alg: str or ~azure_video_analyzer.models.AccessPolicyEccAlgo
...
class EdgeModuleEntityCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure_video_analyzer.models.EdgeModuleEntity]
    :param next_link: A link to the next page of the collection (when the collection contains too
     many results to return in one response).
    :type next_link: str
    """
...
class Endpoint(msrest.serialization.Model):
    ...
    :type type: str or ~azure_video_analyzer.models.VideoAnalyzerEndpointType
    """
...
class ErrorDetail(msrest.serialization.Model):
    ...
    :vartype details: list[~azure_video_analyzer.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure_video_analyzer.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :type error: ~azure_video_analyzer.models.ErrorDetail
    """
...
class JwtAuthentication(AuthenticationBase):
    ...
    :type claims: list[~azure_video_analyzer.models.TokenClaim]
    :param keys: List of keys which can be used to validate access tokens. Having multiple keys
     ...
     one key.
    :type keys: list[~azure_video_analyzer.models.TokenKey]
    """
...
class MetricSpecification(msrest.serialization.Model):
    ...
    :vartype unit: str or ~azure_video_analyzer.models.MetricUnit
    :ivar aggregation_type: The metric aggregation type. Possible values include: "Average",
     "Count", "Total".
    :vartype aggregation_type: str or ~azure_video_analyzer.models.MetricAggregationType
    :ivar lock_aggregation_type: The metric lock aggregation type. Possible values include:
     "Average", "Count", "Total".
    :vartype lock_aggregation_type: str or ~azure_video_analyzer.models.MetricAggregationType
    :param supported_aggregation_types: Supported aggregation types.
    :type supported_aggregation_types: list[str]
    :ivar dimensions: The metric dimensions.
    :vartype dimensions: list[~azure_video_analyzer.models.MetricDimension]
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~azure_video_analyzer.models.OperationDisplay
    :param origin: Origin of the operation.
    :type origin: str
    :param properties: Operation properties format.
    :type properties: ~azure_video_analyzer.models.Properties
    ...
    :type action_type: str or ~azure_video_analyzer.models.ActionType
    """
...
class OperationCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure_video_analyzer.models.Operation]
    """
...
class Properties(msrest.serialization.Model):
    ...
    :vartype service_specification: ~azure_video_analyzer.models.ServiceSpecification
    """
...
class RsaTokenKey(TokenKey):
    ...
    :param alg: Required. RSA algorithm to be used: RS256, RS384 or RS512. Possible values include:
     "RS256", "RS384", "RS512".
    :type alg: str or ~azure_video_analyzer.models.AccessPolicyRsaAlgo
...
class ServiceSpecification(msrest.serialization.Model):
    ...
    :vartype log_specifications: list[~azure_video_analyzer.models.LogSpecification]
    :ivar metric_specifications: List of metric specifications.
    :vartype metric_specifications: list[~azure_video_analyzer.models.MetricSpecification]
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or ~azure_video_analyzer.models.CreatedByType
    ...
    :type last_modified_by_type: str or ~azure_video_analyzer.models.CreatedByType
...
class VideoAnalyzer(TrackedResource):
    ...
    :type identity: ~azure_video_analyzer.models.VideoAnalyzerIdentity
    :param storage_accounts: The storage accounts for this resource.
    :type storage_accounts: list[~azure_video_analyzer.models.StorageAccount]
    :ivar endpoints: The list of endpoints associated with this resource.
    :vartype endpoints: list[~azure_video_analyzer.models.Endpoint]
    :param encryption: The account encryption properties.
    :type encryption: ~azure_video_analyzer.models.AccountEncryption
    """
...
class VideoAnalyzerCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure_video_analyzer.models.VideoAnalyzer]
    """
...
class VideoAnalyzerIdentity(msrest.serialization.Model):
    ...
    :type user_assigned_identities: dict[str,
     ~azure_video_analyzer.models.UserAssignedManagedIdentity]
    """
...
class VideoEntity(Resource):
    ...
    :vartype type_properties_type: str or ~azure_video_analyzer.models.VideoType
    ...
    :vartype flags: ~azure_video_analyzer.models.VideoFlags
    :ivar streaming: Video streaming holds information about video streaming URLs.
    :vartype streaming: ~azure_video_analyzer.models.VideoStreaming
    :ivar media_info: Contains information about the video and audio content.
    :vartype media_info: ~azure_video_analyzer.models.VideoMediaInfo
    """
...
class VideoEntityCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure_video_analyzer.models.VideoEntity]
    :param next_link: A link to the next page of the collection (when the collection contains too
     many results to return in one response).
    :type next_link: str
    """

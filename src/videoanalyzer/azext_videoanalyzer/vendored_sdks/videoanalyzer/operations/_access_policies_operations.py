...
class AccessPoliciesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.AccessPolicyEntityCollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AccessPolicyEntityCollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.AccessPolicyEntity"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AccessPolicyEntity"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        access_policy_name,  # type: str
        parameters,  # type: "models.AccessPolicyEntity"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AccessPolicyEntity"

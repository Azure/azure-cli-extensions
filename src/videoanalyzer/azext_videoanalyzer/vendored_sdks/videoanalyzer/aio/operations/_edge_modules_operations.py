...
class EdgeModulesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_video_analyzer.models.EdgeModuleEntityCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EdgeModuleEntityCollection"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure_video_analyzer.models.EdgeModuleEntity
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EdgeModuleEntity"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type parameters: ~azure_video_analyzer.models.EdgeModuleEntity
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EdgeModuleEntity, or the result of cls(response)
        :rtype: ~azure_video_analyzer.models.EdgeModuleEntity
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def list_provisioning_token(
        ...
        **kwargs
        ...
        :type edge_module_name: str
        :param parameters: The request parameters.
        :type parameters: ~azure_video_analyzer.models.ListProvisioningTokenInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EdgeModuleProvisioningToken, or the result of cls(response)
        :rtype: ~azure_video_analyzer.models.EdgeModuleProvisioningToken
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EdgeModuleProvisioningToken"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

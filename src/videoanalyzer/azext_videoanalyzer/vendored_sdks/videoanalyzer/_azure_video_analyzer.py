...
class AzureVideoAnalyzer(object):
    ...
    :vartype operations: azure_video_analyzer.operations.Operations
    :ivar video_analyzers: VideoAnalyzersOperations operations
    :vartype video_analyzers: azure_video_analyzer.operations.VideoAnalyzersOperations
    :ivar locations: LocationsOperations operations
    :vartype locations: azure_video_analyzer.operations.LocationsOperations
    :ivar edge_modules: EdgeModulesOperations operations
    :vartype edge_modules: azure_video_analyzer.operations.EdgeModulesOperations
    :ivar videos: VideosOperations operations
    :vartype videos: azure_video_analyzer.operations.VideosOperations
    :ivar access_policies: AccessPoliciesOperations operations
    :vartype access_policies: azure_video_analyzer.operations.AccessPoliciesOperations

...
class Create(AAZCommand):
    ...
    :example: Create a firewall rule.
        az documentdb mongocluster firewall-rule create -n AllowOffice --cluster-name MyCluster -g MyResourceGroup --start-ip-address 1.2.3.4 --end-ip-address 1.2.3.9
    """

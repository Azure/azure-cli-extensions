...
class Update(AAZCommand):
    ...
    :example: Update a firewall rule's IP range.
        az documentdb mongocluster firewall-rule update -n AllowOffice --cluster-name MyCluster -g MyResourceGroup --end-ip-address 1.2.3.20
    """

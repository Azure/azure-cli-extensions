...
class List(AAZCommand):
    ...
    :example: List all mongo clusters in a resource group.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.MongoClustersList(ctx=self.ctx)()
        if condition_1:
            self.MongoClustersListByResourceGroup(ctx=self.ctx)()
    ...
    class MongoClustersList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            auth_config = cls._schema_on_200.value.Element.properties.auth_config
            auth_config.allowed_modes = AAZListType(
                serialized_name="allowedModes",
            )

            allowed_modes = cls._schema_on_200.value.Element.properties.auth_config.allowed_modes
            ...
            data_api = cls._schema_on_200.value.Element.properties.data_api
            ...
            replica_parameters = cls._schema_on_200.value.Element.properties.replica_parameters
            ...
            restore_parameters = cls._schema_on_200.value.Element.properties.restore_parameters
    ...
    class MongoClustersListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

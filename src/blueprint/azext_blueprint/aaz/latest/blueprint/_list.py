...
class List(AAZCommand):
    ...
    :example: List blueprints in a management group
        az blueprint list --management-group MyManagementGroup

    :example: List blueprints in a subscription
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BlueprintsList(ctx=self.ctx)()
    ...
    class BlueprintsList(AAZHttpOperation):

...
class Delete(AAZCommand):
    ...
    :example: Delete a published subscription blueprint
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PublishedBlueprintsDelete(ctx=self.ctx)()
    ...
    class PublishedBlueprintsDelete(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _DeleteHelper._build_schema_parameter_definition_metadata_read(_element.metadata)

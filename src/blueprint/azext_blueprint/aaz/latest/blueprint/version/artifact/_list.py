...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PublishedArtifactsList(ctx=self.ctx)()
    ...
    class PublishedArtifactsList(AAZHttpOperation):

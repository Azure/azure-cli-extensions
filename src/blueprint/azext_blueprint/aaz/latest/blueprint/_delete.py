...
class Delete(AAZCommand):
    ...
    :example: Delete a management group blueprint
        az blueprint delete --management-group MyManagementGroup --name MyBlueprint

    :example: Delete a subscription blueprint
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BlueprintsDelete(ctx=self.ctx)()
    ...
    class BlueprintsDelete(AAZHttpOperation):

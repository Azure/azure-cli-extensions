...
@register_command(
    "blueprint assignment who",
    is_preview=True,
)
class Who(AAZCommand):
    """Get Blueprint Servie Principal Name objectId.

    :example: Get SPN objectId
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AssignmentsWhoIsBlueprint(ctx=self.ctx)()
    ...
    class AssignmentsWhoIsBlueprint(AAZHttpOperation):

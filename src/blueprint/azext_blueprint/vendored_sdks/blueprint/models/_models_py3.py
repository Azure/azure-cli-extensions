...
class ArtifactPropertiesBase(Model):
    ...
    def __init__(self, *, depends_on=None, **kwargs) -> None:
...
class BlueprintResourcePropertiesBase(Model):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, **kwargs) -> None:
...
class ParameterDefinition(Model):
    ...
    def __init__(self, *, type, display_name: str=None, description: str=None, strong_type: str=None, default_value=None, allowed_values=None, **kwargs) -> None:
...
class ParameterValue(Model):
    ...
    :param value: Parameter value as value type.
    :type value: object
    ...
    def __init__(self, *, value=None, reference=None, **kwargs) -> None:
...
class RoleAssignmentArtifact(Artifact):
    ...
    def __init__(self, *, role_definition_id: str, principal_ids, display_name: str=None, description: str=None, depends_on=None, resource_group: str=None, **kwargs) -> None:
...
class SharedBlueprintProperties(BlueprintResourcePropertiesBase):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, target_scope=None, parameters=None, resource_groups=None, **kwargs) -> None:

...
class AssignmentOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of AssignmentOperation
        :rtype:
         ~azure.mgmt.blueprint.models.AssignmentOperationPaged[~azure.mgmt.blueprint.models.AssignmentOperation]
        ...
        if raw:
            header_dict = {}
        deserialized = models.AssignmentOperationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AssignmentOperation or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.blueprint.models.AssignmentOperation or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AssignmentOperation', response)

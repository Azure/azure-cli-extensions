...
class GenerateOperation(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProviderRegistrationsGenerateOperations(ctx=self.ctx)()
    ...
    class ProviderRegistrationsGenerateOperations(AAZHttpOperation):
...
class _GenerateOperationHelper:
    """Helper class for GenerateOperation"""


__all__ = ["GenerateOperation"]

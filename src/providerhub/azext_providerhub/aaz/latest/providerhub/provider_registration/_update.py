...
class Update(AAZCommand):
    ...
    :example: provider-registration update
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_resource_provider_endpoint_update(global_notification_endpoints.Element)
        ...
        cls._build_args_resource_provider_endpoint_update(endpoints.Element)
        ...
        cls._build_args_resource_provider_authorization_update(provider_authorizations.Element)
    ...
    _args_resource_provider_authorization_update = None

    @classmethod
    def _build_args_resource_provider_authorization_update(cls, _schema):
        if cls._args_resource_provider_authorization_update is not None:
            _schema.allowed_third_party_extensions = cls._args_resource_provider_authorization_update.allowed_third_party_extensions
            _schema.application_id = cls._args_resource_provider_authorization_update.application_id
            _schema.grouping_tag = cls._args_resource_provider_authorization_update.grouping_tag
            _schema.managed_by_authorization = cls._args_resource_provider_authorization_update.managed_by_authorization
            _schema.managed_by_role_definition_id = cls._args_resource_provider_authorization_update.managed_by_role_definition_id
            _schema.role_definition_id = cls._args_resource_provider_authorization_update.role_definition_id
            return

        cls._args_resource_provider_authorization_update = AAZObjectArg(
            nullable=True,
        )

        resource_provider_authorization_update = cls._args_resource_provider_authorization_update
        resource_provider_authorization_update.allowed_third_party_extensions = AAZListArg(
            options=["allowed-third-party-extensions"],
            nullable=True,
        )
        resource_provider_authorization_update.application_id = AAZStrArg(
            options=["application-id"],
            nullable=True,
        )
        resource_provider_authorization_update.grouping_tag = AAZStrArg(
            options=["grouping-tag"],
            nullable=True,
        )
        resource_provider_authorization_update.managed_by_authorization = AAZObjectArg(
            options=["managed-by-authorization"],
            help="Managed by authorization.",
            nullable=True,
        )
        resource_provider_authorization_update.managed_by_role_definition_id = AAZStrArg(
            options=["managed-by-role-definition-id"],
            nullable=True,
        )
        resource_provider_authorization_update.role_definition_id = AAZStrArg(
            options=["role-definition-id"],
            nullable=True,
        )

        allowed_third_party_extensions = cls._args_resource_provider_authorization_update.allowed_third_party_extensions
        allowed_third_party_extensions.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_resource_provider_authorization_update.allowed_third_party_extensions.Element
        ...
        managed_by_authorization = cls._args_resource_provider_authorization_update.managed_by_authorization
        ...
        additional_authorizations = cls._args_resource_provider_authorization_update.managed_by_authorization.additional_authorizations
        additional_authorizations.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_resource_provider_authorization_update.managed_by_authorization.additional_authorizations.Element
    ...
    _args_resource_provider_endpoint_update = None

    @classmethod
    def _build_args_resource_provider_endpoint_update(cls, _schema):
        if cls._args_resource_provider_endpoint_update is not None:
            _schema.api_versions = cls._args_resource_provider_endpoint_update.api_versions
            _schema.enabled = cls._args_resource_provider_endpoint_update.enabled
            _schema.endpoint_type = cls._args_resource_provider_endpoint_update.endpoint_type
            _schema.endpoint_uri = cls._args_resource_provider_endpoint_update.endpoint_uri
            _schema.features_rule = cls._args_resource_provider_endpoint_update.features_rule
            _schema.locations = cls._args_resource_provider_endpoint_update.locations
            _schema.required_features = cls._args_resource_provider_endpoint_update.required_features
            _schema.sku_link = cls._args_resource_provider_endpoint_update.sku_link
            _schema.timeout = cls._args_resource_provider_endpoint_update.timeout
            return

        cls._args_resource_provider_endpoint_update = AAZObjectArg(
            nullable=True,
        )

        resource_provider_endpoint_update = cls._args_resource_provider_endpoint_update
        resource_provider_endpoint_update.api_versions = AAZListArg(
            options=["api-versions"],
            nullable=True,
        )
        resource_provider_endpoint_update.enabled = AAZBoolArg(
            options=["enabled"],
            nullable=True,
        )
        resource_provider_endpoint_update.endpoint_type = AAZStrArg(
            options=["endpoint-type"],
            nullable=True,
            enum={"Canary": "Canary", "NotSpecified": "NotSpecified", "Production": "Production", "TestInProduction": "TestInProduction"},
        )
        resource_provider_endpoint_update.endpoint_uri = AAZStrArg(
            options=["endpoint-uri"],
            nullable=True,
        )
        resource_provider_endpoint_update.features_rule = AAZObjectArg(
            options=["features-rule"],
            nullable=True,
        )
        resource_provider_endpoint_update.locations = AAZListArg(
            options=["locations"],
            nullable=True,
        )
        resource_provider_endpoint_update.required_features = AAZListArg(
            options=["required-features"],
            nullable=True,
        )
        resource_provider_endpoint_update.sku_link = AAZStrArg(
            options=["sku-link"],
            nullable=True,
        )
        resource_provider_endpoint_update.timeout = AAZDurationArg(
            options=["timeout"],
            nullable=True,
        )

        api_versions = cls._args_resource_provider_endpoint_update.api_versions
        api_versions.Element = AAZStrArg(
            nullable=True,
        )

        features_rule = cls._args_resource_provider_endpoint_update.features_rule
        features_rule.required_features_policy = AAZStrArg(
            options=["required-features-policy"],
            enum={"All": "All", "Any": "Any"},
        )

        locations = cls._args_resource_provider_endpoint_update.locations
        locations.Element = AAZStrArg(
            nullable=True,
        )

        required_features = cls._args_resource_provider_endpoint_update.required_features
        required_features.Element = AAZStrArg(
            nullable=True,
        )
    ...
    class ProviderRegistrationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_provider_registration_read(cls._schema_on_200)
    ...
    class ProviderRegistrationsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_provider_registration_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_resource_provider_authorization_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_resource_provider_endpoint_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_provider_registration_read = None

    @classmethod
    def _build_schema_provider_registration_read(cls, _schema):
        if cls._schema_provider_registration_read is not None:
            _schema.id = cls._schema_provider_registration_read.id
            _schema.kind = cls._schema_provider_registration_read.kind
            _schema.name = cls._schema_provider_registration_read.name
            _schema.properties = cls._schema_provider_registration_read.properties
            _schema.system_data = cls._schema_provider_registration_read.system_data
            _schema.type = cls._schema_provider_registration_read.type
            return

        cls._schema_provider_registration_read = _schema_provider_registration_read = AAZObjectType()

        provider_registration_read = _schema_provider_registration_read
        provider_registration_read.id = AAZStrType(
            flags={"read_only": True},
        )
        provider_registration_read.kind = AAZStrType()
        provider_registration_read.name = AAZStrType(
            flags={"read_only": True},
        )
        provider_registration_read.properties = AAZObjectType()
        provider_registration_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        provider_registration_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_provider_registration_read.properties
        ...
        capabilities = _schema_provider_registration_read.properties.capabilities
        capabilities.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.capabilities.Element
        ...
        required_features = _schema_provider_registration_read.properties.capabilities.Element.required_features
        required_features.Element = AAZStrType()

        dsts_configuration = _schema_provider_registration_read.properties.dsts_configuration
        ...
        features_rule = _schema_provider_registration_read.properties.features_rule
        features_rule.required_features_policy = AAZStrType(
            serialized_name="requiredFeaturesPolicy",
            flags={"required": True},
        )

        global_notification_endpoints = _schema_provider_registration_read.properties.global_notification_endpoints
        ...
        _element = _schema_provider_registration_read.properties.linked_notification_rules.Element
        ...
        actions = _schema_provider_registration_read.properties.linked_notification_rules.Element.actions
        actions.Element = AAZStrType()

        dsts_configuration = _schema_provider_registration_read.properties.linked_notification_rules.Element.dsts_configuration
        dsts_configuration.service_dns_name = AAZStrType(
            serialized_name="serviceDnsName",
        )
        dsts_configuration.service_name = AAZStrType(
        ...
        endpoints = _schema_provider_registration_read.properties.linked_notification_rules.Element.endpoints
        endpoints.Element = AAZObjectType()
        cls._build_schema_resource_provider_endpoint_read(endpoints.Element)

        management = _schema_provider_registration_read.properties.management
        ...
        authorization_owners = _schema_provider_registration_read.properties.management.authorization_owners
        authorization_owners.Element = AAZStrType()

        canary_manifest_owners = _schema_provider_registration_read.properties.management.canary_manifest_owners
        canary_manifest_owners.Element = AAZStrType()

        error_response_message_options = _schema_provider_registration_read.properties.management.error_response_message_options
        ...
        expedited_rollout_metadata = _schema_provider_registration_read.properties.management.expedited_rollout_metadata
        ...
        resource_access_roles = _schema_provider_registration_read.properties.management.resource_access_roles
        resource_access_roles.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.management.resource_access_roles.Element
        _element.actions = AAZListType()
        _element.allowed_group_claims = AAZListType(
            serialized_name="allowedGroupClaims",
        )

        actions = _schema_provider_registration_read.properties.management.resource_access_roles.Element.actions
        actions.Element = AAZStrType()

        allowed_group_claims = _schema_provider_registration_read.properties.management.resource_access_roles.Element.allowed_group_claims
        allowed_group_claims.Element = AAZStrType()

        schema_owners = _schema_provider_registration_read.properties.management.schema_owners
        schema_owners.Element = AAZStrType()

        service_tree_infos = _schema_provider_registration_read.properties.management.service_tree_infos
        service_tree_infos.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.management.service_tree_infos.Element
        ...
        subscriber_settings = _schema_provider_registration_read.properties.notification_settings.subscriber_settings
        subscriber_settings.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.notification_settings.subscriber_settings.Element
        _element.filter_rules = AAZListType(
            serialized_name="filterRules",
        )

        filter_rules = _schema_provider_registration_read.properties.notification_settings.subscriber_settings.Element.filter_rules
        filter_rules.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.notification_settings.subscriber_settings.Element.filter_rules.Element
        ...
        endpoint_information = _schema_provider_registration_read.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information
        endpoint_information.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information.Element
        ...
        notifications = _schema_provider_registration_read.properties.notifications
        notifications.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.notifications.Element
        ...
        optional_features = _schema_provider_registration_read.properties.optional_features
        optional_features.Element = AAZStrType()

        private_resource_provider_configuration = _schema_provider_registration_read.properties.private_resource_provider_configuration
        private_resource_provider_configuration.allowed_subscriptions = AAZListType(
            serialized_name="allowedSubscriptions",
        )

        allowed_subscriptions = _schema_provider_registration_read.properties.private_resource_provider_configuration.allowed_subscriptions
        allowed_subscriptions.Element = AAZStrType()

        provider_authentication = _schema_provider_registration_read.properties.provider_authentication
        provider_authentication.allowed_audiences = AAZListType(
            serialized_name="allowedAudiences",
            flags={"required": True},
        )

        allowed_audiences = _schema_provider_registration_read.properties.provider_authentication.allowed_audiences
        allowed_audiences.Element = AAZStrType()

        provider_authorizations = _schema_provider_registration_read.properties.provider_authorizations
        ...
        provider_hub_metadata = _schema_provider_registration_read.properties.provider_hub_metadata
        ...
        provider_authentication = _schema_provider_registration_read.properties.provider_hub_metadata.provider_authentication
        provider_authentication.allowed_audiences = AAZListType(
            serialized_name="allowedAudiences",
            flags={"required": True},
        )

        allowed_audiences = _schema_provider_registration_read.properties.provider_hub_metadata.provider_authentication.allowed_audiences
        allowed_audiences.Element = AAZStrType()

        provider_authorizations = _schema_provider_registration_read.properties.provider_hub_metadata.provider_authorizations
        provider_authorizations.Element = AAZObjectType()
        cls._build_schema_resource_provider_authorization_read(provider_authorizations.Element)

        third_party_provider_authorization = _schema_provider_registration_read.properties.provider_hub_metadata.third_party_provider_authorization
        ...
        authorizations = _schema_provider_registration_read.properties.provider_hub_metadata.third_party_provider_authorization.authorizations
        authorizations.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.provider_hub_metadata.third_party_provider_authorization.authorizations.Element
        ...
        request_header_options = _schema_provider_registration_read.properties.request_header_options
        ...
        required_features = _schema_provider_registration_read.properties.required_features
        required_features.Element = AAZStrType()

        resource_group_lock_option_during_move = _schema_provider_registration_read.properties.resource_group_lock_option_during_move
        resource_group_lock_option_during_move.block_action_verb = AAZStrType(
            serialized_name="blockActionVerb",
        )

        resource_hydration_accounts = _schema_provider_registration_read.properties.resource_hydration_accounts
        resource_hydration_accounts.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.resource_hydration_accounts.Element
        ...
        resource_provider_authorization_rules = _schema_provider_registration_read.properties.resource_provider_authorization_rules
        ...
        async_operation_polling_rules = _schema_provider_registration_read.properties.resource_provider_authorization_rules.async_operation_polling_rules
        ...
        authorization_actions = _schema_provider_registration_read.properties.resource_provider_authorization_rules.async_operation_polling_rules.authorization_actions
        authorization_actions.Element = AAZStrType()

        response_options = _schema_provider_registration_read.properties.response_options
        response_options.service_client_options_type = AAZStrType(
            serialized_name="serviceClientOptionsType",
        )

        services = _schema_provider_registration_read.properties.services
        services.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.services.Element
        _element.service_name = AAZStrType(
            serialized_name="serviceName",
        )
        _element.status = AAZStrType()

        subscription_lifecycle_notification_specifications = _schema_provider_registration_read.properties.subscription_lifecycle_notification_specifications
        ...
        subscription_state_override_actions = _schema_provider_registration_read.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions
        subscription_state_override_actions.Element = AAZObjectType()

        _element = _schema_provider_registration_read.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions.Element
        ...
        template_deployment_options = _schema_provider_registration_read.properties.template_deployment_options
        ...
        preflight_options = _schema_provider_registration_read.properties.template_deployment_options.preflight_options
        preflight_options.Element = AAZStrType()

        system_data = _schema_provider_registration_read.system_data

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProviderRegistrationsList(ctx=self.ctx)()
    ...
    class ProviderRegistrationsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_token_auth_configuration_read(properties.token_auth_configuration)
            ...
            required_features = cls._schema_on_200.value.Element.properties.capabilities.Element.required_features
            required_features.Element = AAZStrType()

            dsts_configuration = cls._schema_on_200.value.Element.properties.dsts_configuration
            ...
            features_rule = cls._schema_on_200.value.Element.properties.features_rule
            features_rule.required_features_policy = AAZStrType(
                serialized_name="requiredFeaturesPolicy",
                flags={"required": True},
            )

            global_notification_endpoints = cls._schema_on_200.value.Element.properties.global_notification_endpoints
            global_notification_endpoints.Element = AAZObjectType()
            _ListHelper._build_schema_resource_provider_endpoint_read(global_notification_endpoints.Element)

            legacy_registrations = cls._schema_on_200.value.Element.properties.legacy_registrations
            legacy_registrations.Element = AAZStrType()

            lifecycle_info = cls._schema_on_200.value.Element.properties.lifecycle_info
            ...
            allowed_subscriptions = cls._schema_on_200.value.Element.properties.lifecycle_info.allowed_subscriptions
            allowed_subscriptions.Element = AAZStrType()

            linked_notification_rules = cls._schema_on_200.value.Element.properties.linked_notification_rules
            linked_notification_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element
            ...
            _ListHelper._build_schema_token_auth_configuration_read(_element.token_auth_configuration)

            actions = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.actions
            actions.Element = AAZStrType()

            dsts_configuration = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.dsts_configuration
            dsts_configuration.service_dns_name = AAZStrType(
                serialized_name="serviceDnsName",
            )
            dsts_configuration.service_name = AAZStrType(
            ...
            endpoints = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.endpoints
            endpoints.Element = AAZObjectType()
            _ListHelper._build_schema_resource_provider_endpoint_read(endpoints.Element)

            management = cls._schema_on_200.value.Element.properties.management
            ...
            authorization_owners = cls._schema_on_200.value.Element.properties.management.authorization_owners
            authorization_owners.Element = AAZStrType()

            canary_manifest_owners = cls._schema_on_200.value.Element.properties.management.canary_manifest_owners
            canary_manifest_owners.Element = AAZStrType()

            error_response_message_options = cls._schema_on_200.value.Element.properties.management.error_response_message_options
            ...
            expedited_rollout_metadata = cls._schema_on_200.value.Element.properties.management.expedited_rollout_metadata
            ...
            expedited_rollout_submitters = cls._schema_on_200.value.Element.properties.management.expedited_rollout_submitters
            expedited_rollout_submitters.Element = AAZStrType()

            feature_approval_claims = cls._schema_on_200.value.Element.properties.management.feature_approval_claims
            feature_approval_claims.Element = AAZStrType()

            feature_management_owners = cls._schema_on_200.value.Element.properties.management.feature_management_owners
            feature_management_owners.Element = AAZStrType()

            manifest_owners = cls._schema_on_200.value.Element.properties.management.manifest_owners
            manifest_owners.Element = AAZStrType()

            resource_access_roles = cls._schema_on_200.value.Element.properties.management.resource_access_roles
            resource_access_roles.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.management.resource_access_roles.Element
            _element.actions = AAZListType()
            _element.allowed_group_claims = AAZListType(
                serialized_name="allowedGroupClaims",
            )

            actions = cls._schema_on_200.value.Element.properties.management.resource_access_roles.Element.actions
            actions.Element = AAZStrType()

            allowed_group_claims = cls._schema_on_200.value.Element.properties.management.resource_access_roles.Element.allowed_group_claims
            allowed_group_claims.Element = AAZStrType()

            schema_owners = cls._schema_on_200.value.Element.properties.management.schema_owners
            schema_owners.Element = AAZStrType()

            service_tree_infos = cls._schema_on_200.value.Element.properties.management.service_tree_infos
            service_tree_infos.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.management.service_tree_infos.Element
            ...
            management_group_global_notification_endpoints = cls._schema_on_200.value.Element.properties.management_group_global_notification_endpoints
            management_group_global_notification_endpoints.Element = AAZObjectType()
            _ListHelper._build_schema_resource_provider_endpoint_read(management_group_global_notification_endpoints.Element)

            metadata = cls._schema_on_200.value.Element.properties.metadata
            metadata.Element = AAZAnyType()

            notification_settings = cls._schema_on_200.value.Element.properties.notification_settings
            notification_settings.subscriber_settings = AAZListType(
                serialized_name="subscriberSettings",
            )

            subscriber_settings = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings
            subscriber_settings.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings.Element
            _element.filter_rules = AAZListType(
                serialized_name="filterRules",
            )

            filter_rules = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings.Element.filter_rules
            filter_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings.Element.filter_rules.Element
            ...
            endpoint_information = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information
            endpoint_information.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information.Element
            ...
            optional_features = cls._schema_on_200.value.Element.properties.optional_features
            optional_features.Element = AAZStrType()

            private_resource_provider_configuration = cls._schema_on_200.value.Element.properties.private_resource_provider_configuration
            private_resource_provider_configuration.allowed_subscriptions = AAZListType(
                serialized_name="allowedSubscriptions",
            )

            allowed_subscriptions = cls._schema_on_200.value.Element.properties.private_resource_provider_configuration.allowed_subscriptions
            allowed_subscriptions.Element = AAZStrType()

            provider_authentication = cls._schema_on_200.value.Element.properties.provider_authentication
            provider_authentication.allowed_audiences = AAZListType(
                serialized_name="allowedAudiences",
                flags={"required": True},
            )

            allowed_audiences = cls._schema_on_200.value.Element.properties.provider_authentication.allowed_audiences
            allowed_audiences.Element = AAZStrType()

            provider_authorizations = cls._schema_on_200.value.Element.properties.provider_authorizations
            provider_authorizations.Element = AAZObjectType()
            _ListHelper._build_schema_resource_provider_authorization_read(provider_authorizations.Element)

            provider_hub_metadata = cls._schema_on_200.value.Element.properties.provider_hub_metadata
            ...
            provider_authentication = cls._schema_on_200.value.Element.properties.provider_hub_metadata.provider_authentication
            provider_authentication.allowed_audiences = AAZListType(
                serialized_name="allowedAudiences",
                flags={"required": True},
            )

            allowed_audiences = cls._schema_on_200.value.Element.properties.provider_hub_metadata.provider_authentication.allowed_audiences
            allowed_audiences.Element = AAZStrType()

            provider_authorizations = cls._schema_on_200.value.Element.properties.provider_hub_metadata.provider_authorizations
            provider_authorizations.Element = AAZObjectType()
            _ListHelper._build_schema_resource_provider_authorization_read(provider_authorizations.Element)

            third_party_provider_authorization = cls._schema_on_200.value.Element.properties.provider_hub_metadata.third_party_provider_authorization
            ...
            authorizations = cls._schema_on_200.value.Element.properties.provider_hub_metadata.third_party_provider_authorization.authorizations
            authorizations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.provider_hub_metadata.third_party_provider_authorization.authorizations.Element
            ...
            request_header_options = cls._schema_on_200.value.Element.properties.request_header_options
            ...
            required_features = cls._schema_on_200.value.Element.properties.required_features
            required_features.Element = AAZStrType()

            resource_group_lock_option_during_move = cls._schema_on_200.value.Element.properties.resource_group_lock_option_during_move
            resource_group_lock_option_during_move.block_action_verb = AAZStrType(
                serialized_name="blockActionVerb",
            )

            resource_hydration_accounts = cls._schema_on_200.value.Element.properties.resource_hydration_accounts
            resource_hydration_accounts.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_hydration_accounts.Element
            ...
            resource_provider_authorization_rules = cls._schema_on_200.value.Element.properties.resource_provider_authorization_rules
            ...
            async_operation_polling_rules = cls._schema_on_200.value.Element.properties.resource_provider_authorization_rules.async_operation_polling_rules
            ...
            authorization_actions = cls._schema_on_200.value.Element.properties.resource_provider_authorization_rules.async_operation_polling_rules.authorization_actions
            authorization_actions.Element = AAZStrType()

            response_options = cls._schema_on_200.value.Element.properties.response_options
            ...
            subscription_lifecycle_notification_specifications = cls._schema_on_200.value.Element.properties.subscription_lifecycle_notification_specifications
            ...
            subscription_state_override_actions = cls._schema_on_200.value.Element.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions
            subscription_state_override_actions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions.Element
            ...
            template_deployment_options = cls._schema_on_200.value.Element.properties.template_deployment_options
            ...
            preflight_options = cls._schema_on_200.value.Element.properties.template_deployment_options.preflight_options

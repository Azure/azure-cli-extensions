...
@register_command(
    "providerhub default-rollout list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DefaultRolloutsListByProviderRegistration(ctx=self.ctx)()
    ...
    class DefaultRolloutsListByProviderRegistration(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_system_data_read(provider_registration.system_data)
            ...
            _ListHelper._build_schema_notifications_read(properties.notifications)
            ...
            lifecycle_info = cls._schema_on_200.value.Element.properties.specification.provider_registration.properties.lifecycle_info
            ...
            allowed_subscriptions = cls._schema_on_200.value.Element.properties.specification.provider_registration.properties.lifecycle_info.allowed_subscriptions
            ...
            feature_approval_claims = cls._schema_on_200.value.Element.properties.specification.provider_registration.properties.management.feature_approval_claims
            feature_approval_claims.Element = AAZStrType()

            feature_management_owners = cls._schema_on_200.value.Element.properties.specification.provider_registration.properties.management.feature_management_owners
            ...
            _ListHelper._build_schema_resource_access_role_read(resource_access_roles.Element)
            ...
            _ListHelper._build_schema_service_tree_info_read(service_tree_infos.Element)
            ...
            metadata = cls._schema_on_200.value.Element.properties.specification.provider_registration.properties.metadata
            ...
            _ListHelper._build_schema_subscription_state_override_action_read(subscription_state_override_actions.Element)
            ...
            allowed_unauthorized_actions_extensions = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.allowed_unauthorized_actions_extensions
            allowed_unauthorized_actions_extensions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.allowed_unauthorized_actions_extensions.Element
            ...
            lifecycle_info = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.lifecycle_info
            lifecycle_info.lifecycle_stage = AAZStrType(
                serialized_name="lifecycleStage",
            )
            ...
            feature_approval_claims = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.management.feature_approval_claims
            feature_approval_claims.Element = AAZStrType()

            feature_management_owners = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.management.feature_management_owners
            feature_management_owners.Element = AAZStrType()
            ...
            _element = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.metadata.Element
            ...
            resource_deletion_policies = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies
            resource_deletion_policies.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies.Element
            _element.policy_name = AAZStrType(
                serialized_name="policyName",
            )
            _element.properties = AAZObjectType()

            properties = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies.Element.properties
            ...
            action_configurations = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.action_configurations
            action_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.action_configurations.Element
            ...
            required_features = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.required_features
            required_features.Element = AAZStrType()
            ...
            lifecycle_info = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.swagger_specifications.Element.lifecycle_info
            lifecycle_info.lifecycle_stage = AAZStrType(
                serialized_name="lifecycleStage",
            )
            ...
            write_lock = cls._schema_on_200.value.Element.properties.specification.resource_type_registrations.Element.properties.write_lock
            ...
            _ListHelper._build_schema_extended_error_info_read(failed_or_skipped_regions.Element)

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SkusListByResourceTypeRegistrationsNestedResourceTypeThird(ctx=self.ctx)()
    ...
    class SkusListByResourceTypeRegistrationsNestedResourceTypeThird(AAZHttpOperation):

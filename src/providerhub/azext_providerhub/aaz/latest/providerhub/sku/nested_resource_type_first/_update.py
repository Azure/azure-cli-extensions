...
@register_command(
    "providerhub sku nested-resource-type-first update",
)
class Update(AAZCommand):
    """Update the resource type skus in the given resource type.

    :example: sku nested-resource-type-first update
    ...
    def _execute_operations(self):
        ...
        self.SkusCreateOrUpdateNestedResourceTypeFirst(ctx=self.ctx)()

...
@register_command(
    "providerhub custom-rollout wait",
)
class Wait(AAZWaitCommand):
    ...
    class CustomRolloutsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_system_data_read(provider_registration.system_data)
            ...
            _WaitHelper._build_schema_notifications_read(properties.notifications)
            ...
            _WaitHelper._build_schema_resource_provider_authorization_rules_read(properties.resource_provider_authorization_rules)
            ...
            _WaitHelper._build_schema_resource_access_role_read(resource_access_roles.Element)
            ...
            _WaitHelper._build_schema_service_tree_info_read(service_tree_infos.Element)
            ...
            _WaitHelper._build_schema_subscription_state_override_action_read(subscription_state_override_actions.Element)
            ...
            completed_regions_info = cls._schema_on_200.properties.status.completed_regions_info
            completed_regions_info.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.status.completed_regions_info.Element
            ...
            _WaitHelper._build_schema_extended_error_info_read(failed_or_skipped_regions.Element)

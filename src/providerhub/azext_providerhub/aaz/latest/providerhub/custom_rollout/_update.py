...
@register_command(
    "providerhub custom-rollout update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_notifications_update(provider_registration.notifications)
        ...
        cls._build_args_resource_provider_authorization_rules_update(provider_registration.resource_provider_authorization_rules)
        ...
        cls._build_args_token_auth_configuration_update(provider_registration.token_auth_configuration)
        ...
        cls._build_args_resource_access_role_update(resource_access_roles.Element)
        ...
        cls._build_args_notifications_update(_element.notifications)
        ...
        cls._build_args_resource_provider_authorization_rules_update(_element.resource_provider_authorization_rules)
    ...
    _args_extended_error_info_update = None

    @classmethod
    def _build_args_extended_error_info_update(cls, _schema):
        if cls._args_extended_error_info_update is not None:
            _schema.additional_info = cls._args_extended_error_info_update.additional_info
            _schema.code = cls._args_extended_error_info_update.code
            _schema.details = cls._args_extended_error_info_update.details
            _schema.message = cls._args_extended_error_info_update.message
            _schema.target = cls._args_extended_error_info_update.target
            return

        cls._args_extended_error_info_update = AAZObjectArg(
            nullable=True,
        )

        extended_error_info_update = cls._args_extended_error_info_update
        extended_error_info_update.additional_info = AAZListArg(
            options=["additional-info"],
            help="The additional error information.",
            nullable=True,
        )
        extended_error_info_update.code = AAZStrArg(
            options=["code"],
            help="The error code.",
            nullable=True,
        )
        extended_error_info_update.details = AAZListArg(
            options=["details"],
            help="The error details.",
            nullable=True,
        )
        extended_error_info_update.message = AAZStrArg(
            options=["message"],
            help="The error message.",
            nullable=True,
        )
        extended_error_info_update.target = AAZStrArg(
            options=["target"],
            help="The target of the error.",
            nullable=True,
        )

        additional_info = cls._args_extended_error_info_update.additional_info
        additional_info.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_extended_error_info_update.additional_info.Element
        _element.type = AAZStrArg(
            options=["type"],
            help="The type of the error.",
        )

        details = cls._args_extended_error_info_update.details
        details.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_extended_error_info_update(details.Element)
    ...
    _args_notifications_update = None

    @classmethod
    def _build_args_notifications_update(cls, _schema):
        if cls._args_notifications_update is not None:
            _schema.Element = cls._args_notifications_update.Element
            return

        cls._args_notifications_update = AAZListArg(
            nullable=True,
        )

        notifications_update = cls._args_notifications_update
        notifications_update.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_notifications_update.Element
    ...
    _args_resource_access_role_update = None

    @classmethod
    def _build_args_resource_access_role_update(cls, _schema):
        if cls._args_resource_access_role_update is not None:
            _schema.actions = cls._args_resource_access_role_update.actions
            _schema.allowed_group_claims = cls._args_resource_access_role_update.allowed_group_claims
            return

        cls._args_resource_access_role_update = AAZObjectArg(
            nullable=True,
        )

        resource_access_role_update = cls._args_resource_access_role_update
        resource_access_role_update.actions = AAZListArg(
            options=["actions"],
            nullable=True,
        )
        ...
        actions = cls._args_resource_access_role_update.actions
        actions.Element = AAZStrArg(
            nullable=True,
        )

        allowed_group_claims = cls._args_resource_access_role_update.allowed_group_claims
    ...
    _args_resource_provider_authorization_rules_update = None

    @classmethod
    def _build_args_resource_provider_authorization_rules_update(cls, _schema):
        if cls._args_resource_provider_authorization_rules_update is not None:
            _schema.async_operation_polling_rules = cls._args_resource_provider_authorization_rules_update.async_operation_polling_rules
            return

        cls._args_resource_provider_authorization_rules_update = AAZObjectArg(
            nullable=True,
        )

        resource_provider_authorization_rules_update = cls._args_resource_provider_authorization_rules_update
        resource_provider_authorization_rules_update.async_operation_polling_rules = AAZObjectArg(
            options=["async-operation-polling-rules"],
            nullable=True,
        )

        async_operation_polling_rules = cls._args_resource_provider_authorization_rules_update.async_operation_polling_rules
        ...
        authorization_actions = cls._args_resource_provider_authorization_rules_update.async_operation_polling_rules.authorization_actions
    ...
    _args_subscription_state_override_action_update = None

    @classmethod
    def _build_args_subscription_state_override_action_update(cls, _schema):
        if cls._args_subscription_state_override_action_update is not None:
            _schema.action = cls._args_subscription_state_override_action_update.action
            _schema.state = cls._args_subscription_state_override_action_update.state
            return

        cls._args_subscription_state_override_action_update = AAZObjectArg(
            nullable=True,
        )

        subscription_state_override_action_update = cls._args_subscription_state_override_action_update
        subscription_state_override_action_update.action = AAZStrArg(
            options=["action"],
        ...
        subscription_state_override_action_update.state = AAZStrArg(
            options=["state"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomRolloutsGet(ctx=self.ctx)()
    ...
    class CustomRolloutsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_custom_rollout_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_notifications_update(properties.set_prop("notifications", AAZListType, ".notifications"))
            ...
            if resource_access_roles is not None:
                _UpdateHelper._build_schema_resource_access_role_update(resource_access_roles.set_elements(AAZObjectType, "."))
            ...
            if subscription_state_override_actions is not None:
                _UpdateHelper._build_schema_subscription_state_override_action_update(subscription_state_override_actions.set_elements(AAZObjectType, "."))
            ...
            if failed_or_skipped_regions is not None:
                _UpdateHelper._build_schema_extended_error_info_update(failed_or_skipped_regions.set_elements(AAZObjectType, "."))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_extended_error_info_update(cls, _builder):
        if _builder is None:
            return
        ...
        if details is not None:
            cls._build_schema_extended_error_info_update(details.set_elements(AAZObjectType, "."))

    @classmethod
    def _build_schema_notifications_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_resource_access_role_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_resource_provider_authorization_rules_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_subscription_state_override_action_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_custom_rollout_read = None

    @classmethod
    def _build_schema_custom_rollout_read(cls, _schema):
        if cls._schema_custom_rollout_read is not None:
            _schema.id = cls._schema_custom_rollout_read.id
            _schema.name = cls._schema_custom_rollout_read.name
            _schema.properties = cls._schema_custom_rollout_read.properties
            _schema.system_data = cls._schema_custom_rollout_read.system_data
            _schema.type = cls._schema_custom_rollout_read.type
            return

        cls._schema_custom_rollout_read = _schema_custom_rollout_read = AAZObjectType()

        custom_rollout_read = _schema_custom_rollout_read
        custom_rollout_read.id = AAZStrType(
            flags={"read_only": True},
        )
        custom_rollout_read.name = AAZStrType(
            flags={"read_only": True},
        )
        custom_rollout_read.properties = AAZObjectType(
            flags={"required": True},
        )
        custom_rollout_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        cls._build_schema_system_data_read(custom_rollout_read.system_data)
        custom_rollout_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_custom_rollout_read.properties
        ...
        specification = _schema_custom_rollout_read.properties.specification
        ...
        auto_provision_config = _schema_custom_rollout_read.properties.specification.auto_provision_config
        auto_provision_config.resource_graph = AAZBoolType(
            serialized_name="resourceGraph",
        )
        auto_provision_config.storage = AAZBoolType()

        canary = _schema_custom_rollout_read.properties.specification.canary
        canary.regions = AAZListType()

        regions = _schema_custom_rollout_read.properties.specification.canary.regions
        regions.Element = AAZStrType()

        manifest_checkin_specification = _schema_custom_rollout_read.properties.specification.manifest_checkin_specification
        ...
        manifest_checkin_params = _schema_custom_rollout_read.properties.specification.manifest_checkin_specification.manifest_checkin_params
        ...
        provider_registration = _schema_custom_rollout_read.properties.specification.provider_registration
        ...
        properties = _schema_custom_rollout_read.properties.specification.provider_registration.properties
        ...
        capabilities = _schema_custom_rollout_read.properties.specification.provider_registration.properties.capabilities
        capabilities.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.capabilities.Element
        ...
        required_features = _schema_custom_rollout_read.properties.specification.provider_registration.properties.capabilities.Element.required_features
        required_features.Element = AAZStrType()

        dsts_configuration = _schema_custom_rollout_read.properties.specification.provider_registration.properties.dsts_configuration
        ...
        features_rule = _schema_custom_rollout_read.properties.specification.provider_registration.properties.features_rule
        features_rule.required_features_policy = AAZStrType(
            serialized_name="requiredFeaturesPolicy",
            flags={"required": True},
        )

        global_notification_endpoints = _schema_custom_rollout_read.properties.specification.provider_registration.properties.global_notification_endpoints
        ...
        legacy_registrations = _schema_custom_rollout_read.properties.specification.provider_registration.properties.legacy_registrations
        legacy_registrations.Element = AAZStrType()

        lifecycle_info = _schema_custom_rollout_read.properties.specification.provider_registration.properties.lifecycle_info
        ...
        allowed_subscriptions = _schema_custom_rollout_read.properties.specification.provider_registration.properties.lifecycle_info.allowed_subscriptions
        allowed_subscriptions.Element = AAZStrType()

        linked_notification_rules = _schema_custom_rollout_read.properties.specification.provider_registration.properties.linked_notification_rules
        linked_notification_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.linked_notification_rules.Element
        ...
        actions = _schema_custom_rollout_read.properties.specification.provider_registration.properties.linked_notification_rules.Element.actions
        actions.Element = AAZStrType()

        dsts_configuration = _schema_custom_rollout_read.properties.specification.provider_registration.properties.linked_notification_rules.Element.dsts_configuration
        dsts_configuration.service_dns_name = AAZStrType(
            serialized_name="serviceDnsName",
        )
        dsts_configuration.service_name = AAZStrType(
        ...
        endpoints = _schema_custom_rollout_read.properties.specification.provider_registration.properties.linked_notification_rules.Element.endpoints
        endpoints.Element = AAZObjectType()
        cls._build_schema_resource_provider_endpoint_read(endpoints.Element)

        management = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management
        ...
        authorization_owners = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.authorization_owners
        authorization_owners.Element = AAZStrType()

        canary_manifest_owners = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.canary_manifest_owners
        canary_manifest_owners.Element = AAZStrType()

        error_response_message_options = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.error_response_message_options
        ...
        expedited_rollout_metadata = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.expedited_rollout_metadata
        ...
        expedited_rollout_submitters = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.expedited_rollout_submitters
        expedited_rollout_submitters.Element = AAZStrType()

        feature_approval_claims = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.feature_approval_claims
        feature_approval_claims.Element = AAZStrType()

        feature_management_owners = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.feature_management_owners
        feature_management_owners.Element = AAZStrType()

        manifest_owners = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.manifest_owners
        manifest_owners.Element = AAZStrType()

        resource_access_roles = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.resource_access_roles
        resource_access_roles.Element = AAZObjectType()
        cls._build_schema_resource_access_role_read(resource_access_roles.Element)

        schema_owners = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.schema_owners
        schema_owners.Element = AAZStrType()

        service_tree_infos = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management.service_tree_infos
        service_tree_infos.Element = AAZObjectType()
        cls._build_schema_service_tree_info_read(service_tree_infos.Element)

        management_group_global_notification_endpoints = _schema_custom_rollout_read.properties.specification.provider_registration.properties.management_group_global_notification_endpoints
        ...
        metadata = _schema_custom_rollout_read.properties.specification.provider_registration.properties.metadata
        metadata.Element = AAZAnyType()

        notification_settings = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings
        notification_settings.subscriber_settings = AAZListType(
            serialized_name="subscriberSettings",
        )

        subscriber_settings = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings
        subscriber_settings.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings.Element
        _element.filter_rules = AAZListType(
            serialized_name="filterRules",
        )

        filter_rules = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings.Element.filter_rules
        filter_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings.Element.filter_rules.Element
        ...
        endpoint_information = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information
        endpoint_information.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.notification_settings.subscriber_settings.Element.filter_rules.Element.endpoint_information.Element
        ...
        optional_features = _schema_custom_rollout_read.properties.specification.provider_registration.properties.optional_features
        optional_features.Element = AAZStrType()

        private_resource_provider_configuration = _schema_custom_rollout_read.properties.specification.provider_registration.properties.private_resource_provider_configuration
        private_resource_provider_configuration.allowed_subscriptions = AAZListType(
            serialized_name="allowedSubscriptions",
        )

        allowed_subscriptions = _schema_custom_rollout_read.properties.specification.provider_registration.properties.private_resource_provider_configuration.allowed_subscriptions
        allowed_subscriptions.Element = AAZStrType()

        provider_authentication = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_authentication
        provider_authentication.allowed_audiences = AAZListType(
            serialized_name="allowedAudiences",
            flags={"required": True},
        )

        allowed_audiences = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_authentication.allowed_audiences
        allowed_audiences.Element = AAZStrType()

        provider_authorizations = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_authorizations
        ...
        provider_hub_metadata = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata
        ...
        provider_authentication = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.provider_authentication
        provider_authentication.allowed_audiences = AAZListType(
            serialized_name="allowedAudiences",
            flags={"required": True},
        )

        allowed_audiences = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.provider_authentication.allowed_audiences
        allowed_audiences.Element = AAZStrType()

        provider_authorizations = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.provider_authorizations
        provider_authorizations.Element = AAZObjectType()
        cls._build_schema_resource_provider_authorization_read(provider_authorizations.Element)

        third_party_provider_authorization = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.third_party_provider_authorization
        ...
        authorizations = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.third_party_provider_authorization.authorizations
        authorizations.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.provider_hub_metadata.third_party_provider_authorization.authorizations.Element
        ...
        request_header_options = _schema_custom_rollout_read.properties.specification.provider_registration.properties.request_header_options
        ...
        required_features = _schema_custom_rollout_read.properties.specification.provider_registration.properties.required_features
        required_features.Element = AAZStrType()

        resource_group_lock_option_during_move = _schema_custom_rollout_read.properties.specification.provider_registration.properties.resource_group_lock_option_during_move
        resource_group_lock_option_during_move.block_action_verb = AAZStrType(
            serialized_name="blockActionVerb",
        )

        resource_hydration_accounts = _schema_custom_rollout_read.properties.specification.provider_registration.properties.resource_hydration_accounts
        resource_hydration_accounts.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.resource_hydration_accounts.Element
        ...
        response_options = _schema_custom_rollout_read.properties.specification.provider_registration.properties.response_options
        response_options.service_client_options_type = AAZStrType(
            serialized_name="serviceClientOptionsType",
        )

        services = _schema_custom_rollout_read.properties.specification.provider_registration.properties.services
        services.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.provider_registration.properties.services.Element
        _element.service_name = AAZStrType(
            serialized_name="serviceName",
        )
        _element.status = AAZStrType()

        subscription_lifecycle_notification_specifications = _schema_custom_rollout_read.properties.specification.provider_registration.properties.subscription_lifecycle_notification_specifications
        ...
        subscription_state_override_actions = _schema_custom_rollout_read.properties.specification.provider_registration.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions
        ...
        template_deployment_options = _schema_custom_rollout_read.properties.specification.provider_registration.properties.template_deployment_options
        ...
        preflight_options = _schema_custom_rollout_read.properties.specification.provider_registration.properties.template_deployment_options.preflight_options
        preflight_options.Element = AAZStrType()

        release_scopes = _schema_custom_rollout_read.properties.specification.release_scopes
        release_scopes.Element = AAZStrType()

        resource_type_registrations = _schema_custom_rollout_read.properties.specification.resource_type_registrations
        resource_type_registrations.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element
        ...
        properties = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties
        ...
        allowed_resource_names = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_resource_names
        allowed_resource_names.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_resource_names.Element
        _element.get_action_verb = AAZStrType(
            serialized_name="getActionVerb",
        )
        _element.name = AAZStrType()

        allowed_template_deployment_reference_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_template_deployment_reference_actions
        allowed_template_deployment_reference_actions.Element = AAZStrType()

        allowed_unauthorized_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_unauthorized_actions
        allowed_unauthorized_actions.Element = AAZStrType()

        allowed_unauthorized_actions_extensions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_unauthorized_actions_extensions
        allowed_unauthorized_actions_extensions.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.allowed_unauthorized_actions_extensions.Element
        _element.action = AAZStrType()
        _element.intent = AAZStrType()

        api_profiles = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.api_profiles
        api_profiles.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.api_profiles.Element
        ...
        async_timeout_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.async_timeout_rules
        async_timeout_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.async_timeout_rules.Element
        _element.action_name = AAZStrType(
            serialized_name="actionName",
        )
        _element.timeout = AAZStrType()

        authorization_action_mappings = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.authorization_action_mappings
        authorization_action_mappings.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.authorization_action_mappings.Element
        _element.desired = AAZStrType()
        _element.original = AAZStrType()

        availability_zone_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.availability_zone_rule
        availability_zone_rule.availability_zone_policy = AAZStrType(
            serialized_name="availabilityZonePolicy",
        )

        capacity_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.capacity_rule
        ...
        check_name_availability_specifications = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.check_name_availability_specifications
        ...
        resource_types_with_custom_validation = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.check_name_availability_specifications.resource_types_with_custom_validation
        resource_types_with_custom_validation.Element = AAZStrType()

        common_api_versions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.common_api_versions
        common_api_versions.Element = AAZStrType()

        disallowed_action_verbs = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.disallowed_action_verbs
        disallowed_action_verbs.Element = AAZStrType()

        disallowed_end_user_operations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.disallowed_end_user_operations
        disallowed_end_user_operations.Element = AAZStrType()

        dsts_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.dsts_configuration
        dsts_configuration.service_dns_name = AAZStrType(
            serialized_name="serviceDnsName",
        )
        dsts_configuration.service_name = AAZStrType(
        ...
        endpoints = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints
        endpoints.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element
        _element.api_version = AAZStrType(
            serialized_name="apiVersion",
        )
        ...
        api_versions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.api_versions
        api_versions.Element = AAZStrType()

        dsts_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.dsts_configuration
        dsts_configuration.service_dns_name = AAZStrType(
            serialized_name="serviceDnsName",
        )
        dsts_configuration.service_name = AAZStrType(
        ...
        extensions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.extensions
        extensions.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.extensions.Element
        _element.endpoint_uri = AAZStrType(
            serialized_name="endpointUri",
        )
        ...
        extension_categories = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.extensions.Element.extension_categories
        extension_categories.Element = AAZStrType()

        features_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.features_rule
        features_rule.required_features_policy = AAZStrType(
            serialized_name="requiredFeaturesPolicy",
            flags={"required": True},
        )

        locations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.locations
        locations.Element = AAZStrType()

        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.required_features
        required_features.Element = AAZStrType()

        zones = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.endpoints.Element.zones
        zones.Element = AAZStrType()

        extended_locations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extended_locations
        extended_locations.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extended_locations.Element
        _element.supported_policy = AAZStrType(
            serialized_name="supportedPolicy",
        )
        _element.type = AAZStrType()

        extension_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extension_options
        extension_options.resource_creation_begin = AAZObjectType(
            serialized_name="resourceCreationBegin",
        )

        resource_creation_begin = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extension_options.resource_creation_begin
        resource_creation_begin.request = AAZListType()
        resource_creation_begin.response = AAZListType()

        request = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extension_options.resource_creation_begin.request
        request.Element = AAZStrType()

        response = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.extension_options.resource_creation_begin.response
        response.Element = AAZStrType()

        features_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.features_rule
        features_rule.required_features_policy = AAZStrType(
            serialized_name="requiredFeaturesPolicy",
            flags={"required": True},
        )

        identity_management = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.identity_management
        ...
        application_ids = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.identity_management.application_ids
        application_ids.Element = AAZStrType()

        delegation_app_ids = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.identity_management.delegation_app_ids
        delegation_app_ids.Element = AAZStrType()

        legacy_names = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_names
        legacy_names.Element = AAZStrType()

        legacy_policy = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_policy
        ...
        disallowed_conditions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_policy.disallowed_conditions
        disallowed_conditions.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_policy.disallowed_conditions.Element
        _element.disallowed_legacy_operations = AAZListType(
            serialized_name="disallowedLegacyOperations",
        )
        _element.feature = AAZStrType()

        disallowed_legacy_operations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_policy.disallowed_conditions.Element.disallowed_legacy_operations
        disallowed_legacy_operations.Element = AAZStrType()

        disallowed_legacy_operations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.legacy_policy.disallowed_legacy_operations
        disallowed_legacy_operations.Element = AAZStrType()

        lifecycle_info = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.lifecycle_info
        lifecycle_info.lifecycle_stage = AAZStrType(
            serialized_name="lifecycleStage",
        )

        linked_access_checks = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_access_checks
        linked_access_checks.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_access_checks.Element
        _element.action_name = AAZStrType(
            serialized_name="actionName",
        )
        ...
        linked_notification_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules
        linked_notification_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules.Element
        _element.actions = AAZListType()
        ...
        actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules.Element.actions
        actions.Element = AAZStrType()

        actions_on_failed_operation = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules.Element.actions_on_failed_operation
        actions_on_failed_operation.Element = AAZStrType()

        fast_path_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules.Element.fast_path_actions
        fast_path_actions.Element = AAZStrType()

        fast_path_actions_on_failed_operation = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_notification_rules.Element.fast_path_actions_on_failed_operation
        fast_path_actions_on_failed_operation.Element = AAZStrType()

        linked_operation_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_operation_rules
        linked_operation_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_operation_rules.Element
        ...
        depends_on_types = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.linked_operation_rules.Element.depends_on_types
        depends_on_types.Element = AAZStrType()

        logging_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.logging_rules
        logging_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.logging_rules.Element
        _element.action = AAZStrType(
            flags={"required": True},
        )
        ...
        hidden_property_paths = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.logging_rules.Element.hidden_property_paths
        ...
        hidden_paths_on_request = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.logging_rules.Element.hidden_property_paths.hidden_paths_on_request
        hidden_paths_on_request.Element = AAZStrType()

        hidden_paths_on_response = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.logging_rules.Element.hidden_property_paths.hidden_paths_on_response
        hidden_paths_on_response.Element = AAZStrType()

        managed_resource_group_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.managed_resource_group_configuration
        ...
        deny_assignment_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.managed_resource_group_configuration.deny_assignment_configuration
        ...
        not_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.managed_resource_group_configuration.deny_assignment_configuration.not_actions
        not_actions.Element = AAZStrType()

        management = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management
        management.authorization_owners = AAZListType(
            serialized_name="authorizationOwners",
        )
        management.canary_manifest_owners = AAZListType(
        ...
        authorization_owners = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.authorization_owners
        authorization_owners.Element = AAZStrType()

        canary_manifest_owners = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.canary_manifest_owners
        canary_manifest_owners.Element = AAZStrType()

        error_response_message_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.error_response_message_options
        error_response_message_options.server_failure_response_message_type = AAZStrType(
            serialized_name="serverFailureResponseMessageType",
        )

        expedited_rollout_metadata = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.expedited_rollout_metadata
        expedited_rollout_metadata.enabled = AAZBoolType()
        expedited_rollout_metadata.expedited_rollout_intent = AAZStrType(
            serialized_name="expeditedRolloutIntent",
        )

        expedited_rollout_submitters = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.expedited_rollout_submitters
        expedited_rollout_submitters.Element = AAZStrType()

        feature_approval_claims = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.feature_approval_claims
        feature_approval_claims.Element = AAZStrType()

        feature_management_owners = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.feature_management_owners
        feature_management_owners.Element = AAZStrType()

        manifest_owners = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.manifest_owners
        manifest_owners.Element = AAZStrType()

        resource_access_roles = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.resource_access_roles
        resource_access_roles.Element = AAZObjectType()
        cls._build_schema_resource_access_role_read(resource_access_roles.Element)

        schema_owners = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.schema_owners
        schema_owners.Element = AAZStrType()

        service_tree_infos = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.management.service_tree_infos
        service_tree_infos.Element = AAZObjectType()
        cls._build_schema_service_tree_info_read(service_tree_infos.Element)

        marketplace_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.marketplace_options
        marketplace_options.add_on_plan_conversion_allowed = AAZBoolType(
            serialized_name="addOnPlanConversionAllowed",
        )

        metadata = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.metadata
        metadata.Element = AAZDictType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.metadata.Element
        _element.Element = AAZAnyType()

        on_behalf_of_tokens = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.on_behalf_of_tokens
        ...
        open_api_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.open_api_configuration
        open_api_configuration.validation = AAZObjectType()

        validation = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.open_api_configuration.validation
        validation.allow_noncompliant_collection_response = AAZBoolType(
            serialized_name="allowNoncompliantCollectionResponse",
        )

        private_endpoint_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.private_endpoint_configuration
        ...
        group_connectivity_information = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.private_endpoint_configuration.group_connectivity_information
        group_connectivity_information.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.private_endpoint_configuration.group_connectivity_information.Element
        ...
        required_members = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.private_endpoint_configuration.group_connectivity_information.Element.required_members
        required_members.Element = AAZStrType()

        required_zone_names = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.private_endpoint_configuration.group_connectivity_information.Element.required_zone_names
        required_zone_names.Element = AAZStrType()

        quota_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.quota_rule
        ...
        location_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.quota_rule.location_rules
        location_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.quota_rule.location_rules.Element
        ...
        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.quota_rule.required_features
        required_features.Element = AAZStrType()

        request_header_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.request_header_options
        request_header_options.opt_in_headers = AAZStrType(
            serialized_name="optInHeaders",
        )
        request_header_options.opt_out_headers = AAZStrType(
        ...
        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.required_features
        required_features.Element = AAZStrType()

        resource_cache = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_cache
        ...
        resource_concurrency_control_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_concurrency_control_options
        resource_concurrency_control_options.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_concurrency_control_options.Element
        _element.policy = AAZStrType()

        resource_deletion_policies = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies
        resource_deletion_policies.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies.Element
        _element.policy_name = AAZStrType(
            serialized_name="policyName",
        )
        _element.properties = AAZObjectType()

        properties = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_deletion_policies.Element.properties
        ...
        resource_graph_configuration = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_graph_configuration
        resource_graph_configuration.api_version = AAZStrType(
            serialized_name="apiVersion",
        )
        resource_graph_configuration.enabled = AAZBoolType()

        resource_management_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options
        ...
        batch_provisioning_support = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support
        ...
        action_configurations = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.action_configurations
        action_configurations.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.action_configurations.Element
        ...
        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.batch_provisioning_support.required_features
        required_features.Element = AAZStrType()

        delete_dependencies = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.delete_dependencies
        delete_dependencies.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.delete_dependencies.Element
        _element.linked_property = AAZStrType(
            serialized_name="linkedProperty",
        )
        _element.linked_type = AAZStrType(
        ...
        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.delete_dependencies.Element.required_features
        required_features.Element = AAZStrType()

        nested_provisioning_support = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_management_options.nested_provisioning_support
        nested_provisioning_support.minimum_api_version = AAZStrType(
            serialized_name="minimumApiVersion",
        )

        resource_move_policy = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_move_policy
        ...
        resource_query_management = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_query_management
        resource_query_management.filter_option = AAZStrType(
            serialized_name="filterOption",
        )

        resource_type_common_attribute_management = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.resource_type_common_attribute_management
        ...
        routing_rule = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.routing_rule
        routing_rule.host_resource_type = AAZStrType(
            serialized_name="hostResourceType",
        )

        service_tree_infos = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.service_tree_infos
        service_tree_infos.Element = AAZObjectType()
        cls._build_schema_service_tree_info_read(service_tree_infos.Element)

        subscription_lifecycle_notification_specifications = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.subscription_lifecycle_notification_specifications
        subscription_lifecycle_notification_specifications.soft_delete_ttl = AAZStrType(
            serialized_name="softDeleteTTL",
        )
        subscription_lifecycle_notification_specifications.subscription_state_override_actions = AAZListType(
        ...
        subscription_state_override_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.subscription_lifecycle_notification_specifications.subscription_state_override_actions
        subscription_state_override_actions.Element = AAZObjectType()
        cls._build_schema_subscription_state_override_action_read(subscription_state_override_actions.Element)

        subscription_state_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.subscription_state_rules
        subscription_state_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.subscription_state_rules.Element
        _element.allowed_actions = AAZListType(
            serialized_name="allowedActions",
        )
        _element.state = AAZStrType()

        allowed_actions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.subscription_state_rules.Element.allowed_actions
        allowed_actions.Element = AAZStrType()

        swagger_specifications = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.swagger_specifications
        swagger_specifications.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.swagger_specifications.Element
        _element.api_versions = AAZListType(
            serialized_name="apiVersions",
        )
        ...
        api_versions = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.swagger_specifications.Element.api_versions
        api_versions.Element = AAZStrType()

        lifecycle_info = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.swagger_specifications.Element.lifecycle_info
        lifecycle_info.lifecycle_stage = AAZStrType(
            serialized_name="lifecycleStage",
        )

        template_deployment_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.template_deployment_options
        template_deployment_options.preflight_options = AAZListType(
            serialized_name="preflightOptions",
        )
        template_deployment_options.preflight_supported = AAZBoolType(
        ...
        preflight_options = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.template_deployment_options.preflight_options
        preflight_options.Element = AAZStrType()

        template_deployment_policy = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.template_deployment_policy
        ...
        throttling_rules = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules
        throttling_rules.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules.Element
        _element.action = AAZStrType(
            flags={"required": True},
        )
        ...
        application_id = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules.Element.application_id
        application_id.Element = AAZStrType()

        metrics = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules.Element.metrics
        metrics.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules.Element.metrics.Element
        ...
        required_features = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.throttling_rules.Element.required_features
        required_features.Element = AAZStrType()

        write_lock = _schema_custom_rollout_read.properties.specification.resource_type_registrations.Element.properties.write_lock
        write_lock.state = AAZStrType()

        status = _schema_custom_rollout_read.properties.status
        ...
        completed_regions = _schema_custom_rollout_read.properties.status.completed_regions
        completed_regions.Element = AAZStrType()

        completed_regions_info = _schema_custom_rollout_read.properties.status.completed_regions_info
        completed_regions_info.Element = AAZObjectType()

        _element = _schema_custom_rollout_read.properties.status.completed_regions_info.Element
        ...
        failed_or_skipped_regions = _schema_custom_rollout_read.properties.status.failed_or_skipped_regions
        ...
        manifest_checkin_status = _schema_custom_rollout_read.properties.status.manifest_checkin_status

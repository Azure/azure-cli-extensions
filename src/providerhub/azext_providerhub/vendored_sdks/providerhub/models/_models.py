...
class CheckinManifestParams(msrest.serialization.Model):
    ...
    :param checkin_manifest_params: The environment supplied to the checkin manifest operation.
    :type checkin_manifest_params: str
...
class InnerErrorautogenerated(InnerError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(InnerErrorautogenerated, self).__init__(**kwargs)
...
class ResourceTypeRegistrationProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.provisioning_state = kwargs.get('provisioning_state', None)
        self.enable_third_party_s2_s = kwargs.get('enable_third_party_s2_s', None)
        self.subscription_lifecycle_notification_specifications = kwargs.get('subscription_lifecycle_notification_specifications', None)

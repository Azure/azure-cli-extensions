...
class ProviderRegistrationsOperations:
    """ProviderRegistrationsOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.ProviderRegistration"]:
    ...
    async def begin_create_or_update(
        ...
        properties: "models.ProviderRegistration",
        **kwargs
    ) -> AsyncLROPoller["models.ProviderRegistration"]:
        ...
        :return: An instance of AsyncLROPoller that returns either ProviderRegistration or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~providerhub.models.ProviderRegistration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop(
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.ProviderRegistrationArrayResponseWithContinuation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~providerhub.models.ProviderRegistrationArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop(

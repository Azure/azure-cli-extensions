...
class CustomRolloutsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/customRollouts/{rolloutName}'}  # type: ignore
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(properties, 'CustomRolloutSpecification')
    ...
    def list_by_provider_registration(
        ...
        provider_namespace: str,
        **kwargs
    ) -> AsyncIterable["models.CustomRolloutArrayResponseWithContinuation"]:

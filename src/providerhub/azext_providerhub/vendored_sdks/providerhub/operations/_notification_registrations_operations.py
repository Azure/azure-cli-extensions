...
class NotificationRegistrationsOperations(object):
    ...
    def get(
        ...
        notification_registration_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NotificationRegistration"
        ...
        path_format_arguments = {
            ...
            'notificationRegistrationName': self._serialize.url("notification_registration_name", notification_registration_name, 'str'),
        }
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/notificationRegistrations/{notificationRegistrationName}'}  # type: ignore

    def create_or_update(
        self,
        provider_namespace,  # type: str
        notification_registration_name,  # type: str
        properties,  # type: "models.NotificationRegistration"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NotificationRegistration"
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/notificationRegistrations/{notificationRegistrationName}'}  # type: ignore
    ...
    def list_by_provider_registration(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.NotificationRegistrationArrayResponseWithContinuation"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~provider_hub.models.NotificationRegistrationArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

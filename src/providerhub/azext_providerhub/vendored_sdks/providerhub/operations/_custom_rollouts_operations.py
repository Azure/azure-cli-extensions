...
class CustomRolloutsOperations(object):
    ...
    def create_or_update(
        ...
        provider_namespace,  # type: str
        rollout_name,  # type: str
        properties,  # type: "models.CustomRollout"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomRollout"
        ...
        :type properties: ~providerhub.models.CustomRollout
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CustomRollout, or the result of cls(response)
        :rtype: ~providerhub.models.CustomRollout
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_provider_registration(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~providerhub.models.CustomRolloutArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop(

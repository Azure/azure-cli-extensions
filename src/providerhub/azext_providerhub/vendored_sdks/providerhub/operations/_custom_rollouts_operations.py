...
class CustomRolloutsOperations(object):
    ...
    def create_or_update(
        ...
        provider_namespace,  # type: str
        rollout_name,  # type: str
        canary,  # type: "models.CustomRollout"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomRollout"
        ...
        :param rollout_name: The rollout name.
        :type rollout_name: str
        :param canary: The custom rollout canary regions supplied to the CreateOrUpdate operation.
        ...
        properties = models.CustomRollout(
            properties = models.CustomRolloutProperties(
                specification = models.CustomRolloutPropertiesSpecification(
                    canary = canary
                )
            )
        )
    ...
    def list_by_provider_registration(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CustomRolloutArrayResponseWithContinuation"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~provider_hub.models.CustomRolloutArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

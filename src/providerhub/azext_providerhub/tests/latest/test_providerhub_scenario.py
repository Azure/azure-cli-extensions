...
def call_scenario(test, rg):
    ...
    step_provider_registration_create(test, rg, checks=[])
    step_provider_registration_show(test, rg, checks=[])
    step_provider_registration_list(test, rg, checks=[])
    step_provider_registration_delete(test, rg, checks=[])
    step_provider_registration_create(test, rg, checks=[])
    step_provider_registration_generate_operation(test, rg, checks=[])
    step_resource_type_registration_create(test, rg, checks=[])
    step_resource_type_registration_show(test, rg, checks=[])
    step_resource_type_registration_list(test, rg, checks=[])
    step_resource_type_registration_delete(test, rg, checks=[])
    step_resource_type_registration_create(test, rg, checks=[])
    step_generate_manifest(test, rg, checks=[])
    step_checkin_manifest(test, rg, checks=[])
    step_custom_rollout_create(test, rg, checks=[])
    step_custom_rollout_show(test, rg, checks=[])
    step_custom_rollout_list(test, rg, checks=[])
    step_default_rollout_create(test, rg, checks=[])
    step_default_rollout_list(test, rg, checks=[])
    step_default_rollout_show(test, rg, checks=[])
    step_default_rollout_stop(test, rg, checks=[])
    step_default_rollout_delete(test, rg, checks=[])

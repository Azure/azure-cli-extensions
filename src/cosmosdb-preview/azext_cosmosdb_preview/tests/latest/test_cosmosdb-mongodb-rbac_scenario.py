...
class Cosmosdb_previewMongodbRbacScenarioTest(ScenarioTest):
    ...
    def test_cosmosdb_sql_role(self, resource_group):
        ...
        role_def_id = 'test.my_role_def1'
        role_def_id2 = 'test.my_role_def2'
        user_definition_id = 'test.testUser'
        user_name = 'testUser'
        role_definition_create_body = ' {{ \\"Id\\": \\"{0}\\", \\"RoleName\\": \\"my_role_def1\\", \\"Type\\": \\"CustomRole\\", \\"DatabaseName\\":\\"test\\",\\"Privileges\\":[{\\"Resource\\":{\\"Db\\":\\"test\\",\\"Collection\\":\\"test\\"},\\"Actions\\":[\\"insert\\",\\"find\\"]}],\\"Roles\\":[]}} '.format(role_def_id)
        role_definition_update_body = ' {{ \\"Id\\": \\"{0}\\", \\"RoleName\\": \\"my_role_def1\\", \\"Type\\": \\"CustomRole\\", \\"DatabaseName\\":\\"test\\",\\"Privileges\\":[{\\"Resource\\":{\\"Db\\":\\"test\\",\\"Collection\\":\\"test\\"},\\"Actions\\":[\\"find\\"]}],\\"Roles\\":[]}} '.format(role_def_id)
        role_definition_create_body2 = ' {{ \\"Id\\": \\"{0}\\", \\"RoleName\\": \\"my_role_def2\\", \\"Type\\": \\"CustomRole\\", \\"DatabaseName\\":\\"test\\",\\"Privileges\\":[{\\"Resource\\":{\\"Db\\":\\"test\\",\\"Collection\\":\\"test\\"},\\"Actions\\":[\\"insert\\"]}],\\"Roles\\":[{\\"Role\\": \\"my_role_def1\\",\\"Db\\": \\"test\\"}]}} '.format(role_def_id2)
        user_definition_create_body = ' {{ \\"Id\\": \\"{0}\\", \\"UserName\\": \\"testUser\\", \\"Password\\": \\"MyPass\\", \\"CustomData\\": \\"MyCustomData\\", \\"DatabaseName\\":\\"test\\",\\"Mechanisms\\": \\"SCRAM-SHA-256\\",\\"Roles\\": [ {\\"Role\\": \\"my_role_def1\\",\\"Db\\": \\"test\\"}]}} '.format(user_definition_id)
        user_definition_update_body = ' {{ \\"Id\\": \\"{0}\\", \\"UserName\\": \\"testUser\\", \\"Password\\": \\"MyPass\\", \\"CustomData\\": \\"MyCustomData\\", \\"DatabaseName\\":\\"test\\",\\"Mechanisms\\": \\"SCRAM-SHA-256\\",\\"Roles\\": [ {\\"Role\\": \\"my_role_def2\\",\\"Db\\": \\"test\\"}]}} '.format(user_definition_id)
        fully_qualified_role_def_id = '/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.DocumentDB/databaseAccounts/{2}/mongodbRoleDefinitions/{3}'.format(subscription, resource_group, acc_name, role_def_id)
        ...
        self.cmd('az cosmosdb create -n {acc} -g {rg} --kind MongoDB --capabilities EnableMongoRoleBasedAccessControl --locations regionName=eastus2')
        ...
        assert self.cmd('az cosmosdb mongodb role definition exists -g {rg} -a {acc} -i {role_def_id}').get_output_in_json()

        self.cmd('az cosmosdb mongodb role definition show -g {rg} -a {acc} -i {role_def_id}', checks=[
            self.check('roleName', 'my_role_def1')
        ])
        ...
        self.cmd('az cosmosdb mongodb role definition create -g {rg} -a {acc} -b "{create_body2}"', checks=[
            ...
            self.check('roleName', 'my_role_def2'),
        ])
        ...
        self.cmd('az cosmosdb mongodb user defiition create -g {rg} -a {acc} -b "{user_def_create_body}"', checks=[
            self.check('id', fully_qualified_user_definition_id),
            self.check('userName', user_name),
            self.check('length(roles)', 1),
            self.check('roles[0].["role"])', 'my_role_def1')
        ])
        ...
        self.cmd('az cosmosdb mongodb user definition update -g {rg} -a {acc} -b "{user_definition_update_body}"', checks=[
            self.check('id', fully_qualified_user_definition_id),
            self.check('length(roles[0])', 1),
            self.check('roles[0].["role"])', 'my_role_def2')
        ])

        role_assignment_list = self.cmd('az cosmosdb mongodb user definition list -g {rg} -a {acc}').get_output_in_json()
        ...
        self.cmd('az cosmosdb mongodb role definition delete -g {rg} -a {acc} -i {role_def_id} --yes')

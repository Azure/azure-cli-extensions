...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmosdb mongocluster create') as c:
        ...
        c.argument('resource_group', completer=None, options_list=['--resource-group', '-g'], help='Name of the resource group of mongo cluster.', id_part=None)
        c.argument('location', options_list=['--location', '-l'], help="Azure Location of the Cluster", required=True)
        c.argument('administrator_login', options_list=['--administrator-login'], help="The intial adminstrator user to be configured when a cluster is created", required=True)
        c.argument('administrator_login_password', options_list=['--administrator-login-password'], help="The intial adminstrator password to be configured when a cluster is created", required=True)
    ...
    with self.argument_context('cosmosdb mongocluster update') as c:
        ...
        c.argument('resource_group', completer=None, options_list=['--resource-group', '-g'], help='Name of the resource group of mongo cluster.', id_part=None)
        c.argument('location', options_list=['--location', '-l'], help="Azure Location of the Cluster", required=True)
        c.argument('administrator_login', options_list=['--administrator-login'], help="The intial adminstrator user to be configured when a cluster is created")

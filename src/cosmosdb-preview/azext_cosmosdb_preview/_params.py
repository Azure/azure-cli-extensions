...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmosdb sql container merge') as c:
        ...
        c.argument('is-simulation', options_list=['--is-simulation', '-s'], arg_type=get_three_state_flag(), help="This flag is set by default, merge will always be a simulation unless this flag is set to false.")

...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmosdb restore') as c:
        ...
        c.argument('disable_ttl', options_list=['--disable-ttl', '-d'], arg_type=get_three_state_flag(), help="Enable or disable restoring with ttl disabled.", is_preview=True)
...
# SQL container
    ...
    with self.argument_context('cosmosdb sql database restore') as c:
        ...
        c.argument('disable_ttl', options_list=['--disable-ttl', 'd'], arg_type=get_three_state_flag(), help="Enable or disable restoring with ttl disabled.", is_preview= True, required=False])

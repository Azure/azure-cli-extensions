...
def load_arguments(self, _):
    ...
    for scope in [
        ...
        with self.argument_context(scope) as c:
            ...
            c.argument('client_certificates', nargs='+', validator=validate_client_certificates, help="If specified, enables client certificate authentiation to the Cassandra API.")
    ...
    for scope in [
            ...
            'managed-cassandra datacenter update']:
        with self.argument_context(scope) as c:
            c.argument('node_count', options_list=['--node-count', '-n'], help="The number of Cassandra virtual machines in this data center. The minimum value is 3.")
    ...
    with self.argument_context('managed-cassandra datacenter create') as c:
        ...
        c.argument('node_count', options_list=['--node-count', '-n'], help="The number of Cassandra virtual machines in this data center. The minimum value is 3.", required=True)

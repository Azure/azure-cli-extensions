...
def load_arguments(self, _):
    ...
    for scope in [
        ...
        with self.argument_context(scope) as c:
            ...
            c.argument('service_user_distinguished_name', options_list=['--ldap-user-distinguished-name'], help="Distinguished name of the look up user account, who can look up user details on authentication.")
            c.argument('service_user_password', options_list=['--ldap-user-password'], help="Password of the look up user.")
            c.argument('search_base_distinguished_name', options_list=['--ldap-base-distinguished-name'], help="Distinguished name of the object to start the recursive search of users from.")

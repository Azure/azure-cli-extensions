...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmosdb dts copy') as c:
        ...
        c.argument('source_mongo_collection', nargs='+', action=AddMongoCollectionAction, help='Source mongo collection')
        ...
        c.argument('dest_mongo_collection', nargs='+', action=AddMongoCollectionAction, help='Destination mongo collection')

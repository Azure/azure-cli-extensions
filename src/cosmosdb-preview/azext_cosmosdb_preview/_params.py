...
# SQL container
    ...
    with self.argument_context('cosmosdb table role assignment') as c:
        ...
        c.argument('role_definition_id', options_list=['--role-definition-id', '-d'], validator=validate_table_role_definition_id, help="Unique ID of the Role Definition that this Role Assignment refers to.")

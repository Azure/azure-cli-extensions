...
def load_arguments(self, _):
    ...
    with self.argument_context('managed-cassandra cluster create') as c:
        ...
        c.argument('azure_connection_method', options_list=['--azure-connection-method', '-acm'], help="This field can be specified to create VPN based Cassandra cluster, where the datacenter is in customers vnet with limited permissions to azure.")

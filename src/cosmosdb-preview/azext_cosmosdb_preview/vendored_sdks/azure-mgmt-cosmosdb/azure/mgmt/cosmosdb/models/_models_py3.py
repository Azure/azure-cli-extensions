...
class MongoCluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar administrator_login: The administrator's login for the Mongo cluster. Default value is
     'mongoAdmin'.
    ...
    :ivar server_version: The Mongo DB server version.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword administrator_login: The administrator's login for the Mongo cluster. Default value is
         'mongoAdmin'.
        ...
        :keyword server_version: The Mongo DB server version.
...
class MongoClusterForUpdate(_serialization.Model):
    """The properties used to update a mongo cluster resource.
    ...
    :ivar server_version: The Mongo DB server version.
    :vartype server_version: str
    :ivar node_group_specs: The list of node groups.
    :vartype node_group_specs: list[~azure.mgmt.cosmosdb.models.NodeGroupSpec]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword server_version: The Mongo DB server version.
        :paramtype server_version: str
        :keyword node_group_specs: The list of node groups.
        :paramtype node_group_specs: list[~azure.mgmt.cosmosdb.models.NodeGroupSpec]
        """
        super().__init__(**kwargs)
        self.tags = tags
...
class NodeGroupProperties(_serialization.Model):
    ...
    :ivar disk_size_gb: The disk storage size for the virtual machine/s in GB (max: 2048 = 2TiB).
     Default value is 128 GB. Value cannot be decreased after creating the cluster.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword disk_size_gb: The disk storage size for the virtual machine/s in GB (max: 2048 =
         2TiB). Default value is 128 GB. Value cannot be decreased after creating the cluster.

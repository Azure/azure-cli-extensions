...
class CosmosDBManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype firewall_rules: azure.mgmt.cosmosdb.operations.FirewallRulesOperations
    :ivar mongo_cluster_names: MongoClusterNamesOperations operations
    :vartype mongo_cluster_names: azure.mgmt.cosmosdb.operations.MongoClusterNamesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.mongo_cluster_names = MongoClusterNamesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )

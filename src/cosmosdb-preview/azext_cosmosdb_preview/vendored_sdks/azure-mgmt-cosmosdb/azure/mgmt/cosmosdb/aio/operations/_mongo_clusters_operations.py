...
class MongoClustersOperations:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        mongo_cluster_name: str,
        parameters: Union[_models.MongoClusterForUpdate, IO],
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "MongoClusterForUpdate")
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        mongo_cluster_name: str,
        parameters: _models.MongoClusterForUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.MongoCluster]:
        ...
        :type parameters: ~azure.mgmt.cosmosdb.models.MongoClusterForUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The parameters for updating a Mongo cluster. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.cosmosdb.models.MongoClusterForUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response

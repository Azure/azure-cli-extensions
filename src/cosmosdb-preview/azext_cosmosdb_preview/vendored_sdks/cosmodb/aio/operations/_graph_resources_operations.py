...
class GraphResourcesOperations:
    """GraphResourcesOperations async operations.
    ...
    def list_graphs(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either GraphResourcesListResult or the result of cls(response)
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_graphs.metadata['url']  # type: ignore
    ...
    async def get_graph(
        ...
        **kwargs
        ...
        :param account_name: Cosmos DB database account name.
        :type account_name: str
        :param graph_name: Cosmos DB graph resource name.
        :type graph_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.get_graph.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=50, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
    ...
    async def _create_update_graph_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._create_update_graph_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=50, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
        ...
        body_content = self._serialize.body(create_update_graph_parameters, 'GraphResourceCreateUpdateParameters')
    ...
    async def _delete_graph_resource_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._delete_graph_resource_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=50, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),

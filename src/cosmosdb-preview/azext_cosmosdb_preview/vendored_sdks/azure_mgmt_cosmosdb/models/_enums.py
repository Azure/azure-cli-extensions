...
class EmbeddingSourceAuthenticationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The type of authentication to use when calling the embedding provider API."""
...
class FullTextFilterType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """A filter applied during full text analysis."""
...
class FullTextPackageType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The package used for full text processing."""
...
class FullTextTokenizerType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The tokenizer used for full text processing."""
...
class StopWordListKindType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The stop word list kind used for full text analysis."""

...
class RestorableSqlResourcesOperations(object):
    ...
    def list(
        ...
        deserialized = models.DatabaseRestoreResourcePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DatabaseRestoreResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

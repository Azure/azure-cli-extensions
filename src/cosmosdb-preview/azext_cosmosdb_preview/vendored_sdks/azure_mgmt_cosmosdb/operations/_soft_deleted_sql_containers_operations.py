...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "databaseName": _SERIALIZER.url("database_name", database_name, "str", pattern=r"^[^/\\#?]+$"),
        "containerName": _SERIALIZER.url("container_name", container_name, "str", pattern=r"^[^/\\#?]+$"),
    }
...
class SoftDeletedSqlContainersOperations:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.SoftDeletedSqlContainerGetResult"]:
        ...
        :return: An iterator like instance of either SoftDeletedSqlContainerGetResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.SoftDeletedSqlContainerGetResult]

...
class RestorableMongodbCollectionsOperations(object):
    ...
    def get(
            self, location, instance_id, restorable_mongodb_collection_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param instance_id: The instanceId GUID of a restorable database
         account.
        :type instance_id: str
        :param restorable_mongodb_collection_id: The GUID of the restorable
         MongoDB collection.
        :type restorable_mongodb_collection_id: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.models.RestorableMongodbCollectionGetResult[None]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.cosmosdb.models.DefaultErrorResponseException>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                ...
                path_format_arguments = {
                    ...
                    'location': self._serialize.url("location", location, 'str'),
                    'instanceId': self._serialize.url("instance_id", instance_id, 'str'),
                    'restorableMongodbCollectionId': self._serialize.url("restorable_mongodb_collection_id", restorable_mongodb_collection_id, 'str')
                }
                url = self._client.format_url(url, **path_format_arguments)
        ...
        if raw:
            header_dict = {}
        deserialized = models.RestorableMongodbCollectionGetResult(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableMongodbCollections/{restorableMongodbCollectionId}'}

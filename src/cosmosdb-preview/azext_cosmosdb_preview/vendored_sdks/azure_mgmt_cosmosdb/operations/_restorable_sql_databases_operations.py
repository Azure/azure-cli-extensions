...
class RestorableSqlDatabasesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RestorableSqlDatabasesListResult"]
        ...
        :return: An iterator like instance of either RestorableSqlDatabasesListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.RestorableSqlDatabasesListResult]

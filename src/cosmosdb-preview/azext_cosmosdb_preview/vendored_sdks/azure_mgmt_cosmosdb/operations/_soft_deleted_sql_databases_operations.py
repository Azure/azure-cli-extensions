...
def build_get_request(
    resource_group_name: str, location: str, account_name: str, database_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SoftDeletedSqlDatabasesOperations:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.SoftDeletedSqlDatabaseGetResult"]:
        ...
        :return: An iterator like instance of either SoftDeletedSqlDatabaseGetResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.SoftDeletedSqlDatabaseGetResult]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("SoftDeletedSqlDatabasesListResult", pipeline_response)
    ...
    def get(
        ...
        :return: SoftDeletedSqlDatabaseGetResult or the result of cls(response)
        ...
        deserialized = self._deserialize("SoftDeletedSqlDatabaseGetResult", pipeline_response.http_response)

...
class SqlResourcesOperations(object):
    ...
    def list_sql_stored_procedures(
        ...
        # Deserialize response
        deserialized = models.SqlStoredProcedureGetResultsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlStoredProcedureGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_sql_user_defined_functions(
        ...
        # Deserialize response
        deserialized = models.SqlUserDefinedFunctionGetResultsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlUserDefinedFunctionGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_sql_triggers(
        ...
        # Deserialize response
        deserialized = models.SqlTriggerGetResultsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlTriggerGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_sql_role_definitions(
        ...
        # Deserialize response
        deserialized = models.SqlRoleDefinitionGetResultsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlRoleDefinitionGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_sql_role_assignments(
        ...
        # Deserialize response
        deserialized = models.SqlRoleAssignmentGetResultsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlRoleAssignmentGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

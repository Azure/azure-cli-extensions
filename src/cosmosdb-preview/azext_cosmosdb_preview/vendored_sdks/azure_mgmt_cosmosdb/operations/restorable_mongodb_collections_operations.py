...
class RestorableMongodbCollectionsOperations(object):
    ...
    def list(
        ...
        deserialized = models.RestorableMongodbCollectionGetResultPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RestorableMongodbCollectionGetResultPaged(internal_paging, self._deserialize.dependencies, header_dict)

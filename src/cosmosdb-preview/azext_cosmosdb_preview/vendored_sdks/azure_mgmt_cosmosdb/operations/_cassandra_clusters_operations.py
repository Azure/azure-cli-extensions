...
class CassandraClustersOperations(object):
    ...
    def _invoke_command_initial(
        ...
        resource_group_name,  # type: str
        cluster_name,  # type: str
        body,  # type: "models.CommandPostBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CommandOutput"
    ...
    def begin_invoke_command(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.CommandOutput"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either CommandOutput or the result of cls(response)
    ...
    def status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.CassandraClusterPublicStatus"

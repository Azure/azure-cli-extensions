...
class NotebookWorkspacesOperations(object):
    ...
    def list_by_database_account(
        ...
        deserialized = models.NotebookWorkspacePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.NotebookWorkspacePaged(internal_paging, self._deserialize.dependencies, header_dict)

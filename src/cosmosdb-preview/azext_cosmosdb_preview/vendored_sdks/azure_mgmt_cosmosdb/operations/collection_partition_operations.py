...
class CollectionPartitionOperations(object):
    ...
    def list_usages(
        ...
        # Deserialize response
        deserialized = models.PartitionUsagePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.PartitionUsagePaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

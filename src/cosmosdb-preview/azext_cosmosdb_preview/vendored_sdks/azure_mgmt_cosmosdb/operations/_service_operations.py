...
class ServiceOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ServiceResourceListResult or the result of cls(response)
    ...
    def _create_initial(
        ...
        create_update_parameters,  # type: "_models.ServiceResource"
        **kwargs  # type: Any
    ):
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=50, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
            'serviceName': self._serialize.url("service_name", service_name, 'str', max_length=50, min_length=3),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(create_update_parameters, 'ServiceResource')

...
class CassandraDataCenterOperations(object):
    ...
    def list_data_centers_method(
        ...
        :return: An iterator like instance of DataCenterResource
        :rtype:
         ~azure.mgmt.cosmosdb.models.DataCenterResourcePaged[~azure.mgmt.cosmosdb.models.DataCenterResource]
    ...
    def get(
        ...
        :param cluster_name: Managed Cassandra cluster name.
        :type cluster_name: str
        :param data_center_name: Data center name in a managed Cassandra
         cluster.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DataCenterResource or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.cosmosdb.models.DataCenterResource or
    ...
    def delete(
            self, resource_group_name, cluster_name, data_center_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/dataCenters/{dataCenterName}'}


    def _create_update_initial(
            self, resource_group_name, cluster_name, data_center_name, properties=None, custom_headers=None, raw=False, **operation_config):
        body = models.DataCenterResource(properties=properties)
    ...
    def create_update(
        ...
        overwrite all properties. To update only some properties, use PATCH.
        ...
        :type properties:
         ~azure.mgmt.cosmosdb.models.DataCenterResourceProperties
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/dataCenters/{dataCenterName}'}
    ...
    def update(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/dataCenters/{dataCenterName}'}

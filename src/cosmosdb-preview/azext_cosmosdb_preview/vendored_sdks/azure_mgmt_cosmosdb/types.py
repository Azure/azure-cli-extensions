...
class DatabaseAccountCreateUpdateProperties(TypedDict, total=False):
    ...
    :ivar enableEmbeddingGenerator: Flag to indicate whether to enable Integrated Embeddings on the
     Cosmos DB account. This property is supported only for API for NoSQL accounts and cannot be
    ...
    :vartype enableEmbeddingGenerator: bool
...
class DatabaseAccountUpdateProperties(TypedDict, total=False):
    ...
    :vartype enableMaterializedViews: bool
    :ivar enableEmbeddingGenerator: Flag to indicate whether to enable Integrated Embeddings on the
     Cosmos DB account. This property is supported only for existing API for NoSQL accounts with
...
class EmbeddingSource(TypedDict, total=False):
    ...
    :ivar sourcePaths: The non-empty list of top-level source paths in the document to generate
     embeddings from. A source path cannot be the same as the destination vector embedding path.
     Required.
    :vartype sourcePaths: list[str]
    :ivar endpoint: The endpoint URL of the AI model provider resource. Required.
    :vartype endpoint: str
    :ivar deploymentName: The model deployment name used for generating embeddings. Required.
    :vartype deploymentName: str
    :ivar modelName: The name of the embedding model. Required.
    :vartype modelName: str
    :ivar authType: The authentication type Azure Cosmos DB uses when calling the embedding model
     endpoint. Required. "Entra"
    :vartype authType: Union[str, "EmbeddingSourceAuthenticationType"]
    """

    sourcePaths: Required[list[str]]
    ...
    authType: Required[Union[str, "EmbeddingSourceAuthenticationType"]]
...
class FullTextPath(TypedDict, total=False):
    ...
    :vartype tokenizer: Union[str, "FullTextTokenizerType"]
    :ivar filters: The filter pipeline applied to this path.
    :vartype filters: list[Union[str, "FullTextFilterType"]]
    :ivar stopWordListKind: The stop word list kind for this path. Known values are: "none",
     "extended", and "basic".
    :vartype stopWordListKind: Union[str, "StopWordListKindType"]
    :ivar addStopWords: Custom words to add to the stop word list for this path.
    :vartype addStopWords: list[str]
    :ivar removeStopWords: Words to remove from the built-in stop word list for this path.
    :vartype removeStopWords: list[str]
    """
...
class FullTextPolicy(TypedDict, total=False):
    ...
    :vartype package: Union[str, "FullTextPackageType"]
    :ivar defaultSpec: The default full text analysis specification inherited by full text paths
     that omit these settings.
    :vartype defaultSpec: "FullTextSpec"
...
class FullTextSpec(TypedDict, total=False):
    ...
    :vartype filters: list[Union[str, "FullTextFilterType"]]
    :ivar stopWordListKind: The stop word list kind of the full text analysis. Known values are:
     "none", "extended", and "basic".
    :vartype stopWordListKind: Union[str, "StopWordListKindType"]
    :ivar addStopWords: Custom words to add to the stop word list.
    :vartype addStopWords: list[str]
    :ivar removeStopWords: Words to remove from the built-in stop word list.
    :vartype removeStopWords: list[str]
    """
...
class VectorEmbedding(TypedDict, total=False):
    ...
    :ivar embeddingSource: The embedding source configuration to automatically generate embeddings
     at the configured paths.
    :vartype embeddingSource: "EmbeddingSource"
    """

...
from ...operations._fleet_operations import (
...
class FleetOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.FleetResource"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.FleetResource]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.FleetResource"]:
    ...
    async def get(self, resource_group_name: str, fleet_name: str, **kwargs: Any) -> _models.FleetResource:

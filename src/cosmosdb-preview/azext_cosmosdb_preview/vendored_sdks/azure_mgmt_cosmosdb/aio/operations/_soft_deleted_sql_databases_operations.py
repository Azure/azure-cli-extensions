...
from ...operations._soft_deleted_sql_databases_operations import (
    build_get_request,
    build_list_request,
    build_purge_request,
...
class SoftDeletedSqlDatabasesOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.SoftDeletedSqlDatabaseGetResult"]:
        ...
        :return: An iterator like instance of either SoftDeletedSqlDatabaseGetResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.SoftDeletedSqlDatabaseGetResult]

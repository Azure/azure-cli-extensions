...
from ...operations._soft_deleted_database_accounts_operations import (
    build_get_request,
    build_list_by_location_request,
    build_list_by_resource_group_and_location_request,
    build_purge_request,
...
class SoftDeletedDatabaseAccountsOperations:
    ...
    def list_by_location(
    ...
    ) -> AsyncItemPaged["_models.SoftDeletedDatabaseAccountGetResult"]:
        ...
        :return: An iterator like instance of either SoftDeletedDatabaseAccountGetResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.SoftDeletedDatabaseAccountGetResult]

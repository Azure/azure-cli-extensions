...
class CassandraClustersOperations:
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.ListClusters"]:
    ...
    async def begin_create_update(
        ...
        body: "models.ClusterResource",
        **kwargs
    ) -> AsyncLROPoller["models.ClusterResource"]:
    ...
    async def _invoke_command_initial(
        ...
        **kwargs
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CommandOutput"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        return deserialized
    _invoke_command_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/command'}  # type: ignore
    ...
    async def begin_invoke_command(
        ...
        body: "models.CommandPostBody",
        **kwargs
    ) -> AsyncLROPoller["models.CommandOutput"]:
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either CommandOutput or the result of cls(response)
    ...
    def list_backups(
        ...
        cluster_name: str,
        **kwargs
    ) -> AsyncIterable["models.ListBackups"]:
    ...
    async def status(
        ...
        cluster_name: str,
        **kwargs
    ) -> "models.CassandraClusterPublicStatus":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CassandraClusterPublicStatus"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

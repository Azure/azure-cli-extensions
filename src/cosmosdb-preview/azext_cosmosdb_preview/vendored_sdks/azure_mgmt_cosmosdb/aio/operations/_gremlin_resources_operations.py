...
from ...operations._gremlin_resources_operations import (
    ...
    build_create_update_gremlin_role_assignment_request,
    build_create_update_gremlin_role_definition_request,
    build_delete_gremlin_database_request,
    build_delete_gremlin_graph_request,
    build_delete_gremlin_role_assignment_request,
    build_delete_gremlin_role_definition_request,
    ...
    build_get_gremlin_role_assignment_request,
    build_get_gremlin_role_definition_request,
    build_list_gremlin_databases_request,
    build_list_gremlin_graphs_request,
    build_list_gremlin_role_assignments_request,
    build_list_gremlin_role_definitions_request,
...
class GremlinResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_gremlin_role_assignments(
        self, resource_group_name: str, account_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.GremlinRoleAssignmentResource"]:
        ...
        :return: An iterator like instance of either GremlinRoleAssignmentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _create_update_gremlin_role_assignment_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
    ...
    @overload
    async def begin_create_update_gremlin_role_assignment(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
        role_assignment_id: str,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.GremlinRoleAssignmentResource]:
        ...
        :return: An instance of AsyncLROPoller that returns either GremlinRoleAssignmentResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_update_gremlin_role_assignment(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_update_gremlin_role_assignment_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_assignment_id=role_assignment_id,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.GremlinRoleAssignmentResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
    ...
    async def _delete_gremlin_role_assignment_initial(
        self, resource_group_name: str, account_name: str, role_assignment_id: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_delete_gremlin_role_assignment(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_gremlin_role_assignment_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_assignment_id=role_assignment_id,
                api_version=api_version,
    ...
    def list_gremlin_role_definitions(
        self, resource_group_name: str, account_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.GremlinRoleDefinitionResource"]:
        ...
        :return: An iterator like instance of either GremlinRoleDefinitionResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.GremlinRoleDefinitionResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _create_update_gremlin_role_definition_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
    ...
    @overload
    async def begin_create_update_gremlin_role_definition(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
        role_definition_id: str,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.GremlinRoleDefinitionResource]:
        ...
        :return: An instance of AsyncLROPoller that returns either GremlinRoleDefinitionResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.GremlinRoleDefinitionResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_update_gremlin_role_definition(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_update_gremlin_role_definition_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_definition_id=role_definition_id,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.GremlinRoleDefinitionResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GremlinRoleDefinitionResource](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    async def _delete_gremlin_role_definition_initial(
        self, resource_group_name: str, account_name: str, role_definition_id: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_delete_gremlin_role_definition(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_gremlin_role_definition_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_definition_id=role_definition_id,
                api_version=api_version,

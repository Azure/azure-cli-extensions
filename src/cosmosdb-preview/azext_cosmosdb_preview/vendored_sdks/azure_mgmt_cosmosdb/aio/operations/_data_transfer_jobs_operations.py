...
class DataTransferJobsOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(job_create_parameters, 'CreateJobRequest')
    ...
    def list_by_database_account(
        ...
        **kwargs: Any
        ...
        :type account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either DataTransferJobFeedResults or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.DataTransferJobFeedResults]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
@register_command(
    "sentinel bookmark relation create",
...
class Create(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.operationalinsights/workspaces/{}/providers/microsoft.securityinsights/bookmarks/{}/relations/{}", "2022-06-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.BookmarkRelationsCreateOrUpdate(ctx=self.ctx)()

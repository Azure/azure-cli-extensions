...
class AadDataConnector(DataConnector):
    ...
    _attribute_map = {
        ...
        'state': {'key': 'properties.dataTypes.alerts.state', 'type': 'str'},
    }
...
class AlertRuleTemplate(Resource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.kind: str = 'AlertRuleTemplate'
...
class AscDataConnectorProperties(DataConnectorWithAlertsProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AscDataConnectorProperties, self).__init__(state=state, **kwargs)
        self.subscription_id = subscription_id
...
class AwsCloudTrailDataConnector(DataConnector):
    ...
    _attribute_map = {
        ...
        'state': {'key': 'properties.dataTypes.logs.state', 'type': 'str'},
    }
...
class Bookmark(ResourceWithEtag):
    ...
    :ivar email_properties_updated_by_email: The email of the user.
    :vartype email_properties_updated_by_email: str
    :ivar name_properties_updated_by_name: The name of the user.
    :vartype name_properties_updated_by_name: str
    :param object_id_properties_updated_by_object_id: The object id of the user.
    :type object_id_properties_updated_by_object_id: str
    :ivar email_properties_created_by_email: The email of the user.
    :vartype email_properties_created_by_email: str
    :ivar name_properties_created_by_name: The name of the user.
    :vartype name_properties_created_by_name: str
    :param object_id_properties_created_by_object_id: The object id of the user.
    :type object_id_properties_created_by_object_id: str
    """
    ...
    _validation = {
        ...
        'name': {'readonly': True},
        'type': {'readonly': True},
        'email_properties_updated_by_email': {'readonly': True},
        'name_properties_updated_by_name': {'readonly': True},
        'email_properties_created_by_email': {'readonly': True},
        'name_properties_created_by_name': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'email_properties_updated_by_email': {'key': 'properties.updatedBy.email', 'type': 'str'},
        'name_properties_updated_by_name': {'key': 'properties.updatedBy.name', 'type': 'str'},
        'object_id_properties_updated_by_object_id': {'key': 'properties.updatedBy.objectId', 'type': 'str'},
        'email_properties_created_by_email': {'key': 'properties.createdBy.email', 'type': 'str'},
        'name_properties_created_by_name': {'key': 'properties.createdBy.name', 'type': 'str'},
        'object_id_properties_created_by_object_id': {'key': 'properties.createdBy.objectId', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        object_id_properties_updated_by_object_id: Optional[str] = None,
        object_id_properties_created_by_object_id: Optional[str] = None,
        **kwargs
    ):
        ...
        self.email_properties_updated_by_email = None
        self.name_properties_updated_by_name = None
        self.object_id_properties_updated_by_object_id = object_id_properties_updated_by_object_id
        self.email_properties_created_by_email = None
        self.name_properties_created_by_name = None
        self.object_id_properties_created_by_object_id = object_id_properties_created_by_object_id
...
class MCASDataConnector(DataConnector):
    ...
    :param tenant_id: The tenant id to connect to, and get the data from.
    :type tenant_id: str
    :param state_properties_data_types_alerts_state: Describe whether this data type connection is
     enabled or not. Possible values include: "Enabled", "Disabled".
    :type state_properties_data_types_alerts_state: str or ~security_insights.models.DataTypeState
    :param state_properties_data_types_discovery_logs_state: Describe whether this data type
     connection is enabled or not. Possible values include: "Enabled", "Disabled".
    :type state_properties_data_types_discovery_logs_state: str or
     ~security_insights.models.DataTypeState
    """
    ...
    _attribute_map = {
        ...
        'kind': {'key': 'kind', 'type': 'str'},
        'tenant_id': {'key': 'properties.tenantId', 'type': 'str'},
        'state_properties_data_types_alerts_state': {'key': 'properties.dataTypes.alerts.state', 'type': 'str'},
        'state_properties_data_types_discovery_logs_state': {'key': 'properties.dataTypes.discoveryLogs.state', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        etag: Optional[str] = None,
        tenant_id: Optional[str] = None,
        state_properties_data_types_alerts_state: Optional[Union[str, "DataTypeState"]] = None,
        state_properties_data_types_discovery_logs_state: Optional[Union[str, "DataTypeState"]] = None,
        **kwargs
    ):
        super(MCASDataConnector, self).__init__(etag=etag, **kwargs)
        self.kind: str = 'MicrosoftCloudAppSecurity'
        self.tenant_id = tenant_id
        self.state_properties_data_types_alerts_state = state_properties_data_types_alerts_state
        self.state_properties_data_types_discovery_logs_state = state_properties_data_types_discovery_logs_state
...
class OfficeDataConnector(DataConnector):
    ...
    :param tenant_id: The tenant id to connect to, and get the data from.
    :type tenant_id: str
    :param state_properties_data_types_share_point_state: Describe whether this data type
     connection is enabled or not. Possible values include: "Enabled", "Disabled".
    :type state_properties_data_types_share_point_state: str or
     ~security_insights.models.DataTypeState
    :param state_properties_data_types_exchange_state: Describe whether this data type connection
     is enabled or not. Possible values include: "Enabled", "Disabled".
    :type state_properties_data_types_exchange_state: str or
     ~security_insights.models.DataTypeState
    """
    ...
    _attribute_map = {
        ...
        'kind': {'key': 'kind', 'type': 'str'},
        'tenant_id': {'key': 'properties.tenantId', 'type': 'str'},
        'state_properties_data_types_share_point_state': {'key': 'properties.dataTypes.sharePoint.state', 'type': 'str'},
        'state_properties_data_types_exchange_state': {'key': 'properties.dataTypes.exchange.state', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        etag: Optional[str] = None,
        tenant_id: Optional[str] = None,
        state_properties_data_types_share_point_state: Optional[Union[str, "DataTypeState"]] = None,
        state_properties_data_types_exchange_state: Optional[Union[str, "DataTypeState"]] = None,
        **kwargs
    ):
        super(OfficeDataConnector, self).__init__(etag=etag, **kwargs)
        self.kind: str = 'Office365'
        self.tenant_id = tenant_id
        self.state_properties_data_types_share_point_state = state_properties_data_types_share_point_state
        self.state_properties_data_types_exchange_state = state_properties_data_types_exchange_state
...
class TIDataConnector(DataConnector):
    ...
    _attribute_map = {
        ...
        'kind': {'key': 'kind', 'type': 'str'},
        'tenant_id': {'key': 'properties.tenantId', 'type': 'str'},
        'state': {'key': 'properties.dataTypes.indicators.state', 'type': 'str'},
    }

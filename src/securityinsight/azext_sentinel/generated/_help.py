...
not.
      ...
      - name: --ti-data-connector
        ...
        long-summary: |
            Usage: --ti-data-connector tenant-id=XX tip-lookback-period=XX state=XX kind=XX etag=XX

            tenant-id: The tenant id to connect to, and get the data from.
            tip-lookback-period: The lookback period for the feed to be imported.
            state: Describe whether this data type connection is enabled or not.
            kind: Required. The data connector kind
            etag: Etag of the azure resource
    examples:

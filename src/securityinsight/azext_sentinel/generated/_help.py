...
helps['sentinel alert-rule show'] = """
    ...
    examples:
      - name: Get a Fusion alert rule.
        text: |-
               az sentinel alert-rule show --resource-group "myRg" --rule-id "myFirstFusionRule" --workspace-name "myWo\
rkspace"
...
ple" --workspace-name "myWorkspace"
      - name: Get a Scheduled alert rule.
        text: |-
               az sentinel alert-rule show --resource-group "myRg" --rule-id "73e01a99-5cd7-4139-a149-9f2736ff2ab5" --w\
...
helps['sentinel alert-rule get-action'] = """
    ...
    examples:
      - name: Get an action of alert rule.
        text: |-
               az sentinel alert-rule get-action --action-id "912bec42-cb66-4c03-ac63-1761b6898c3e" --resource-group "m\
yRg" --rule-id "73e01a99-5cd7-4139-a149-9f2736ff2ab5" --workspace-name "myWorkspace"
"""
...
enerated < ago(2d)" --query-result "Security Event query result" --updated "2019-01-01T13:15:30Z" --bookmark-id "73e01a\
99-5cd7-4139-a149-9f2736ff2ab5" --resource-group "myRg" --workspace-name "myWorkspace"
"""
...
helps['sentinel data-connector create'] = """
    ...
    parameters:
      ...
      - name: --asc-data-connector
        ...
        long-summary: |
            Usage: --asc-data-connector state=XX subscription-id=XX kind=XX etag=XX
      ...
      - name: --aws-cloud-trail-data-connector
        ...
        long-summary: |
            ...
            kind: Required. The data connector kind
            etag: Etag of the azure resource
      - name: --m-c-a-s-data-connector
        short-summary: Represents MCAS (Microsoft Cloud App Security) data connector.
        long-summary: |
            Usage: --m-c-a-s-data-connector tenant-id=XX state=XX state=XX kind=XX etag=XX
      ...
      - name: --office-data-connector
        ...
        long-summary: |
            Usage: --office-data-connector tenant-id=XX state=XX state=XX kind=XX etag=XX
            ...
            kind: Required. The data connector kind
            etag: Etag of the azure resource
      - name: --t-i-data-connector
        short-summary: Represents threat intelligence data connector.
        long-summary: |
            Usage: --t-i-data-connector tenant-id=XX state=XX kind=XX etag=XX
...
\\"" tenant-id="2070ecc9-b4d5-4ae4-adaa-936fa1954fa8" state="Enabled" --data-connector-id "73e01a99-5cd7-4139-a149-9f27\
36ff2ab5" --resource-group "myRg" --workspace-name "myWorkspace"
"""
...
helps['sentinel data-connector update'] = """
    ...
    examples:
      - name: Creates or updates an Office365 data connector.
        text: |-
               az sentinel data-connector update --office-data-connector etag="\\"0300bf09-0000-0000-0000-5c37296e0000\
\\"" tenant-id="2070ecc9-b4d5-4ae4-adaa-936fa1954fa8" state="Enabled" --data-connector-id "73e01a99-5cd7-4139-a149-9f27\
36ff2ab5" --resource-group "myRg" --workspace-name "myWorkspace"
"""

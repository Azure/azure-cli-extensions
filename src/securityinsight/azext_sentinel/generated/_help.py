...
"2019-01-01T13:15:30Z" --created-by-object-id "2046feea-040d-4a46-9e2b-91c2941bfa70" --display-name "My bookmark" \
--labels "Tag1" --labels "Tag2" --notes "Found a suspicious activity" --query "SecurityEvent | where TimeGenerated > \
ago(1d) and TimeGenerated < ago(2d)" --query-result "Security Event query result" --updated "2019-01-01T13:15:30Z" \
--updated-by-object-id "2046feea-040d-4a46-9e2b-91c2941bfa70" --bookmark-id "73e01a99-5cd7-4139-a149-9f2736ff2ab5" \
--resource-group "myRg" --workspace-name "myWorkspace"
"""
...
not.
      ...
      - name: --office-data-connector
        ...
        long-summary: |
            Usage: --office-data-connector tenant-id=XX state-properties-data-types-share-point-state=XX \
state-properties-data-types-exchange-state=XX kind=XX etag=XX

...
class AddMCASDataConnector(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.m_c_a_s_data_connector = action
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'tenant-id':
                ...
                d['state_properties_data_types_alerts_state'] = v[0]
            elif kl == 'state':
                d['state_properties_data_types_discovery_logs_state'] = v[0]
            elif kl == 'etag':
                d['etag'] = v[0]
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'tenant-id':
                ...
                d['state_properties_data_types_share_point_state'] = v[0]
            elif kl == 'state':
                d['state_properties_data_types_exchange_state'] = v[0]
            elif kl == 'etag':
                d['etag'] = v[0]
        d['kind'] = 'Office365'
        return d
...
class AddTIDataConnector(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.t_i_data_connector = action

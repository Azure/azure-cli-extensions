...
def load_arguments(self, _):
    ...
    with self.argument_context('sentinel alert-rule show') as c:
        ...
        c.argument('rule_id', help='Alert rule ID', id_part='child_name_1')
    ...
    with self.argument_context('sentinel alert-rule create') as c:
        ...
        c.argument('microsoft_security_incident_creation_alert_rule',
                   action=AddMicrosoftSecurityIncidentCreationAlertRule, nargs='+', help='Represents MicrosoftSecurityI'
                   'ncidentCreation rule.', arg_group='AlertRule')
        c.argument('scheduled_alert_rule', action=AddScheduledAlertRule, nargs='+', help='Represents scheduled alert ru'
                   'le.', arg_group='AlertRule')

    with self.argument_context('sentinel alert-rule delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('rule_id', help='Alert rule ID', id_part='child_name_1')
        c.argument('action_id', help='Action ID', id_part='child_name_2')
    ...
    with self.argument_context('sentinel alert-rule-template show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('alert_rule_template_id', help='Alert rule template ID', id_part='child_name_1')
    ...
    with self.argument_context('sentinel bookmark show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('bookmark_id', help='Bookmark ID', id_part='child_name_1')
    ...
    with self.argument_context('sentinel bookmark create') as c:
        ...
        c.argument('created_by_object_id', help='The object id of the user.')
    ...
    with self.argument_context('sentinel data-connector show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('data_connector_id', help='Connector ID', id_part='child_name_1')

    with self.argument_context('sentinel data-connector create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.')
        c.argument('data_connector_id', help='Connector ID')
        c.argument('aad_data_connector', action=AddAadDataConnector, nargs='+', help='Represents AAD (Azure Active Dire'
                   'ctory) data connector.', arg_group='DataConnector')
        c.argument('aatp_data_connector', action=AddAatpDataConnector, nargs='+', help='Represents AATP (Azure Advanced'
                   ' Threat Protection) data connector.', arg_group='DataConnector')
        c.argument('asc_data_connector', action=AddAscDataConnector, nargs='+', help='Represents ASC (Azure Security Ce'
                   'nter) data connector.', arg_group='DataConnector')
        ...
        c.argument('m_c_a_s_data_connector', action=AddMCASDataConnector, nargs='+', help='Represents MCAS (Microsoft C'
                   'loud App Security) data connector.', arg_group='DataConnector')
        c.argument('mdatp_data_connector', action=AddMdatpDataConnector, nargs='+', help='Represents MDATP (Microsoft D'
                   'efender Advanced Threat Protection) data connector.', arg_group='DataConnector')
        c.argument('office_data_connector', action=AddOfficeDataConnector, nargs='+', help='Represents office data conn'
                   'ector.', arg_group='DataConnector')
        c.argument('t_i_data_connector', action=AddTIDataConnector, nargs='+', help='Represents threat intelligence dat'
                   'a connector.', arg_group='DataConnector')
    ...
    with self.argument_context('sentinel data-connector update') as c:
        ...
        c.argument('t_i_data_connector', action=AddTIDataConnector, nargs='+', help='Represents threat intelligence dat'
                   'a connector.', arg_group='DataConnector')
        c.ignore('AadDataConnector', 'AatpDataConnector', 'AscDataConnector', 'AwsCloudTrailDataConnector', 'MCASDataCo'
                 'nnector', 'MdatpDataConnector', 'OfficeDataConnector', 'TIDataConnector')
    ...
    with self.argument_context('sentinel incident show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('incident_id', help='Incident ID', id_part='child_name_1')
    ...
    with self.argument_context('sentinel incident-comment show') as c:
        ...
        c.argument('workspace_name', help='The name of the workspace.', id_part='name')
        c.argument('incident_id', help='Incident ID', id_part='child_name_1')
        c.argument('incident_comment_id', help='Incident comment ID', id_part='child_name_2')

...
@register_command(
    "sentinel analytics-setting create",
...
class Create(AAZCommand):
    ...
    class SecurityMLAnalyticsSettingsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            disc_anomaly = cls._schema_on_200_201.discriminate_by("kind", "Anomaly")
            disc_anomaly.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties
            ...
            required_data_connectors = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties.required_data_connectors
            required_data_connectors.Element = AAZObjectType()

            _element = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties.required_data_connectors.Element
            ...
            data_types = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties.required_data_connectors.Element.data_types
            data_types.Element = AAZStrType()

            tactics = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties.tactics
            tactics.Element = AAZStrType()

            techniques = cls._schema_on_200_201.discriminate_by("kind", "Anomaly").properties.techniques

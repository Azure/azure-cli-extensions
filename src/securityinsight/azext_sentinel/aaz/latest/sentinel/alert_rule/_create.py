...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_alert_details_override_create(nrt.alert_details_override)
        ...
        cls._build_args_entity_mappings_create(nrt.entity_mappings)
        ...
        cls._build_args_incident_configuration_create(nrt.incident_configuration)
        nrt.query = AAZStrArg(
            options=["query"],
        ...
        cls._build_args_alert_details_override_create(scheduled.alert_details_override)
        ...
        cls._build_args_entity_mappings_create(scheduled.entity_mappings)
        ...
        cls._build_args_incident_configuration_create(scheduled.incident_configuration)
    ...
    _args_alert_details_override_create = None

    @classmethod
    def _build_args_alert_details_override_create(cls, _schema):
        if cls._args_alert_details_override_create is not None:
            _schema.alert_description_format = cls._args_alert_details_override_create.alert_description_format
            _schema.alert_display_name_format = cls._args_alert_details_override_create.alert_display_name_format
            _schema.alert_severity_column_name = cls._args_alert_details_override_create.alert_severity_column_name
            _schema.alert_tactics_column_name = cls._args_alert_details_override_create.alert_tactics_column_name
            return

        cls._args_alert_details_override_create = AAZObjectArg()

        alert_details_override_create = cls._args_alert_details_override_create
        alert_details_override_create.alert_description_format = AAZStrArg(
            options=["alert-description-format"],
            help="the format containing columns name(s) to override the alert description",
        )
        alert_details_override_create.alert_display_name_format = AAZStrArg(
            options=["alert-display-name-format"],
            help="the format containing columns name(s) to override the alert name",
        )
        alert_details_override_create.alert_severity_column_name = AAZStrArg(
            options=["alert-severity-column-name"],
            help="the column name to take the alert severity from",
        )
        alert_details_override_create.alert_tactics_column_name = AAZStrArg(
    ...
    _args_entity_mappings_create = None

    @classmethod
    def _build_args_entity_mappings_create(cls, _schema):
        if cls._args_entity_mappings_create is not None:
            _schema.Element = cls._args_entity_mappings_create.Element
            return

        cls._args_entity_mappings_create = AAZListArg()

        entity_mappings_create = cls._args_entity_mappings_create
        entity_mappings_create.Element = AAZObjectArg()

        _element = cls._args_entity_mappings_create.Element
        ...
        field_mappings = cls._args_entity_mappings_create.Element.field_mappings
        field_mappings.Element = AAZObjectArg()

        _element = cls._args_entity_mappings_create.Element.field_mappings.Element
    ...
    _args_incident_configuration_create = None

    @classmethod
    def _build_args_incident_configuration_create(cls, _schema):
        if cls._args_incident_configuration_create is not None:
            _schema.create_incident = cls._args_incident_configuration_create.create_incident
            _schema.grouping_configuration = cls._args_incident_configuration_create.grouping_configuration
            return

        cls._args_incident_configuration_create = AAZObjectArg()

        incident_configuration_create = cls._args_incident_configuration_create
        incident_configuration_create.create_incident = AAZBoolArg(
            options=["create-incident"],
            help="Create incidents from alerts triggered by this analytics rule",
            required=True,
        )
        incident_configuration_create.grouping_configuration = AAZObjectArg(
        ...
        grouping_configuration = cls._args_incident_configuration_create.grouping_configuration
        ...
        group_by_alert_details = cls._args_incident_configuration_create.grouping_configuration.group_by_alert_details
        group_by_alert_details.Element = AAZStrArg(
            enum={"DisplayName": "DisplayName", "Severity": "Severity"},
        )

        group_by_custom_details = cls._args_incident_configuration_create.grouping_configuration.group_by_custom_details
        group_by_custom_details.Element = AAZStrArg()

        group_by_entities = cls._args_incident_configuration_create.grouping_configuration.group_by_entities
    ...
    class AlertRulesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                _build_schema_alert_details_override_create(properties.set_prop("alertDetailsOverride", AAZObjectType, ".nrt.alert_details_override"))
                ...
                _build_schema_entity_mappings_create(properties.set_prop("entityMappings", AAZListType, ".nrt.entity_mappings"))
                _build_schema_incident_configuration_create(properties.set_prop("incidentConfiguration", AAZObjectType, ".nrt.incident_configuration"))
            ...
            if properties is not None:
                _build_schema_alert_details_override_create(properties.set_prop("alertDetailsOverride", AAZObjectType, ".scheduled.alert_details_override"))
                ...
                _build_schema_entity_mappings_create(properties.set_prop("entityMappings", AAZListType, ".scheduled.entity_mappings"))
                properties.set_prop("eventGroupingSettings", AAZObjectType, ".scheduled.event_grouping_settings")
                _build_schema_incident_configuration_create(properties.set_prop("incidentConfiguration", AAZObjectType, ".scheduled.incident_configuration"))
        ...
        def _build_schema_on_200_201(cls):
            ...
            disc_fusion = cls._schema_on_200_201.discriminate_by("kind", "Fusion")
            disc_fusion.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties
            ...
            scenario_exclusion_patterns = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.scenario_exclusion_patterns
            scenario_exclusion_patterns.Element = AAZObjectType()

            _element = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.scenario_exclusion_patterns.Element
            ...
            source_settings = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings
            source_settings.Element = AAZObjectType()

            _element = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element
            ...
            source_sub_types = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element.source_sub_types
            source_sub_types.Element = AAZObjectType()

            _element = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element.source_sub_types.Element
            _element.enabled = AAZBoolType(
                flags={"required": True},
            )
            ...
            severity_filters = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element.source_sub_types.Element.severity_filters
            ...
            filters = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element.source_sub_types.Element.severity_filters.filters
            filters.Element = AAZObjectType()

            _element = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.source_settings.Element.source_sub_types.Element.severity_filters.filters.Element
            _element.enabled = AAZBoolType(
                flags={"required": True},
            )
            ...
            tactics = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.tactics
            tactics.Element = AAZStrType(
                flags={"read_only": True},
            )

            techniques = cls._schema_on_200_201.discriminate_by("kind", "Fusion").properties.techniques
            techniques.Element = AAZStrType(
                flags={"read_only": True},
            )

            disc_ml_behavior_analytics = cls._schema_on_200_201.discriminate_by("kind", "MLBehaviorAnalytics")
            disc_ml_behavior_analytics.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "MLBehaviorAnalytics").properties
            properties.alert_rule_template_name = AAZStrType(
                serialized_name="alertRuleTemplateName",
                flags={"required": True},
            )
            ...
            tactics = cls._schema_on_200_201.discriminate_by("kind", "MLBehaviorAnalytics").properties.tactics
            tactics.Element = AAZStrType(
                flags={"read_only": True},
            )

            techniques = cls._schema_on_200_201.discriminate_by("kind", "MLBehaviorAnalytics").properties.techniques
            techniques.Element = AAZStrType(
                flags={"read_only": True},
            )

            disc_microsoft_security_incident_creation = cls._schema_on_200_201.discriminate_by("kind", "MicrosoftSecurityIncidentCreation")
            disc_microsoft_security_incident_creation.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "MicrosoftSecurityIncidentCreation").properties
            properties.alert_rule_template_name = AAZStrType(
                serialized_name="alertRuleTemplateName",
            )
            properties.description = AAZStrType()
            ...
            display_names_exclude_filter = cls._schema_on_200_201.discriminate_by("kind", "MicrosoftSecurityIncidentCreation").properties.display_names_exclude_filter
            display_names_exclude_filter.Element = AAZStrType()

            display_names_filter = cls._schema_on_200_201.discriminate_by("kind", "MicrosoftSecurityIncidentCreation").properties.display_names_filter
            display_names_filter.Element = AAZStrType()

            severities_filter = cls._schema_on_200_201.discriminate_by("kind", "MicrosoftSecurityIncidentCreation").properties.severities_filter
            severities_filter.Element = AAZStrType()

            disc_nrt = cls._schema_on_200_201.discriminate_by("kind", "NRT")
            disc_nrt.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "NRT").properties
            ...
            custom_details = cls._schema_on_200_201.discriminate_by("kind", "NRT").properties.custom_details
            custom_details.Element = AAZStrType()

            tactics = cls._schema_on_200_201.discriminate_by("kind", "NRT").properties.tactics
            tactics.Element = AAZStrType()

            techniques = cls._schema_on_200_201.discriminate_by("kind", "NRT").properties.techniques
            techniques.Element = AAZStrType()

            disc_scheduled = cls._schema_on_200_201.discriminate_by("kind", "Scheduled")
            disc_scheduled.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.discriminate_by("kind", "Scheduled").properties
            properties.alert_details_override = AAZObjectType(
                serialized_name="alertDetailsOverride",
            )
            _build_schema_alert_details_override_read(properties.alert_details_override)
            ...
            custom_details = cls._schema_on_200_201.discriminate_by("kind", "Scheduled").properties.custom_details
            custom_details.Element = AAZStrType()

            event_grouping_settings = cls._schema_on_200_201.discriminate_by("kind", "Scheduled").properties.event_grouping_settings
            event_grouping_settings.aggregation_kind = AAZStrType(
                serialized_name="aggregationKind",
            )

            tactics = cls._schema_on_200_201.discriminate_by("kind", "Scheduled").properties.tactics
            tactics.Element = AAZStrType()

            techniques = cls._schema_on_200_201.discriminate_by("kind", "Scheduled").properties.techniques
            techniques.Element = AAZStrType()
            ...
            tactics = cls._schema_on_200_201.discriminate_by("kind", "ThreatIntelligence").properties.tactics
            tactics.Element = AAZStrType(
                flags={"read_only": True},
            )

            techniques = cls._schema_on_200_201.discriminate_by("kind", "ThreatIntelligence").properties.techniques
            techniques.Element = AAZStrType(
                flags={"read_only": True},
            )
...
def _build_schema_alert_details_override_create(_builder):
    if _builder is None:
        return
...
def _build_schema_entity_mappings_create(_builder):
    if _builder is None:
        return
    ...
    if _elements is not None:
        _elements.set_prop("entityType", AAZStrType, "@EntityMappings_create.[].entity_type")
        _elements.set_prop("fieldMappings", AAZListType, "@EntityMappings_create.[].field_mappings")
    ...
    if _elements is not None:
        _elements.set_prop("columnName", AAZStrType, "@EntityMappings_create.[].field_mappings.[].column_name")
        _elements.set_prop("identifier", AAZStrType, "@EntityMappings_create.[].field_mappings.[].identifier")


def _build_schema_incident_configuration_create(_builder):
    if _builder is None:
        return

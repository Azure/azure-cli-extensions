...
@register_command(
    "sentinel source-control update",
...
def _build_schema_source_control_read(_schema):
    global _schema_source_control_read
    if _schema_source_control_read is not None:
        _schema.etag = _schema_source_control_read.etag
        _schema.id = _schema_source_control_read.id
        _schema.name = _schema_source_control_read.name
        _schema.properties = _schema_source_control_read.properties
        _schema.system_data = _schema_source_control_read.system_data
        _schema.type = _schema_source_control_read.type
        return

    _schema_source_control_read = AAZObjectType()

    source_control_read = _schema_source_control_read
    source_control_read.etag = AAZStrType()
    ...
    source_control_read.system_data = AAZObjectType(
    ...
    content_types = _schema_source_control_read.properties.content_types
    content_types.Element = AAZStrType()

    last_deployment_info = _schema_source_control_read.properties.last_deployment_info
    ...
    deployment = _schema_source_control_read.properties.last_deployment_info.deployment
    ...
    repository = _schema_source_control_read.properties.repository
    ...
    path_mapping = _schema_source_control_read.properties.repository.path_mapping
    path_mapping.Element = AAZObjectType()

    _element = _schema_source_control_read.properties.repository.path_mapping.Element
    _element.content_type = AAZStrType(
        serialized_name="contentType",
    )
    _element.path = AAZStrType()

    repository_resource_info = _schema_source_control_read.properties.repository_resource_info
    ...
    azure_dev_ops_resource_info = _schema_source_control_read.properties.repository_resource_info.azure_dev_ops_resource_info
    ...
    git_hub_resource_info = _schema_source_control_read.properties.repository_resource_info.git_hub_resource_info
    git_hub_resource_info.app_installation_id = AAZStrType(
        serialized_name="appInstallationId",
    )

    webhook = _schema_source_control_read.properties.repository_resource_info.webhook
    ...
    system_data = _schema_source_control_read.system_data

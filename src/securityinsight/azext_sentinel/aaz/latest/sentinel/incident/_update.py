...
_schema_incident_read = None


def _build_schema_incident_read(_schema):
    global _schema_incident_read
    if _schema_incident_read is not None:
        _schema.etag = _schema_incident_read.etag
        _schema.id = _schema_incident_read.id
        _schema.name = _schema_incident_read.name
        _schema.properties = _schema_incident_read.properties
        _schema.system_data = _schema_incident_read.system_data
        _schema.type = _schema_incident_read.type
        return

    _schema_incident_read = AAZObjectType()

    incident_read = _schema_incident_read
    incident_read.etag = AAZStrType()
    incident_read.id = AAZStrType(
        flags={"read_only": True},
    )
    incident_read.name = AAZStrType(
        flags={"read_only": True},
    )
    incident_read.properties = AAZObjectType(
        flags={"client_flatten": True},
    )
    incident_read.system_data = AAZObjectType(
        serialized_name="systemData",
        flags={"read_only": True},
    )
    incident_read.type = AAZStrType(
        flags={"read_only": True},
    )

    properties = _schema_incident_read.properties
    ...
    additional_data = _schema_incident_read.properties.additional_data
    ...
    alert_product_names = _schema_incident_read.properties.additional_data.alert_product_names
    alert_product_names.Element = AAZStrType(
        flags={"read_only": True},
    )

    tactics = _schema_incident_read.properties.additional_data.tactics
    tactics.Element = AAZStrType(
        flags={"read_only": True},
    )

    techniques = _schema_incident_read.properties.additional_data.techniques
    techniques.Element = AAZStrType(
        flags={"read_only": True},
    )

    labels = _schema_incident_read.properties.labels
    labels.Element = AAZObjectType()

    _element = _schema_incident_read.properties.labels.Element
    ...
    owner = _schema_incident_read.properties.owner
    ...
    related_analytic_rule_ids = _schema_incident_read.properties.related_analytic_rule_ids
    related_analytic_rule_ids.Element = AAZStrType(
        flags={"read_only": True},
    )

    team_information = _schema_incident_read.properties.team_information
    ...
    system_data = _schema_incident_read.system_data

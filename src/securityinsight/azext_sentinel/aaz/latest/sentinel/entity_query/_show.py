...
class Show(AAZCommand):
    ...
    class EntityQueriesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_expansion = cls._schema_on_200.discriminate_by("kind", "Expansion")
            disc_expansion.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200.discriminate_by("kind", "Expansion").properties
            ...
            data_sources = cls._schema_on_200.discriminate_by("kind", "Expansion").properties.data_sources
            data_sources.Element = AAZStrType()

            input_fields = cls._schema_on_200.discriminate_by("kind", "Expansion").properties.input_fields
            input_fields.Element = AAZStrType()

            output_entity_types = cls._schema_on_200.discriminate_by("kind", "Expansion").properties.output_entity_types

...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.EntityQueriesGet(ctx=self.ctx)()
...
_schema_entity_query_read = None


def _build_schema_entity_query_read(_schema):
    global _schema_entity_query_read
    if _schema_entity_query_read is not None:
        _schema.etag = _schema_entity_query_read.etag
        _schema.id = _schema_entity_query_read.id
        _schema.kind = _schema_entity_query_read.kind
        _schema.name = _schema_entity_query_read.name
        _schema.system_data = _schema_entity_query_read.system_data
        _schema.type = _schema_entity_query_read.type
        _schema.discriminate_by(
            "kind",
            "Activity",
            _schema_entity_query_read.discriminate_by(
                "kind",
                "Activity",
            )
        )
    ...
    _schema_entity_query_read = AAZObjectType()

    entity_query_read = _schema_entity_query_read
    entity_query_read.etag = AAZStrType()
    entity_query_read.id = AAZStrType(
        flags={"read_only": True},
    )
    entity_query_read.kind = AAZStrType(
        flags={"required": True},
    )
    entity_query_read.name = AAZStrType(
        flags={"read_only": True},
    )
    entity_query_read.system_data = AAZObjectType(
        serialized_name="systemData",
        flags={"read_only": True},
    )
    entity_query_read.type = AAZStrType(
        flags={"read_only": True},
    )

    system_data = _schema_entity_query_read.system_data
    ...
    disc_activity = _schema_entity_query_read.discriminate_by("kind", "Activity")
    disc_activity.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_entity_query_read.discriminate_by("kind", "Activity").properties
    ...
    entities_filter = _schema_entity_query_read.discriminate_by("kind", "Activity").properties.entities_filter
    entities_filter.Element = AAZListType()

    _element = _schema_entity_query_read.discriminate_by("kind", "Activity").properties.entities_filter.Element
    _element.Element = AAZStrType()

    query_definitions = _schema_entity_query_read.discriminate_by("kind", "Activity").properties.query_definitions
    query_definitions.query = AAZStrType()

    required_input_fields_sets = _schema_entity_query_read.discriminate_by("kind", "Activity").properties.required_input_fields_sets
    required_input_fields_sets.Element = AAZListType()

    _element = _schema_entity_query_read.discriminate_by("kind", "Activity").properties.required_input_fields_sets.Element
    _element.Element = AAZStrType()

    disc_expansion = _schema_entity_query_read.discriminate_by("kind", "Expansion")
    disc_expansion.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_entity_query_read.discriminate_by("kind", "Expansion").properties
    ...
    data_sources = _schema_entity_query_read.discriminate_by("kind", "Expansion").properties.data_sources
    data_sources.Element = AAZStrType()

    input_fields = _schema_entity_query_read.discriminate_by("kind", "Expansion").properties.input_fields
    input_fields.Element = AAZStrType()

    output_entity_types = _schema_entity_query_read.discriminate_by("kind", "Expansion").properties.output_entity_types

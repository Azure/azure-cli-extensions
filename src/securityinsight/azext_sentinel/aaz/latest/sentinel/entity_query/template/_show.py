...
@register_command(
    "sentinel entity-query template show",
...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.operationalinsights/workspaces/{}/providers/microsoft.securityinsights/entityquerytemplates/{}", "2022-06-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.entity_query_template_id = AAZStrArg(
            options=["-n", "--name", "--entity-query-template-id"],
            help="entity query template ID",
            required=True,
    ...
    def _execute_operations(self):
        self.EntityQueryTemplatesGet(ctx=self.ctx)()
    ...
    class EntityQueryTemplatesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_activity = cls._schema_on_200.discriminate_by("kind", "Activity")
            disc_activity.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200.discriminate_by("kind", "Activity").properties
            ...
            data_types = cls._schema_on_200.discriminate_by("kind", "Activity").properties.data_types
            data_types.Element = AAZObjectType()

            _element = cls._schema_on_200.discriminate_by("kind", "Activity").properties.data_types.Element
            _element.data_type = AAZStrType(
                serialized_name="dataType",
            )

            entities_filter = cls._schema_on_200.discriminate_by("kind", "Activity").properties.entities_filter
            entities_filter.Element = AAZListType()

            _element = cls._schema_on_200.discriminate_by("kind", "Activity").properties.entities_filter.Element
            _element.Element = AAZStrType()

            query_definitions = cls._schema_on_200.discriminate_by("kind", "Activity").properties.query_definitions
            query_definitions.query = AAZStrType()
            query_definitions.summarize_by = AAZStrType(
                serialized_name="summarizeBy",
            )

            required_input_fields_sets = cls._schema_on_200.discriminate_by("kind", "Activity").properties.required_input_fields_sets
            required_input_fields_sets.Element = AAZListType()

            _element = cls._schema_on_200.discriminate_by("kind", "Activity").properties.required_input_fields_sets.Element
            _element.Element = AAZStrType()

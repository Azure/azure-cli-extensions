...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.operationalinsights/workspaces/{}/providers/microsoft.securityinsights/officeconsents/{}", "2022-06-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.OfficeConsentsGet(ctx=self.ctx)()

...
def _build_schema_settings_read(_schema):
    global _schema_settings_read
    if _schema_settings_read is not None:
        _schema.etag = _schema_settings_read.etag
        _schema.id = _schema_settings_read.id
        _schema.kind = _schema_settings_read.kind
        _schema.name = _schema_settings_read.name
        _schema.system_data = _schema_settings_read.system_data
        _schema.type = _schema_settings_read.type
    ...
    _schema_settings_read = AAZObjectType()

    settings_read = _schema_settings_read
    settings_read.etag = AAZStrType()
    settings_read.id = AAZStrType(
        flags={"read_only": True},
    )
    settings_read.kind = AAZStrType(
        flags={"required": True},
    )
    ...
    disc_anomalies = _schema_settings_read.discriminate_by("kind", "Anomalies")
    disc_anomalies.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_settings_read.discriminate_by("kind", "Anomalies").properties
    properties.is_enabled = AAZBoolType(
        serialized_name="isEnabled",
        flags={"read_only": True},
    )

    disc_entity_analytics = _schema_settings_read.discriminate_by("kind", "EntityAnalytics")
    disc_entity_analytics.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_settings_read.discriminate_by("kind", "EntityAnalytics").properties
    properties.entity_providers = AAZListType(
        serialized_name="entityProviders",
    )

    entity_providers = _schema_settings_read.discriminate_by("kind", "EntityAnalytics").properties.entity_providers
    entity_providers.Element = AAZStrType()

    disc_eyes_on = _schema_settings_read.discriminate_by("kind", "EyesOn")
    disc_eyes_on.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_settings_read.discriminate_by("kind", "EyesOn").properties
    properties.is_enabled = AAZBoolType(
        serialized_name="isEnabled",
        flags={"read_only": True},
    )

    disc_ueba = _schema_settings_read.discriminate_by("kind", "Ueba")
    disc_ueba.properties = AAZObjectType(
        flags={"client_flatten": True},
    )

    properties = _schema_settings_read.discriminate_by("kind", "Ueba").properties
    properties.data_sources = AAZListType(
        serialized_name="dataSources",
    )

    data_sources = _schema_settings_read.discriminate_by("kind", "Ueba").properties.data_sources

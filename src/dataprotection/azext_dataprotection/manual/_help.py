...
helps['dataprotection backup-instance create'] = """
    type: command
    short-summary: Configure backup for a resource in a backup vault.
    examples:
      - name: create a backup instance in a backup vault
        text: az dataprotection backup-instance create -g MyResourceGroup --vault-name MyVault --backup-instance backupinstance.json
"""
...
helps['dataprotection backup-instance restore'] = """
    type: group
    short-summary: Restore backed up instances from recovery points in a backup vault.
"""

...
class RestorableTimeRangeScenarioTest(ScenarioTest):
    ...
    def test_dataprotection_restorable_time_range_find(test):
        ...
        test.cmd('az dataprotection restorable-time-range find --source-data-store-type "OperationalStore" -g "{rg}" --vault-name "{vaultName}" --backup-instance-name "{backupInstanceName}"', checks=[
        ...
        test.cmd('az dataprotection restorable-time-range find --source-data-store-type "OperationalStore" -g "{rg}" --vault-name "{vaultName}" --backup-instance-name "{backupInstanceName}" '
                 '--start-time 2001-02-27T12:00:00.000Z --end-time 2002-05-14T14:10:00.000Z')
        test.cmd('az dataprotection restorable-time-range find --source-data-store-type "OperationalStore" -g "{rg}" --vault-name "{vaultName}" --backup-instance-name "{backupInstanceName}" '
                 '--start-time 2001-02-27T12:00:00.00Z --end-time 2002-05-14T14:10:00.00Z')
        test.cmd('az dataprotection restorable-time-range find --source-data-store-type "OperationalStore" -g "{rg}" --vault-name "{vaultName}" --backup-instance-name "{backupInstanceName}" '
                 '--start-time 2001-02-27T12:00:00 --end-time 2002-05-14T14:10:00')
        test.cmd('az dataprotection restorable-time-range find --source-data-store-type "OperationalStore" -g "{rg}" --vault-name "{vaultName}" --backup-instance-name "{backupInstanceName}" '

...
class RestorableTimeRangesOperations(object):
    ...
    def find(
        ...
        backup_instances,  # type: str
        parameters,  # type: "models.AzureBackupFindRestorableTimeRangesRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AzureBackupFindRestorableTimeRangesResponseResource"
        """find.
        ...
        path_format_arguments = {
            ...
            'backupInstances': self._serialize.url("backup_instances", backup_instances, 'str'),
        }
        ...
        return deserialized
    find.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstances}/findRestorableTimeRanges'}  # type: ignore

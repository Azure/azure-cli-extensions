...
class AzureBackupFindRestorableTimeRangesRequest(msrest.serialization.Model):
    ...
    :param start_time: Required. Start time for the List Restore Ranges request.
    :type start_time: str
...
class AzureBackupJob(msrest.serialization.Model):
    ...
    :param data_source_set_name: Required. Data Source Set Name of the DataSource.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.data_source_set_name = kwargs['data_source_set_name']
...
class OperationExtendedInfo(msrest.serialization.Model):
    ...
    :param object_type: This property will be used as the discriminator for deciding the specific

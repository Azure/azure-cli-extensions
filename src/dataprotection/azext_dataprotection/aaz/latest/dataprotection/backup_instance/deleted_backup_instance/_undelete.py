...
class Undelete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DeletedBackupInstancesUndelete(ctx=self.ctx)()
    ...
    class DeletedBackupInstancesUndelete(AAZHttpOperation):
...
class _UndeleteHelper:
    """Helper class for Undelete"""

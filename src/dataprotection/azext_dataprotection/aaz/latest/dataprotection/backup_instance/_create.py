    ...
    class BackupInstancesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if data_source_info is not None:
                ...
                _CreateHelper._build_schema_base_resource_properties_create(data_source_info.set_prop("resourceProperties", AAZObjectType, ".resource_properties"))
            ...
            if data_source_set_info is not None:
                ...
                _CreateHelper._build_schema_base_resource_properties_create(data_source_set_info.set_prop("resourceProperties", AAZObjectType, ".resource_properties"))

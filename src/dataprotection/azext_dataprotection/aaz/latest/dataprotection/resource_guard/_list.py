...
class List(AAZCommand):
    ...
    :example: List ResourceGuards in a subscription
        az dataprotection resource-guard list

    :example: List ResourceGuards in a resource group
    ...
    class ResourceGuardsGetResourcesInResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            resource_guard_operations = cls._schema_on_200.value.Element.properties.resource_guard_operations
            resource_guard_operations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_guard_operations.Element
            ...
            vault_critical_operation_exclusion_list = cls._schema_on_200.value.Element.properties.vault_critical_operation_exclusion_list

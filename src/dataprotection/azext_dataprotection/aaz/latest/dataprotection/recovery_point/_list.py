...
class List(AAZCommand):
    ...
    :example: List Recovery Points in a Vault
        az dataprotection recovery-point list --backup-instance-name "testInstance1" --resource- group "000pikumar" --vault-name "PratikPrivatePreviewVault1"
    """

    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.dataprotection/backupvaults/{}/backupinstances/{}/recoverypoints", "2025-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.skip_token = AAZStrArg(
            options=["--skip-token"],
            help="skipToken Filter.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.RecoveryPointsList(ctx=self.ctx)()
    ...
    class RecoveryPointsList(AAZHttpOperation):

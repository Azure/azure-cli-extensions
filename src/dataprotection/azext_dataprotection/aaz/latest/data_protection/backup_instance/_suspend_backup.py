...
@register_command(
    "data-protection backup-instance suspend-backup",
...
class SuspendBackup(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BackupInstancesSuspendBackups(ctx=self.ctx)()
    ...
    class BackupInstancesSuspendBackups(AAZHttpOperation):
...
class _SuspendBackupHelper:
    """Helper class for SuspendBackup"""


__all__ = ["SuspendBackup"]

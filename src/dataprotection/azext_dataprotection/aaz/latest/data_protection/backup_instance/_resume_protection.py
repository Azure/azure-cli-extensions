...
@register_command(
    "data-protection backup-instance resume-protection",
    is_experimental=True,
)
class ResumeProtection(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BackupInstancesResumeProtection(ctx=self.ctx)()
    ...
    class BackupInstancesResumeProtection(AAZHttpOperation):
...
class _ResumeProtectionHelper:
    """Helper class for ResumeProtection"""


__all__ = ["ResumeProtection"]

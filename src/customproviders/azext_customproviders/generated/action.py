    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'routing-type':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter actions. All possible keys are: '
                               'routing-type, name, endpoint'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'routing-type':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter resource_types. All possible keys are: '
                               'routing-type, name, endpoint'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'validation-type':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter validations. All possible keys are: '
                               'validation-type, specification'.format(k))
        return d

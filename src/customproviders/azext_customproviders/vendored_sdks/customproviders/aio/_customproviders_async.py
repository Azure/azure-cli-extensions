...
class Customproviders(object):
    ...
    :vartype operation: customproviders.aio.operations_async.OperationOperations
    :ivar custom_resource_provider: CustomResourceProviderOperations operations
    :vartype custom_resource_provider: customproviders.aio.operations_async.CustomResourceProviderOperations
    :ivar association: AssociationOperations operations
    :vartype association: customproviders.aio.operations_async.AssociationOperations

...
class CommunityGalleryImagesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type public_gallery_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CommunityGalleryImageList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_07_01.models.CommunityGalleryImageList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

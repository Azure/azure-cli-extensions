...
class CommunityGalleryImagesOperations:
    ...
    async def list(
        ...
        public_gallery_name: str,
        **kwargs: Any
    ) -> "_models.CommunityGalleryImageList":
        ...
        :type public_gallery_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CommunityGalleryImageList, or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2021_07_01.models.CommunityGalleryImageList
        :raises: ~azure.core.exceptions.HttpResponseError
        """

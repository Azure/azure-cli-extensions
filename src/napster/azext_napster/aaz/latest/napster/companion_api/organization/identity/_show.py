...
@register_command(
    "napster companion-api organization identity show",
)
class Show(AAZCommand):
    """Show the details of managed identities.

    :example: Organizations_Get_MaximumSet - generated by [MaximumSet] rule
        az napster companion-api organization identity show --resource-group acctest0001 --organizationname napster-test-saml
    """
    ...
    class OrganizationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_organization_resource_read(cls._schema_on_200)

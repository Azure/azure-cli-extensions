...
@register_command(
    "napster companion-api organization create",
)
class Create(AAZCommand):
    """Create a OrganizationResource

    :example: Organizations_CreateOrUpdate_MaximumSet - generated by [MaximumSet] rule
        az napster companion-api organization create --resource-group acctest0001 --organizationname napster-test-saml --marketplace "{subscription-id:09fffd7d-d000-4467-cc23-d82b97e9431d,offer-details:{publisher-id:touchcastinc1655995956899,offer-id:napster_companion_api,plan-id:napster_companion_api_feb_2026,plan-name:'Pay As You Go',term-unit:P1M,term-id:n7ja87drquhy},saas-resource-id:/subscriptions/61641157-140c-4b97-b365-30ff76d9f82e/resourceGroups/acctest0001/providers/Microsoft.SaaS/resources/napsterSaaS}" --user "{first-name:Yashika,last-name:Jain,email-address:yashikajain@microsoft.com,upn:yashikajain@microsoft.com,phone-number:+1-425-555-1234}" --partner-properties "{application:dsaf}" --single-sign-on-properties "{type:Saml,state:Initial,enterprise-app-id:b2c3d4e5-f6a7-4b5c-8d9e-0f1a2b3c4d5e,url:'https://companion-api.napsterai.dev/admin/ms-auth',aad-domains:[MicrosoftCustomerLed.onmicrosoft.com]}" --type None --user-assigned-identities "{}" --tags "{}" --location eastus2euap
    """

...
@register_command(
    "napster companion-api organization update",
)
class Update(AAZCommand):
    """Update a OrganizationResource

    :example: Organizations_CreateOrUpdate_MaximumSet - generated by [MaximumSet] rule
        az napster companion-api organization update --resource-group acctest0001 --organizationname napster-test-saml
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.single_sign_on_properties = AAZObjectArg(
            options=["--sso", "--single-sign-on-properties"],
            arg_group="Properties",
        ...
        marketplace.saas_resource_id = AAZStrArg(
            options=["saas-resource-id"],
            help="Marketplace SaaS Resource Id",
            nullable=True,
        )
        ...
        partner_properties.application = AAZStrArg(
            options=["application"],
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if marketplace is not None:
                ...
                marketplace.set_prop("saasResourceId", AAZStrType, ".saas_resource_id")
            ...
            if offer_details is not None:
                ...
                offer_details.set_prop("planId", AAZStrType, ".plan_id")
            ...
            if partner_properties is not None:
                partner_properties.set_prop("application", AAZStrType, ".application", typ_kwargs={"flags": {"required": True}})

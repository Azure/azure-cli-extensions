...
@register_command(
    "napster companion-api organization identity remove",
)
class Remove(AAZCommand):
    """Remove the user or system managed identities.

    :example: Organizations_CreateOrUpdate_MaximumSet - generated by [MaximumSet] rule
        az napster companion-api organization identity remove --resource-group acctest0001 --organizationname napster-test-saml
    """
    ...
    class OrganizationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_organization_resource_read(cls._schema_on_200)
    ...
    class OrganizationsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_organization_resource_read(cls._schema_on_200_201)

...
class Create(AAZCommand):
    ...
    :example: Creates a receive side connection
        az azure-data-transfer connection create --resource-group testRG --connection-name testConnection --flow-types Mission API --location East US --justification justification --pipeline testdc --requirement-id id --direction Receive --remote-subscription-id 00000000-0000-0000-0000-000000000000

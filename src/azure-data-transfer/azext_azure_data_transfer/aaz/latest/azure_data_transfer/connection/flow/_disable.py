...
@register_command(
    "azure-data-transfer connection flow disable",
    is_preview=True,
)
class Disable(AAZCommand):
    ...
    :example: Disables the specified flow
        az azure-data-transfer connection flow disable --resource-group testRG --connection-name testConnection --flow-name testFlow
    """

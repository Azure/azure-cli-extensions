...
@register_command(
    "azure-data-transfer connection flow show",
)
class Show(AAZCommand):
    """Get flow resource.

    :example: Gets flow resource
        az azure-data-transfer connection flow show --resource-group testRG --connection-name testConnection --flow-name testFlow
    """

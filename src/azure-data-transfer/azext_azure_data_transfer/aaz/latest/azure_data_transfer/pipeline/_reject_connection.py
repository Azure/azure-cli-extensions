...
@register_command(
    "azure-data-transfer pipeline reject-connection",
)
class RejectConnection(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-27",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.AzureDataTransfer/pipelines/{}/rejectconnection", "2024-09-27"],
        ]
    }

...
import azext_interactive.azclishell.progress as prog
...
class ShellProgressViewTest(unittest.TestCase):
    ...
    def test_shell_progress_write(self):
        ...
        self.assertEqual(prog.ShellProgressView.progress_bar, "")
    ...
    def test_shell_progress_write_2(self):
        ...
        self.assertTrue(prog.ShellProgressView.progress_bar is not None)

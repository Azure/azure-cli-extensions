...
@register_command(
    "monitor data-collection endpoint association list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DataCollectionRuleAssociationsListByDataCollectionEndpoint(ctx=self.ctx)()
    ...
    class DataCollectionRuleAssociationsListByDataCollectionEndpoint(AAZHttpOperation):

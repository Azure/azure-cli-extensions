...
@register_command(
    "monitor data-collection rule association list-by-resource",
)
class ListByResource(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DataCollectionRuleAssociationsListByResource(ctx=self.ctx)()
    ...
    class DataCollectionRuleAssociationsListByResource(AAZHttpOperation):
...
class _ListByResourceHelper:
    """Helper class for ListByResource"""

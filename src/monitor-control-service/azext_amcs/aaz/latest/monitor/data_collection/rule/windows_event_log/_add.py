...
class Add(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.x_path_queries = AAZListArg(
        ...
        x_path_queries = cls._args_schema.x_path_queries
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("xPathQueries", AAZListType, ".x_path_queries")

            streams = _builder.get(".streams")
            if streams is not None:
                streams.set_elements(AAZStrType, ".")

            x_path_queries = _builder.get(".xPathQueries")

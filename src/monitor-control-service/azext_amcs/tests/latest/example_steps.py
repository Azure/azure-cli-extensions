...
def step_data_collection_rule_create(test, rg, checks=None):
    ...
    test.cmd('az monitor data-collection rule create '
             ...
             'Processor Time" counter-specifiers="\\\\Memory\\\\Committed Bytes" counter-specifiers="\\\\LogicalDisk(_T'
             'otal)\\\\Free Megabytes" counter-specifiers="\\\\PhysicalDisk(_Total)\\\\Avg. Disk Queue Length" '
             ...
             'Count" sampling-frequency-in-seconds=30 scheduled-transfer-period="PT5M" streams="Microsoft-Perf" '
             '--syslog name="cronSyslog" facility-names="cron" log-levels="Debug" log-levels="Critical" '
             ...
             'log-levels="Emergency" streams="Microsoft-Syslog" '
             '--windows-event-log name="cloudSecurityTeamEvents" scheduled-transfer-period="PT1M" '
             'streams="Microsoft-WindowsEvent" x-path-queries="Security!" '
             '--windows-event-log name="appTeam1AppEvents" scheduled-transfer-period="PT5M" '

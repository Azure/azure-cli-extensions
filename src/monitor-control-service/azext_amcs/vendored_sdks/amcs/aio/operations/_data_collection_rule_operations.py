...
class DataCollectionRuleOperations:
    """DataCollectionRuleOperations async operations.
    ...
    def list_by_resource_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.DataCollectionRuleResourceListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2019_11_01_preview.models.DataCollectionRuleResourceListResult]
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.DataCollectionRuleResource":
    ...
    async def create(
        ...
        data_flows: Optional[List["models.DataFlow"]] = None,
        log_analytics: Optional[List["models.LogAnalyticsDestination"]] = None,
        azure_monitor_metrics: Optional["models.AzureMonitorMetricsDestination"] = None,
        performance_counters: Optional[List["models.PerfCounterDataSource"]] = None,
        windows_event_logs: Optional[List["models.WindowsEventLogDataSource"]] = None,
        syslog: Optional[List["models.SyslogDataSource"]] = None,
        extensions: Optional[List["models.ExtensionDataSource"]] = None,
        **kwargs
    ) -> "models.DataCollectionRuleResource":

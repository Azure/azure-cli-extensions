...
class DataCollectionEndpointsOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.DataCollectionEndpointResourceListResult"]:
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.DataCollectionEndpointResource":
    ...
    async def create(
        ...
        resource_group_name: str,
        data_collection_endpoint_name: str,
        body: Optional["models.DataCollectionEndpointResource"] = None,
        **kwargs
    ) -> "models.DataCollectionEndpointResource":

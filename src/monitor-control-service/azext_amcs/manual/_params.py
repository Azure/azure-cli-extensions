...
def load_arguments(self, _):
    ...
    with self.argument_context('monitor data-collection rule') as c:
        ...
        c.argument('name', options_list=['--name', '-n'], type=str, help='The name of the data collection rule. The '
                   'name is case insensitive.', id_part='none')
        ...
        c.argument('data_sources_performance_counters', options_list=['--performance-counter'], arg_group="Data Source",
                   action=AddDataSourcesPerformanceCounters, nargs='+', help='The list of performance counter data '
                   'source configurations.')

        c.argument('data_sources_windows_event_logs', options_list=['--windows-event-log'], arg_group="Data Source",
                   action=AddDataSourcesWindowsEventLogs, nargs='+', help='The list of Windows Event Log data source '
                   'configurations.')
        c.argument('data_sources_syslog', options_list=['--syslog'], arg_group="Data Source",
                   action=AddDataSourcesSyslog, nargs='+', help='The list of Syslog data source configurations.')
        c.argument('data_sources_extensions', options_list=['--extensions'], arg_group="Data Source",

...
def load_arguments(self, _):
    ...
    with self.argument_context('monitor data-collection rule create') as c:
        ...
        c.argument('data_sources_performance_counters', options_list=['--performance-counter'],
                   action=AddDataSourcesPerformanceCounters, nargs='+', help='The list of performance counter data '
                   'source configurations.')
        c.argument('data_sources_windows_event_logs', options_list=['--windows-event-log'],
                   action=AddDataSourcesWindowsEventLogs, nargs='+', help='The list of Windows Event Log data source '
                   'configurations.')
        c.argument('data_sources_syslog', options_list=['--syslog'], action=AddDataSourcesSyslog, nargs='+', help='The '
                   'list of Syslog data source configurations.')

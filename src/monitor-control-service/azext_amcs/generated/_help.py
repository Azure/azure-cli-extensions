...
(regardless of type) within the data collection rule.
      ...
      - name: --destinations-azure-monitor-metrics
        ...
        long-summary: |
            ...
            name: Required. A friendly name for the destination.  This name should be unique across all destinations \
(regardless of type) within the data collection rule.
      - name: --data-sources-performance-counters
        short-summary: "The list of performance counter data source configurations."
        long-summary: |
            Usage: --data-sources-performance-counters streams=XX scheduled-transfer-period=XX \
sampling-frequency-in-seconds=XX counter-specifiers=XX name=XX
...
(regardless of type) within the data collection rule.
            ...
            Multiple actions can be specified by using more than one --data-sources-performance-counters argument.
      - name: --data-sources-windows-event-logs
        short-summary: "The list of Windows Event Log data source configurations."
        long-summary: |
            Usage: --data-sources-windows-event-logs streams=XX scheduled-transfer-period=XX x-path-queries=XX name=XX
...
(regardless of type) within the data collection rule.
            ...
            Multiple actions can be specified by using more than one --data-sources-windows-event-logs argument.
      - name: --data-sources-syslog
        short-summary: "The list of Syslog data source configurations."
        long-summary: |
            Usage: --data-sources-syslog streams=XX facility-names=XX log-levels=XX name=XX
...
(regardless of type) within the data collection rule.
            ...
            Multiple actions can be specified by using more than one --data-sources-syslog argument.
    examples:

...
@register_command(
    "network front-door waf-policy list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PoliciesList(ctx=self.ctx)()
    ...
    class PoliciesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            rules = cls._schema_on_200.value.Element.properties.custom_rules.rules
            rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element
            ...
            group_by = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.group_by
            group_by.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.group_by.Element
            _element.variable_name = AAZStrType(
                serialized_name="variableName",
                flags={"required": True},
            )

            match_conditions = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.match_conditions
            match_conditions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.match_conditions.Element
            ...
            match_value = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.match_conditions.Element.match_value
            match_value.Element = AAZStrType()

            transforms = cls._schema_on_200.value.Element.properties.custom_rules.rules.Element.match_conditions.Element.transforms
            ...
            exclusions = cls._schema_on_200.value.Element.properties.managed_rules.managed_rule_sets.Element.exclusions
            ...
            exclusions = cls._schema_on_200.value.Element.properties.managed_rules.managed_rule_sets.Element.rule_group_overrides.Element.exclusions
            exclusions.Element = AAZObjectType()
            _ListHelper._build_schema_managed_rule_exclusion_read(exclusions.Element)

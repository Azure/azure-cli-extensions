...
@register_command(
    "network front-door waf-policy managed-rules exception list",
)
class List(AAZCommand):
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.managedRules.exceptionsList.exceptions

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.managedRules.exceptionsList.exceptions = value
            return

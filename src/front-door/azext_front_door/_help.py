...
helps['network front-door'] = """
    type: group
    short-summary: Manage Classical Azure Front Doors. For managing Azure Front Door Standard/Premium, please refer https://learn.microsoft.com/cli/azure/afd?view=azure-cli-latest.
"""

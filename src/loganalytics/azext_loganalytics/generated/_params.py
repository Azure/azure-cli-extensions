...
def load_arguments(self, _):
    ...
    with self.argument_context('loganalytics dataexport list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics dataexport show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_export_name', options_list=['--name', '-n', '--data-export-name'], type=str, help='The data '
                   'export rule name.')

    with self.argument_context('loganalytics dataexport create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_export_name', options_list=['--name', '-n', '--data-export-name'], type=str, help='The data '
                   'export rule name.')
    ...
    with self.argument_context('loganalytics dataexport update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_export_name', options_list=['--name', '-n', '--data-export-name'], type=str, help='The data '
                   'export rule name.')
    ...
    with self.argument_context('loganalytics dataexport delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_export_name', options_list=['--name', '-n', '--data-export-name'], type=str, help='The data '
                   'export rule name.')

    with self.argument_context('loganalytics datasource list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
    ...
    with self.argument_context('loganalytics datasource show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_name', options_list=['--name', '-n', '--data-source-name'], type=str, help='Name of '
                   'the datasource')

    with self.argument_context('loganalytics datasource create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        ...
        c.argument('properties', type=validate_file_or_dict, help='The data source properties in raw json format, each '
                   'kind of data source have it\'s own schema. Expected value: json-string/json-file/@json-file.')
    ...
    with self.argument_context('loganalytics datasource update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_name', options_list=['--name', '-n', '--data-source-name'], type=str, help='The name '
                   'of the datasource resource.')
    ...
    with self.argument_context('loganalytics datasource delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_name', options_list=['--name', '-n', '--data-source-name'], type=str, help='Name of '
                   'the datasource.')

    with self.argument_context('loganalytics intelligencepack list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics intelligencepack disable') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
    ...
    with self.argument_context('loganalytics intelligencepack enable') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('intelligence_pack_name', options_list=['--name', '-n', '--intelligence-pack-name'], type=str,
                   help='The name of the intelligence pack to be enabled.')

    with self.argument_context('loganalytics linkedservice list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics linkedservice show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('linked_service_name', options_list=['--name', '-n', '--linked-service-name'], type=str, help='Name '
                   'of the linked service.')

    with self.argument_context('loganalytics linkedservice create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('linked_service_name', options_list=['--name', '-n', '--linked-service-name'], type=str, help='Name '
    ...
    with self.argument_context('loganalytics linkedservice update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('linked_service_name', options_list=['--name', '-n', '--linked-service-name'], type=str, help='Name '
                   'of the linkedServices resource')
    ...
    with self.argument_context('loganalytics linkedservice delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('linked_service_name', options_list=['--name', '-n', '--linked-service-name'], type=str, help='Name '
                   'of the linked service.')

    with self.argument_context('loganalytics linkedservice wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('linked_service_name', options_list=['--name', '-n', '--linked-service-name'], type=str, help='Name '
                   'of the linked service.')

    with self.argument_context('loganalytics linkedstorageaccount list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics linkedstorageaccount show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_type', arg_type=get_enum_type(['CustomLogs', 'AzureWatson', 'Query', 'Alerts']),
                   help='Linked storage accounts type.')

    with self.argument_context('loganalytics linkedstorageaccount create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_type', arg_type=get_enum_type(['CustomLogs', 'AzureWatson', 'Query', 'Alerts']),
                   help='Linked storage accounts type.')
    ...
    with self.argument_context('loganalytics linkedstorageaccount update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_type', arg_type=get_enum_type(['CustomLogs', 'AzureWatson', 'Query', 'Alerts']),
                   help='Linked storage accounts type.')
    ...
    with self.argument_context('loganalytics linkedstorageaccount delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('data_source_type', arg_type=get_enum_type(['CustomLogs', 'AzureWatson', 'Query', 'Alerts']),
                   help='Linked storage accounts type.')

    with self.argument_context('loganalytics managementgroup list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics operationstatuses show') as c:
        c.argument('location', arg_type=get_location_type(self.cli_ctx), id_part='name')
        c.argument('async_operation_id', type=str, help='The operation Id.', id_part='child_name_1')

    with self.argument_context('loganalytics sharedkey get-shared-key') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics sharedkey regenerate') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
    ...
    with self.argument_context('loganalytics storageinsightconfig list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics storageinsightconfig show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('storage_insight_name', type=str, help='Name of the storageInsightsConfigs resource')

    with self.argument_context('loganalytics storageinsightconfig create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('storage_insight_name', type=str, help='Name of the storageInsightsConfigs resource')
    ...
    with self.argument_context('loganalytics storageinsightconfig update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('storage_insight_name', type=str, help='Name of the storageInsightsConfigs resource')
        c.argument('e_tag', type=str, help='The ETag of the storage insight.')
    ...
    with self.argument_context('loganalytics storageinsightconfig delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('storage_insight_name', type=str, help='Name of the storageInsightsConfigs resource')

    with self.argument_context('loganalytics savedsearch list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')

    with self.argument_context('loganalytics savedsearch show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('saved_search_id', type=str, help='The id of the saved search.')

    with self.argument_context('loganalytics savedsearch create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('saved_search_id', type=str, help='The id of the saved search.')
        ...
        c.argument('input_query', type=str, help='The query expression for the saved search.')
    ...
    with self.argument_context('loganalytics savedsearch update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('saved_search_id', type=str, help='The id of the saved search.')
        c.argument('etag', type=str, help='The ETag of the saved search.')
    ...
    with self.argument_context('loganalytics savedsearch delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
        c.argument('saved_search_id', type=str, help='The id of the saved search.')

    with self.argument_context('loganalytics availableservicetier list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.')
    ...
    with self.argument_context('loganalytics workspacepurge purge') as c:
        c.argument('resource_group_name', resource_group_name_type)
        ...
        c.argument('filters', type=validate_file_or_dict, help='The set of columns and filters (queries) to run over '
                   'them to purge the resulting data. Expected value: json-string/json-file/@json-file.')

    with self.argument_context('loganalytics workspacepurge show-purge-status') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workspace_name', type=str, help='The name of the workspace.', id_part='name')
    ...
    with self.argument_context('loganalytics cluster create') as c:
        ...
        c.argument('billing_type', arg_type=get_enum_type(['Cluster', 'Workspaces']), help='Configures whether billing '
                   'will be only on the cluster or each workspace will be billed by its proportional use. This does '
                   'not change the overall billing, only how it will be distributed. Default value is \'Cluster\'')
        ...
        c.argument('type_', options_list=['--type'],
                   arg_type=get_enum_type(['SystemAssigned', 'UserAssigned', 'None']),
                   help='Type of managed service identity.', arg_group='Identity')
    ...
    with self.argument_context('loganalytics table update') as c:
        ...
        c.argument('table_name', options_list=['--name', '-n', '--table-name'], type=str,
                   help='The name of the table.')
        c.argument('retention_in_days', type=int, help='The data table data retention in days, between 7 and 730. '
                   'Setting this property to null will default to the workspace retention.')
        c.argument('is_troubleshoot_enabled', arg_type=get_three_state_flag(), help='Enable or disable troubleshoot '
                   'for this table.')
    ...
    with self.argument_context('loganalytics workspace create') as c:
        ...
        c.argument('features', type=validate_file_or_dict, help='Workspace features. Expected value: '
    ...
    with self.argument_context('loganalytics deletedworkspace list') as c:
        c.argument('resource_group_name', resource_group_name_type)

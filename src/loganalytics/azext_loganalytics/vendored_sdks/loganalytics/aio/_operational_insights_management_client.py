...
class OperationalInsightsManagementClient(object):
    ...
    :vartype data_exports: operational_insights_management_client.aio.operations.DataExportsOperations
    :ivar data_sources: DataSourcesOperations operations
    :vartype data_sources: operational_insights_management_client.aio.operations.DataSourcesOperations
    :ivar intelligence_packs: IntelligencePacksOperations operations
    :vartype intelligence_packs: operational_insights_management_client.aio.operations.IntelligencePacksOperations
    :ivar linked_services: LinkedServicesOperations operations
    :vartype linked_services: operational_insights_management_client.aio.operations.LinkedServicesOperations
    :ivar linked_storage_accounts: LinkedStorageAccountsOperations operations
    :vartype linked_storage_accounts: operational_insights_management_client.aio.operations.LinkedStorageAccountsOperations
    :ivar management_groups: ManagementGroupsOperations operations
    :vartype management_groups: operational_insights_management_client.aio.operations.ManagementGroupsOperations
    :ivar operation_statuses: OperationStatusesOperations operations
    :vartype operation_statuses: operational_insights_management_client.aio.operations.OperationStatusesOperations
    :ivar shared_keys: SharedKeysOperations operations
    :vartype shared_keys: operational_insights_management_client.aio.operations.SharedKeysOperations
    ...
    :vartype storage_insight_configs: operational_insights_management_client.aio.operations.StorageInsightConfigsOperations
    :ivar saved_searches: SavedSearchesOperations operations
    :vartype saved_searches: operational_insights_management_client.aio.operations.SavedSearchesOperations
    :ivar available_service_tiers: AvailableServiceTiersOperations operations
    :vartype available_service_tiers: operational_insights_management_client.aio.operations.AvailableServiceTiersOperations
    ...
    :vartype workspace_purge: operational_insights_management_client.aio.operations.WorkspacePurgeOperations
    ...
    :vartype operations: operational_insights_management_client.aio.operations.Operations
    ...
    :vartype deleted_workspaces: operational_insights_management_client.aio.operations.DeletedWorkspacesOperations

...
class DataSourcesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type parameters: ~operational_insights_management_client.models.DataSource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataSource, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.DataSource
    ...
    def list_by_workspace(
        ...
        **kwargs
    ) -> AsyncIterable["models.DataSourceListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operational_insights_management_client.models.DataSourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataSourceListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

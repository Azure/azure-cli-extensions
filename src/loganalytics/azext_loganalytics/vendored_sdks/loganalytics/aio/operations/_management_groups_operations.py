...
class ManagementGroupsOperations:
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.WorkspaceListManagementGroupsResult"]:
        ...
        :return: An iterator like instance of either WorkspaceListManagementGroupsResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operational_insights_management_client.models.WorkspaceListManagementGroupsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WorkspaceListManagementGroupsResult"]
        error_map = {

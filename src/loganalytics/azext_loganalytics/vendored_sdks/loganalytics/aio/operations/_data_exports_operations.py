...
class DataExportsOperations:
    """DataExportsOperations async operations.
    ...
    def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.DataExportListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operational_insights_management_client.models.DataExportListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataExportListResult"]
        error_map = {
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type parameters: ~operational_insights_management_client.models.DataExport
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataExport, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.DataExport
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataExport"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        body_content = self._serialize.body(parameters, 'DataExport')

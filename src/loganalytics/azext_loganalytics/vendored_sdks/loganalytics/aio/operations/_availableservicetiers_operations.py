...
class availableservicetiersOperations:
    """availableservicetiersOperations async operations.
    ...
    async def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> List["models.availableservicetier"]:
        ...
        :rtype: list[~operational_insights_management_client.models.availableservicetier]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[List["models.availableservicetier"]]
        error_map = {

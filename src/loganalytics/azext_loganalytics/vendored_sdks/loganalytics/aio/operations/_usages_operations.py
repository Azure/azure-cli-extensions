...
class UsagesOperations:
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.WorkspaceListUsagesResult"]:
        ...
        :return: An iterator like instance of either WorkspaceListUsagesResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operational_insights_management_client.models.WorkspaceListUsagesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WorkspaceListUsagesResult"]
        error_map = {

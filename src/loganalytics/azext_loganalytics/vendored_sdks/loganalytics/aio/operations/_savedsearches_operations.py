...
class savedsearchesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type parameters: ~operational_insights_management_client.models.savedsearch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: savedsearch, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.savedsearch
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.savedsearch"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> "models.savedsearcheslistresult":
        ...
        :rtype: ~operational_insights_management_client.models.savedsearcheslistresult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.savedsearcheslistresult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class LinkedStorageAccountsOperations:
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        data_source_type: Union[str, "models.DataSourceType"],
        ...
        **kwargs
        ...
        :type data_source_type: str or ~operational_insights_management_client.models.DataSourceType
        :param parameters: The parameters required to create or update linked storage accounts.
        :type parameters: ~operational_insights_management_client.models.LinkedStorageAccountsResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: LinkedStorageAccountsResource, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.LinkedStorageAccountsResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LinkedStorageAccountsResource"]
        error_map = {
    ...
    def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.LinkedStorageAccountsListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operational_insights_management_client.models.LinkedStorageAccountsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LinkedStorageAccountsListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

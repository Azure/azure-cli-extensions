...
class StorageInsightConfigsOperations(object):
    ...
    def create_or_update(
        ...
        parameters,  # type: "models.StorageInsight"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.StorageInsight"
        ...
        :type parameters: ~operational_insights_management_client.models.StorageInsight
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageInsight, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.StorageInsight
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageInsight"]
        error_map = {
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.StorageInsightListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~operational_insights_management_client.models.StorageInsightListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StorageInsightListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

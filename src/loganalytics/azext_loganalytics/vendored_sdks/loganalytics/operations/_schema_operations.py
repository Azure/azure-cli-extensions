...
class SchemaOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SearchGetSchemaResponse"
        ...
        :rtype: ~operational_insights_management_client.models.SearchGetSchemaResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SearchGetSchemaResponse"]
        error_map = {

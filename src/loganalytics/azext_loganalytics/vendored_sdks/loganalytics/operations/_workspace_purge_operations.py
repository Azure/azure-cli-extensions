...
class WorkspacePurgeOperations(object):
    ...
    def purge(
        ...
        body,  # type: "models.WorkspacePurgeBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.WorkspacePurgeResponse"
        ...
        :param body: Describes the body of a request to purge data in a single table of an Log
         Analytics Workspace.
        :type body: ~operational_insights_management_client.models.WorkspacePurgeBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WorkspacePurgeResponse, or the result of cls(response)
        :rtype: ~operational_insights_management_client.models.WorkspacePurgeResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WorkspacePurgeResponse"]
        error_map = {
    ...
    def get_purge_status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.WorkspacePurgeStatusResponse"
        ...
        :rtype: ~operational_insights_management_client.models.WorkspacePurgeStatusResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WorkspacePurgeStatusResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

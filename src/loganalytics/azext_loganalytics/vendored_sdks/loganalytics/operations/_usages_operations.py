...
class UsagesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.WorkspaceListUsagesResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~operational_insights_management_client.models.WorkspaceListUsagesResult]

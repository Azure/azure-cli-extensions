...
class ManagementGroupsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.WorkspaceListManagementGroupsResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~operational_insights_management_client.models.WorkspaceListManagementGroupsResult]

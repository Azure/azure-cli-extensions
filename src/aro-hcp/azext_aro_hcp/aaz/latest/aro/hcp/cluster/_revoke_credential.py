...
@register_command(
    "aro hcp cluster revoke-credential",
    is_preview=True,
)
class RevokeCredential(AAZCommand):
    """Revoke all credentials for your Azure Red Hat OpenShift with hosted control plane cluster

    :example: Revoke all admin credentials
        az aro hcp cluster revoke-credential --resource-group MyResourceGroup --name MyCluster
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.HcpOpenShiftClustersRevokeCredentials(ctx=self.ctx)()
    ...
    class HcpOpenShiftClustersRevokeCredentials(AAZHttpOperation):
...
class _RevokeCredentialHelper:
    """Helper class for RevokeCredential"""


__all__ = ["RevokeCredential"]

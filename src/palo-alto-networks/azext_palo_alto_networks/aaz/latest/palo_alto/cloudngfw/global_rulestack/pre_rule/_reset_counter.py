...
@register_command(
    "palo-alto cloudngfw global-rulestack pre-rule reset-counter",
)
class ResetCounter(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/prerules/{}/resetcounters", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PreRulesResetCounters(ctx=self.ctx)()
    ...
    class PreRulesResetCounters(AAZHttpOperation):

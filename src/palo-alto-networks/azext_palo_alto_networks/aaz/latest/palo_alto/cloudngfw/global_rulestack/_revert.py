...
@register_command(
    "palo-alto cloudngfw global-rulestack revert",
)
class Revert(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/revert", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackRevert(ctx=self.ctx)()
    ...
    class GlobalRulestackRevert(AAZHttpOperation):

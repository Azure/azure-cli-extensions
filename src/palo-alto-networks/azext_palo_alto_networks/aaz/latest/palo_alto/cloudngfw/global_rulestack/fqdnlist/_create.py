...
@register_command(
    "palo-alto cloudngfw global-rulestack fqdnlist create",
)
class Create(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/fqdnlists/{}", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.FqdnListGlobalRulestackCreateOrUpdate(ctx=self.ctx)()
    ...
    class FqdnListGlobalRulestackCreateOrUpdate(AAZHttpOperation):

...
@register_command(
    "palo-alto cloudngfw global-rulestack certificate list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CertificateObjectGlobalRulestackList(ctx=self.ctx)()
    ...
    class CertificateObjectGlobalRulestackList(AAZHttpOperation):

...
@register_command(
    "palo-alto cloudngfw global-rulestack certificate delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CertificateObjectGlobalRulestackDelete(ctx=self.ctx)()
    ...
    class CertificateObjectGlobalRulestackDelete(AAZHttpOperation):

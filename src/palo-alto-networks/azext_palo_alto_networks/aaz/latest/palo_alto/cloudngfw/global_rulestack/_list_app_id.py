...
@register_command(
    "palo-alto cloudngfw global-rulestack list-app-id",
)
class ListAppId(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/listappids", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackListAppIds(ctx=self.ctx)()
    ...
    class GlobalRulestackListAppIds(AAZHttpOperation):

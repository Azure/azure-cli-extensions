...
@register_command(
    "palo-alto cloudngfw global-rulestack pre-rule wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/prerules/{}", "2022-08-29"],
        ]
    }
    ...
    class PreRulesGet(AAZHttpOperation):

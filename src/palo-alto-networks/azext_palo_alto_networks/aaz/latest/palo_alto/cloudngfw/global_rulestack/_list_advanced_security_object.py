...
@register_command(
    "palo-alto cloudngfw global-rulestack list-advanced-security-object",
)
class ListAdvancedSecurityObject(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/listadvancedsecurityobjects", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackListAdvancedSecurityObjects(ctx=self.ctx)()
    ...
    class GlobalRulestackListAdvancedSecurityObjects(AAZHttpOperation):

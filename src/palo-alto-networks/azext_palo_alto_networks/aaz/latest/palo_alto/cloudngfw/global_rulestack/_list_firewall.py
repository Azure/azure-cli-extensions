...
@register_command(
    "palo-alto cloudngfw global-rulestack list-firewall",
)
class ListFirewall(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/listfirewalls", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackListFirewalls(ctx=self.ctx)()
    ...
    class GlobalRulestackListFirewalls(AAZHttpOperation):

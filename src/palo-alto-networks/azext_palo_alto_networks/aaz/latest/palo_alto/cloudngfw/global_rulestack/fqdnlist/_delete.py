...
@register_command(
    "palo-alto cloudngfw global-rulestack fqdnlist delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.FqdnListGlobalRulestackDelete(ctx=self.ctx)()
    ...
    class FqdnListGlobalRulestackDelete(AAZHttpOperation):

...
@register_command(
    "palo-alto cloudngfw global-rulestack post-rule wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/postrules/{}", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PostRulesGet(ctx=self.ctx)()
    ...
    class PostRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            applications = cls._schema_on_200.properties.applications
            applications.Element = AAZStrType()

            category = cls._schema_on_200.properties.category
            ...
            feeds = cls._schema_on_200.properties.category.feeds
            feeds.Element = AAZStrType()

            url_custom = cls._schema_on_200.properties.category.url_custom
            ...
            cidrs = cls._schema_on_200.properties.destination.cidrs
            cidrs.Element = AAZStrType()

            countries = cls._schema_on_200.properties.destination.countries
            countries.Element = AAZStrType()

            feeds = cls._schema_on_200.properties.destination.feeds
            feeds.Element = AAZStrType()

            fqdn_lists = cls._schema_on_200.properties.destination.fqdn_lists
            fqdn_lists.Element = AAZStrType()

            prefix_lists = cls._schema_on_200.properties.destination.prefix_lists
            prefix_lists.Element = AAZStrType()

            protocol_port_list = cls._schema_on_200.properties.protocol_port_list
            ...
            cidrs = cls._schema_on_200.properties.source.cidrs
            cidrs.Element = AAZStrType()

            countries = cls._schema_on_200.properties.source.countries
            countries.Element = AAZStrType()

            feeds = cls._schema_on_200.properties.source.feeds
            feeds.Element = AAZStrType()

            prefix_lists = cls._schema_on_200.properties.source.prefix_lists
            prefix_lists.Element = AAZStrType()

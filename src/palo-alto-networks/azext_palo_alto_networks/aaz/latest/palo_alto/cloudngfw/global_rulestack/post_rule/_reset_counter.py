...
@register_command(
    "palo-alto cloudngfw global-rulestack post-rule reset-counter",
)
class ResetCounter(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/postrules/{}/resetcounters", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PostRulesResetCounters(ctx=self.ctx)()
    ...
    class PostRulesResetCounters(AAZHttpOperation):
...
class _ResetCounterHelper:
    """Helper class for ResetCounter"""


__all__ = ["ResetCounter"]

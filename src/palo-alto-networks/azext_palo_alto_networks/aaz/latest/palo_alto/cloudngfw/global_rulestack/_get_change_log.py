...
@register_command(
    "palo-alto cloudngfw global-rulestack get-change-log",
)
class GetChangeLog(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/getchangelog", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackGetChangeLog(ctx=self.ctx)()
    ...
    class GlobalRulestackGetChangeLog(AAZHttpOperation):

...
@register_command(
    "palo-alto cloudngfw global-rulestack certificate wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/certificates/{}", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CertificateObjectGlobalRulestackGet(ctx=self.ctx)()
    ...
    class CertificateObjectGlobalRulestackGet(AAZHttpOperation):

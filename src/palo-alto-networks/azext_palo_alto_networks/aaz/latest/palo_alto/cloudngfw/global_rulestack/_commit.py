...
@register_command(
    "palo-alto cloudngfw global-rulestack commit",
)
class Commit(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/commit", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.GlobalRulestackCommit(ctx=self.ctx)()
    ...
    class GlobalRulestackCommit(AAZHttpOperation):

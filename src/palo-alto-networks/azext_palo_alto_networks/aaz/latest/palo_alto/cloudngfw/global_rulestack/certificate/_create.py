...
@register_command(
    "palo-alto cloudngfw global-rulestack certificate create",
)
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CertificateObjectGlobalRulestackCreateOrUpdate(ctx=self.ctx)()
    ...
    class CertificateObjectGlobalRulestackCreateOrUpdate(AAZHttpOperation):

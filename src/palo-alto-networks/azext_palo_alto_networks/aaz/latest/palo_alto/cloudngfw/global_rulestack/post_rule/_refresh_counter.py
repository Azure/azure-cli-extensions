...
@register_command(
    "palo-alto cloudngfw global-rulestack post-rule refresh-counter",
)
class RefreshCounter(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/postrules/{}/refreshcounters", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PostRulesRefreshCounters(ctx=self.ctx)()
    ...
    class PostRulesRefreshCounters(AAZHttpOperation):

...
@register_command(
    "palo-alto cloudngfw global-rulestack list-security-service",
)
class ListSecurityService(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-29",
        "resources": [
            ["mgmt-plane", "/providers/paloaltonetworks.cloudngfw/globalrulestacks/{}/listsecurityservices", "2022-08-29"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalRulestackListSecurityServices(ctx=self.ctx)()
    ...
    class GlobalRulestackListSecurityServices(AAZHttpOperation):

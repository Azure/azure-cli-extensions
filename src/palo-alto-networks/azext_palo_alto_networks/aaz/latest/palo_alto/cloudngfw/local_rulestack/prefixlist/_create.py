...
@register_command(
    "palo-alto cloudngfw local-rulestack prefixlist create",
)
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PrefixListLocalRulestackCreateOrUpdate(ctx=self.ctx)()
    ...
    class PrefixListLocalRulestackCreateOrUpdate(AAZHttpOperation):

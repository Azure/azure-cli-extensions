...
class Export(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "JobQueryParameter"

        _args_schema = cls._args_schema
        _args_schema.affected_object_types = AAZStrArg(
            options=["--affected-object-types"],
            arg_group="JobQueryParameter",
            help="The type of objects.",
        )
        _args_schema.end_time = AAZStrArg(
            options=["--end-time"],
            arg_group="JobQueryParameter",
            help="Date time to get jobs upto.",
        )
        _args_schema.fabric_id = AAZStrArg(
            options=["--fabric-id"],
            arg_group="JobQueryParameter",
        ...
        _args_schema.job_output_type = AAZStrArg(
            options=["--job-output-type"],
            arg_group="JobQueryParameter",
            help="The output type of the jobs.",
            enum={"Excel": "Excel", "Json": "Json", "Xml": "Xml"},
        )
        _args_schema.job_status = AAZStrArg(
            options=["--job-status"],
            arg_group="JobQueryParameter",
            help="The states of the job to be filtered can be in.",
        )
        _args_schema.start_time = AAZStrArg(
            options=["--start-time"],
            arg_group="JobQueryParameter",
            help="Date time to get jobs from.",
        )
        _args_schema.timezone_offset = AAZFloatArg(
            options=["--timezone-offset"],
            arg_group="JobQueryParameter",
            help="The timezone offset for the location of the request (in minutes).",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationJobsExport(ctx=self.ctx)()
    ...
    class ReplicationJobsExport(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("affectedObjectTypes", AAZStrType, ".affected_object_types")
            ...
            _builder.set_prop("timezoneOffset", AAZFloatType, ".timezone_offset")
        ...
        def _build_schema_on_200(cls):
            ...
            _ExportHelper._build_schema_failover_replication_protected_item_details_read(protected_item_details.Element)

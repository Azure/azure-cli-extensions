...
@register_command(
    "site-recovery vault recovery-plan re-protect",
)
class ReProtect(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationrecoveryplans/{}/reprotect", "2022-08-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationRecoveryPlansReprotect(ctx=self.ctx)()
    ...
    class ReplicationRecoveryPlansReprotect(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ReProtectHelper._build_schema_recovery_plan_action_read(end_group_actions.Element)
            ...
            _ReProtectHelper._build_schema_recovery_plan_action_read(start_group_actions.Element)

...
@register_command(
    "site-recovery vault recovery-plan unplanned-failover",
)
class UnplannedFailover(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationrecoveryplans/{}/unplannedfailover", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.source_site_operations = AAZStrArg(
            ...
            arg_group="Properties",
            help="A value indicating whether source site operations are required.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationRecoveryPlansUnplannedFailover(ctx=self.ctx)()
    ...
    class ReplicationRecoveryPlansUnplannedFailover(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("sourceSiteOperations", AAZStrType, ".source_site_operations", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200(cls):
            ...
            _UnplannedFailoverHelper._build_schema_recovery_plan_action_read(end_group_actions.Element)
            ...
            _UnplannedFailoverHelper._build_schema_recovery_plan_action_read(start_group_actions.Element)

...
@register_command(
    "site-recovery vault recovery-plan failover-cancel",
)
class FailoverCancel(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationrecoveryplans/{}/failovercancel", "2022-08-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationRecoveryPlansFailoverCancel(ctx=self.ctx)()
    ...
    class ReplicationRecoveryPlansFailoverCancel(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _FailoverCancelHelper._build_schema_recovery_plan_action_read(end_group_actions.Element)
            ...
            _FailoverCancelHelper._build_schema_recovery_plan_action_read(start_group_actions.Element)

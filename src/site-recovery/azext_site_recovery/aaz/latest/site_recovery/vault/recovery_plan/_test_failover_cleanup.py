...
@register_command(
    "site-recovery vault recovery-plan test-failover-cleanup",
)
class TestFailoverCleanup(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationrecoveryplans/{}/testfailovercleanup", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.comments = AAZStrArg(
            ...
            help="The test failover cleanup comments.",
            fmt=AAZStrArgFormat(
                max_length=1024,
            ),
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationRecoveryPlansTestFailoverCleanup(ctx=self.ctx)()
    ...
    class ReplicationRecoveryPlansTestFailoverCleanup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _TestFailoverCleanupHelper._build_schema_recovery_plan_action_read(end_group_actions.Element)
            ...
            _TestFailoverCleanupHelper._build_schema_recovery_plan_action_read(start_group_actions.Element)

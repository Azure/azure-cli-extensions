...
class Update(AAZCommand):
    ...
    class ReplicationAlertSettingsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_alert_read(cls._schema_on_200)
...
def _build_schema_alert_read(_schema):
    global _schema_alert_read
    if _schema_alert_read is not None:
        _schema.id = _schema_alert_read.id
        _schema.location = _schema_alert_read.location
        _schema.name = _schema_alert_read.name
        _schema.properties = _schema_alert_read.properties
        _schema.type = _schema_alert_read.type
        return

    _schema_alert_read = AAZObjectType()

...
@register_command(
    "site-recovery vault fabric v-center list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationvCentersListByReplicationFabrics(ctx=self.ctx)()
    ...
    class ReplicationvCentersListByReplicationFabrics(AAZHttpOperation):

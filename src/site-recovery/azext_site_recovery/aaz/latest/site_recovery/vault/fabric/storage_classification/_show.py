...
@register_command(
    "site-recovery vault fabric storage-classification show",
)
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.storage_classification_name = AAZStrArg(
            options=["-n", "--name", "--storage-classification-name"],
    ...
    def _execute_operations(self):
        self.ReplicationStorageClassificationsGet(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ReplicationStorageClassificationsGet(AAZHttpOperation):

...
@register_command(
    "site-recovery vault fabric protection-container migration-item pause-replication",
)
class PauseReplication(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/replicationprotectioncontainers/{}/replicationmigrationitems/{}/pausereplication", "2022-08-01"],
        ]
    }
    ...
    def _execute_operations(self):
        yield self.ReplicationMigrationItemsPauseReplication(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ReplicationMigrationItemsPauseReplication(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("instanceType", AAZStrType, ".instance_type", typ_kwargs={"flags": {"required": True}})

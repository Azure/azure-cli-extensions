...
@register_command(
    "site-recovery vault fabric protection-container migration-item test-migrate-cleanup",
)
class TestMigrateCleanup(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/replicationprotectioncontainers/{}/replicationmigrationitems/{}/testmigratecleanup", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.comments = AAZStrArg(
            ...
            help="Test migrate cleanup comments.",
            fmt=AAZStrArgFormat(
                max_length=1024,
            ),
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationMigrationItemsTestMigrateCleanup(ctx=self.ctx)()
    ...
    class ReplicationMigrationItemsTestMigrateCleanup(AAZHttpOperation):

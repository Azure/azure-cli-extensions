...
@register_command(
    "site-recovery vault fabric renew-certificate",
)
class RenewCertificate(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/renewcertificate", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.fabric_name = AAZStrArg(
            options=["--fabric-name"],
            help="fabric name to renew certs for.",
            required=True,
        )
        ...
        _args_schema = cls._args_schema
        _args_schema.renew_certificate_type = AAZStrArg(
            options=["--renew-certificate-type"],
            arg_group="Properties",
            help="Renew certificate type.",
        )
        return cls._args_schema

    def _execute_operations(self):
        yield self.ReplicationFabricsRenewCertificate(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ReplicationFabricsRenewCertificate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("renewCertificateType", AAZStrType, ".renew_certificate_type")

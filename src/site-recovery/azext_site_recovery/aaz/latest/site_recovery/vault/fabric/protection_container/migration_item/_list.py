...
@register_command(
    "site-recovery vault fabric protection-container migration-item list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationMigrationItemsListByReplicationProtectionContainers(ctx=self.ctx)()
    ...
    class ReplicationMigrationItemsListByReplicationProtectionContainers(AAZHttpOperation):

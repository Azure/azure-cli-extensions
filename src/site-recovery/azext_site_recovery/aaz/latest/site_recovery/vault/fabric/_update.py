...
@register_command(
    "site-recovery vault fabric update",
)
class Update(AAZCommand):
    ...
    class ReplicationFabricsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_fabric_read(cls._schema_on_200)
...
def _build_schema_fabric_read(_schema):
    global _schema_fabric_read
    if _schema_fabric_read is not None:
        _schema.id = _schema_fabric_read.id
        _schema.location = _schema_fabric_read.location
        _schema.name = _schema_fabric_read.name
        _schema.properties = _schema_fabric_read.properties
        _schema.type = _schema_fabric_read.type
        return

    _schema_fabric_read = AAZObjectType()

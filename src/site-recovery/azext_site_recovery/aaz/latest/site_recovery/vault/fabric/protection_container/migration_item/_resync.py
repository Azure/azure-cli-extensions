...
@register_command(
    "site-recovery vault fabric protection-container migration-item resync",
)
class Resync(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/replicationprotectioncontainers/{}/replicationmigrationitems/{}/resync", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        v_mware_cbt.skip_cbt_reset = AAZStrArg(
            options=["skip-cbt-reset"],
            help="A value indicating whether CBT is to be reset.",
            required=True,
        )
        return cls._args_schema

    def _execute_operations(self):
        yield self.ReplicationMigrationItemsResync(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ReplicationMigrationItemsResync(AAZHttpOperation):
        ...
        def content(self):
            ...
            if disc_v_mware_cbt is not None:
                disc_v_mware_cbt.set_prop("skipCbtReset", AAZStrType, ".v_mware_cbt.skip_cbt_reset", typ_kwargs={"flags": {"required": True}})

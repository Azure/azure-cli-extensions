...
@register_command(
    "site-recovery vault fabric protection-container migration-item migrate",
)
class Migrate(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/replicationprotectioncontainers/{}/replicationmigrationitems/{}/migrate", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        v_mware_cbt.perform_shutdown = AAZStrArg(
    ...
    def _execute_operations(self):
        yield self.ReplicationMigrationItemsMigrate(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ReplicationMigrationItemsMigrate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if disc_v_mware_cbt is not None:
                disc_v_mware_cbt.set_prop("performShutdown", AAZStrType, ".v_mware_cbt.perform_shutdown", typ_kwargs={"flags": {"required": True}})

...
@register_command(
    "site-recovery vault fabric protection-container migration-item migration-recovery-point list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MigrationRecoveryPointsListByReplicationMigrationItems(ctx=self.ctx)()
    ...
    class MigrationRecoveryPointsListByReplicationMigrationItems(AAZHttpOperation):

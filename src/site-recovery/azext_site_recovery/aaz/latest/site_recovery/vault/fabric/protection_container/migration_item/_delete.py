...
@register_command(
    "site-recovery vault fabric protection-container migration-item delete",
...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.delete_option = AAZStrArg(
            options=["--delete-option"],
            help="The delete option.",
        )
        return cls._args_schema
        ...
        def query_parameters(self):
            parameters = {
                **self.serialize_query_param(
                    "deleteOption", self.ctx.args.delete_option,
                ),
                **self.serialize_query_param(

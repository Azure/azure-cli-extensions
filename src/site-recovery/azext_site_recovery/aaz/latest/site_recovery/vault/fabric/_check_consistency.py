...
@register_command(
    "site-recovery vault fabric check-consistency",
)
class CheckConsistency(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/checkconsistency", "2022-08-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationFabricsCheckConsistency(ctx=self.ctx)()
    ...
    class ReplicationFabricsCheckConsistency(AAZHttpOperation):

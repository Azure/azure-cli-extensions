...
@register_command(
    "site-recovery vault fabric protection-container protected-item update",
)
class Update(AAZCommand):
    ...
    class ReplicationProtectedItemsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_replication_protected_item_read(cls._schema_on_200)
...
def _build_schema_replication_protected_item_read(_schema):
    global _schema_replication_protected_item_read
    if _schema_replication_protected_item_read is not None:
        _schema.id = _schema_replication_protected_item_read.id
        _schema.location = _schema_replication_protected_item_read.location
        _schema.name = _schema_replication_protected_item_read.name
        _schema.properties = _schema_replication_protected_item_read.properties
        _schema.type = _schema_replication_protected_item_read.type
        return

    _schema_replication_protected_item_read = AAZObjectType()

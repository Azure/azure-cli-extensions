...
@register_command(
    "site-recovery vault fabric protection-container migration-item update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationMigrationItemsGet(ctx=self.ctx)()
    ...
    class ReplicationMigrationItemsGet(AAZHttpOperation):

...
@register_command(
    "site-recovery vault fabric migratetoaad",
)
class Migratetoaad(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationFabricsMigrateToAad(ctx=self.ctx)()
    ...
    class ReplicationFabricsMigrateToAad(AAZHttpOperation):

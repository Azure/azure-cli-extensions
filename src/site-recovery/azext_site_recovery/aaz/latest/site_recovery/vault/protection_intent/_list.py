...
@register_command(
    "site-recovery vault protection-intent list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationProtectionIntentsList(ctx=self.ctx)()
    ...
    class ReplicationProtectionIntentsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            protection_profile = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").protection_profile
            protection_profile.resource_type = AAZStrType(
                serialized_name="resourceType",
                flags={"required": True},
            )

            disc_existing = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").protection_profile.discriminate_by("resource_type", "Existing")
            disc_existing.protection_profile_id = AAZStrType(
                serialized_name="protectionProfileId",
                flags={"required": True},
            )

            disc_new = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").protection_profile.discriminate_by("resource_type", "New")
            ...
            recovery_availability_set = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_availability_set
            recovery_availability_set.resource_type = AAZStrType(
                serialized_name="resourceType",
                flags={"required": True},
            )

            disc_existing = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_availability_set.discriminate_by("resource_type", "Existing")
            disc_existing.recovery_availability_set_id = AAZStrType(
                serialized_name="recoveryAvailabilitySetId",
            )

            recovery_proximity_placement_group = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_proximity_placement_group
            recovery_proximity_placement_group.resource_type = AAZStrType(
                serialized_name="resourceType",
                flags={"required": True},
            )

            disc_existing = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_proximity_placement_group.discriminate_by("resource_type", "Existing")
            disc_existing.recovery_proximity_placement_group_id = AAZStrType(
                serialized_name="recoveryProximityPlacementGroupId",
            )

            recovery_virtual_network = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_virtual_network
            recovery_virtual_network.resource_type = AAZStrType(
                serialized_name="resourceType",
                flags={"required": True},
            )

            disc_existing = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_virtual_network.discriminate_by("resource_type", "Existing")
            ...
            disc_new = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").recovery_virtual_network.discriminate_by("resource_type", "New")
            ...
            vm_disks = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").vm_disks
            vm_disks.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").vm_disks.Element
            ...
            _element = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").vm_managed_disks.Element
            ...
            recovery_resource_group_custom_input = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").vm_managed_disks.Element.recovery_resource_group_custom_input
            recovery_resource_group_custom_input.resource_type = AAZStrType(
                serialized_name="resourceType",
                flags={"required": True},
            )

            disc_existing = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "A2A").vm_managed_disks.Element.recovery_resource_group_custom_input.discriminate_by("resource_type", "Existing")

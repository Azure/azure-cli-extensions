...
class Show(AAZCommand):
    ...
    class ReplicationProtectionIntentsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_disk_encryption_info_read(disc_a2_a.disk_encryption_info)
            ...
            _ShowHelper._build_schema_storage_account_custom_details_read(disc_a2_a.primary_staging_storage_account)
            ...
            _ShowHelper._build_schema_storage_account_custom_details_read(disc_a2_a.recovery_boot_diag_storage_account)
            ...
            _ShowHelper._build_schema_storage_account_custom_details_read(_element.primary_staging_storage_account_custom_input)
            _element.recovery_azure_storage_account_custom_input = AAZObjectType(
                serialized_name="recoveryAzureStorageAccountCustomInput",
            )
            _ShowHelper._build_schema_storage_account_custom_details_read(_element.recovery_azure_storage_account_custom_input)
            ...
            _ShowHelper._build_schema_disk_encryption_info_read(_element.disk_encryption_info)

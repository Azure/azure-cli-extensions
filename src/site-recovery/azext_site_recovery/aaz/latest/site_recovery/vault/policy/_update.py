...
@register_command(
    "site-recovery vault policy update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.ReplicationPoliciesCreate(ctx=self.ctx)()
    ...
    class ReplicationPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_policy_read(cls._schema_on_200)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if provider_specific_input is not None:
                ...
                provider_specific_input.set_const("instanceType", "InMage", AAZStrType, ".in_mage", typ_kwargs={"flags": {"required": True}})
                provider_specific_input.set_const("instanceType", "InMageAzureV2", AAZStrType, ".in_mage_azure_v2", typ_kwargs={"flags": {"required": True}})
                provider_specific_input.set_const("instanceType", "InMageRcm", AAZStrType, ".in_mage_rcm", typ_kwargs={"flags": {"required": True}})
                provider_specific_input.set_const("instanceType", "InMageRcmFailback", AAZStrType, ".in_mage_rcm_failback", typ_kwargs={"flags": {"required": True}})
                ...
                provider_specific_input.discriminate_by("instanceType", "HyperVReplica2012")
                provider_specific_input.discriminate_by("instanceType", "HyperVReplica2012R2")
                provider_specific_input.discriminate_by("instanceType", "HyperVReplicaAzure")
                provider_specific_input.discriminate_by("instanceType", "InMage")
                provider_specific_input.discriminate_by("instanceType", "InMageAzureV2")
                provider_specific_input.discriminate_by("instanceType", "InMageRcm")
                provider_specific_input.discriminate_by("instanceType", "InMageRcmFailback")
            ...
            disc_hyper_v_replica2012_r2 = _builder.get(".properties.providerSpecificInput{instanceType:HyperVReplica2012R2}")
            ...
            storage_accounts = _builder.get(".properties.providerSpecificInput{instanceType:HyperVReplicaAzure}.storageAccounts")
            if storage_accounts is not None:
                storage_accounts.set_elements(AAZStrType, ".")

            disc_in_mage = _builder.get(".properties.providerSpecificInput{instanceType:InMage}")
            ...
            disc_in_mage_azure_v2 = _builder.get(".properties.providerSpecificInput{instanceType:InMageAzureV2}")
            ...
            disc_in_mage_rcm_failback = _builder.get(".properties.providerSpecificInput{instanceType:InMageRcmFailback}")
...
_schema_policy_read = None


def _build_schema_policy_read(_schema):
    global _schema_policy_read
    if _schema_policy_read is not None:
        _schema.id = _schema_policy_read.id
        _schema.location = _schema_policy_read.location
        _schema.name = _schema_policy_read.name
        _schema.properties = _schema_policy_read.properties
        _schema.type = _schema_policy_read.type
        return

    _schema_policy_read = AAZObjectType()

    policy_read = _schema_policy_read
    policy_read.id = AAZStrType(
        flags={"read_only": True},
    )
    policy_read.location = AAZStrType()
    policy_read.name = AAZStrType(
        flags={"read_only": True},
    )
    policy_read.properties = AAZObjectType()
    policy_read.type = AAZStrType(
        flags={"read_only": True},
    )

    properties = _schema_policy_read.properties
    ...
    provider_specific_details = _schema_policy_read.properties.provider_specific_details
    provider_specific_details.instance_type = AAZStrType(
        serialized_name="instanceType",
        flags={"required": True},
    )

    disc_a2_a = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "A2A")
    ...
    disc_hyper_v_replica2012 = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "HyperVReplica2012")
    ...
    disc_hyper_v_replica2012_r2 = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "HyperVReplica2012R2")
    ...
    disc_hyper_v_replica_azure = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "HyperVReplicaAzure")
    ...
    disc_hyper_v_replica_base_policy_details = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "HyperVReplicaBasePolicyDetails")
    ...
    disc_in_mage = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "InMage")
    ...
    disc_in_mage_azure_v2 = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "InMageAzureV2")
    ...
    disc_in_mage_base_policy_details = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "InMageBasePolicyDetails")
    ...
    disc_in_mage_rcm = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "InMageRcm")
    ...
    disc_in_mage_rcm_failback = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "InMageRcmFailback")
    ...
    disc_v_mware_cbt = _schema_policy_read.properties.provider_specific_details.discriminate_by("instance_type", "VMwareCbt")

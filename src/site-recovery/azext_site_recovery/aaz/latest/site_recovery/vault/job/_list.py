...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationJobsList(ctx=self.ctx)()
    ...
    class ReplicationJobsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_export_job_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "ExportJobDetails")
            ...
            disc_failover_job_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "FailoverJobDetails")
            disc_failover_job_details.protected_item_details = AAZListType(
                serialized_name="protectedItemDetails",
            )

            protected_item_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "FailoverJobDetails").protected_item_details
            protected_item_details.Element = AAZObjectType()
            _ListHelper._build_schema_failover_replication_protected_item_details_read(protected_item_details.Element)

            disc_switch_protection_job_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "SwitchProtectionJobDetails")
            ...
            disc_test_failover_job_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "TestFailoverJobDetails")
            ...
            protected_item_details = cls._schema_on_200.value.Element.properties.custom_details.discriminate_by("instance_type", "TestFailoverJobDetails").protected_item_details
            protected_item_details.Element = AAZObjectType()
            _ListHelper._build_schema_failover_replication_protected_item_details_read(protected_item_details.Element)

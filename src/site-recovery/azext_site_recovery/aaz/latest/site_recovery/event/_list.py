...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationEventsList(ctx=self.ctx)()
    ...
    class ReplicationEventsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_job_status = cls._schema_on_200.value.Element.properties.event_specific_details.discriminate_by("instance_type", "JobStatus")
            ...
            disc_hyper_v_replica_base_event_details = cls._schema_on_200.value.Element.properties.provider_specific_details.discriminate_by("instance_type", "HyperVReplicaBaseEventDetails")

...
@register_command(
    "site-recovery vmware-site run-as-account list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RunAsAccountsGetAllRunAsAccountsInSite(ctx=self.ctx)()
    ...
    class RunAsAccountsGetAllRunAsAccountsInSite(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.credential_type = AAZStrType(

...
@register_command(
    "site-recovery fabric reassociate-gateway",
)
class ReassociateGateway(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/reassociategateway", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.fabric_name = AAZStrArg(
            options=["--fabric-name"],
            help="The name of the fabric containing the process server.",
            required=True,
        )
        ...
        _args_schema.update_type = AAZStrArg(
            options=["--update-type"],
            arg_group="Properties",
            help="A value for failover type. It can be systemlevel/serverlevel.",
        )
        _args_schema.vms_to_migrate = AAZListArg(
            options=["--vms-to-migrate"],
            arg_group="Properties",
            help="The VMS to migrate.",
        )

        vms_to_migrate = cls._args_schema.vms_to_migrate
        vms_to_migrate.Element = AAZStrArg()
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationFabricsReassociateGateway(ctx=self.ctx)()
    ...
    class ReplicationFabricsReassociateGateway(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("containerName", AAZStrType, ".container_name")
                properties.set_prop("sourceProcessServerId", AAZStrType, ".source_process_server_id")
                properties.set_prop("targetProcessServerId", AAZStrType, ".target_process_server_id")
                properties.set_prop("updateType", AAZStrType, ".update_type")
                properties.set_prop("vmsToMigrate", AAZListType, ".vms_to_migrate")

            vms_to_migrate = _builder.get(".properties.vmsToMigrate")
            if vms_to_migrate is not None:
                vms_to_migrate.set_elements(AAZStrType, ".")
        ...
        def _build_schema_on_200(cls):
            ...
            _ReassociateGatewayHelper._build_schema_encryption_details_read(properties.encryption_details)
            ...
            _ReassociateGatewayHelper._build_schema_encryption_details_read(properties.rollover_encryption_details)
            ...
            _ReassociateGatewayHelper._build_schema_health_error_read(health_errors.Element)
            ...
            _ReassociateGatewayHelper._build_schema_process_server_details_read(process_servers.Element)
            ...
            _ReassociateGatewayHelper._build_schema_version_details_read(disc_v_mware.agent_version_details)
            ...
            _ReassociateGatewayHelper._build_schema_version_details_read(_element.agent_version_details)
            ...
            _ReassociateGatewayHelper._build_schema_version_details_read(_element.mars_agent_version_details)
            _element.name = AAZStrType()
            ...
            _ReassociateGatewayHelper._build_schema_health_error_read(validation_errors.Element)
            ...
            _ReassociateGatewayHelper._build_schema_health_error_read(health_error_details.Element)

            return cls._schema_on_200


class _ReassociateGatewayHelper:
    """Helper class for ReassociateGateway"""

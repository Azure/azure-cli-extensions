...
@register_command(
    "site-recovery fabric check-consistency",
)
class CheckConsistency(AAZCommand):
    ...
    class ReplicationFabricsCheckConsistency(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _CheckConsistencyHelper._build_schema_encryption_details_read(properties.encryption_details)
            ...
            _CheckConsistencyHelper._build_schema_encryption_details_read(properties.rollover_encryption_details)
            ...
            _CheckConsistencyHelper._build_schema_health_error_read(health_errors.Element)
            ...
            _CheckConsistencyHelper._build_schema_process_server_details_read(process_servers.Element)
            ...
            _CheckConsistencyHelper._build_schema_version_details_read(disc_v_mware.agent_version_details)
            ...
            _CheckConsistencyHelper._build_schema_version_details_read(_element.agent_version_details)
            ...
            _CheckConsistencyHelper._build_schema_version_details_read(_element.mars_agent_version_details)
            _element.name = AAZStrType()
            ...
            _CheckConsistencyHelper._build_schema_health_error_read(validation_errors.Element)
            ...
            _CheckConsistencyHelper._build_schema_health_error_read(health_error_details.Element)

            return cls._schema_on_200


class _CheckConsistencyHelper:
    """Helper class for CheckConsistency"""

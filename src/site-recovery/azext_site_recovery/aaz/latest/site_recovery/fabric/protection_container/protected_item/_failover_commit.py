...
class FailoverCommit(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationProtectedItemsFailoverCommit(ctx=self.ctx)()
    ...
    class ReplicationProtectedItemsFailoverCommit(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _FailoverCommitHelper._build_schema_health_error_read(health_errors.Element)
            ...
            _FailoverCommitHelper._build_schema_extended_location_read(disc_a2_a.initial_primary_extended_location)
            ...
            _FailoverCommitHelper._build_schema_extended_location_read(disc_a2_a.initial_recovery_extended_location)
            ...
            _FailoverCommitHelper._build_schema_extended_location_read(disc_a2_a.primary_extended_location)
            ...
            _FailoverCommitHelper._build_schema_extended_location_read(disc_a2_a.recovery_extended_location)
            ...
            _FailoverCommitHelper._build_schema_vm_nic_details_read(vm_nics.Element)
            ...
            _FailoverCommitHelper._build_schema_initial_replication_details_read(disc_hyper_v_replica2012.initial_replication_details)
            ...
            _FailoverCommitHelper._build_schema_disk_details_read(v_m_disk_details.Element)
            ...
            _FailoverCommitHelper._build_schema_initial_replication_details_read(disc_hyper_v_replica2012_r2.initial_replication_details)
            ...
            _FailoverCommitHelper._build_schema_initial_replication_details_read(disc_hyper_v_replica_azure.initial_replication_details)
            ...
            _FailoverCommitHelper._build_schema_azure_vm_disk_details_read(azure_vm_disk_details.Element)
            ...
            _FailoverCommitHelper._build_schema_initial_replication_details_read(disc_hyper_v_replica_base_replication_details.initial_replication_details)
            ...
            _FailoverCommitHelper._build_schema_initial_replication_details_read(disc_in_mage.resync_details)
            ...
            _FailoverCommitHelper._build_schema_health_error_read(validation_errors.Element)
            ...
            _FailoverCommitHelper._build_schema_in_mage_rcm_sync_details_read(_element.ir_details)
            ...
            _FailoverCommitHelper._build_schema_in_mage_rcm_sync_details_read(_element.resync_details)
            ...
            _FailoverCommitHelper._build_schema_in_mage_rcm_failback_sync_details_read(_element.ir_details)
            _element.is_initial_replication_complete = AAZStrType(
                serialized_name="isInitialReplicationComplete",
                flags={"read_only": True},
            )
            ...
            _FailoverCommitHelper._build_schema_in_mage_rcm_failback_sync_details_read(_element.resync_details)
...
class _FailoverCommitHelper:
    """Helper class for FailoverCommit"""

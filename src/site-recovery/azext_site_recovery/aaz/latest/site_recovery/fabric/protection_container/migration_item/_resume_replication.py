...
@register_command(
    "site-recovery fabric protection-container migration-item resume-replication",
)
class ResumeReplication(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-08-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.recoveryservices/vaults/{}/replicationfabrics/{}/replicationprotectioncontainers/{}/replicationmigrationitems/{}/resumereplication", "2022-08-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.provider_specific_details = AAZObjectArg(
            ...
            help="The provider specific input for resume replication.",
            required=True,
        )
        ...
        v_mware_cbt.delete_migration_resources = AAZStrArg(
            options=["delete-migration-resources"],
            help="A value indicating whether Migration resources to be deleted.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationMigrationItemsResumeReplication(ctx=self.ctx)()
    ...
    class ReplicationMigrationItemsResumeReplication(AAZHttpOperation):
        ...
        def content(self):
            ...
            if disc_v_mware_cbt is not None:
                disc_v_mware_cbt.set_prop("deleteMigrationResources", AAZStrType, ".v_mware_cbt.delete_migration_resources")

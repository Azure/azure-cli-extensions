...
@register_command(
    "site-recovery fabric storage-classification storage-classification-mapping list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReplicationStorageClassificationMappingsListByReplicationStorageClassifications(ctx=self.ctx)()
    ...
    class ReplicationStorageClassificationMappingsListByReplicationStorageClassifications(AAZHttpOperation):

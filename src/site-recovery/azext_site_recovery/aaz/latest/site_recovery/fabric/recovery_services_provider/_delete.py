...
@register_command(
    "site-recovery fabric recovery-services-provider delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReplicationRecoveryServicesProvidersPurge(ctx=self.ctx)()
    ...
    class ReplicationRecoveryServicesProvidersPurge(AAZHttpOperation):

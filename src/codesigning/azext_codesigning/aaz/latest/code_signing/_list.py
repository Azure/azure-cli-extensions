...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.CodeSigningAccountListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.CodeSigningAccountListBySubscription(ctx=self.ctx)()
    ...
    class CodeSigningAccountListByResourceGroup(AAZHttpOperation):
    ...
    class CodeSigningAccountListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

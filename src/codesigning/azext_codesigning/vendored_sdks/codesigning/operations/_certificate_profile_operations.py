...
class CertificateProfileOperations(object):
    ...
    def create(
        ...
        certificate_profile=None,  # type: Optional["models.CertificateProfile"]
        **kwargs  # type: Any
    ):
        ...
        return deserialized
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSignAccounts/{accountName}/certificateProfiles/{profileName}'}  # type: ignore
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSignAccounts/{accountName}/certificateProfiles/{profileName}'}  # type: ignore

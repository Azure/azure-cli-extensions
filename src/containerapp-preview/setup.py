...
setup(
    ...
    version=VERSION,
    description='Microsoft Azure Command-Line Tools Containerapps Extension',
    ...
    url='https://github.com/azure/azure-cli-extensions/tree/main/src/containerapp-preview',

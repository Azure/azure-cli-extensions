...
class VmExecuteStart(AAZCommand):
    """VirtualMachinesExecuteStart: Execute start operation for a batch of virtual machines, this operation is triggered as soon as Computeschedule receives it.

    :example: VirtualMachinesExecuteStart
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesExecuteStart(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesExecuteStart(AAZHttpOperation):
...
class _VmExecuteStartHelper:
    """Helper class for VmExecuteStart"""


__all__ = ["VmExecuteStart"]

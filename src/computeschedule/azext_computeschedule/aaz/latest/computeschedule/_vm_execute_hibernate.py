...
@register_command(
    "computeschedule vm-execute-hibernate",
)
class VmExecuteHibernate(AAZCommand):
    """VirtualMachinesExecuteHibernate: Execute hibernate operation for a batch of virtual machines, this operation is triggered as soon as Computeschedule receives it.

    :example: VirtualMachinesExecuteHibernate
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesExecuteHibernate(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesExecuteHibernate(AAZHttpOperation):
...
class _VmExecuteHibernateHelper:
    """Helper class for VmExecuteHibernate"""


__all__ = ["VmExecuteHibernate"]

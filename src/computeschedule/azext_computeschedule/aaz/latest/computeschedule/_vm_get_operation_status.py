...
class VmGetOperationStatus(AAZCommand):
    """VirtualMachinesGetOperationStatus: Polling endpoint to read status of operations performed on virtual machines

    :example: VirtualMachinesGetOperationStatus
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesGetOperationStatus(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesGetOperationStatus(AAZHttpOperation):
...
class _VmGetOperationStatusHelper:
    """Helper class for VmGetOperationStatus"""


__all__ = ["VmGetOperationStatus"]

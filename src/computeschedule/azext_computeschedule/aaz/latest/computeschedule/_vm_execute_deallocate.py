...
@register_command(
    "computeschedule vm-execute-deallocate",
)
class VmExecuteDeallocate(AAZCommand):
    """VirtualMachinesExecuteDeallocate: Execute deallocate operation for a batch of virtual machines, this operation is triggered as soon as Computeschedule receives it.

    :example: VirtualMachinesExecuteDeallocate
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesExecuteDeallocate(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesExecuteDeallocate(AAZHttpOperation):
...
class _VmExecuteDeallocateHelper:
    """Helper class for VmExecuteDeallocate"""


__all__ = ["VmExecuteDeallocate"]

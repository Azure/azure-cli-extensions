...
class VmSubmitDeallocate(AAZCommand):
    """VirtualMachinesSubmitDeallocate: Schedule deallocate operation for a batch of virtual machines at datetime in future.

    :example: VirtualMachinesSubmitDeallocate
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesSubmitDeallocate(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesSubmitDeallocate(AAZHttpOperation):
...
class _VmSubmitDeallocateHelper:
    """Helper class for VmSubmitDeallocate"""


__all__ = ["VmSubmitDeallocate"]

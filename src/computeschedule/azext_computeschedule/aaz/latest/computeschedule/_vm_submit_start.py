...
@register_command(
    "computeschedule vm-submit-start",
)
class VmSubmitStart(AAZCommand):
    """VirtualMachinesSubmitStart: Schedule start operation for a batch of virtual machines at datetime in future.

    :example: VirtualMachinesSubmitStart
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ScheduledActionsVirtualMachinesSubmitStart(ctx=self.ctx)()
    ...
    class ScheduledActionsVirtualMachinesSubmitStart(AAZHttpOperation):
...
class _VmSubmitStartHelper:
    """Helper class for VmSubmitStart"""


__all__ = ["VmSubmitStart"]

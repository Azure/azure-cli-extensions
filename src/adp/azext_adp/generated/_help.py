...
helps['adp account list'] = """
    type: command
    short-summary: "List all ADP accounts available under the subscription"
    examples:
...
helps['adp account create'] = """
    type: command
    short-summary: "Creates or updates an ADP account."
    examples:
      - name: Put account
        text: |-
...
helps['adp data-pool create'] = """
    type: command
    short-summary: "Creates or updates a Data Pool."
    parameters:
      - name: --locations

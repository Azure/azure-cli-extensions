...
class AccountOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.adp.v2020_07_01_preview.models.AccountList]
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        _parameters = models.AccountPatch(tags=tags)
        api_version = "2020-07-01-preview"
        ...
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'AccountPatch')
        else:
            body_content = None
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.adp.v2020_07_01_preview.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        _parameters = models.Account(tags=tags, location=location)
        api_version = "2020-07-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'Account')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content

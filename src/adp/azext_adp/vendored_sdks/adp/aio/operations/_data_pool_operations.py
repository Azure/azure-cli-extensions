...
class DataPoolOperations:
    """DataPoolOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.adp.v2020_07_01_preview.models.DataPoolList]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.adp.v2020_07_01_preview.models.DataPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=50, min_length=0, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
            'dataPoolName': self._serialize.url("data_pool_name", data_pool_name, 'str', max_length=50, min_length=0, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def _update_initial(
        ...
        account_name: str,
        data_pool_name: str,
        locations: Optional[List["models.DataPoolLocation"]] = None,
        **kwargs
    ) -> "models.DataPool":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataPool"]
        error_map = {
        ...
        parameters = models.DataPoolPatch(locations=locations)
        api_version = "2020-07-01-preview"
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.adp.v2020_07_01_preview.models.DataPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        parameters = models.DataPool(locations=locations)
        api_version = "2020-07-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

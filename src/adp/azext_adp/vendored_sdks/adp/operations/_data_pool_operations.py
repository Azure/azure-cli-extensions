...
class DataPoolOperations(object):
    """DataPoolOperations operations.
    ...
    def _update_initial(
        ...
        account_name,  # type: str
        data_pool_name,  # type: str
        locations=None,  # type: Optional[List["models.DataPoolLocation"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DataPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataPool"]
        ...
        _parameters = models.DataPoolPatch(locations=locations)
        api_version = "2020-07-01-preview"
        ...
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'DataPoolPatch')
        else:
            body_content = None
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.DataPool(locations=locations)
        api_version = "2020-07-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'DataPool')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content

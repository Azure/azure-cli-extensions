...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.FileSharesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.FileSharesListByParent(ctx=self.ctx)()
    ...
    class FileSharesListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            nfs_protocol_properties = cls._schema_on_200.value.Element.properties.nfs_protocol_properties
            ...
            public_access_properties = cls._schema_on_200.value.Element.properties.public_access_properties
            public_access_properties.allowed_subnets = AAZListType(
                serialized_name="allowedSubnets",
            )

            allowed_subnets = cls._schema_on_200.value.Element.properties.public_access_properties.allowed_subnets
    ...
    class FileSharesListByParent(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
@register_command(
    "file-shares file-share private-link-resource show",
)
class Show(AAZCommand):
    """Get the private link resources that need to be created for a file share.

    :example: Get PrivateLinkResource
        az file-shares file-share private-link-resource show --resource-group res4303 --resource-name testfileshare01 --private-link-resource-name fileshare
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.private_link_resource_name = AAZStrArg(
            options=["-n", "--name", "--private-link-resource-name"],
    ...
    class PrivateLinkResourcesGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.FileShares/fileShares/{resourceName}/privateLinkResources/{privateLinkResourceName}",
                **self.url_parameters
            )
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "privateLinkResourceName", self.ctx.args.private_link_resource_name,
                    required=True,
                ),
                **self.serialize_url_param(

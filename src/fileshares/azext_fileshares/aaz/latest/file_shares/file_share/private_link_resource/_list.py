...
@register_command(
    "file-shares file-share private-link-resource list",
)
class List(AAZCommand):
    """List the private link resources that need to be created for a file share.

    :example: List PrivateLinkResources
        az file-shares file-share private-link-resource list --resource-group res4303 --resource-name testfileshare01
    """

...
@register_command(
    "file-shares file-share private-endpoint-connection update",
)
class Update(AAZCommand):
    ...
    :example: PrivateEndpointConnections_Create
        az file-shares file-share private-endpoint-connection update --resource-group rgfileshares --resource-name fileshare --private-endpoint-connection-name privateEndpointConnection1
    """

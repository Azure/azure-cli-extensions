...
@register_command(
    "file-shares file-share private-endpoint-connection create",
)
class Create(AAZCommand):
    ...
    :example: PrivateEndpointConnections_Create
        az file-shares file-share private-endpoint-connection create --resource-group rgfileshares --resource-name fileshare --private-endpoint-connection-name privateEndpointConnection1 --private-link-service-connection-state "{status:Approved,description:'Approved by admin'}"
    """
    ...
    class PrivateEndpointConnectionsCreate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.FileShares/fileShares/{resourceName}/privateEndpointConnections/{privateEndpointConnectionName}",
                **self.url_parameters
            )

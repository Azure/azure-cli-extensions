...
@register_command(
    "file-shares file-share private-endpoint-connection show",
)
class Show(AAZCommand):
    """Get the specified private endpoint connection associated with the file share.

    :example: PrivateEndpointConnections_Get
        az file-shares file-share private-endpoint-connection show --resource-group rgfileshares --resource-name fileshare --private-endpoint-connection-name privateEndpointConnection1
    """

...
@register_command(
    "file-shares file-share private-endpoint-connection delete",
...
class Delete(AAZCommand):
    ...
    :example: PrivateEndpointConnections_Delete
        az file-shares file-share private-endpoint-connection delete --resource-group rgfileshares --resource-name fileshare --private-endpoint-connection-name privateEndpointConnection1
    """

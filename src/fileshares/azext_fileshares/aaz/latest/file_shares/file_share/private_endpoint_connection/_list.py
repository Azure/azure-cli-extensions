...
@register_command(
    "file-shares file-share private-endpoint-connection list",
)
class List(AAZCommand):
    """List a PrivateEndpointConnection List.

    :example: PrivateEndpointConnections_ListByFileShare
        az file-shares file-share private-endpoint-connection list --resource-group rgfileshares --resource-name fileshare
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PrivateEndpointConnectionsListByFileShare(ctx=self.ctx)()
    ...
    class PrivateEndpointConnectionsListByFileShare(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.FileShares/fileShares/{resourceName}/privateEndpointConnections",
                **self.url_parameters
            )

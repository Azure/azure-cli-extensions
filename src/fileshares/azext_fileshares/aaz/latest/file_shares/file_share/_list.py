...
@register_command(
    "file-shares file-share list",
)
class List(AAZCommand):
    """List FileShare resources by subscription ID

    :example: FileShares_ListBySubscription_MaximumSet
        az file-shares file-share list

    :example: FileShares_ListBySubscription_MinimumSet
        az file-shares file-share list

    :example: FileShares_ListByParent_MaximumSet

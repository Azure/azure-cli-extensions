...
@register_command(
    "file-shares file-share create",
)
class Create(AAZCommand):
    """Create a file share.

    :example: FileShares_CreateOrUpdate_MaximumSet
        az file-shares file-share create --resource-group rgfileshares --resource-name fileshare --mount-name fileshare --media-tier SSD --redundancy Local --protocol NFS --provisioned-storage-gi-b 8 --provisioned-io-per-sec 5 --provisioned-throughput-mi-b-per-sec 22 --nfs-protocol-properties "{root-squash:NoRootSquash,encryption-in-transit-required:Enabled}" --public-access-properties "{allowed-subnets:[/subscriptions/9760acf5-4638-11e7-9bdb-020073ca7778/resourceGroups/myRP/providers/Microsoft.Network/virtualNetworks/testvnet3/subnets/testsubnet3]}" --public-network-access Enabled --tags "{key9647:xwokdvyoae}" --location westus
    """

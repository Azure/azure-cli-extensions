...
@register_command(
    "file-shares file-share update",
)
class Update(AAZCommand):
    """Update a file share.

    :example: FileShares_CreateOrUpdate_MaximumSet
        az file-shares file-share update --resource-group rgfileshares --resource-name fileshare
    """
...
class _UpdateHelper:
    ...
    def _build_schema_file_share_read(cls, _schema):
        if cls._schema_file_share_read is not None:
            ...
            _schema.identity = cls._schema_file_share_read.identity
        ...
        file_share_read.identity = AAZIdentityObjectType()
        ...
        identity = _schema_file_share_read.identity
        ...
        user_assigned_identities = _schema_file_share_read.identity.user_assigned_identities
        user_assigned_identities.Element = AAZObjectType(
            nullable=True,
        )

        _element = _schema_file_share_read.identity.user_assigned_identities.Element

...
@register_command(
    "file-shares file-share file-share-snapshot create",
)
class Create(AAZCommand):
    """Create a FileShareSnapshot.

    :example: FileShareSnapshot_CreateOrUpdate_MaximumSet
        az file-shares file-share file-share-snapshot create --resource-group rgfileshares --resource-name fileshare --name testfilesharesnapshot --metadata "{key9372:jtc}"
    """

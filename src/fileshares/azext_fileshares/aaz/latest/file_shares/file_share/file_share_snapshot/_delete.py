...
@register_command(
    "file-shares file-share file-share-snapshot delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a FileShareSnapshot.

    :example: FileShareSnapshot_Delete_MaximumSet
        az file-shares file-share file-share-snapshot delete --resource-group rgfileshares --resource-name fileshare --name testfilesharesnapshot
    """

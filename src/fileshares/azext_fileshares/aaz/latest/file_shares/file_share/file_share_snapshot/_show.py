...
@register_command(
    "file-shares file-share file-share-snapshot show",
)
class Show(AAZCommand):
    """Get a FileShareSnapshot

    :example: FileShareSnapshot_Get_MaximumSet
        az file-shares file-share file-share-snapshot show --resource-group rgfileshares --resource-name fileshare --name testfilesharesnapshot
    """

...
@register_command(
    "file-shares file-share file-share-snapshot update",
)
class Update(AAZCommand):
    """Update a FileShareSnapshot.

    :example: FileShareSnapshot_Update_MaximumSet
        az file-shares file-share file-share-snapshot update --resource-group rgfileshares --resource-name fileshare --name testfilesharesnapshot --metadata "{key491:dalhvhxqhjszelfuueetvxmgkbukwa}"
    """

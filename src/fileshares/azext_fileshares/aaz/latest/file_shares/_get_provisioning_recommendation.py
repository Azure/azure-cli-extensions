...
@register_command(
    "file-shares get-provisioning-recommendation",
)
class GetProvisioningRecommendation(AAZCommand):
    """Get file shares provisioning parameters recommendation.

    :example: FileShare_GetProvisioningRecommendation_MaximumSet
    ...
    class FileShareGetProvisioningRecommendation(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("provisionedStorageGiB", AAZIntType, ".provisioned_storage_gi_b", typ_kwargs={"flags": {"required": True}})

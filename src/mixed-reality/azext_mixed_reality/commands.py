...
from ._client_factory import spatial_anchors_account
...
def load_command_table(self, _):
    spatial_anchors_account_util = CliCommandType(
        ...
        client_factory=spatial_anchors_account,
        client_arg_name='self',
        exception_handler=mixed_reality_exception_handler
    )

    with self.command_group('spatial_anchors_account', spatial_anchors_account_util, client_factory=spatial_anchors_account) as g:
        g.custom_command('create', 'cli_spatial_anchors_account_create')

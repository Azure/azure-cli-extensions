...
def load_command_table(self, _):
    ...
    with self.command_group('mixed-reality', mixed_reality_, client_factory=cf_mixed_reality) as g:
        g.custom_command('check-name-availability-local', 'check_name_availability_local_mixed_reality')
    ...
    with self.command_group('mixed-reality remote-rendering-account', mixed_reality_remote_rendering_accounts, client_factory=cf_remote_rendering_accounts) as g:
        ...
        g.custom_show_command('show', 'get_mixed_reality_remote_rendering_account')
    ...
    with self.command_group('mixed-reality spatial-anchors-account', mixed_reality_spatial_anchors_accounts, client_factory=cf_spatial_anchors_accounts) as g:
        ...
        g.custom_show_command('show', 'get_mixed_reality_spatial_anchors_account')

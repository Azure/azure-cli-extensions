...
@register_command(
    "spatial-anchors-account key renew",
    is_preview=True,
)
class Renew(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Regenerate"

        _args_schema = cls._args_schema
        _args_schema.serial = AAZIntArg(
            options=["--serial"],
            arg_group="Regenerate",
            help="Serial of key to be regenerated",
            default=1,
            enum={"1": 1, "2": 2},
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SpatialAnchorsAccountsRegenerateKeys(ctx=self.ctx)()

...
@register_command(
    "spatial-anchors-account update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    class SpatialAnchorsAccountsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_spatial_anchors_account_read(cls._schema_on_200)
    ...
    class SpatialAnchorsAccountsCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_spatial_anchors_account_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_spatial_anchors_account_read = None

    @classmethod
    def _build_schema_spatial_anchors_account_read(cls, _schema):
        if cls._schema_spatial_anchors_account_read is not None:
            _schema.id = cls._schema_spatial_anchors_account_read.id
            _schema.identity = cls._schema_spatial_anchors_account_read.identity
            _schema.kind = cls._schema_spatial_anchors_account_read.kind
            _schema.location = cls._schema_spatial_anchors_account_read.location
            _schema.name = cls._schema_spatial_anchors_account_read.name
            _schema.plan = cls._schema_spatial_anchors_account_read.plan
            _schema.properties = cls._schema_spatial_anchors_account_read.properties
            _schema.sku = cls._schema_spatial_anchors_account_read.sku
            _schema.system_data = cls._schema_spatial_anchors_account_read.system_data
            _schema.tags = cls._schema_spatial_anchors_account_read.tags
            _schema.type = cls._schema_spatial_anchors_account_read.type
            return

        cls._schema_spatial_anchors_account_read = _schema_spatial_anchors_account_read = AAZObjectType()

        spatial_anchors_account_read = _schema_spatial_anchors_account_read
        spatial_anchors_account_read.id = AAZStrType(
            flags={"read_only": True},
        )
        spatial_anchors_account_read.identity = AAZObjectType()
        cls._build_schema_identity_read(spatial_anchors_account_read.identity)
        spatial_anchors_account_read.kind = AAZObjectType()
        cls._build_schema_sku_read(spatial_anchors_account_read.kind)
        spatial_anchors_account_read.location = AAZStrType(
            flags={"required": True},
        )
        spatial_anchors_account_read.name = AAZStrType(
            flags={"read_only": True},
        )
        spatial_anchors_account_read.plan = AAZObjectType()
        cls._build_schema_identity_read(spatial_anchors_account_read.plan)
        spatial_anchors_account_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        spatial_anchors_account_read.sku = AAZObjectType()
        cls._build_schema_sku_read(spatial_anchors_account_read.sku)
        spatial_anchors_account_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        spatial_anchors_account_read.tags = AAZDictType()
        spatial_anchors_account_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_spatial_anchors_account_read.properties
        ...
        system_data = _schema_spatial_anchors_account_read.system_data
        ...
        tags = _schema_spatial_anchors_account_read.tags

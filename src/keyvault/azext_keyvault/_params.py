...
def load_arguments(self, _):
    from azext_keyvault.keyvault.models import JsonWebKeyOperation
    from azext_keyvault.keyvault.models import KeyAttributes, SecretAttributes, CertificateAttributes, StorageAccountAttributes
    from azext_keyvault.mgmt.keyvault.models.key_vault_management_client_enums import (

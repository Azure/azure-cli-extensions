...
class VaultsOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, vault_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.keyvault.models.Vault]]

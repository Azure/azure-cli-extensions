...
def load_command_table(self, _):
    ...
    kv_vaults_sdk = CliCommandType(
        operations_tmpl='azext_keyvault.mgmt.keyvault.operations.vaults_operations#VaultsOperations.{}',
        client_factory=keyvault_client_vaults_factory
    )

    kv_data_sdk = CliCommandType(
        operations_tmpl='azext_keyvault.keyvault.key_vault_client#KeyVaultClient.{}',
    ...
    with self.command_group('keyvault', kv_vaults_sdk, client_factory=keyvault_client_vaults_factory) as g:
        g.custom_command('create', 'create_keyvault', doc_string_source='azext_keyvault.mgmt.keyvault.models#VaultProperties')

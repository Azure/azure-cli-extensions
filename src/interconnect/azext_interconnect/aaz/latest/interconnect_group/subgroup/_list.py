...
@register_command(
    "interconnect-group subgroup list",
)
class List(AAZCommand):
    """List all subgroups in an interconnect group.

    :example: List subgroups
        az network interconnect-group subgroup list --resource-group rg1 --interconnect-group-name test-ig
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SubgroupsList(ctx=self.ctx)()
    ...
    class SubgroupsList(AAZHttpOperation):

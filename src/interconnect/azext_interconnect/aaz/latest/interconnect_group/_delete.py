...
@register_command(
    "interconnect-group delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete the specified interconnect group.

    :example: Delete interconnect group
        az network interconnect-group delete --resource-group rg1 --interconnect-group-name test-ig
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.InterconnectGroupsDelete(ctx=self.ctx)()
    ...
    class InterconnectGroupsDelete(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ClusterAssociationsListByParent(ctx=self.ctx)()
    ...
    class ClusterAssociationsListByParent(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkSecurity/agentFabrics/{agentFabricName}/clusterAssociations",
                **self.url_parameters
            )

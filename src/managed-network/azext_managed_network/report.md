...
```
managed-network scope-assignment create --scope "/subscriptions/{{ subscription_id }}"
...
```
managed-network scope-assignment delete --scope "/subscriptions/{{ subscription_id }}"
        --name subscriptionCAssignment
```

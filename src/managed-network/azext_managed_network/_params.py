...
def load_arguments(self, _):
    ...
    with self.argument_context('managed-network peering-policy create') as c:
        ...
        c.argument('location', arg_type=get_location_type(self.cli_ctx))
        c.argument('policy_type', options_list=['--type', '--policy-type'], arg_type=get_enum_type(['HubAndSpokeTopology', 'MeshTopology']), id_part=None, help='Gets or sets the connectivity type of a network structure policy')

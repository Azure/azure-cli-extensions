...
def load_arguments(self, _):
    ...
    with self.argument_context('managednetwork group create') as c:
        c.argument('resource_group', resource_group_name_type)
    ...
    with self.argument_context('managednetwork group update') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Group.')
        c.argument('location', arg_type=get_location_type(self.cli_ctx))
    ...
    with self.argument_context('managednetwork group delete') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Group.')

    with self.argument_context('managednetwork group list') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')

    with self.argument_context('managednetwork group show') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Group.')

    with self.argument_context('managednetwork peering-policy create') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
    ...
    with self.argument_context('managednetwork peering-policy update') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Peering Policy.')
        c.argument('location', arg_type=get_location_type(self.cli_ctx))
    ...
    with self.argument_context('managednetwork peering-policy delete') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Peering Policy.')

    with self.argument_context('managednetwork peering-policy list') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')

    with self.argument_context('managednetwork peering-policy show') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('managed_network_name', id_part=None, help='The name of the Managed Network.')
        c.argument('name', id_part=None, help='The name of the Managed Network Peering Policy.')

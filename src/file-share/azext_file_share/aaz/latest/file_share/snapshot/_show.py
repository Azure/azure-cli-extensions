...
@register_command(
    "file-share snapshot show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a FileShareSnapshot

    :example: Show a File Share Snapshot
        az file-share snapshot show --resource-group rgfileshares --resource-name fileshare --name testfilesharesnapshot
    """

...
@register_command(
    "file-share snapshot list",
    is_preview=True,
)
class List(AAZCommand):
    """List FileShareSnapshot by FileShare.

    :example: List File Share Snapshots
        az file-share snapshot list --resource-group rgfileshares --resource-name fileshare
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FileShareSnapshotList(ctx=self.ctx)()
    ...
    class FileShareSnapshotList(AAZHttpOperation):

...
class IntegrationServiceEnvironmentSkuOperations:
    """IntegrationServiceEnvironmentSkuOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~logic_management_client.models.IntegrationServiceEnvironmentSkuList]

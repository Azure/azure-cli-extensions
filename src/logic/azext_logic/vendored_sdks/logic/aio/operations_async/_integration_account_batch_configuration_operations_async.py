...
class IntegrationAccountBatchConfigurationOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.BatchConfigurationCollection"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.BatchConfiguration"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        batch_configuration_name: str,
        properties: "models.BatchConfigurationProperties",

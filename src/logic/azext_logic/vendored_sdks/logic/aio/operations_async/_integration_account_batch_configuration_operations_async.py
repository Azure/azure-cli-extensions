...
class IntegrationAccountBatchConfigurationOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> "models.BatchConfigurationCollection":
    ...
    async def create_or_update(
        ...
        release_criteria: "models.BatchReleaseCriteria",
        location: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        created_time: Optional[datetime.datetime] = None,
        changed_time: Optional[datetime.datetime] = None,
        metadata: Optional[object] = None,
        batch_configuration_properties_created_time: Optional[datetime.datetime] = None,
        batch_configuration_properties_changed_time: Optional[datetime.datetime] = None,
        **kwargs
    ) -> "models.BatchConfiguration":

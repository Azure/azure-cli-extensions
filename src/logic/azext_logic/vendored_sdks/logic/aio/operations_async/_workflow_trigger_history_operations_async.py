...
class WorkflowTriggerHistoryOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.WorkflowTriggerHistoryListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~logic_management_client.models.WorkflowTriggerHistoryListResult]

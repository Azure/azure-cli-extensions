...
class WorkflowTriggerHistoryOperations:
    """WorkflowTriggerHistoryOperations async operations.
    ...
    def list(
        ...
        **kwargs
    ) -> "models.WorkflowTriggerHistoryListResult":
        ...
        """
        cls: ClsType["models.WorkflowTriggerHistoryListResult"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.WorkflowTriggerHistory"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"

...
class IntegrationAccountPartnerOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.IntegrationAccountPartnerListResult"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.IntegrationAccountPartner"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"
    ...
    async def create_or_update(
        ...
        metadata: Optional["models.IntegrationAccountPartnerPropertiesMetadata"] = None,
        **kwargs
    ) -> "models.IntegrationAccountPartner":

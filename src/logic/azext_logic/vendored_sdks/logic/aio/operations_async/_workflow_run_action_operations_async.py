...
class WorkflowRunActionOperations:
    """WorkflowRunActionOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~logic_management_client.models.WorkflowRunActionListResult
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.WorkflowRunActionListResult"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.WorkflowRunAction"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"
    ...
    def list_expression_trace(
        ...
        **kwargs
        ...
        :rtype: ~logic_management_client.models.ExpressionTraces
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.ExpressionTraces"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"

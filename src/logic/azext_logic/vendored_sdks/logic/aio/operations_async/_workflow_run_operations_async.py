...
class WorkflowRunOperations:
    """WorkflowRunOperations async operations.
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.WorkflowRunListResult"]:
     ...
     StartTime, and ClientTrackingId.
        ...
        :return: An iterator like instance of either WorkflowRunListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~logic_management_client.models.WorkflowRunListResult]

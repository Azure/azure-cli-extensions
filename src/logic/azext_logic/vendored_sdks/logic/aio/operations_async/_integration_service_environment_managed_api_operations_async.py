...
class IntegrationServiceEnvironmentManagedApiOperations:
    ...
    async def begin_put(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedApi or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~logic_management_client.models.ManagedApi]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
class IntegrationAccountSchemaOperations:
    """IntegrationAccountSchemaOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.IntegrationAccountSchemaListResult"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.IntegrationAccountSchema"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        schema_name: str,
        schema_type: Union[str, "models.SchemaType"],
        location: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        target_namespace: Optional[str] = None,
        document_name: Optional[str] = None,
        file_name: Optional[str] = None,
        metadata: Optional["models.IntegrationAccountSchemaPropertiesMetadata"] = None,

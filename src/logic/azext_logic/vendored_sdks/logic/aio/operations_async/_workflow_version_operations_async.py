...
class WorkflowVersionOperations:
    """WorkflowVersionOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.WorkflowVersionListResult"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~logic_management_client.models.ErrorResponseException:
        """
        cls: ClsType["models.WorkflowVersion"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-05-01"

...
class WorkflowVersionsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.WorkflowVersionListResult"]
        ...
        :return: An iterator like instance of either WorkflowVersionListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~logic_management_client.models.WorkflowVersionListResult]

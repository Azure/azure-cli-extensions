...
class IntegrationAccountPartnerOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~logic_management_client.models.IntegrationAccountPartnerListResult]
    ...
    def create_or_update(
        ...
        business_identities=None,  # type: Optional[List["models.BusinessIdentity"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.IntegrationAccountPartner"
        ...
        partner = models.IntegrationAccountPartner(location=location, tags=tags, partner_type=partner_type, metadata=metadata, business_identities=business_identities)
        api_version = "2019-05-01"

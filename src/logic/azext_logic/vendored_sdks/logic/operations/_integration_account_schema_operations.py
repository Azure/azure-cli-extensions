...
class IntegrationAccountSchemaOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('IntegrationAccountSchemaListResult', pipeline_response)
    ...
    def create_or_update(
        ...
        integration_account_name,  # type: str
        schema_name,  # type: str
        schema_type,  # type: Union[str, "models.SchemaType"]
        location=None,  # type: Optional[str]
        tags=None,  # type: Optional[Dict[str, str]]
        target_namespace=None,  # type: Optional[str]
        document_name=None,  # type: Optional[str]
        file_name=None,  # type: Optional[str]
        metadata=None,  # type: Optional["models.IntegrationAccountSchemaPropertiesMetadata"]
        ...
        **kwargs  # type: Any
        ...
        :type metadata: ~logic_management_client.models.IntegrationAccountSchemaPropertiesMetadata
        :param content: The content.
        :type content: str
        :param content_type: The content type.
        :type content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: IntegrationAccountSchema or IntegrationAccountSchema or the result of cls(response)
        ...
        schema = models.IntegrationAccountSchema(location=location, tags=tags, schema_type=schema_type, target_namespace=target_namespace, document_name=document_name, file_name=file_name, metadata=metadata, content=content, content_type=content_type)
        api_version = "2019-05-01"

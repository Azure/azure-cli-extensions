...
class IntegrationAccountCertificateOperations(object):
    """IntegrationAccountCertificateOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.IntegrationAccountCertificateListResult"]
        ...
        :return: An iterator like instance of either IntegrationAccountCertificateListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~logic_management_client.models.IntegrationAccountCertificateListResult]
    ...
    def create_or_update(
        ...
        key_vault=None,  # type: Optional["models.KeyVaultKeyReferenceKeyVault"]
        ...
        **kwargs  # type: Any
        ...
        certificate = models.IntegrationAccountCertificate(location=location, tags=tags, metadata=metadata, public_certificate=public_certificate, key_vault=key_vault, key_name=key_name, key_version=key_version)
        api_version = "2019-05-01"

...
class WorkflowOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~logic_management_client.models.WorkflowListResult]
    ...
    def create_or_update(
        ...
        parameters=None,  # type: Optional[Dict[str, "models.WorkflowParameter"]]
        id=None,  # type: Optional[str]
        triggers=None,  # type: Optional["models.FlowAccessControlConfigurationPolicy"]
        contents=None,  # type: Optional["models.FlowAccessControlConfigurationPolicy"]
        actions=None,  # type: Optional["models.FlowAccessControlConfigurationPolicy"]
        workflow_management=None,  # type: Optional["models.FlowAccessControlConfigurationPolicy"]
        workflow=None,  # type: Optional["models.FlowEndpoints"]
        connector=None,  # type: Optional["models.FlowEndpoints"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Workflow"
        ...
        workflow = models.Workflow(location=location, tags=tags, state=state, definition=definition, parameters=parameters, id_integration_service_environment_id=id, triggers=triggers, contents=contents, actions=actions, workflow_management=workflow_management, workflow=workflow, connector=connector)
        api_version = "2019-05-01"
    ...
    def list_callback_url(
        ...
        **kwargs  # type: Any
        ...
        list_callback_url = models.GetCallbackUrlParameters(not_after=not_after, key_type=key_type)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _move_initial(
        ...
        **kwargs  # type: Any
        ...
        move = models.WorkflowReference(id=id)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def regenerate_access_key(
        ...
        **kwargs  # type: Any
        ...
        key_type = models.RegenerateActionParameter(key_type=key_type)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def validate_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        validate = models.Workflow(location=location, tags=tags, state=state, definition=definition, parameters=parameters, id_integration_service_environment_id=id, triggers=triggers, contents=contents, actions=actions, workflow_management=workflow_management, workflow=workflow, connector=connector)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def validate_by_location(
        ...
        **kwargs  # type: Any
        ...
        validate = models.Workflow(location=resource_location, tags=tags, state=state, definition=definition, parameters=parameters, id_integration_service_environment_id=id, triggers=triggers, contents=contents, actions=actions, workflow_management=workflow_management, workflow=workflow, connector=connector)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

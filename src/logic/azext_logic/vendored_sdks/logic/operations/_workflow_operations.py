...
class WorkflowOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        _workflow = models.Workflow(location=location, tags=tags, state=state, endpoints_configuration=endpoints_configuration, sku=sku, integration_account=integration_account, integration_service_environment=integration_service_environment, definition=definition, parameters=parameters)
        api_version = "2019-05-01"
    ...
    def _move_initial(
        ...
        **kwargs  # type: Any
        ...
        _move = models.Workflow(location=location, tags=tags, state=state, endpoints_configuration=endpoints_configuration, sku=sku, integration_account=integration_account, integration_service_environment=integration_service_environment, definition=definition, parameters=parameters)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")
    ...
    def validate_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        _validate = models.Workflow(location=location, tags=tags, state=state, endpoints_configuration=endpoints_configuration, sku=sku, integration_account=integration_account, integration_service_environment=integration_service_environment, definition=definition, parameters=parameters)
        api_version = "2019-05-01"
        content_type = kwargs.pop("content_type", "application/json")

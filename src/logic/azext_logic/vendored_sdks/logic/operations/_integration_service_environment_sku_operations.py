...
class IntegrationServiceEnvironmentSkuOperations(object):
    """IntegrationServiceEnvironmentSkuOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~logic_management_client.models.IntegrationServiceEnvironmentSkuList

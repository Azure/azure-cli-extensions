...
def load_arguments(self, _):
    ...
    with self.argument_context('logic workflow create') as c:
        ...
        c.argument('parameters', type=validate_file_or_dict, help='The parameters. Expected value: '
                   'json-string/@json-file.')
        c.argument('id_', options_list=['--id'], type=str, help='The resource id.', arg_group='Integration Service '
                   'Environment')
        c.argument('resource_reference_id', type=str, help='The resource id.', arg_group='Integration Account')
        c.argument('triggers', type=validate_file_or_dict, help='The access control configuration for invoking '
                   'workflow triggers. Expected value: json-string/@json-file.', arg_group='Access Control')
        c.argument('contents', type=validate_file_or_dict, help='The access control configuration for accessing '
                   'workflow run contents. Expected value: json-string/@json-file.', arg_group='Access Control')
        c.argument('actions', type=validate_file_or_dict, help='The access control configuration for workflow actions. '
                   'Expected value: json-string/@json-file.', arg_group='Access Control')
        c.argument('workflow_management', type=validate_file_or_dict, help='The access control configuration for '
                   'workflow management. Expected value: json-string/@json-file.', arg_group='Access Control')
        c.argument('properties_endpoints_configuration_workflow', action=AddWorkflow, nargs='+', help='The workflow '
                   'endpoints.', arg_group='Endpoints Configuration')
        c.argument('connector', action=AddWorkflow, nargs='+', help='The connector endpoints.', arg_group='Endpoints '
                   'Configuration')
    ...
    with self.argument_context('logic workflow validate-by-location') as c:
        ...
        c.argument('workflow_management', type=validate_file_or_dict, help='The access control configuration for '
                   'workflow management. Expected value: json-string/@json-file.', arg_group='Access Control')
        c.argument('workflow', action=AddWorkflow, nargs='+', help='The workflow endpoints.', arg_group='Endpoints '
                   'Configuration')
        c.argument('connector', action=AddWorkflow, nargs='+', help='The connector endpoints.', arg_group='Endpoints '
                   'Configuration')
    ...
    with self.argument_context('logic workflow-trigger show-schema-json') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('workflow_name', type=str, help='The workflow name.', id_part='name')
        c.argument('trigger_name', type=str, help='The workflow trigger name.', id_part='child_name_1')
    ...
    with self.argument_context('logic integration-account create') as c:
        ...
        c.argument('resource_location', type=str, help='The resource location.', arg_group='Integration Service '
                   'Environment')
        c.argument('resource_tags', action=AddResourceTags, nargs='+', help='The resource tags. Expect value: '
                   'KEY1=VALUE1 KEY2=VALUE2 ...', arg_group='Integration Service Environment')
        c.argument('sku', action=AddSku, nargs='+', help='The sku.', arg_group='Integration Service Environment')
        c.argument('provisioning_state', arg_type=get_enum_type(['NotSpecified', 'Accepted', 'Running', 'Ready',
                   ...
                   help='The provisioning state.', arg_group='Integration Service Environment Properties')
        c.argument('workflow_state', arg_type=get_enum_type(['NotSpecified', 'Completed', 'Enabled', 'Disabled',
                                                             'Deleted', 'Suspended']), help='The integration service '
                   'environment state.', arg_group='Integration Service Environment Properties')
        c.argument('integration_service_environment_id', type=str, help='Gets the tracking id.',
                   arg_group='Integration Service Environment Properties')
        c.argument('endpoints_configuration', type=validate_file_or_dict, help='The endpoints configuration. Expected '
                   'value: json-string/@json-file.', arg_group='Integration Service Environment Properties')
        ...
        c.argument('encryption_configuration', type=validate_file_or_dict, help='The encryption configuration. '
                   'Expected value: json-string/@json-file.', arg_group='Integration Service Environment Properties')
        c.argument('name', arg_type=get_enum_type(['NotSpecified', 'Free', 'Basic', 'Standard']), help='The sku name.',
                   arg_group='Sku')
    ...
    with self.argument_context('logic integration-account list-key-vault-key') as c:
        ...
        c.argument('id_', options_list=['--id'], type=str, help='The resource id.', arg_group='Key Vault')
    ...
    with self.argument_context('logic integration-account-batch-configuration create') as c:
        ...
        c.argument('message_count', type=int, help='The message count.', arg_group='Release Criteria')
        c.argument('batch_size', type=int, help='The batch size in bytes.', arg_group='Release Criteria')
        c.argument('frequency', arg_type=get_enum_type(['NotSpecified', 'Second', 'Minute', 'Hour', 'Day', 'Week',
                                                        'Month', 'Year']), help='The frequency.', arg_group='Release '
                   'Criteria Recurrence')
        c.argument('interval', type=int, help='The interval.', arg_group='Release Criteria Recurrence')
        c.argument('start_time', type=str, help='The start time.', arg_group='Release Criteria Recurrence')
        c.argument('end_time', type=str, help='The end time.', arg_group='Release Criteria Recurrence')
        c.argument('time_zone', type=str, help='The time zone.', arg_group='Release Criteria Recurrence')
        c.argument('minutes', nargs='+', help='The minutes.', arg_group='Release Criteria Recurrence Schedule')
        c.argument('hours', nargs='+', help='The hours.', arg_group='Release Criteria Recurrence Schedule')
        c.argument('week_days', nargs='+', help='The days of the week.', arg_group='Release Criteria Recurrence '
                   'Schedule')
        c.argument('month_days', nargs='+', help='The month days.', arg_group='Release Criteria Recurrence Schedule')
        c.argument('monthly_occurrences', action=AddMonthlyOccurrences, nargs='+', help='The monthly occurrences.',
                   arg_group='Release Criteria Recurrence Schedule')
    ...
    with self.argument_context('logic integration-account-map create') as c:
        ...
        c.argument('location', arg_type=get_location_type(self.cli_ctx), required=False,
                   validator=get_default_location_from_resource_group)
        c.argument('tags', tags_type)
        c.argument('map_type', arg_type=get_enum_type(['NotSpecified', 'Xslt', 'Xslt20', 'Xslt30', 'Liquid']),
                   help='The map type.')
        c.argument('content', type=str, help='The content.')
        c.argument('properties_content_type', type=str, help='The content type.')
        c.argument('metadata', type=validate_file_or_dict,
                   help='The metadata. Expected value: json-string/@json-file.')
        c.argument('ref', type=str, help='The reference name.', arg_group='Parameters Schema')
    ...
    with self.argument_context('logic integration-account-partner create') as c:
        ...
        c.argument('metadata', type=validate_file_or_dict,
                   help='The metadata. Expected value: json-string/@json-file.')
        c.argument('business_identities', action=AddBusinessIdentities, nargs='+', help='The list of partner business '
                   'identities.', arg_group='Content B2b')
    ...
    with self.argument_context('logic integration-account-certificate create') as c:
        ...
        c.argument('key_vault', action=AddKeyVault, nargs='+', help='The key vault reference.', arg_group='Key')
        c.argument('key_name', type=str, help='The private key name in key vault.', arg_group='Key')
        c.argument('key_version', type=str, help='The private key version in key vault.', arg_group='Key')

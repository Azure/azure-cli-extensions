...
helps['logic workflow'] = """
    type: group
    short-summary: Manage workflow with logic
"""
...
helps['logic workflow create'] = """
    ...
    parameters:
      - name: --properties-endpoints-configuration-workflow
        short-summary: "The workflow endpoints."
        long-summary: |
            Usage: --properties-endpoints-configuration-workflow outgoing-ip-addresses=XX \
access-endpoint-ip-addresses=XX
      ...
      - name: --connector
        ...
        long-summary: |
            Usage: --connector outgoing-ip-addresses=XX access-endpoint-ip-addresses=XX
...
json#\\",\\"actions\\":{\\"Find_pet_by_ID\\":{\\"type\\":\\"ApiConnection\\",\\"inputs\\":{\\"path\\":\\"/pet/@{encodeU\
RIComponent(\'1\')}\\",\\"method\\":\\"get\\",\\"host\\":{\\"connection\\":{\\"name\\":\\"@parameters(\'$connections\')\
[\'test-custom-connector\'][\'connectionId\']\\"}}},\\"runAfter\\":{}}},\\"contentVersion\\":\\"1.0.0.0\\",\\"outputs\\\
":{},\\"parameters\\":{\\"$connections\\":{\\"type\\":\\"Object\\",\\"defaultValue\\":{}}},\\"triggers\\":{\\"manual\\"\
:{\\"type\\":\\"Request\\",\\"inputs\\":{\\"schema\\":{}},\\"kind\\":\\"Http\\"}}}" --resource-reference-id \
"/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/test-resource-group/providers/Microsoft.Logic/integ\
rationAccounts/test-integration-account" --parameters "{\\"$connections\\":{\\"value\\":{\\"test-custom-connector\\":{\
\\"connectionId\\":\\"/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/test-resource-group/providers/\
Microsoft.Web/connections/test-custom-connector\\",\\"connectionName\\":\\"test-custom-connector\\",\\"id\\":\\"/subscr\
iptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/providers/Microsoft.Web/locations/brazilsouth/managedApis/test-custom-conn\
ector\\"}}}}" --name "test-workflow"
"""
...
helps['logic workflow validate-by-location'] = """
    ...
    parameters:
      - name: --workflow
        short-summary: "The workflow endpoints."
        long-summary: |
            Usage: --workflow outgoing-ip-addresses=XX access-endpoint-ip-addresses=XX
...
\\":{},\\"parameters\\":{},\\"triggers\\":{}}" --resource-reference-id "/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69a\
b345/resourceGroups/test-resource-group/providers/Microsoft.Logic/integrationAccounts/test-integration-account" --name \
"test-workflow"
"""
...
\\":{},\\"triggers\\":{}}" --resource-reference-id "/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/\
...
helps['logic workflow-version'] = """
    type: group
    short-summary: Manage workflow version with logic
"""
...
helps['logic workflow-trigger'] = """
    type: group
    short-summary: Manage workflow trigger with logic
"""
...
helps['logic workflow-trigger show-schema-json'] = """
    type: command
    short-summary: "Get the trigger schema as JSON."
    examples:
      - name: Get trigger schema
        text: |-
               az logic workflow-trigger show-schema-json --resource-group "testResourceGroup" --trigger-name \
"testTrigger" --workflow-name "testWorkflow"
"""

helps['logic workflow-version-trigger'] = """
    type: group
    short-summary: Manage workflow version trigger with logic
"""
...
helps['logic workflow-trigger-history'] = """
    type: group
    short-summary: Manage workflow trigger history with logic
"""
...
helps['logic workflow-run'] = """
    type: group
    short-summary: Manage workflow run with logic
"""
...
helps['logic workflow-run-action'] = """
    type: group
    short-summary: Manage workflow run action with logic
"""
...
helps['logic workflow-run-action-repetition'] = """
    type: group
    short-summary: Manage workflow run action repetition with logic
"""
...
helps['logic workflow-run-action-repetition-request-history'] = """
    type: group
    short-summary: Manage workflow run action repetition request history with logic
"""
...
helps['logic workflow-run-action-request-history'] = """
    type: group
    short-summary: Manage workflow run action request history with logic
"""
...
helps['logic workflow-run-action-scope-repetition'] = """
    type: group
    short-summary: Manage workflow run action scope repetition with logic
"""
...
helps['logic workflow-run-operation'] = """
    type: group
    short-summary: Manage workflow run operation with logic
"""
...
helps['logic integration-account'] = """
    type: group
    short-summary: Manage integration account with logic
"""
...
helps['logic integration-account list-key-vault-key'] = """
    ...
    examples:
      - name: Get Integration Account callback URL
        text: |-
               az logic integration-account list-key-vault-key --name "testIntegrationAccount" --id \
...
helps['logic integration-account-assembly'] = """
    type: group
    short-summary: Manage integration account assembly with logic
"""
...
helps['logic integration-account-batch-configuration'] = """
    type: group
    short-summary: Manage integration account batch configuration with logic
"""
...
helps['logic integration-account-batch-configuration create'] = """
    ...
    parameters:
      - name: --monthly-occurrences
        short-summary: "The monthly occurrences."
        long-summary: |
            Usage: --monthly-occurrences day=XX occurrence=XX

            day: The day of the week.
            occurrence: The occurrence.

            Multiple actions can be specified by using more than one --monthly-occurrences argument.
    examples:
...
"DEFAULT" --batch-size 234567 --message-count 10 --frequency "Minute" --interval 1 --start-time "2017-03-24T11:43:00" \
--time-zone "India Standard Time" --batch-configuration-name "testBatchConfiguration" --integration-account-name \
"testIntegrationAccount" --resource-group "testResourceGroup"
"""
...
helps['logic integration-account-schema'] = """
    type: group
    short-summary: Manage integration account schema with logic
"""
...
helps['logic integration-account-map'] = """
    type: group
    short-summary: Manage integration account map with logic
"""
...
helps['logic integration-account-partner'] = """
    type: group
    short-summary: Manage integration account partner with logic
"""
...
helps['logic integration-account-partner create'] = """
    ...
    parameters:
      - name: --business-identities
        ...
        long-summary: |
            Usage: --business-identities qualifier=XX value=XX
            ...
            Multiple actions can be specified by using more than one --business-identities argument.
    examples:
...
--location "westus" --business-identities qualifier="AA" value="ZZ" --metadata "{}" --partner-type "B2B" \
--partner-name "testPartner" --resource-group "testResourceGroup"
"""
...
helps['logic integration-account-agreement'] = """
    type: group
    short-summary: Manage integration account agreement with logic
"""
...
helps['logic integration-account-certificate'] = """
    type: group
    short-summary: Manage integration account certificate with logic
"""
...
helps['logic integration-account-certificate create'] = """
    ...
    parameters:
      - name: --key-vault
        ...
        long-summary: |
            Usage: --key-vault id=XX

            id: The resource id.
    examples:
      - name: Create or update a certificate
        text: |-
               az logic integration-account-certificate create --location "brazilsouth" --key-name "<keyName>" \
--key-vault id="/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourcegroups/testResourceGroup/providers/microsof\
t.keyvault/vaults/<keyVaultName>" --key-version "87d9764197604449b9b8eb7bd8710868" --public-certificate \
...
helps['logic integration-account-session'] = """
    type: group
    short-summary: Manage integration account session with logic
"""
...
helps['logic integration-service-environment'] = """
    type: group
    short-summary: Manage integration service environment with logic
"""
...
helps['logic integration-service-environment-sku'] = """
    type: group
    short-summary: Manage integration service environment sku with logic
"""
...
helps['logic integration-service-environment-network-health'] = """
    type: group
    short-summary: Manage integration service environment network health with logic
"""
...
helps['logic integration-service-environment-managed-api'] = """
    type: group
    short-summary: Manage integration service environment managed api with logic
"""
...
helps['logic integration-service-environment-managed-api-operation'] = """
    type: group
    short-summary: Manage integration service environment managed api operation with logic
"""

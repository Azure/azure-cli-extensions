...
def logic_workflow_create(client,
                          resource_group_name,
                          workflow_name,
                          endpoints_configuration_workflow,
                          location=None,
                          tags=None,
                          state=None,
                          definition=None,
...
def logic_integration_account_create(client,
                                     ...
                                     tags=None,
                                     state=None,
                                     integration_service_environment_sku=None,
                                     integration_service_environment_properties_provisioning_state=None,
                                     integration_service_environment_properties_integration_service_environment_id=None,
                                     integration_service_environment_properties_endpoints_configuration=None,
                                     integration_service_environment_properties_network_configuration=None,
                                     integration_service_environment_properties_encryption_configuration=None,
                                     sku_name=None):
    return client.create_or_update(resource_group_name=resource_group_name,
                                   integration_account_name=integration_account_name,
                                   location=location,
                                   tags=tags,
                                   state=state,
                                   sku=integration_service_environment_sku,
                                   provisioning_state=integration_service_environment_properties_provisioning_state,
                                   integration_service_environment_id=integration_service_environment_properties_integration_service_environment_id,
                                   endpoints_configuration=integration_service_environment_properties_endpoints_configuration,
                                   network_configuration=integration_service_environment_properties_network_configuration,
                                   encryption_configuration=integration_service_environment_properties_encryption_configuration,
                                   name=sku_name)
...
def logic_integration_account_agreement_update(instance,
                                               resource_group_name,
                                               integration_account_name,
                                               agreement_name):
    return instance

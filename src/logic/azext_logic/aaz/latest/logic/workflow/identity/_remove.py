...
@register_command(
    "logic workflow identity remove",
)
class Remove(AAZCommand):
    ...
    class WorkflowsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_workflow_read(cls._schema_on_200)
    ...
    class WorkflowsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_workflow_read(cls._schema_on_200_201)

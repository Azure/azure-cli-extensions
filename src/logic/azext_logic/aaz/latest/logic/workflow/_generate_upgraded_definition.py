...
class GenerateUpgradedDefinition(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.target_schema_version = AAZStrArg(
            options=["--target-schema-version"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkflowsGenerateUpgradedDefinition(ctx=self.ctx)()
    ...
    class WorkflowsGenerateUpgradedDefinition(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("targetSchemaVersion", AAZStrType, ".target_schema_version")
...
class _GenerateUpgradedDefinitionHelper:
    """Helper class for GenerateUpgradedDefinition"""


__all__ = ["GenerateUpgradedDefinition"]

...
class ListCallbackUrl(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.key_type = AAZStrArg(
            ...
            help="The key type.",
            enum={"NotSpecified": "NotSpecified", "Primary": "Primary", "Secondary": "Secondary"},
        )
        _args_schema.not_after = AAZDateTimeArg(
            options=["--not-after"],
            arg_group="Parameters",
            help="The expiry time.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.IntegrationAccountsListCallbackUrl(ctx=self.ctx)()
    ...
    class IntegrationAccountsListCallbackUrl(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("notAfter", AAZStrType, ".not_after")
...
class _ListCallbackUrlHelper:
    """Helper class for ListCallbackUrl"""


__all__ = ["ListCallbackUrl"]

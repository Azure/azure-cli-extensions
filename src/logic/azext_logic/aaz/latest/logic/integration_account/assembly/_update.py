...
class Update(AAZCommand):
    ...
    class IntegrationAccountAssembliesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_assembly_definition_read(cls._schema_on_200)
    ...
    class IntegrationAccountAssembliesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_assembly_definition_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_assembly_definition_read = None

    @classmethod
    def _build_schema_assembly_definition_read(cls, _schema):
        if cls._schema_assembly_definition_read is not None:
            _schema.id = cls._schema_assembly_definition_read.id
            _schema.location = cls._schema_assembly_definition_read.location
            _schema.name = cls._schema_assembly_definition_read.name
            _schema.properties = cls._schema_assembly_definition_read.properties
            _schema.tags = cls._schema_assembly_definition_read.tags
            _schema.type = cls._schema_assembly_definition_read.type
            return

        cls._schema_assembly_definition_read = _schema_assembly_definition_read = AAZObjectType()

        assembly_definition_read = _schema_assembly_definition_read
        assembly_definition_read.id = AAZStrType(
            flags={"read_only": True},
        )
        assembly_definition_read.location = AAZStrType()
        assembly_definition_read.name = AAZStrType(
            flags={"read_only": True},
        )
        assembly_definition_read.properties = AAZObjectType(
            flags={"required": True},
        )
        assembly_definition_read.tags = AAZDictType()
        assembly_definition_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_assembly_definition_read.properties
        ...
        content_link = _schema_assembly_definition_read.properties.content_link
        ...
        content_hash = _schema_assembly_definition_read.properties.content_link.content_hash
        content_hash.algorithm = AAZStrType()
        content_hash.value = AAZStrType()

        tags = _schema_assembly_definition_read.tags

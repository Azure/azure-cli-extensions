...
class Delete(AAZCommand):
    ...
    :example: Delete batch configuration
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IntegrationAccountBatchConfigurationsDelete(ctx=self.ctx)()
    ...
    class IntegrationAccountBatchConfigurationsDelete(AAZHttpOperation):

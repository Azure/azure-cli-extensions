...
class List(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.filter = AAZStrArg(
            options=["--filter"],
            help="The filter to apply on the operation. Options for filters include: ChangedTime.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IntegrationAccountSessionsList(ctx=self.ctx)()
    ...
    class IntegrationAccountSessionsList(AAZHttpOperation):

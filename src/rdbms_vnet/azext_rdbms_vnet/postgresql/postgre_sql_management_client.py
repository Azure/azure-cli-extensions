...
class PostgreSQLManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('azure-mgmt-postgresql/{}'.format(VERSION))
...
class PostgreSQLManagementClient(object):
    """The Microsoft Azure management API provides create, read, update, and delete functionality for Azure PostgreSQL resources including servers, databases, firewall rules, VNET rules, log files and configurations with new business model.

...
from azext_fleet_preview._help import helps
from azext_fleet_preview._client_factory import CUSTOM_MGMT_FLEET
...
class FleetCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        fleet_custom = CliCommandType(operations_tmpl='azext_fleet_preview.custom#{}')
        super(FleetCommandsLoader, self).__init__(cli_ctx=cli_ctx,
                                                  resource_type=CUSTOM_MGMT_FLEET,
                                                  custom_command_type=fleet_custom)

    def load_command_table(self, args):
        from azext_fleet_preview.commands import load_command_table
        load_command_table(self, args)
        return self.command_table

    def load_arguments(self, command):
        from azext_fleet_preview._params import load_arguments

...
from azext_fleet_preview._client_factory import cf_fleets, cf_fleet_members, cf_update_runs, cf_fleet_update_strategies


def load_command_table(self, _):

    fleets_sdk = CliCommandType(
        operations_tmpl="azext_fleet_preview.vendored_sdks.operations._fleets_operations#FleetsOperations.{}",
        operation_group="fleets",
        client_factory=cf_fleets
    )

    fleet_members_sdk = CliCommandType(
        operations_tmpl="azext_fleet_preview.vendored_sdks.operations._fleet_members_operations#FleetMembersOperations.{}",
        operation_group="fleet_members",
        client_factory=cf_fleet_members
    )

    update_runs_sdk = CliCommandType(
        operations_tmpl="azext_fleet_preview.vendored_sdks.operations._update_runs_operations#UpdateRunsOperations.{}",
        operation_group="update_runs",
        client_factory=cf_update_runs
    )

    fleet_update_strategy_sdk = CliCommandType(
        operations_tmpl="azext_fleet_preview.vendored_sdks.operations._fleet_update_strategies_operations#FleetUpdateStrategiesOperations.{}",

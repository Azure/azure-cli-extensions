...
@register_command(
    "resilience operation-status show",
)
class Show(AAZCommand):
    """Get the current status of an async operation.

    :example: OperationStatus_Get_MaximumSet
        az resilience operation-status show --location eastus --operation-id 12345678-1234-1234-1234-123456789012
    """

    _aaz_info = {
        "version": "2026-09-30-preview",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.azureresiliencemanagement/locations/{}/operationstatuses/{}", "2026-09-30-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.OperationStatusGet(ctx=self.ctx)()
    ...
    class OperationStatusGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_operation_status_result_read(cls._schema_on_200)

...
@register_command(
    "resilience recovery-plan validate-for-operation",
)
class ValidateForOperation(AAZCommand):
    ...
    :example: RecoveryPlanActions_ValidateForOperation_MaximumSet
        az resilience recovery-plan validate-for-operation --service-group-name sampleServiceGroupName --operation-id qmn --recovery-plan-name samplePlanName --operation-name Failover
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.operation_name = AAZStrArg(
            ...
            arg_group="Body",
            help="Operation Name to validate.",
            required=True,
            enum={"Failover": "Failover", "FailoverCommit": "FailoverCommit", "Reprotect": "Reprotect", "TestFailover": "TestFailover", "TestFailoverCleanup": "TestFailoverCleanup"},
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.RecoveryPlanActionsValidateForOperation(ctx=self.ctx)()
    ...
    class RecoveryPlanActionsValidateForOperation(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/providers/Microsoft.AzureResilienceManagement/recoveryPlans/{recoveryPlanName}/validateForOperation",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("operationName", AAZStrType, ".operation_name", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200(cls):
            ...
            _ValidateForOperationHelper._build_schema_error_response_read(cls._schema_on_200)

            return cls._schema_on_200


class _ValidateForOperationHelper:
    """Helper class for ValidateForOperation"""

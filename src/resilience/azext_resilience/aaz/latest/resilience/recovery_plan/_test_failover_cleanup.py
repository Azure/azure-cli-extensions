...
@register_command(
    "resilience recovery-plan test-failover-cleanup",
)
class TestFailoverCleanup(AAZCommand):
    ...
    :example: RecoveryPlanActions_TestFailoverCleanup_MaximumSet
        az resilience recovery-plan test-failover-cleanup --service-group-name sampleServiceGroupName --operation-id qmn --recovery-plan-name samplePlanName --comments Test failover clean-up comments
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.comments = AAZStrArg(
            options=["--comments"],
            arg_group="Body",
            help="Comments for test failover cleanup.",
            fmt=AAZStrArgFormat(
                max_length=1024,
            ),
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RecoveryPlanActionsTestFailoverCleanup(ctx=self.ctx)()
    ...
    class RecoveryPlanActionsTestFailoverCleanup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/providers/Microsoft.AzureResilienceManagement/recoveryPlans/{recoveryPlanName}/testFailoverCleanup",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("comments", AAZStrType, ".comments")

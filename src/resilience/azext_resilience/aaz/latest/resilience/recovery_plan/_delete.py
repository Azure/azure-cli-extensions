...
@register_command(
    "resilience recovery-plan delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a RecoveryPlan

    :example: RecoveryPlans_Delete_MaximumSet
        az resilience recovery-plan delete --service-group-name sampleServiceGroupName --recovery-plan-name samplePlanName
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RecoveryPlansDelete(ctx=self.ctx)()
    ...
    class RecoveryPlansDelete(AAZHttpOperation):

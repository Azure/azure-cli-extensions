...
def frontend_collaboration_analytics_deploymentinfo(cmd, collaboration_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.workloads_analytics_deployment_info_get(collaboration_id)
...
def frontend_collaboration_analytics_cleanroompolicy(cmd, collaboration_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.workloads_analytics_cleanroompolicy_get(collaboration_id)
...
def frontend_collaboration_invitation_show(cmd, collaboration_id, invitation_id):
...
def frontend_collaboration_invitation_accept(cmd, collaboration_id, invitation_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.invitation_id_accept_post(collaboration_id, invitation_id)
...
def frontend_collaboration_dataset_publish(cmd, collaboration_id, dataset_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.analytics_dataset_id_publish_post(collaboration_id, dataset_id)
...
def frontend_collaboration_consent_check(cmd, collaboration_id, document_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.check_consent_document_id_get(collaboration_id, document_id)


def frontend_collaboration_consent_set(cmd, collaboration_id, document_id, action):
...
def frontend_collaboration_query_publish(cmd, collaboration_id, query_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.analytics_queries_query_id_publish_post(collaboration_id, query_id)
...
def frontend_collaboration_query_run(cmd, collaboration_id, query_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.analytics_queries_query_id_run_post(collaboration_id, query_id)
...
def frontend_collaboration_query_runhistory_list(cmd, collaboration_id, query_id):
...
def frontend_collaboration_query_runhistory_show(cmd, collaboration_id, run_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.analytics_queries_runid_get(collaboration_id, run_id)
...
def frontend_collaboration_attestation_cleanroom(cmd, collaboration_id):
    ...
    """
    client = get_frontend_client(cmd)
    return client.collaboration.attestationreport_cleanroom_get(collaboration_id)
...
def frontend_login(cmd, use_microsoft_identity=False):
        ...
        if msal_token:
            ...
            try:
                ...
                if len(token_parts) >= 2:
                    ...
                    user_info = claims.get('preferred_username') or claims.get('upn') or claims.get('email') or 'MSAL User'
                else:
                    user_info = 'MSAL User'
            except Exception:
                user_info = 'MSAL User'

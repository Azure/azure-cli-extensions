...
class TestFrontendCollaboration(unittest.TestCase):
    ...
    def test_show_collaboration_success(self, mock_get_client):
        ...
        mock_client.collaboration.id_get.assert_called_once_with("test-collab-123")
    ...
    def test_show_collaboration_not_found(self, mock_get_client):
        ...
        mock_client = Mock()
        mock_client.collaboration.id_get.side_effect = Exception("Collaboration not found")
        mock_get_client.return_value = mock_client
    ...
    def test_list_workloads_success(self, mock_get_client):
        ...
        mock_client.collaboration.workloads_get.assert_called_once_with("test-collab-123")
    ...
    def test_show_analytics(self, mock_get_client):
        ...
        mock_client.collaboration.workloads_analytics_get.assert_called_once_with("test-collab-123")
    ...
    def test_show_analytics_deployment_info(self, mock_get_client):
        ...
        mock_client.collaboration.workloads_analytics_deployment_info_get.assert_called_once_with("test-collab-123")
    ...
    def test_show_analytics_cleanroom_policy(self, mock_get_client):
        ...
        mock_client.collaboration.workloads_analytics_cleanroompolicy_get.assert_called_once_with("test-collab-123")
    ...
    def test_show_oidc_issuer_info(self, mock_get_client):
        ...
        mock_client.collaboration.oidc_issuer_info_get.assert_called_once_with("test-collab-123")

...
@register_command(
    "managedcleanroom collaboration enable-workload",
)
class EnableWorkload(AAZCommand):
    """Enables a workload on a collaboration.

    :example: Enable Workload
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CollaborationsEnableWorkload(ctx=self.ctx)()
    ...
    class CollaborationsEnableWorkload(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                f"/subscriptions/{{subscriptionId}}/resourceGroups/{{resourceGroupName}}/providers/{PrivateEndpointUtil.get_configured_namespace()}/collaborations/{{collaborationName}}/enableWorkload",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("workloadType", AAZStrType, ".workload_type", typ_kwargs={"flags": {"required": True}})
...
class _EnableWorkloadHelper:
    """Helper class for EnableWorkload"""


__all__ = ["EnableWorkload"]

...
@register_command(
    "managedcleanroom collaboration delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a collaboration.

    :example: Delete a collaboration
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CollaborationsDelete(ctx=self.ctx)()
    ...
    class CollaborationsDelete(AAZHttpOperation):

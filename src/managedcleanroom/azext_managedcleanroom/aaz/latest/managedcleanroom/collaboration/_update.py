...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CollaborationsUpdate(ctx=self.ctx)()
    ...
    class CollaborationsUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            target_resource_configuration = cls._schema_on_200.properties.target_resource_configuration
            ...
            i_p_tag_configuration = cls._schema_on_200.properties.target_resource_configuration.i_p_tag_configuration

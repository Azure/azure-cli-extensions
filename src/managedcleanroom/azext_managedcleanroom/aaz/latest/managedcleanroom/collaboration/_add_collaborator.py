...
@register_command(
    "managedcleanroom collaboration add-collaborator",
)
class AddCollaborator(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CollaborationsAddCollaborator(ctx=self.ctx)()
    ...
    class CollaborationsAddCollaborator(AAZHttpOperation):
...
class _AddCollaboratorHelper:
    """Helper class for AddCollaborator"""


__all__ = ["AddCollaborator"]

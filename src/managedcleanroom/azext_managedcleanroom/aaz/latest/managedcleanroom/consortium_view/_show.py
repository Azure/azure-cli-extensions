...
@register_command(
    "managedcleanroom consortium-view show",
)
class Show(AAZCommand):
    """Get a consortium view.

    :example: Get a consortium view
        az managedcleanroom consortium-view show --resource-group testrg --consortium-view-name ContosoConsortiumView
    """

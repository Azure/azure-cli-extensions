...
def load_frontend_command_table(loader, _):
    ...
    frontend_custom = CliCommandType(operations_tmpl='azext_managedcleanroom._frontend_custom#{}')
    ...
    # Workloads commands
    with loader.command_group('managedcleanroom frontend collaboration workloads', custom_command_type=frontend_custom) as g:
        g.custom_command('list', 'frontend_collaboration_workloads_list')
    
    # Analytics commands
    with loader.command_group('managedcleanroom frontend collaboration analytics', custom_command_type=frontend_custom) as g:
        g.custom_show_command('show', 'frontend_collaboration_analytics_show')
        g.custom_command('deploymentinfo', 'frontend_collaboration_analytics_deploymentinfo')
        g.custom_command('cleanroompolicy', 'frontend_collaboration_analytics_cleanroompolicy')
    
    # OIDC commands
    with loader.command_group('managedcleanroom frontend collaboration oidc issuerinfo', custom_command_type=frontend_custom) as g:
        g.custom_show_command('show', 'frontend_collaboration_oidc_issuerinfo_show')
    
    # Invitation commands
    with loader.command_group('managedcleanroom frontend collaboration invitation', custom_command_type=frontend_custom) as g:
    ...
    # Dataset commands
    with loader.command_group('managedcleanroom frontend collaboration dataset', custom_command_type=frontend_custom) as g:
    ...
    # Consent commands
    with loader.command_group('managedcleanroom frontend collaboration consent', custom_command_type=frontend_custom) as g:
        g.custom_command('check', 'frontend_collaboration_consent_check')
        g.custom_command('set', 'frontend_collaboration_consent_set')
    
    # Query commands
    with loader.command_group('managedcleanroom frontend collaboration query', custom_command_type=frontend_custom) as g:
    ...
    # Query vote commands
    with loader.command_group('managedcleanroom frontend collaboration query vote', custom_command_type=frontend_custom) as g:
    ...
    with loader.command_group('managedcleanroom frontend collaboration query runhistory', custom_command_type=frontend_custom) as g:
        g.custom_command('list', 'frontend_collaboration_query_runhistory_list')
        g.custom_show_command('show', 'frontend_collaboration_query_runhistory_show')
    
    # Audit commands
    with loader.command_group('managedcleanroom frontend collaboration audit', custom_command_type=frontend_custom) as g:
        g.custom_command('list', 'frontend_collaboration_audit_list')
    
    # Attestation commands
    with loader.command_group('managedcleanroom frontend collaboration attestation', custom_command_type=frontend_custom) as g:
        g.custom_command('cgs', 'frontend_collaboration_attestation_cgs')
        g.custom_command('cleanroom', 'frontend_collaboration_attestation_cleanroom')

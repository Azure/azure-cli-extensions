...
class TransactionNodeOperations:
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}'}  # type: ignore
    ...
    async def delete(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}'}  # type: ignore
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs
    ) -> AsyncIterable["models.TransactionNodeCollection"]:
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~blockchain_management_client.models.TransactionNodeCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

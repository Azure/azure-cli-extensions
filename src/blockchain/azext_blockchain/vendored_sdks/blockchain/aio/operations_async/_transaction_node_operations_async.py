...
class TransactionNodeOperations:
    ...
    async def begin_create(
        ...
        firewall_rules: Optional[List["models.FirewallRule"]] = None,
        **kwargs
    ) -> AsyncLROPoller["models.TransactionNode"]:
        ...
        :return: An instance of AsyncLROPoller that returns either TransactionNode or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~blockchain_management_client.models.TransactionNode]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

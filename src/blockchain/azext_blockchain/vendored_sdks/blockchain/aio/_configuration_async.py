...
class BlockchainManagementClientConfiguration(Configuration):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(BlockchainManagementClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'blockchainmanagementclient/{}'.format(VERSION))

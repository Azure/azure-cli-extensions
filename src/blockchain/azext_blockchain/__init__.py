...
class BlockchainManagementClientCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        try:
            from azext_blockchain.manual.commands import load_command_table as load_command_table_manual
    ...
    def load_arguments(self, command):
        from azext_blockchain.generated._params import load_arguments
        load_arguments(self, command)
        try:
            from azext_blockchain.manual._params import load_arguments as load_arguments_manual
            load_arguments_manual(self, command)
        except ImportError:
            pass


COMMAND_LOADER_CLS = BlockchainManagementClientCommandsLoader

...
def load_arguments(self, _):
    ...
    with self.argument_context('blockchain blockchain-member show') as c:
        c.argument('blockchain_member_name', options_list=['--name', '-n'], help='Blockchain member name.', id_part='na'
                   'me')
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('blockchain blockchain-member update') as c:
        ...
        c.argument('firewall_rules', action=AddBlockchainTransactionNodeUpdateFirewallRules, nargs='+', help='Gets or s'
                   'ets the firewall rules.')
        c.argument('consortium_management_account_password', help='Sets the managed consortium management account passw'
                   'ord.')

    with self.argument_context('blockchain blockchain-member delete') as c:
        c.argument('blockchain_member_name', options_list=['--name', '-n'], help='Blockchain member name', id_part='nam'
                   'e')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('blockchain blockchain-member list-all') as c:
        pass
    ...
    with self.argument_context('blockchain blockchain-member-operation-result show') as c:
        ...
        c.argument('operation_id', help='Operation Id.', id_part='child_name_1')

    with self.argument_context('blockchain consortium list') as c:
        c.argument('location_name', options_list=['--name', '-n'], help='Location Name.')

    with self.argument_context('blockchain sku list') as c:
        pass
    ...
    with self.argument_context('blockchain transaction-node show') as c:
        c.argument('blockchain_member_name', help='Blockchain member name.', id_part='name')
        c.argument('transaction_node_name', options_list=['--name', '-n'], help='Transaction node name.', id_part='chil'
                   'd_name_1')
        c.argument('resource_group_name', resource_group_name_type)

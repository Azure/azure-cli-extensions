...
class List(AAZCommand):
    ...
    :example: Lists databricks accessConnectors within a resource group
        az databricks access-connector list  --resource-group MyResourceGroup

    :example: Lists all the databricks accessConnectors within a subscription.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.AccessConnectorsListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.AccessConnectorsListBySubscription(ctx=self.ctx)()
    ...
    class AccessConnectorsListByResourceGroup(AAZHttpOperation):
    ...
    class AccessConnectorsListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

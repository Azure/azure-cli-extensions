...
def load_arguments(self, _):
    ...
    with self.argument_context('databricks workspace create') as c:
        ...
        c.argument('prepare_encryption', arg_type=get_three_state_flag(), help='Enable the Managed Identity for managed storage account to prepare for CMK encryption.')

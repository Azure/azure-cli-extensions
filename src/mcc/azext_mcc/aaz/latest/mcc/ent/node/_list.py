...
class List(AAZCommand):
    ...
    :example: List every cache node attached to an MCC Enterprise resource
        az mcc ent node list --mcc-resource-name MyMccResource --resource-group MyResourceGroup

    :example: List cache nodes with the full set of details
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnterpriseMccCacheNodesOperationsListByEnterpriseMccCustomerResource(ctx=self.ctx)()
    ...
    class EnterpriseMccCacheNodesOperationsListByEnterpriseMccCustomerResource(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            current_tls_certificate = cls._schema_on_200.value.Element.properties.additional_cache_node_properties.current_tls_certificate
            ...
            issues_list = cls._schema_on_200.value.Element.properties.additional_cache_node_properties.issues_list
            issues_list.Element = AAZStrType()

            last_auto_update_info = cls._schema_on_200.value.Element.properties.additional_cache_node_properties.last_auto_update_info

...
class Update(AAZCommand):
    ...
    class EnterpriseMccCustomersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_enterprise_mcc_customer_resource_read(cls._schema_on_200)
    ...
    class EnterpriseMccCustomersCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_enterprise_mcc_customer_resource_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_enterprise_mcc_customer_resource_read = None

    @classmethod
    def _build_schema_enterprise_mcc_customer_resource_read(cls, _schema):
        if cls._schema_enterprise_mcc_customer_resource_read is not None:
            _schema.id = cls._schema_enterprise_mcc_customer_resource_read.id
            _schema.location = cls._schema_enterprise_mcc_customer_resource_read.location
            _schema.name = cls._schema_enterprise_mcc_customer_resource_read.name
            _schema.properties = cls._schema_enterprise_mcc_customer_resource_read.properties
            _schema.system_data = cls._schema_enterprise_mcc_customer_resource_read.system_data
            _schema.tags = cls._schema_enterprise_mcc_customer_resource_read.tags
            _schema.type = cls._schema_enterprise_mcc_customer_resource_read.type
            return

        cls._schema_enterprise_mcc_customer_resource_read = _schema_enterprise_mcc_customer_resource_read = AAZObjectType()

        enterprise_mcc_customer_resource_read = _schema_enterprise_mcc_customer_resource_read
        enterprise_mcc_customer_resource_read.id = AAZStrType(
            flags={"read_only": True},
        )
        enterprise_mcc_customer_resource_read.location = AAZStrType(
            flags={"required": True},
        )
        enterprise_mcc_customer_resource_read.name = AAZStrType(
            flags={"read_only": True},
        )
        enterprise_mcc_customer_resource_read.properties = AAZObjectType()
        enterprise_mcc_customer_resource_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        enterprise_mcc_customer_resource_read.tags = AAZDictType()
        enterprise_mcc_customer_resource_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_enterprise_mcc_customer_resource_read.properties
        ...
        additional_customer_properties = _schema_enterprise_mcc_customer_resource_read.properties.additional_customer_properties
        ...
        customer = _schema_enterprise_mcc_customer_resource_read.properties.customer
        ...
        system_data = _schema_enterprise_mcc_customer_resource_read.system_data
        ...
        tags = _schema_enterprise_mcc_customer_resource_read.tags

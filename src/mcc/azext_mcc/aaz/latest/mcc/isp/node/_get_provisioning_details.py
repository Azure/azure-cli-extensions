...
class GetProvisioningDetails(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.connectedcache/ispcustomers/{}/ispcachenodes/{}/getcachenodeinstalldetails", "2024-11-30-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.cache_node_resource_name = AAZStrArg(
            options=["--cache-node-resource-name"],
            help="Name of the ConnectedCache resource",
            required=True,
        ...
        _args_schema.customer_resource_name = AAZStrArg(
            options=["--customer-resource-name"],
            help="Name of the Customer resource",
            required=True,
            id_part="name",
            fmt=AAZStrArgFormat(
                pattern="^[a-zA-Z0-9\\_\\-]*",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IspCacheNodesOperationsGetCacheNodeInstallDetails(ctx=self.ctx)()

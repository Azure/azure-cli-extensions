...
@register_command(
    "mongo-db atlas organization project cluster create",
)
class Create(AAZCommand):
    """Create a Cluster

    :example: Clusters_CreateOrUpdate_MaximumSet
        az mongo-db atlas organization project cluster create --resource-group rgopenapi --organization-name myOrganization --project-name myProject --cluster-name myCluster --cluster-tier FREE --region-name eastus2
    """
    ...
    class ClustersCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("clusterTier", AAZStrType, ".cluster_tier", typ_kwargs={"flags": {"required": True}})
                properties.set_prop("regionName", AAZStrType, ".region_name", typ_kwargs={"flags": {"required": True}})

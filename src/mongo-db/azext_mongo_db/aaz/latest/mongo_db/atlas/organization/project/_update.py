...
@register_command(
    "mongo-db atlas organization project update",
)
class Update(AAZCommand):
    """Update a Project

    :example: Projects_CreateOrUpdate_MaximumSet
        az mongo-db atlas organization project update --resource-group rgopenapi --organization-name myOrganization --project-name myProject
    """

...
@register_command(
    "mongo-db atlas organization project cluster show",
)
class Show(AAZCommand):
    """Get a Cluster

    :example: Clusters_Get_MaximumSet
        az mongo-db atlas organization project cluster show --resource-group rgopenapi --organization-name myOrganization --project-name myProject --cluster-name myCluster
    """

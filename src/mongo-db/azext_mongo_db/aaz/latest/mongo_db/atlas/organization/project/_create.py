...
@register_command(
    "mongo-db atlas organization project create",
)
class Create(AAZCommand):
    """Create a Project

    :example: Projects_CreateOrUpdate_MaximumSet
        az mongo-db atlas organization project create --resource-group rgopenapi --organization-name myOrganization --project-name myProject
    """

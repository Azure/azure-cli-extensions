...
@register_command(
    "mongo-db atlas organization project list",
)
class List(AAZCommand):
    """List Project resources by OrganizationResource

    :example: Projects_List_MaximumSet
        az mongo-db atlas organization project list --resource-group rgopenapi --organization-name myOrganization
    """
    ...
    class ProjectsList(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects",
                **self.url_parameters
            )

...
class DashboardManagementClient:
    ...
    :vartype operations: dashboard_management_client.aio.operations.Operations
    :ivar grafana: GrafanaOperations operations
    :vartype grafana: dashboard_management_client.aio.operations.GrafanaOperations
    ...
    async def __aenter__(self) -> "DashboardManagementClient":

...
class List(AAZCommand):
    ...
    :example: List Neon Roles under a Branch
        az neon neon-role list --resource-group rgneon --organization-name org-test-cli --project-id old-frost-16758796 --branch-id br-spring-field-a8vje3tr
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NeonRolesList(ctx=self.ctx)()
    ...
    class NeonRolesList(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    :example: List Neon Databases
        az neon postgres neon-database list --subscription 38a546de-5736-48e8-a69a-5cc636794112 --resource-group rgneon --organization-name org-test-cli --project-id old-frost-16758796 --branch-id br-spring-field-a8vje3tr
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NeonDatabasesList(ctx=self.ctx)()
    ...
    class NeonDatabasesList(AAZHttpOperation):

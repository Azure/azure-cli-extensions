...
@register_command(
    "fabric capacity check-name-availability",
)
class CheckNameAvailability(AAZCommand):
    ...
    _aaz_info = {
        "version": "2023-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.fabric/locations/{}/checknameavailability", "2023-11-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FabricCapacitiesCheckNameAvailability(ctx=self.ctx)()

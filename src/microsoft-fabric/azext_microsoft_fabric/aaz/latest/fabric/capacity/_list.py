...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2023-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.fabric/capacities", "2023-11-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.FabricCapacitiesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.FabricCapacitiesListBySubscription(ctx=self.ctx)()

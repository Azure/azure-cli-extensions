...
class DataFactoryCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        super(DataFactoryCommandsLoader, self).__init__(cli_ctx=cli_ctx,
...
COMMAND_LOADER_CLS = DataFactoryCommandsLoader

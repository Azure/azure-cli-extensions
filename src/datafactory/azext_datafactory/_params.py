...
def load_arguments(self, _):
    ...
    with self.argument_context('datafactory create') as c:
        ...
        c.argument('repo_configuration', id_part=None, help='Git repo information of the factory.')
        ...
        c.argument('identity', id_part=None, help='Managed service identity of the factory.')
    ...
    with self.argument_context('datafactory linkedservice create') as c:
        ...
        c.argument('additional_properties', id_part=None, help='Unmatched properties from the message are deserialized this collection')
        c.argument('connect_via', id_part=None, help='The integration runtime reference.')
    ...
    with self.argument_context('datafactory dataset create') as c:
        ...
        c.argument('linked_service_name', id_part=None, help='Linked service reference.')
        ...
        c.argument('folder', id_part=None, help='The folder that this Dataset is in. If not specified, Dataset will appear at the root level.')
    ...
    with self.argument_context('datafactory pipeline create') as c:
        ...
        c.argument('folder', id_part=None, help='The folder that this Pipeline is in. If not specified, Pipeline will appear at the root level.')
    ...
    with self.argument_context('datafactory dataflow create') as c:
        ...
        c.argument('folder', id_part=None, help='The folder that this data flow is in. If not specified, Data flow will appear at the root level.')
    ...
    with self.argument_context('datafactory create-data-flow-debug-session create') as c:
        ...
        c.argument('integration_runtime', id_part=None, help='Set to use integration runtime setting for data flow debug session.')
        c.argument('additional_properties', id_part=None, help='Unmatched properties from the message are deserialized this collection')
        c.argument('session_id', id_part=None, help='The ID of data flow debug session.')
        c.argument('data_flow', id_part=None, help='Data flow instance.')
        ...
        c.argument('staging', id_part=None, help='Staging info for debug session.')
        c.argument('debug_settings', id_part=None, help='Data flow debug settings.')
        ...
        c.argument('command_payload', id_part=None, help='The command payload object.')

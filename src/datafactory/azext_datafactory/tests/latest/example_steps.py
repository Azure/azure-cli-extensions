...
def step_configure_factory_repo(test, rg, checks=None):
    ...
    test.cmd('az datafactory configure-factory-repo '
             ...
             '--fvc account-name="ADF" collaboration-branch="master" last-commit-id="" project-name="project" '
             'repository-name="repo" root-folder="/" tenant-id="" '
             '--location "East US"',
             checks=checks)
...
@try_manual
def step_managed_virtual_network_create(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_managed_virtual_network_show(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_managed_virtual_network_list(test, rg, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /ManagedPrivateEndpoints/put/ManagedVirtualNetworks_Create
@try_manual
def step_managed_private_endpoint_create(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az datafactory managed-private-endpoint create '
             '--factory-name "{myFactory}" '
             '--group-id "blob" '
             '--plr-id "/subscriptions/{subscription_id}/resourceGroups/{rg}/providers/Microsoft.Storage/storageAccount'
             's/{sa}" '
             '--name "{myManagedPrivateEndpoint}" '
             '--managed-vnet-name "{myManagedVirtualNetwork}" '
             '--resource-group "{rg}"',
             checks=checks)
...
@try_manual
def step_managed_private_endpoint_show(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_managed_private_endpoint_list(test, rg, checks=None):
    if checks is None:
        checks = []
...
# EXAMPLE: /ManagedPrivateEndpoints/delete/ManagedVirtualNetworks_Delete
@try_manual
def step_managed_private_endpoint_delete(test, rg, checks=None):
    if checks is None:
        checks = []

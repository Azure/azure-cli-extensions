...
class DataFlowDebugSessionOperations(object):
    ...
    def _create_initial(
        ...
        integration_runtime=None,  # type: Optional["models.IntegrationRuntimeDebugResource"]
        **kwargs  # type: Any
    ):
        ...
        request = models.CreateDataFlowDebugSessionRequest(compute_type=compute_type, core_count=core_count, time_to_live=time_to_live, integration_runtime=integration_runtime)
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :type integration_runtime: ~data_factory_management_client.models.IntegrationRuntimeDebugResource
    ...
    def add_data_flow(
        ...
        data_flow=None,  # type: Optional["models.DataFlowDebugResource"]
        datasets=None,  # type: Optional[List["DatasetDebugResource"]]
        linked_services=None,  # type: Optional[List["LinkedServiceDebugResource"]]
        staging=None,  # type: Optional["models.DataFlowStagingInfo"]
        debug_settings=None,  # type: Optional["models.DataFlowDebugPackageDebugSettings"]
        **kwargs  # type: Any
    ):
        ...
        request = models.DataFlowDebugPackage(session_id=session_id, data_flow=data_flow, datasets=datasets, linked_services=linked_services, staging=staging, debug_settings=debug_settings)
        api_version = "2018-06-01"

...
class PipelinesOperations(object):
    ...
    def create_or_update(
        ...
        annotations=None,  # type: Optional[List["PipelineAnnotationsItem"]]
        ...
        **kwargs  # type: Any
        ...
        pipeline = models.PipelineResource(description=description, activities=activities, parameters=parameters, variables=variables, concurrency=concurrency, annotations=annotations, run_dimensions=run_dimensions, name=name)
        api_version = "2018-06-01"

...
class LinkedServiceOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        _linked_service.properties = _linked_service.properties.properties
        print(_linked_service.properties)
        api_version = "2018-06-01"
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/linkedservices/{linkedServiceName}'}  # type: ignore
    ...
    def update(
        ...
        if_match=None,  # type: Optional[str]
        properties_connect_via=None,  # type: Optional["models.IntegrationRuntimeReference"]
        ...
        **kwargs  # type: Any
        ...
        :param linked_service_name: The linked service name.
        :type linked_service_name: str
        :param properties_type: Type of linked service.
        :type properties_type: str
        :param if_match: ETag of the linkedService entity.  Should only be specified for update, for
         which it should match existing entity or can be * for unconditional update.
        :type if_match: str
        :param properties_connect_via: The integration runtime reference.
        :type properties_connect_via: ~data_factory_management_client.models.IntegrationRuntimeReference
        :param properties_description: Linked service description.
        :type properties_description: str
        :param properties_parameters: Parameters for linked service.
        :type properties_parameters: dict[str, ~data_factory_management_client.models.ParameterSpecification]
        :param properties_annotations: List of tags that can be used for describing the linked service.
        ...
        _linked_service = models.LinkedServiceResource(properties=properties, type=properties_type, connect_via=properties_connect_via, description=properties_description, parameters=properties_parameters, annotations=properties_annotations)
        api_version = "2018-06-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/linkedservices/{linkedServiceName}'}  # type: ignore

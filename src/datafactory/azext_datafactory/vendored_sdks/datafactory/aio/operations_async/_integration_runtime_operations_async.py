...
class IntegrationRuntimeOperations:
    ...
    async def list_auth_key(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.list_auth_key.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'factoryName': self._serialize.url("factory_name", factory_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'),
        ...
        return deserialized
    list_auth_key.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/listAuthKeys'}
    ...
    remove_link.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/removeLinks'}
    ...
    async def create_or_update_managed(
        self,
        resource_group_name: str,
        factory_name: str,
        integration_runtime_name: str,
        managed_type: Union[str, "models.IntegrationRuntimeType"],
        if_match: Optional[str] = None,
        managed_description: Optional[str] = None,
        managed_compute_properties: Optional["models.IntegrationRuntimeComputeProperties"] = None,
        managed_ssis_properties: Optional["models.IntegrationRuntimeSsisProperties"] = None,
        **kwargs
    ) -> "models.IntegrationRuntimeResource":
        """Creates or updates an integration runtime.
    ...
    async def create_or_update_selfhosted(
        self,
        resource_group_name: str,
        factory_name: str,
        integration_runtime_name: str,
        selfhosted_type: Union[str, "models.IntegrationRuntimeType"],
        if_match: Optional[str] = None,
        selfhosted_description: Optional[str] = None,
        selfhosted_linked_info: Optional["models.LinkedIntegrationRuntimeType"] = None,
        **kwargs
    ) -> "models.IntegrationRuntimeResource":
        """Creates or updates an integration runtime.

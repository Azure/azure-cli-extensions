...
class DataFlowOperations:
    ...
    async def create(
        ...
        **kwargs
        ...
        return deserialized
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/dataflows/{dataFlowName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs
        ...
        :param if_match: ETag of the data flow entity. Should only be specified for update, for which
         it should match existing entity or can be * for unconditional update.
        :type if_match: str
        :param properties_type: Type of data flow.
        :type properties_type: str
        :param properties_description: The description of the data flow.
        :type properties_description: str
        :param properties_annotations: List of tags that can be used for describing the data flow.
        :type properties_annotations: list[object]
        :param properties_folder: The folder that this data flow is in. If not specified, Data flow
         will appear at the root level.
        :type properties_folder: ~data_factory_management_client.models.DataFlowFolder
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataFlowResource, or the result of cls(response)
        :rtype: ~data_factory_management_client.models.DataFlowResource
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _data_flow = models.DataFlowResource(properties=properties, type=properties_type, description=properties_description, annotations=properties_annotations, folder=properties_folder)
        api_version = "2018-06-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/dataflows/{dataFlowName}'}  # type: ignore

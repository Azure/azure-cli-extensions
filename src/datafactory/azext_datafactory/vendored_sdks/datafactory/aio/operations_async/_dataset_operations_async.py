...
class DatasetOperations:
    ...
    async def update(
        ...
        dataset_name: str,
        properties_type: str,
        properties_linked_service_name: "models.LinkedServiceReference",
        if_match: Optional[str] = None,
        properties_description: Optional[str] = None,
        properties_structure: Optional[object] = None,
        properties_schema: Optional[object] = None,
        properties_parameters: Optional[Dict[str, "models.ParameterSpecification"]] = None,
        properties_annotations: Optional[List[object]] = None,
        properties_folder: Optional["models.DatasetFolder"] = None,
        **kwargs
    ) -> "models.DatasetResource":
        """Creates or updates a dataset.

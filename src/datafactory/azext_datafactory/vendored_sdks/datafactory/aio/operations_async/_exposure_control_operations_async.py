...
class ExposureControlOperations:
    ...
    async def query_feature_value_by_factory(
        ...
        **kwargs
        ...
        _exposure_control_batch_request = models.ExposureControlBatchRequest(exposure_control_requests=exposure_control_requests)
        api_version = "2018-06-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_exposure_control_batch_request, 'ExposureControlBatchRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)

...
class ManagedPrivateEndpointOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        _managed_private_endpoint = models.ManagedPrivateEndpointResource(connection_state=connection_state, fqdns=fqdns, group_id=group_id, private_link_resource_id=private_link_resource_id)
        api_version = "2018-06-01"
        ...
        body_content = self._serialize.body(_managed_private_endpoint, 'ManagedPrivateEndpointResource')

...
def load_command_table(self, _):
    ...
    from ._client_factory import cf_factory
    ...
    from ._client_factory import cf_integration_runtime
    ...
    from ._client_factory import cf_linked_service
    ...
    from ._client_factory import cf_pipeline_run
    ...
    from ._client_factory import cf_activity_run
    ...
    from ._client_factory import cf_trigger
    ...
    from ._client_factory import cf_data_flow

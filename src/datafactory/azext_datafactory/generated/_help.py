...
helps['datafactory create'] = """
    ...
    parameters:
      - name: --fvc
        ...
        long-summary: |
            Usage: --fvc project-name=XX tenant-id=XX type=XX account-name=XX repository-name=XX \
collaboration-branch=XX root-folder=XX last-commit-id=XX
      ...
      - name: --fghc
        ...
        long-summary: |
            Usage: --fghc host-name=XX type=XX account-name=XX repository-name=XX collaboration-branch=XX \
root-folder=XX last-commit-id=XX
...
5678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName" --fvc \
account-name="ADF" collaboration-branch="master" last-commit-id="" project-name="project" repository-name="repo" \
root-folder="/" tenant-id="" --location "East US"
"""
...
--ghatbu "some" --git-hub-client-id "some" --resource-group "exampleResourceGroup"
"""
...
).parameters.OutputBlobNameList\\"}}}]" --parameters "{\\"OutputBlobNameList\\":{\\"type\\":\\"Array\\"}}" \
...
--plr-id "/subscriptions/12345678-1234-1234-1234-12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.St\
orage/storageAccounts/exampleBlobStorage" --name "exampleManagedPrivateEndpointName" --managed-vnet-name \
"exampleManagedVirtualNetworkName" --resource-group "exampleResourceGroup"
"""
...
helps['datafactory managed-private-endpoint delete'] = """
    ...
    examples:
      - name: ManagedVirtualNetworks_Delete
        text: |-

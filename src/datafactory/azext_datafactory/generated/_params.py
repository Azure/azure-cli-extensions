...
def load_arguments(self, _):
    ...
    with self.argument_context('datafactory create') as c:
        ...
        c.argument('factory_vsts_configuration', options_list=['--fvc'], action=AddFactoryVstsConfiguration, nargs='+',
                   help='Factory\'s VSTS repo information.', arg_group='RepoConfiguration')
        c.argument('factory_git_hub_configuration', options_list=['--fghc'], action=AddFactoryGitHubConfiguration,
                   nargs='+', help='Factory\'s GitHub repo information.', arg_group='RepoConfiguration')
    ...
    with self.argument_context('datafactory get-git-hub-access-token') as c:
        ...
        c.argument('git_hub_access_token_base_url', options_list=['--ghatbu'], type=str, help='GitHub access token '
                   'base URL.')
    ...
    with self.argument_context('datafactory managed-private-endpoint list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('factory_name', type=str, help='The factory name.')
        c.argument('managed_virtual_network_name', options_list=['--managed-vnet-name'], type=str, help='Managed '
    ...
    with self.argument_context('datafactory managed-private-endpoint show') as c:
        ...
        c.argument('factory_name', type=str, help='The factory name.', id_part='name')
        c.argument('managed_virtual_network_name', options_list=['--managed-vnet-name'], type=str, help='Managed '
                   'virtual network name', id_part='child_name_1')

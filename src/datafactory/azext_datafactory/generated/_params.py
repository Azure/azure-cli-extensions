...
def load_arguments(self, _):
    ...
    with self.argument_context("datafactory show") as c:
        ...
        c.argument(
            "factory_name",
            options_list=["--name", "-n", "--factory-name"],
            type=str,
        ...
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the factory entity. Should only be specified for get. If "
    ...
    with self.argument_context("datafactory create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the factory entity. Should only be specified for update, for "
        ...
        c.argument(
            ...
            help="List of parameters for factory. Expected "
    ...
    with self.argument_context("datafactory get-data-plane-access") as c:
        ...
        c.argument(
            "permissions",
            type=str,
            help="The string with permissions for Data Plane access. Currently only "
            "'r' is supported which grants read only access.",
        )
        c.argument(
            "access_resource_path",
            type=str,
            help="The resource path to get access relative to factory. "
            "Currently only empty string is supported which corresponds to the factory resource.",
        )
        c.argument(
            "profile_name",
            type=str,
            help="The name of the profile. Currently only the default is supported. "
            "The default value is DefaultProfile.",
        )
        c.argument(
            "start_time",
            type=str,
            help="Start time for the token. If not specified the current time will be "
            "used.",
        )
        c.argument(
            "expire_time",
            type=str,
            help="Expiration time for the token. Maximum duration for the token is "
    ...
    with self.argument_context("datafactory integration-runtime show") as c:
        ...
        c.argument(
            ...
            options_list=["--name", "-n", "--integration-runtime-name"],
            type=str,
        ...
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the integration runtime entity. Should only be specified "
    ...
    with self.argument_context(
        ...
        c.argument("factory_name", type=str, help="The factory name.")
        c.argument(
            "integration_runtime_name", type=str, help="The integration runtime name."
        )
        c.argument("name", type=str, help="The name of the linked integration runtime.")
        c.argument(
            "subscription_id",
            type=str,
            help="The ID of the subscription that the linked integration runtime "
            "belongs to.",
        )
        c.argument(
            "data_factory_name",
            type=str,
            help="The name of the data factory that the linked integration "
            "runtime belongs to.",
        )
        c.argument(
            "location",
    ...
    with self.argument_context("datafactory integration-runtime managed create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the integration runtime entity. Should only be specified for "
        ...
        c.argument(
            "compute_properties",
            type=validate_file_or_dict,
            help="The compute resource for managed "
            "integration runtime. Expected value: json-string/json-file/@json-file.",
            arg_group="Type " "Properties",
        )
        c.argument(
            "ssis_properties",
            type=validate_file_or_dict,
            help="SSIS properties for managed integration "
    ...
    with self.argument_context(
        ...
        c.argument(
            ...
            options_list=['--self-contained-interactive-authoring-enabled', '--selfcontainediaenabled'],
            type=str,
    ...
    with self.argument_context("datafactory integration-runtime update") as c:
        ...
        c.argument(
            "auto_update",
            arg_type=get_enum_type(["On", "Off"]),
            help="Enables or disables the auto-update "
        ...
        c.argument(
            "update_delay_offset",
            type=str,
            help="The time offset (in hours) in the day, e.g., PT03H is 3 "
    ...
    with self.argument_context(
        ...
        c.argument(
            "key_name",
            arg_type=get_enum_type(["authKey1", "authKey2"]),
            help="The name of the authentication " "key to regenerate.",
        )
    ...
    with self.argument_context("datafactory integration-runtime-node show") as c:
        ...
        c.argument(
            "node_name",
            type=str,
            help="The integration runtime node name.",
    ...
    with self.argument_context("datafactory integration-runtime-node update") as c:
        ...
        c.argument(
            ...
            type=int,
            help="The number of concurrent jobs permitted to run on the "
    ...
    with self.argument_context("datafactory linked-service show") as c:
        ...
        c.argument(
            "linked_service_name",
            options_list=["--name", "-n", "--linked-service-name"],
            type=str,
        ...
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the linked service entity. Should only be specified for "
    ...
    with self.argument_context("datafactory linked-service create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the linkedService entity.  Should only be specified for update, "
            "for which it should match existing entity or can be * for unconditional update.",
        )
        c.argument(
            "properties",
            type=validate_file_or_dict,
            help="Properties of linked service. Expected value: "
    ...
    with self.argument_context("datafactory linked-service update") as c:
        ...
        c.argument(
            "connect_via",
            type=validate_file_or_dict,
            help="The integration runtime reference. Expected value: "
            "json-string/json-file/@json-file.",
        )
        ...
        c.argument(
            "parameters",
            type=validate_file_or_dict,
            help="Parameters for linked service. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "annotations",
            type=validate_file_or_dict,
            help="List of tags that can be used for describing the "
    ...
    with self.argument_context("datafactory dataset show") as c:
        ...
        c.argument(
            "dataset_name",
            options_list=["--name", "-n", "--dataset-name"],
            type=str,
        ...
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the dataset entity. Should only be specified for get. If "
            "the ETag matches the existing entity tag, or if * was provided, then no content will be returned.",
        )
    ...
    with self.argument_context("datafactory dataset create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the dataset entity.  Should only be specified for update, for "
            "which it should match existing entity or can be * for unconditional update.",
        )
        c.argument(
            "properties",
            type=validate_file_or_dict,
            help="Dataset properties. Expected value: "
            "json-string/json-file/@json-file.",
        )
    ...
    with self.argument_context("datafactory dataset update") as c:
        ...
        c.argument(
            "structure",
            type=validate_file_or_dict,
            help="Columns that define the structure of the dataset. "
        ...
        c.argument(
            "schema",
            type=validate_file_or_dict,
            help="Columns that define the physical type schema of the "
        ...
        c.argument(
            "linked_service_name",
            type=validate_file_or_dict,
            help="Linked service reference. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "parameters",
            type=validate_file_or_dict,
            help="Parameters for dataset. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "annotations",
        ...
        c.argument(
            ...
            action=AddFolder,
            nargs="+",
            help="The folder that this Dataset is in. If not specified, "
    ...
    with self.argument_context("datafactory pipeline create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the pipeline entity.  Should only be specified for update, for "
            "which it should match existing entity or can be * for unconditional update.",
        )
        c.argument(
            "pipeline",
            type=validate_file_or_dict,
            help="Pipeline resource definition. Expected value: "
            "json-string/json-file/@json-file.",
        )
    ...
    with self.argument_context("datafactory pipeline update") as c:
        ...
        c.argument(
            "activities",
            type=validate_file_or_dict,
            help="List of activities in pipeline. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "parameters",
            type=validate_file_or_dict,
            help="List of parameters for pipeline. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "variables",
            type=validate_file_or_dict,
            help="List of variables for pipeline. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "concurrency",
            type=int,
            help="The max number of concurrent runs for the pipeline.",
        )
        c.argument(
            "annotations",
            type=validate_file_or_dict,
        ...
        c.argument(
            "run_dimensions",
            type=validate_file_or_dict,
            help="Dimensions emitted by Pipeline. Expected value: "
            "json-string/json-file/@json-file.",
        )
        c.argument(
            "duration",
            type=validate_file_or_dict,
            help="TimeSpan value, after which an Azure Monitoring "
            "Metric is fired. Expected value: json-string/json-file/@json-file.",
            arg_group="Policy Elapsed " "Time Metric",
        )
        c.argument(
            "folder_name",
            type=str,
            help="The name of the folder that this Pipeline is in.",
            arg_group="Folder",
        )
        c.ignore("pipeline")
    ...
    with self.argument_context("datafactory pipeline create-run") as c:
        ...
        c.argument(
            ...
            type=str,
            help="The pipeline run identifier. If run ID is specified "
            "the parameters of the specified run will be used to create a new run.",
        )
        c.argument(
            "is_recovery",
            arg_type=get_three_state_flag(),
            help="Recovery mode flag. If recovery mode is set "
        ...
        c.argument(
            "start_activity_name",
            type=str,
            help="In recovery mode, the rerun will start from this activity. "
            "If not specified, all activities will run.",
        )
        c.argument(
            "start_from_failure",
            arg_type=get_three_state_flag(),
            help="In recovery mode, if set to true, the "
        ...
        c.argument(
            "parameters",
            type=validate_file_or_dict,
            help="Parameters of the pipeline run. These parameters "
    ...
    with self.argument_context("datafactory pipeline-run show") as c:
        ...
        c.argument(
            "run_id",
            type=str,
            help="The pipeline run identifier.",
            id_part="child_name_1",
        )
    ...
    with self.argument_context("datafactory pipeline-run cancel") as c:
        ...
        c.argument(
            "is_recursive",
            arg_type=get_three_state_flag(),
            help="If true, cancel all the Child pipelines that "
    ...
    with self.argument_context("datafactory pipeline-run query-by-factory") as c:
        ...
        c.argument(
            "continuation_token",
            type=str,
            help="The continuation token for getting the next page of results. "
            "Null for first page.",
        )
        c.argument(
            "last_updated_after",
            help="The time at or after which the run event was updated in 'ISO 8601' "
            "format.",
        )
        c.argument(
            "last_updated_before",
            help="The time at or before which the run event was updated in 'ISO 8601' "
            "format.",
        )
        c.argument("filters", action=AddFilters, nargs="+", help="List of filters.")
        c.argument(
            "order_by", action=AddOrderBy, nargs="+", help="List of OrderBy option."
        )
    ...
    with self.argument_context("datafactory trigger show") as c:
        ...
        c.argument(
            "trigger_name",
            options_list=["--name", "-n", "--trigger-name"],
            type=str,
        ...
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the trigger entity. Should only be specified for get. If "
            "the ETag matches the existing entity tag, or if * was provided, then no content will be returned.",
        )
    ...
    with self.argument_context("datafactory trigger create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the trigger entity.  Should only be specified for update, for "
            "which it should match existing entity or can be * for unconditional update.",
        )
        c.argument(
            "properties",
            type=validate_file_or_dict,
            help="Properties of the trigger. Expected value: "
            "json-string/json-file/@json-file.",
        )
    ...
    with self.argument_context("datafactory trigger query-by-factory") as c:
        ...
        c.argument(
            "parent_trigger_name",
            type=str,
            help="The name of the parent TumblingWindowTrigger to get the "
    ...
    with self.argument_context("datafactory managed-virtual-network show") as c:
        ...
        c.argument(
            ...
            options_list=["--name", "-n", "--managed-virtual-network-name"],
            type=str,
            help="Managed virtual network name",
            id_part="child_name_1",
        )
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the managed Virtual Network entity. Should only be "
    ...
    with self.argument_context("datafactory managed-virtual-network create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the managed Virtual Network entity. Should only be specified "
    ...
    with self.argument_context("datafactory managed-private-endpoint list") as c:
        ...
        c.argument(
            "managed_virtual_network_name",
            options_list=["--managed-virtual-network-name", "--mvnet-name"],
            type=str,
            help="Managed virtual network name",
        )
    ...
    with self.argument_context("datafactory managed-private-endpoint show") as c:
        ...
        c.argument(
            ...
            options_list=["--name", "-n", "--managed-private-endpoint-name"],
            type=str,
            help="Managed private endpoint name",
            id_part="child_name_2",
        )
        c.argument(
            "if_none_match",
            type=str,
            help="ETag of the managed private endpoint entity. Should only be "
            "specified for get. If the ETag matches the existing entity tag, or if * was provided, then no "
            "content will be returned.",
        )
    ...
    with self.argument_context("datafactory managed-private-endpoint create") as c:
        ...
        c.argument(
            "if_match",
            type=str,
            help="ETag of the managed private endpoint entity. Should only be specified "
            "for update, for which it should match existing entity or can be * for unconditional update.",
        )
        ...
        c.argument(
            ...
            options_list=["--private-link-resource-id", "--private-link"],
            type=str,

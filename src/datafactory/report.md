...
|**--self-contained-interactive-authoring-enabled**|string|An alternative option to ensure interactive authoring function when your self-hosted integration runtime is unable to establish a connection with Azure Relay.|--selfcontainedIAenabled|selfContainedInteractiveAuthoringEnabled|

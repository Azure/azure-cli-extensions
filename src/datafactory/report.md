...
eGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName" --fvc account-name="ADF" \
collaboration-branch="master" last-commit-id="" project-name="project" repository-name="repo" root-folder="/" \
tenant-id="" --location "East US"
```
...
```
az datafactory get-git-hub-access-token --name "exampleFactoryName" --git-hub-access-code "some" --ghatbu "some" \
--git-hub-client-id "some" --resource-group "exampleResourceGroup"
```
...
```
az datafactory managed-private-endpoint list --factory-name "exampleFactoryName" --managed-vnet-name \
...
ame" --managed-vnet-name "exampleManagedVirtualNetworkName" --resource-group "exampleResourceGroup"
```
...
```
az datafactory managed-private-endpoint create --factory-name "exampleFactoryName" --group-id "blob" --plr-id \
"/subscriptions/12345678-1234-1234-1234-12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.Storage/sto\
rageAccounts/exampleBlobStorage" --name "exampleManagedPrivateEndpointName" --managed-vnet-name \
"exampleManagedVirtualNetworkName" --resource-group "exampleResourceGroup"
```
...
"exampleManagedPrivateEndpointName" --managed-vnet-name "exampleManagedVirtualNetworkName" --resource-group \
"exampleResourceGroup"
```
...
OutputBlobNameList\\"}}}]" --parameters "{\\"OutputBlobNameList\\":{\\"type\\":\\"Array\\"}}" --pipeline-name \

...
class usagesOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure_quota_extension_api.models.currentusagesbase
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.currentusagesbase"]
        error_map = {
    ...
    def list(
        ...
        scope: str,
        **kwargs
    ) -> AsyncIterable["models.usageslimits"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_quota_extension_api.models.usageslimits]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.usageslimits"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

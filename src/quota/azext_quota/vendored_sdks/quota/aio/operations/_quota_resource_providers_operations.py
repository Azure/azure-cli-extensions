...
class QuotaResourceProvidersOperations:
    """QuotaResourceProvidersOperations async operations.
    ...
    async def list(
        ...
        **kwargs
        ...
        :return: ResourceProvidersList, or the result of cls(response)
        :rtype: ~azure_quota_extension_api.models.ResourceProvidersList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ResourceProvidersList"]
        error_map = {
        ...
        deserialized = self._deserialize('ResourceProvidersList', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Quota/quotaLimitProviders'}  # type: ignore

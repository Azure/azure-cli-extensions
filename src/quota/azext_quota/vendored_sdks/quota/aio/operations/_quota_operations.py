...
class quotaOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.currentquotalimitbase"]:
    ...
    async def begin_create_or_update(
        ...
        create_quota_request: "models.currentquotalimitbase",
        **kwargs
    ) -> AsyncLROPoller["models.currentquotalimitbase"]:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_quota_extension_api.models.quotalimits]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

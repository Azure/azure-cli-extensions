...
class QuotaRequestStatusOperations:
    ...
    :type models: ~azure_quota_extension_api.models
    ...
    async def get(
        ...
        **kwargs
        ...
        :param scope: The target Azure resource URI. For example,
         ``/subscriptions/9f6cce51-6baf-4de5-a3c4-6f58b85315b9/resourceGroups/qms-
         test/providers/Microsoft.Batch/batchAccounts/testAccount/``. This is the target Azure resource
         URI for the List GET operation. If a ``{resourceName}`` is added after ``/quotaLimits``\ , then
        ...
        :rtype: ~azure_quota_extension_api.models.QuotaRequestDetails
        ...
        return deserialized
    get.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimitsRequests/{id}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs
        ...
        :param skiptoken: The **Skiptoken** parameter is used only if a previous operation returned a
         partial result. If a previous response contains a **nextLink** element, the value of the
         **nextLink** element includes a **skiptoken** parameter that specifies a starting point to use
         for subsequent calls.
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either QuotaRequestDetailsList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_quota_extension_api.models.QuotaRequestDetailsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimitsRequests'}  # type: ignore

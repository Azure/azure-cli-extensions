...
class AzureQuotaExtensionAPI(object):
    ...
    :vartype quota_request_status: azure_quota_extension_api.aio.operations.QuotaRequestStatusOperations
    :ivar quota_resource_providers: QuotaResourceProvidersOperations operations
    :vartype quota_resource_providers: azure_quota_extension_api.aio.operations.QuotaResourceProvidersOperations
    :ivar operation: OperationOperations operations
    :vartype operation: azure_quota_extension_api.aio.operations.OperationOperations

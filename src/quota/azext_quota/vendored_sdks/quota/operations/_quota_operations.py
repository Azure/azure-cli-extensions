...
class QuotaOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure_quota_extension_api.models.CurrentQuotaLimitBase
        ...
        return deserialized
    get.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}'}  # type: ignore
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}'}  # type: ignore
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        #. Use the GET operation to determine how much quota remains for the specific resource and to
        calculate the new quota limit. These steps are detailed in `this example
        <https://techcommunity.microsoft.com/t5/azure-governance-and-management/using-the-new-quota-
        rest-api/ba-p/2183670>`_.
        ...
        :type create_quota_request: ~azure_quota_extension_api.models.CurrentQuotaLimitBase
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    begin_create_or_update.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}'}  # type: ignore
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _update_initial.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}'}  # type: ignore
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_quota_extension_api.models.QuotaLimits]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': '/{scope}/providers/Microsoft.Quota/quotaLimits'}  # type: ignore

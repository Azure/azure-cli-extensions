...
class Update(AAZCommand):
    ...
    :example: Update quota for compute
        az quota update --resource-name standardFSv2Family --scope /subscriptions/00000000-0000-0000-0000-0000\00000000/providers/Microsoft.Compute/locations/eastus --limit-object value=10 --resource-type dedicated

    :example: Update quota for network
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.QuotaUpdate(ctx=self.ctx)()

...
from azext_privatedns._format import (transform_privatedns_zone_table_output, transform_privatedns_record_set_output, transform_privatedns_record_set_table_output)
...
def load_command_table(self, _):
    ...
    with self.command_group('network privatedns zone', network_privatedns_zone_sdk) as g:
        ...
        g.custom_command('create', 'create_privatedns_zone', client_factory=cf_privatedns_mgmt_zones)
        g.generic_update_command('update', setter_name='update', custom_func_name='update_privatedns_zone')

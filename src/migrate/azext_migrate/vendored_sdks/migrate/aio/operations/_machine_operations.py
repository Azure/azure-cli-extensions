...
class MachineOperations:
    ...
    def list_by_project(
        ...
        project_name: str,
        **kwargs
    ) -> AsyncIterable["models.MachineResultList"]:
        ...
        :return: An iterator like instance of either MachineResultList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_migrate_v2.models.MachineResultList]
    ...
    list_by_project.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/machines'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure_migrate_v2.models.Machine
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/machines/{machineName}'}  # type: ignore

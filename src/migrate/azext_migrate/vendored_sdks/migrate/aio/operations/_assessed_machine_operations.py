...
class AssessedMachineOperations:
    """AssessedMachineOperations async operations.
    ...
    def list_by_assessment(
        ...
        assessment_name: str,
        **kwargs
    ) -> AsyncIterable["models.AssessedMachineResultList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_migrate_v2.models.AssessedMachineResultList]

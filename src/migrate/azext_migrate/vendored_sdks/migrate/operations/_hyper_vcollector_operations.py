...
class HyperVCollectorOperations(object):
    """HyperVCollectorOperations operations.
    ...
    def list_by_project(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.HyperVCollectorList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_migrate_v2.models.HyperVCollectorList]
    ...
    def get(
        ...
        resource_group_name,  # type: str
        project_name,  # type: str
        hyper_v_collector_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.HyperVCollector"

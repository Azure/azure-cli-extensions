...
class GroupOperations(object):
    ...
    def list_by_project(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.GroupResultList"]
        """Get all groups.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_migrate_v2.models.GroupResultList]
    ...
    def create(
        ...
        properties=None,  # type: Optional["models.GroupProperties"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Group"
    ...
    def update_machine(
        ...
        group_name,  # type: str
        e_tag=None,  # type: Optional[str]
        properties=None,  # type: Optional["models.GroupBodyProperties"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Group"

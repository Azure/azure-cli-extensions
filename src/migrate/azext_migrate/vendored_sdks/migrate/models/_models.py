...
class Assessment(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.e_tag = kwargs.get('e_tag', None)
        self.type = None
        self.azure_location = kwargs['azure_location']
        self.azure_offer_code = kwargs['azure_offer_code']
        self.ea_subscription_id = None
        self.azure_pricing_tier = kwargs['azure_pricing_tier']
        self.azure_storage_redundancy = kwargs['azure_storage_redundancy']
        ...
        self.azure_hybrid_use_benefit = kwargs['azure_hybrid_use_benefit']
        self.discount_percentage = kwargs['discount_percentage']
        self.confidence_rating_in_percentage = None
        self.sizing_criterion = kwargs['sizing_criterion']
        self.reserved_instance = kwargs['reserved_instance']
        self.azure_vm_families = kwargs['azure_vm_families']
        self.azure_disk_type = kwargs['azure_disk_type']
        self.vm_uptime = kwargs['vm_uptime']
...
class HyperVCollector(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.name = None
        self.type = None
        self.discovery_site_id = kwargs.get('discovery_site_id', None)
        self.created_timestamp = None
        self.updated_timestamp = None
        self.id_properties_agent_properties_id = None
        self.version = None
        self.last_heartbeat_utc = None
        self.spn_details = kwargs.get('spn_details', None)
...
class ProjectProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.assessment_solution_id = kwargs.get('assessment_solution_id', None)
...
class VmUptime(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.days_per_month = kwargs.get('days_per_month', None)
        self.hours_per_day = kwargs.get('hours_per_day', None)

...
class AzureBlobDefinition(_serialization.Model):
    ...
    :vartype service_principal:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ServicePrincipalDefinition
    ...
    :vartype managed_identity:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ManagedIdentityDefinition
...
class AzureBlobPatchDefinition(_serialization.Model):
    ...
    :ivar service_principal: Parameters to authenticate using Service Principal.
    :vartype service_principal:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ServicePrincipalPatchDefinition
    :ivar account_key: The account key (shared key) to access the storage account.
    :vartype account_key: str
    :ivar sas_token: The Shared Access token to access the storage container.
    :vartype sas_token: str
    :ivar managed_identity: Parameters to authenticate using a Managed Identity.
    :vartype managed_identity:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ManagedIdentityPatchDefinition
    :ivar local_auth_ref: Name of a local secret on the Kubernetes cluster to use as the
     authentication secret rather than the managed or user-provided configuration secrets.
    :vartype local_auth_ref: str
    """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class FluxConfiguration(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype system_data: ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.SystemData
    :ivar scope: Scope at which the operator will be installed. Known values are: "cluster" and
     "namespace".
    :vartype scope: str or ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ScopeType
    ...
    :vartype source_kind: str or
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.SourceKindType
    ...
    :vartype git_repository:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.GitRepositoryDefinition
    :ivar bucket: Parameters to reconcile to the Bucket source kind type.
    :vartype bucket:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.BucketDefinition
    :ivar azure_blob: Parameters to reconcile to the AzureBlob source kind type.
    :vartype azure_blob:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.AzureBlobDefinition
    :ivar oci_repository: Parameters to reconcile to the OCIRepository source kind type.
    :vartype oci_repository:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.OCIRepositoryDefinition
    ...
    :vartype kustomizations: dict[str,
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.KustomizationDefinition]
    ...
    :vartype statuses:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ObjectStatusDefinition]
    ...
    :vartype compliance_state: str or
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxComplianceState
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ProvisioningState
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype scope: str or
         ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ScopeType
...
class FluxConfigurationPatch(_serialization.Model):
    ...
    :ivar git_repository: Parameters to reconcile to the GitRepository source kind type.
    :vartype git_repository:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.GitRepositoryPatchDefinition
    :ivar bucket: Parameters to reconcile to the Bucket source kind type.
    :vartype bucket:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.BucketPatchDefinition
    :ivar azure_blob: Parameters to reconcile to the AzureBlob source kind type.
    :vartype azure_blob:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.AzureBlobPatchDefinition
    :ivar oci_repository: Parameters to reconcile to the OCIRepository source kind type.
    :vartype oci_repository:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.OCIRepositoryPatchDefinition
    :ivar kustomizations: Array of kustomizations used to reconcile the artifact pulled by the
     source type on the cluster.
    :vartype kustomizations: dict[str,
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.KustomizationPatchDefinition]
    :ivar configuration_protected_settings: Key-value pairs of protected configuration settings for
     the configuration.
    :vartype configuration_protected_settings: dict[str, str]
    """
...
class FluxConfigurationsList(_serialization.Model):
    ...
    :vartype value:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration]
...
class GitRepositoryDefinition(_serialization.Model):
    ...
    :vartype repository_ref:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.RepositoryRefDefinition
...
class HelmReleasePropertiesDefinition(_serialization.Model):
    ...
    :vartype helm_chart_ref:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ObjectReferenceDefinition
...
class KustomizationDefinition(_serialization.Model):
    ...
    :vartype post_build:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.PostBuildDefinition
    """
...
class KustomizationPatchDefinition(_serialization.Model):
    ...
    :ivar post_build: Used for variable substitution for this Kustomization after kustomize build.
    :vartype post_build:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.PostBuildPatchDefinition
    """
...
class LayerSelectorDefinition(_serialization.Model):
    ...
    :vartype operation: str or
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.OperationType
    """
...
class ObjectStatusDefinition(_serialization.Model):
    ...
    :vartype status_conditions:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.ObjectStatusConditionDefinition]
    :ivar helm_release_properties: Additional properties that are provided from objects of the
     HelmRelease kind.
    :vartype helm_release_properties:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.HelmReleasePropertiesDefinition
    """
...
class OCIRepositoryDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype repository_ref:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.OCIRepositoryRefDefinition
    :ivar layer_selector: The layer to be pulled from the OCI artifact.
    :vartype layer_selector:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.LayerSelectorDefinition
    :ivar verify: Verification of the authenticity of an OCI Artifact.
    :vartype verify:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.VerifyDefinition
    ...
    :vartype tls_config:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.TlsConfigDefinition
    :ivar local_auth_ref: Name of a local secret on the Kubernetes cluster to use as the
     authentication secret rather than the managed or user-provided configuration secrets.
    :vartype local_auth_ref: str
    """
...
class OCIRepositoryPatchDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    """Parameters to reconcile to the OCIRepository source kind type.
    ...
    :ivar repository_ref: The source reference for the OCIRepository object.
    :vartype repository_ref:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.OCIRepositoryRefPatchDefinition
    :ivar layer_selector: The layer to be pulled from the OCI artifact.
    :vartype layer_selector:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.LayerSelectorPatchDefinition
    :ivar verify: Verification of the authenticity of an OCI Artifact.
    :vartype verify:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.VerifyPatchDefinition
    :ivar insecure: Specify whether to allow connecting to a non-TLS HTTP container registry.
    :vartype insecure: bool
    :ivar use_workload_identity: Specifies whether to use Workload Identity to authenticate with
     the OCI repository.
    ...
    :ivar tls_config: Parameters to authenticate using TLS config for OCI repository.
    :vartype tls_config:
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.TlsConfigPatchDefinition
    :ivar local_auth_ref: Name of a local secret on the Kubernetes cluster to use as the
     authentication secret rather than the managed or user-provided configuration secrets.
    :vartype local_auth_ref: str
    """
...
class PostBuildDefinition(_serialization.Model):
    ...
    :vartype substitute_from:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.SubstituteFromDefinition]
    """
...
class PostBuildPatchDefinition(_serialization.Model):
    ...
    :ivar substitute_from: Array of ConfigMaps/Secrets from which the variables are substituted for
     this Kustomization.
    :vartype substitute_from:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.SubstituteFromPatchDefinition]
    """
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or
     ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.CreatedByType
...
class VerifyDefinition(_serialization.Model):
    ...
    :vartype match_oidc_identity:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.MatchOidcIdentityDefinition]
    """
...
class VerifyPatchDefinition(_serialization.Model):
    ...
    :ivar match_oidc_identity: Array defining the criteria for matching the OIDC identity while
     verifying an OCI artifact.
    :vartype match_oidc_identity:
     list[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.MatchOidcIdentityPatchDefinition]
    """

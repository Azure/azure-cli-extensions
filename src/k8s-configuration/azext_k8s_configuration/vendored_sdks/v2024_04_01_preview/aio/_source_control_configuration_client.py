...
class SourceControlConfigurationClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype flux_configurations:
     azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.aio.operations.FluxConfigurationsOperations
    :ivar flux_config_operation_status: FluxConfigOperationStatusOperations operations
    :vartype flux_config_operation_status:
     azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.aio.operations.FluxConfigOperationStatusOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.flux_configurations = FluxConfigurationsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-04-01-preview"
        )

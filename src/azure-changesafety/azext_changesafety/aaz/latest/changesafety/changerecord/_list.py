...
@register_command(
    "changesafety changerecord list",
)
class List(AAZCommand):
    """List ChangeRecord resources by subscription ID
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ChangeRecordsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.ChangeRecordsListByResourceGroup(ctx=self.ctx)()
    ...
    class ChangeRecordsListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.ChangeSafety/changeRecords",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            stage_map = cls._schema_on_200.value.Element.properties.stage_map
            stage_map.parameters = AAZDictType()
            stage_map.resource_id = AAZStrType(
                serialized_name="resourceId",
            )

            parameters = cls._schema_on_200.value.Element.properties.stage_map.parameters
            parameters.Element = AAZAnyType()

            stage_map_snapshot = cls._schema_on_200.value.Element.properties.stage_map_snapshot
    ...
    class ChangeRecordsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ChangeSafety/changeRecords",
                **self.url_parameters
            )

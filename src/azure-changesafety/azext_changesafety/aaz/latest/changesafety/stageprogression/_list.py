...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ChangeRecordStageProgressionsListByParentAtSubscriptionLevel(ctx=self.ctx)()
        if condition_1:
            self.ChangeRecordStageProgressionsListByParent(ctx=self.ctx)()
    ...
    class ChangeRecordStageProgressionsListByParentAtSubscriptionLevel(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.ChangeSafety/changeRecords/{changeRecordName}/stageProgressions",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            stage_variables = cls._schema_on_200.value.Element.properties.stage_variables
    ...
    class ChangeRecordStageProgressionsListByParent(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ChangeSafety/changeRecords/{changeRecordName}/stageProgressions",
                **self.url_parameters
            )

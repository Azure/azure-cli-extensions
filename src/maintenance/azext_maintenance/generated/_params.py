...
def load_arguments(self, _):
    ...
    with self.argument_context('maintenance public-configuration show') as c:
        c.argument('resource_name', type=str, help='Maintenance Configuration Name. Swagger name=resourceName',
                   id_part='name')

    with self.argument_context('maintenance applyupdate show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('provider_name', type=str, help='Resource provider name. Swagger name=providerName')
        c.argument('resource_type', type=str, help='Resource type. Swagger name=resourceType')
        c.argument('resource_name', type=str, help='Resource identifier. Swagger name=resourceName')
        c.argument('apply_update_name', options_list=['--name', '-n', '--apply-update-name'], type=str,
                   help='applyUpdate Id. Swagger name=applyUpdateName')

    with self.argument_context('maintenance applyupdate create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('provider_name', type=str, help='Resource provider name. Swagger name=providerName')
        c.argument('resource_parent_type', type=str, help='Resource parent type. Swagger name=resourceParentType')
        c.argument('resource_parent_name', type=str,
                   help='Resource parent identifier. Swagger name=resourceParentName')
        c.argument('resource_type', type=str, help='Resource type. Swagger name=resourceType')
        c.argument('resource_name', type=str, help='Resource identifier. Swagger name=resourceName')
    ...
    with self.argument_context('maintenance assignment create') as c:
        ...
        c.argument('configuration_assignment_name', options_list=['--name', '-n', '--configuration-assignment-name'],
                   type=str, help='Configuration assignment name. Swagger name=configurationAssignmentName')
        c.argument('location', arg_type=get_location_type(self.cli_ctx), required=False,
                   validator=get_default_location_from_resource_group)
        c.argument('maintenance_configuration_id', type=str, help='The maintenance configuration Id. Swagger '
                   'name=maintenanceConfigurationId')
        c.argument('resource_id', type=str, help='The unique resourceId. Swagger name=resourceId')
    ...
    with self.argument_context('maintenance assignment delete') as c:
        ...
        c.argument('resource_name', type=str, help='Resource identifier. Swagger name=resourceName')
        c.argument('configuration_assignment_name', options_list=['--name', '-n', '--configuration-assignment-name'],
                   type=str, help='Unique configuration assignment name. Swagger name=configurationAssignmentName')
    ...
    with self.argument_context('maintenance configuration create') as c:
        ...
        c.argument('namespace', type=str, help='Gets or sets namespace of the resource. Swagger name=namespace')
        c.argument('extension_properties', action=AddExtensionProperties, nargs='+', help='Gets or sets '
                   ...
                   'Swagger name=extensionProperties')
        c.argument('maintenance_scope', arg_type=get_enum_type(['Host', 'OSImage', 'Extension', 'InGuestPatch',
                   ...
                   'maintenanceScope of the configuration. Swagger name=maintenanceScope')
        c.argument('visibility', arg_type=get_enum_type(['Custom', 'Public']), help='Gets or sets the visibility of '
                   'the configuration. The default value is \'Custom\'. Swagger name=visibility')
        c.argument('start_date_time', options_list=['--maintenance-window-start-date-time', '--start-date-time'],
                   ...
                   'time zone provided and adjusted to daylight savings according to that time zone. Swagger '
                   'name=startDateTime', arg_group='Maintenance Window')
        c.argument('expiration_date_time', options_list=['--maintenance-window-expiration-date-time',
                   ...
                   '9999-12-31 23:59:59. Swagger name=expirationDateTime', arg_group='Maintenance Window')
        c.argument('duration', options_list=['--maintenance-window-duration', '--duration'], type=str, help='Duration '
                   ...
                   'maintenance scope provided. Example: 05:00. Swagger name=duration',
        ...
        c.argument('time_zone', options_list=['--maintenance-window-time-zone', '--time-zone'], type=str, help='Name '
                   ...
                   'Standard Time, Cen. Australia Standard Time. Swagger name=timeZone',
                   arg_group='Maintenance Window')
        c.argument('recur_every', options_list=['--maintenance-window-recur-every', '--recur-every'], type=str,
                   ...
                   'Swagger name=recurEvery', arg_group='Maintenance Window')

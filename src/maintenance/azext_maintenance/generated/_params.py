...
def load_arguments(self, _):
    ...
    with self.argument_context('maintenance configuration create') as c:
        ...
        c.argument('start_date_time', type=str, help='Effective start date of the maintenance window in YYYY-MM-DD '
                   'hh:mm format. The start date can be set to either the current date or future date. The window will '
                   'be created in the time zone provided and adjusted to daylight savings according to that time zone.',
                   arg_group='Maintenance Window')
        c.argument('expiration_date_time', type=str, help='Effective expiration date of the maintenance window in '
                   'YYYY-MM-DD hh:mm format. The window will be created in the time zone provided and adjusted to '
                   'daylight savings according to that time zone. Expiration date must be set to a future date. If not '
                   'provided, it will be set to the maximum datetime 9999-12-31 23:59:59.', arg_group='Maintenance '
                   'Window')
        c.argument('duration', type=str, help='Duration of the maintenance window in HH:mm format. If not provided, '
                   'default value will be used based on maintenance scope provided. Example: 05:00.',
                   arg_group='Maintenance Window')
        c.argument('time_zone', type=str, help='Name of the timezone. List of timezones can be obtained by executing '
                   '[System.TimeZoneInfo]::GetSystemTimeZones() in PowerShell. Example: Pacific Standard Time, UTC, W. '
                   'Europe Standard Time, Korea Standard Time, Cen. Australia Standard Time.', arg_group='Maintenance '
                   'Window')
        c.argument('recur_every', type=str, help='Rate at which a Maintenance window is expected to recur. The rate '
                   'can be expressed as daily, weekly, or monthly schedules. Daily schedule are formatted as '
                   'recurEvery: [Frequency as integer][\'Day(s)\']. If no frequency is provided, the default frequency '
                   'is 1. Daily schedule examples are recurEvery: Day, recurEvery: 3Days.  Weekly schedule are '
                   'formatted as recurEvery: [Frequency as integer][\'Week(s)\'] [Optional comma separated list of '
                   'weekdays Monday-Sunday]. Weekly schedule examples are recurEvery: 3Weeks, recurEvery: Week '
                   ...
                   'Second, Third, Fourth, Last)] [Weekday Monday-Sunday]. Monthly schedule examples are recurEvery: '
                   'Month, recurEvery: 2Months, recurEvery: Month day23,day24, recurEvery: Month Last Sunday, '
                   'recurEvery: Month Fourth Monday.', arg_group='Maintenance Window')

...
def load_command_table(self, _):
    ...
    with self.command_group('maintenance public-maintenance-configuration',
                            maintenance_public_maintenance_configuration,
                            client_factory=cf_public_maintenance_configuration, is_experimental=True) as g:
        g.custom_command('list', 'maintenance_public_maintenance_configuration_list')
        g.custom_show_command('show', 'maintenance_public_maintenance_configuration_show')
    ...
    with self.command_group('maintenance apply-update', maintenance_apply_update, client_factory=cf_apply_update,
                            is_experimental=True) as g:
        g.custom_show_command('show', 'maintenance_apply_update_show')
        g.custom_command('create', 'maintenance_apply_update_create')
        g.custom_command('update', 'maintenance_apply_update_update')
        g.custom_command('get-parent', 'maintenance_apply_update_get_parent')
    ...
    with self.command_group('maintenance configuration-assignment', maintenance_configuration_assignment,
                            client_factory=cf_configuration_assignment, is_experimental=True) as g:
        g.custom_command('list', 'maintenance_configuration_assignment_list')
        g.custom_command('create', 'maintenance_configuration_assignment_create')
        g.custom_command('update', 'maintenance_configuration_assignment_update')
        g.custom_command('delete', 'maintenance_configuration_assignment_delete', confirmation=True)
        g.custom_command('list-parent', 'maintenance_configuration_assignment_list_parent')
    ...
    with self.command_group('maintenance maintenance-configuration', maintenance_maintenance_configuration,
                            client_factory=cf_maintenance_configuration, is_experimental=True) as g:
        g.custom_command('list', 'maintenance_maintenance_configuration_list')
        g.custom_show_command('show', 'maintenance_maintenance_configuration_show')
        g.custom_command('create', 'maintenance_maintenance_configuration_create')
        g.custom_command('update', 'maintenance_maintenance_configuration_update')
        g.custom_command('delete', 'maintenance_maintenance_configuration_delete', confirmation=True)

...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.extension_properties = AAZDictArg(
            ...
            help="Gets or sets                                                                        extensionProperties of the                                                                        maintenanceConfiguration                                                                        Expect value: KEY1=VALUE1                                                                        KEY2=VALUE2 ...",
            nullable=True,
        )
        _args_schema.maintenance_scope = AAZStrArg(
            options=["--maintenance-scope"],
            help="Gets or sets maintenanceScope                                                                        of the configuration.                                                                        Allowed values: All,                                                                        Extension, Host,                                                                        InGuestPatch, InResource,                                                                        OSImage, Resource, SQLDB,                                                                        SQLManagedInstance.",
            nullable=True,
        ...
        _args_schema.visibility = AAZStrArg(
            options=["--visibility"],
            help="Gets or sets the visibility                                                                        of the configuration.                                                                        Allowed values: Custom,                                                                        Public.",
            nullable=True,
        ...
        _args_schema.reboot_setting = AAZStrArg(
            ...
            help="Possible reboot preference as                                                                        defined by the user based on                                                                        which it would be decided to                                                                        reboot the machine or not                                                                        after the patch operation is                                                                        completed.  Allowed values:                                                                        Always, IfRequired, Never.",
            nullable=True,
        ...
        _args_schema = cls._args_schema
        _args_schema.classifications_to_include = AAZListArg(
            options=["--classifications-to-include"],
        ...
        classifications_to_include = cls._args_schema.classifications_to_include
        classifications_to_include.Element = AAZStrArg(
            nullable=True,
        )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if install_patches is not None:
                install_patches.set_prop("linuxParameters", AAZObjectType)

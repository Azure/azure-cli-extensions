...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.install_patches_post_tasks = AAZListArg(
            options=["--post-tasks", "--install-patches-post-tasks"],
            arg_group="InstallPatches",
            help="List of post tasks. e.g. [{'source' :'runbook', 'taskScope': 'Resource', 'parameters': { 'arg1': 'value1'}}]",
            nullable=True,
        )
        _args_schema.install_patches_pre_tasks = AAZListArg(
            options=["--pre-tasks", "--install-patches-pre-tasks"],
            arg_group="InstallPatches",
            help="List of pre tasks. e.g. [{'source' :'runbook', 'taskScope': 'Global', 'parameters': { 'arg1': 'value1'}}]",
            nullable=True,
        )
        ...
        install_patches_linux_parameters.classifications_to_include = AAZListArg(
            options=["classifications-to-include"],
            help="Classification category of patches to be patched",
            nullable=True,
        )
        install_patches_linux_parameters.package_name_masks_to_exclude = AAZListArg(
            options=["package-name-masks-to-exclude"],
            help="Package names to be excluded for patching.",
            nullable=True,
        )
        install_patches_linux_parameters.package_name_masks_to_include = AAZListArg(
            options=["package-name-masks-to-include"],
            help="Package names to be included for patching.",
            nullable=True,
        )

        classifications_to_include = cls._args_schema.install_patches_linux_parameters.classifications_to_include
        classifications_to_include.Element = AAZStrArg(
            nullable=True,
        )

        package_name_masks_to_exclude = cls._args_schema.install_patches_linux_parameters.package_name_masks_to_exclude
        package_name_masks_to_exclude.Element = AAZStrArg(
            nullable=True,
        )

        package_name_masks_to_include = cls._args_schema.install_patches_linux_parameters.package_name_masks_to_include
        package_name_masks_to_include.Element = AAZStrArg(
            nullable=True,
        )

        install_patches_post_tasks = cls._args_schema.install_patches_post_tasks
        install_patches_post_tasks.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_task_properties_update(install_patches_post_tasks.Element)

        install_patches_pre_tasks = cls._args_schema.install_patches_pre_tasks
        install_patches_pre_tasks.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_task_properties_update(install_patches_pre_tasks.Element)

        install_patches_windows_parameters = cls._args_schema.install_patches_windows_parameters
        install_patches_windows_parameters.classifications_to_include = AAZListArg(
            options=["classifications-to-include"],
            help="Classification category of patches to be patched",
            nullable=True,
        )
        ...
        install_patches_windows_parameters.kb_numbers_to_exclude = AAZListArg(
            options=["kb-numbers-to-exclude"],
            help="Windows KBID to be excluded for patching.",
            nullable=True,
        )
        install_patches_windows_parameters.kb_numbers_to_include = AAZListArg(
            options=["kb-numbers-to-include"],
            help="Windows KBID to be included for patching.",
            nullable=True,
        )

        classifications_to_include = cls._args_schema.install_patches_windows_parameters.classifications_to_include
        classifications_to_include.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_exclude = cls._args_schema.install_patches_windows_parameters.kb_numbers_to_exclude
        kb_numbers_to_exclude.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_include = cls._args_schema.install_patches_windows_parameters.kb_numbers_to_include
    ...
    def _build_args_task_properties_update(cls, _schema):
        ...
        task_properties_update.parameters = AAZDictArg(
            options=["parameters"],
            help="Gets or sets the parameters of the task.",
            nullable=True,
        )
        task_properties_update.source = AAZStrArg(
            options=["source"],
            help="Gets or sets the name of the runbook.",
            nullable=True,
        )
        task_properties_update.task_scope = AAZStrArg(
            options=["task-scope"],
            help="Global Task execute once when schedule trigger. Resource task execute for each VM.",
            default="Global",
            nullable=True,
    ...
    class MaintenanceConfigurationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_maintenance_configuration_read(cls._schema_on_200)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if tasks is not None:
                tasks.set_prop("postTasks", AAZListType, ".install_patches_post_tasks")
                tasks.set_prop("preTasks", AAZListType, ".install_patches_pre_tasks")

            post_tasks = _builder.get(".properties.installPatches.tasks.postTasks")
            if post_tasks is not None:
                _build_schema_task_properties_update(post_tasks.set_elements(AAZObjectType, "."))

            pre_tasks = _builder.get(".properties.installPatches.tasks.preTasks")
            if pre_tasks is not None:
                _build_schema_task_properties_update(pre_tasks.set_elements(AAZObjectType, "."))
...
def _build_schema_task_properties_update(_builder):
    if _builder is None:
        return
...
def _build_schema_maintenance_configuration_read(_schema):
    global _schema_maintenance_configuration_read
    if _schema_maintenance_configuration_read is not None:
        _schema.id = _schema_maintenance_configuration_read.id
        _schema.location = _schema_maintenance_configuration_read.location
        _schema.name = _schema_maintenance_configuration_read.name
        _schema.properties = _schema_maintenance_configuration_read.properties
        _schema.system_data = _schema_maintenance_configuration_read.system_data
        _schema.tags = _schema_maintenance_configuration_read.tags
        _schema.type = _schema_maintenance_configuration_read.type
        return

    _schema_maintenance_configuration_read = AAZObjectType()

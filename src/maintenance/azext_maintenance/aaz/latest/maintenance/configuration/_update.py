...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.install_patches_linux_parameters = AAZObjectArg(
            options=["--install-patches-linux-parameters"],
        ...
        _args_schema.install_patches_windows_parameters = AAZObjectArg(
            options=["--install-patches-windows-parameters"],
            arg_group="InstallPatches",
        ...
        install_patches_linux_parameters.classifications_to_includes = AAZListArg(
        ...
        install_patches_linux_parameters.package_names_masks_to_exclude = AAZListArg(
            options=["package-names-masks-to-exclude"],
            singular_options=["package-name-masks-to-exclude"],
            help="Package names to be excluded for patching.",
            nullable=True,
        )
        install_patches_linux_parameters.package_names_masks_to_include = AAZListArg(
            options=["package-names-masks-to-include"],
            singular_options=["package-name-masks-to-include"],
            help="Package names to be included for patching.",
            nullable=True,
        )

        classifications_to_includes = cls._args_schema.install_patches_linux_parameters.classifications_to_includes
        classifications_to_includes.Element = AAZStrArg(
            nullable=True,
        )

        package_names_masks_to_exclude = cls._args_schema.install_patches_linux_parameters.package_names_masks_to_exclude
        package_names_masks_to_exclude.Element = AAZStrArg(
            nullable=True,
        )

        package_names_masks_to_include = cls._args_schema.install_patches_linux_parameters.package_names_masks_to_include
        package_names_masks_to_include.Element = AAZStrArg(
            nullable=True,
        )

        install_patches_windows_parameters = cls._args_schema.install_patches_windows_parameters
        install_patches_windows_parameters.classifications_to_includes = AAZListArg(
            options=["classifications-to-includes"],
            singular_options=["classifications-to-include"],
            help="Classification category of patches to be patched",
            nullable=True,
        ...
        install_patches_windows_parameters.kb_numbers_to_excludes = AAZListArg(
            options=["kb-numbers-to-excludes"],
            singular_options=["kb-numbers-to-exclude"],
            help="Windows KBID to be excluded for patching.",
            nullable=True,
        )
        install_patches_windows_parameters.kb_numbers_to_includes = AAZListArg(
            options=["kb-numbers-to-includes"],
            singular_options=["kb-numbers-to-include"],
            help="Windows KBID to be included for patching.",
            nullable=True,
        )

        classifications_to_includes = cls._args_schema.install_patches_windows_parameters.classifications_to_includes
        classifications_to_includes.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_excludes = cls._args_schema.install_patches_windows_parameters.kb_numbers_to_excludes
        kb_numbers_to_excludes.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_includes = cls._args_schema.install_patches_windows_parameters.kb_numbers_to_includes
        kb_numbers_to_includes.Element = AAZStrArg(
            nullable=True,
        )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if linux_parameters is not None:
                ...
                linux_parameters.set_prop("packageNameMasksToExclude", AAZListType, ".package_names_masks_to_exclude")
                linux_parameters.set_prop("packageNameMasksToInclude", AAZListType, ".package_names_masks_to_include")
            ...
            if windows_parameters is not None:
                windows_parameters.set_prop("classificationsToInclude", AAZListType, ".classifications_to_includes")
                windows_parameters.set_prop("excludeKbsRequiringReboot", AAZBoolType, ".exclude_kbs_requiring_reboot")
                windows_parameters.set_prop("kbNumbersToExclude", AAZListType, ".kb_numbers_to_excludes")
                windows_parameters.set_prop("kbNumbersToInclude", AAZListType, ".kb_numbers_to_includes")

...
class Update(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.maintenance/maintenanceconfigurations/{}", "2023-09-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.install_patches = AAZObjectArg(
            options=["--install-patches"],
            arg_group="Properties",
            help="The input parameters to be passed to the patch run operation.",
            nullable=True,
        )
        ...
        install_patches = cls._args_schema.install_patches
        install_patches.linux_parameters = AAZObjectArg(
        ...
        install_patches.reboot_setting = AAZStrArg(
        ...
        install_patches.windows_parameters = AAZObjectArg(
        ...
        linux_parameters = cls._args_schema.install_patches.linux_parameters
        ...
        classifications_to_include = cls._args_schema.install_patches.linux_parameters.classifications_to_include
        classifications_to_include.Element = AAZStrArg(
            nullable=True,
        )

        package_name_masks_to_exclude = cls._args_schema.install_patches.linux_parameters.package_name_masks_to_exclude
        package_name_masks_to_exclude.Element = AAZStrArg(
            nullable=True,
        )

        package_name_masks_to_include = cls._args_schema.install_patches.linux_parameters.package_name_masks_to_include
        package_name_masks_to_include.Element = AAZStrArg(
            nullable=True,
        )

        windows_parameters = cls._args_schema.install_patches.windows_parameters
        ...
        classifications_to_include = cls._args_schema.install_patches.windows_parameters.classifications_to_include
        classifications_to_include.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_exclude = cls._args_schema.install_patches.windows_parameters.kb_numbers_to_exclude
        kb_numbers_to_exclude.Element = AAZStrArg(
            nullable=True,
        )

        kb_numbers_to_include = cls._args_schema.install_patches.windows_parameters.kb_numbers_to_include
    ...
    class MaintenanceConfigurationsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_maintenance_configuration_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("installPatches", AAZObjectType, ".install_patches")

...
class List(AAZCommand):
    ...
    :example: ApplyUpdates_List
        az maintenance apply-update list --resource-group "examplerg"
    """

    _aaz_info = {
        "version": "2023-09-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.maintenance/applyupdates", "2023-09-01-preview"],
        ]
    }

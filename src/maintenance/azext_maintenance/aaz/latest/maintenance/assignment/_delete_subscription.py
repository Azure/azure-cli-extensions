...
@register_command(
    "maintenance assignment delete-subscription",
    is_experimental=True,
    confirmation="Are you sure you want to perform this operation?",
)
class DeleteSubscription(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationAssignmentsForSubscriptionsDelete(ctx=self.ctx)()
    ...
    class ConfigurationAssignmentsForSubscriptionsDelete(AAZHttpOperation):
...
class _DeleteSubscriptionHelper:
    """Helper class for DeleteSubscription"""


__all__ = ["DeleteSubscription"]

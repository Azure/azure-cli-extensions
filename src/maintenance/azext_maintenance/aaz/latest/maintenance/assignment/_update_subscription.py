...
@register_command(
    "maintenance assignment update-subscription",
    is_experimental=True,
)
class UpdateSubscription(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationAssignmentsForSubscriptionsUpdate(ctx=self.ctx)()
    ...
    class ConfigurationAssignmentsForSubscriptionsUpdate(AAZHttpOperation):
...
class _UpdateSubscriptionHelper:
    """Helper class for UpdateSubscription"""


__all__ = ["UpdateSubscription"]

...
@register_command(
    "maintenance assignment update-resource-group",
)
class UpdateResourceGroup(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationAssignmentsForResourceGroupUpdate(ctx=self.ctx)()
    ...
    class ConfigurationAssignmentsForResourceGroupUpdate(AAZHttpOperation):
...
class _UpdateResourceGroupHelper:
    """Helper class for UpdateResourceGroup"""


__all__ = ["UpdateResourceGroup"]

...
@register_command(
    "maintenance assignment show-resource-group",
)
class ShowResourceGroup(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationAssignmentsForResourceGroup(ctx=self.ctx)()
    ...
    class ConfigurationAssignmentsForResourceGroup(AAZHttpOperation):
...
class _ShowResourceGroupHelper:
    """Helper class for ShowResourceGroup"""


__all__ = ["ShowResourceGroup"]

...
@register_command(
    "maintenance assignment create-resource-group",
)
class CreateResourceGroup(AAZCommand):
...
class _CreateResourceGroupHelper:
    """Helper class for CreateResourceGroup"""


__all__ = ["CreateResourceGroup"]

...
class Update(AAZCommand):
    ...
    :example: ConfigurationAssignments_Update
        az maintenance assignment update --name "workervmPolicy" --provider-name "Microsoft.Compute" --resource-group "examplerg" --resource-name "smdvm1"  --resource-type "virtualMachines"
    """

...
@register_command(
    "maintenance assignment create-or-update-resource-group",
    is_experimental=True,
)
class CreateOrUpdateResourceGroup(AAZCommand):
...
class _CreateOrUpdateResourceGroupHelper:
    """Helper class for CreateOrUpdateResourceGroup"""


__all__ = ["CreateOrUpdateResourceGroup"]

...
@register_command(
    "maintenance assignment delete-resource-group",
...
class DeleteResourceGroup(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.configuration_assignment_name = AAZStrArg(
            options=["--configuration-assignment-name"],
            help="Unique configuration assignment name",
            required=True,
            fmt=AAZStrArgFormat(
                pattern="^.+$",
            ),
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationAssignmentsForResourceGroupDelete(ctx=self.ctx)()
    ...
    class ConfigurationAssignmentsForResourceGroupDelete(AAZHttpOperation):
...
class _DeleteResourceGroupHelper:
    """Helper class for DeleteResourceGroup"""


__all__ = ["DeleteResourceGroup"]

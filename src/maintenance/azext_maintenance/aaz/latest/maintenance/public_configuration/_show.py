...
class Show(AAZCommand):
    ...
    :example: PublicMaintenanceConfigurations_GetForResource
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.maintenance/publicmaintenanceconfigurations/{}", "2022-07-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PublicMaintenanceConfigurationsGet(ctx=self.ctx)()
    ...
    class PublicMaintenanceConfigurationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_task_properties_read(post_tasks.Element)

            pre_tasks = cls._schema_on_200.properties.install_patches.tasks.pre_tasks
            pre_tasks.Element = AAZObjectType()
            _build_schema_task_properties_read(pre_tasks.Element)
...
def _build_schema_task_properties_read(_schema):
    global _schema_task_properties_read
    if _schema_task_properties_read is not None:
        _schema.parameters = _schema_task_properties_read.parameters
        _schema.source = _schema_task_properties_read.source
        _schema.task_scope = _schema_task_properties_read.task_scope
        return

    _schema_task_properties_read = AAZObjectType()

...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.maintenance/applyupdates", "2022-07-01-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.maintenance/applyupdates", "2022-07-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ApplyUpdateForResourceGroupList(ctx=self.ctx)()
        if condition_1:
    ...
    class ApplyUpdateForResourceGroupList(AAZHttpOperation):

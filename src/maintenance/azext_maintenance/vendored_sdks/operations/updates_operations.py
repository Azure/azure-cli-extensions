...
class UpdatesOperations(object):
    ...
    def list_parent(
        ...
        deserialized = models.UpdatePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.UpdatePaged(internal_paging, self._deserialize.dependencies, header_dict)

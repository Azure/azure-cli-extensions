...
```
az maintenance configuration create --location "westus2" --maintenance-scope "Host" --duration "05:00" \
--expiration-date-time "9999-12-31 00:00" --recur-every "Day" --start-date-time "2020-04-30 08:00" --time-zone \
"Pacific Standard Time" --namespace "Microsoft.Maintenance" --visibility "Custom" --resource-group "examplerg" \
...
```
az maintenance configuration update --location "westus2" --maintenance-scope "Host" --duration "05:00" \
--expiration-date-time "9999-12-31 00:00" --recur-every "Month Third Sunday" --start-date-time "2020-04-30 08:00" \
--time-zone "Pacific Standard Time" --namespace "Microsoft.Maintenance" --visibility "Custom" --resource-group \
"examplerg" --resource-name "configuration1"
```

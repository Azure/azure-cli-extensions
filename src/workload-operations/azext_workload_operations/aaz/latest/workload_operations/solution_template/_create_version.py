...
class CreateVersion(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.solution_template_version = AAZFileArg(
            options=["--solution-template-version"],
            arg_group="Properties",
            help="Path to file containing version",
        )
        ...
        print("Atharva ", solution_template_version)
    ...
    class SolutionTemplatesCreateVersion(AAZHttpOperation):
        ...
        def content(self):
            ...
            try:
                solution_template_version_str = str(self.ctx.args.solution_template_version)
                solution_template_version_json = json.loads(solution_template_version_str)
                content["solutionTemplateVersion"]["properties"] = solution_template_version_json
            except json.JSONDecodeError as e:
                print(f"Error parsing solution_template_version as JSON: {e}")
                content["solutionTemplateVersion"]["properties"] = solution_template_version_str

            content = self.serialize_content(content)
            print("AVU", content)
            return content

...
@register_command(
    "workload-operations solution-template version show",
    is_preview=True,
)
    ...
    class SolutionTemplateVersionsGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/solutionTemplates/{solutionTemplateName}/versions/{solutionTemplateVersionName}",
                **self.url_parameters
            )

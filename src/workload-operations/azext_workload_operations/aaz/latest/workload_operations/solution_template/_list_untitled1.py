...
@register_command(
    "workload-operations solution-template list-untitled1",
    is_preview=True,
)
class ListUntitled1(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.edge/solutiontemplates", "2025-01-01-preview"],
        ]
    }
    ...
    class SolutionTemplatesListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/solutionTemplates",
                **self.url_parameters
            )

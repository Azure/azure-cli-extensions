...
@register_command(
    "workload-operations workflow version list",
    is_preview=True,
)
    ...
    class WorkflowVersionsListByWorkflow(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/workflows/{workflowName}/versions",
                **self.url_parameters
            )

...
class DeleteRevision(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.edge/targets/{}/deleterevision", "2025-01-01-preview"],
        ]
    }
    ...
    class TargetsDeleteRevision(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/targets/{targetName}/deleteRevision",
                **self.url_parameters
            )

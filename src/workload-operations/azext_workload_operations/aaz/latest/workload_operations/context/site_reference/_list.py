...
@register_command(
    "workload-operations context site-reference list",
    is_preview=True,
)
    ...
    class SiteReferencesListByContext(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/contexts/{contextName}/siteReferences",
                **self.url_parameters
            )

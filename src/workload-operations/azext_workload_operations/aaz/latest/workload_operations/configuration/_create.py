...
@register_command(
    "workload-operations configuration create",
    is_preview=True,
)
    ...
    class ConfigurationsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                # properties.set_prop("currentVersion", AAZStrType, ".version", typ_kwargs={"flags": {"required": True}})
                properties.currentVersion = "1.0.0"
                properties.dynamicConfigurationType = "Shared"
                properties.dynamicConfigurationModel = "Common"
        ...
        def _build_schema_on_200_201(cls):
            ...
            return cls._schema_on_200_201
    class DynamicConfigurationsCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                # properties.currentVersion = "1.0.0"
                # properties.dynamicConfigurationType = AAZStrType()
                # properties.dynamicConfigurationType = "Shared"
                # properties.dynamicConfigurationModel = AAZStrType()
                # properties.dynamicConfigurationModel = "Common"

            c = self.serialize_content(_content_value)
            # print(c)
            return c
    ...
    class DynamicConfigurationVersionsCreateOrUpdate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "dynamicConfigurationVersionName", self.ctx.args.version,
                    required=True,
                ),
                **self.serialize_url_param(
                    "resourceGroupName", self.ctx.args.resource_group,

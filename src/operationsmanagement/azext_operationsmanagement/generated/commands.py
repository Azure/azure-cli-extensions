...
def load_command_table(self, _):
    ...
    operationsmanagement_solution = CliCommandType(
        operations_tmpl='azext_operationsmanagement.vendored_sdks.operationsmanagement.operations._solutions_operations'
        '#SolutionsOperations.{}',
    ...
    with self.command_group('operationsmanagement solution', operationsmanagement_solution,
        ...
        g.custom_command('delete', 'operationsmanagement_solution_delete', supports_no_wait=True, confirmation=True)
    ...
    with self.command_group('operationsmanagement management-association', operationsmanagement_management_association,
        ...
        g.generic_update_command('update', custom_func_name='operationsmanagement_management_association_update')
        g.custom_command('delete', 'operationsmanagement_management_association_delete', confirmation=True)
    ...
    operationsmanagement_management_configuration = CliCommandType(
        ...
        'tions_operations#ManagementConfigurationsOperations.{}',
    ...
    with self.command_group('operationsmanagement management-configuration',
        ...
        g.custom_command('delete', 'operationsmanagement_management_configuration_delete', confirmation=True)

    with self.command_group('operationsmanagement', is_experimental=True):
        pass

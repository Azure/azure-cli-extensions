    ...
    parameters:
      - name: --plan
        ...
        long-summary: |
            ...
            name: name of the solution to be created. For Microsoft published solution it should be in the format of so\
lutionType(workspaceName). SolutionType part is case sensitive. For third party solution, it can be anything.
...
format of OMSGallery/:code:`<solutionType>`. This is case sensitive
      - name: --properties
        ...
        long-summary: |
            ...
            workspace-resource-id: Required. The azure resourceId for the workspace where the solution will be deployed\
/enabled.
            contained-resources: The azure resources that will be contained within the solutions. They will be locked a\
nd gets deleted automatically when the solution is deleted.
            referenced-resources: The resources that will be referenced from this solution. Deleting any of those solut\
ion out of band will break the solution.
    examples:
      - name: SolutionCreate
        text: |-
               az operationsmanagement solution create --location "East US" --plan name="name1" product="product1" prom\
otion-code="promocode1" publisher="publisher1" --properties contained-resources="/subscriptions/sub2/resourceGroups/rg2\
/providers/provider1/resources/resource1" contained-resources="/subscriptions/sub2/resourceGroups/rg2/providers/provide\
r2/resources/resource2" referenced-resources="/subscriptions/sub2/resourceGroups/rg2/providers/provider1/resources/reso\
urce2" referenced-resources="/subscriptions/sub2/resourceGroups/rg2/providers/provider2/resources/resource3" workspace-\
resource-id="/subscriptions/sub2/resourceGroups/rg2/providers/Microsoft.OperationalInsights/workspaces/ws1" --resource-\
group "rg1" --name "solution1"
"""
...
helps['operationsmanagement solution update'] = """
    ...
    examples:
      - name: SolutionUpdate
        text: |-
               az operationsmanagement solution update --tags Dept="IT" Environment="Test" --resource-group "rg1" --nam\
e "solution1"
"""
...
helps['operationsmanagement management-association show'] = """
    ...
    examples:
      - name: SolutionGet
        text: |-
               az operationsmanagement management-association show --name "managementAssociation1" --provider-name "pro\
viderName" --resource-group "rg1" --resource-name "resourceName" --resource-type "resourceType"
"""
...
helps['operationsmanagement management-association create'] = """
    ...
    examples:
      - name: SolutionCreate
        text: |-
               az operationsmanagement management-association create --name "managementAssociation1" --location "East U\
S" --application-id "/subscriptions/sub1/resourcegroups/rg1/providers/Microsoft.Appliance/Appliances/appliance1" --prov\
ider-name "providerName" --resource-group "rg1" --resource-name "resourceName" --resource-type "resourceType"
"""
...
helps['operationsmanagement management-association update'] = """
    ...
    examples:
      - name: SolutionCreate
        text: |-
               az operationsmanagement management-association update --name "managementAssociation1" --location "East U\
S" --application-id "/subscriptions/sub1/resourcegroups/rg1/providers/Microsoft.Appliance/Appliances/appliance1" --prov\
ider-name "providerName" --resource-group "rg1" --resource-name "resourceName" --resource-type "resourceType"
"""
...
helps['operationsmanagement management-configuration show'] = """
    ...
    examples:
      - name: SolutionGet
        text: |-
               az operationsmanagement management-configuration show --name "managementConfigurationName" --resource-gr\
oup "rg1"
"""
...
helps['operationsmanagement management-configuration create'] = """
    ...
    examples:
      - name: ManagementConfigurationCreate
        text: |-
               az operationsmanagement management-configuration create --name "managementConfiguration1" --parameters l\
ocation="East US" --resource-group "rg1"
"""
...
helps['operationsmanagement management-configuration update'] = """
    ...
    examples:
      - name: ManagementConfigurationCreate
        text: |-
               az operationsmanagement management-configuration update --name "managementConfiguration1" --parameters l\
ocation="East US" --resource-group "rg1"
"""
...
helps['operationsmanagement management-configuration delete'] = """
    ...
    examples:
      - name: ManagementConfigurationDelete
        text: |-
               az operationsmanagement management-configuration delete --name "managementConfigurationName" --resource-\
group "rg1"
"""

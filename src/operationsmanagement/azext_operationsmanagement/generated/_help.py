...
group "rg1" --solution-name "solution1"
"""
...
helps['operationsmanagement solution update'] = """
    ...
    examples:
      - name: SolutionUpdate
        text: |-
               az operationsmanagement solution update --tags Dept="IT" Environment="Test" --resource-group "rg1" --sol\
ution-name "solution1"
"""
...
on1" --location "East US" --properties application-id="/subscriptions/sub1/resourcegroups/rg1/providers/Microsoft.Appli\
ance/Appliances/appliance1" --provider-name "providerName" --resource-group "rg1" --resource-name "resourceName" --reso\
urce-type "resourceType"
"""
...
helps['operationsmanagement management-association update'] = """
    ...
    examples:
      - name: SolutionCreate
        text: |-
               az operationsmanagement management-association update --management-association-name "managementAssociati\
on1" --location "East US" --properties application-id="/subscriptions/sub1/resourcegroups/rg1/providers/Microsoft.Appli\
ance/Appliances/appliance1" --provider-name "providerName" --resource-group "rg1" --resource-name "resourceName" --reso\
urce-type "resourceType"
"""
...
guration1" --parameters location="East US" --resource-group "rg1"
"""
...
helps['operationsmanagement management-configuration update'] = """
    ...
    examples:
      - name: ManagementConfigurationCreate
        text: |-
               az operationsmanagement management-configuration update --management-configuration-name "managementConfi\
guration1" --parameters location="East US" --resource-group "rg1"
"""

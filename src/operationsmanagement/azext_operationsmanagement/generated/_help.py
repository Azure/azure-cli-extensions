...
helps['operationsmanagement solution'] = """
    type: group
    short-summary: Manage solution with operationsmanagement
"""

helps['operationsmanagement solution list'] = """
    type: command
    short-summary: "Retrieves the solution list. It will retrieve both first party and third party solutions And \
...
helps['operationsmanagement solution create'] = """
    type: command
    short-summary: "Create the Solution."
    parameters:
      - name: --plan
...
helps['operationsmanagement management-association'] = """
    type: group
    short-summary: Manage management association with operationsmanagement
"""
...
helps['operationsmanagement management-association create'] = """
    type: command
    short-summary: "Create the ManagementAssociation."
    examples:
      - name: SolutionCreate
        text: |-
...
helps['operationsmanagement management-association update'] = """
    type: command
    short-summary: "Update the ManagementAssociation."
"""
...
helps['operationsmanagement management-configuration'] = """
    type: group
    short-summary: Manage management configuration with operationsmanagement
"""
...
helps['operationsmanagement management-configuration create'] = """
    type: command
    short-summary: "Create the ManagementConfiguration."
    parameters:
      - name: --properties-parameters
        short-summary: "Parameters to run the ARM template"
        long-summary: |
            Usage: --properties-parameters name=XX value=XX

            name: name of the parameter.
            value: value for the parameter. In Jtoken

            Multiple actions can be specified by using more than one --properties-parameters argument.
    examples:
      - name: ManagementConfigurationCreate
        text: |-
               az operationsmanagement management-configuration create --name "managementConfiguration1" --location \
"East US" --resource-group "rg1"
"""

helps['operationsmanagement management-configuration update'] = """
    type: command
    short-summary: "Update the ManagementConfiguration."
    parameters:
      - name: --properties-parameters
        short-summary: "Parameters to run the ARM template"
        long-summary: |

...
def cf_solution(cli_ctx, *_):
    return cf_operationsmanagement_cl(cli_ctx).solution


def cf_management_association(cli_ctx, *_):
    return cf_operationsmanagement_cl(cli_ctx).management_association


def cf_management_configuration(cli_ctx, *_):
    return cf_operationsmanagement_cl(cli_ctx).management_configuration

...
class OperationOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~operations_management_client.models.OperationListResult]
    ...
    list.metadata = {'url': '/providers/Microsoft.OperationsManagement/operations'}  # type: ignore

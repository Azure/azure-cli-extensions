...
class CodeMessageError1(msrest.serialization.Model):
    """The error body contract.

    :param error: The error details for a failed request.
    :type error: ~azure.mgmt.operationsmanagement.models.CodeMessageError1Error
    """

    _attribute_map = {
        'error': {'key': 'error', 'type': 'CodeMessageError1Error'},
    }

    def __init__(
        self,
        *,
        error: Optional["CodeMessageError1Error"] = None,
        **kwargs
    ):
        super(CodeMessageError1, self).__init__(**kwargs)
        self.error = error


class CodeMessageError1Error(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CodeMessageError1Error, self).__init__(**kwargs)
        self.code = code

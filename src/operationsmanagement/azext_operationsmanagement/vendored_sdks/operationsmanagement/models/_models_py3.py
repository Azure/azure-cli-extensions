...
class CodeMessageError(msrest.serialization.Model):
    ...
    :type error: ~azure.mgmt.operationsmanagement.models.Error
    """
...
class ManagementConfiguration(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'parent_resource_type': {'key': 'properties.parentResourceType', 'type': 'str'},
        'parameters': {'key': 'properties.parameters', 'type': '[ArmTemplateParameter]'},
    ...
    def __init__(
        ...
        *,
        ...
        parameters: Optional[List["ArmTemplateParameter"]] = None,

...
class ManagementConfigurationOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        parameters = models.ManagementConfiguration(location=location, application_id=application_id, parent_resource_type=parent_resource_type, parameters=parameters, template=template)
        api_version = "2015-11-01-preview"

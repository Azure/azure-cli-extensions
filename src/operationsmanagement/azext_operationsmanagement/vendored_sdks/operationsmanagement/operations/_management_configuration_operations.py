...
class ManagementConfigurationOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize(models.CodeMessageError1, response)
    ...
    def create_or_update(
        ...
        properties=None,  # type: Optional["models.ManagementConfigurationProperties"]
        **kwargs  # type: Any
    ):
        ...
        :type properties: ~azure.mgmt.operationsmanagement.models.ManagementConfigurationProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _parameters = models.ManagementConfiguration(location=location, properties=properties)
        api_version = "2015-11-01-preview"

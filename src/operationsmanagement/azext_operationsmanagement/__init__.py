...
class OperationsManagementClientCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_operationsmanagement.generated._client_factory import cf_operationsmanagement
        operationsmanagement_custom = CliCommandType(
            operations_tmpl='azext_operationsmanagement.custom#{}',
            client_factory=cf_operationsmanagement)
        super(OperationsManagementClientCommandsLoader, self).__init__(cli_ctx=cli_ctx,

...
class PipelineTemplateDefinitionOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> "models.PipelineTemplateDefinitionListResult":
        """Lists all pipeline templates which can be used to configure an Azure Pipeline.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PipelineTemplateDefinitionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.devops.models.PipelineTemplateDefinitionListResult
    ...
    list.metadata = {'url': '/providers/Microsoft.DevOps/pipelineTemplateDefinitions'}

...
class Pipeline(Resource):
    ...
    def __init__(
        self,
        *,
        id_properties_bootstrap_configuration_template_id: str,
        name_properties_project_name: str,
        name_properties_organization_name: str,
        tags: Optional[Dict[str, str]] = None,
        location: Optional[str] = None,
        parameters_properties_bootstrap_configuration_template_parameters: Optional[Dict[str, str]] = None,
        repository_type: Optional[Union[str, "CodeRepositoryType"]] = None,
        id_properties_bootstrap_configuration_repository_id: Optional[str] = None,
        default_branch: Optional[str] = None,
        properties: Optional[Dict[str, str]] = None,
        parameters_properties_bootstrap_configuration_repository_authorization_parameters: Optional[Dict[str, str]] = None,
        **kwargs
    ):
        super(Pipeline, self).__init__(tags=tags, location=location, **kwargs)
        self.pipeline_id = None
        self.id_properties_bootstrap_configuration_template_id = id_properties_bootstrap_configuration_template_id
        self.parameters_properties_bootstrap_configuration_template_parameters = parameters_properties_bootstrap_configuration_template_parameters
        self.repository_type = repository_type
        self.id_properties_bootstrap_configuration_repository_id = id_properties_bootstrap_configuration_repository_id
        self.default_branch = default_branch
        self.properties = properties
        self.parameters_properties_bootstrap_configuration_repository_authorization_parameters = parameters_properties_bootstrap_configuration_repository_authorization_parameters
        self.id_properties_project_id = None
        self.name_properties_project_name = name_properties_project_name
        self.id_properties_organization_id = None
        self.name_properties_organization_name = name_properties_organization_name

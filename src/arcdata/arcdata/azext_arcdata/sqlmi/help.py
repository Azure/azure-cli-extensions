...
helps["sql mi-arc endpoint list"] = (
    """
    type: command
    short-summary: {short}
    examples:
...
# pylint: disable=line-too-long
helps["sql mi-arc get-mirroring-cert"] = (
    """
    type: command
    short-summary: {short}
    examples:
...
# pylint: disable=line-too-long
helps["sql mi-arc config remove"] = (
    """
    type: command
    short-summary: {short}
    long-summary: {long}
...
# pylint: disable=line-too-long
helps["sql mi-arc config replace"] = (
    """
    type: command
    short-summary: {short}
    long-summary: {long}
...
helps["sql mi-arc reprovision-replica"] = (
    """
    type: command
    short-summary: {short}
    long-summary: {long}

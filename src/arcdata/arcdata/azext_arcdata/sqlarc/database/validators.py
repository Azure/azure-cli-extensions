...
def partially_validate_time(given_time):
    ...
    if given_time != None and given_time > current_time:
        raise CLIError(
...
def validate_time(backup_information, given_time):
    if (
        ...
        or backup_information.last_full_backup == None
    ):
...
def validate_backups_are_active(
    ...
    if instance_backups_policy == None and database_backups_policy == None:
        raise ValueError(
            "There is no backups policy currently set for this SQL database or SQL Server instance."
        )
    elif database_backups_policy == None and instance_backups_policy != None:
    ...
    elif database_backups_policy != None:

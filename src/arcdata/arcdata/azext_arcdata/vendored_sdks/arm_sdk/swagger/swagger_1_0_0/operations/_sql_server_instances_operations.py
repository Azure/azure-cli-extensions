...
class SqlServerInstancesOperations(object):
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_arc_data_management_client.models.SqlServerInstanceListResult]
    ...
    def begin_create(
        ...
        **kwargs,  # type: Any
        ...
        :return: An instance of LROPoller that returns either SqlServerInstance or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure_arc_data_management_client.models.SqlServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop(
            "polling", True

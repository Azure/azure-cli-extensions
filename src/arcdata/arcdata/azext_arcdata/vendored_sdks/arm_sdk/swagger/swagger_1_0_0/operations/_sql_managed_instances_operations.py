...
class SqlManagedInstancesOperations(object):
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_arc_data_management_client.models.SqlManagedInstanceListResult]
    ...
    def get(
        ...
        **kwargs,  # type: Any
        ...
        path_format_arguments = {
            ...
            "sqlManagedInstanceName": self._serialize.url(
                "sql_managed_instance_name", sql_managed_instance_name, "str"
            ),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def begin_create(
        ...
        **kwargs,  # type: Any
        ...
        :return: An instance of LROPoller that returns either SqlManagedInstance or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure_arc_data_management_client.models.SqlManagedInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop(
            "polling", True

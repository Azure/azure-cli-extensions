...
class AzureArcDataManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype sql_server_databases:
     azure_arc_data_management_client.aio.operations.SqlServerDatabasesOperations
    ...
    :vartype failover_groups:
     azure_arc_data_management_client.aio.operations.FailoverGroupsOperations

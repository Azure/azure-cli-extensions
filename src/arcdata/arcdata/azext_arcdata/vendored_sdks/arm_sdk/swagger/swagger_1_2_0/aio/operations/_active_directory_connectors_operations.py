...
class ActiveDirectoryConnectorsOperations:
    """ActiveDirectoryConnectorsOperations async operations.
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ActiveDirectoryConnectorListResult"]:
        ...
        :return: An iterator like instance of either ActiveDirectoryConnectorListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure_arc_data_management_client.models.ActiveDirectoryConnectorListResult]
    ...
    async def begin_create(
        ...
        **kwargs: Any,
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure_arc_data_management_client.models.ActiveDirectoryConnectorResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop(
            "api_version", "2023-01-15-preview"

...
class SqlServerLicensesOperations:
    """SqlServerLicensesOperations async operations.
    ...
    def list(
        self, **kwargs: Any
    ) -> AsyncIterable["_models.SqlServerLicenseListResult"]:
        ...
        :return: An iterator like instance of either SqlServerLicenseListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurearcdata.models.SqlServerLicenseListResult]
...
# JGAGggIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBTvOcnpqsDralf
# av79WJHZTmK6sOnmOkQ/7GMTFT6fJKCCEW4wggh+MIIHZqADAgECAhM2AAAByGSC
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN6xx0iJOrob8SE4zjV+W+3XdcQjzPzS
# i23i7X5P+AAbMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYA
# dKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEA
# pwgCZzKvRfA3M4k1eTWOKCI5C5wIRAeEvEh3kfYvFCP9HeU8m0HoPzsODAMBVRt6
# ugOZCKW+EEQWNrWSp+kGgxRqQibtlJhvdm8Q69ZuLv8xThgfrWf2EmNFBK2EfELa
# CjwyBBgsWvuA1gJua3dUW2qSCgQz8sT0+eG4lBczxxDXDSNVHw/wszhXLS4zC+d+
# S5vNGO2Zq5n/C7riuUm870jRderbI2sOTek5yp9YLZ1JI+AEB/WbWTDZvrKQfXp5
# Z7WIHIIVEZuQNaBtOTicj2/EG4oVIIr6QJYdwkUGjmB7GdgJAWRzMLJWt2K2agjb
# ZZBQI/+whf7XJ+s1yETUZaGCFykwghclBgorBgEEAYI3AwMBMYIXFTCCFxEGCSqG
...
# BCASCOubO0jf18igUOwPytIWnoIhGEjD0TSjzOMv8zIeuwIGZdYHa6HfGBMyMDI0
# MDIyODE1MDMxMC4yODdaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJVUzETMBEG
...
# MBoGCSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgy0Aa
# JOswHg6+x87QLsnvUvceYiRSIZBAGjjcuUU9iXswgfoGCyqGSIb3DQEJEAIvMYHq
...
# SIb3DQEBCwUABIICAE9xsS02qyl/40PO5RU2/sUch8XDiYRw3qkVq4YyDOBG4KQn
# 5AaJ+zunrV3JXDKMCcp5Bhcto11MBCb6AqbEnNdPKQWvt2UGxi3QHjtt3m6uqlbL
# T6gs7TqzfXgjV2cwnF150k7CkN5wByJ/HKGmgnyXnoIROSfrMFM0maDcOvKGQGz0
# SefYecq8RtO6uhVwOV6cqrxStsEbVN+mBiM7l7tSheT0xEcPIOnt6Q2bbiEiPzYL
# 4btI7VB9QM5pImQWPRqJVcVd6Wcd8fa1vfgqBoCAt/ud477zG+8G8t0zopaamkwW
# xeorC5KS1ux8Y5969lijCVUq+9Y6SNpjYiwCEqM9DaJ1OlYuoZmzEBOsw8dpaMTT
# YqfWuOAj9ga+PTcdUwYyqnQ8fWfdDhLgVP/6wvyshJ2sXkTOL/75bXvUtF4wxNa4
# RO2GhMW/J/he/P7cfFFalGgf5iVIX1wcfjX9aJPv26zG81af0r9zq/W8dU2MQ6+t
# 3k+a49lqEp6X3i9frswWL3Isv2WqsWo+5OxDeeQ1Su39QLcVDUjrl2qZwD1BnsVq
# 3FZvSuGGG+rLmIvmHcBcKHbcaiIY3vKNyzLd9vasqu6UBV2HokCIabJppiZVJA8a
# lnOP+ubv3jApxfzFPbX+L44eTGuJLns/V0aExQ4DxvTet8/TjxQ3JQP7guo7

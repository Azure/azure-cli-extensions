...
class ActiveDirectoryConnectorDomainDetails(msrest.serialization.Model):
    ...
    :ivar service_account_provisioning: The service account provisioning mode for this Active
     Directory connector. Known values are: "automatic", "manual". Default value: "manual".
    ...
    def __init__(
        ...
        *,
        primary_domain_controller: Optional[
            "_models.ActiveDirectoryDomainController"
        ] = None,
        secondary_domain_controllers: Optional[
            List["_models.ActiveDirectoryDomainController"]
        ] = None,
        **kwargs,
    ):
        """
...
class DataControllerProperties(msrest.serialization.Model):
    ...
    :ivar infrastructure: The infrastructure the data controller is running on. Known values are:
     "azure", "gcp", "aws", "alibaba", "onpremises", "other". Default value: "other".
    ...
    def __init__(
        ...
        *,
        infrastructure: Optional[
            Union[str, "_models.Infrastructure"]
        ] = "other",
        ...
        log_analytics_workspace_config: Optional[
            "_models.LogAnalyticsWorkspaceConfig"
        ] = None,
        upload_service_principal: Optional[
            "_models.UploadServicePrincipal"
        ] = None,
        ...
        **kwargs,
        ...
        :keyword infrastructure: The infrastructure the data controller is running on. Known values
         are: "azure", "gcp", "aws", "alibaba", "onpremises", "other". Default value: "other".
...
class ErrorResponse(msrest.serialization.Model):
    ...
    def __init__(
        self, *, error: Optional["_models.ErrorResponseBody"] = None, **kwargs
    ):
        """
        :keyword error: null.
...
class SqlManagedInstanceProperties(msrest.serialization.Model):
    ...
    :ivar license_type: The license type to apply for this managed instance. Known values are:
     "BasePrice", "LicenseIncluded", "DisasterRecovery". Default value: "BasePrice".
    ...
    def __init__(
        ...
        *,
        ...
        active_directory_information: Optional[
            "_models.ActiveDirectoryInformation"
        ] = None,
        license_type: Optional[
            Union[str, "_models.ArcSqlManagedInstanceLicenseType"]
        ] = "BasePrice",
        cluster_id: Optional[str] = None,
        extension_id: Optional[str] = None,
        **kwargs,
...
class SqlManagedInstanceSku(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar tier: The pricing tier for the instance. Known values are: "GeneralPurpose",
    ...
    def __init__(
        ...
        *,
        tier: Optional[
            Union[str, "_models.SqlManagedInstanceSkuTier"]
        ] = "GeneralPurpose",
        dev: Optional[bool] = True,
        size: Optional[str] = None,
        family: Optional[str] = None,
        ...
        **kwargs,
        ...
        """
        :keyword tier: The pricing tier for the instance. Known values are: "GeneralPurpose",
         "BusinessCritical". Default value: "GeneralPurpose".
...
class SqlServerInstanceProperties(msrest.serialization.Model):
    ...
    :ivar version: SQL Server version. Known values are: "SQL Server 2012", "SQL Server 2014", "SQL
     Server 2016", "SQL Server 2017", "SQL Server 2019", "SQL Server 2022", "Unknown".
    ...
    :vartype v_core: str
    :ivar status: Required. The cloud connectivity status. Known values are: "Connected",
    ...
    :ivar license_type: SQL Server license type. Known values are: "Paid", "Free", "HADR",
     "Undefined".
    ...
    :ivar host_type: Type of host for Azure Arc SQL Server. Known values are: "Virtual Machine",
     "Physical Server", "AWS Virtual Machine", "GCP Virtual Machine", "Other".
    ...
    def __init__(
        ...
        *,
        ...
        license_type: Optional[
            Union[str, "_models.ArcSqlServerLicenseType"]
        ] = None,
        azure_defender_status_last_updated: Optional[datetime.datetime] = None,
        azure_defender_status: Optional[
            Union[str, "_models.DefenderStatus"]
        ] = None,
        ...
        **kwargs,
        ...
        :keyword version: SQL Server version. Known values are: "SQL Server 2012", "SQL Server 2014",
         "SQL Server 2016", "SQL Server 2017", "SQL Server 2019", "SQL Server 2022", "Unknown".
        ...
        :keyword status: Required. The cloud connectivity status. Known values are: "Connected",
         "Disconnected", "Registered", "Unknown".
        ...
        :keyword license_type: SQL Server license type. Known values are: "Paid", "Free", "HADR",
         "Undefined".
        :paramtype license_type: str or
...
class SystemData(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        last_modified_by_type: Optional[
            Union[str, "_models.CreatedByType"]
        ] = None,

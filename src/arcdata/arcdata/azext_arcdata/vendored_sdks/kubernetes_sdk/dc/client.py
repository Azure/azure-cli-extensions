...
from azext_arcdata.vendored_sdks.kubernetes_sdk.dc.export_util import (
    ExportType,
...
from azext_arcdata.vendored_sdks.kubernetes_sdk.models.export_task_custom_resource import (

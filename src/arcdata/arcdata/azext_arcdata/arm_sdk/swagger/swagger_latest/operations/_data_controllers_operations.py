...
def build_patch_data_controller_request_initial(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    data_controller_name,  # type: str
    **kwargs  # type: Any
...
class DataControllersOperations(object):
    ...
    def list_in_subscription(
        ...
        :return: An iterator like instance of either PageOfDataControllerResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.azurearcdata.models.PageOfDataControllerResource]
    ...
    def begin_delete_data_controller(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs,  # type: Any
        ...
        if cont_token is None:
            raw_result = self._delete_data_controller_initial(
                resource_group_name=resource_group_name,
                data_controller_name=data_controller_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
...
# Bz9rhUeNTtDgWxwTNcmwfxG7Mx+AHKCCEW4wggh+MIIHZqADAgECAhM2AAAByGSC
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIII0zGA6dPlyB+afhQ5VY1Z0T1iO9sI3
# pO2pV2Z2BRrnMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYA
# dKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEA
# P2A7VYwKc+gb+6XKCwfUV6kb2xKjNKlcfao2vft3hy8vQbFeWzLT/hEDJZb2W0ww
# 5DwoYqUfw/lj8IV47CRigDeoiMekuMcyoYwW1Osysskim0M32agMCacvP0wIKeq6
# J45EoEi2xBnPBbTIVdGUPDrHKyIBk71b93rJ/vLth4SM/RlMjPRK+9edEpR+lTq6
# IgGAFTivCWauiJKwu4Cks/k770gln0Ai9qW3JpDy4Dg9dp2TrFE+aLO1Q9Dcbepu
# oQ4wDWEDQiyYRWtQLeB7XgR3v5YFNAINQWYJauodBwi8hTU3BJQJV1ONTdYPybBA
# 4YIyy9qMKGlqzWYZCXWdCaGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCCF3wGCSqG
...
# BCB9J2dGagJdGRLWyfTNYilW0UiS/cLjgzHzBsjpSbp9igIGZc4je3laGBMyMDI0
# MDIyODE1MDMwOS44NzhaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJVUzETMBEG
...
# DQEJBDEiBCB2hezKSjMK6mkd2rM+WlvnkSOlmQtLSrP+MavgHUb8vTCB+gYLKoZI
...
# YQKydL0wDQYJKoZIhvcNAQELBQAEggIADBu+06VPefN04IBvnHJAF98VZv6qRMeB
# DQ0AQYF4rEQvWArQyJlqNVyLPbke44WoBe5fwuP6DttDo3n1kkSd8sUR7WDSrD6Y
# IE6Pjt99QcQJnY9uZ8hCzWDfD9vQpR93Bqyl2iuTJRb+sLQDYj9Wz/ept8pbCcPq
# yZW+wYd2tz9d7moqvzW4Imnfa0TJcoPtwO9vzPd8vYQLGz9S+DCRU5uUaq9hGZ6t
# MpZbq3QvokY+7FfGGECz6OGzmp5EhbhIUkX3HWr5EvKFhvNlAnc2JqcfmXCaQLsA
# pe0W3AffI/hwWvfDhO8qPSWHhO+lTi6KpOLLB5YyJXgpuXuIrD6x87ujZZ88fs8L
# gDVlP89iOaE74RPPsfT7BKQYYJrYndQwM7Y1QAC+tUB52fYKO34A8biNn+pW/SYy
# N1t5+m9feGKFwuBTCrGqp4TThN3CTUki8zwP+uskUgewggbs7bI33R+x6rNR2Dth
# xW6rYMT+4OwX1FqhyK2tvt6xAUqt55MY8qZE/72xfwcrrCBysVbGeemIyk6fg0XK
# GKdkaAX9vQkOYDjh58bO56ewOTqdo9Ne5p0laWrhuRIvDizBS3OVB+nmkNkifgOw
# xmTBPT2ooni8Rb/xDVT/sQ7SXUw1CwABcNe10A2eM9TGfBrcyjPS52rFGlzcnKOa
# 9kKx0WashnM=

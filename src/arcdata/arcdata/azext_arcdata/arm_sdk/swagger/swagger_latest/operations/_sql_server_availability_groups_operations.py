...
def build_create_request(
    ...
    availability_group_name,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}")  # pylint: disable=line-too-long
...
def build_detail_view_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/getDetailView")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlServerInstanceName": _SERIALIZER.url("sql_server_instance_name", sql_server_instance_name, 'str'),
...
def build_failover_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/failover")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlServerInstanceName": _SERIALIZER.url("sql_server_instance_name", sql_server_instance_name, 'str'),
...
def build_force_failover_allow_data_loss_request(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    sql_server_instance_name,  # type: str
    availability_group_name,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/forceFailoverAllowDataLoss")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlServerInstanceName": _SERIALIZER.url("sql_server_instance_name", sql_server_instance_name, 'str'),
...
def build_create_availability_group_request_initial(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    sql_server_instance_name,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/createAvailabilityGroup")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlServerInstanceName": _SERIALIZER.url("sql_server_instance_name", sql_server_instance_name, 'str'),
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlServerInstanceName": _SERIALIZER.url("sql_server_instance_name", sql_server_instance_name, 'str'),
...
class SqlServerAvailabilityGroupsOperations(object):
    ...
    def create(
        ...
        sql_server_instance_name,  # type: str
        availability_group_name,  # type: str
        sql_server_availability_group_resource,  # type: "_models.SqlServerAvailabilityGroupResource"
        **kwargs,  # type: Any
    ):
        # type: (...) -> "_models.SqlServerAvailabilityGroupResource"
    ...
    def _update_initial(
        ...
        sql_server_instance_name,  # type: str
        availability_group_name,  # type: str
        sql_server_availability_group_update,  # type: "_models.SqlServerAvailabilityGroupUpdate"
        **kwargs,  # type: Any
    ):
        # type: (...) -> Optional["_models.SqlServerAvailabilityGroupResource"]
        cls = kwargs.pop(
            "cls", None
    ...
    def begin_update(
        ...
        **kwargs,  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SqlServerAvailabilityGroupResource"]
    ...
    def _create_availability_group_initial(
        ...
        resource_group_name,  # type: str
        sql_server_instance_name,  # type: str
        create_ag_configuration,  # type: "_models.AvailabilityGroupCreateUpdateConfiguration"
        **kwargs,  # type: Any
    ):
        # type: (...) -> Optional["_models.SqlServerAvailabilityGroupResource"]
        cls = kwargs.pop(
    ...
    def list(
        ...
        **kwargs,  # type: Any
        ...
        # type: (...) -> Iterable["_models.ArcSqlServerAvailabilityGroupListResult"]
        ...
        :return: An iterator like instance of either ArcSqlServerAvailabilityGroupListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.azurearcdata.models.ArcSqlServerAvailabilityGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop(
            "api_version", "2024-03-01-preview"
...
# JGAGggIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpsDkGn46uNrmI
# pomToN7XF0uATT4D8krxH+TD2rUItKCCEW4wggh+MIIHZqADAgECAhM2AAAByGSC
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPaYNGDCBSRpIDcQQ1NJSshepKaFlAiS
# FODx8IzxDaEPMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYA
# dKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEA
# CIYnsFjxe0CtIFDLqdfjucHleYcFiVe1/kDK2nZhRWW93CT95KAVg093Ak/IKJ/F
# 30MtAZrKkWmoZlYQqQ7fK44DXCUaw+aLgquR5BT38efp31yQqUn6D40BLZ+YZC+b
# 7PFT1r2ezty0dMvZSwR9YRSRWQ7cBUpbvfBT1F1HDEJ4AjxCA/1lVLntRjH511kV
# VorIEcU2ysgUVNWcEcg4wxfLh3XeSOiWiPuKCnfPDczA8uU2XVdqDN4W643+DYz1
# YHFgGnXKJQeqmjL9zQTkGtNs1ZeFkMlOKMtahLbCtkHKRWWT7YzK5YNgZUKUibg7
...
# SIb3DQEBCwUABIICAERNAwfcJJYmip6XSzl+Oh/SFkRjnGWTj3WsATj0XZXiYTJR
# WLFWZoxQBhMuQ9iE54zlvom2W4xhTUX22/XwdrlGyc2MB9j9CfatpL245mtOUAMF
# sdpSxZtyLsQQSXAAOVPwXsqIXRPelYvjTjk5ZAEh/bKvf3lxtgckZJi/+TAj5Dx9
# HPNEoICaFd9G5ROCF5w7HqMNK6i6bf0ll6A0hiqZ7kSzio0sLBv9pSNV1d2QObdW
# IA+WquYtv/6zA2psdcqpaXmkgzf0fXzbtRqReIe3/h3299P/u0gRbusyYYipEn6p
# uDbQo28wuG+cvseTlZLxAxXS0wYFeb2/SXzOYMQUS8pj9fkJAwQDNFiLhOGMxNSF
# iM5WEZjuiE8RglPtUdZTlJUgZzkhyd5nsiCRGPnoRcyrwWCzbkqzb6WEX3k1vsgl
# hkJG4iI0QVJSjKlPc/FBLI+nxwNu0Xtiwr5kC/G9YvJ1hPT7Nq8MU3y3lChuO2hx
# fuT2QLzJZ86QlB35heAYiiVwJHSFXnsEnXYR1125/zr6lRH8A/Qh2AFvKqaE59TE
# CnwDHgOWxNV1XYB1FRqr3TdtyIh2Jo77zlBE2+ptJvGYZiwDsOI06Xt3DuBHqM1Q
# MIPbTbDxR2d4GKhizCl8jvNU9+N1Vby96wfJqZXaqefNydWCrJLM1z1ZWkAI

...
class SqlManagedInstancesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of either SqlManagedInstanceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure_arc_data_management_client.models.SqlManagedInstanceListResult]
    ...
    def get(
        ...
        **kwargs,  # type: Any
        ...
        :rtype: ~azure_arc_data_management_client.models.SqlManagedInstance
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs,  # type: Any
        ...
        :type sql_managed_instance: ~azure_arc_data_management_client.models.SqlManagedInstance
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either SqlManagedInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure_arc_data_management_client.models.SqlManagedInstance]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def update(
        ...
        **kwargs,  # type: Any
        ...
        :type parameters: ~azure_arc_data_management_client.models.SqlManagedInstanceUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SqlManagedInstance, or the result of cls(response)
        :rtype: ~azure_arc_data_management_client.models.SqlManagedInstance
        :raises: ~azure.core.exceptions.HttpResponseError

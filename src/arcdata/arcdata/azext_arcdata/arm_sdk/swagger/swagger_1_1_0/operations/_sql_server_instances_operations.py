...
class SqlServerInstancesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of either SqlServerInstanceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure_arc_data_management_client.models.SqlServerInstanceListResult]
    ...
    def begin_create(
        ...
        **kwargs,  # type: Any
        ...
        :return: An instance of LROPoller that returns either SqlServerInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure_arc_data_management_client.models.SqlServerInstance]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

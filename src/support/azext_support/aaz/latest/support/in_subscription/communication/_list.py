...
class List(AAZCommand):
    ...
    :example: List web communication created on or after a specific date for a subscription support ticket.
        az support in-subscription communication list --support-ticket-name "TestTicketName" --filter "CreatedDate ge 2024-01-01"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CommunicationsList(ctx=self.ctx)()
    ...
    class CommunicationsList(AAZHttpOperation):

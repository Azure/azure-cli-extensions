...
@register_command(
    "support no-subscription chat-transcript list",
)
class List(AAZCommand):
    """List all chat transcripts for a support ticket

    :example: List all chat transcripts for a support ticket
        az support no-subscription chat-transcript list --support-ticket-name "TestTicketName"
    """
    ...
    class SupportTicketChatTranscriptsNoSubscriptionList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            messages = cls._schema_on_200.value.Element.properties.messages

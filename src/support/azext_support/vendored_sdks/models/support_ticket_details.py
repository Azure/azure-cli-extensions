...
class SupportTicketDetails(Model):
    ...
    def __init__(self, description, problem_classification_id, severity, contact_details, title, service_id, support_ticket_id=None, require24_x7_response=None, service_level_agreement=None, support_engineer=None, problem_start_time=None, technical_ticket_details=None, quota_ticket_details=None):
        super(SupportTicketDetails, self).__init__()
        self.id = None
        self.name = None
        self.type = None

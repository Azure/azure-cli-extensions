...
class ServicesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.support.models.ServicePaged[~azure.mgmt.support.models.Service]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServicePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.support.models.Service or

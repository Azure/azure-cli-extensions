...
class FidalgoCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_fidalgo.generated._client_factory import cf_fidalgo_cl
        fidalgo_custom = CliCommandType(
            operations_tmpl='azext_fidalgo.custom#{}',
            client_factory=cf_fidalgo_cl)
        parent = super(FidalgoCommandsLoader, self)
        parent.__init__(cli_ctx=cli_ctx, custom_command_type=fidalgo_custom)

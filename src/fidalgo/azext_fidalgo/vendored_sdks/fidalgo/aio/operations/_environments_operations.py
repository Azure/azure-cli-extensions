...
class EnvironmentsOperations:
    ...
    def list_by_project(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~fidalgo.models.EnvironmentListResult]
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~fidalgo.models.Environment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _deploy_initial(
        ...
        project_name: str,
        environment_name: str,
        deployment: Optional["models.EnvironmentDeploy"] = None,
        **kwargs
    ) -> None:
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        error_map = {

...
from ...operations._environments_operations import build_create_or_update_request_initial, build_delete_request_initial, build_deploy_request_initial, build_get_request, build_list_by_project_request, build_update_request_initial
T = TypeVar('T')
...
class EnvironmentsOperations:
    ...
    def list_by_project(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EnvironmentListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.Fidalgo.models.EnvironmentListResult]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Environment or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.Fidalgo.models.Environment]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01-privatepreview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    @distributed_trace_async
    async def begin_deploy(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        project_name: str,
        environment_name: str,

...
class ImageVersionsOperations:
    ...
    def list_by_image(
        ...
        image_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ImageVersionListResult"]:
        ...
        :return: An iterator like instance of either ImageVersionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.Fidalgo.models.ImageVersionListResult]
    ...
    list_by_image.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fidalgo/devcenters/{devCenterName}/galleries/{galleryName}/images/{imageName}/versions"}  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.Fidalgo.models.ImageVersion
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fidalgo/devcenters/{devCenterName}/galleries/{galleryName}/images/{imageName}/versions/{versionName}"}  # type: ignore

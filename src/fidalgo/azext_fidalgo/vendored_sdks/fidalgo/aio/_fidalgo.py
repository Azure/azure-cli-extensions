...
class Fidalgo(object):
    ...
    :vartype attached_networks: fidalgo.aio.operations.AttachedNetworksOperations
    ...
    :vartype galleries: fidalgo.aio.operations.GalleriesOperations
    :ivar images: ImagesOperations operations
    :vartype images: fidalgo.aio.operations.ImagesOperations
    :ivar image_versions: ImageVersionsOperations operations
    :vartype image_versions: fidalgo.aio.operations.ImageVersionsOperations
    ...
    :vartype dev_box_definitions: fidalgo.aio.operations.DevBoxDefinitionsOperations

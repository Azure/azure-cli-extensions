...
class AttachedNetworkConnection(Resource):
    ...
    def __init__(
        self,
        *,
        network_connection_resource_id: Optional[str] = None,
        **kwargs
    ):
...
class DevBoxDefinitionProperties(DevBoxDefinitionUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DevBoxDefinitionProperties, self).__init__(image_reference=image_reference, sku=sku, **kwargs)
        self.provisioning_state = None
        self.image_validation_status = None
        self.image_validation_error_details = None
        self.active_image_reference = None
...
class PoolProperties(PoolUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PoolProperties, self).__init__(sku=sku, machine_definition_id=machine_definition_id, dev_box_definition_name=dev_box_definition_name, network_settings_id=network_settings_id, network_connection_name=network_connection_name, **kwargs)
        self.provisioning_state = None

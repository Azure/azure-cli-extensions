...
def build_list_by_project_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fidalgo/projects/{projectName}/environmentTypes")  # pylint: disable=line-too-long
...
def build_list_by_dev_center_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fidalgo/devcenters/{devCenterName}/environmentTypes")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fidalgo/devcenters/{devCenterName}/environmentTypes/{environmentTypeName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "devCenterName": _SERIALIZER.url("dev_center_name", dev_center_name, 'str'),
...
class EnvironmentTypesOperations(object):
    ...
    def list_by_project(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either EnvironmentTypeListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.Fidalgo.models.EnvironmentTypeListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.Fidalgo.models.EnvironmentType
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        dev_center_name,  # type: str
        environment_type_name,  # type: str
        body,  # type: "_models.EnvironmentType"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.EnvironmentType"
        ...
        :type body: ~azure.mgmt.Fidalgo.models.EnvironmentType
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EnvironmentType, or the result of cls(response)
        :rtype: ~azure.mgmt.Fidalgo.models.EnvironmentType
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        dev_center_name,  # type: str
        environment_type_name,  # type: str
        body,  # type: "_models.EnvironmentTypeUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.EnvironmentType"
        ...
        :type body: ~azure.mgmt.Fidalgo.models.EnvironmentTypeUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EnvironmentType, or the result of cls(response)
        :rtype: ~azure.mgmt.Fidalgo.models.EnvironmentType
        :raises: ~azure.core.exceptions.HttpResponseError

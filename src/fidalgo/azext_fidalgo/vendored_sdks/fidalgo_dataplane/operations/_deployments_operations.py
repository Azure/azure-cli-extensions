...
def build_list_by_environment_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/projects/{projectName}/environments/{environmentName}/deployments')
    ...
    def list_by_environment(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either DeploymentHistoryResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.fidalgo.models.DeploymentHistoryResult]

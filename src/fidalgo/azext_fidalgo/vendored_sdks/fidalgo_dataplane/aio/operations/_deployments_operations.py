...
class DeploymentsOperations:
    ...
    def list_by_environment(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeploymentHistoryResult or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.fidalgo.models.DeploymentHistoryResult]
    ...
    list_by_environment.metadata = {'url': '/projects/{projectName}/environments/{environmentName}/deployments'}  # type: ignore

...
def create_apim_tag(cmd, client,
                    ...
                    tag_id,
                    display_name):
    return client.create_or_update(resource_group_name=resource_group, service_name=service_name, tag_id=tag_id, display_name=display_name)
...
def create_apim_certificate(cmd, client,
                            ...
                            data,
                            password):
    return client.create_or_update(resource_group_name=resource_group, service_name=service_name, certificate_id=certificate_id, data=data, password=password)
...
def create_apim_policy(cmd, client,
                       ...
                       value,
                       _format=None):
    return client.create_or_update(resource_group_name=resource_group, service_name=service_name, policy_id=policy_id, value=value, format=_format)
...
def create_apim_product_policy(cmd, client,
                               ...
                               value,
                               _format=None):
    return client.create_or_update(resource_group_name=resource_group, service_name=service_name, product_id=product_id, policy_id=policy_id, value=value, _format=format)

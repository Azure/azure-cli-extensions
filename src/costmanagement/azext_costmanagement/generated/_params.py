...
from azext_costmanagement.action import (
    ...
    AddPivots,
    AddQueryTimePeriod,
    AddViewsDatasetConfiguration,
    AddViewsDatasetGrouping,
    AddDatasetSorting,
    AddDefinition,
    AddTimePeriod,
    AddForecastDatasetConfiguration,
    AddQueryDatasetGrouping,
...
def load_arguments(self, _):
    ...
    with self.argument_context('costmanagement view create') as c:
        ...
        c.argument('query_time_period', action=AddQueryTimePeriod, nargs='*', help='Has time period for pulling data '
                   'for the report.')
        c.argument('dataset_granularity', arg_type=get_enum_type(['Daily', 'Monthly']), help='The granularity of rows '
                   'in the report.')
        c.argument('dataset_configuration', action=AddViewsDatasetConfiguration, nargs='*', help='Has configuration '
                   'information for the data in the report. The configuration will be ignored if aggregation and '
        ...
        c.argument('dataset_aggregation', type=validate_file_or_dict, help='Dictionary of aggregation expression to '
                   'use in the report. The key of each item in the dictionary is the alias for the aggregated column. '
                   'Report can have up to 2 aggregation clauses. Expected value: json-string/@json-file.')
        c.argument('dataset_grouping', action=AddViewsDatasetGrouping, nargs='*', help='Array of group by expression '
                   'to use in the report. Report can have up to 2 group by clauses.')
        c.argument('dataset_sorting', action=AddDatasetSorting, nargs='*', help='Array of order by expression to use '
                   'in the report.')
        c.argument('dataset_filter', type=validate_file_or_dict, help='Has filter expression to use in the report. '
    ...
    with self.argument_context('costmanagement forecast external-cloud-provider-usage') as c:
        ...
        c.argument('dataset_configuration', action=AddForecastDatasetConfiguration, nargs='*', help='Has configuration '
    ...
    with self.argument_context('costmanagement query usage') as c:
        ...
        c.argument('dataset_grouping', action=AddQueryDatasetGrouping, nargs='*', help='Array of group by expression '
                   'to use in the query. Query can have up to 2 group by clauses.')

...
def load_arguments(self, _):
    ...
    with self.argument_context('costmanagement alert dismiss') as c:
        c.argument('scope', help='The scope associated with alerts operations. This includes \'/subscriptions/{subscrip'
                   ...
                   'rs.')
        c.argument('alert_id', help='Alert ID')
        c.argument('definition', action=AddDefinition, nargs='+', help='defines the type of alert Expect value: KEY1=VA'
                   'LUE1 KEY2=VALUE2 ... , available KEYs are: type, category, criteria.')
        ...
        c.argument('details_contact_emails', nargs='+', help='list of emails to contact Expected value: json-string/@js'
                   'on-file.')
        c.argument('details_contact_groups', nargs='+', help='list of action groups to broadcast to Expected value: jso'
                   'n-string/@json-file.')
        c.argument('details_contact_roles', nargs='+', help='list of contact roles Expected value: json-string/@json-fi'
                   'le.')

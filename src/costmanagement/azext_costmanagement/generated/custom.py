...
def costmanagement_alert_dismiss(cmd, client,
    ...
    if isinstance(details_resource_group_filter, str):
        details_resource_group_filter = json.loads(details_resource_group_filter)
    if isinstance(details_resource_filter, str):
        details_resource_filter = json.loads(details_resource_filter)
    if isinstance(details_meter_filter, str):

...
def load_command_table(self, _):
    ...
    #     '_dimension_operations#DimensionOperations.{}',
    ...
    #     operations_tmpl='azext_costmanagement.vendored_sdks.costmanagement.operations.'
    #     '_alert_operations#AlertOperations.{}',
    ...
    #     operations_tmpl='azext_costmanagement.vendored_sdks.costmanagement.operations.'
    #     '_forecast_operations#ForecastOperations.{}',
    ...
    #     g.custom_command('usage-by-external-cloud-provider-type',
    #                      'costmanagement_query_usage_by_external_cloud_provider_type')

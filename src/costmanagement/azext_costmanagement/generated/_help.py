    ...
    parameters:
      - name: --definition-time-period
        ...
        long-summary: |
            ...
            from: Required. The start date to pull data from.
            to: Required. The end date to pull data to.
      - name: --definition-dataset-configuration
        short-summary: Has configuration information for the data in the export. The configuration will be ignored if a\
ggregation and grouping are provided.
        long-summary: |
            Usage: --definition-dataset-configuration columns=XX

            columns: Array of column names to be included in the query. Any valid query column name is allowed. If not \
provided, then query includes all columns.
      - name: --definition-dataset-grouping
        short-summary: Array of group by expression to use in the query. Query can have up to 2 group by clauses.
        long-summary: |
            Usage: --definition-dataset-grouping type=XX name=XX
...
date must be greater than start date.
    ...
    examples:
      - name: BillingAccountCreateOrUpdateExport
        text: |-
               az costmanagement export create --name "TestExport" --definition-type "Usage" --definition-dataset-aggre\
gation "{\\"costSum\\":{\\"name\\":\\"PreTaxCost\\",\\"function\\":\\"Sum\\"}}" --definition-dataset-configuration colu\
mns="Date" columns="MeterId" columns="InstanceId" columns="ResourceLocation" columns="PreTaxCost" --definition-dataset-\
filter "{\\"and\\":[{\\"or\\":[{\\"dimension\\":{\\"name\\":\\"ResourceLocation\\",\\"operator\\":\\"In\\",\\"values\\"\
:[\\"East US\\",\\"West Europe\\"]}},{\\"tag\\":{\\"name\\":\\"Environment\\",\\"operator\\":\\"In\\",\\"values\\":[\\"\
UAT\\",\\"Prod\\"]}}]},{\\"dimension\\":{\\"name\\":\\"ResourceGroup\\",\\"operator\\":\\"In\\",\\"values\\":[\\"API\\"\
]}}]}" --definition-dataset-grouping name="SubscriptionName" type="Dimension" --definition-dataset-grouping name="Envir\
onment" type="Tag" --definition-timeframe "MonthToDate" --delivery-info-destination container="exports" resource-id="/s\
ubscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MYDEVTESTRG/providers/Microsoft.Storage/storageAccount\
s/ccmeastusdiag182" root-folder-path="ad-hoc" --schedule-recurrence "Weekly" --schedule-recurrence-period from="2018-06\
-01T00:00:00Z" to="2018-10-31T00:00:00Z" --schedule-status "Active" --scope "providers/Microsoft.Billing/billingAccount\
s/123456"
...
ubscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MYDEVTESTRG/providers/Microsoft.Storage/storageAccount\
s/ccmeastusdiag182" root-folder-path="ad-hoc" --schedule-recurrence "Weekly" --schedule-recurrence-period from="2018-06\
-01T00:00:00Z" to="2018-10-31T00:00:00Z" --schedule-status "Active" --scope "providers/Microsoft.Management/managementG\
roups/TestMG"
...
ubscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MYDEVTESTRG/providers/Microsoft.Storage/storageAccount\
s/ccmeastusdiag182" root-folder-path="ad-hoc" --schedule-recurrence "Weekly" --schedule-recurrence-period from="2018-06\
-01T00:00:00Z" to="2018-10-31T00:00:00Z" --schedule-status "Active" --scope "subscriptions/00000000-0000-0000-0000-0000\
...
date must be greater than start date.
    ...
    examples:
      - name: BillingAccountCreateOrUpdateExport
        text: |-
               az costmanagement export update --name "TestExport" --definition-type "Usage" --definition-dataset-aggre\
gation "{\\"costSum\\":{\\"name\\":\\"PreTaxCost\\",\\"function\\":\\"Sum\\"}}" --definition-dataset-configuration colu\
mns="Date" columns="MeterId" columns="InstanceId" columns="ResourceLocation" columns="PreTaxCost" --definition-dataset-\
filter "{\\"and\\":[{\\"or\\":[{\\"dimension\\":{\\"name\\":\\"ResourceLocation\\",\\"operator\\":\\"In\\",\\"values\\"\
:[\\"East US\\",\\"West Europe\\"]}},{\\"tag\\":{\\"name\\":\\"Environment\\",\\"operator\\":\\"In\\",\\"values\\":[\\"\

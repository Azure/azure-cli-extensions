...
not provided, then report includes all columns.
      ...
      - name: --dataset-sorting
        short-summary: "Array of order by expression to use in the report."
        long-summary: |
            Usage: --dataset-sorting direction=XX name=XX

            direction: Direction of sort.
            name: Required. The name of the column to sort.

            Multiple actions can be specified by using more than one --dataset-sorting argument.
      - name: --kpis
        short-summary: "List of KPIs to show in Cost Analysis UI."
        long-summary: |
            Usage: --kpis type=XX id=XX enabled=XX
...
all available columns. The available columns can vary by customer channel (see examples).
    ...
    examples:
      - name: ExportCreateOrUpdateByBillingAccount
        text: |-
               az costmanagement export create --name "TestExport" --scope "providers/Microsoft.Billing/billingAccounts\
/123456"
...
/100/enrollmentAccounts/456"
      - name: ExportCreateOrUpdateByManagementGroup
        text: |-
               az costmanagement export create --name "TestExport" --scope "providers/Microsoft.Management/managementGr\
oups/TestMG"
      - name: ExportCreateOrUpdateByResourceGroup
        text: |-
               az costmanagement export create --name "TestExport" --scope "subscriptions/00000000-0000-0000-0000-00000\

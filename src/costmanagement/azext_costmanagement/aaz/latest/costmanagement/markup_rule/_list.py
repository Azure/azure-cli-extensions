...
@register_command(
    "costmanagement markup-rule list",
)
class List(AAZCommand):
    """List all the active markup rules for the partner billing account/billing profile calling the API.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MarkupRulesList(ctx=self.ctx)()
    ...
    class MarkupRulesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            customer_details = cls._schema_on_200.value.Element.properties.customer_details

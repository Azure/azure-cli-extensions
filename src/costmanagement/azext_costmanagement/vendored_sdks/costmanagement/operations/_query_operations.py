...
class QueryOperations(object):
    ...
    def usage(
        ...
        grouping=None,  # type: Optional[List["models.QueryGrouping"]]
        ...
        **kwargs  # type: Any
        ...
        parameters = models.QueryDefinition(type=type, timeframe=timeframe, time_period=time_period, granularity=granularity, configuration=configuration, aggregation=aggregation, grouping=grouping, filter=filter)

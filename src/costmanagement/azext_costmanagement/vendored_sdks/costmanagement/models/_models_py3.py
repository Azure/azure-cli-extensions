...
class ExportProperties(CommonExportProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ExportProperties, self).__init__(format=format, run_history=run_history, type=type, timeframe=timeframe, time_period=time_period, granularity=granularity, configuration=configuration, destination=destination, **kwargs)
        self.status = status
        self.recurrence = recurrence
        self.recurrence_period = recurrence_period

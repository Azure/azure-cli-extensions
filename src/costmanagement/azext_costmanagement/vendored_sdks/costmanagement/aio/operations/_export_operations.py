...
class ExportOperations:
    ...
    async def create_or_update(
        ...
        format: Optional[Union[str, "models.FormatType"]] = None,
        run_history: Optional["models.ExportExecutionListResult"] = None,
        ...
        time_period: Optional["models.ExportTimePeriod"] = None,
        granularity: Optional[Union[str, "models.GranularityType"]] = None,
        configuration: Optional["models.ExportDatasetConfiguration"] = None,
        ...
        **kwargs
        ...
        parameters = models.Export(e_tag=e_tag, format=format, run_history=run_history, status=status, recurrence=recurrence, recurrence_period=recurrence_period, type_definition_type=type, timeframe=timeframe, time_period=time_period, granularity=granularity, configuration=configuration, destination=destination)
        api_version = "2020-06-01"

...
@register_command(
    "discovery workspace private-endpoint-connection create",
)
class Create(AAZCommand):
    """Create the specified private endpoint connection.

    :example: Approve a workspace private endpoint connection.
    ...
    class WorkspacePrivateEndpointConnectionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            private_endpoint = cls._schema_on_200_201.properties.private_endpoint
            private_endpoint.id = AAZStrType(
                flags={"read_only": True},
            )

            private_link_service_connection_state = cls._schema_on_200_201.properties.private_link_service_connection_state

...
class LoadTestAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods,name-too-long
    ClientMixinABC[AsyncPipelineClient, LoadTestAdministrationClientConfiguration]
):
...
class LoadTestRunClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, LoadTestRunClientConfiguration]):

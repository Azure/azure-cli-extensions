...
@register_command(
    "network-analytics data-product list-roles-assignment",
)
class ListRolesAssignment(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DataProductsListRolesAssignments(ctx=self.ctx)()
...
class _ListRolesAssignmentHelper:
    """Helper class for ListRolesAssignment"""


__all__ = ["ListRolesAssignment"]

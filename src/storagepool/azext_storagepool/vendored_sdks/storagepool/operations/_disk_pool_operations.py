...
class DiskPoolOperations(object):
    """DiskPoolOperations operations.
    ...
    def _create_or_update_initial(
        ...
        availability_zones=None,  # type: Optional[List[str]]
        disks=None,  # type: Optional[List["models.Disk"]]
        ...
        **kwargs  # type: Any
        ...
        disk_pool_payload = models.DiskPool(tags=tags, location=location, sku=sku, availability_zones=availability_zones, disks=disks, subnet_id=subnet_id)
        api_version = "2020-03-15-preview"

...
class IscsiTargetOperations(object):
    """IscsiTargetOperations operations.
    ...
    def _create_or_update_initial(
        ...
        tpgs=None,  # type: Optional[List["models.TargetPortalGroup"]]
        target_iqn=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        iscsi_target_payload = models.IscsiTarget(tpgs=tpgs, target_iqn=target_iqn)
        api_version = "2020-03-15-preview"

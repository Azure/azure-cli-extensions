...
class ExtensionsOperations:
    ...
    def list_by_arc_setting(
        ...
        **kwargs
    ) -> AsyncIterable["models.ExtensionList"]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExtensionList"]
        error_map = {
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_arc_setting.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
                    'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
                    'arcSettingName': self._serialize.url("arc_setting_name", arc_setting_name, 'str'),
                }
    ...
    async def begin_create(
        ...
        extension: "models.Extension",
        **kwargs
    ) -> AsyncLROPoller["models.Extension"]:

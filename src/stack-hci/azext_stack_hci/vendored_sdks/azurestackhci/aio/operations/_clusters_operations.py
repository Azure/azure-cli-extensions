...
class ClustersOperations:
    ...
    async def _upload_certificate_initial(
        ...
        **kwargs
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(upload_certificate_request, 'UploadCertificateRequest')
        body_content_kwargs['content'] = body_content
    ...
    async def _create_identity_initial(
        ...
        cluster_name: str,
        **kwargs
    ) -> Optional["models.ClusterIdentityResponse"]:
        ...
        # Construct URL
        url = self._create_identity_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
    ...
    async def begin_create_identity(
        ...
        cluster_name: str,
        **kwargs
    ) -> AsyncLROPoller["models.ClusterIdentityResponse"]:
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either ClusterIdentityResponse or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.ClusterIdentityResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]

...
class ArcSettingsOperations:
    """ArcSettingsOperations async operations.
    ...
    def list_by_cluster(
        ...
        cluster_name: str,
        **kwargs
    ) -> AsyncIterable["models.ArcSettingList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhci.models.ArcSettingList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ArcSettingList"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ArcSetting"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def update(
        ...
        cluster_name: str,
        arc_setting_name: str,
        arc_setting: "models.ArcSettingsPatch",
        **kwargs
    ) -> "models.ArcSetting":
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(arc_setting, 'ArcSettingsPatch')
        body_content_kwargs['content'] = body_content
    ...
    async def generate_password(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PasswordCredential"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        # Construct URL
        url = self.generate_password.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
    ...
    async def _create_identity_initial(
        ...
        arc_setting_name: str,
        **kwargs
    ) -> Optional["models.ArcIdentityResponse"]:
    ...
    async def begin_create_identity(
        ...
        arc_setting_name: str,
        **kwargs
    ) -> AsyncLROPoller["models.ArcIdentityResponse"]:
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either ArcIdentityResponse or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.ArcIdentityResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]

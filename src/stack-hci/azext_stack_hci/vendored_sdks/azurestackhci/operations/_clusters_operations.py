...
class ClustersOperations(object):
    ...
    def update(
        ...
        resource_group_name,  # type: str
        cluster_name,  # type: str
        cluster,  # type: "models.ClusterPatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Cluster"
    ...
    def _upload_certificate_initial(
        ...
        resource_group_name,  # type: str
        cluster_name,  # type: str
        upload_certificate_request,  # type: "models.UploadCertificateRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def _create_identity_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.ClusterIdentityResponse"]
    ...
    def begin_create_identity(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ClusterIdentityResponse"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either ClusterIdentityResponse or the result of cls(response)

...
class ClusterOperations(object):
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.AzureStackHCI/clusters'}  # type: ignore
    ...
    def create(
        ...
        aad_client_id=None,  # type: Optional[str]
        aad_tenant_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Cluster"
        ...
        _cluster = models.Cluster(tags=tags, location=location, aad_client_id=aad_client_id, aad_tenant_id=aad_tenant_id)
        api_version = "2020-03-01-preview"
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _cluster = models.ClusterUpdate(tags=tags)
        api_version = "2020-03-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_cluster, 'ClusterUpdate')
        body_content_kwargs['content'] = body_content

...
class ArcSetting(Resource):
    ...
    :type created_by_type: str or ~azure.mgmt.azurestackhci.models.CreatedByType
    ...
    :type last_modified_by_type: str or ~azure.mgmt.azurestackhci.models.CreatedByType
    ...
    def __init__(
        ...
        *,
        ...
        arc_service_principal_object_id: Optional[str] = None,
        arc_application_object_id: Optional[str] = None,
        connectivity_properties: Optional[object] = None,
...
class ClusterDesiredProperties(msrest.serialization.Model):
    ...
    :param windows_server_subscription: Desired state of Windows Server Subscription. Possible
     values include: "Disabled", "Enabled".
    :type windows_server_subscription: str or
     ~azure.mgmt.azurestackhci.models.WindowsServerSubscription
    :param diagnostic_level: Desired level of diagnostic data emitted by the cluster. Possible
     values include: "Off", "Basic", "Enhanced".
    :type diagnostic_level: str or ~azure.mgmt.azurestackhci.models.DiagnosticLevel
    """
...
class ClusterReportedProperties(msrest.serialization.Model):
    ...
    :param diagnostic_level: Level of diagnostic data emitted by the cluster. Possible values

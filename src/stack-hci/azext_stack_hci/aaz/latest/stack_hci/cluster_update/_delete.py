...
@register_command(
    "stack-hci cluster-update delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete specified Update

    :example: Delete cluster update
        az stack-hci cluster-update delete -g rg --cluster-name name -n updates-name
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.UpdatesDelete(ctx=self.ctx)()
    ...
    class UpdatesDelete(AAZHttpOperation):

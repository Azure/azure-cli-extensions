...
@register_command(
    "stack-hci cluster-update summary update",
)
class Update(AAZCommand):
    ...
    class UpdateSummariesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_update_summaries_read(cls._schema_on_200)
...
class _UpdateHelper:
    ...
    _schema_update_summaries_read = None

    @classmethod
    def _build_schema_update_summaries_read(cls, _schema):
        if cls._schema_update_summaries_read is not None:
            _schema.id = cls._schema_update_summaries_read.id
            _schema.location = cls._schema_update_summaries_read.location
            _schema.name = cls._schema_update_summaries_read.name
            _schema.properties = cls._schema_update_summaries_read.properties
            _schema.system_data = cls._schema_update_summaries_read.system_data
            _schema.type = cls._schema_update_summaries_read.type
            return

        cls._schema_update_summaries_read = _schema_update_summaries_read = AAZObjectType()

        update_summaries_read = _schema_update_summaries_read
        update_summaries_read.id = AAZStrType(
            flags={"read_only": True},
        )
        update_summaries_read.location = AAZStrType()
        update_summaries_read.name = AAZStrType(
            flags={"read_only": True},
        )
        update_summaries_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        update_summaries_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        update_summaries_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_update_summaries_read.properties
        ...
        health_check_result = _schema_update_summaries_read.properties.health_check_result
        health_check_result.Element = AAZObjectType()

        _element = _schema_update_summaries_read.properties.health_check_result.Element
        ...
        tags = _schema_update_summaries_read.properties.health_check_result.Element.tags
        tags.key = AAZStrType()
        tags.value = AAZStrType()

        package_versions = _schema_update_summaries_read.properties.package_versions
        package_versions.Element = AAZObjectType()

        _element = _schema_update_summaries_read.properties.package_versions.Element
        ...
        system_data = _schema_update_summaries_read.system_data

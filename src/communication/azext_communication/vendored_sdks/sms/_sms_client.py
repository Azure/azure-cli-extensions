...
from azext_communication.vendored_sdks.sms._generated.models import (
    SendMessageRequest,
    SmsRecipient,
    SmsSendOptions,
)
from azext_communication.vendored_sdks.sms._models import SmsSendResult
...
class SmsClient(object):
    ...
    """
    def __init__(
            self, endpoint_, # type: str
            credential, # type: TokenCredential
            **kwargs # type: Any
        ):
        # type: (...) -> None
        endpoint = str(endpoint_)
        try:

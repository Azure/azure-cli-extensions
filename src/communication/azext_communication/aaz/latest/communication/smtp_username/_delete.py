...
@register_command(
    "communication smtp-username delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete to delete a single SmtpUsername resource.

    :example: Delete a SmtpUsername resource.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SmtpUsernamesDelete(ctx=self.ctx)()
    ...
    class SmtpUsernamesDelete(AAZHttpOperation):

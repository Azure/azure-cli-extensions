...
@register_command(
    "communication smtp-username list",
)
class List(AAZCommand):
    """List all SmtpUsernameResources for a Communication resource.

    :example: Get all SmtpUsername resources for a CommunicationService resource.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SmtpUsernamesList(ctx=self.ctx)()
    ...
    class SmtpUsernamesList(AAZHttpOperation):

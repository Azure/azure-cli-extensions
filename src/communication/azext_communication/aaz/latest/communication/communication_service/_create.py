...
@register_command(
    "communication communication-service create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.communication_service_name = AAZStrArg(
            options=["-n", "--name", "--communication-service-name"],
        ...
        _args_schema = cls._args_schema
        _args_schema.assign_identity = AAZObjectArg(
        ...
        assign_identity = cls._args_schema.assign_identity
        assign_identity.type = AAZStrArg(
            options=["type"],
            help="Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).",
            required=True,
            enum={"None": "None", "SystemAssigned": "SystemAssigned", "SystemAssigned,UserAssigned": "SystemAssigned,UserAssigned", "UserAssigned": "UserAssigned"},
        )
        assign_identity.user_assigned_identities = AAZDictArg(
            options=["user-assigned-identities"],
            help="The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.",
        )

        user_assigned_identities = cls._args_schema.assign_identity.user_assigned_identities
    ...
    class CommunicationServicesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("identity", AAZObjectType, ".assign_identity")

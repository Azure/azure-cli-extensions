...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.CommunicationServicesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.CommunicationServicesListBySubscription(ctx=self.ctx)()
    ...
    class CommunicationServicesListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            linked_domains = cls._schema_on_200.value.Element.properties.linked_domains
    ...
    class CommunicationServicesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

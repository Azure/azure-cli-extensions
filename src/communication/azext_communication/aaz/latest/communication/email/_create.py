...
class Create(AAZCommand):
    """Create a new EmailCommunicationService or update an existing EmailCommunicationService.

    :example: Create a email communication resource with tags
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.data_location = AAZStrArg(
            ...
            help="The location where the emailcommunication service stores its data at rest.",
        )

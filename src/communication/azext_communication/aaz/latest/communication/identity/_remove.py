...
class Remove(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.communication_service_name = AAZStrArg(
            options=["-n", "--communication-service-name"],
    ...
    class CommunicationServicesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_communication_service_resource_read(cls._schema_on_200)
    ...
    class CommunicationServicesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_communication_service_resource_read(cls._schema_on_200_201)

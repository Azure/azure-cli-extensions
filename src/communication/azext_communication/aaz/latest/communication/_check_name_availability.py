...
@register_command(
    "communication check-name-availability",
)
class CheckNameAvailability(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CommunicationServicesCheckNameAvailability(ctx=self.ctx)()
    ...
    class CommunicationServicesCheckNameAvailability(AAZHttpOperation):

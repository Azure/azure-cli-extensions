...
@register_command(
    "communication email senderusername show",
)
class SenderUsernameShow(AAZCommand):
    """Get the SenderUsername and its properties.

    :example: Get a sender username's properties
        az communication email senderusername show -n ResourceName -g ResourceGroup --domain-name DomainName --sender-username SenderUsername 
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EmailCommunicationServicesGetSenderUsernameProperties(ctx=self.ctx)()
    ...
    class EmailCommunicationServicesGetSenderUsernameProperties(AAZHttpOperation):
...
class _SenderUsernameShowHelper:
    """Helper class for Show"""


__all__ = ["SenderUsernameShow"]
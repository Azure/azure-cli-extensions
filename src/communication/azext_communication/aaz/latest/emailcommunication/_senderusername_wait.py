...
@register_command(
    "communication email senderusername wait",
)
class SenderUsernameWait(AAZWaitCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.sender_username = AAZStrArg(
            ...
            help="Name of the sender user name.",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EmailCommunicationServicesWaitSenderusername(ctx=self.ctx)()
    ...
    class EmailCommunicationServicesWaitSenderusername(AAZHttpOperation):
...
class _SenderUsernameWaitHelper:
    """Helper class for WaitSenderUsername"""

__all__ = ["SenderUsernameWait"]

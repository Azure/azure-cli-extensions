...
def _load_email_arguments(self):
    with self.argument_context('communication email send') as c:
        ...
        c.argument('waitUntil', options_list=['--wait-until'], arg_type=get_enum_type(['started', 'completed', '1', '0']), help='Indicates whether to wait until the server operation is started or completed. Accepted values are: started, completed, 1, 0.')   

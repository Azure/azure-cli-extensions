...
class List(AAZCommand):
    ...
    class ListJobDocuments(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_deidentification_document_location_read(_element.input)
            _element.output = AAZObjectType()
            _ListHelper._build_schema_deidentification_document_location_read(_element.output)
...
class _ListHelper:
    ...
    _schema_deidentification_document_location_read = None

    @classmethod
    def _build_schema_deidentification_document_location_read(cls, _schema):
        if cls._schema_deidentification_document_location_read is not None:
            _schema.etag = cls._schema_deidentification_document_location_read.etag
            _schema.location = cls._schema_deidentification_document_location_read.location
            return

        cls._schema_deidentification_document_location_read = _schema_deidentification_document_location_read = AAZObjectType()

        deidentification_document_location_read = _schema_deidentification_document_location_read
        deidentification_document_location_read.etag = AAZStrType(
            flags={"read_only": True},
        )
        deidentification_document_location_read.location = AAZStrType(
            flags={"required": True},
        )

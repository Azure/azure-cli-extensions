...
@register_command(
    "service-networking traffic-controller frontend list",
    is_preview=True,
)
class List(AAZCommand):
    """List All Frontend resources by TrafficController

    :example: List all Frontends for Traffic Controller
        az service-networking traffic-controller frontend list -g testRG --traffic-controller-name testTC
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FrontendsInterfaceListByTrafficController(ctx=self.ctx)()
    ...
    class FrontendsInterfaceListByTrafficController(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            public_ip_address = cls._schema_on_200.value.Element.properties.public_ip_address

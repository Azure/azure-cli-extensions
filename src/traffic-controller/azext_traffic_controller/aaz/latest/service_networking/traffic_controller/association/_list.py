...
@register_command(
    "service-networking traffic-controller association list",
    is_preview=True,
)
class List(AAZCommand):
    """List all Association resources by Traffic Controller

    :example: List associations for a traffic controller
        az service-networking traffic-controller association list -g testRG --traffic-controller-name testTC
    """

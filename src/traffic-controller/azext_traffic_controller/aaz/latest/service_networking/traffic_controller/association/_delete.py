...
@register_command(
    "service-networking traffic-controller association delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete a Traffic Controller Association
        az service-networking traffic-controller association create -g testRG -n testAssociation --traffic-controller-name testTC
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AssociationsInterfaceDelete(ctx=self.ctx)()
    ...
    class AssociationsInterfaceDelete(AAZHttpOperation):

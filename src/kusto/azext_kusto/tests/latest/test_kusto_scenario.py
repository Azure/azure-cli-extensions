...
from .example_steps import step_data_connection_show2
...
from .example_steps import step_data_connection_event2
...
def call_scenario(test):
    ...
    step_cluster_create(test, checks=[
        ...
        test.check("publicIPType", "DualStack", case_sensitive=False),
    ...
    ##               "/Clusters/{myCluster2}", case_sensitive=False),
    ...
    ##    test.check("tableLevelSharingProperties.tablesToInclude[0]", "Table1", case_sensitive=False),
    ##])
    ##step_data_connection_show2(test, checks=[
    ##    test.check("location", "westus", case_sensitive=False),
    ...
    ##step_data_connection_event2(test, checks=[])
    ...
    ##    test.check("name", "{myCluster2}", case_sensitive=False),
    ##    test.check("identity.type", "SystemAssigned", case_sensitive=False),
    ##    test.check("location", "westus", case_sensitive=False),
    ##    test.check("enableAutoStop", True),
    ##    test.check("enablePurge", True),
    ...
    ##    test.check("publicIPType", "IPv4", case_sensitive=False),
...
class KustoScenarioTest(ScenarioTest):
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs.update({
            'subscription_id': 'e8257c73-24c5-4791-94dc-8b7901c90dbf' ##self.get_subscription_id()
        })

        self.kwargs.update({
            'myCluster4': 'default',
            'myAttachedDatabaseConfiguration2': 'default',
            'myCluster2': 'kustoCluster2',
            'myCluster': 'kustoCluster',
            'myCluster3': 'kustoclusterrptest4',
            'myAttachedDatabaseConfiguration': 'attachedDatabaseConfigurationsTest',
            'myManagedPrivateEndpoint': 'managedPrivateEndpointTest',
            'myScript': 'kustoScript',
            'myPrivateEndpointConnection': 'privateEndpointTest',
    ...
    @StorageAccountPreparer(name_prefix='clitestkusto_teststorageaccount'[:7], key='sa_2',
                            resource_group_parameter_name='rg')

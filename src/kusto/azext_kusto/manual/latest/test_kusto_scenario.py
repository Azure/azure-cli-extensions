...
def call_scenario(test):
    ...
    step_cluster_create(test, checks=[
        ...
        test.check("allowedIpRangeList[0]", "0.0.0.0/0", case_sensitive=False),
    ...
    step_attached_database_configuration_create(test, checks=[
        ...
        test.check("clusterResourceId", "/subscriptions/{subscription_id}/resourceGroups/{rg}/providers/Microsoft.Kusto"
                   "/Clusters/{myCluster4}", case_sensitive=False),
    ...
    step_data_connection_event(test, checks=[])
...
class KustoScenarioTest(ScenarioTest):
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs.update({
            ...
            'myCluster2': 'leader4',
            'myCluster4': 'KustoClusterLeader',
            'myCluster': 'kustoclusterrptest4',
            'myCluster3': 'kustoclusterrptest',
            ...
            'myManagedPrivateEndpoint': 'kustoManagedPrivateEndpoint1',
            'myScript': 'kustoScript1',
            'myPrivateEndpointConnection': 'privateEndpointConnectionName',
            'myPrivateLinkResource': 'cluster',
    ...
    @StorageAccountPreparer(name_prefix='clitestkusto_storageAccountTest'[:7], key='sa',

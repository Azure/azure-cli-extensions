...
def call_scenario(test):
    ...
    step_attached_database_configuration_show(
        test,
        checks=[
            test.check("location", "West US 2", case_sensitive=False),
            test.check(
            ...
            test.check(
                "tableLevelSharingProperties.externalTablesToExclude[0]",
                "ExternalTable2",
                case_sensitive=False,
            ),
            test.check(
                "tableLevelSharingProperties.externalTablesToInclude[0]",
                "ExternalTable1",
                case_sensitive=False,
            ),
            test.check(
                "tableLevelSharingProperties.materializedViewsToExclude[0]",
                "MaterializedViewTable2",
                case_sensitive=False,
            ),
            test.check(
                "tableLevelSharingProperties.materializedViewsToInclude[0]",
                "MaterializedViewTable1",
                case_sensitive=False,
            ),
            test.check(
                "tableLevelSharingProperties.tablesToExclude[0]",
                "Table2",
                case_sensitive=False,
            ),
            test.check(
                "tableLevelSharingProperties.tablesToInclude[0]",
                "Table1",
                case_sensitive=False,
            ),
        ],
    )
    step_data_connection_show(
        test,
        checks=[
            test.check("location", "West US 2", case_sensitive=False),
            test.check(
                "eventHubResourceId",
                "/subscriptions/{subscription_id}/resourceGroups/testrg/providers/"
                "Microsoft.EventHub/namespaces/testcli/eventhubs/eventhubTest1",
                case_sensitive=False,
            ),
        ],
    )
    ...
    step_script_list(test, checks=[test.check("length(@)", 1)])
    ...
    step_private_link_resource_list(test, checks=[test.check("length(@)", 1)])
...
class KustoScenarioTest(ScenarioTest):
    ...
    @StorageAccountPreparer(
        name_prefix="clitestkusto_storageAccountTest"[:7],
        key="sa",

...
# EXAMPLE: /AttachedDatabaseConfigurations/put/
...
def step_attached_database_configuration_create(test, checks=None):
    ...
    test.cmd(
        ...
        '--location "westus2" '
        '--cluster-resource-id "/subscriptions/{subscription_id}/resource'
        'Groups/{rg}/providers/Microsoft.Kusto/Clusters/{myCluster}" '
        '--database-name "KustoDatabase" '
        '--default-principals-modification-kind "Union" '
        '--table-level-sharing-properties '
        'external-tables-to-exclude="ExternalTable2" '
        'external-tables-to-include="ExternalTable1" '
        'materialized-views-to-exclude="MaterializedViewTable2" '
        'materialized-views-to-include="MaterializedViewTable1" '
        'tables-to-exclude="Table2" '
        'tables-to-include="Table1" '
        '--resource-group "{rg}" ',
        checks=[],
    )
    test.cmd(
        "az kusto attached-database-configuration wait --created "
        '--name "{myAttachedDatabaseConfiguration}" '
        '--cluster-name "{myCluster1}" '
        '--resource-group "{rg}" ',
        checks=checks,
...
# EXAMPLE: /AttachedDatabaseConfigurations/get/
...
def step_cluster_list_sku(test, checks=None):
    if checks is None:
        checks = []
    test.cmd("az kusto cluster list-sku " '-g "" ', checks=checks)
...
def step_cluster_detach_follower_database(test, checks=None):
    ...
    test.cmd(
        ...
        '--cluster-resource-id "/subscriptions/{subscription_id}/resource'
        'Groups/{rg}/providers/Microsoft.Kusto/clusters/{myCluster1}" '
        '--resource-group "{rg}" ',
        checks=checks,
    )
...
# EXAMPLE: /ClusterPrincipalAssignments/put/
...
# EXAMPLE: /DatabasePrincipalAssignments/put/
...
# EXAMPLE: /DatabasePrincipalAssignments/get/
...
# EXAMPLE: /DatabasePrincipalAssignments/delete/
...
def step_database_principal_assignment_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto database-principal-assignment delete -y "
        '--cluster-name "{myCluster}" '
        '--database-name "KustoDatabase" '
        '--principal-assignment-name "testcli1" '
        '--resource-group "{rg}" ',
...
def step_database_add_principal(test, checks=None):
    ...
    test.cmd(
        ...
        '--cluster-name "{myCluster}" '
        '--database-name "KustoDatabase" '
        '--value name="clitest" type="App" '
        'app-id="7bd74dc8-dd5f-4cee-8e64-866138abcf89" role="Admin" '
        '--resource-group "{rg}" ',
        checks=checks,
    )
...
def step_data_connection_event_hub_create(test, checks=None):
    ...
    test.cmd(
        ...
        '--event-hub-resource-id "/subscriptions/{subscription_id}/'
        'resourceGroups/testrg/providers/Microsoft.EventHub'
        '/namespaces/testcli/eventhubs/eventhubTest1" '
        '--resource-group "{rg}" ',
        checks=checks,
    )
...
def step_data_connection_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto data-connection delete -y "
        '--cluster-name "{myCluster}" '
        '--name "{myDataConnection}" '
        '--database-name "KustoDatabase" '
        '--resource-group "{rg}" ',
...
# EXAMPLE: /ManagedPrivateEndpoints/put/
...
def step_managed_private_endpoint_create(test, checks=None):
    ...
    test.cmd(
        ...
        '--group-id "blob" '
        '--private-link-resource-id "/subscriptions/{subscription_id}/resource'
        'Groups/testrg/providers/Microsoft.Storage/storageAccounts/clisatest" '
        '--request-message "Please Approve." '
        '--resource-group "{rg}" ',
        checks=[],
    )
    test.cmd(
        "az kusto managed-private-endpoint wait --created "
        '--cluster-name "{myCluster}" '
        '--name "{myManagedPrivateEndpoint}" '
        '--resource-group "{rg}" ',
        checks=checks,
...
def step_managed_private_endpoint_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto managed-private-endpoint delete -y "
        '--cluster-name "{myCluster}" '
        '--name "{myManagedPrivateEndpoint}" '
        '--resource-group "{rg}" ',
        checks=checks,
...
# EXAMPLE: /AttachedDatabaseConfigurations/delete/
...
def step_attached_database_configuration_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto attached-database-configuration delete -y "
        '--name "{myAttachedDatabaseConfiguration}" '
        '--cluster-name "{myCluster}" '
        '--resource-group "{rg}" ',
        checks=checks,
...
# EXAMPLE: /ClusterPrincipalAssignments/delete/
...
def step_cluster_principal_assignment_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto cluster-principal-assignment delete -y "
        '--cluster-name "{myCluster}" '
        '--principal-assignment-name "testcli1" '
        '--resource-group "{rg}" ',
        checks=checks,
...
# EXAMPLE: /PrivateEndpointConnections/put/
...
def step_private_endpoint_connection_create(test, checks=None):
    test.cmd(
        ...
        '--group-id "cluster" '
        "--manual-request true "
        '--subnet "/subscriptions/{subscription_id}/resourceGroups/testrg/'
        'providers/Microsoft.Network/virtualNetworks/MyVnet/subnets/MySubnet" '
        '--private-connection-resource-id "/subscriptions/{subscription_id}/'
        'resourceGroups/{rg}/providers/Microsoft.Kusto/Clusters/{myCluster}" '
    ...
    test.cmd(
        ...
        'description="Approved by test" status="Approved" '
        '--name "{myPrivateEndpointConnection}" '
        '--resource-group "{rg}"',
        checks=[],
    )
    test.cmd(
        "az kusto private-endpoint-connection wait --created "
        '--cluster-name "{myCluster}" '
        '--name "{myPrivateEndpointConnection}" '
        '--resource-group "{rg}"',
        checks=checks,
...
def step_private_endpoint_connection_list(test, checks=None):
    if checks is None:
        checks = []
    myPrivateEndpointConnectionRes = test.cmd(
        "az kusto private-endpoint-connection list "
        '--cluster-name "{myCluster}" '
        '--resource-group "{rg}" ',
        checks=checks,
    ).get_output_in_json()
    res = myPrivateEndpointConnectionRes[0]
    test.kwargs.update(
        {"myPrivateEndpointConnection": res["name"]}
    )


# EXAMPLE: /PrivateEndpointConnections/delete/
...
def step_private_endpoint_connection_delete(test, checks=None):
    if checks is None:
        checks = []
    test.cmd(
        "az kusto private-endpoint-connection delete -y "
        '--cluster-name "{myCluster}" '
        '--name "{myPrivateEndpointConnection}" '
        '--resource-group "{rg}" ',
        checks=checks,
...
def step_script_create(test, checks=None):
    ...
    test.cmd(
        ...
        '--script-url '
        '"https://clisatest.blob.core.windows.net/kustosa/kustoscript.txt" '

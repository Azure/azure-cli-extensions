...
class ClusterOperations:
    ...
    def list_follower_database(
        ...
        cluster_name: str,
        **kwargs
    ) -> "models.FollowerDatabaseListResult":
    ...
    async def detach_follower_database(
     ...
     configuration in the follower cluster.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    detach_follower_database.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/detachFollowerDatabases'}
    ...
    async def add_language_extension(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    add_language_extension.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/addLanguageExtensions'}

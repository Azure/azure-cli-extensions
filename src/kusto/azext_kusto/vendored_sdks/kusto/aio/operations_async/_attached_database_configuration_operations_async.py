...
class AttachedDatabaseConfigurationOperations:
    ...
    def list_by_cluster(
        ...
        **kwargs
        ...
        :return: AttachedDatabaseConfigurationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.kusto.models.AttachedDatabaseConfigurationListResult
    ...
    list_by_cluster.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/attachedDatabaseConfigurations'}
    ...
    async def create_or_update(
     ...
     to attach reside.
        ...
        :type default_principals_modification_kind: str or ~azure.mgmt.kusto.models.DefaultPrincipalsModificationKind
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns AttachedDatabaseConfiguration
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/attachedDatabaseConfigurations/{attachedDatabaseConfigurationName}'}

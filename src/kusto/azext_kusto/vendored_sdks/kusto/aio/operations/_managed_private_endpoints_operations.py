...
class ManagedPrivateEndpointsOperations:
    ...
    async def check_name_availability(
        ...
        cluster_name: str,
        resource_name: "models.ManagedPrivateEndpointsCheckNameRequest",
        **kwargs
    ...
    def list(
        ...
        cluster_name: str,
        **kwargs
    ) -> AsyncIterable["models.ManagedPrivateEndpointListResult"]:
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.ManagedPrivateEndpoint",
        **kwargs
    ) -> AsyncLROPoller["models.ManagedPrivateEndpoint"]:

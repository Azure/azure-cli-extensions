...
class DatabaseOperations(object):
    ...
    def list_by_cluster(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DatabaseListResult"
        ...
        :type cluster_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DatabaseListResult or the result of cls(response)
        :rtype: ~azure.mgmt.kusto.models.DatabaseListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns Database
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}'}
    ...
    def list_principal(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_principal.metadata['url']
                path_format_arguments = {
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                    'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
                    'databaseName': self._serialize.url("database_name", database_name, 'str'),
    ...
    list_principal.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/listPrincipals'}
    ...
    def add_principal(
        ...
        cluster_name,  # type: str
        database_name,  # type: str
        value=None,  # type: Optional[List["DatabasePrincipal"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DatabasePrincipalListResult"
        ...
        # Construct URL
        url = self.add_principal.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
            'databaseName': self._serialize.url("database_name", database_name, 'str'),
        ...
        return deserialized
    add_principal.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/addPrincipals'}
    ...
    def remove_principal(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.remove_principal.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
            'databaseName': self._serialize.url("database_name", database_name, 'str'),
        ...
        return deserialized
    remove_principal.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/removePrincipals'}

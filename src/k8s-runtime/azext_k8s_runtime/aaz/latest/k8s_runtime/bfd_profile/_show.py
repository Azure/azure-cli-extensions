...
@register_command(
    "k8s-runtime bfd-profile show",
)
class Show(AAZCommand):
    """Get a BfdProfile

    :example: Get a Bfd Profile
        az k8s-runtime bfd-profile show --resource-uri subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/example/providers/Microsoft.Kubernetes/connectedClusters/cluster1 --bfd-profile-name testprofile
    """

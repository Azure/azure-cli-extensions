...
class VirtualMachineScaleSetsOperations(object):
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet]]
    ...
    def update(
        ...
        :param parameters: The scale set object.
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet or
    ...
    def get_instance_view(
        ...
        :return: VirtualMachineScaleSetInstanceView or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetInstanceView
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetPaged[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_skus(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetSkuPaged[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetSku]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def get_os_upgrade_history(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.UpgradeOperationHistoricalStatusInfoPaged[~azure.mgmt.compute.v2019_12.models.UpgradeOperationHistoricalStatusInfo]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def force_recovery_service_fabric_platform_update_domain_walk(
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.RecoveryWalkResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL

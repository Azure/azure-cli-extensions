...
class VirtualMachineScaleSetVMExtensionsOperations(object):
    ...
    def _create_or_update_initial(
            self, resource_group_name, vm_scale_set_name, instance_id, vm_extension_name, extension_parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, vm_scale_set_name, instance_id, vm_extension_name, extension_parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type extension_parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineExtension
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.VirtualMachineExtension]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.VirtualMachineExtension]]
    ...
    def update(
        ...
        :param extension_parameters: Parameters supplied to the Update Virtual
         Machine Extension operation.
        :type extension_parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineExtensionUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def _delete_initial(
            self, resource_group_name, vm_scale_set_name, instance_id, vm_extension_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def delete(
            self, resource_group_name, vm_scale_set_name, instance_id, vm_extension_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def get(
            self, resource_group_name, vm_scale_set_name, instance_id, vm_extension_name, expand=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.VirtualMachineExtension or
    ...
    def list(
        ...
        :return: VirtualMachineExtensionsListResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineExtensionsListResult

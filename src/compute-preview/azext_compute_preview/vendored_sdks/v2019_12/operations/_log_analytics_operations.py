...
class LogAnalyticsOperations(object):
    ...
    def export_request_rate_by_interval(
        ...
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.RequestRateByIntervalInput
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.LogAnalyticsOperationResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.LogAnalyticsOperationResult]]
    ...
    def export_throttled_requests(
        ...
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.ThrottledRequestsInput
        :param location: The location upon which virtual-machine-sizes is
         queried.
        :type location: str
        :param dict custom_headers: headers that will be added to the request

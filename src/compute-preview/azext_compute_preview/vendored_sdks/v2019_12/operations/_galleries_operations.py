...
class GalleriesOperations(object):
    ...
    def create_or_update(
        ...
        :type gallery: ~azure.mgmt.compute.v2019_12.models.Gallery
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns Gallery or
         ClientRawResponse<Gallery> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.Gallery]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.Gallery]]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.Gallery or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.GalleryPaged[~azure.mgmt.compute.v2019_12.models.Gallery]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.GalleryPaged(internal_paging, self._deserialize.dependencies, header_dict)

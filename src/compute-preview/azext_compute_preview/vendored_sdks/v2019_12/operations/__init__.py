...
from ._shared_vm_extensions_operations import SharedVmExtensionsOperations
from ._shared_vm_extension_versions_operations import SharedVmExtensionVersionsOperations
...
__all__ = [
    ...
    'SharedVmExtensionsOperations',
    'SharedVmExtensionVersionsOperations',

...
class VirtualMachinesOperations(object):
    ...
    def list_by_location(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachinePaged[~azure.mgmt.compute.v2019_12.models.VirtualMachine]
    ...
    def capture(
        ...
        :param parameters: Parameters supplied to the Capture Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineCaptureParameters
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.VirtualMachineCaptureResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.VirtualMachineCaptureResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the Create Virtual Machine
         operation.
        :type parameters: ~azure.mgmt.compute.v2019_12.models.VirtualMachine
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.VirtualMachine]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.VirtualMachine]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :param parameters: Parameters supplied to the Update Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.VirtualMachine or
    ...
    def instance_view(
        ...
        :rtype: ~azure.mgmt.compute.v2019_12.models.VirtualMachineInstanceView
    ...
    def list_available_sizes(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12.models.VirtualMachineSizePaged[~azure.mgmt.compute.v2019_12.models.VirtualMachineSize]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def run_command(
        ...
        :type parameters: ~azure.mgmt.compute.v2019_12.models.RunCommandInput
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12.models.RunCommandResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12.models.RunCommandResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """

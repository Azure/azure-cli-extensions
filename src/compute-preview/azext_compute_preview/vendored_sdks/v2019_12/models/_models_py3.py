...
class AdditionalUnattendContent(Model):
    ...
    :type pass_name: str or ~azure.mgmt.compute.v2019_12.models.PassNames
    ...
    :type component_name: str or
     ~azure.mgmt.compute.v2019_12.models.ComponentNames
    ...
    :type setting_name: str or
     ~azure.mgmt.compute.v2019_12.models.SettingNames
...
class ApiError(Model):
    ...
    :type details: list[~azure.mgmt.compute.v2019_12.models.ApiErrorBase]
    :param innererror: The Api inner error
    :type innererror: ~azure.mgmt.compute.v2019_12.models.InnerError
...
class AvailabilitySet(Resource):
    ...
    :type virtual_machines:
     list[~azure.mgmt.compute.v2019_12.models.SubResource]
    ...
    :type proximity_placement_group:
     ~azure.mgmt.compute.v2019_12.models.SubResource
    :ivar statuses: The resource status information.
    :vartype statuses:
     list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    ...
    :type sku: ~azure.mgmt.compute.v2019_12.models.Sku
    """
...
class BootDiagnosticsInstanceView(Model):
    ...
    :ivar status: The boot diagnostics status information for the VM. <br><br>
     ...
     diagnostics.
    :vartype status: ~azure.mgmt.compute.v2019_12.models.InstanceViewStatus
    """
...
class CloudError(Model):
    ...
    :param error:
    :type error: ~azure.mgmt.compute.v2019_12.models.ApiError
    """
...
class ContainerService(Resource):
    ...
    :type orchestrator_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceOrchestratorProfile
    :param custom_profile: Properties for custom clusters.
    :type custom_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceCustomProfile
    :param service_principal_profile: Properties for cluster service
     principals.
    :type service_principal_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceServicePrincipalProfile
    :param master_profile: Required. Properties of master agents.
    :type master_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceMasterProfile
    :param agent_pool_profiles: Required. Properties of the agent pool.
    :type agent_pool_profiles:
     list[~azure.mgmt.compute.v2019_12.models.ContainerServiceAgentPoolProfile]
    :param windows_profile: Properties of Windows VMs.
    :type windows_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceWindowsProfile
    :param linux_profile: Required. Properties of Linux VMs.
    :type linux_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceLinuxProfile
    :param diagnostics_profile: Properties of the diagnostic agent.
    :type diagnostics_profile:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceDiagnosticsProfile
    """
    ...
    def __init__(self, *, location: str, master_profile, agent_pool_profiles, linux_profile, tags=None, orchestrator_profile=None, custom_profile=None, service_principal_profile=None, windows_profile=None, diagnostics_profile=None, **kwargs) -> None:
...
class ContainerServiceAgentPoolProfile(Model):
    ...
    :param vm_size: Required. Size of agent VMs. Possible values include:
     ...
     'Standard_GS5'
    :type vm_size: str or
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceVMSizeTypes
    ...
    def __init__(self, *, name: str, vm_size, dns_prefix: str, count: int=1, **kwargs) -> None:
...
class ContainerServiceCustomProfile(Model):
    ...
    def __init__(self, *, orchestrator: str, **kwargs) -> None:
...
class ContainerServiceDiagnosticsProfile(Model):
    ...
    :param vm_diagnostics: Required. Profile for the container service VM
     diagnostic agent.
    :type vm_diagnostics:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceVMDiagnostics
    """
...
class ContainerServiceLinuxProfile(Model):
    ...
    :param ssh: Required. The ssh key configuration for Linux VMs.
    :type ssh:
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceSshConfiguration
    """
...
class ContainerServiceMasterProfile(Model):
    ...
    def __init__(self, *, dns_prefix: str, count: int=1, **kwargs) -> None:
...
class ContainerServiceOrchestratorProfile(Model):
    ...
    :type orchestrator_type: str or
     ~azure.mgmt.compute.v2019_12.models.ContainerServiceOrchestratorTypes
    """
    ...
    def __init__(self, *, orchestrator_type, **kwargs) -> None:
...
class ContainerServiceServicePrincipalProfile(Model):
    ...
    :type client_id: str
    :param secret: Required. The secret password associated with the service
     principal.
    :type secret: str
    """
...
class ContainerServiceSshConfiguration(Model):
    ...
    :type public_keys:
     list[~azure.mgmt.compute.v2019_12.models.ContainerServiceSshPublicKey]
    """
...
class CreationData(Model):
    ...
    :type create_option: str or
     ~azure.mgmt.compute.v2019_12.models.DiskCreateOption
    ...
    :type image_reference:
     ~azure.mgmt.compute.v2019_12.models.ImageDiskReference
    ...
    def __init__(self, *, create_option, storage_account_id: str=None, image_reference=None, source_uri: str=None, source_resource_id: str=None, upload_size_bytes: int=None, **kwargs) -> None:
...
class DataDisk(Model):
    ...
    :type vhd: ~azure.mgmt.compute.v2019_12.models.VirtualHardDisk
    :param image: The source user image virtual hard disk. The virtual hard
     ...
     exist.
    :type image: ~azure.mgmt.compute.v2019_12.models.VirtualHardDisk
    ...
    :type caching: str or ~azure.mgmt.compute.v2019_12.models.CachingTypes
    ...
    :type create_option: str or
     ~azure.mgmt.compute.v2019_12.models.DiskCreateOptionTypes
    ...
    :type managed_disk:
     ~azure.mgmt.compute.v2019_12.models.ManagedDiskParameters
...
class DedicatedHost(Resource):
    ...
    :vartype virtual_machines:
     list[~azure.mgmt.compute.v2019_12.models.SubResourceReadOnly]
    ...
    :type license_type: str or
     ~azure.mgmt.compute.v2019_12.models.DedicatedHostLicenseTypes
    ...
    :vartype instance_view:
     ~azure.mgmt.compute.v2019_12.models.DedicatedHostInstanceView
...
class DedicatedHostAvailableCapacity(Model):
    ...
    :type allocatable_vms:
     list[~azure.mgmt.compute.v2019_12.models.DedicatedHostAllocatableVM]
    """
...
class DedicatedHostInstanceView(Model):
    ...
    :type available_capacity:
     ~azure.mgmt.compute.v2019_12.models.DedicatedHostAvailableCapacity
...
class DiagnosticsProfile(Model):
    ...
    :type boot_diagnostics:
     ~azure.mgmt.compute.v2019_12.models.BootDiagnostics
    """
...
class DiffDiskSettings(Model):
    ...
    :type option: str or ~azure.mgmt.compute.v2019_12.models.DiffDiskOptions
    """
...
class Disk(Resource):
    ...
    :param sku:
    :type sku: ~azure.mgmt.compute.v2019_12.models.DiskSku
    ...
    :param os_type: The Operating System type. Possible values include:
     'Windows', 'Linux'
    :type os_type: str or
     ~azure.mgmt.compute.v2019_12.models.OperatingSystemTypes
    ...
    :type hyper_vgeneration: str or
     ~azure.mgmt.compute.v2019_12.models.HyperVGeneration
    ...
    :type creation_data: ~azure.mgmt.compute.v2019_12.models.CreationData
    ...
    :type encryption_settings_collection:
     ~azure.mgmt.compute.v2019_12.models.EncryptionSettingsCollection
    ...
    :ivar disk_state: The state of the disk. Possible values include:
     ...
     'ActiveUpload'
    :vartype disk_state: str or ~azure.mgmt.compute.v2019_12.models.DiskState
    ...
    :type encryption: ~azure.mgmt.compute.v2019_12.models.Encryption
    """
    ...
    def __init__(self, *, location: str, creation_data, tags=None, sku=None, zones=None, os_type=None, hyper_vgeneration=None, disk_size_gb: int=None, encryption_settings_collection=None, disk_iops_read_write: int=None, disk_mbps_read_write: int=None, encryption=None, **kwargs) -> None:
...
class DiskEncryptionSet(Resource):
    ...
    :type tags: dict[str, str]
    :param identity:
    :type identity: ~azure.mgmt.compute.v2019_12.models.EncryptionSetIdentity
    :param active_key: The key vault key which is currently used by this disk
     encryption set.
    :type active_key:
     ~azure.mgmt.compute.v2019_12.models.KeyVaultAndKeyReference
    ...
    :vartype previous_keys:
     list[~azure.mgmt.compute.v2019_12.models.KeyVaultAndKeyReference]
...
class DiskEncryptionSettings(Model):
    ...
    :type disk_encryption_key:
     ~azure.mgmt.compute.v2019_12.models.KeyVaultSecretReference
    :param key_encryption_key: Specifies the location of the key encryption
     key in Key Vault.
    :type key_encryption_key:
     ~azure.mgmt.compute.v2019_12.models.KeyVaultKeyReference
...
class DiskInstanceView(Model):
    ...
    :type encryption_settings:
     list[~azure.mgmt.compute.v2019_12.models.DiskEncryptionSettings]
    :param statuses: The resource status information.
    :type statuses:
     list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    """
...
class DiskSku(Model):
    ...
    :type name: str or
     ~azure.mgmt.compute.v2019_12.models.DiskStorageAccountTypes
...
class Encryption(Model):
    ...
    :type type: str or ~azure.mgmt.compute.v2019_12.models.EncryptionType
    """
    ...
    def __init__(self, *, type, disk_encryption_set_id: str=None, **kwargs) -> None:
...
class EncryptionSetIdentity(Model):
    ...
    :param type: The type of Managed Identity used by the DiskEncryptionSet.
     ...
     'SystemAssigned'
    :type type: str or
     ~azure.mgmt.compute.v2019_12.models.DiskEncryptionSetIdentityType
...
class EncryptionSettingsCollection(Model):
    ...
    :param encryption_settings: A collection of encryption settings, one for
     each disk volume.
    :type encryption_settings:
     list[~azure.mgmt.compute.v2019_12.models.EncryptionSettingsElement]
...
class EncryptionSettingsElement(Model):
    ...
    :param disk_encryption_key: Key Vault Secret Url and vault id of the disk
     encryption key
    :type disk_encryption_key:
     ~azure.mgmt.compute.v2019_12.models.KeyVaultAndSecretReference
...
class Endpoint(Model):
    ...
    :param name: The name of the extension endpoint.
    :type name: str
    :param protocol: The protocol of the extension endpoint.
    :type protocol: str
    """
    ...
    def __init__(self, *, name: str=None, protocol: str=None, **kwargs) -> None:
        super(Endpoint, self).__init__(**kwargs)
        self.name = name
        self.protocol = protocol


class ExtensionCertificate(Model):
    """This defines extension certificate.

    :param store_location: Extension certification store location.
    :type store_location: str
    :param store_name: Extension certification store name.
    :type store_name: str
    :param thumbprint_required: Flag indicating if thumbprint is required.
    :type thumbprint_required: bool
    :param thumbprint_algorithm: Extension certification thumbprint algorithm.
    ...
    _attribute_map = {
        ...
        'thumbprint_required': {'key': 'thumbprintRequired', 'type': 'bool'},
        'thumbprint_algorithm': {'key': 'thumbprintAlgorithm', 'type': 'str'},
    }

    def __init__(self, *, store_location: str=None, store_name: str=None, thumbprint_required: bool=None, thumbprint_algorithm: str=None, **kwargs) -> None:
        super(ExtensionCertificate, self).__init__(**kwargs)
        self.store_location = store_location
        self.store_name = store_name
        self.thumbprint_required = thumbprint_required
        self.thumbprint_algorithm = thumbprint_algorithm


class ExtensionConfiguration(Model):
    """This defines extension configuration schemas.

    :param is_json_extension: Flag indicating if this is a json extension or
     not.
    :type is_json_extension: bool
    :param public_configuration_schema: Public configuration schema in xml
     format.
    :type public_configuration_schema: str
    :param private_configuration_schema: Private configuration schema in xml
     format.
    :type private_configuration_schema: str
    :param sample_config: Sample configuration schema in xml format.
    :type sample_config: str
    """

    _attribute_map = {
        'is_json_extension': {'key': 'isJsonExtension', 'type': 'bool'},
        'public_configuration_schema': {'key': 'publicConfigurationSchema', 'type': 'str'},
        'private_configuration_schema': {'key': 'privateConfigurationSchema', 'type': 'str'},
        'sample_config': {'key': 'sampleConfig', 'type': 'str'},
    }

    def __init__(self, *, is_json_extension: bool=None, public_configuration_schema: str=None, private_configuration_schema: str=None, sample_config: str=None, **kwargs) -> None:
        super(ExtensionConfiguration, self).__init__(**kwargs)
        self.is_json_extension = is_json_extension
        self.public_configuration_schema = public_configuration_schema
        self.private_configuration_schema = private_configuration_schema
        self.sample_config = sample_config


class ExtensionEndpoints(Model):
    """This defines the endpoints used in extension.

    :param input_endpoints: A list of extension input endpoints.
    :type input_endpoints:
     list[~azure.mgmt.compute.v2019_12.models.ExtensionInputEndpoint]
    :param internal_endpoints: A list of extension internal input endpoints.
    :type internal_endpoints:
     list[~azure.mgmt.compute.v2019_12.models.ExtensionInternalEndpoint]
    :param instance_input_endpoints: A list of extension instance input
     endpoints.
    :type instance_input_endpoints:
     list[~azure.mgmt.compute.v2019_12.models.ExtensionInstanceInputEndpoint]
    """

    _attribute_map = {
        'input_endpoints': {'key': 'inputEndpoints', 'type': '[ExtensionInputEndpoint]'},
        'internal_endpoints': {'key': 'internalEndpoints', 'type': '[ExtensionInternalEndpoint]'},
        'instance_input_endpoints': {'key': 'instanceInputEndpoints', 'type': '[ExtensionInstanceInputEndpoint]'},
    }

    def __init__(self, *, input_endpoints=None, internal_endpoints=None, instance_input_endpoints=None, **kwargs) -> None:
        super(ExtensionEndpoints, self).__init__(**kwargs)
        self.input_endpoints = input_endpoints
        self.internal_endpoints = internal_endpoints
        self.instance_input_endpoints = instance_input_endpoints
...
class ExtensionIdentifier(Model):
    ...
    :param publisher: Required. The name of the Shared VM Extension publisher.
    :type publisher: str
    :param type: Required. The name of the Shared VM Extension type.
    :type type: str
    """
    ...
    def __init__(self, *, publisher: str, type: str, **kwargs) -> None:
        super(ExtensionIdentifier, self).__init__(**kwargs)
        self.publisher = publisher
        self.type = type


class ExtensionImageLocalResource(Model):
    """This defines extension image local resources.

    :param name: Extension image local resource name.
    :type name: str
    :param size_in_mb: Extension image local resource size in MB.
    :type size_in_mb: int
    """
    ...
    def __init__(self, *, name: str=None, size_in_mb: int=None, **kwargs) -> None:
        super(ExtensionImageLocalResource, self).__init__(**kwargs)
        self.name = name
        self.size_in_mb = size_in_mb


class ExtensionInternalEndpoint(Endpoint):
    ...
    :param protocol: The protocol of the extension endpoint.
    :type protocol: str
    :param port: Extension input endpoint port.
    :type port: str
    """
    ...
    def __init__(self, *, name: str=None, protocol: str=None, port: str=None, **kwargs) -> None:
        super(ExtensionInternalEndpoint, self).__init__(name=name, protocol=protocol, **kwargs)
        self.port = port


class ExtensionInputEndpoint(ExtensionInternalEndpoint):
    ...
    :param port: Extension input endpoint port.
    :type port: str
    :param local_port: Extension input endpoint local port.
    :type local_port: str
    """
    ...
    def __init__(self, *, name: str=None, protocol: str=None, port: str=None, local_port: str=None, **kwargs) -> None:
        super(ExtensionInputEndpoint, self).__init__(name=name, protocol=protocol, port=port, **kwargs)
        self.local_port = local_port


class ExtensionInstanceInputEndpoint(Endpoint):
    ...
    :param local_port: Extension input endpoint local port.
    :type local_port: str
    :param fixed_port_min: Extension input endpoint fixed port minimum value.
    :type fixed_port_min: str
    :param fixed_port_max: Extension input endpoint fixed port maximum value.
    :type fixed_port_max: str
    """
    ...
    _attribute_map = {
        ...
        'protocol': {'key': 'protocol', 'type': 'str'},
        'local_port': {'key': 'localPort', 'type': 'str'},
        'fixed_port_min': {'key': 'fixedPortMin', 'type': 'str'},
        'fixed_port_max': {'key': 'fixedPortMax', 'type': 'str'},
    }

    def __init__(self, *, name: str=None, protocol: str=None, local_port: str=None, fixed_port_min: str=None, fixed_port_max: str=None, **kwargs) -> None:
        super(ExtensionInstanceInputEndpoint, self).__init__(name=name, protocol=protocol, **kwargs)
        self.local_port = local_port
        self.fixed_port_min = fixed_port_min
        self.fixed_port_max = fixed_port_max
...
class Gallery(Resource):
    ...
    :param identifier:
    :type identifier: ~azure.mgmt.compute.v2019_12.models.GalleryIdentifier
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.compute.v2019_12.models.enum
    """
...
class GalleryApplicationVersion(Resource):
    ...
    :type publishing_profile:
     ~azure.mgmt.compute.v2019_12.models.GalleryApplicationVersionPublishingProfile
    ...
    :vartype replication_status:
     ~azure.mgmt.compute.v2019_12.models.ReplicationStatus
    """
...
class GalleryArtifactPublishingProfileBase(Model):
    ...
    :type target_regions:
     list[~azure.mgmt.compute.v2019_12.models.TargetRegion]
    ...
    :type storage_account_type: str or
     ~azure.mgmt.compute.v2019_12.models.StorageAccountType
    """
...
class GalleryApplicationVersionPublishingProfile(GalleryArtifactPublishingProfileBase):
    ...
    :type source: ~azure.mgmt.compute.v2019_12.models.UserArtifactSource
...
class GalleryArtifactSource(Model):
    ...
    :type managed_image: ~azure.mgmt.compute.v2019_12.models.ManagedArtifact
    """
...
class GalleryDiskImage(Model):
    ...
    :param host_caching: The host caching of the disk. Valid values are
     ...
     'ReadOnly', 'ReadWrite'
    :type host_caching: str or ~azure.mgmt.compute.v2019_12.models.HostCaching
    :param source:
    :type source:
     ~azure.mgmt.compute.v2019_12.models.GalleryArtifactVersionSource
    """
...
class GalleryImage(Resource):
    ...
    :type os_state: str or
     ~azure.mgmt.compute.v2019_12.models.OperatingSystemStateTypes
    :param hyper_vgeneration: The hypervisor generation of the Virtual
     Machine. Applicable to OS disks only. Possible values include: 'V1', 'V2'
    :type hyper_vgeneration: str or
     ~azure.mgmt.compute.v2019_12.models.HyperVGeneration
    ...
    :type identifier:
     ~azure.mgmt.compute.v2019_12.models.GalleryImageIdentifier
    :param recommended:
    :type recommended:
     ~azure.mgmt.compute.v2019_12.models.RecommendedMachineConfiguration
    :param disallowed:
    :type disallowed: ~azure.mgmt.compute.v2019_12.models.Disallowed
    :param purchase_plan:
    :type purchase_plan: ~azure.mgmt.compute.v2019_12.models.ImagePurchasePlan
...
class GalleryImageVersion(Resource):
    ...
    :type publishing_profile:
     ~azure.mgmt.compute.v2019_12.models.GalleryImageVersionPublishingProfile
    ...
    :type storage_profile:
     ~azure.mgmt.compute.v2019_12.models.GalleryImageVersionStorageProfile
    :ivar replication_status:
    :vartype replication_status:
     ~azure.mgmt.compute.v2019_12.models.ReplicationStatus
    """
...
class GalleryImageVersionStorageProfile(Model):
    ...
    :param os_disk_image:
    :type os_disk_image:
     ~azure.mgmt.compute.v2019_12.models.GalleryOSDiskImage
    :param data_disk_images: A list of data disk images.
    :type data_disk_images:
     list[~azure.mgmt.compute.v2019_12.models.GalleryDataDiskImage]
    """
...
class GrantAccessData(Model):
    ...
    :type access: str or ~azure.mgmt.compute.v2019_12.models.AccessLevel
...
class HardwareProfile(Model):
    ...
    :type vm_size: str or
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineSizeTypes
    """
...
class Image(Resource):
    ...
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile:
     ~azure.mgmt.compute.v2019_12.models.ImageStorageProfile
    ...
    :type hyper_vgeneration: str or
     ~azure.mgmt.compute.v2019_12.models.HyperVGenerationTypes
    """
...
class ImageDisk(Model):
    ...
    :type snapshot: ~azure.mgmt.compute.v2019_12.models.SubResource
    :param managed_disk: The managedDisk.
    :type managed_disk: ~azure.mgmt.compute.v2019_12.models.SubResource
    ...
    :param storage_account_type: Specifies the storage account type for the
     ...
     'Premium_LRS', 'StandardSSD_LRS', 'UltraSSD_LRS'
    :type storage_account_type: str or
     ~azure.mgmt.compute.v2019_12.models.StorageAccountTypes
    ...
    :type disk_encryption_set:
     ~azure.mgmt.compute.v2019_12.models.DiskEncryptionSetParameters
    """
...
class ImageStorageProfile(Model):
    ...
    :type os_disk: ~azure.mgmt.compute.v2019_12.models.ImageOSDisk
    :param data_disks: Specifies the parameters that are used to add a data
     ...
     [About disks and VHDs for Azure virtual
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type data_disks: list[~azure.mgmt.compute.v2019_12.models.ImageDataDisk]
...
class InstanceViewStatus(Model):
    ...
    :param level: The level code. Possible values include: 'Info', 'Warning',
     'Error'
    :type level: str or ~azure.mgmt.compute.v2019_12.models.StatusLevelTypes
...
class KeyVaultAndKeyReference(Model):
    ...
    :param source_vault: Required. Resource id of the KeyVault containing the
     key or secret
    :type source_vault: ~azure.mgmt.compute.v2019_12.models.SourceVault
...
class KeyVaultKeyReference(Model):
    ...
    :param source_vault: Required. The relative URL of the Key Vault
     containing the key.
    :type source_vault: ~azure.mgmt.compute.v2019_12.models.SubResource
    """
...
class LinuxConfiguration(Model):
    ...
    :type ssh: ~azure.mgmt.compute.v2019_12.models.SshConfiguration
...
class LogAnalyticsOperationResult(Model):
    ...
    :vartype properties:
     ~azure.mgmt.compute.v2019_12.models.LogAnalyticsOutput
    """
...
class MaintenanceRedeployStatus(Model):
    ...
    :type last_operation_result_code: str or
     ~azure.mgmt.compute.v2019_12.models.MaintenanceOperationResultCodeTypes
...
class NetworkProfile(Model):
    ...
    :type network_interfaces:
     list[~azure.mgmt.compute.v2019_12.models.NetworkInterfaceReference]
    """
...
class OSDisk(Model):
    ...
    :param encryption_settings: Specifies the encryption settings for the OS
     Disk. <br><br> Minimum api-version: 2015-06-15
    :type encryption_settings:
     ~azure.mgmt.compute.v2019_12.models.DiskEncryptionSettings
    :param name: The disk name.
    :type name: str
    :param vhd: The virtual hard disk.
    :type vhd: ~azure.mgmt.compute.v2019_12.models.VirtualHardDisk
    ...
    :type diff_disk_settings:
     ~azure.mgmt.compute.v2019_12.models.DiffDiskSettings
    :param create_option: Required. Specifies how the virtual machine should
     be created.<br><br> Possible values are:<br><br> **Attach** \\u2013 This
     value is used when you are using a specialized disk to create the virtual
     machine.<br><br> **FromImage** \\u2013 This value is used when you are
...
class OSProfile(Model):
    ...
    :type windows_configuration:
     ~azure.mgmt.compute.v2019_12.models.WindowsConfiguration
    ...
    :type linux_configuration:
     ~azure.mgmt.compute.v2019_12.models.LinuxConfiguration
    :param secrets: Specifies set of certificates that should be installed
     onto the virtual machine.
    :type secrets: list[~azure.mgmt.compute.v2019_12.models.VaultSecretGroup]
...
class ProximityPlacementGroup(Resource):
    ...
    :type proximity_placement_group_type: str or
     ~azure.mgmt.compute.v2019_12.models.ProximityPlacementGroupType
    :ivar virtual_machines: A list of references to all virtual machines in
...
class RecommendedMachineConfiguration(Model):
    ...
    :param v_cp_us:
    :type v_cp_us: ~azure.mgmt.compute.v2019_12.models.ResourceRange
    :param memory:
    :type memory: ~azure.mgmt.compute.v2019_12.models.ResourceRange
    """
...
class RegionalReplicationStatus(Model):
    ...
    :vartype state: str or
     ~azure.mgmt.compute.v2019_12.models.ReplicationState
...
class ReplicationStatus(Model):
    ...
    :vartype aggregated_state: str or
     ~azure.mgmt.compute.v2019_12.models.AggregatedReplicationState
    :ivar summary: This is a summary of replication status for each region.
    :vartype summary:
     list[~azure.mgmt.compute.v2019_12.models.RegionalReplicationStatus]
    """
...
class RequestRateByIntervalInput(LogAnalyticsInputBase):
    ...
    :type interval_length: str or
     ~azure.mgmt.compute.v2019_12.models.IntervalInMins
    """
...
class ResourceSku(Model):
    ...
    :vartype capacity: ~azure.mgmt.compute.v2019_12.models.ResourceSkuCapacity
    ...
    :vartype location_info:
     list[~azure.mgmt.compute.v2019_12.models.ResourceSkuLocationInfo]
    ...
    :vartype costs: list[~azure.mgmt.compute.v2019_12.models.ResourceSkuCosts]
    :ivar capabilities: A name value pair to describe the capability.
    :vartype capabilities:
     list[~azure.mgmt.compute.v2019_12.models.ResourceSkuCapabilities]
    ...
    :vartype restrictions:
     list[~azure.mgmt.compute.v2019_12.models.ResourceSkuRestrictions]
    """
...
class ResourceSkuCapacity(Model):
    ...
    :vartype scale_type: str or
     ~azure.mgmt.compute.v2019_12.models.ResourceSkuCapacityScaleType
    """
...
class ResourceSkuLocationInfo(Model):
    ...
    :vartype zone_details:
     list[~azure.mgmt.compute.v2019_12.models.ResourceSkuZoneDetails]
    """
...
class ResourceSkuRestrictions(Model):
    ...
    :ivar type: The type of restrictions. Possible values include: 'Location',
     'Zone'
    :vartype type: str or
     ~azure.mgmt.compute.v2019_12.models.ResourceSkuRestrictionsType
    ...
    :vartype restriction_info:
     ~azure.mgmt.compute.v2019_12.models.ResourceSkuRestrictionInfo
    ...
    :vartype reason_code: str or
     ~azure.mgmt.compute.v2019_12.models.ResourceSkuRestrictionsReasonCode
    """
...
class RollbackStatusInfo(Model):
    ...
    :vartype rollback_error: ~azure.mgmt.compute.v2019_12.models.ApiError
    """
...
class RollingUpgradeRunningStatus(Model):
    ...
    :vartype code: str or
     ~azure.mgmt.compute.v2019_12.models.RollingUpgradeStatusCode
    ...
    :vartype last_action: str or
     ~azure.mgmt.compute.v2019_12.models.RollingUpgradeActionType
...
class RollingUpgradeStatusInfo(Resource):
    ...
    :vartype policy: ~azure.mgmt.compute.v2019_12.models.RollingUpgradePolicy
    :ivar running_status: Information about the current running state of the
     overall upgrade.
    :vartype running_status:
     ~azure.mgmt.compute.v2019_12.models.RollingUpgradeRunningStatus
    :ivar progress: Information about the number of virtual machine instances
     in each upgrade state.
    :vartype progress:
     ~azure.mgmt.compute.v2019_12.models.RollingUpgradeProgressInfo
    :ivar error: Error details for this upgrade, if there are any.
    :vartype error: ~azure.mgmt.compute.v2019_12.models.ApiError
    """
...
class RunCommandDocument(RunCommandDocumentBase):
    ...
    :type parameters:
     list[~azure.mgmt.compute.v2019_12.models.RunCommandParameterDefinition]
    """
...
class RunCommandInput(Model):
    ...
    :type parameters:
     list[~azure.mgmt.compute.v2019_12.models.RunCommandInputParameter]
    """
...
class RunCommandResult(Model):
    ...
    :type value: list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    """
...
class ScaleInPolicy(Model):
    ...
    :type rules: list[str or
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetScaleInRules]
    """
...
class ScheduledEventsProfile(Model):
    ...
    :type terminate_notification_profile:
     ~azure.mgmt.compute.v2019_12.models.TerminateNotificationProfile
    """
...
class SharedVmExtension(Resource):
    ...
    :type tags: dict[str, str]
    :param identifier:
    :type identifier: ~azure.mgmt.compute.v2019_12.models.ExtensionIdentifier
    :param label: The label of this Shared VM Extension.
    :type label: str
    :param description: The description of this Shared VM Extension.
    :type description: str
    :param company_name: The company name of this Shared VM Extension.
    :type company_name: str
    :param eula: The Eula agreement for the Shared VM Extension.
    :type eula: str
    :param privacy_uri: The privacy statement uri.
    :type privacy_uri: str
    :param homepage_uri: The homepage uri.
    :type homepage_uri: str
    :ivar provisioning_state: The current state of the shared VM extension.
     The provisioning state, which only appears in the response. Possible
     values include: 'Creating', 'Updating', 'Failed', 'Succeeded', 'Deleting',
     'Migrating'
    :vartype provisioning_state: str or
    ...
    _attribute_map = {
        ...
        'location': {'key': 'location', 'type': 'str'},
        'tags': {'key': 'tags', 'type': '{str}'},
        'identifier': {'key': 'properties.identifier', 'type': 'ExtensionIdentifier'},
        'label': {'key': 'properties.label', 'type': 'str'},
        'description': {'key': 'properties.description', 'type': 'str'},
        'company_name': {'key': 'properties.companyName', 'type': 'str'},
        'eula': {'key': 'properties.eula', 'type': 'str'},
        'privacy_uri': {'key': 'properties.privacyUri', 'type': 'str'},
        'homepage_uri': {'key': 'properties.homepageUri', 'type': 'str'},
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
    }

    def __init__(self, *, location: str, tags=None, identifier=None, label: str=None, description: str=None, company_name: str=None, eula: str=None, privacy_uri: str=None, homepage_uri: str=None, **kwargs) -> None:
        super(SharedVmExtension, self).__init__(location=location, tags=tags, **kwargs)
        self.identifier = identifier
        self.label = label
        self.description = description
        self.company_name = company_name
        self.eula = eula
        self.privacy_uri = privacy_uri
        self.homepage_uri = homepage_uri
        self.provisioning_state = None


class SharedVmExtensionVersion(Resource):
    ...
    :param tags: Resource tags
    :type tags: dict[str, str]
    :param media_link: The link for the extension source package.
    :type media_link: str
    :param regions: A list of regions to publish the extension version.
    :type regions: list[str]
    :param compute_role: This property allows you to specify the compute role
     of the extension. <br><br> Possible values are: <br><br> **PaaS** <br><br>
     **IaaS** <br><br> **All**. Possible values include: 'PaaS', 'IaaS', 'All'
    :type compute_role: str or
     ~azure.mgmt.compute.v2019_12.models.ComputeRoleTypes
    :param supported_os: This property allows you to specify the supported OS
     for this extension. <br><br> Possible values are: <br><br> **Windows**
     <br><br> **Linux**. Possible values include: 'Windows', 'Linux'
    :type supported_os: str or
     ~azure.mgmt.compute.v2019_12.models.OperatingSystemTypes
    :param supports_multiple_extensions: Flag indicating if it supports
     multiple extensions.
    :type supports_multiple_extensions: bool
    :param is_internal_extension: Flag indicating if it is internal extension.
    :type is_internal_extension: bool
    :param disallow_major_version_upgrade: Flag indicating if major version
     upgrade is disallowed.
    :type disallow_major_version_upgrade: bool
    :param rollback_supported: Flag indicating if the extension version
     supports rollback or not
    :type rollback_supported: bool
    :param configuration:
    :type configuration:
     ~azure.mgmt.compute.v2019_12.models.ExtensionConfiguration
    :param certificate:
    :type certificate:
     ~azure.mgmt.compute.v2019_12.models.ExtensionCertificate
    :param endpoints:
    :type endpoints: ~azure.mgmt.compute.v2019_12.models.ExtensionEndpoints
    :param local_resources: A list of extension image local resources.
    :type local_resources:
     list[~azure.mgmt.compute.v2019_12.models.ExtensionImageLocalResource]
    :param block_role_upon_failure: Flag indicating if extension role should
     be blocked upon failure
    :type block_role_upon_failure: bool
    :ivar provisioning_state: The current state of the shared VM extension.
     The provisioning state, which only appears in the response. Possible
     values include: 'Creating', 'Updating', 'Failed', 'Succeeded', 'Deleting',
     'Migrating'
    ...
    _attribute_map = {
        ...
        'location': {'key': 'location', 'type': 'str'},
        'tags': {'key': 'tags', 'type': '{str}'},
        'media_link': {'key': 'properties.mediaLink', 'type': 'str'},
        'regions': {'key': 'properties.regions', 'type': '[str]'},
        'compute_role': {'key': 'properties.computeRole', 'type': 'ComputeRoleTypes'},
        'supported_os': {'key': 'properties.supportedOS', 'type': 'OperatingSystemTypes'},
        'supports_multiple_extensions': {'key': 'properties.supportsMultipleExtensions', 'type': 'bool'},
        'is_internal_extension': {'key': 'properties.isInternalExtension', 'type': 'bool'},
        'disallow_major_version_upgrade': {'key': 'properties.disallowMajorVersionUpgrade', 'type': 'bool'},
        'rollback_supported': {'key': 'properties.rollbackSupported', 'type': 'bool'},
        'configuration': {'key': 'properties.configuration', 'type': 'ExtensionConfiguration'},
        'certificate': {'key': 'properties.certificate', 'type': 'ExtensionCertificate'},
        'endpoints': {'key': 'properties.endpoints', 'type': 'ExtensionEndpoints'},
        'local_resources': {'key': 'properties.localResources', 'type': '[ExtensionImageLocalResource]'},
        'block_role_upon_failure': {'key': 'properties.blockRoleUponFailure', 'type': 'bool'},
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
    }

    def __init__(self, *, location: str, tags=None, media_link: str=None, regions=None, compute_role=None, supported_os=None, supports_multiple_extensions: bool=None, is_internal_extension: bool=None, disallow_major_version_upgrade: bool=None, rollback_supported: bool=None, configuration=None, certificate=None, endpoints=None, local_resources=None, block_role_upon_failure: bool=None, **kwargs) -> None:
        super(SharedVmExtensionVersion, self).__init__(location=location, tags=tags, **kwargs)
        self.media_link = media_link
        self.regions = regions
        self.compute_role = compute_role
        self.supported_os = supported_os
        self.supports_multiple_extensions = supports_multiple_extensions
        self.is_internal_extension = is_internal_extension
        self.disallow_major_version_upgrade = disallow_major_version_upgrade
        self.rollback_supported = rollback_supported
        self.configuration = configuration
        self.certificate = certificate
        self.endpoints = endpoints
        self.local_resources = local_resources
        self.block_role_upon_failure = block_role_upon_failure
        self.provisioning_state = None
...
class Snapshot(Resource):
    ...
    :vartype managed_by: str
    :param sku:
    :type sku: ~azure.mgmt.compute.v2019_12.models.SnapshotSku
    :ivar time_created: The time when the disk was created.
    :vartype time_created: datetime
    :param os_type: The Operating System type. Possible values include:
     'Windows', 'Linux'
...
class SnapshotSku(Model):
    ...
    :type name: str or
     ~azure.mgmt.compute.v2019_12.models.SnapshotStorageAccountTypes
    :ivar tier: The sku tier.
    :vartype tier: str
    """
...
class SshConfiguration(Model):
    ...
    :param public_keys: The list of SSH public keys used to authenticate with
     linux based VMs.
    :type public_keys: list[~azure.mgmt.compute.v2019_12.models.SshPublicKey]
    """
...
class StorageProfile(Model):
    ...
    :type image_reference: ~azure.mgmt.compute.v2019_12.models.ImageReference
    :param os_disk: Specifies information about the operating system disk used
     by the virtual machine. <br><br> For more information about disks, see
     [About disks and VHDs for Azure virtual
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type os_disk: ~azure.mgmt.compute.v2019_12.models.OSDisk
    :param data_disks: Specifies the parameters that are used to add a data
     disk to a virtual machine. <br><br> For more information about disks, see
     [About disks and VHDs for Azure virtual
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type data_disks: list[~azure.mgmt.compute.v2019_12.models.DataDisk]
    """
...
class UpgradeOperationHistoricalStatusInfo(Model):
    ...
    :ivar properties: Information about the properties of the upgrade
     operation.
    :vartype properties:
     ~azure.mgmt.compute.v2019_12.models.UpgradeOperationHistoricalStatusInfoProperties
    :ivar type: Resource type
    :vartype type: str
...
class UpgradeOperationHistoricalStatusInfoProperties(Model):
    ...
    :ivar running_status: Information about the overall status of the upgrade
     operation.
    :vartype running_status:
     ~azure.mgmt.compute.v2019_12.models.UpgradeOperationHistoryStatus
...
class UpgradeOperationHistoryStatus(Model):
    ...
    :ivar code: Code indicating the current status of the upgrade. Possible
     values include: 'RollingForward', 'Cancelled', 'Completed', 'Faulted'
    :vartype code: str or ~azure.mgmt.compute.v2019_12.models.UpgradeState
    :ivar start_time: Start time of the upgrade.
    :vartype start_time: datetime
...
class UpgradePolicy(Model):
    ...
    :type mode: str or ~azure.mgmt.compute.v2019_12.models.UpgradeMode
    :param rolling_upgrade_policy: The configuration parameters used while
     performing a rolling upgrade.
    :type rolling_upgrade_policy:
     ~azure.mgmt.compute.v2019_12.models.RollingUpgradePolicy
    ...
    :type automatic_os_upgrade_policy:
     ~azure.mgmt.compute.v2019_12.models.AutomaticOSUpgradePolicy
    """
...
class Usage(Model):
    ...
    :type name: ~azure.mgmt.compute.v2019_12.models.UsageName
    """
...
class VaultSecretGroup(Model):
    ...
    :type vault_certificates:
     list[~azure.mgmt.compute.v2019_12.models.VaultCertificate]
    """
...
class VirtualMachine(Resource):
    ...
    :param plan: Specifies information about the marketplace image used to
     ...
     then click **Save**.
    :type plan: ~azure.mgmt.compute.v2019_12.models.Plan
    :param hardware_profile: Specifies the hardware settings for the virtual
     machine.
    :type hardware_profile:
     ~azure.mgmt.compute.v2019_12.models.HardwareProfile
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile: ~azure.mgmt.compute.v2019_12.models.StorageProfile
    ...
    :type additional_capabilities:
     ~azure.mgmt.compute.v2019_12.models.AdditionalCapabilities
    :param os_profile: Specifies the operating system settings for the virtual
     machine.
    :type os_profile: ~azure.mgmt.compute.v2019_12.models.OSProfile
    :param network_profile: Specifies the network interfaces of the virtual
     machine.
    :type network_profile: ~azure.mgmt.compute.v2019_12.models.NetworkProfile
    :param diagnostics_profile: Specifies the boot diagnostic settings state.
     <br><br>Minimum api-version: 2015-06-15.
    :type diagnostics_profile:
     ~azure.mgmt.compute.v2019_12.models.DiagnosticsProfile
    ...
    :type availability_set: ~azure.mgmt.compute.v2019_12.models.SubResource
    ...
    :type priority: str or
     ~azure.mgmt.compute.v2019_12.models.VirtualMachinePriorityTypes
    ...
    :type eviction_policy: str or
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineEvictionPolicyTypes
    ...
    :type billing_profile: ~azure.mgmt.compute.v2019_12.models.BillingProfile
    ...
    :type host: ~azure.mgmt.compute.v2019_12.models.SubResource
    :ivar provisioning_state: The provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    :ivar instance_view: The virtual machine instance view.
    :vartype instance_view:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineInstanceView
    ...
    :vartype resources:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineExtension]
    :param identity: The identity of the virtual machine, if configured.
    :type identity: ~azure.mgmt.compute.v2019_12.models.VirtualMachineIdentity
...
class VirtualMachineAgentInstanceView(Model):
    ...
    :type extension_handlers:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineExtensionHandlerInstanceView]
    :param statuses: The resource status information.
    :type statuses:
     list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    """
...
class VirtualMachineExtension(Resource):
    ...
    :type instance_view:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineExtensionInstanceView
    """
...
class VirtualMachineExtensionHandlerInstanceView(Model):
    ...
    :type status: ~azure.mgmt.compute.v2019_12.models.InstanceViewStatus
    """
...
class VirtualMachineIdentity(Model):
    ...
    :type type: str or
     ~azure.mgmt.compute.v2019_12.models.ResourceIdentityType
    ...
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineIdentityUserAssignedIdentitiesValue]
    """
...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :type tags: dict[str, str]
    :param plan:
    :type plan: ~azure.mgmt.compute.v2019_12.models.PurchasePlan
    :param os_disk_image:
    :type os_disk_image: ~azure.mgmt.compute.v2019_12.models.OSDiskImage
    :param data_disk_images:
    :type data_disk_images:
     list[~azure.mgmt.compute.v2019_12.models.DataDiskImage]
    :param automatic_os_upgrade_properties:
    :type automatic_os_upgrade_properties:
     ~azure.mgmt.compute.v2019_12.models.AutomaticOSUpgradeProperties
...
class VirtualMachineInstanceView(Model):
    ...
    :type hyper_vgeneration: str or
     ~azure.mgmt.compute.v2019_12.models.HyperVGenerationType
    ...
    :type vm_agent:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineAgentInstanceView
    :param maintenance_redeploy_status: The Maintenance Operation status on
     the virtual machine.
    :type maintenance_redeploy_status:
     ~azure.mgmt.compute.v2019_12.models.MaintenanceRedeployStatus
    :param disks: The virtual machine disk information.
    :type disks: list[~azure.mgmt.compute.v2019_12.models.DiskInstanceView]
    :param extensions: The extensions information.
    :type extensions:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineExtensionInstanceView]
    :param boot_diagnostics: Boot Diagnostics is a debugging feature which
     allows you to view Console Output and Screenshot to diagnose VM status.
     <br><br> You can easily view the output of your console log. <br><br>
     Azure also enables you to see a screenshot of the VM from the hypervisor.
    :type boot_diagnostics:
     ~azure.mgmt.compute.v2019_12.models.BootDiagnosticsInstanceView
    :param statuses: The resource status information.
    :type statuses:
     list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    """
...
class VirtualMachineScaleSet(Resource):
    ...
    :type upgrade_policy: ~azure.mgmt.compute.v2019_12.models.UpgradePolicy
    :param automatic_repairs_policy: Policy for automatic repairs.
    :type automatic_repairs_policy:
     ~azure.mgmt.compute.v2019_12.models.AutomaticRepairsPolicy
    :param virtual_machine_profile: The virtual machine profile.
    :type virtual_machine_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVMProfile
    :ivar provisioning_state: The provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    ...
    :param scale_in_policy: Specifies the scale-in policy that decides which
     ...
     is scaled-in.
    :type scale_in_policy: ~azure.mgmt.compute.v2019_12.models.ScaleInPolicy
    :param identity: The identity of the virtual machine scale set, if
     configured.
    :type identity:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetIdentity
...
class VirtualMachineScaleSetDataDisk(Model):
    ...
    :param managed_disk: The managed disk parameters.
    :type managed_disk:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetManagedDiskParameters
...
class VirtualMachineScaleSetExtensionProfile(Model):
    ...
    :param extensions: The virtual machine scale set child extension
     resources.
    :type extensions:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetExtension]
    """
...
class VirtualMachineScaleSetIdentity(Model):
    ...
    :param user_assigned_identities: The list of user identities associated
     ...
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetIdentityUserAssignedIdentitiesValue]
    """
...
class VirtualMachineScaleSetInstanceView(Model):
    ...
    :vartype virtual_machine:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetInstanceViewStatusesSummary
    :ivar extensions: The extensions information.
    :vartype extensions:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVMExtensionsSummary]
    :param statuses: The resource status information.
    :type statuses:
     list[~azure.mgmt.compute.v2019_12.models.InstanceViewStatus]
    """
...
class VirtualMachineScaleSetInstanceViewStatusesSummary(Model):
    ...
    :vartype statuses_summary:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineStatusCodeCount]
    """
...
class VirtualMachineScaleSetIPConfiguration(SubResource):
    ...
    :type subnet: ~azure.mgmt.compute.v2019_12.models.ApiEntityReference
    :param primary: Specifies the primary network interface in case the
     virtual machine has more than 1 network interface.
    :type primary: bool
    :param public_ip_address_configuration: The publicIPAddressConfiguration.
    :type public_ip_address_configuration:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetPublicIPAddressConfiguration
    ...
    :type private_ip_address_version: str or
     ~azure.mgmt.compute.v2019_12.models.IPVersion
...
class VirtualMachineScaleSetNetworkConfiguration(SubResource):
    ...
    :param dns_settings: The dns settings to be applied on the network
     interfaces.
    :type dns_settings:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetNetworkConfigurationDnsSettings
    :param ip_configurations: Required. Specifies the IP configurations of the
     network interface.
    :type ip_configurations:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetIPConfiguration]
...
class VirtualMachineScaleSetNetworkProfile(Model):
    ...
    :type health_probe: ~azure.mgmt.compute.v2019_12.models.ApiEntityReference
    :param network_interface_configurations: The list of network
     configurations.
    :type network_interface_configurations:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetNetworkConfiguration]
    """
...
class VirtualMachineScaleSetPublicIPAddressConfiguration(Model):
    ...
    :param dns_settings: The dns settings to be applied on the publicIP
     addresses .
    :type dns_settings:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings
    :param ip_tags: The list of IP tags associated with the public IP address.
    :type ip_tags:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetIpTag]
    :param public_ip_prefix: The PublicIPPrefix from which to allocate
     publicIP addresses.
    :type public_ip_prefix: ~azure.mgmt.compute.v2019_12.models.SubResource
...
class VirtualMachineScaleSetSku(Model):
    ...
    :vartype resource_type: str
    :ivar sku: The Sku.
    :vartype sku: ~azure.mgmt.compute.v2019_12.models.Sku
    :ivar capacity: Specifies the number of virtual machines in the scale set.
    :vartype capacity:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetSkuCapacity
    """
...
class VirtualMachineScaleSetSkuCapacity(Model):
    ...
    :vartype scale_type: str or
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetSkuScaleType
    """
...
class VirtualMachineScaleSetStorageProfile(Model):
    ...
    :param os_disk: Specifies information about the operating system disk used
     ...
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type os_disk:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetOSDisk
    :param data_disks: Specifies the parameters that are used to add data
     ...
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type data_disks:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetDataDisk]
    """
...
class VirtualMachineScaleSetUpdate(UpdateResource):
    ...
    :param virtual_machine_profile: The virtual machine profile.
    :type virtual_machine_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateVMProfile
    :param overprovision: Specifies whether the Virtual Machine Scale Set
     should be overprovisioned.
    :type overprovision: bool
    :param do_not_run_extensions_on_overprovisioned_vms: When Overprovision is
...
class VirtualMachineScaleSetUpdateIPConfiguration(SubResource):
    ...
    :param public_ip_address_configuration: The publicIPAddressConfiguration.
    :type public_ip_address_configuration:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdatePublicIPAddressConfiguration
    :param private_ip_address_version: Available from Api-Version 2017-03-30
     onwards, it represents whether the specific ipconfiguration is IPv4 or
     IPv6. Default is taken as IPv4.  Possible values are: 'IPv4' and 'IPv6'.
     Possible values include: 'IPv4', 'IPv6'
...
class VirtualMachineScaleSetUpdateNetworkConfiguration(SubResource):
    ...
    :type ip_configurations:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateIPConfiguration]
    :param enable_ip_forwarding: Whether IP forwarding enabled on this NIC.
    :type enable_ip_forwarding: bool
    """
...
class VirtualMachineScaleSetUpdateNetworkProfile(Model):
    ...
    :param network_interface_configurations: The list of network
     configurations.
    :type network_interface_configurations:
     list[~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateNetworkConfiguration]
    """
...
class VirtualMachineScaleSetUpdateStorageProfile(Model):
    ...
    :type os_disk:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateOSDisk
...
class VirtualMachineScaleSetUpdateVMProfile(Model):
    ...
    :type os_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateOSProfile
    :param storage_profile: The virtual machine scale set storage profile.
    :type storage_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateStorageProfile
    :param network_profile: The virtual machine scale set network profile.
    :type network_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetUpdateNetworkProfile
    ...
    :type extension_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetExtensionProfile
    ...
    :type scheduled_events_profile:
     ~azure.mgmt.compute.v2019_12.models.ScheduledEventsProfile
    """
...
class VirtualMachineScaleSetVM(Resource):
    ...
    :ivar instance_view: The virtual machine instance view.
    :vartype instance_view:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVMInstanceView
    :param hardware_profile: Specifies the hardware settings for the virtual
     machine.
    :type hardware_profile:
     ~azure.mgmt.compute.v2019_12.models.HardwareProfile
    ...
    :type network_profile_configuration:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVMNetworkProfileConfiguration
    :param diagnostics_profile: Specifies the boot diagnostic settings state.
     <br><br>Minimum api-version: 2015-06-15.
    :type diagnostics_profile:
     ~azure.mgmt.compute.v2019_12.models.DiagnosticsProfile
    ...
    :type protection_policy:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVMProtectionPolicy
    :param plan: Specifies information about the marketplace image used to
     create the virtual machine. This element is only used for marketplace
     images. Before you can use a marketplace image from an API, you must
     enable the image for programmatic use.  In the Azure portal, find the
...
class VirtualMachineScaleSetVMInstanceView(Model):
    ...
    :vartype vm_health:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineHealthStatus
    :param boot_diagnostics: Boot Diagnostics is a debugging feature which
     allows you to view Console Output and Screenshot to diagnose VM status.
     <br><br> You can easily view the output of your console log. <br><br>
     Azure also enables you to see a screenshot of the VM from the hypervisor.
...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    :type os_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetOSProfile
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetStorageProfile
    :param network_profile: Specifies properties of the network interfaces of
     the virtual machines in the scale set.
    :type network_profile:
     ~azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetNetworkProfile
    :param diagnostics_profile: Specifies the boot diagnostic settings state.
     <br><br>Minimum api-version: 2015-06-15.
    :type diagnostics_profile:
     ~azure.mgmt.compute.v2019_12.models.DiagnosticsProfile
...
class WindowsConfiguration(Model):
    ...
    :type additional_unattend_content:
     list[~azure.mgmt.compute.v2019_12.models.AdditionalUnattendContent]
    :param win_rm: Specifies the Windows Remote Management listeners. This
     enables remote Windows PowerShell.
    :type win_rm: ~azure.mgmt.compute.v2019_12.models.WinRMConfiguration
    """
...
class WinRMConfiguration(Model):
    ...
    :type listeners: list[~azure.mgmt.compute.v2019_12.models.WinRMListener]
    """
...
class WinRMListener(Model):
    ...
    :param protocol: Specifies the protocol of listener. <br><br> Possible
     ...
     'Http', 'Https'
    :type protocol: str or ~azure.mgmt.compute.v2019_12.models.ProtocolTypes
    :param certificate_url: This is the URL of a certificate that has been
     uploaded to Key Vault as a secret. For adding a secret to the Key Vault,
     see [Add a key or secret to the key
     vault](https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add).

...
class ComputeOperationValuePaged(Paged):
    """
    A paging container for iterating over a list of :class:`ComputeOperationValue <azure.mgmt.compute.v2019_12.models.ComputeOperationValue>` object
    """
...
class AvailabilitySetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`AvailabilitySet <azure.mgmt.compute.v2019_12.models.AvailabilitySet>` object
    """
...
class VirtualMachineSizePaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineSize <azure.mgmt.compute.v2019_12.models.VirtualMachineSize>` object
    """
...
class ProximityPlacementGroupPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ProximityPlacementGroup <azure.mgmt.compute.v2019_12.models.ProximityPlacementGroup>` object
    """
...
class DedicatedHostGroupPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DedicatedHostGroup <azure.mgmt.compute.v2019_12.models.DedicatedHostGroup>` object
    """
...
class DedicatedHostPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DedicatedHost <azure.mgmt.compute.v2019_12.models.DedicatedHost>` object
    """
...
class UsagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Usage <azure.mgmt.compute.v2019_12.models.Usage>` object
    """
...
class VirtualMachinePaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachine <azure.mgmt.compute.v2019_12.models.VirtualMachine>` object
    """
...
class ImagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Image <azure.mgmt.compute.v2019_12.models.Image>` object
    """
...
class VirtualMachineScaleSetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSet <azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSet>` object
    """
...
class VirtualMachineScaleSetSkuPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetSku <azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetSku>` object
    """
...
class UpgradeOperationHistoricalStatusInfoPaged(Paged):
    """
    A paging container for iterating over a list of :class:`UpgradeOperationHistoricalStatusInfo <azure.mgmt.compute.v2019_12.models.UpgradeOperationHistoricalStatusInfo>` object
    """
...
class VirtualMachineScaleSetExtensionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetExtension <azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetExtension>` object
    """
...
class VirtualMachineScaleSetVMPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetVM <azure.mgmt.compute.v2019_12.models.VirtualMachineScaleSetVM>` object
    """
...
class RunCommandDocumentBasePaged(Paged):
    """
    A paging container for iterating over a list of :class:`RunCommandDocumentBase <azure.mgmt.compute.v2019_12.models.RunCommandDocumentBase>` object
    """
...
class ResourceSkuPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ResourceSku <azure.mgmt.compute.v2019_12.models.ResourceSku>` object
    """
...
class DiskPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Disk <azure.mgmt.compute.v2019_12.models.Disk>` object
    """
...
class SnapshotPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Snapshot <azure.mgmt.compute.v2019_12.models.Snapshot>` object
    """
...
class DiskEncryptionSetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DiskEncryptionSet <azure.mgmt.compute.v2019_12.models.DiskEncryptionSet>` object
    """
...
class GalleryPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Gallery <azure.mgmt.compute.v2019_12.models.Gallery>` object
    """
...
class GalleryImagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`GalleryImage <azure.mgmt.compute.v2019_12.models.GalleryImage>` object
    """
...
class GalleryImageVersionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`GalleryImageVersion <azure.mgmt.compute.v2019_12.models.GalleryImageVersion>` object
    """
...
class GalleryApplicationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`GalleryApplication <azure.mgmt.compute.v2019_12.models.GalleryApplication>` object
    """
...
class GalleryApplicationVersionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`GalleryApplicationVersion <azure.mgmt.compute.v2019_12.models.GalleryApplicationVersion>` object
    """
...
class ContainerServicePaged(Paged):
    """
    A paging container for iterating over a list of :class:`ContainerService <azure.mgmt.compute.v2019_12.models.ContainerService>` object
    """

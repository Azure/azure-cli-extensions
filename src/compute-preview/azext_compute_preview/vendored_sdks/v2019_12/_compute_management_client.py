...
from .operations import SharedVmExtensionsOperations
from .operations import SharedVmExtensionVersionsOperations
...
class ComputeManagementClient(SDKClient):
    ...
    :vartype operations: azure.mgmt.compute.v2019_12.operations.Operations
    :ivar availability_sets: AvailabilitySets operations
    :vartype availability_sets: azure.mgmt.compute.v2019_12.operations.AvailabilitySetsOperations
    :ivar proximity_placement_groups: ProximityPlacementGroups operations
    :vartype proximity_placement_groups: azure.mgmt.compute.v2019_12.operations.ProximityPlacementGroupsOperations
    :ivar dedicated_host_groups: DedicatedHostGroups operations
    :vartype dedicated_host_groups: azure.mgmt.compute.v2019_12.operations.DedicatedHostGroupsOperations
    :ivar dedicated_hosts: DedicatedHosts operations
    :vartype dedicated_hosts: azure.mgmt.compute.v2019_12.operations.DedicatedHostsOperations
    :ivar virtual_machine_extension_images: VirtualMachineExtensionImages operations
    :vartype virtual_machine_extension_images: azure.mgmt.compute.v2019_12.operations.VirtualMachineExtensionImagesOperations
    :ivar virtual_machine_extensions: VirtualMachineExtensions operations
    :vartype virtual_machine_extensions: azure.mgmt.compute.v2019_12.operations.VirtualMachineExtensionsOperations
    :ivar virtual_machine_images: VirtualMachineImages operations
    :vartype virtual_machine_images: azure.mgmt.compute.v2019_12.operations.VirtualMachineImagesOperations
    :ivar usage: Usage operations
    :vartype usage: azure.mgmt.compute.v2019_12.operations.UsageOperations
    :ivar virtual_machines: VirtualMachines operations
    :vartype virtual_machines: azure.mgmt.compute.v2019_12.operations.VirtualMachinesOperations
    :ivar virtual_machine_sizes: VirtualMachineSizes operations
    :vartype virtual_machine_sizes: azure.mgmt.compute.v2019_12.operations.VirtualMachineSizesOperations
    :ivar images: Images operations
    :vartype images: azure.mgmt.compute.v2019_12.operations.ImagesOperations
    :ivar virtual_machine_scale_sets: VirtualMachineScaleSets operations
    :vartype virtual_machine_scale_sets: azure.mgmt.compute.v2019_12.operations.VirtualMachineScaleSetsOperations
    :ivar virtual_machine_scale_set_extensions: VirtualMachineScaleSetExtensions operations
    :vartype virtual_machine_scale_set_extensions: azure.mgmt.compute.v2019_12.operations.VirtualMachineScaleSetExtensionsOperations
    :ivar virtual_machine_scale_set_rolling_upgrades: VirtualMachineScaleSetRollingUpgrades operations
    :vartype virtual_machine_scale_set_rolling_upgrades: azure.mgmt.compute.v2019_12.operations.VirtualMachineScaleSetRollingUpgradesOperations
    :ivar virtual_machine_scale_set_vm_extensions: VirtualMachineScaleSetVMExtensions operations
    :vartype virtual_machine_scale_set_vm_extensions: azure.mgmt.compute.v2019_12.operations.VirtualMachineScaleSetVMExtensionsOperations
    :ivar virtual_machine_scale_set_vms: VirtualMachineScaleSetVMs operations
    :vartype virtual_machine_scale_set_vms: azure.mgmt.compute.v2019_12.operations.VirtualMachineScaleSetVMsOperations
    :ivar log_analytics: LogAnalytics operations
    :vartype log_analytics: azure.mgmt.compute.v2019_12.operations.LogAnalyticsOperations
    :ivar virtual_machine_run_commands: VirtualMachineRunCommands operations
    :vartype virtual_machine_run_commands: azure.mgmt.compute.v2019_12.operations.VirtualMachineRunCommandsOperations
    :ivar resource_skus: ResourceSkus operations
    :vartype resource_skus: azure.mgmt.compute.v2019_12.operations.ResourceSkusOperations
    :ivar disks: Disks operations
    :vartype disks: azure.mgmt.compute.v2019_12.operations.DisksOperations
    :ivar snapshots: Snapshots operations
    :vartype snapshots: azure.mgmt.compute.v2019_12.operations.SnapshotsOperations
    :ivar disk_encryption_sets: DiskEncryptionSets operations
    :vartype disk_encryption_sets: azure.mgmt.compute.v2019_12.operations.DiskEncryptionSetsOperations
    :ivar galleries: Galleries operations
    :vartype galleries: azure.mgmt.compute.v2019_12.operations.GalleriesOperations
    :ivar gallery_images: GalleryImages operations
    :vartype gallery_images: azure.mgmt.compute.v2019_12.operations.GalleryImagesOperations
    :ivar gallery_image_versions: GalleryImageVersions operations
    :vartype gallery_image_versions: azure.mgmt.compute.v2019_12.operations.GalleryImageVersionsOperations
    :ivar gallery_applications: GalleryApplications operations
    :vartype gallery_applications: azure.mgmt.compute.v2019_12.operations.GalleryApplicationsOperations
    :ivar gallery_application_versions: GalleryApplicationVersions operations
    :vartype gallery_application_versions: azure.mgmt.compute.v2019_12.operations.GalleryApplicationVersionsOperations
    :ivar shared_vm_extensions: SharedVmExtensions operations
    :vartype shared_vm_extensions: azure.mgmt.compute.v2019_12.operations.SharedVmExtensionsOperations
    :ivar shared_vm_extension_versions: SharedVmExtensionVersions operations
    :vartype shared_vm_extension_versions: azure.mgmt.compute.v2019_12.operations.SharedVmExtensionVersionsOperations
    :ivar container_services: ContainerServices operations
    :vartype container_services: azure.mgmt.compute.v2019_12.operations.ContainerServicesOperations
    ...
    def __init__(
        ...
        self.gallery_application_versions = GalleryApplicationVersionsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.shared_vm_extensions = SharedVmExtensionsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.shared_vm_extension_versions = SharedVmExtensionVersionsOperations(
            self._client, self.config, self._serialize, self._deserialize)

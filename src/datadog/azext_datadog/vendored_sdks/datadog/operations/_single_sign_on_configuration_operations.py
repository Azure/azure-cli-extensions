...
class SingleSignOnConfigurationOperations(object):
    """SingleSignOnConfigurationOperations operations.
    ...
    def _create_or_update_initial(
        ...
        properties=None,  # type: Optional["models.DatadogSingleSignOnProperties"]
        **kwargs  # type: Any
    ):

...
class MonitorOperations(object):
    ...
    def _create_initial(
        ...
        monitoring_status=None,  # type: Optional[Union[str, "models.MonitoringStatus"]]
        marketplace_subscription_status=None,  # type: Optional[Union[str, "models.MarketplaceSubscriptionStatus"]]

...
class ListApiKey(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MonitorsListApiKeys(ctx=self.ctx)()
    ...
    class MonitorsListApiKeys(AAZHttpOperation):
...
class _ListApiKeyHelper:
    """Helper class for ListApiKey"""

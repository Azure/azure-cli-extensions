...
@register_command(
    "datadog monitor get-default-key",
)
class GetDefaultKey(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MonitorsGetDefaultKey(ctx=self.ctx)()
    ...
    class MonitorsGetDefaultKey(AAZHttpOperation):
...
class _GetDefaultKeyHelper:
    """Helper class for GetDefaultKey"""


__all__ = ["GetDefaultKey"]

...
class LatestLinkedSaas(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DatadogMonitorResourcesLatestLinkedSaaS(ctx=self.ctx)()
    ...
    class DatadogMonitorResourcesLatestLinkedSaaS(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/latestLinkedSaaS",
                **self.url_parameters
            )

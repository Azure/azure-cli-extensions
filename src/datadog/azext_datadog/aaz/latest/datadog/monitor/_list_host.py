...
class ListHost(AAZCommand):
    ...
    class MonitorsListHosts(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.apps = AAZListType()
            _element.meta = AAZObjectType()
            _element.name = AAZStrType()

            aliases = cls._schema_on_200.value.Element.aliases
            aliases.Element = AAZStrType()

            apps = cls._schema_on_200.value.Element.apps
            apps.Element = AAZStrType()

            meta = cls._schema_on_200.value.Element.meta
            meta.agent_version = AAZStrType(
                serialized_name="agentVersion",
            )
            meta.install_method = AAZObjectType(
                serialized_name="installMethod",
            )
            meta.logs_agent = AAZObjectType(
                serialized_name="logsAgent",
            )

            install_method = cls._schema_on_200.value.Element.meta.install_method
            install_method.installer_version = AAZStrType(
                serialized_name="installerVersion",
            )
            install_method.tool = AAZStrType()
            install_method.tool_version = AAZStrType(
                serialized_name="toolVersion",
            )

            logs_agent = cls._schema_on_200.value.Element.meta.logs_agent
            logs_agent.transport = AAZStrType()

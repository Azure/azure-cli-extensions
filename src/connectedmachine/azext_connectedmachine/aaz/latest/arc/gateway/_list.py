...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.GatewaysListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.GatewaysListBySubscription(ctx=self.ctx)()
    ...
    class GatewaysListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            allowed_features = cls._schema_on_200.value.Element.properties.allowed_features
    ...
    class GatewaysListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

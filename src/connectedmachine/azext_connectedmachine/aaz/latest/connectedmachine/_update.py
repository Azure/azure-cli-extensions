...
class Update(AAZCommand):
    ...
    class MachinesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_record_string__read(_schema_on_200.tags)
            ...
            _UpdateHelper._build_schema_record_string__read(properties.detected_properties)
            ...
            _UpdateHelper._build_schema_record_string__read(assigned_license.tags)
            ...
            _UpdateHelper._build_schema_record_string__read(_element.tags)

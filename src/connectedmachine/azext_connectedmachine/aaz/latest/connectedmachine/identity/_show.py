...
class Show(AAZCommand):
    ...
    :example: Sample command for identity show
    ...
    class MachinesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_record<string>_read(_schema_on_200.tags)
            ...
            _ShowHelper._build_schema_record<string>_read(properties.detected_properties)
            ...
            _ShowHelper._build_schema_record<string>_read(assigned_license.tags)
            ...
            _ShowHelper._build_schema_record<string>_read(_element.tags)

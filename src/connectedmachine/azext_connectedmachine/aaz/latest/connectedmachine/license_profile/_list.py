...
class List(AAZCommand):
    ...
    :example: Sample command for license-profile list
        az connectedmachine license-profile list --resource-group "myResourceGroup" --subscription "mySubscription" --machine-name "myMachine"
    """

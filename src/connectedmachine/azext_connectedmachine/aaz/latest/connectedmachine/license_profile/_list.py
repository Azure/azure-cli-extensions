...
@register_command(
    "connectedmachine license-profile list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LicenseProfilesList(ctx=self.ctx)()
    ...
    class LicenseProfilesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            esu_profile = cls._schema_on_200.value.Element.properties.esu_profile
            ...
            esu_keys = cls._schema_on_200.value.Element.properties.esu_profile.esu_keys
            esu_keys.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.esu_profile.esu_keys.Element
            _element.license_status = AAZIntType(
                serialized_name="licenseStatus",
            )
            _element.sku = AAZStrType()

            product_profile = cls._schema_on_200.value.Element.properties.product_profile
            ...
            product_features = cls._schema_on_200.value.Element.properties.product_profile.product_features
            product_features.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.product_profile.product_features.Element
            ...
            software_assurance = cls._schema_on_200.value.Element.properties.software_assurance

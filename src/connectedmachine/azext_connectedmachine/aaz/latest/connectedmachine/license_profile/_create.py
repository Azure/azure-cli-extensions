...
class Create(AAZCommand):
    ...
    :example: Sample command for license-profile create
        az connectedmachine license-profile create --license-profile-name "myLicenseProfileName" --resource-group "myResourceGroup" --subscription "mySubscription" --machine-name "myMachine"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.subscription_status = AAZStrArg(
            ...
            enum={"Disabled": "Disabled", "Enabled": "Enabled", "Enabling": "Enabling", "Unknown": "Unknown"},
        )

...
class Create(AAZCommand):
    ...
    :example: Sample command for license create
        az connectedmachine license create --name 'myESULicense' --resource-group 'ytongtest' --location 'eastus2euap' --license-type 'ESU' --state 'Activated' --target 'Windows Server 2012' --edition 'Datacenter' --type 'pCore' --processors 16 --subscription 'b24cc8ee-df4f-48ac-94cf-46edf36b0fae'
    """

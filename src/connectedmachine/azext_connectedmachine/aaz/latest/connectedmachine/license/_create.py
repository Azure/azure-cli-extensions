...
class Create(AAZCommand):
    ...
    :example: Sample command for license create
        az connectedmachine license create --license-name "myLicenseName" --resource-group "myResourceGroup" --subscription "mySubscription" --location "eastus2euap" --license-type "ESU" --license-details "{{"state":"Activated", "target":"Windows Server 2012", "edition":"Datacenter", "type":"pCore", "processors":16}}"
    """

...
class List(AAZCommand):
    ...
    :example: Sample command for network-security-perimeter-configuration list
        az connectedmachine private-link-scope network-security-perimeter-configuration list --resource-group "myResourceGroup" --scope-name "myScopeName" --subscription "mySubscription"
    """

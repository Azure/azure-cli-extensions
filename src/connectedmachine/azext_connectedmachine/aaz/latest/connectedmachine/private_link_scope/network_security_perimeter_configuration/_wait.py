...
@register_command(
    "connectedmachine private-link-scope network-security-perimeter-configuration wait",
)
class Wait(AAZWaitCommand):
    ...
    class NetworkSecurityPerimeterConfigurationsGetByPrivateLinkScope(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_accessrule_read(access_rules.Element)
            ...
            _WaitHelper._build_schema_accessrule_read(suggested_access_rules.Element)

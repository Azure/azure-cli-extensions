...
class Show(AAZCommand):
    ...
    :example: Sample command for network-security-perimeter-configuration show
        az connectedmachine private-link-scope network-security-perimeter-configuration show --resource-group "myResourceGroup" --scope-name "myScopeName" --subscription "mySubscription" --perimeter-name "myPrimeterName"
    """
    ...
    class NetworkSecurityPerimeterConfigurationsGetByPrivateLinkScope(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            profile.diagnostic_settings_version = AAZStrType(

...
class Show(AAZCommand):
    ...
    class MachineRunCommandsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_runcommandmanagedidentity_read(properties.error_blob_managed_identity)
            ...
            _ShowHelper._build_schema_runcommandmanagedidentity_read(properties.output_blob_managed_identity)
            ...
            _ShowHelper._build_schema_runcommandinputparameter_read(parameters.Element)

            protected_parameters = cls._schema_on_200.properties.protected_parameters
            protected_parameters.Element = AAZObjectType()
            _ShowHelper._build_schema_runcommandinputparameter_read(protected_parameters.Element)
            ...
            _ShowHelper._build_schema_runcommandmanagedidentity_read(source.script_uri_managed_identity)

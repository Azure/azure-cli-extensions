...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_runcommandmanagedidentity_create_or_update_update(_args_schema.error_blob_managed_identity)
        ...
        cls._build_args_runcommandmanagedidentity_create_or_update_update(_args_schema.output_blob_managed_identity)
        ...
        cls._build_args_runcommandinputparameter_create_or_update_update(parameters.Element)

        protected_parameters = cls._args_schema.protected_parameters
        protected_parameters.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_runcommandinputparameter_create_or_update_update(protected_parameters.Element)
        ...
        cls._build_args_runcommandmanagedidentity_create_or_update_update(source.script_uri_managed_identity)
    ...
    _args_runcommandinputparameter_create_or_update_update = None

    @classmethod
    def _build_args_runcommandinputparameter_create_or_update_update(cls, _schema):
        if cls._args_runcommandinputparameter_create_or_update_update is not None:
            _schema.name = cls._args_runcommandinputparameter_create_or_update_update.name
            _schema.value = cls._args_runcommandinputparameter_create_or_update_update.value
            return

        cls._args_runcommandinputparameter_create_or_update_update = AAZObjectArg(
            nullable=True,
        )

        runcommandinputparameter_create_or_update_update = cls._args_runcommandinputparameter_create_or_update_update
        runcommandinputparameter_create_or_update_update.name = AAZStrArg(
            options=["name"],
            help="The run command parameter name.",
        )
        runcommandinputparameter_create_or_update_update.value = AAZStrArg(
            options=["value"],
    ...
    _args_runcommandmanagedidentity_create_or_update_update = None

    @classmethod
    def _build_args_runcommandmanagedidentity_create_or_update_update(cls, _schema):
        if cls._args_runcommandmanagedidentity_create_or_update_update is not None:
            _schema.client_id = cls._args_runcommandmanagedidentity_create_or_update_update.client_id
            _schema.object_id = cls._args_runcommandmanagedidentity_create_or_update_update.object_id
            return

        cls._args_runcommandmanagedidentity_create_or_update_update = AAZObjectArg(
            nullable=True,
        )

        runcommandmanagedidentity_create_or_update_update = cls._args_runcommandmanagedidentity_create_or_update_update
        runcommandmanagedidentity_create_or_update_update.client_id = AAZStrArg(
            options=["client-id"],
            help="Client Id (GUID value) of the user-assigned managed identity. ObjectId should not be used if this is provided.",
            nullable=True,
        )
        runcommandmanagedidentity_create_or_update_update.object_id = AAZStrArg(
            options=["object-id"],
    ...
    class MachineRunCommandsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_runcommandmanagedidentity_read(properties.error_blob_managed_identity)
            ...
            _UpdateHelper._build_schema_runcommandmanagedidentity_read(properties.output_blob_managed_identity)
            ...
            _UpdateHelper._build_schema_runcommandinputparameter_read(parameters.Element)

            protected_parameters = cls._schema_on_200.properties.protected_parameters
            protected_parameters.Element = AAZObjectType()
            _UpdateHelper._build_schema_runcommandinputparameter_read(protected_parameters.Element)
            ...
            _UpdateHelper._build_schema_runcommandmanagedidentity_read(source.script_uri_managed_identity)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_runcommandmanagedidentity_create_or_update_update(properties.set_prop("errorBlobManagedIdentity", AAZObjectType, ".error_blob_managed_identity"))
                properties.set_prop("errorBlobUri", AAZStrType, ".error_blob_uri")
                _UpdateHelper._build_schema_runcommandmanagedidentity_create_or_update_update(properties.set_prop("outputBlobManagedIdentity", AAZObjectType, ".output_blob_managed_identity"))
            ...
            if parameters is not None:
                _UpdateHelper._build_schema_runcommandinputparameter_create_or_update_update(parameters.set_elements(AAZObjectType, "."))

            protected_parameters = _builder.get(".properties.protectedParameters")
            if protected_parameters is not None:
                _UpdateHelper._build_schema_runcommandinputparameter_create_or_update_update(protected_parameters.set_elements(AAZObjectType, "."))
            ...
            if source is not None:
                ...
                _UpdateHelper._build_schema_runcommandmanagedidentity_create_or_update_update(source.set_prop("scriptUriManagedIdentity", AAZObjectType, ".script_uri_managed_identity"))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_runcommandinputparameter_create_or_update_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_runcommandmanagedidentity_create_or_update_update(cls, _builder):
        if _builder is None:
            return

...
class Update(AAZCommand):
    """Update operation to update the run command.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MachineRunCommandsUpdate(ctx=self.ctx)()
    ...
    class MachineRunCommandsUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_run_command_managed_identity_read(properties.error_blob_managed_identity)
            ...
            _UpdateHelper._build_schema_run_command_managed_identity_read(properties.output_blob_managed_identity)
            ...
            _UpdateHelper._build_schema_run_command_input_parameter_read(parameters.Element)

            protected_parameters = cls._schema_on_200.properties.protected_parameters
            protected_parameters.Element = AAZObjectType()
            _UpdateHelper._build_schema_run_command_input_parameter_read(protected_parameters.Element)
            ...
            _UpdateHelper._build_schema_run_command_managed_identity_read(source.script_uri_managed_identity)

...
class ListBySub(AAZCommand):
    ...
    class MachinesListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListBySubHelper._build_schema_record<string>_read(_element.tags)
            ...
            _ListBySubHelper._build_schema_record<string>_read(properties.detected_properties)
            ...
            _ListBySubHelper._build_schema_record<string>_read(assigned_license.tags)
            ...
            _ListBySubHelper._build_schema_record<unknown>_read(properties.protected_settings)
            properties.provisioning_state = AAZStrType(
                serialized_name="provisioningState",
                flags={"read_only": True},
            )
            ...
            _ListBySubHelper._build_schema_record<unknown>_read(properties.settings)

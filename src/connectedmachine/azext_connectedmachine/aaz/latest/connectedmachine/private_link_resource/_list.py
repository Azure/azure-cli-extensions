...
class List(AAZCommand):
    ...
    :example: Sample command for private-link-resource list
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PrivateLinkResourcesListByPrivateLinkScope(ctx=self.ctx)()
    ...
    class PrivateLinkResourcesListByPrivateLinkScope(AAZHttpOperation):

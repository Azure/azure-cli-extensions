...
@register_command(
    "connectedmachine private-endpoint-connection wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.hybridcompute/privatelinkscopes/{}/privateendpointconnections/{}", "2025-02-19-preview"],
        ]
    }

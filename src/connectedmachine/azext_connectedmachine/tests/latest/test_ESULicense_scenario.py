...
# - az connectedmachine network-configuration: Manage the network configuration on an Azure Arc-Enabled Server
# - az connectedmachine private-link-scope network-security-perimeter-configuration: Manage the network security perimeter configuration on an Azure Arc-Enabled Server
...
class ESULicenseScenarioTest(ScenarioTest):
    ...
    def test_esu_license(self):
        ...
        # product_feature_string = '''[{"name":"HotPatching","subscriptionStatus":"Enabled"}]'''
        # self.kwargs['product_feature'] = json.dumps(product_feature_string)

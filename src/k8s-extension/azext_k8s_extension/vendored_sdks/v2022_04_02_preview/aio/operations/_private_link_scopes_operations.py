...
from ...operations._private_link_scopes_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_tags_request
T = TypeVar('T')
...
class PrivateLinkScopesOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.KubernetesConfigurationPrivateLinkScopeListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2022_04_02_preview.models.KubernetesConfigurationPrivateLinkScopeListResult]

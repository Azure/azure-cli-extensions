...
class SourceControlConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.mgmt.kubernetesconfiguration.v2022_01_15_preview.models.SourceControlConfiguration
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SourceControlConfigurationList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2022_01_15_preview.models.SourceControlConfigurationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

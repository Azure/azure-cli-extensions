...
class ExtensionsOperations(object):
    ...
    def create(
            self, resource_group_name, cluster_rp, cluster_resource_name, cluster_name, extension_instance_name, extension_instance, custom_headers=None, raw=False, **operation_config):
        ...
        :type extension_instance:
         ~azure.mgmt.kubernetesconfiguration.models.ExtensionInstance
    ...
    def get(
            self, resource_group_name, cluster_rp, cluster_resource_name, cluster_name, extension_instance_name, custom_headers=None, raw=False, **operation_config):
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of ExtensionInstance
        :rtype:
         ~azure.mgmt.kubernetesconfiguration.models.ExtensionInstancePaged[~azure.mgmt.kubernetesconfiguration.models.ExtensionInstance]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.kubernetesconfiguration.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExtensionInstancePaged(internal_paging, self._deserialize.dependencies, header_dict)

...
class ExtensionTypesOperations:
    ...
    def location_list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.ExtensionType]
    ...
    def list_versions(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ExtensionTypeVersionForReleaseTrain or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.ExtensionTypeVersionForReleaseTrain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

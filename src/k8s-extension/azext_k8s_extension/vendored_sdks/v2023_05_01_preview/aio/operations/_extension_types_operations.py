...
class ExtensionTypesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.aio.SourceControlConfigurationClient`'s
    ...
    def location_list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.ExtensionType]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_location_list_request(
                    location=location,
                    ...
                    template_url=self.location_list.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    async def location_get(self, location: str, extension_type_name: str, **kwargs: Any) -> _models.ExtensionType:
        ...
        :rtype: ~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.ExtensionType
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_location_get_request(
            location=location,
            extension_type_name=extension_type_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.location_get.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    location_get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.KubernetesConfiguration/locations/{location}/extensionTypes/{extensionTypeName}"
    }
    ...
    def list_versions(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ExtensionTypeVersionForReleaseTrain or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.ExtensionTypeVersionForReleaseTrain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_version(
        ...
        deserialized = self._deserialize("ExtensionTypeVersionForReleaseTrain", pipeline_response)
    ...
    get_version.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.KubernetesConfiguration/locations/{location}/extensionTypes/{extensionTypeName}/versions/{versionNumber}"
    }
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_cluster_list_versions_request(
                    resource_group_name=resource_group_name,
                    cluster_rp=cluster_rp,
                    cluster_resource_name=cluster_resource_name,
                    cluster_name=cluster_name,
                    ...
                    show_latest=show_latest,
                    api_version=api_version,
                    template_url=self.cluster_list_versions.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    cluster_list_versions.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/{clusterResourceName}/{clusterName}/providers/Microsoft.KubernetesConfiguration/extensionTypes/{extensionTypeName}/versions"
    }
    ...
    async def cluster_get_version(
        ...
        **kwargs: Any
        ...
        request = build_cluster_get_version_request(
            resource_group_name=resource_group_name,
            cluster_rp=cluster_rp,
            cluster_resource_name=cluster_resource_name,
            cluster_name=cluster_name,
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.cluster_get_version.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    cluster_get_version.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/{clusterResourceName}/{clusterName}/providers/Microsoft.KubernetesConfiguration/extensionTypes/{extensionTypeName}/versions/{versionNumber}"
    }

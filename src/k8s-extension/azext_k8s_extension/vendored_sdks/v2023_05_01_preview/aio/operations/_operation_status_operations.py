...
from ...operations._operation_status_operations import build_list_request
...
class OperationStatusOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either OperationStatusResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.models.OperationStatusResult]

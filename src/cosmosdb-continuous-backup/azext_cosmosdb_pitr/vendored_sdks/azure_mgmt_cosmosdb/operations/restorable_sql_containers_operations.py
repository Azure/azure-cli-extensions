...
class RestorableSqlContainersOperations(object):
    ...
    def list(
        ...
        deserialized = models.RestorableSqlContainerGetResultPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RestorableSqlContainerGetResultPaged(internal_paging, self._deserialize.dependencies, header_dict)

...
class RestorableMongodbDatabasesOperations(object):
    ...
    def list(
        ...
        deserialized = models.RestorableMongodbDatabaseGetResultPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RestorableMongodbDatabaseGetResultPaged(internal_paging, self._deserialize.dependencies, header_dict)

...
examples:
  ...
  - name: Creates a new Azure Cosmos DB database account by restoring from an existing account in the given location
...
type: command
short-summary: Creates a new Azure Cosmos DB database account by restoring from an existing database account.
parameters:
  - name: --databases-to-restore
    short-summary: Add a database and its collection names to restore
    long-summary: |
...
examples:
  - name: Creates a new Azure Cosmos DB database account by restoring from an existing database account. (autogenerated)
    ...
    crafted: true
  - name: Creates a new Azure Cosmos DB database account by restoring only the selected databases and collections from an existing database account.

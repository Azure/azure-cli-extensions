        ...
        for k in properties:
            ...
            if kl == 'name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter plan. All possible keys are: name, '
                               'publisher, product, promotion-code, version'.format(k))
        return d
        ...
        for k in properties:
            ...
            if kl == 'name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter schedules. All possible keys are: name, '
                               'days-of-week, ramp-up-start-time, ramp-up-load-balancing-algorithm, '
                               'ramp-up-minimum-hosts-pct, ramp-up-capacity-threshold-pct, peak-start-time, '
                               'peak-load-balancing-algorithm, ramp-down-start-time, ramp-down-load-balancing-algorithm'
                               ', ramp-down-minimum-hosts-pct, ramp-down-capacity-threshold-pct, '
                               'ramp-down-force-logoff-users, ramp-down-stop-hosts-when, ramp-down-wait-time-minutes, '
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'operation':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter migration_request. All possible keys are: '
                               'operation, migration-path'.format(k))
        return d

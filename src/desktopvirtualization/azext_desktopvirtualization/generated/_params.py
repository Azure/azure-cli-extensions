...
def load_arguments(self, _):
    ...
    with self.argument_context('desktopvirtualization workspace create') as c:
        ...
        c.argument('application_group_references', nargs='+', help='List of applicationGroup resource Ids. Expected val'
    ...
    with self.argument_context('desktopvirtualization workspace update') as c:
        ...
        c.argument('description', help='Description of Workspace.')
        c.argument('friendly_name', help='Friendly name of Workspace.')
        c.argument('application_group_references', nargs='+', help='List of applicationGroup links. Expected value: jso'
                   'n-string/@json-file.')
    ...
    with self.argument_context('desktopvirtualization applicationgroup show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('application_group_name', help='The name of the application group')
    ...
    with self.argument_context('desktopvirtualization applicationgroup create') as c:
        ...
        c.argument('application_group_type', arg_type=get_enum_type(['RemoteApp', 'Desktop']), help='Resource Type of A'
                   'pplicationGroup.')
    ...
    with self.argument_context('desktopvirtualization hostpool show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('host_pool_name', help='The name of the host pool within the specified resource group')
    ...
    with self.argument_context('desktopvirtualization hostpool create') as c:
        ...
        c.argument('personal_desktop_assignment_type', arg_type=get_enum_type(['Automatic', 'Direct']), help='PersonalD'
                   'esktopAssignment type for HostPool.')
        ...
        c.argument('load_balancer_type', arg_type=get_enum_type(['BreadthFirst', 'DepthFirst', 'Persistent']), help='Th'
                   'e type of the load balancer.')
        ...
        c.argument('registration_info', action=AddDesktopvirtualizationHostpoolCreateRegistrationInfo, nargs='+',
                   help='The registration info of HostPool. Expect value: KEY1=VALUE1 KEY2=VALUE2 ... , available KEYs '
                   'are: expiration-time, token, registration-token-operation.')
    ...
    with self.argument_context('desktopvirtualization hostpool update') as c:
        ...
        c.argument('registration_info', action=AddDesktopvirtualizationHostpoolUpdateRegistrationInfo, nargs='+',
                   help='The registration info of HostPool. Expect value: KEY1=VALUE1 KEY2=VALUE2 ... , available KEYs '
                   'are: expiration-time, registration-token-operation.')
        c.argument('sso_context', help='Path to keyvault containing ssoContext secret.')

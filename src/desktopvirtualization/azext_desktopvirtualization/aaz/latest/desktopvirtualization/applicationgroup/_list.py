...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ApplicationGroupsListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.ApplicationGroupsListBySubscription(ctx=self.ctx)()
    ...
    class ApplicationGroupsListByResourceGroup(AAZHttpOperation):
    ...
    class ApplicationGroupsListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

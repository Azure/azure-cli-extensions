...
def step_scaling_plan_create(test, checks=None):
    ...
    test.cmd('az desktopvirtualization scaling-plan create '
             ...
             'off-peak-start-time="2022-03-20T05:38:08.181Z" peak-load-balancing-algorithm="BreadthFirst" '
             ...
             '05:38:08.182Z" ramp-down-wait-time-minutes=30 ramp-up-capacity-threshold-pct=80 '
             'ramp-up-load-balancing-algorithm="DepthFirst" ramp-up-minimum-hosts-pct=20 '
             'ramp-up-start-time="2022-03-20T05:38:08.182Z" '
             '--time-zone "" '
             '--tags tag1="value1" tag2="value2" '
             '--name "{myScalingPlan}"',
             checks=checks)

...
class HealthCheckName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    SX_S_STACK_LISTENER_CHECK = "SxSStackListenerCheck"  #: Verifies that the SxS stack is up and running so connections can succeed. If this check fails is classified as fatal as no connection can succeed if the SxS stack is not ready.
...
class Status(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    SX_S_STACK_LISTENER_NOT_READY = "SxSStackListenerNotReady"  #: SxS stack installed on the SessionHost is not ready to receive connections.

...
class HostPoolOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: HostPool or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.HostPool or ~azure.mgmt.desktopvirtualization.models.HostPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.HostPool"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.HostPoolList"
        """List hostPools.

        :param resource_group_name: The name of the resource group. The name is case insensitive.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: HostPoolList or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.HostPoolList
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class HostPoolsOperations(object):
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        host_pool_name,  # type: str
        host_pool,  # type: "models.HostPool"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.HostPool"
    ...
    def update(
        ...
        resource_group_name,  # type: str
        host_pool_name,  # type: str
        host_pool=None,  # type: Optional["models.HostPoolPatch"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.HostPool"
        """Update a host pool.
    ...
    def retrieve_registration_token(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RegistrationInfo"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class SessionHostOperations(object):
    """SessionHostOperations operations.
    ...
    def update(
        ...
        host_pool_name,  # type: str
        session_host_name,  # type: str
        allow_new_session=None,  # type: Optional[bool]
        assigned_user=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SessionHost"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :type host_pool_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SessionHostList or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.SessionHostList
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class SessionHostsOperations(object):
    ...
    def get(
        ...
        session_host_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SessionHost"
        """Get a session host.
    ...
    def update(
        ...
        host_pool_name,  # type: str
        session_host_name,  # type: str
        session_host=None,  # type: Optional["models.SessionHostPatch"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SessionHost"
        ...
        :param session_host_name: The name of the session host within the specified host pool.
        :type session_host_name: str
        :param session_host: Object containing SessionHost definitions.
        :type session_host: ~desktop_virtualization_api_client.models.SessionHostPatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SessionHost, or the result of cls(response)
        :rtype: ~desktop_virtualization_api_client.models.SessionHost
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SessionHostList"]
        """List sessionHosts.

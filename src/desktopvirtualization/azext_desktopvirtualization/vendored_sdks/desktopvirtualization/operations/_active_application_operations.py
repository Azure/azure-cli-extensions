...
class ActiveApplicationOperations(object):
    """ActiveApplicationOperations operations.
    ...
    def list_by_session_host(
     ...
     and sessionstate.
        ...
        :return: ApplicationList or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.ApplicationList
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_by_session_host.metadata['url']
    ...
    list_by_session_host.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/activeApplications'}

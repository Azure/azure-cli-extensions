...
class ActiveApplicationOperations(object):
    ...
    def list_by_session_host(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ApplicationList"]
     ...
     and sessionstate.
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_by_session_host.metadata['url']  # type: ignore
    ...
    list_by_session_host.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/activeApplications'}  # type: ignore

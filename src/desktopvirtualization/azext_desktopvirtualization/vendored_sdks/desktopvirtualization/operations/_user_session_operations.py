...
class UserSessionOperations(object):
    """UserSessionOperations operations.
    ...
    def list_by_host_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.UserSessionList"]
        """List userSessions.
     ...
     and sessionstate.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~desktop_virtualization_api_client.models.UserSessionList]
    ...
    def get(
        ...
        user_session_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.UserSession"
        """Get a userSession.
    ...
    def send_message(
        ...
        session_host_name,  # type: str
        user_session_id,  # type: str
        message_title=None,  # type: Optional[str]
        message_body=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> None

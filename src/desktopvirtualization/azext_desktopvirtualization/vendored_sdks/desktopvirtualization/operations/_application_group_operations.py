...
class ApplicationGroupOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApplicationGroup or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.ApplicationGroup or ~azure.mgmt.desktopvirtualization.models.ApplicationGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGroup"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ApplicationGroupList"
     ...
     applicationGroupType.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApplicationGroupList or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.ApplicationGroupList
        :raises: ~azure.core.exceptions.HttpResponseError
        """

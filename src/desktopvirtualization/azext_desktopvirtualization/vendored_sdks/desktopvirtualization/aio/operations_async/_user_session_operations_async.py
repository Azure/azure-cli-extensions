...
class UserSessionOperations:
    ...
    def list_by_host_pool(
     ...
     and sessionstate.
        ...
        :return: UserSessionList or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.UserSessionList
    ...
    send_message.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/userSessions/{userSessionId}/sendMessage'}

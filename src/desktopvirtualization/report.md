...
--tags tag1="value1" tag2="value2" --name "hostPool1" --resource-group "resourceGroup1"
```
...
expiration-time="2020-10-01T15:01:54.9571247Z" registration-token-operation="Update" --sso-context "KeyVaultPath" \
--tags tag1="value1" tag2="value2" --name "hostPool1" --resource-group "resourceGroup1"
```

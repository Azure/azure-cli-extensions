...
class List(AAZCommand):
    ...
    class EnvironmentsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            onboarding = cls._schema_on_200.value.Element.properties.onboarding
            onboarding.developer_portal_uri = AAZListType(
                serialized_name="developerPortalUri",
            )
            onboarding.instructions = AAZStrType()

            developer_portal_uri = cls._schema_on_200.value.Element.properties.onboarding.developer_portal_uri
            ...
            management_portal_uri = cls._schema_on_200.value.Element.properties.server.management_portal_uri

...
class List(AAZCommand):
    ...
    class ApisList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            contacts = cls._schema_on_200.value.Element.properties.contacts
            contacts.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.contacts.Element
            _element.email = AAZStrType()
            _element.name = AAZStrType()
            _element.url = AAZStrType()

            external_documentation = cls._schema_on_200.value.Element.properties.external_documentation
            external_documentation.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.external_documentation.Element
            ...
            license = cls._schema_on_200.value.Element.properties.license
            license.identifier = AAZStrType()
            license.name = AAZStrType()
            license.url = AAZStrType()

            terms_of_service = cls._schema_on_200.value.Element.properties.terms_of_service

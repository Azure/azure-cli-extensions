...
class Create(AAZCommand):
    ...
    :example: Create Default Portal Configuration
        az apic service portal default create -g contoso-resources --service-name contoso --title "Contoso" --is-published false  --authentication'{"clientId":"00000000-0000-0000-0000-000000000000","tenantId":"00000000-0000-0000-0000-000000000000"}'
    """

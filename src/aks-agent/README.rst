...
1. Deploy the AKS agent Helm chart in your cluster
2. Configure Kubernetes RBAC for secure cluster resource access
3. Optionally configure Azure workload identity for Azure resource access
4. Guide you through LLM model configuration with credentials stored securely in Kubernetes secrets

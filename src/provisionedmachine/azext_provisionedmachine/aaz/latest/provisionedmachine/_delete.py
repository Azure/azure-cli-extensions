...
@register_command(
    "provisionedmachine delete",
    is_preview=True,
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a specific Provisioned Machine resource.

    :example: Delete a provisioned machine
        az provisionedmachine delete -n myProvisionedMachine -g myResourceGroup
    :example: Delete a provisioned machine (skip confirmation)
        az provisionedmachine delete -n myProvisionedMachine -g myResourceGroup --yes
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.EdgeMachinesDelete(ctx=self.ctx)()
    ...
    class EdgeMachinesDelete(AAZHttpOperation):

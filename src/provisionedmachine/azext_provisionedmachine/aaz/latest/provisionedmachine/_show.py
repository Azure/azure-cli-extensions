...
@register_command(
    "provisionedmachine show",
    is_preview=True,
)
class Show(AAZCommand):
    """Show a specific Provisioned Machine resource.

    :example: Show a provisioned machine
        az provisionedmachine show -n myProvisionedMachine -g myResourceGroup
    """
    ...
    def _output(self, *args, **kwargs):
        ...
        if isinstance(result, dict):
            result["apiVersion"] = self._aaz_info["version"]
        return result

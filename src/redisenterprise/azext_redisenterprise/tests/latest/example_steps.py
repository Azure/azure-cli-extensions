...
@try_manual
def step_database_list_key(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_private_endpoint_connection_put(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_private_link_resource_list(test, rg, checks=None):
    if checks is None:
        checks = []

...
@register_command(
    "redisenterprise database force-unlink",
)
class ForceUnlink(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.cache/redisenterprise/{}/databases/{}/forceunlink", "2026-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DatabasesForceUnlink(ctx=self.ctx)()
...
class _ForceUnlinkHelper:
    """Helper class for ForceUnlink"""

...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.geo_replication = AAZObjectArg(
            options=["--geo-replication"],
            arg_group="Properties",
            help="Optional set of properties to configure geo replication for this database.",
        )
        ...
        geo_replication = cls._args_schema.geo_replication
        geo_replication.group_nickname = AAZStrArg(
            options=["group-nickname"],
            help="Name for the group of linked database resources",
        )
        geo_replication.linked_databases = AAZListArg(
            options=["linked-databases"],
            help="List of database resources to link with this database",
        )

        linked_databases = cls._args_schema.geo_replication.linked_databases
        linked_databases.Element = AAZObjectArg()

        _element = cls._args_schema.geo_replication.linked_databases.Element
    ...
    class DatabasesCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("geoReplication", AAZObjectType, ".geo_replication")

...
@register_command(
    "data-transfer connection list-untitled1",
)
class ListUntitled1(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-05-21",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.azuredatatransfer/connections", "2025-05-21"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConnectionsListBySubscription(ctx=self.ctx)()
    ...
    class ConnectionsListBySubscription(AAZHttpOperation):

...
@register_command(
    "network alb association create",
)
class Create(AAZCommand):
    """Create an Application Gateway for Containers association resource

    :example: Create an Application Gateway for Containers association resource
        az network alb association create -g test-rg -n test-association --alb-name test-alb --subnet <subnetId>
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.subnet = AAZStrArg(
            options=["--subnet"],
            arg_group="Properties",
            help="Name or Id of exiting subnet resource",
        )

...
@register_command(
    "network alb association delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete an Application Gateway for Containers association resource

    :example: Delete an Application Gateway for Containers association resource
        az network alb association delete -g test-rg -n test-association --alb-name test-alb
    """

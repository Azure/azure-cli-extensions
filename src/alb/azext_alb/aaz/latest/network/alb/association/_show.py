...
@register_command(
    "network alb association show",
)
class Show(AAZCommand):
    """Get an Application Gateway for Containers association resource

    :example: Get the details of an Application Gateway for containers association resource
        az network alb association show -g test-rg -n test-association --alb-name test-alb
    """

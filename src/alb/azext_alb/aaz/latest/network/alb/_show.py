...
class Show(AAZCommand):
    ...
    class TrafficControllerInterfaceGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_resource_id_read(associations.Element)
            ...
            _ShowHelper._build_schema_resource_id_read(frontends.Element)

            security_policies = cls._schema_on_200.properties.security_policies
            security_policies.Element = AAZObjectType()
            _ShowHelper._build_schema_resource_id_read(security_policies.Element)

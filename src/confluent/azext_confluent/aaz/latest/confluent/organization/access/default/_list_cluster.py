...
class ListCluster(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessListClusters(ctx=self.ctx)()
    ...
    class AccessListClusters(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            spec = cls._schema_on_200.data.Element.spec
            ...
            byok = cls._schema_on_200.data.Element.spec.byok
            byok.id = AAZStrType()
            byok.related = AAZStrType()
            byok.resource_name = AAZStrType()

            config = cls._schema_on_200.data.Element.spec.config
            config.kind = AAZStrType()

            environment = cls._schema_on_200.data.Element.spec.environment
            environment.environment = AAZStrType()
            environment.id = AAZStrType()
            environment.related = AAZStrType()
            environment.resource_name = AAZStrType()

            network = cls._schema_on_200.data.Element.spec.network
            network.environment = AAZStrType()
            network.id = AAZStrType()
            network.related = AAZStrType()
            network.resource_name = AAZStrType()

            status = cls._schema_on_200.data.Element.status
...
class _ListClusterHelper:
    """Helper class for ListCluster"""

...
class ListInvitation(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessListInvitations(ctx=self.ctx)()
    ...
    class AccessListInvitations(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.accepted_at = AAZStrType()
            _element.auth_type = AAZStrType()
            _element.email = AAZStrType()
            _element.expires_at = AAZStrType()
...
class _ListInvitationHelper:
    """Helper class for ListInvitation"""


__all__ = ["ListInvitation"]

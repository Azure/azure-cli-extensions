...
@register_command(
    "confluent organization create-role-bindings",
)
class CreateRoleBindings(AAZCommand):
...
class _CreateRoleBindingsHelper:
    """Helper class for CreateRoleBindings"""


__all__ = ["CreateRoleBindings"]

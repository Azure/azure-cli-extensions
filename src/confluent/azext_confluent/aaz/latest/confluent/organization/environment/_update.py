...
class _UpdateHelper:
    ...
    def _build_schema_sc_environment_record_read(cls, _schema):
        if cls._schema_sc_environment_record_read is not None:
            ...
            _schema.system_data = cls._schema_sc_environment_record_read.system_data
        ...
        sc_environment_record_read.system_data = AAZObjectType(
        ...
        system_data = _schema_sc_environment_record_read.system_data

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.OrganizationListSchemaRegistryClusters(ctx=self.ctx)()
    ...
    class OrganizationListSchemaRegistryClusters(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_schema_registry_cluster_environment_region_entity_read(spec.environment)
            ...
            _ListHelper._build_schema_schema_registry_cluster_environment_region_entity_read(spec.region)

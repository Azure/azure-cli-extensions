...
class ListServiceAccounts(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessListServiceAccounts(ctx=self.ctx)()
    ...
    class AccessListServiceAccounts(AAZHttpOperation):
...
class _ListServiceAccountsHelper:
    """Helper class for ListServiceAccounts"""

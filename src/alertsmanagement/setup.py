...
VERSION = '0.1.0'
try:
    from azext_alertsmanagement.manual.version import VERSION
except ImportError:
    pass
...
try:
    from azext_alertsmanagement.manual.dependency import DEPENDENCIES
except ImportError:
    pass
...
setup(
    ...
    package_data={'azext_alertsmanagement': ['azext_metadata.json']},
)

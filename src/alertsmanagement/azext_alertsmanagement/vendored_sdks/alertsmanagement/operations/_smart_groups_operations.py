...
class SmartGroupsOperations(object):
    ...
    def get_all(
        ...
        sort_order=None,  # type: Optional[Union[str, "models.SortOrder"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.SmartGroupsList"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SmartGroupsList"]
        error_map = {

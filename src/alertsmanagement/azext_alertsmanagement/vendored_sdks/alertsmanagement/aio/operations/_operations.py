...
class Operations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.OperationsList]
    ...
    list.metadata = {'url': '/providers/Microsoft.AlertsManagement/operations'}  # type: ignore

...
class AlertProcessingRulesOperations:
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.AlertProcessingRulesList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.AlertProcessingRulesList]

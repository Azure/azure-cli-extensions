...
@register_command(
    "alerts-management prometheus-rule-group show",
)
class Show(AAZCommand):
    ...
    class PrometheusRuleGroupsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            action_properties = cls._schema_on_200.properties.rules.Element.actions.Element.action_properties
            action_properties.Element = AAZStrType()

            annotations = cls._schema_on_200.properties.rules.Element.annotations
            annotations.Element = AAZStrType()

            labels = cls._schema_on_200.properties.rules.Element.labels
            labels.Element = AAZStrType()

            resolve_configuration = cls._schema_on_200.properties.rules.Element.resolve_configuration

...
def load_command_table(self, _):
    ...
    with self.command_group('monitor action-rule', alertsmanagement_processing_rules, client_factory=cf_processing_rules,
        ...
        #g.custom_command('delete', 'delete_alertsmanagement_processing_rule')

...
helps['monitor alert-processing-rule create'] = """
    ...
    parameters:
      - name: --filter-alert-context
        ...
        long-summary: |
            Usage: --filter-alert-context <operator> <space seperated values>
      ...
      - name: --schedule-recurrence
        ...
        long-summary: |
            Usage: --filter-schedule-recurrence <space seperated values>
            
            values:
              If --schedule-recurrence-type is Weekly, allowed values range from Sunday to Saturday.
              If --schedule-recurrence-type is Monthly, allowed values range from 1 to 31, stands for day of month
    ...
    examples:
      - name: Create or update a rule that adds an action group to all alerts in a subscription
        text: |-
              ...
              --action-groups "/subscriptions/subId1/resourcegroups/RGId1/providers/microsoft.insights/actiongroups/ActionGroup1"
              --enabled true 
      ...
      - name: Create or update a rule that adds two action groups to all Sev0 and Sev1 alerts in two resource groups
        text: |-
              ...
              --rule-type AddActionGroups
              --action-groups "/subscriptions/subId1/resourcegroups/RGId1/providers/microsoft.insights/actiongroups/AGId1" "/subscriptions/subId1/resourceGroups/RGId1/providers/microsoft.insights/actionGroups/AGId2"
              --scopes "/subscriptions/subId1"
              --resource-group alertscorrelationrg
      ...
      - name: Create or update a rule that removes all action groups from all alerts in a subscription coming from a specific alert rule
        text: |-
              ...
              --scopes "/subscriptions/subId1"
              --resource-group alertscorrelationrg
              --filter-alert-rule-id Equals "/subscriptions/suubId1/resourceGroups/Rgid2/providers/microsoft.insights/activityLogAlerts/RuleName"

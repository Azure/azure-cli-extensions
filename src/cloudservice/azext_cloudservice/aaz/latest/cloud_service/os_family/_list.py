...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CloudServiceOperatingSystemsListOSFamilies(ctx=self.ctx)()
    ...
    class CloudServiceOperatingSystemsListOSFamilies(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.versions.Element

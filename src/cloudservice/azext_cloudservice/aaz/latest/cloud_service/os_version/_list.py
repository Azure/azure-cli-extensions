...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CloudServiceOperatingSystemsListOSVersions(ctx=self.ctx)()
    ...
    class CloudServiceOperatingSystemsListOSVersions(AAZHttpOperation):

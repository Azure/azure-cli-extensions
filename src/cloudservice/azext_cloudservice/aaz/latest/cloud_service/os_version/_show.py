...
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.os_version_name = AAZStrArg(
            options=["-n", "--name", "--os-version-name"],
            help="Name of the OS version.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CloudServiceOperatingSystemsGetOSVersion(ctx=self.ctx)()
    ...
    class CloudServiceOperatingSystemsGetOSVersion(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "osVersionName", self.ctx.args.os_version_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            properties.family_label = AAZStrType(
                serialized_name="familyLabel",
                flags={"read_only": True},
            )

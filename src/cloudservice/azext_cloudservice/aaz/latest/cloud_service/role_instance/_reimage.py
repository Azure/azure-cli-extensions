...
@register_command(
    "cloud-service role-instance reimage",
)
class Reimage(AAZCommand):
    """The reimage role instance asynchronous operation reinstalls the operating system on instances of web roles or worker roles.

    :example: Role instance reimage
        az cloud-service role-instance reimage -g rg --cloud-service-name cloudservice --role-instances-name name
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.role_instance_name = AAZStrArg(
            options=["--role-instance-name"],
            help="Name of the role instance.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CloudServiceRoleInstancesReimage(ctx=self.ctx)()
    ...
    class CloudServiceRoleInstancesReimage(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "roleInstanceName", self.ctx.args.role_instance_name,
                    required=True,
                ),
                **self.serialize_url_param(

...
class AppLogsConfiguration(Model):
    ...
    :type log_analytics_configuration:
     ~azure.mgmt.web.v2020_12_01.models.LogAnalyticsConfiguration
    """
...
class ArcConfiguration(Model):
    ...
    :type artifacts_storage_type: str or
     ~azure.mgmt.web.v2020_12_01.models.StorageType
    ...
    :type front_end_service_configuration:
     ~azure.mgmt.web.v2020_12_01.models.FrontEndConfiguration
    :param kube_config:
...
class AutoHealTriggers(Model):
    ...
    def __init__(self, *, requests=None, private_bytes_in_kb: int=None, status_codes=None, status_codes_range=None, slow_requests=None, slow_requests_with_path=None, **kwargs) -> None:
...
class Certificate(Resource):
    ...
    def __init__(self, *, location: str, kind: str=None, tags=None, host_names=None, pfx_blob: bytearray=None, password: str=None, key_vault_id: str=None, key_vault_secret_name: str=None, server_farm_id: str=None, canonical_name: str=None, domain_validation_method: str=None, **kwargs) -> None:
...
class CertificatePatchResource(ProxyOnlyResource):
    ...
    def __init__(self, *, kind: str=None, host_names=None, pfx_blob: bytearray=None, password: str=None, key_vault_id: str=None, key_vault_secret_name: str=None, server_farm_id: str=None, canonical_name: str=None, domain_validation_method: str=None, **kwargs) -> None:
...
class FrontEndConfiguration(Model):
    ...
    :type kind: str or ~azure.mgmt.web.v2020_12_01.models.FrontEndServiceType
    """
...
class IdentityProviders(ProxyOnlyResource):
    ...
    def __init__(self, *, kind: str=None, azure_active_directory=None, facebook=None, git_hub=None, google=None, legacy_microsoft_account=None, twitter=None, apple=None, azure_static_web_apps=None, custom_open_id_connect_providers=None, **kwargs) -> None:
...
class KubeEnvironment(Resource):
    ...
    :param tags: Resource tags.
    :type tags: dict[str, str]
    :param kube_environment_type: Type of the Kubernetes Environment.
     Only Set for WorkerApps as Managed
    :type kube_environment_type: str
    :param extended_location:
    :type extended_location:
     ~azure.mgmt.web.v2020_12_01.models.ExtendedLocation
    :ivar provisioning_state: Provisioning state of the Kubernetes
     ...
     'UpgradeFailed', 'AKSProvisionComplete'
    :vartype provisioning_state: str or
     ~azure.mgmt.web.v2020_12_01.models.KubeEnvironmentProvisioningState
    ...
    :type arc_configuration:
     ~azure.mgmt.web.v2020_12_01.models.ArcConfiguration
    :param app_logs_configuration: Cluster configuration which enables the log
     daemon to export
     app logs to a destination. Currently only "log-analytics" is
     supported
    :type app_logs_configuration:
     ~azure.mgmt.web.v2020_12_01.models.AppLogsConfiguration
    :param worker_apps_configuration: Cluster configuration which enables
     users to create Worker Apps
     enabled dedicated Kube Environments
    :type worker_apps_configuration:
     ~azure.mgmt.web.v2020_12_01.models.WorkerAppsConfiguration
    ...
    _attribute_map = {
        ...
        'type': {'key': 'type', 'type': 'str'},
        'tags': {'key': 'tags', 'type': '{str}'},
        'kube_environment_type': {'key': 'properties.type', 'type': 'str'},
        ...
        'worker_apps_configuration': {'key': 'properties.workerAppsConfiguration', 'type': 'WorkerAppsConfiguration'},
        'aks_resource_id': {'key': 'properties.aksResourceID', 'type': 'str'},
    }

    def __init__(self, *, location: str, kind: str=None, tags=None, kube_environment_type: str=None, extended_location=None, internal_load_balancer_enabled: bool=None, static_ip: str=None, arc_configuration=None, app_logs_configuration=None, worker_apps_configuration=None, aks_resource_id: str=None, **kwargs) -> None:
        super(KubeEnvironment, self).__init__(kind=kind, location=location, tags=tags, **kwargs)
        self.kube_environment_type = kube_environment_type
        self.extended_location = extended_location
        self.provisioning_state = None
        ...
        self.worker_apps_configuration = worker_apps_configuration
...
class StackMajorVersion(Model):
    ...
    def __init__(self, *, display_version: str=None, runtime_version: str=None, is_default: bool=None, minor_versions=None, application_insights: bool=None, app_settings_dictionary=None, site_config_properties_dictionary=None, is_preview: bool=None, is_deprecated: bool=None, is_hidden: bool=None, **kwargs) -> None:
...
class StaticSiteARMResource(Resource):
    ...
    def __init__(self, *, location: str, kind: str=None, tags=None, repository_url: str=None, branch: str=None, repository_token: str=None, build_properties=None, template_properties=None, sku=None, identity=None, **kwargs) -> None:
...
class StaticSitePatchResource(ProxyOnlyResource):
    ...
    def __init__(self, *, kind: str=None, repository_url: str=None, branch: str=None, repository_token: str=None, build_properties=None, template_properties=None, **kwargs) -> None:
...
class StatusCodesBasedTrigger(Model):
    ...
    def __init__(self, *, status: int=None, sub_status: int=None, win32_status: int=None, path: str=None, count: int=None, time_interval: str=None, **kwargs) -> None:
...
class WorkerAppsConfiguration(Model):
    """Configuration required deploy Kube Environment Dedicated
    to Worker Apps.
    Create request is not accepted, if ArcConfiguration or AksResourceId is
    provided
    with WorkerAppsConfiguration.

    :param subnet_resource_id: Service Principle Secret used to provision
     WorkerApps Kube Environment
     VnetResource
    :type subnet_resource_id: str
    """
    ...
    def __init__(self, *, subnet_resource_id: str=None, **kwargs) -> None:
        super(WorkerAppsConfiguration, self).__init__(**kwargs)
        self.subnet_resource_id = subnet_resource_id

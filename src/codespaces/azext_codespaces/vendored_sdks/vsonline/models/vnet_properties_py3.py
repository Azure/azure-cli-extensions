...
class VnetProperties(Model):
    """Model representing Vnet Injection properties for VS Online Account.

    :param subnet_id: The ARM resource identifier of the virtual network
     subnet which the codespaces of the VSO Plan will join. This is of the form
     /subscriptions/{subscription}/resourceGroups/{group}/providers/{provider}/virtualNetworks/{network}/subnets/{subnet}.The
     virtual network must be in the same region and subscription as the VSO
     Plan.
    :type subnet_id: str
    """

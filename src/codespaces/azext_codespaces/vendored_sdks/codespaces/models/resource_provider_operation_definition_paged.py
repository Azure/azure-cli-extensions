...
class ResourceProviderOperationDefinitionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ResourceProviderOperationDefinition <microsoft.codespaces.models.ResourceProviderOperationDefinition>` object
    """

...
@register_command(
    "reservations reservation list-history",
)
class ListHistory(AAZCommand):
    """List of all the revisions for the `Reservation`.

    :example: Get history of a reservation.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReservationListRevisions(ctx=self.ctx)()
    ...
    class ReservationListRevisions(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHistoryHelper._build_schema_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _ListHistoryHelper._build_schema_applied_scopes_read(properties.applied_scopes)
            ...
            _ListHistoryHelper._build_schema_sku_name_read(purchase_properties.sku)
...
class _ListHistoryHelper:
    """Helper class for ListHistory"""

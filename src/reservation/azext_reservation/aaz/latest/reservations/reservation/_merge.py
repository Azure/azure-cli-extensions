...
class Merge(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.sources = AAZListArg(
            ...
            help="Format of the resource id should be /providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReservationMerge(ctx=self.ctx)()
    ...
    class ReservationMerge(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _MergeHelper._build_schema_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _MergeHelper._build_schema_applied_scopes_read(properties.applied_scopes)

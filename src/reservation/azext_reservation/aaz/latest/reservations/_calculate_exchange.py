...
class CalculateExchange(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.reservations_to_exchange = AAZListArg(
            options=["--reservations-to-exchange"],
            arg_group="Properties",
            help="List of reservations that are being returned in this exchange.",
        )
        _args_schema.reservations_to_purchase = AAZListArg(
            options=["--reservations-to-purchase"],
            arg_group="Properties",
            help="List of reservations that are being purchased in this exchange.",
        )

        reservations_to_exchange = cls._args_schema.reservations_to_exchange
        reservations_to_exchange.Element = AAZObjectArg()

        _element = cls._args_schema.reservations_to_exchange.Element
        ...
        reservations_to_purchase = cls._args_schema.reservations_to_purchase
        reservations_to_purchase.Element = AAZObjectArg()

        _element = cls._args_schema.reservations_to_purchase.Element
    ...
    class CalculateExchangePost(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("reservationsToExchange", AAZListType, ".reservations_to_exchange")
                properties.set_prop("reservationsToPurchase", AAZListType, ".reservations_to_purchase")

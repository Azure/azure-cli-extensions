...
class AddonArcProperties(AddonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.v_center = kwargs.get('v_center', None)
...
class PlacementPolicyUpdate(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.affinity_strength = kwargs.get('affinity_strength', None)
        self.azure_hybrid_benefit_type = kwargs.get('azure_hybrid_benefit_type', None)
...
class PrivateCloud(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.extended_network_blocks = kwargs.get('extended_network_blocks', None)
        self.provisioning_state = None

...
class PrivateCloudsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PrivateCloudList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~avs_client.models.PrivateCloudList]
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds'}  # type: ignore
    ...
    list_in_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.AVS/privateClouds'}  # type: ignore
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        private_cloud_name,  # type: str
        private_cloud,  # type: "_models.PrivateCloud"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PrivateCloud"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PrivateCloud"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.PrivateCloud"]
        ...
        :return: An instance of LROPoller that returns either PrivateCloud or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~avs_client.models.PrivateCloud]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}'}  # type: ignore

    def _update_initial(
        self,
        resource_group_name,  # type: str
        private_cloud_name,  # type: str
        private_cloud_update,  # type: "_models.PrivateCloudUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PrivateCloud"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PrivateCloud"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}'}  # type: ignore
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}'}  # type: ignore
    ...
    def _rotate_vcenter_password_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._rotate_vcenter_password_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    _rotate_vcenter_password_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/rotateVcenterPassword'}  # type: ignore
    ...
    def begin_rotate_vcenter_password(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_rotate_vcenter_password.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/rotateVcenterPassword'}  # type: ignore
    ...
    def _rotate_nsxt_password_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._rotate_nsxt_password_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
    ...
    def begin_rotate_nsxt_password(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_rotate_nsxt_password.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/rotateNsxtPassword'}  # type: ignore

...
class ScriptCmdletsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~avs_client.models.ScriptCmdletsList]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            ...
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str', pattern=r'^[-\w\._]+$'),
            'scriptPackageName': self._serialize.url("script_package_name", script_package_name, 'str', pattern=r'^[-\w\._@]+$'),
            'scriptCmdletName': self._serialize.url("script_cmdlet_name", script_cmdlet_name, 'str', pattern=r'^[-\w\._]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)

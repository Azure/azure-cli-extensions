...
class GlobalReachConnectionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~avs_client.models.GlobalReachConnectionList]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str', pattern=r'^[-\w\._]+$'),
            'globalReachConnectionName': self._serialize.url("global_reach_connection_name", global_reach_connection_name, 'str', pattern=r'^[-\w\._]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~avs_client.models.GlobalReachConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

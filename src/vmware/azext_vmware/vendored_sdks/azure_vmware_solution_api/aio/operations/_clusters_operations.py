...
class ClustersOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_vmware_solution_api.models.ClusterList]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure_vmware_solution_api.models.Cluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :type cluster: ~azure_vmware_solution_api.models.Cluster
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure_vmware_solution_api.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type cluster_update: ~azure_vmware_solution_api.models.ClusterUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the AsyncLROBasePolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.

...
def workload_network_dhcp_server_create(client: AVSClient, resource_group_name, private_cloud, dhcp_id: str, display_name=None, revision=None, server_address=None, lease_time=None):
    ...
    # don't need dhcpType='SERVER' because dhcpType is discriminator for WorkloadNetworkDhcpServer?
    if display_name is not None and revision is not None and server_address is not None and lease_time is not None:
    ...
    return client.workload_networks.begin_create_dhcp(resource_group_name=resource_group_name, private_cloud_name=private_cloud, dhcp_id=dhcp_id)
...
def workload_network_dhcp_relay_create(client: AVSClient, resource_group_name, private_cloud, dhcp_id: str, display_name=None, revision=None, server_addresses=None):
    ...
    # don't need dhcpType='SERVER' because dhcpType is discriminator for WorkloadNetworkDhcpRelay?
    if display_name is not None and revision is not None and server_addresses is not None:
...
def workload_network_dhcp_server_update(client: AVSClient, resource_group_name, private_cloud, dhcp_id: str, display_name=None, revision=None, server_address=None, lease_time=None):
    ...
    return client.workload_networks.begin_update_dhcp(resource_group_name=resource_group_name, private_cloud_name=private_cloud, dhcp_id=dhcp_id)

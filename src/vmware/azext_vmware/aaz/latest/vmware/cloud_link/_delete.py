...
@register_command(
    "vmware cloud-link delete",
    confirmation="This will delete the cloud link. Are you sure?",
)
class Delete(AAZCommand):
    """Delete a cloud link in a private cloud

    :example: Delete a cloud link.
        az vmware cloud-link delete --resource-group group1 --private-cloud cloud1 --cloud-link-name cloudLink1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CloudLinksDelete(ctx=self.ctx)()

...
class Show(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/clusters/{}/hosts/{}", "2024-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.host_id = AAZStrArg(
            options=["-n", "--name", "--host-id"],
            help="The host identifier.",
            required=True,
    ...
    class HostsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.maintenance = AAZStrType()

...
@register_command(
    "vmware location check-quota-availability",
)
class CheckQuotaAvailability(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LocationsCheckQuotaAvailability(ctx=self.ctx)()
    ...
    class LocationsCheckQuotaAvailability(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.hosts_remaining = AAZDictType(
                serialized_name="hostsRemaining",

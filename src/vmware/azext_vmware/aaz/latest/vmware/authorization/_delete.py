...
@register_command(
    "vmware authorization delete",
    confirmation="This will delete the authorization. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AuthorizationsDelete(ctx=self.ctx)()
    ...
    class AuthorizationsDelete(AAZHttpOperation):

...
class Create(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/authorizations/{}", "2025-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.authorization_name = AAZStrArg(
            options=["-n", "--name", "--authorization-name"],
        ...
        _args_schema.express_route_id = AAZStrArg(
            ...
            help="The ID of the ExpressRoute Circuit",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.AuthorizationsCreateOrUpdate(ctx=self.ctx)()
    ...
    class AuthorizationsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            properties.express_route_authorization_id = AAZStrType(
                serialized_name="expressRouteAuthorizationId",
                flags={"read_only": True},
            )
            properties.express_route_authorization_key = AAZStrType(

...
class RotateNsxtPassword(AAZCommand):
    ...
    class PrivateCloudsRotateNsxtPassword(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RotateNsxtPasswordHelper._build_schema_circuit_read(properties.circuit)
            ...
            _RotateNsxtPasswordHelper._build_schema_circuit_read(properties.secondary_circuit)

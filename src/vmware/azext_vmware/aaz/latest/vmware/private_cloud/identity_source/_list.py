...
@register_command(
    "vmware private-cloud identity-source list",
)
class List(AAZCommand):
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.identitySources

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.identitySources = value
            return
    ...
    class PrivateCloudsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_private_cloud_read(cls._schema_on_200)

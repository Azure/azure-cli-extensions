...
class Show(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/provisionednetworks/{}", "2024-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.provisioned_network_name = AAZStrArg(
            options=["-n", "--name", "--provisioned-network-name"],
            help="Name of the cloud link.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProvisionedNetworksGet(ctx=self.ctx)()
    ...
    class ProvisionedNetworksGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "provisionedNetworkName", self.ctx.args.provisioned_network_name,
                    required=True,
                ),
                **self.serialize_url_param(

...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/hcxenterprisesites", "2024-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.HcxEnterpriseSitesList(ctx=self.ctx)()
    ...
    class HcxEnterpriseSitesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.activation_key = AAZStrType(

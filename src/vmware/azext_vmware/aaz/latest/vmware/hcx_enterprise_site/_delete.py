...
@register_command(
    ...
    confirmation="This will delete the HCX enterprise site. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.hcx_enterprise_site_name = AAZStrArg(
            options=["-n", "--name", "--hcx-enterprise-site-name"],
            help="Name of the HCX Enterprise Site in the private cloud",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.HcxEnterpriseSitesDelete(ctx=self.ctx)()
    ...
    class HcxEnterpriseSitesDelete(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "hcxEnterpriseSiteName", self.ctx.args.hcx_enterprise_site_name,
                    required=True,
                ),
                **self.serialize_url_param(

...
@register_command(
    ...
    confirmation="This will delete the global reach connection. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.GlobalReachConnectionsDelete(ctx=self.ctx)()
    ...
    class GlobalReachConnectionsDelete(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/globalreachconnections", "2024-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalReachConnectionsList(ctx=self.ctx)()
    ...
    class GlobalReachConnectionsList(AAZHttpOperation):

...
@register_command(
    "vmware global-reach-connection update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GlobalReachConnectionsGet(ctx=self.ctx)()
    ...
    class GlobalReachConnectionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_global_reach_connection_read(cls._schema_on_200)
    ...
    class GlobalReachConnectionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_global_reach_connection_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_global_reach_connection_read = None

    @classmethod
    def _build_schema_global_reach_connection_read(cls, _schema):
        if cls._schema_global_reach_connection_read is not None:
            _schema.id = cls._schema_global_reach_connection_read.id
            _schema.name = cls._schema_global_reach_connection_read.name
            _schema.properties = cls._schema_global_reach_connection_read.properties
            _schema.type = cls._schema_global_reach_connection_read.type
            return

        cls._schema_global_reach_connection_read = _schema_global_reach_connection_read = AAZObjectType()

        global_reach_connection_read = _schema_global_reach_connection_read
        global_reach_connection_read.id = AAZStrType(
            flags={"read_only": True},
        )
        global_reach_connection_read.name = AAZStrType(
            flags={"read_only": True},
        )
        global_reach_connection_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        global_reach_connection_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_global_reach_connection_read.properties

...
class Wait(AAZWaitCommand):
    ...
    class LicensesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_vmware_firewall = cls._schema_on_200.properties.discriminate_by("kind", "VmwareFirewall")
            ...
            labels = cls._schema_on_200.properties.discriminate_by("kind", "VmwareFirewall").labels
            labels.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.discriminate_by("kind", "VmwareFirewall").labels.Element

...
class Update(AAZCommand):
    ...
    class LicensesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_license_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    def _build_schema_license_read(cls, _schema):
        ...
        disc_vmware_firewall = _schema_license_read.properties.discriminate_by("kind", "VmwareFirewall")
        ...
        _element = _schema_license_read.properties.discriminate_by("kind", "VmwareFirewall").labels.Element

...
@register_command(
    ...
    confirmation="This will delete the workload network DNS services. Are you sure?",
)
class Delete(AAZCommand):
    ...
    :example: Delete a DNS service by ID in a workload network.
        az vmware workload-network dns-service delete --resource-group group1 --dns-service dnsService1 --private-cloud cloud1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksDeleteDnsService(ctx=self.ctx)()
    ...
    class WorkloadNetworksDeleteDnsService(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    :example: List of DNS services in a workload network.
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/workloadnetworks/default/dnsservices", "2025-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListDnsServices(ctx=self.ctx)()
    ...
    class WorkloadNetworksListDnsServices(AAZHttpOperation):

...
@register_command(
    "vmware workload-network segment list",
)
class List(AAZCommand):
    """List of segments in a private cloud workload network.

    :example: List of segments in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListSegments(ctx=self.ctx)()
    ...
    class WorkloadNetworksListSegments(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            port_vif = cls._schema_on_200.value.Element.properties.port_vif
            port_vif.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.port_vif.Element
            ...
            dhcp_ranges = cls._schema_on_200.value.Element.properties.subnet.dhcp_ranges

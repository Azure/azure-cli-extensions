...
class Update(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/workloadnetworks/default/segments/{}", "2024-09-01"],
        ]
    }
...
class _UpdateHelper:
    ...
    def _build_schema_workload_network_segment_read(cls, _schema):
        if cls._schema_workload_network_segment_read is not None:
            ...
            _schema.system_data = cls._schema_workload_network_segment_read.system_data
        ...
        workload_network_segment_read.system_data = AAZObjectType(
        ...
        system_data = _schema_workload_network_segment_read.system_data

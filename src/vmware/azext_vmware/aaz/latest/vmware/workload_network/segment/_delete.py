...
@register_command(
    "vmware workload-network segment delete",
    confirmation="This will delete the workload network segment. Are you sure?",
)
class Delete(AAZCommand):
    """Delete a segment by id in a private cloud workload network.

    :example: Delete a segment by ID in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksDeleteSegment(ctx=self.ctx)()
    ...
    class WorkloadNetworksDeleteSegment(AAZHttpOperation):

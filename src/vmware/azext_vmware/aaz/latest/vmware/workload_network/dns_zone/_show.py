...
class Show(AAZCommand):
    ...
    :example: Get a DNS zone by ID in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksGetDnsZone(ctx=self.ctx)()
    ...
    class WorkloadNetworksGetDnsZone(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            dns_server_ips = cls._schema_on_200.properties.dns_server_ips
            dns_server_ips.Element = AAZStrType()

            domain = cls._schema_on_200.properties.domain

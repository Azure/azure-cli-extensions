...
class List(AAZCommand):
    ...
    :example: List of DNS zones in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListDnsZones(ctx=self.ctx)()
    ...
    class WorkloadNetworksListDnsZones(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            dns_server_ips = cls._schema_on_200.value.Element.properties.dns_server_ips
            dns_server_ips.Element = AAZStrType()

            domain = cls._schema_on_200.value.Element.properties.domain

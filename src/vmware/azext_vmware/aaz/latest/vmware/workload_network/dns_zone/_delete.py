...
@register_command(
    ...
    confirmation="This will delete the workload network DNS zone. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksDeleteDnsZone(ctx=self.ctx)()
    ...
    class WorkloadNetworksDeleteDnsZone(AAZHttpOperation):

...
@register_command(
    "vmware workload-network port-mirroring update",
)
class Update(AAZCommand):
    """Update a port mirroring profile by id in a private cloud workload network.

    :example: Update a port mirroring profile by ID in a workload network.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.destination = AAZStrArg(
            ...
            help="Destination VM Group.",
            nullable=True,
        )
        _args_schema.direction = AAZStrArg(
            options=["--direction"],
            arg_group="Properties",
            help="Direction of port mirroring profile.",
            nullable=True,
            enum={"BIDIRECTIONAL": "BIDIRECTIONAL", "EGRESS": "EGRESS", "INGRESS": "INGRESS"},
        )
        _args_schema.display_name = AAZStrArg(
            options=["--display-name"],
            arg_group="Properties",
            help="Display name of the port mirroring profile.",
            nullable=True,
        )
    ...
    def _execute_operations(self):
        ...
        yield self.WorkloadNetworksCreatePortMirroring(ctx=self.ctx)()
    ...
    class WorkloadNetworksGetPortMirroring(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_workload_network_port_mirroring_read(cls._schema_on_200)

            return cls._schema_on_200

    class WorkloadNetworksCreatePortMirroring(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_workload_network_port_mirroring_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                properties.set_prop("destination", AAZStrType, ".destination")
...
class _UpdateHelper:
    ...
    _schema_workload_network_port_mirroring_read = None

    @classmethod
    def _build_schema_workload_network_port_mirroring_read(cls, _schema):
        if cls._schema_workload_network_port_mirroring_read is not None:
        ...
        cls._schema_workload_network_port_mirroring_read = _schema_workload_network_port_mirroring_read = AAZObjectType()

        workload_network_port_mirroring_read = _schema_workload_network_port_mirroring_read
        workload_network_port_mirroring_read.id = AAZStrType(
            flags={"read_only": True},
        )
        workload_network_port_mirroring_read.name = AAZStrType(
            flags={"read_only": True},
        )
        ...
        properties = _schema_workload_network_port_mirroring_read.properties

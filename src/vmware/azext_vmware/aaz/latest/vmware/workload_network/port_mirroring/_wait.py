...
@register_command(
    "vmware workload-network port-mirroring wait",
)
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksGetPortMirroring(ctx=self.ctx)()
    ...
    class WorkloadNetworksGetPortMirroring(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.destination = AAZStrType()

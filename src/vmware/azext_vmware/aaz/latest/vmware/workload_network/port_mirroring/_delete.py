...
@register_command(
    ...
    confirmation="This will delete the workload network port mirroring. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.port_mirroring = AAZStrArg(
            options=["-n", "--name", "--port-mirroring"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksDeletePortMirroring(ctx=self.ctx)()
    ...
    class WorkloadNetworksDeletePortMirroring(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "portMirroringId", self.ctx.args.port_mirroring,
                    required=True,
                ),
                **self.serialize_url_param(

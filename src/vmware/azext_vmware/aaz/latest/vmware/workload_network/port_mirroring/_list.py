...
class List(AAZCommand):
    ...
    :example: List of port mirroring profiles in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListPortMirroring(ctx=self.ctx)()
    ...
    class WorkloadNetworksListPortMirroring(AAZHttpOperation):

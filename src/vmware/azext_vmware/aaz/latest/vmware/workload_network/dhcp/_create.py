...
class Create(AAZCommand):
    ...
    :example: Create a DHCP by ID in a workload network.
        az vmware workload-network dhcp create --resource-group group1 --private-cloud cloud1 --dhcp dhcp1 --display-name dhcpConfigurations1 --revision 1
    """
    ...
    class WorkloadNetworksCreateDhcp(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            segments = cls._schema_on_200_201.properties.segments
            segments.Element = AAZStrType()

            disc_relay = cls._schema_on_200_201.properties.discriminate_by("dhcp_type", "RELAY")
            disc_relay.server_addresses = AAZListType(
                serialized_name="serverAddresses",
            )

            server_addresses = cls._schema_on_200_201.properties.discriminate_by("dhcp_type", "RELAY").server_addresses
            server_addresses.Element = AAZStrType()

            disc_server = cls._schema_on_200_201.properties.discriminate_by("dhcp_type", "SERVER")

...
@register_command(
    "vmware workload-network vm list",
)
class List(AAZCommand):
    """List of virtual machines in a private cloud workload network.

    :example: List of Virtual Machines in a workload network.
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/workloadnetworks/default/virtualmachines", "2024-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListVirtualMachines(ctx=self.ctx)()
    ...
    class WorkloadNetworksListVirtualMachines(AAZHttpOperation):

...
@register_command(
    "vmware workload-network vm show",
)
class Show(AAZCommand):
    """Get a virtual machine by id in a private cloud workload network.

    :example: Get a Virtual Machines by ID in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksGetVirtualMachine(ctx=self.ctx)()
    ...
    class WorkloadNetworksGetVirtualMachine(AAZHttpOperation):

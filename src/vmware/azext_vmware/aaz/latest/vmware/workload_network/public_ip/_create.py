...
@register_command(
    "vmware workload-network public-ip create",
)
class Create(AAZCommand):
    """Create a Public IP Block by id in a private cloud workload network.

    :example: Create a Public IP Block by ID in a workload network.
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/workloadnetworks/default/publicips/{}", "2024-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.public_ip = AAZStrArg(
        ...
        _args_schema.display_name = AAZStrArg(
            ...
            help="Display name of the Public IP Block.",
        )
        _args_schema.number_of_public_ips = AAZIntArg(
            options=["--number-of-public-ips"],
            arg_group="Properties",
            help="Number of Public IPs requested.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksCreatePublicIP(ctx=self.ctx)()
    ...
    class WorkloadNetworksCreatePublicIP(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "publicIPId", self.ctx.args.public_ip,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("numberOfPublicIPs", AAZIntType, ".number_of_public_ips")
        ...
        def _build_schema_on_200_201(cls):
            ...
            properties.number_of_public_i_ps = AAZIntType(
                serialized_name="numberOfPublicIPs",
            )

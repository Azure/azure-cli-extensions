...
@register_command(
    "vmware workload-network public-ip show",
)
class Show(AAZCommand):
    """Get a Public IP Block by id in a private cloud workload network.

    :example: Get a Public IP Block by ID in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksGetPublicIP(ctx=self.ctx)()
    ...
    class WorkloadNetworksGetPublicIP(AAZHttpOperation):

...
@register_command(
    "vmware workload-network public-ip list",
)
class List(AAZCommand):
    """List of Public IP Blocks in a private cloud workload network.

    :example: List of Public IP Blocks in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListPublicIPs(ctx=self.ctx)()
    ...
    class WorkloadNetworksListPublicIPs(AAZHttpOperation):

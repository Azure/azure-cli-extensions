...
@register_command(
    "vmware workload-network gateway list",
)
class List(AAZCommand):
    """List of gateways in a private cloud workload network.

    :example: List of Gateways in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListGateways(ctx=self.ctx)()
    ...
    class WorkloadNetworksListGateways(AAZHttpOperation):

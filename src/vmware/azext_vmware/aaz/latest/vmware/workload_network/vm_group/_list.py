...
@register_command(
    "vmware workload-network vm-group list",
)
class List(AAZCommand):
    """List of vm groups in a private cloud workload network.

    :example: List of VM Groups in a workload network.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkloadNetworksListVMGroups(ctx=self.ctx)()
    ...
    class WorkloadNetworksListVMGroups(AAZHttpOperation):

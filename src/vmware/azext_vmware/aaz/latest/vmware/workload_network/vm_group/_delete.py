...
@register_command(
    "vmware workload-network vm-group delete",
    confirmation="This will delete the workload network VM group. Are you sure?",
)
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkloadNetworksDeleteVMGroup(ctx=self.ctx)()
    ...
    class WorkloadNetworksDeleteVMGroup(AAZHttpOperation):

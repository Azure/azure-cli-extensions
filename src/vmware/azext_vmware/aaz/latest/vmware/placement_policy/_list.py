...
class List(AAZCommand):
    ...
    :example: List placement policies.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PlacementPoliciesList(ctx=self.ctx)()
    ...
    class PlacementPoliciesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_vm_host = cls._schema_on_200.value.Element.properties.discriminate_by("type", "VmHost")
            ...
            host_members = cls._schema_on_200.value.Element.properties.discriminate_by("type", "VmHost").host_members
            host_members.Element = AAZStrType()

            vm_members = cls._schema_on_200.value.Element.properties.discriminate_by("type", "VmHost").vm_members
            vm_members.Element = AAZStrType()

            disc_vm_vm = cls._schema_on_200.value.Element.properties.discriminate_by("type", "VmVm")
            ...
            vm_members = cls._schema_on_200.value.Element.properties.discriminate_by("type", "VmVm").vm_members
            vm_members.Element = AAZStrType()

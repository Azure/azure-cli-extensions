...
class Update(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/clusters/{}/placementpolicies/{}", "2024-09-01"],
        ]
    }
    ...
    class PlacementPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_placement_policy_read(cls._schema_on_200)
    ...
    class PlacementPoliciesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_placement_policy_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_placement_policy_read = None

    @classmethod
    def _build_schema_placement_policy_read(cls, _schema):
        if cls._schema_placement_policy_read is not None:
            _schema.id = cls._schema_placement_policy_read.id
            _schema.name = cls._schema_placement_policy_read.name
            _schema.properties = cls._schema_placement_policy_read.properties
            _schema.system_data = cls._schema_placement_policy_read.system_data
            _schema.type = cls._schema_placement_policy_read.type
            return

        cls._schema_placement_policy_read = _schema_placement_policy_read = AAZObjectType()

        placement_policy_read = _schema_placement_policy_read
        placement_policy_read.id = AAZStrType(
            flags={"read_only": True},
        )
        placement_policy_read.name = AAZStrType(
            flags={"read_only": True},
        )
        placement_policy_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        placement_policy_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        placement_policy_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_placement_policy_read.properties
        ...
        disc_vm_host = _schema_placement_policy_read.properties.discriminate_by("type", "VmHost")
        ...
        host_members = _schema_placement_policy_read.properties.discriminate_by("type", "VmHost").host_members
        host_members.Element = AAZStrType()

        vm_members = _schema_placement_policy_read.properties.discriminate_by("type", "VmHost").vm_members
        vm_members.Element = AAZStrType()

        disc_vm_vm = _schema_placement_policy_read.properties.discriminate_by("type", "VmVm")
        ...
        vm_members = _schema_placement_policy_read.properties.discriminate_by("type", "VmVm").vm_members
        vm_members.Element = AAZStrType()

        system_data = _schema_placement_policy_read.system_data

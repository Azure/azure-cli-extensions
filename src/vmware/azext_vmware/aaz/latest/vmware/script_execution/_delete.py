...
@register_command(
    "vmware script-execution delete",
    confirmation="This will delete the script execution. Are you sure?",
)
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/scriptexecutions/{}", "2025-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ScriptExecutionsDelete(ctx=self.ctx)()

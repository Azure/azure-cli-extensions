...
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.avs/privateclouds/{}/iscsipaths/default", "2024-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IscsiPathsGet(ctx=self.ctx)()
    ...
    class IscsiPathsGet(AAZHttpOperation):

...
class VmwareDatastoresScenarioTest(ScenarioTest):
    ...
    def test_vmware_datastores(self):
        ...
        self.cmd('az vmware datastore netapp-volume create --name ANFDatastore1 --resource-group {rg} --private-cloud {privatecloud} --cluster {cluster} --net-app-volume {volume_id}')

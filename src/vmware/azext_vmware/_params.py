...
def load_arguments(self, _):
    ...
    with self.argument_context('vmware datastore disk-pool-volume create') as c:
        ...
        c.argument('mount_option', help='Mode that describes whether the LUN has to be mounted as a datastore or attached as a LUN. Possible values include: "MOUNT", "ATTACH". Default value: "MOUNT".')

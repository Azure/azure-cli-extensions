...
class ManagedNetworkScenarioTest(ScenarioTest):
    ...
    def test_managednetwork(self, resource_group):
        ...
        self.cmd('az managednetwork group create --resource-group "{rg}" --managed-network-name "MyManagedNetwork" --name "MyManagedNetworkGroup" --location "eastus" --virtual-networks /subscriptions/{sub}/resourceGroups/fengtest/providers/Microsoft.Network/virtualNetworks/fengtest-vnet')

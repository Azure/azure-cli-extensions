...
class EdgeOrderManagementClientOperationsMixin(object):
    ...
    def list_operations(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.OperationListResult]
    ...
    def list_addresses_at_subscription_level(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.AddressResourceList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.AddressResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_product_families(
        self,
        product_families_request,  # type: "models.ProductFamiliesRequest"
        expand=None,  # type: Optional[str]
        skip_token=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.ProductFamilies"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.ProductFamilies]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_configurations(
        self,
        configurations_request,  # type: "models.ConfigurationsRequest"
        skip_token=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.Configurations"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.Configurations]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_product_families_metadata(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ProductFamiliesMetadata"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.ProductFamiliesMetadata]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_order_items_at_subscription_level(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.OrderItemResourceList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.models.OrderItemResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_address_initial(
        ...
        address_name,  # type: str
        resource_group_name,  # type: str
        address_resource,  # type: "models.AddressResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.AddressResource"]
    ...
    def begin_create_address(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.AddressResource"]
    ...
    def _update_address_initial(
        ...
        address_name,  # type: str
        resource_group_name,  # type: str
        address_update_parameter,  # type: "models.AddressUpdateParameter"
    ...
    def _create_order_item_initial(
        ...
        order_item_name,  # type: str
        resource_group_name,  # type: str
        order_item_resource,  # type: "models.OrderItemResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OrderItemResource"]
    ...
    def begin_create_order_item(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.OrderItemResource"]
    ...
    def _update_order_item_initial(
        ...
        order_item_name,  # type: str
        resource_group_name,  # type: str
        order_item_update_parameter,  # type: "models.OrderItemUpdateParameter"
        if_match=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OrderItemResource"]
    ...
    def cancel_order_item(
        ...
        order_item_name,  # type: str
        resource_group_name,  # type: str
        cancellation_reason,  # type: "models.CancellationReason"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Cancel order item.
    ...
    def _return_order_item_initial(
        ...
        order_item_name,  # type: str
        resource_group_name,  # type: str
        return_order_item_details,  # type: "models.ReturnOrderItemDetails"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]

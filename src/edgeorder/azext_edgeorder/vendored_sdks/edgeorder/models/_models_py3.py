...
class AddressDetails(msrest.serialization.Model):
    ...
    :param forward_address: Required. Customer address and contact details. It should be address
     resource.
    :type forward_address: ~azure.mgmt.edgeorder.models.AddressProperties
...
class AddressProperties(msrest.serialization.Model):
    ...
    :type shipping_address: ~azure.mgmt.edgeorder.models.ShippingAddress
    :param contact_details: Required. Contact details for the address.
    :type contact_details: ~azure.mgmt.edgeorder.models.ContactDetails
...
class ConfigurationFilters(msrest.serialization.Model):
    ...
    :type hierarchy_information: ~azure.mgmt.edgeorder.models.HierarchyInformation
    :param filterable_property: Filters specific to product.
    :type filterable_property: list[~azure.mgmt.edgeorder.models.FilterableProperty]
    """
...
class ConfigurationsRequest(msrest.serialization.Model):
    ...
    :param configuration_filters: Required. Holds details about product hierarchy information and
     filterable property.
    :type configuration_filters: list[~azure.mgmt.edgeorder.models.ConfigurationFilters]
    ...
    :type customer_subscription_details: ~azure.mgmt.edgeorder.models.CustomerSubscriptionDetails
    """
...
class EncryptionPreferences(msrest.serialization.Model):
    ...
    :type double_encryption_status: str or ~azure.mgmt.edgeorder.models.DoubleEncryptionStatus
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :type error: ~azure.mgmt.edgeorder.models.ErrorDetail
    """
...
class FilterableProperty(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.edgeorder.models.SupportedFilterTypes
...
class MeterDetails(msrest.serialization.Model):
    ...
    :type billing_type: str or ~azure.mgmt.edgeorder.models.BillingType
...
class NotificationPreference(msrest.serialization.Model):
    ...
    :param stage_name: Required. Name of the stage. Possible values include: "Shipped",
     "Delivered".
    :type stage_name: str or ~azure.mgmt.edgeorder.models.NotificationStageName
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.edgeorder.models.OperationDisplay
...
class OrderItemDetails(msrest.serialization.Model):
    ...
    :type product_details: ~azure.mgmt.edgeorder.models.ProductDetails
    :param order_item_type: Required. Order item type. Possible values include: "Purchase",
     "Rental".
    :type order_item_type: str or ~azure.mgmt.edgeorder.models.OrderItemType
    ...
    :type preferences: ~azure.mgmt.edgeorder.models.Preferences
...
class OrderItemResource(TrackedResource):
    ...
    :type order_item_details: ~azure.mgmt.edgeorder.models.OrderItemDetails
    :param address_details: Required. Represents shipping and return address for order item.
    :type address_details: ~azure.mgmt.edgeorder.models.AddressDetails
...
class Preferences(msrest.serialization.Model):
    ...
    :type notification_preferences: list[~azure.mgmt.edgeorder.models.NotificationPreference]
    :param transport_preferences: Preferences related to the shipment logistics of the order.
    :type transport_preferences: ~azure.mgmt.edgeorder.models.TransportPreferences
    :param encryption_preferences: Preferences related to the Encryption.
    :type encryption_preferences: ~azure.mgmt.edgeorder.models.EncryptionPreferences
...
class ProductDetails(msrest.serialization.Model):
    ...
    :type display_info: ~azure.mgmt.edgeorder.models.DisplayInfo
    ...
    :vartype count: int
    :ivar product_double_encryption_status: Double encryption status of the configuration. Read-
     only field. Possible values include: "Disabled", "Enabled".
...
class ProductFamiliesMetadataDetails(msrest.serialization.Model):
    ...
    :type resource_provider_details: list[~azure.mgmt.edgeorder.models.ResourceProviderDetails]
    """
...
class ProductFamiliesRequest(msrest.serialization.Model):
    ...
    :type filterable_properties: dict[str, list[~azure.mgmt.edgeorder.models.FilterableProperty]]
    :param customer_subscription_details: Customer subscription properties. Clients can display
     available products to unregistered customers by explicitly passing subscription details.
    :type customer_subscription_details: ~azure.mgmt.edgeorder.models.CustomerSubscriptionDetails
    """
...
class ReturnOrderItemDetails(msrest.serialization.Model):
    ...
    :type return_address: ~azure.mgmt.edgeorder.models.AddressProperties
...
class ShippingAddress(msrest.serialization.Model):
    ...
    :param address_type: Type of address. Possible values include: "None", "Residential",
     "Commercial".
    :type address_type: str or ~azure.mgmt.edgeorder.models.AddressType
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or ~azure.mgmt.edgeorder.models.CreatedByType
    ...
    :type last_modified_by_type: str or ~azure.mgmt.edgeorder.models.CreatedByType
...
class TransportPreferences(msrest.serialization.Model):
    ...
    :type preferred_shipment_type: str or ~azure.mgmt.edgeorder.models.TransportShipmentTypes
    """

...
def edgeorder_cancel_order_item(client,
                                order_item_name,
                                resource_group_name,
                                reason):
    cancellation_reason = {}
...
def edgeorder_create_address(client,
                             address_name,
                             resource_group_name,
                             location,
                             contact_details,
...
def edgeorder_create_order_item(client,
                                order_item_name,
                                resource_group_name,
                                order_item_resource):
...
def edgeorder_delete_address(client,
                             address_name,
                             resource_group_name):
...
def edgeorder_delete_order_item(client,
                                order_item_name,
                                resource_group_name):
...
def edgeorder_list_address_at_resource_group_level(client,
                                                   resource_group_name,
                                                   filter_=None,
                                                   skip_token=None):
...
def edgeorder_list_address_at_subscription_level(client,
                                                 filter_=None,
                                                 skip_token=None):
...
def edgeorder_list_configuration(client,
...
def edgeorder_list_order_at_resource_group_level(client,
                                                 resource_group_name,
                                                 skip_token=None):
...
def edgeorder_list_order_at_subscription_level(client,
                                               skip_token=None):
    return client.list_order_at_subscription_level(skip_token=skip_token)


def edgeorder_list_order_item_at_resource_group_level(client,
                                                      resource_group_name,
                                                      filter_=None,
                                                      expand=None,
                                                      skip_token=None):
...
def edgeorder_list_order_item_at_subscription_level(client,
                                                    filter_=None,
                                                    expand=None,
                                                    skip_token=None):
...
def edgeorder_list_product_family(client,
...
def edgeorder_list_product_family_metadata(client,
                                           skip_token=None):
    return client.list_product_families_metadata(skip_token=skip_token)


def edgeorder_return_order_item(client,
                                order_item_name,
                                resource_group_name,
                                return_reason,
                                service_tag=None,
...
def edgeorder_show_address(client,
                           address_name,
                           resource_group_name):
...
def edgeorder_show_order(client,
                         order_name,
                         resource_group_name,
                         location):
    return client.get_order_by_name(order_name=order_name,
                                    resource_group_name=resource_group_name,
                                    location=location)


def edgeorder_show_order_item(client,
                              order_item_name,
                              resource_group_name,
                              expand=None):
...
def edgeorder_update_address(client,
                             address_name,
                             resource_group_name,
                             if_match=None,
                             tags=None,
...
def edgeorder_update_order_item(client,
                                order_item_name,
                                resource_group_name,
                                if_match=None,
                                tags=None,

...
class Deactivate(AAZCommand):
    """Deactivates the specified sim.
    """

    _aaz_info = {
        "version": "2021-04-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.mobilenetwork/sims/{}/deactivate", "2021-04-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SimsDeactivate(ctx=self.ctx)()
    ...
    class SimsDeactivate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/sims/{simName}/deactivate",
                **self.url_parameters
            )

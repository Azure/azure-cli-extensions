...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServicesListByMobileNetwork(ctx=self.ctx)()
    ...
    class ServicesListByMobileNetwork(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            pcc_rules = cls._schema_on_200.value.Element.properties.pcc_rules
            pcc_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.pcc_rules.Element

...
@register_command(
    "mobile-network data-network show",
)
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.mobilenetwork/mobilenetworks/{}/datanetworks/{}", "2022-04-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.data_network_name = AAZStrArg(
            options=["-n", "--name", "--data-network-name"],
            help="The name of the data network.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DataNetworksGet(ctx=self.ctx)()

...
class Show(AAZCommand):
    ...
    class PacketCoreControlPlanesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_azure_stack_edge_device_resource_id_read(platform.azure_stack_edge_device)
            ...
            _ShowHelper._build_schema_azure_stack_edge_device_resource_id_read(azure_stack_edge_devices.Element)

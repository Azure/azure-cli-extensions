...
@register_command(
    "mobile-network pccp collect-diagnostics-package",
)
class CollectDiagnosticsPackage(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.blob_url = AAZStrArg(
            options=["--blob-url"],
            arg_group="Parameters",
            help="The Storage Account Blob URL to upload the diagnostics package to.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PacketCoreControlPlaneCollectDiagnosticsPackage(ctx=self.ctx)()
    ...
    class PacketCoreControlPlaneCollectDiagnosticsPackage(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("storageAccountBlobUrl", AAZStrType, ".blob_url", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200(cls):
            ...
            _CollectDiagnosticsPackageHelper._build_schema_error_detail_read(_schema_on_200.error)
...
class _CollectDiagnosticsPackageHelper:
    """Helper class for CollectDiagnosticsPackage"""
...
__all__ = ["CollectDiagnosticsPackage"]

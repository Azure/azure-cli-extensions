...
@register_command(
    "mobile-network sim policy list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SimPoliciesListByMobileNetwork(ctx=self.ctx)()
    ...
    class SimPoliciesListByMobileNetwork(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_slice_resource_id_read(properties.default_slice)
            ...
            _ListHelper._build_schema_data_network_resource_id_read(_element.default_data_network)

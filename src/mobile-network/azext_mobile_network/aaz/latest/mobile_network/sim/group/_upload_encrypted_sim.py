...
@register_command(
    "mobile-network sim group upload-encrypted-sim",
)
class UploadEncryptedSim(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.signed_key = AAZStrArg(
            options=["--signed-key"],
            arg_group="Parameters",
            help="The encrypted transport key, signed using the SIM vendor private key.",
            required=True,
            fmt=AAZStrArgFormat(
                pattern="^[0-9a-fA-F]+$",
            ),
        ...
        _args_schema.sims = AAZListArg(
            options=["--sims"],
            arg_group="Parameters",
            help="A list of SIMs to upload, with encrypted properties.",
            required=True,
        )
        _args_schema.vendor_key = AAZStrArg(
            options=["--vendor-key"],
            arg_group="Parameters",
            help="The fingerprint of the SIM vendor public key. The private counterpart is used for signing the encrypted transport key.",
            required=True,
            fmt=AAZStrArgFormat(
                pattern="^[0-9a-fA-F]+$",
            ),
        ...
        _args_schema.version = AAZIntArg(
            options=["--version"],
            arg_group="Parameters",
            help="The upload file format version.",
            required=True,
            fmt=AAZIntArgFormat(
                minimum=1,
            ),
        ...
        _element.encrypted_credentials = AAZStrArg(
            options=["encrypted-credentials"],
            help="The encrypted SIM credentials.",
            fmt=AAZStrArgFormat(
                pattern="^[0-9a-fA-F]+$",
            ),
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SimBulkUploadEncrypted(ctx=self.ctx)()
    ...
    class SimBulkUploadEncrypted(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("version", AAZIntType, ".version", typ_kwargs={"flags": {"required": True}})
            ...
            if properties is not None:
                ...
                properties.set_prop("encryptedCredentials", AAZStrType, ".encrypted_credentials")
        ...
        def _build_schema_on_200(cls):
            ...
            _UploadEncryptedSimHelper._build_schema_error_detail_read(_schema_on_200.error)
...
class _UploadEncryptedSimHelper:
    """Helper class for UploadEncryptedSim"""

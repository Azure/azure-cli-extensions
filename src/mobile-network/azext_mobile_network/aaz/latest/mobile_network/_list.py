...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.mobilenetwork/mobilenetworks", "2022-04-01-preview"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.MobileNetworksListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.MobileNetworksListBySubscription(ctx=self.ctx)()

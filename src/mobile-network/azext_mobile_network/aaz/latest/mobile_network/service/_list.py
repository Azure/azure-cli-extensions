...
class List(AAZCommand):
    ...
    class ServicesListByMobileNetwork(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_ambr_read(rule_qos_policy.guaranteed_bit_rate)
            rule_qos_policy.maximum_bit_rate = AAZObjectType(
                serialized_name="maximumBitRate",
                flags={"required": True},
            )
            _ListHelper._build_schema_ambr_read(rule_qos_policy.maximum_bit_rate)
            ...
            _ListHelper._build_schema_ambr_read(service_qos_policy.maximum_bit_rate)

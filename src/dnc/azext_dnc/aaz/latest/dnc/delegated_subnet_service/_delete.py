...
@register_command(
    "dnc delegated-subnet-service delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete the subnet delegated to DNC
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DelegatedSubnetServiceDeleteDetails(ctx=self.ctx)()
    ...
    class DelegatedSubnetServiceDeleteDetails(AAZHttpOperation):

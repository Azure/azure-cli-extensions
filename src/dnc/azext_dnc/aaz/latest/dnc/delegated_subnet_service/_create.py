...
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DelegatedSubnetServicePutDetails(ctx=self.ctx)()
    ...
    class DelegatedSubnetServicePutDetails(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            subnet_details = cls._schema_on_200_201.properties.subnet_details

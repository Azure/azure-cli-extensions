...
class Delete(AAZCommand):
    ...
    :example: Delete an orchestrator instance
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.OrchestratorInstanceServiceDelete(ctx=self.ctx)()
    ...
    class OrchestratorInstanceServiceDelete(AAZHttpOperation):

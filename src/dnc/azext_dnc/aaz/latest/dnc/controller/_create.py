...
class Create(AAZCommand):
    ...
    :example: Create a test controller
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.purpose = AAZStrArg(
            ...
            help="The purpose of the dnc controller resource.",
            is_preview=True,
            default="prod",
            enum={"prod": "prod", "test": "test"},
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ControllerCreate(ctx=self.ctx)()
    ...
    class ControllerCreate(AAZHttpOperation):

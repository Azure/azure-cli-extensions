...
class DelegatedSubnetServiceOperations:
    """DelegatedSubnetServiceOperations async operations.
    ...
    async def _put_details_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        parameters: "models.DelegatedSubnet",
        **kwargs
    ) -> "models.DelegatedSubnet":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DelegatedSubnet"]
        error_map = {
    ...
    async def begin_put_details(
        self,
        resource_group_name: str,
        resource_name: str,
        parameters: "models.DelegatedSubnet",
        **kwargs
    ) -> AsyncLROPoller["models.DelegatedSubnet"]:
        ...
        :return: An instance of AsyncLROPoller that returns either DelegatedSubnet or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~dnc.models.DelegatedSubnet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token is None:
            raw_result = await self._put_details_initial(
    ...
    async def _patch_details_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        parameters: "models.ResourceUpdateParameters",
        **kwargs
    ) -> "models.DelegatedSubnet":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DelegatedSubnet"]
        error_map = {
    ...
    async def begin_patch_details(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._patch_details_initial(
                resource_group_name=resource_group_name,
                resource_name=resource_name,
                parameters=parameters,
                cls=lambda x,y,z: x,
    ...
    async def _delete_details_initial(
        self,
        resource_group_name: str,
        resource_name: str,
    ...
    async def begin_delete_details(
        self,
        resource_group_name: str,
        resource_name: str,
        force_delete: Optional[bool] = None,
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._delete_details_initial(
                resource_group_name=resource_group_name,
                resource_name=resource_name,
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.DelegatedSubnets"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~dnc.models.DelegatedSubnets]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class DNC(object):
    ...
    :vartype controller: dnc.operations.ControllerOperations
    :ivar delegated_network: DelegatedNetworkOperations operations
    :vartype delegated_network: dnc.operations.DelegatedNetworkOperations
    :ivar orchestrator_instance_service: OrchestratorInstanceServiceOperations operations
    :vartype orchestrator_instance_service: dnc.operations.OrchestratorInstanceServiceOperations
    ...
    :vartype operations: dnc.operations.Operations

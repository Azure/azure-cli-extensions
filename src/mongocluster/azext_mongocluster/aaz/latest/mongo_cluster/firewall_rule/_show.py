...
@register_command(
    "mongo-cluster firewall-rule show",
)
class Show(AAZCommand):
    """Get information about a mongo cluster firewall rule.

    :example: Gets a firewall rule on a Mongo Cluster resource.
        az mongo-cluster firewall-rule show --resource-group TestGroup --mongo-cluster-name myMongoCluster --firewall-rule-name rule1
    """

...
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/solutiontemplates/{}/versions/{}", "2026-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SolutionTemplateVersionsGet(ctx=self.ctx)()
    ...
    class SolutionTemplateVersionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.configurations = AAZAnyType()

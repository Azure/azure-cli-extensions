...
from azext_workload_orchestration_preview.common.target import target_prepare as _target_prepare
from azext_workload_orchestration_preview.common.hierarchy import hierarchy_create as _hierarchy_create
...
def _validate_dependency_versions(data):
    ...
    from azext_workload_orchestration_preview.common.consts import EXTENSION_DEPENDENCIES

...
def _check_default_storage_class(clients, bundle_dir, cluster_info, capabilities):
    ...
    from azext_workload_orchestration_preview.support.consts import SC_DEFAULT_ANNOTATION_V1, SC_DEFAULT_ANNOTATION_BETA
...
def _check_dns_resolution(clients, bundle_dir, cluster_info, capabilities):
    ...
    from azext_workload_orchestration_preview.support.consts import DNS_EXTERNAL_HOST

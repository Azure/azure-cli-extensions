...
@register_command(
    "network-function traffic-collector delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a specified Azure Traffic Collector resource

    :example: Delete a specified azure traffic collector resource
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureTrafficCollectorsDelete(ctx=self.ctx)()
    ...
    class AzureTrafficCollectorsDelete(AAZHttpOperation):

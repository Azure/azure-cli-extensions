...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.IpGroupsList(ctx=self.ctx)()
        if condition_1:
            self.IpGroupsListByResourceGroup(ctx=self.ctx)()
    ...
    class IpGroupsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.firewalls.Element
            _element.id = AAZStrType()

            ip_addresses = cls._schema_on_200.value.Element.properties.ip_addresses
    ...
    class IpGroupsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
class Wait(AAZWaitCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.expand = AAZStrArg(
            options=["--expand"],
            help="Expands resourceIds (of Firewalls/Network Security Groups etc.) back referenced by the IpGroups resource.",
        )
        return cls._args_schema
    ...
    class IpGroupsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.properties.firewalls.Element
            _element.id = AAZStrType()

            ip_addresses = cls._schema_on_200.properties.ip_addresses

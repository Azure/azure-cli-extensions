...
def load_command_table(self, _):  # pylint: disable=unused-argument
    ...
    with self.command_group('storage-mover endpoint') as g:
        ...
        g.custom_command('create-for-storage-smb-file-share', 'endpoint_create_for_storage_smb_file_share')
        ...
        g.custom_command('update-for-storage-smb-file-share', 'endpoint_update_for_storage_smb_file_share')

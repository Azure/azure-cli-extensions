...
class List(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.location = AAZStrArg(
            options=["--location"],
            help="Location of NewRelic organization.",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.OrganizationsList(ctx=self.ctx)()
    ...
    class OrganizationsList(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "userEmail", self.ctx.args.user_email,
                    required=True,
                ),
                **self.serialize_query_param(
        ...
        def _build_schema_on_200(cls):
            ...
            properties.billing_source = AAZStrType(
                serialized_name="billingSource",
            )
            properties.organization_id = AAZStrType(
                serialized_name="organizationId",
            )
            properties.organization_name = AAZStrType(

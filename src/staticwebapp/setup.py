...
setup(
    ...
    url='https://github.com/Azure/azure-cli-extensions/tree/master/src/staticwebapp',
    long_description=README + '\n\n' + HISTORY,
    license='MIT',
    classifiers=CLASSIFIERS,
    packages=find_packages(),
    install_requires=DEPENDENCIES,
    package_data={'azext_staticwebapp': ['azext_metadata.json']},
)

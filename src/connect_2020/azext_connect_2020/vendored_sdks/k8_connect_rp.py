...
class K8ConnectRPConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('k8connectrp/{}'.format(VERSION))
...
class K8ConnectRP(SDKClient):
    ...
    :vartype connected_cluster: hybridkubernetes.operations.ConnectedClusterOperations
    :ivar operations: Operations operations
    :vartype operations: hybridkubernetes.operations.Operations

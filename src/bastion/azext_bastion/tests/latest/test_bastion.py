...
class BastionScenario(ScenarioTest):
    ...
    def test_bastion_host_crud(self):
        ...
        self.cmd("vm create -n {vm_name} -g {rg} --vnet-name {vnet_name} --subnet {subnet_name} --nsg-rule None --image Canonical:UbuntuServer:22.04-LTS:latest --authentication-type password --admin-username testadmin --admin-password TestPassword11!!")

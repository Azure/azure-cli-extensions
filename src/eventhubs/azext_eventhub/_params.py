...
def load_arguments_namespace(self, _):
    ...
    with self.argument_context('eventhubs namespace list') as c:
        c.argument('resource_group_name', arg_type=resource_group_name_type)
...
def load_arguments_eventhub(self, _):
    with self.argument_context('eventhubs eventhub create') as c:
        c.argument('resource_group_name', arg_type=resource_group_name_type)
        c.argument('namespace_name', options_list=['--namespace-name'], help='name of the Namespace')
        c.argument('event_hub_name', options_list=['--name', '-n'], help='Name of Evnethub')
    ...
    # region EventHub Get
    for scope in ['eventhubs eventhub show', 'eventhubs eventhub delete']:
        with self.argument_context(scope) as c:
            c.argument('resource_group_name', arg_type=resource_group_name_type)
            c.argument('namespace_name', options_list=['--namespace-name'], help='name of the Namespace')
...
def load_arguments_consumergroup(self, _):
    ...
    for scope in ['eventhubs consumergroup show', 'eventhubs consumergroup delete']:
        with self.argument_context(scope) as c:
            c.argument('resource_group_name', arg_type=resource_group_name_type)
            c.argument('namespace_name', options_list=['--namespace-name'], help='name of the Namespace')
            c.argument('event_hub_name', options_list=['--event-hub-name'], help='name of the EventHub')
...
def load_arguments_geodr(self, _):
    with self.argument_context('eventhubs georecovery-alias exists') as c:
        ...
        c.argument('name', options_list=['--name'],
                   help='Name of the Geo Recovery Configs - Alias to check availability')
    ...
    for scope in ['eventhubs georecovery-alias show', 'eventhubs georecovery-alias delete']:
        with self.argument_context(scope) as c:
            c.argument('resource_group_name', arg_type=resource_group_name_type)
            c.argument('namespace_name', options_list=['--namespace-name'], help='name of the Namespace')
            c.argument('alias', options_list=['--alias'], help='Name of the Alias (Disaster Recovery)')
    ...
    for scope in ['eventhubs georecovery-alias break-pair', 'eventhubs georecovery-alias fail-over', 'eventhubs georecovery-alias authorizationrule list']:
        with self.argument_context(scope)as c:
            c.argument('resource_group_name', arg_type=resource_group_name_type)

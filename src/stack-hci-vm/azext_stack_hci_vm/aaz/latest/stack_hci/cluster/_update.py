...
@register_command(
    "stack-hci-vm cluster update",
)
class Update(AAZCommand):
    """Update an HCI cluster.

    :example: Update cluster
        az stack-hci-vm cluster update --endpoint "https://98294836-31be-4668-aeae-698667faf99b.waconazure.com" --desired-properties "{diagnosticLevel:Basic,windowsServerSubscription:Enabled}" --tags "tag:"value" --name "myCluster" --resource-group "test-rg"
    """

...
@register_command(
    "stack-hci-vm cluster create",
)
class Create(AAZCommand):
    """Create an HCI cluster.

    :example: Create cluster
        az stack-hci-vm cluster create --location "East US" --aad-client-id "24a6e53d-04e5-44d2-b7cc-1b732a847dfc" --aad-tenant-id "7e589cc1-a8b6-4dff-91bd-5ec0fa18db94" --endpoint "https://98294836-31be-4668-aeae-698667faf99b.waconazure.com" --name "myCluster" --resource- group "test-rg"
    """

...
@register_command(
    "stack-hci-vm cluster extend-software-assurance-benefit",
)
class ExtendSoftwareAssuranceBenefit(AAZCommand):
    ...
    :example: Extend software assurance benefit
        az stack-hci-vm cluster extend-software-assurance-benefit --cluster-name name -g rg --software-assurance-intent enable
    """

...
class Delete(AAZCommand):
    ...
    :example: Delete arc extension
        az stack-hci-vm extension delete --arc-setting-name "default" --cluster-name "myCluster" --name "MicrosoftMonitoringAgent" --resource-group "test-rg"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExtensionsDelete(ctx=self.ctx)()

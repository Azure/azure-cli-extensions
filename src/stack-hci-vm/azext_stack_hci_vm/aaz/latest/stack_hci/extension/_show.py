...
@register_command(
    "stack-hci-vm extension show",
)
class Show(AAZCommand):
    """Get particular arc extension of HCI cluster.

    :example: Get arc settings extension
        az stack-hci-vm extension show --arc-setting-name "default" --cluster-name "myCluster" --name "MicrosoftMonitoringAgent" --resource-group "test-rg"
    """

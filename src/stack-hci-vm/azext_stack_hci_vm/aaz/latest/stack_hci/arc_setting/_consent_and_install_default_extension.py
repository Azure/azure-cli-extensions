...
@register_command(
    "stack-hci-vm arc-setting consent-and-install-default-extension",
)
class ConsentAndInstallDefaultExtension(AAZCommand):
    ...
    :example: Consent and install default extension
        az stack-hci-vm arc-setting consent-and-install-default-extension -g rg --arc-setting-name default --cluster-name name
    """

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ArcSettingsListByCluster(ctx=self.ctx)()
    ...
    class ArcSettingsListByCluster(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.default_extensions.Element
            ...
            per_node_details = cls._schema_on_200.value.Element.properties.per_node_details
            per_node_details.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.per_node_details.Element

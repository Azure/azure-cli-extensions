...
@register_command(
    "stack-hci-vm arc-setting initialize-disable-proces",
)
class InitializeDisableProces(AAZCommand):
    """Initialize ARC Disable process on the cluster

    :example: Initialize disable proces
        az stack-hci-vm arc-setting initialize-disable-proces -g rg --arc-setting-name default --cluster-name name
    """

...
def load_command_table(self, _):  # pylint: disable=unused-argument
    ...
    with self.command_group('stack-hci-vm cluster'):
        from azext_stack_hci.custom import ClusterList, ClusterCreate, IdentityAssign, IdentityRemove
        self.command_table['stack-hci-vm cluster list'] = ClusterList(loader=self)
        self.command_table['stack-hci-vm cluster create'] = ClusterCreate(loader=self)
        self.command_table['stack-hci-vm cluster identity assign'] = IdentityAssign(loader=self)

...
aA/WsuujlM=" --properties-server-id "080d4133-bdb5-40a0-96a0-71a6057bfe9a" --server-osversion "10.0.14393.0" \
--server-role "Standalone" --resource-group "SampleResourceGroup_1" --server-id "080d4133-bdb5-40a0-96a0-71a6057bfe9a" \
--storage-sync-service-name "SampleStorageSyncService_1"
"""

...
helps['storagesync storage-sync-service show'] = """
    ...
    examples:
      - name: StorageSyncServices_Get
        text: |-
               az storagesync storage-sync-service show --resource-group "SampleResourceGroup_1" --name "SampleStorageS\
yncService_1"
"""
...
c" --resource-group "SampleResourceGroup_1" --name "SampleStorageSyncService_1"
"""
...
helps['storagesync storage-sync-service delete'] = """
    ...
    examples:
      - name: StorageSyncServices_Delete
        text: |-
               az storagesync storage-sync-service delete --resource-group "SampleResourceGroup_1" --name "SampleStorag\
eSyncService_1"
"""
...
helps['storagesync storage-sync-service wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the storagesync storage-sync-service is successfully create\
d.
        text: |-
               az storagesync storage-sync-service wait --resource-group "SampleResourceGroup_1" --name "SampleStorageS\
yncService_1" --created
      - name: Pause executing next line of CLI script until the storagesync storage-sync-service is successfully update\
d.
        text: |-
               az storagesync storage-sync-service wait --resource-group "SampleResourceGroup_1" --name "SampleStorageS\
yncService_1" --updated
      - name: Pause executing next line of CLI script until the storagesync storage-sync-service is successfully delete\
d.
        text: |-
               az storagesync storage-sync-service wait --resource-group "SampleResourceGroup_1" --name "SampleStorageS\
yncService_1" --deleted
"""
...
helps['storagesync private-endpoint-connection show'] = """
    ...
    examples:
      - name: PrivateEndpointConnections_Get
        text: |-
               az storagesync private-endpoint-connection show --name "{privateEndpointConnectionName}" --resource-grou\
p "res6977" --storage-sync-service-name "sss2527"
"""
...
er.
    examples:
      - name: PrivateEndpointConnections_Create
        text: |-
               az storagesync private-endpoint-connection create --name "{privateEndpointConnectionName}" --private-lin\
k-service-connection-state description="Auto-Approved" status="Approved" --resource-group "res7687" --storage-sync-serv\
ice-name "sss2527"
"""
...
helps['storagesync private-endpoint-connection delete'] = """
    ...
    examples:
      - name: PrivateEndpointConnections_Delete
        text: |-
               az storagesync private-endpoint-connection delete --name "{privateEndpointConnectionName}" --resource-gr\
oup "res6977" --storage-sync-service-name "sss2527"
"""

helps['storagesync private-endpoint-connection wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the storagesync private-endpoint-connection is\
 met.
    examples:
      - name: Pause executing next line of CLI script until the storagesync private-endpoint-connection is successfully\
 created.
        text: |-
               az storagesync private-endpoint-connection wait --name "{privateEndpointConnectionName}" --resource-grou\
p "res6977" --storage-sync-service-name "sss2527" --created
      - name: Pause executing next line of CLI script until the storagesync private-endpoint-connection is successfully\
 deleted.
        text: |-
               az storagesync private-endpoint-connection wait --name "{privateEndpointConnectionName}" --resource-grou\
p "res6977" --storage-sync-service-name "sss2527" --deleted
"""
...
pleStorageSyncService_1" --name "SampleSyncGroup_1"
"""
...
nc-service-name "SampleStorageSyncService_1" --name "SampleSyncGroup_1"
"""
...
ampleStorageSyncService_1" --name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint show'] = """
    ...
    examples:
      - name: CloudEndpoints_Get
        text: |-
               az storagesync cloud-endpoint show --name "SampleCloudEndpoint_1" --resource-group "SampleResourceGroup_\
1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint create'] = """
    ...
    examples:
      - name: CloudEndpoints_Create
        text: |-
               az storagesync cloud-endpoint create --name "SampleCloudEndpoint_1" --azure-file-share-name "cvcloud-afs\
cv-0719-058-a94a1354-a1fd-4e9a-9a50-919fad8c4ba4" --friendly-name "ankushbsubscriptionmgmtmab" --storage-account-resour\
ce-id "/subscriptions/744f4d70-6d17-4921-8970-a765d14f763f/resourceGroups/tminienv59svc/providers/Microsoft.Storage/sto\
rageAccounts/tminienv59storage" --storage-account-tenant-id "\\"72f988bf-86f1-41af-91ab-2d7cd011db47\\"" --resource-gro\
up "SampleResourceGroup_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_\
1"
"""
...
helps['storagesync cloud-endpoint delete'] = """
    ...
    examples:
      - name: CloudEndpoints_Delete
        text: |-
               az storagesync cloud-endpoint delete --name "SampleCloudEndpoint_1" --resource-group "SampleResourceGrou\
p_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint post-backup'] = """
    ...
    examples:
      - name: CloudEndpoints_PostBackup
        text: |-
               az storagesync cloud-endpoint post-backup --name "SampleCloudEndpoint_1" --azure-file-share "https://sam\
pleserver.file.core.test-cint.azure-test.net/sampleFileShare" --resource-group "SampleResourceGroup_1" --storage-sync-s\
ervice-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint post-restore'] = """
    ...
    examples:
      - name: CloudEndpoints_PostRestore
        text: |-
               az storagesync cloud-endpoint post-restore --name "SampleCloudEndpoint_1" --azure-file-share-uri "https:\
//hfsazbackupdevintncus2.file.core.test-cint.azure-test.net/sampleFileShare" --restore-file-spec path="text1.txt" isdir\
=false --restore-file-spec path="MyDir" isdir=true --restore-file-spec path="MyDir/SubDir" isdir=false --restore-file-s\
pec path="MyDir/SubDir/File1.pdf" isdir=false --source-azure-file-share-uri "https://hfsazbackupdevintncus2.file.core.t\
est-cint.azure-test.net/sampleFileShare" --status "Succeeded" --resource-group "SampleResourceGroup_1" --storage-sync-s\
ervice-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint pre-backup'] = """
    ...
    examples:
      - name: CloudEndpoints_PreBackup
        text: |-
               az storagesync cloud-endpoint pre-backup --name "SampleCloudEndpoint_1" --azure-file-share "https://samp\
leserver.file.core.test-cint.azure-test.net/sampleFileShare" --resource-group "SampleResourceGroup_1" --storage-sync-se\
rvice-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint pre-restore'] = """
    ...
    examples:
      - name: CloudEndpoints_PreRestore
        text: |-
               az storagesync cloud-endpoint pre-restore --name "SampleCloudEndpoint_1" --azure-file-share-uri "https:/\
/hfsazbackupdevintncus2.file.core.test-cint.azure-test.net/sampleFileShare" --restore-file-spec path="text1.txt" isdir=\
false --restore-file-spec path="MyDir" isdir=true --restore-file-spec path="MyDir/SubDir" isdir=false --restore-file-sp\
ec path="MyDir/SubDir/File1.pdf" isdir=false --resource-group "SampleResourceGroup_1" --storage-sync-service-name "Samp\
leStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
helps['storagesync cloud-endpoint restoreheartbeat'] = """
    ...
    examples:
      - name: CloudEndpoints_restoreheartbeat
        text: |-
               az storagesync cloud-endpoint restoreheartbeat --name "SampleCloudEndpoint_1" --resource-group "SampleRe\
sourceGroup_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
nc Cloud Endpoint.
    examples:
      - name: CloudEndpoints_TriggerChangeDetection
        text: |-
               az storagesync cloud-endpoint trigger-change-detection --name "SampleCloudEndpoint_1" --change-detection\
-mode "Recursive" --directory-path "NewDirectory" --resource-group "SampleResourceGroup_1" --storage-sync-service-name \
"SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1" --created
      - name: Pause executing next line of CLI script until the storagesync cloud-endpoint is successfully deleted.
        text: |-
               az storagesync cloud-endpoint wait --name "SampleCloudEndpoint_1" --resource-group "SampleResourceGroup_\
1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1" --deleted
"""
...
helps['storagesync server-endpoint show'] = """
    ...
    examples:
      - name: ServerEndpoints_Get
        text: |-
               az storagesync server-endpoint show --resource-group "SampleResourceGroup_1" --name "SampleServerEndpoin\
t_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
-space-percent 100 --resource-group "SampleResourceGroup_1" --name "SampleServerEndpoint_1" --storage-sync-service-name\
 "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1"
"""
...
ResourceGroup_1" --name "SampleServerEndpoint_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-\
...
helps['storagesync server-endpoint delete'] = """
    ...
    examples:
      - name: ServerEndpoints_Delete
        text: |-
               az storagesync server-endpoint delete --resource-group "SampleResourceGroup_1" --name "SampleServerEndpo\
...
rceGroup_1" --name "SampleServerEndpoint_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name \
"SampleSyncGroup_1"
"""
...
t_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1" --created
      - name: Pause executing next line of CLI script until the storagesync server-endpoint is successfully updated.
        text: |-
               az storagesync server-endpoint wait --resource-group "SampleResourceGroup_1" --name "SampleServerEndpoin\
t_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1" --updated
      - name: Pause executing next line of CLI script until the storagesync server-endpoint is successfully deleted.
        text: |-
               az storagesync server-endpoint wait --resource-group "SampleResourceGroup_1" --name "SampleServerEndpoin\
t_1" --storage-sync-service-name "SampleStorageSyncService_1" --sync-group-name "SampleSyncGroup_1" --deleted
"""
...
helps['storagesync registered-server wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the storagesync registered-server is successfully created.
        text: |-
               az storagesync registered-server wait --resource-group "SampleResourceGroup_1" --server-id "080d4133-bdb\
5-40a0-96a0-71a6057bfe9a" --storage-sync-service-name "SampleStorageSyncService_1" --created
      - name: Pause executing next line of CLI script until the storagesync registered-server is successfully deleted.
        text: |-
               az storagesync registered-server wait --resource-group "SampleResourceGroup_1" --server-id "080d4133-bdb\
5-40a0-96a0-71a6057bfe9a" --storage-sync-service-name "SampleStorageSyncService_1" --deleted
"""

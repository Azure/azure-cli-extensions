...
helps['storagesync storage-sync-service'] = """
    type: group
    short-summary: Manage storage sync service with storagesync
"""

helps['storagesync storage-sync-service list'] = """
    type: command
    short-summary: "Get a StorageSyncService list by Resource group name. And Get a StorageSyncService list by \
subscription."
    examples:
...
helps['storagesync private-link-resource'] = """
    type: group
    short-summary: Manage private link resource with storagesync
"""
...
helps['storagesync private-endpoint-connection'] = """
    type: group
    short-summary: Manage private endpoint connection with storagesync
"""
...
helps['storagesync sync-group'] = """
    type: group
    short-summary: Manage sync group with storagesync
"""
...
helps['storagesync cloud-endpoint'] = """
    type: group
    short-summary: Manage cloud endpoint with storagesync
"""
...
helps['storagesync server-endpoint'] = """
    type: group
    short-summary: Manage server endpoint with storagesync
"""
...
"NamespaceThenModifiedFiles" --initial-upload-policy "ServerAuthoritative" --local-cache-mode \
"UpdateLocallyCachedFiles" --offline-data-transfer "on" --offline-data-transfer-share-name "myfileshare" \
--server-local-path "D:\\\\SampleServerEndpoint_1" --server-resource-id "/subscriptions/52b8da2f-61e0-4a1f-8dde-336911f\
367fb/resourceGroups/SampleResourceGroup_1/providers/Microsoft.StorageSync/storageSyncServices/SampleStorageSyncService\
_1/registeredServers/080d4133-bdb5-40a0-96a0-71a6057bfe9a" --tier-files-older-than-days 0 --volume-free-space-percent \
...
helps['storagesync registered-server'] = """
    type: group
    short-summary: Manage registered server with storagesync
"""
...
helps['storagesync workflow'] = """
    type: group
    short-summary: Manage workflow with storagesync
"""
...
helps['storagesync operation-status'] = """
    type: group
    short-summary: Manage operation status with storagesync
"""

...
def storagesync_private_link_resource_list(cmd, client,
                                           resource_group_name,
                                           storage_sync_service_name):
...
def storagesync_private_endpoint_connection_list(cmd, client,
                                                 resource_group_name,
                                                 storage_sync_service_name):
    return client.list_by_storage_sync_service(resource_group_name=resource_group_name,
                                               storage_sync_service_name=storage_sync_service_name)
...
def storagesync_private_endpoint_connection_show(cmd, client,
                                                 resource_group_name,
                                                 storage_sync_service_name,
...
def storagesync_private_endpoint_connection_create(cmd, client,
                                                   resource_group_name,
                                                   storage_sync_service_name,
                                                   private_endpoint_connection_name,
...
def storagesync_private_endpoint_connection_delete(cmd, client,
                                                   resource_group_name,
                                                   storage_sync_service_name,
                                                   private_endpoint_connection_name):
    return client.begin_delete(resource_group_name=resource_group_name,
...
def storagesync_cloud_endpoint_post_backup(cmd, client,
    ...
    return client.begin_post_backup(resource_group_name=resource_group_name,
                                    storage_sync_service_name=storage_sync_service_name,
                                    sync_group_name=sync_group_name,
                                    cloud_endpoint_name=cloud_endpoint_name,
...
def storagesync_cloud_endpoint_post_restore(cmd, client,
    ...
    return client.begin_post_restore(resource_group_name=resource_group_name,
                                     storage_sync_service_name=storage_sync_service_name,
                                     sync_group_name=sync_group_name,
                                     cloud_endpoint_name=cloud_endpoint_name,
                                     partition=partition,
...
def storagesync_cloud_endpoint_pre_backup(cmd, client,
                                          ...
                                          cloud_endpoint_name,
                                          azure_file_share=None):
    return client.begin_pre_backup(resource_group_name=resource_group_name,
                                   storage_sync_service_name=storage_sync_service_name,
                                   sync_group_name=sync_group_name,
                                   cloud_endpoint_name=cloud_endpoint_name,
                                   azure_file_share=azure_file_share)
...
def storagesync_cloud_endpoint_pre_restore(cmd, client,
    ...
    return client.begin_pre_restore(resource_group_name=resource_group_name,
                                    storage_sync_service_name=storage_sync_service_name,
                                    sync_group_name=sync_group_name,
                                    cloud_endpoint_name=cloud_endpoint_name,
                                    partition=partition,
...
def storagesync_cloud_endpoint_trigger_change_detection(cmd, client,
    ...
    return client.begin_trigger_change_detection(resource_group_name=resource_group_name,
                                                 storage_sync_service_name=storage_sync_service_name,
                                                 sync_group_name=sync_group_name,
                                                 cloud_endpoint_name=cloud_endpoint_name,
...
def storagesync_server_endpoint_recall_action(cmd, client,
                                              ...
                                              pattern=None,
                                              recall_path=None):
    return client.begin_recall_action(resource_group_name=resource_group_name,
                                      storage_sync_service_name=storage_sync_service_name,
                                      sync_group_name=sync_group_name,
                                      server_endpoint_name=server_endpoint_name,
                                      pattern=pattern,
...
def storagesync_registered_server_trigger_rollover(cmd, client,
                                                   ...
                                                   server_id,
                                                   server_certificate=None):
    return client.begin_trigger_rollover(resource_group_name=resource_group_name,
                                         storage_sync_service_name=storage_sync_service_name,
                                         server_id=server_id,
                                         server_certificate=server_certificate)

...
class SyncGroupsOperations(object):
    ...
    def list_by_storage_sync_service(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SyncGroupArray"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagesync.models.SyncGroupArray]
    ...
    def create(
        ...
        parameters,  # type: "_models.SyncGroupCreateParameters"
        **kwargs  # type: Any
    ):

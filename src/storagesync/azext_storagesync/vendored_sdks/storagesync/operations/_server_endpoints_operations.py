...
class ServerEndpointsOperations(object):
    ...
    def _create_initial(
        ...
        parameters,  # type: "_models.ServerEndpointCreateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ServerEndpoint"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ServerEndpoint"]
    ...
    def _update_initial(
        ...
        sync_group_name,  # type: str
        server_endpoint_name,  # type: str
        parameters=None,  # type: Optional["_models.ServerEndpointUpdateParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ServerEndpoint"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.ServerEndpoint"]]
    ...
    def list_by_sync_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ServerEndpointArray"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagesync.models.ServerEndpointArray]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _recall_action_initial(
        ...
        sync_group_name,  # type: str
        server_endpoint_name,  # type: str
        parameters,  # type: "_models.RecallActionParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]

...
class CloudEndpointOperations(object):
    ...
    def _create_initial(
        ...
        **kwargs  # type: Any
        ...
        parameters = models.CloudEndpointCreateParameters(storage_account_resource_id=storage_account_resource_id, azure_file_share_name=azure_file_share_name, storage_account_tenant_id=storage_account_tenant_id, friendly_name=friendly_name)
    ...
    def _post_restore_initial(
        ...
        **kwargs  # type: Any
        ...
        parameters = models.PostRestoreRequest(partition=partition, replica_group=replica_group, request_id=request_id_parameter, azure_file_share_uri=azure_file_share_uri, status=status, source_azure_file_share_uri=source_azure_file_share_uri, failed_file_list=failed_file_list, restore_file_spec=restore_file_spec)
        api_version = "2020-09-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def _trigger_change_detection_initial(
        ...
        **kwargs  # type: Any
        ...
        parameters = models.TriggerChangeDetectionParameters(directory_path=directory_path, change_detection_mode=change_detection_mode, paths=paths)
        api_version = "2020-09-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

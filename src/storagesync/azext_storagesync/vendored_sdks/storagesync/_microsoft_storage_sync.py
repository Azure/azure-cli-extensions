...
class MicrosoftStorageSync(object):
    ...
    :vartype operations: microsoft_storage_sync.operations.Operations
    :ivar storage_sync_services: StorageSyncServicesOperations operations
    :vartype storage_sync_services: microsoft_storage_sync.operations.StorageSyncServicesOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources: microsoft_storage_sync.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections: microsoft_storage_sync.operations.PrivateEndpointConnectionsOperations
    :ivar sync_groups: SyncGroupsOperations operations
    :vartype sync_groups: microsoft_storage_sync.operations.SyncGroupsOperations
    :ivar cloud_endpoints: CloudEndpointsOperations operations
    :vartype cloud_endpoints: microsoft_storage_sync.operations.CloudEndpointsOperations
    :ivar server_endpoints: ServerEndpointsOperations operations
    :vartype server_endpoints: microsoft_storage_sync.operations.ServerEndpointsOperations
    :ivar registered_servers: RegisteredServersOperations operations
    :vartype registered_servers: microsoft_storage_sync.operations.RegisteredServersOperations
    :ivar workflows: WorkflowsOperations operations
    :vartype workflows: microsoft_storage_sync.operations.WorkflowsOperations

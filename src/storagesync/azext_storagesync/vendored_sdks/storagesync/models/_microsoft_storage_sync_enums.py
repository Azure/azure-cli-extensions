...
class ServerEndpointCloudTieringHealthState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ServerEndpointSyncHealthState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

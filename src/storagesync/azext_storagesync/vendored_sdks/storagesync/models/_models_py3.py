...
class CheckNameAvailabilityResult(msrest.serialization.Model):
    ...
    :ivar reason: Gets the reason that a Storage Sync Service name could not be used. The Reason
     ...
     "AlreadyExists".
    :vartype reason: str or ~microsoft_storage_sync.models.NameAvailabilityReason
...
class CloudEndpoint(Resource):
    ...
    :vartype change_enumeration_status:
     ~microsoft_storage_sync.models.CloudEndpointChangeEnumerationStatus
    """
...
class CloudEndpointArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.CloudEndpoint]
    """
...
class CloudEndpointChangeEnumerationActivity(msrest.serialization.Model):
    ...
    :vartype operation_state: str or
     ~microsoft_storage_sync.models.CloudEndpointChangeEnumerationActivityState
    ...
    :vartype total_counts_state: str or
     ~microsoft_storage_sync.models.CloudEndpointChangeEnumerationTotalCountsState
...
class CloudEndpointChangeEnumerationStatus(msrest.serialization.Model):
    ...
    :vartype last_enumeration_status:
     ~microsoft_storage_sync.models.CloudEndpointLastChangeEnumerationStatus
    :ivar activity: Change enumeration activity.
    :vartype activity: ~microsoft_storage_sync.models.CloudEndpointChangeEnumerationActivity
    """
...
class CloudTieringFilesNotTiering(msrest.serialization.Model):
    ...
    :vartype errors: list[~microsoft_storage_sync.models.FilesNotTieringError]
    """
...
class OperationEntity(msrest.serialization.Model):
    ...
    :type display: ~microsoft_storage_sync.models.OperationDisplayInfo
    :param origin: The origin.
    :type origin: str
    :param properties: Properties of the operations resource.
    :type properties: ~microsoft_storage_sync.models.OperationProperties
    """
...
class OperationEntityListResult(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.OperationEntity]
    """
...
class OperationProperties(msrest.serialization.Model):
    ...
    :type service_specification:
     ~microsoft_storage_sync.models.OperationResourceServiceSpecification
    """
...
class OperationResourceMetricSpecification(msrest.serialization.Model):
    ...
    :type dimensions:
     list[~microsoft_storage_sync.models.OperationResourceMetricSpecificationDimension]
    """
...
class OperationResourceServiceSpecification(msrest.serialization.Model):
    ...
    :type metric_specifications:
     list[~microsoft_storage_sync.models.OperationResourceMetricSpecification]
    """
...
class OperationStatus(msrest.serialization.Model):
    ...
    :vartype error: ~microsoft_storage_sync.models.StorageSyncApiError
    """
...
class PrivateEndpointConnection(Resource):
    ...
    :type private_link_service_connection_state:
     ~microsoft_storage_sync.models.PrivateLinkServiceConnectionState
    :ivar provisioning_state: The provisioning state of the private endpoint connection resource.
     Possible values include: "Succeeded", "Creating", "Deleting", "Failed".
    :vartype provisioning_state: str or
     ~microsoft_storage_sync.models.PrivateEndpointConnectionProvisioningState
    """
...
class PrivateEndpointConnectionListResult(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.PrivateEndpointConnection]
    """
...
class PrivateLinkResourceListResult(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.PrivateLinkResource]
    """
...
class PrivateLinkServiceConnectionState(msrest.serialization.Model):
    ...
    :type status: str or ~microsoft_storage_sync.models.PrivateEndpointServiceConnectionStatus
...
class RegisteredServer(Resource):
    ...
    :vartype agent_version_status: str or
     ~microsoft_storage_sync.models.RegisteredServerAgentVersionStatus
...
class RegisteredServerArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.RegisteredServer]
    """
...
class ServerEndpoint(Resource):
    ...
    :vartype sync_status: ~microsoft_storage_sync.models.ServerEndpointSyncStatus
    ...
    :vartype cloud_tiering_status: ~microsoft_storage_sync.models.ServerEndpointCloudTieringStatus
    :ivar recall_status: Recall status. Only populated if cloud tiering is enabled.
    :vartype recall_status: ~microsoft_storage_sync.models.ServerEndpointRecallStatus
    ...
    :type initial_upload_policy: str or ~microsoft_storage_sync.models.InitialUploadPolicy
    :ivar server_name: Server name.
    :vartype server_name: str
    """
...
class ServerEndpointArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.ServerEndpoint]
    """
...
class ServerEndpointCloudTieringStatus(msrest.serialization.Model):
    ...
    :ivar health: Cloud tiering health state. Possible values include: "Unavailable", "Healthy",
     "Error".
    :vartype health: str or ~microsoft_storage_sync.models.ServerEndpointHealthState
    ...
    :vartype space_savings: ~microsoft_storage_sync.models.CloudTieringSpaceSavings
    :ivar cache_performance: Information regarding how well the local cache on the server is
     performing.
    :vartype cache_performance: ~microsoft_storage_sync.models.CloudTieringCachePerformance
    ...
    :vartype volume_free_space_policy_status:
     ~microsoft_storage_sync.models.CloudTieringVolumeFreeSpacePolicyStatus
    :ivar date_policy_status: Status of the date policy.
    :vartype date_policy_status: ~microsoft_storage_sync.models.CloudTieringDatePolicyStatus
    """
...
class ServerEndpointRecallStatus(msrest.serialization.Model):
    ...
    :vartype recall_errors: list[~microsoft_storage_sync.models.ServerEndpointRecallError]
    """
...
class ServerEndpointSyncActivityStatus(msrest.serialization.Model):
    ...
    :vartype sync_mode: str or ~microsoft_storage_sync.models.ServerEndpointSyncMode
...
class ServerEndpointSyncSessionStatus(msrest.serialization.Model):
    ...
    :vartype files_not_syncing_errors:
     list[~microsoft_storage_sync.models.ServerEndpointFilesNotSyncingError]
    :ivar last_sync_mode: Sync mode. Possible values include: "Regular", "NamespaceDownload",
     "InitialUpload", "SnapshotUpload", "InitialFullDownload".
    :vartype last_sync_mode: str or ~microsoft_storage_sync.models.ServerEndpointSyncMode
    """
...
class ServerEndpointSyncStatus(msrest.serialization.Model):
    ...
    :ivar download_health: Download Health Status. Possible values include: "Unavailable",
     "Healthy", "Error".
    :vartype download_health: str or ~microsoft_storage_sync.models.ServerEndpointHealthState
    :ivar upload_health: Upload Health Status. Possible values include: "Unavailable", "Healthy",
     "Error".
    :vartype upload_health: str or ~microsoft_storage_sync.models.ServerEndpointHealthState
    :ivar combined_health: Combined Health Status. Possible values include: "Unavailable",
     "Healthy", "Error".
    :vartype combined_health: str or ~microsoft_storage_sync.models.ServerEndpointHealthState
    :ivar sync_activity: Sync activity. Possible values include: "Upload", "Download",
     "UploadAndDownload".
    :vartype sync_activity: str or ~microsoft_storage_sync.models.ServerEndpointSyncActivityState
    ...
    :vartype upload_status: ~microsoft_storage_sync.models.ServerEndpointSyncSessionStatus
    :ivar download_status: Download Status.
    :vartype download_status: ~microsoft_storage_sync.models.ServerEndpointSyncSessionStatus
    :ivar upload_activity: Upload sync activity.
    :vartype upload_activity: ~microsoft_storage_sync.models.ServerEndpointSyncActivityStatus
    :ivar download_activity: Download sync activity.
    :vartype download_activity: ~microsoft_storage_sync.models.ServerEndpointSyncActivityStatus
    ...
    :vartype background_data_download_activity:
     ~microsoft_storage_sync.models.ServerEndpointBackgroundDataDownloadActivity
    """
...
class StorageSyncApiError(msrest.serialization.Model):
    ...
    :type details: ~microsoft_storage_sync.models.StorageSyncErrorDetails
    :param inner_error: Inner error details of the given entry.
    :type inner_error: ~microsoft_storage_sync.models.StorageSyncInnerErrorDetails
    """
...
class StorageSyncError(msrest.serialization.Model):
    ...
    :type error: ~microsoft_storage_sync.models.StorageSyncApiError
    :param innererror: Error details of the given entry.
    :type innererror: ~microsoft_storage_sync.models.StorageSyncApiError
    """
...
class StorageSyncService(TrackedResource):
    ...
    :vartype private_endpoint_connections:
     list[~microsoft_storage_sync.models.PrivateEndpointConnection]
    """
...
class StorageSyncServiceArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.StorageSyncService]
    """
...
class SubscriptionState(msrest.serialization.Model):
    ...
    :type state: str or ~microsoft_storage_sync.models.Reason
...
class SyncGroupArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.SyncGroup]
    """
...
class Workflow(Resource):
    ...
    :param status: workflow status. Possible values include: "active", "expired", "succeeded",
     "aborted", "failed".
    :type status: str or ~microsoft_storage_sync.models.WorkflowStatus
    :param operation: operation direction. Possible values include: "do", "undo", "cancel".
    :type operation: str or ~microsoft_storage_sync.models.OperationDirection
...
class WorkflowArray(msrest.serialization.Model):
    ...
    :type value: list[~microsoft_storage_sync.models.Workflow]
    """

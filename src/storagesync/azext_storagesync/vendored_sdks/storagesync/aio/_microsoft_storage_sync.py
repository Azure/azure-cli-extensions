...
class MicrosoftStorageSync(object):
    ...
    :vartype operation: microsoft_storage_sync.aio.operations.OperationOperations
    :ivar storage_sync_service: StorageSyncServiceOperations operations
    :vartype storage_sync_service: microsoft_storage_sync.aio.operations.StorageSyncServiceOperations
    :ivar private_link_resource: PrivateLinkResourceOperations operations
    :vartype private_link_resource: microsoft_storage_sync.aio.operations.PrivateLinkResourceOperations
    :ivar private_endpoint_connection: PrivateEndpointConnectionOperations operations
    :vartype private_endpoint_connection: microsoft_storage_sync.aio.operations.PrivateEndpointConnectionOperations
    :ivar sync_group: SyncGroupOperations operations
    :vartype sync_group: microsoft_storage_sync.aio.operations.SyncGroupOperations
    :ivar cloud_endpoint: CloudEndpointOperations operations
    :vartype cloud_endpoint: microsoft_storage_sync.aio.operations.CloudEndpointOperations
    :ivar server_endpoint: ServerEndpointOperations operations
    :vartype server_endpoint: microsoft_storage_sync.aio.operations.ServerEndpointOperations
    :ivar registered_server: RegisteredServerOperations operations
    :vartype registered_server: microsoft_storage_sync.aio.operations.RegisteredServerOperations
    :ivar workflow: WorkflowOperations operations
    :vartype workflow: microsoft_storage_sync.aio.operations.WorkflowOperations

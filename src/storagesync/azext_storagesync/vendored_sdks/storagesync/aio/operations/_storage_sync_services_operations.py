...
class StorageSyncServicesOperations:
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.CheckNameAvailabilityParameters
    ...
    async def _create_initial(
        ...
        **kwargs
    ) -> Optional["models.StorageSyncService"]:
    ...
    async def begin_create(
        ...
        parameters: "models.StorageSyncServiceCreateParameters",
        **kwargs
    ) -> AsyncLROPoller["models.StorageSyncService"]:
        ...
        :type parameters: ~microsoft_storage_sync.models.StorageSyncServiceCreateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft_storage_sync.models.StorageSyncService]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        storage_sync_service_name: str,
        parameters: Optional["models.StorageSyncServiceUpdateParameters"] = None,
        **kwargs
    ) -> Optional["models.StorageSyncService"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.StorageSyncService"]]
        error_map = {
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.StorageSyncServiceUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs
    ) -> AsyncIterable["models.StorageSyncServiceArray"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_storage_sync.models.StorageSyncServiceArray]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class StorageSyncServiceOperations:
    """StorageSyncServiceOperations async operations.
    ...
    async def _create_initial(
        ...
        incoming_traffic_policy: Optional[Union[str, "models.IncomingTrafficPolicy"]] = None,
        **kwargs
        ...
        parameters = models.StorageSyncServiceCreateParameters(location=location, tags=tags, incoming_traffic_policy=incoming_traffic_policy)
        api_version = "2020-09-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

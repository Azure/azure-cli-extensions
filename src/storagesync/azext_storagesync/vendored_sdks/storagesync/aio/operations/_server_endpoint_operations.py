...
class ServerEndpointOperations:
    ...
    async def _create_initial(
        ...
        **kwargs
    ) -> Optional["models.ServerEndpoint"]:
    ...
    async def begin_create(
        ...
        local_cache_mode: Optional[Union[str, "models.LocalCacheMode"]] = None,
        **kwargs
    ) -> AsyncLROPoller["models.ServerEndpoint"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft_storage_sync.models.ServerEndpoint]

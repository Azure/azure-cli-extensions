...
class SyncGroupsOperations:
    ...
    def list_by_storage_sync_service(
        ...
        **kwargs
    ) -> AsyncIterable["models.SyncGroupArray"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_storage_sync.models.SyncGroupArray]
    ...
    async def create(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.SyncGroupCreateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response

...
class RegisteredServerOperations:
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        parameters = models.RegisteredServerCreateParameters(server_certificate=server_certificate, agent_version=agent_version, server_os_version=server_os_version, last_heart_beat=last_heart_beat, server_role=server_role, cluster_id=cluster_id, cluster_name=cluster_name, server_id=registered_server_create_parameters_properties_server_id, friendly_name=friendly_name)
        api_version = "2020-09-01"

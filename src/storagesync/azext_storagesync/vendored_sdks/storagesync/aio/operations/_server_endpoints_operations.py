...
class ServerEndpointsOperations:
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.ServerEndpointCreateParameters
    ...
    async def _update_initial(
        ...
        sync_group_name: str,
        server_endpoint_name: str,
        parameters: Optional["models.ServerEndpointUpdateParameters"] = None,
        **kwargs
    ) -> Optional["models.ServerEndpoint"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.ServerEndpoint"]]
        error_map = {
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.ServerEndpointUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    async def begin_recall_action(
        ...
        **kwargs
        ...
        :type parameters: ~microsoft_storage_sync.models.RecallActionParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy

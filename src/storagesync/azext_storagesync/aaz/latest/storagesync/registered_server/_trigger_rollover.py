...
class TriggerRollover(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.server_id = AAZStrArg(
            options=["--server-id"],
            help="Server Id",
            required=True,
        ...
        _args_schema = cls._args_schema
        _args_schema.server_certificate = AAZStrArg(
            options=["--server-certificate"],
            arg_group="Parameters",
            help="Certificate Data",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.RegisteredServersTriggerRollover(ctx=self.ctx)()
    ...
    class RegisteredServersTriggerRollover(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "serverId", self.ctx.args.server_id,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def content(self):
            ...
            _builder.set_prop("serverCertificate", AAZStrType, ".server_certificate")
...
class _TriggerRolloverHelper:
    """Helper class for TriggerRollover"""


__all__ = ["TriggerRollover"]

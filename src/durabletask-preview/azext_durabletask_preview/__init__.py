...
from azext_durabletask._help import helps  # pylint: disable=unused-import
...
class DurabletaskCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_durabletask._client_factory import cf_durabletask
    ...
    def load_arguments(self, command):
        from azext_durabletask._params import load_arguments

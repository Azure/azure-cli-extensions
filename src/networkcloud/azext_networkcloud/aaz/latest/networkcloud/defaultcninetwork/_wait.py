...
@register_command(
    "networkcloud defaultcninetwork wait",
)
class Wait(AAZWaitCommand):
    ...
    class DefaultCniNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_bgp_peer_read(bgp_peers.Element)
            ...
            _WaitHelper._build_schema_bgp_peer_read(fabric_bgp_peers.Element)

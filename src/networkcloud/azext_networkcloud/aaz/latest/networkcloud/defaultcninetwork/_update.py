...
@register_command(
    "networkcloud defaultcninetwork update",
    is_experimental=True,
)
class Update(AAZCommand):
    """Update tags associated with the provided default CNI network.

    :example: Update tags for CNI network
        az networkcloud defaultcninetwork update --tags key1="myvalue1" key2="myvalue2" --name "defaultCniNetworkName" --resource-group "resourceGroupName"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "DefaultCniNetworkUpdateParameters"

        _args_schema = cls._args_schema
        _args_schema.tags = AAZDictArg(
            options=["--tags"],
            arg_group="DefaultCniNetworkUpdateParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DefaultCniNetworksUpdate(ctx=self.ctx)()
    ...
    class DefaultCniNetworksUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_bgp_peer_read(bgp_peers.Element)
            ...
            _UpdateHelper._build_schema_bgp_peer_read(fabric_bgp_peers.Element)

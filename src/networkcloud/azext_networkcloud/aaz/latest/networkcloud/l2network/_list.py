...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.L2NetworksListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.L2NetworksListBySubscription(ctx=self.ctx)()
    ...
    class L2NetworksListByResourceGroup(AAZHttpOperation):
    ...
    class L2NetworksListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
class Update(AAZCommand):
    ...
    :example: Update tags for L3 network
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "L3NetworkUpdateParameters"

        _args_schema = cls._args_schema
        _args_schema.tags = AAZDictArg(
            options=["--tags"],
            arg_group="L3NetworkUpdateParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.L3NetworksUpdate(ctx=self.ctx)()
    ...
    class L3NetworksUpdate(AAZHttpOperation):

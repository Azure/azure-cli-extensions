...
class List(AAZCommand):
    ...
    :example: List trunked networks for subscription
        az networkcloud trunkednetwork list

    :example: List trunked networks for resource group
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.TrunkedNetworksListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.TrunkedNetworksListBySubscription(ctx=self.ctx)()
    ...
    class TrunkedNetworksListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            isolation_domain_ids = cls._schema_on_200.value.Element.properties.isolation_domain_ids
            ...
            vlans = cls._schema_on_200.value.Element.properties.vlans
    ...
    class TrunkedNetworksListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

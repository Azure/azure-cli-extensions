...
@register_command(
    "networkcloud trunkednetwork delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete trunked network
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/trunkednetworks/{}", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.TrunkedNetworksDelete(ctx=self.ctx)()
    ...
    class TrunkedNetworksDelete(AAZHttpOperation):

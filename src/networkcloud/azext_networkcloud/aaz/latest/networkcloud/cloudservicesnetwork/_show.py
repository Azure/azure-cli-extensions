...
class Show(AAZCommand):
    ...
    :example: Get cloud services network
    ...
    class CloudServicesNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_egress_endpoint_read(additional_egress_endpoints.Element)
            ...
            _ShowHelper._build_schema_egress_endpoint_read(enabled_egress_endpoints.Element)

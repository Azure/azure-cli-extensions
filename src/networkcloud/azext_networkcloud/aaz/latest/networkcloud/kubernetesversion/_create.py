...
@register_command(
    "networkcloud kubernetesversion create",
)
class Create(AAZCommand):
    ...
    :example: Create or update Kubernetes versions
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "KubernetesVersionParameters"

        _args_schema = cls._args_schema
        _args_schema.extended_location = AAZObjectArg(
            options=["--extended-location"],
            arg_group="KubernetesVersionParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.KubernetesVersionsCreateOrUpdate(ctx=self.ctx)()
    ...
    class KubernetesVersionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            values = cls._schema_on_200_201.properties.values
            values.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.values.Element

...
@register_command(
    "networkcloud kubernetesversion delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete the specified Kubernetes version resource.

    :example: Delete Kubernetes versions
        az networkcloud kubernetesversion delete --resource-group resourceGroupName --kubernetes-version-name default
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.KubernetesVersionsDelete(ctx=self.ctx)()
    ...
    class KubernetesVersionsDelete(AAZHttpOperation):

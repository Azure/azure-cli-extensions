...
class PowerOff(AAZCommand):
    ...
    :example: Power off virtual machine
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "VirtualMachinePowerOffParameters"

        _args_schema = cls._args_schema
        _args_schema.skip_shutdown = AAZStrArg(
            options=["--skip-shutdown"],
            arg_group="VirtualMachinePowerOffParameters",
            help="The indicator of whether to skip the graceful OS shutdown and power off the virtual machine immediately.",
            default="False",

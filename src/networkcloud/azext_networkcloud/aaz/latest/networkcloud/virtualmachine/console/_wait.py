...
@register_command(
    "networkcloud virtualmachine console wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/virtualmachines/{}/consoles/{}", "2026-08-01-preview"],
        ]
    }

...
class List(AAZCommand):
    ...
    :example: List consoles of the virtual machine
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConsolesListByVirtualMachine(ctx=self.ctx)()
    ...
    class ConsolesListByVirtualMachine(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            ssh_public_key = cls._schema_on_200.value.Element.properties.ssh_public_key

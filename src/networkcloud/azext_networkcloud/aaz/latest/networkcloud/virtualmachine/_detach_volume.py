...
@register_command(
    "networkcloud virtualmachine detach-volume",
    is_experimental=True,
)
class DetachVolume(AAZCommand):
    """Detach volume from the provided virtual machine.

    :example: Detach volume from virtual machine
        az networkcloud virtualmachine detach-volume --resource-group "resourceGroupName" --volume-id "/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/volumes/volumeName" --name "virtualMachineName"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "VirtualMachineDetachVolumeParameters"

        _args_schema = cls._args_schema
        _args_schema.volume_id = AAZStrArg(
            options=["--volume-id"],
            arg_group="VirtualMachineDetachVolumeParameters",
            help="The resource ID of the volume.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachinesDetachVolume(ctx=self.ctx)()
    ...
    class VirtualMachinesDetachVolume(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("volumeId", AAZStrType, ".volume_id", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200(cls):
            ...
            _DetachVolumeHelper._build_schema_operation_status_result_read(cls._schema_on_200)
...
class _DetachVolumeHelper:
    """Helper class for DetachVolume"""

...
class Start(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/virtualmachines/{}/start", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachinesStart(ctx=self.ctx)()
    ...
    class VirtualMachinesStart(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _StartHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

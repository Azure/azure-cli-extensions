...
@register_command(
    "networkcloud virtualmachine attach-volume",
    is_experimental=True,
)
class AttachVolume(AAZCommand):
    """Attach volume to the provided virtual machine.

    :example: Attach volume to virtual machine
        az networkcloud virtualmachine attach-volume --resource-group "resourceGroupName" --volume-id "/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/volumes/volumeName" --name "virtualMachineName"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "VirtualMachineAttachVolumeParameters"

        _args_schema = cls._args_schema
        _args_schema.volume_id = AAZStrArg(
            options=["--volume-id"],
            arg_group="VirtualMachineAttachVolumeParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachinesAttachVolume(ctx=self.ctx)()
    ...
    class VirtualMachinesAttachVolume(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AttachVolumeHelper._build_schema_operation_status_result_read(cls._schema_on_200)
...
class _AttachVolumeHelper:
    """Helper class for AttachVolume"""

...
@register_command(
    "networkcloud virtualmachine delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete virtual machine
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachinesDelete(ctx=self.ctx)()
    ...
    class VirtualMachinesDelete(AAZHttpOperation):

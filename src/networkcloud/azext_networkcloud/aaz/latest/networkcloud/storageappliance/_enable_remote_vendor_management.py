...
class EnableRemoteVendorManagement(AAZCommand):
    ...
    :example: Turn on remote vendor management for storage appliance
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/storageappliances/{}/enableremotevendormanagement", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StorageAppliancesEnableRemoteVendorManagement(ctx=self.ctx)()
    ...
    class StorageAppliancesEnableRemoteVendorManagement(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _EnableRemoteVendorManagementHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

            return cls._schema_on_200_201


class _EnableRemoteVendorManagementHelper:
    """Helper class for EnableRemoteVendorManagement"""
...
__all__ = ["EnableRemoteVendorManagement"]

...
class List(AAZCommand):
    ...
    :example: List storage appliances for subscription
        az networkcloud storageappliance list

    :example: List storage appliances for resource group
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.networkcloud/storageappliances", "2026-01-01-preview"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.StorageAppliancesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.StorageAppliancesListByResourceGroup(ctx=self.ctx)()
    ...
    class StorageAppliancesListBySubscription(AAZHttpOperation):
    ...
    class StorageAppliancesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

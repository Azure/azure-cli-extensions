...
class DisableRemoteVendorManagement(AAZCommand):
    ...
    :example: Turn off remote vendor management for storage appliance
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StorageAppliancesDisableRemoteVendorManagement(ctx=self.ctx)()
    ...
    class StorageAppliancesDisableRemoteVendorManagement(AAZHttpOperation):
...
class _DisableRemoteVendorManagementHelper:
    """Helper class for DisableRemoteVendorManagement"""
...
__all__ = ["DisableRemoteVendorManagement"]

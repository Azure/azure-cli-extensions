...
class RunDataExtractsRestricted(AAZCommand):
    ...
    :example: Run restricted data extraction on bare metal machine
        az networkcloud baremetalmachine run-data-extracts-restricted --resource-group "resourceGroupName" --name "bareMetalMachineName" --commands "[{command:'cluster-cve-report',arguments:['--min-severity=8']}]" --limit-time-seconds 60
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "BareMetalMachineRunDataExtractsRestrictedParameters"

        _args_schema = cls._args_schema
        _args_schema.commands = AAZListArg(
            options=["--commands"],
            arg_group="BareMetalMachineRunDataExtractsRestrictedParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BareMetalMachinesRunDataExtractsRestricted(ctx=self.ctx)()
    ...
    class BareMetalMachinesRunDataExtractsRestricted(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/runDataExtractsRestricted",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RunDataExtractsRestrictedHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

            return cls._schema_on_200_201


class _RunDataExtractsRestrictedHelper:
    """Helper class for RunDataExtractsRestricted"""
...
__all__ = ["RunDataExtractsRestricted"]

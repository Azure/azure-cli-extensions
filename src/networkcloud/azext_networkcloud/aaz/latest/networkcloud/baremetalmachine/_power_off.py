...
class PowerOff(AAZCommand):
    ...
    :example: Power off bare metal machine
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "BareMetalMachinePowerOffParameters"

        _args_schema = cls._args_schema
        _args_schema.skip_shutdown = AAZStrArg(
            options=["--skip-shutdown"],
            arg_group="BareMetalMachinePowerOffParameters",
            help="The indicator of whether to skip the graceful OS shutdown and power off the bare metal machine immediately.",
            default="False",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BareMetalMachinesPowerOff(ctx=self.ctx)()
    ...
    class BareMetalMachinesPowerOff(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _PowerOffHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

            return cls._schema_on_200_201


class _PowerOffHelper:
    """Helper class for PowerOff"""

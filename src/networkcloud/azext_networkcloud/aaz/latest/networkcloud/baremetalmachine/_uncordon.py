...
class Uncordon(AAZCommand):
    ...
    :example: Uncordon bare metal machine
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BareMetalMachinesUncordon(ctx=self.ctx)()
    ...
    class BareMetalMachinesUncordon(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UncordonHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

            return cls._schema_on_200_201


class _UncordonHelper:
    """Helper class for Uncordon"""

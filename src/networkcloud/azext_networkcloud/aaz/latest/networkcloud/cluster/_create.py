...
class Create(AAZCommand):
    ...
    :example: Create cluster with OpenBao secret archive provider
        az networkcloud cluster create --name "clusterName" --resource-group "resourceGroupName" --extended-location name="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ExtendedLocation/customLocations/clusterManagerExtendedLocationName" type="CustomLocation" --location "eastus" --cluster-location "Foo Street, 3rd Floor, row 9" --cluster-type "SingleRack" --cluster-version "3.0.0" --compute-deployment-threshold type="PercentSuccess" grouping="PerCluster" value="90" --network-fabric-id "/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.Network/virtualNetworks/test-vnet/subnets/default" --aggregator-or-single-rack-definition "./aggregator-or-single-rack-definition.json" --secret-archive-settings identity-type="UserAssignedIdentity" identity-resource-id="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUAI" vault-uri="https://openbao.example.com/" encryption-public-key="somepublickey" provider="OpenBao" authentication-method="AppRole" application-role-id="edge-credentials-role" authentication-mount-path="approle" key-value-version="V2" mount-path="kv" namespace="edge-credentials" path-template="azure-local/{namespace}/{name}"

    :example: Create cluster with HashiCorp Vault secret archive provider
        az networkcloud cluster create --name "clusterName" --resource-group "resourceGroupName" --extended-location name="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ExtendedLocation/customLocations/clusterManagerExtendedLocationName" type="CustomLocation" --location "eastus" --cluster-location "Foo Street, 3rd Floor, row 9" --cluster-type "SingleRack" --cluster-version "3.0.0" --compute-deployment-threshold type="PercentSuccess" grouping="PerCluster" value="90" --network-fabric-id "/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.Network/virtualNetworks/test-vnet/subnets/default" --aggregator-or-single-rack-definition "./aggregator-or-single-rack-definition.json" --secret-archive-settings identity-type="UserAssignedIdentity" identity-resource-id="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUAI" vault-uri="https://vault.example.com/" encryption-public-key="somepublickey" provider="HashiCorpVault" authentication-method="AppRole" application-role-id="edge-credentials-role" authentication-mount-path="approle" key-value-version="V2" mount-path="secret" namespace="edge-credentials" path-template="azure-local/{namespace}/{name}"

    :example: Create cluster with CyberArk secret archive provider
        az networkcloud cluster create --name "clusterName" --resource-group "resourceGroupName" --extended-location name="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ExtendedLocation/customLocations/clusterManagerExtendedLocationName" type="CustomLocation" --location "eastus" --cluster-location "Foo Street, 3rd Floor, row 9" --cluster-type "SingleRack" --cluster-version "3.0.0" --compute-deployment-threshold type="PercentSuccess" grouping="PerCluster" value="90" --network-fabric-id "/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.Network/virtualNetworks/test-vnet/subnets/default" --aggregator-or-single-rack-definition "./aggregator-or-single-rack-definition.json" --secret-archive-settings identity-type="UserAssignedIdentity" identity-resource-id="/subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUAI" vault-uri="https://cyberark.example.com/" encryption-public-key="somepublickey" provider="CyberArk" application-id="EdgeCredentials" safe-name="Azure-Local-Credentials" folder-name="Root" object-name-template="{namespace}-{name}"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _element.command_output_type = AAZStrArg(
            ...
            enum={"BareMetalMachineRunCommand": "BareMetalMachineRunCommand", "BareMetalMachineRunDataExtracts": "BareMetalMachineRunDataExtracts", "BareMetalMachineRunDataExtractsRestricted": "BareMetalMachineRunDataExtractsRestricted", "BareMetalMachineRunReadCommands": "BareMetalMachineRunReadCommands", "ClusterSupportAdministrativeActions": "ClusterSupportAdministrativeActions", "StorageRunReadCommands": "StorageRunReadCommands"},
        )
    ...
    class ClustersCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            edge_management_service_ca_certificate = cls._schema_on_200_201.properties.edge_management_service_ca_certificate
            ...
            managed_credentials = cls._schema_on_200_201.properties.managed_credentials
            ...
            provider_configuration = cls._schema_on_200_201.properties.secret_archive_settings.provider_configuration
            provider_configuration.provider = AAZStrType(
                flags={"required": True},
            )

            disc_cyber_ark = cls._schema_on_200_201.properties.secret_archive_settings.provider_configuration.discriminate_by("provider", "CyberArk")
            ...
            disc_hashi_corp_vault = cls._schema_on_200_201.properties.secret_archive_settings.provider_configuration.discriminate_by("provider", "HashiCorpVault")
            ...
            disc_open_bao = cls._schema_on_200_201.properties.secret_archive_settings.provider_configuration.discriminate_by("provider", "OpenBao")

...
class ContinueUpdateVersion(AAZCommand):
    ...
    :example: Continue a paused update to the cluster version
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "ClusterContinueUpdateVersionParameters"
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ClustersContinueUpdateVersion(ctx=self.ctx)()
    ...
    class ClustersContinueUpdateVersion(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _ContinueUpdateVersionHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

            return cls._schema_on_200_201


class _ContinueUpdateVersionHelper:
    """Helper class for ContinueUpdateVersion"""

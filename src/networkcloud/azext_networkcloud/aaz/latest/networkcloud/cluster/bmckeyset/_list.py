...
class List(AAZCommand):
    ...
    :example: List baseboard management controller key sets of the cluster
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/clusters/{}/bmckeysets", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BmcKeySetsListByCluster(ctx=self.ctx)()
    ...
    class BmcKeySetsListByCluster(AAZHttpOperation):

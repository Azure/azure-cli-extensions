...
class Deploy(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "ClusterDeployParameters"
        ...
        skip_validations_for_machines = cls._args_schema.skip_validations_for_machines
        skip_validations_for_machines.Element = AAZStrArg()
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ClustersDeploy(ctx=self.ctx)()
    ...
    class ClustersDeploy(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("skipValidationsForMachines", AAZListType, ".skip_validations_for_machines")

            skip_validations_for_machines = _builder.get(".skipValidationsForMachines")
            if skip_validations_for_machines is not None:
                skip_validations_for_machines.set_elements(AAZStrType, ".")
        ...
        def _build_schema_on_200_201(cls):
            ...
            _DeployHelper._build_schema_operation_status_result_read(cls._schema_on_200_201)

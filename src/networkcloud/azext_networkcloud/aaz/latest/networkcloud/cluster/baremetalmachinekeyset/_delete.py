...
class Delete(AAZCommand):
    ...
    :example: Delete bare metal machine key set of cluster
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/clusters/{}/baremetalmachinekeysets/{}", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BareMetalMachineKeySetsDelete(ctx=self.ctx)()
    ...
    class BareMetalMachineKeySetsDelete(AAZHttpOperation):

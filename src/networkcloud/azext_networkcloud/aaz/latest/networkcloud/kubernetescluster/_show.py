...
@register_command(
    "networkcloud kubernetescluster show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get properties of the provided the Kubernetes cluster.

    :example: Get Kubernetes cluster
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.KubernetesClustersGet(ctx=self.ctx)()
    ...
    class KubernetesClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_ssh_public_key_read(ssh_public_keys.Element)
            ...
            _ShowHelper._build_schema_l2_network_attachment_configuration_read(l2_networks.Element)
            ...
            _ShowHelper._build_schema_l3_network_attachment_configuration_read(l3_networks.Element)
            ...
            _ShowHelper._build_schema_trunked_network_attachment_configuration_read(trunked_networks.Element)
            ...
            _element = cls._schema_on_200.properties.network_configuration.bgp_service_load_balancer_configuration.ip_address_pools.Element
            ...
            addresses = cls._schema_on_200.properties.network_configuration.bgp_service_load_balancer_configuration.ip_address_pools.Element.addresses

...
@register_command(
    "networkcloud kubernetescluster feature list",
    is_preview=True,
)
class List(AAZCommand):
    """List a list of features for the provided Kubernetes cluster.

    :example: List features for the Kubernetes cluster.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.KubernetesClusterFeaturesListByKubernetesCluster(ctx=self.ctx)()
    ...
    class KubernetesClusterFeaturesListByKubernetesCluster(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            options = cls._schema_on_200.value.Element.properties.options
            options.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.options.Element

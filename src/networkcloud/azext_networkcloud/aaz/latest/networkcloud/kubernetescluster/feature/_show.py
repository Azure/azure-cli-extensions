...
@register_command(
    "networkcloud kubernetescluster feature show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get properties of the provided the Kubernetes cluster feature.

    :example: Get Kubernetes cluster feature
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.KubernetesClusterFeaturesGet(ctx=self.ctx)()
    ...
    class KubernetesClusterFeaturesGet(AAZHttpOperation):

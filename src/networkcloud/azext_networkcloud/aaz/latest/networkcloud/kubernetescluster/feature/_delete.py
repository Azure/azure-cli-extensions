...
@register_command(
    "networkcloud kubernetescluster feature delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete Kubernetes cluster feature
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.KubernetesClusterFeaturesDelete(ctx=self.ctx)()
    ...
    class KubernetesClusterFeaturesDelete(AAZHttpOperation):

...
@register_command(
    "networkcloud kubernetescluster wait",
)
class Wait(AAZWaitCommand):
    ...
    class KubernetesClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_ssh_public_key_read(ssh_public_keys.Element)
            ...
            _WaitHelper._build_schema_l2_network_attachment_configuration_read(l2_networks.Element)
            ...
            _WaitHelper._build_schema_l3_network_attachment_configuration_read(l3_networks.Element)
            ...
            _WaitHelper._build_schema_trunked_network_attachment_configuration_read(trunked_networks.Element)

...
@register_command(
    "networkcloud kubernetescluster delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete Kubernetes cluster
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.KubernetesClustersDelete(ctx=self.ctx)()
    ...
    class KubernetesClustersDelete(AAZHttpOperation):

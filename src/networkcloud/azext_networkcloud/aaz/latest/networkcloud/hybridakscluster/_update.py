...
@register_command(
    "networkcloud hybridakscluster update",
    is_experimental=True,
)
class Update(AAZCommand):
    """Update tags associated with the additional details related to the Hybrid AKS provisioned cluster.

    :example: Update tags for Hybrid AKS provisioned cluster data
        az networkcloud hybridakscluster update --name "hybridAksClusterName" --tags key1="myvalue1" key2="myvalue2" --resource-group "resourceGroupName"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "HybridAksClusterUpdateParameters"

        _args_schema = cls._args_schema
        _args_schema.tags = AAZDictArg(
            options=["--tags"],
            arg_group="HybridAksClusterUpdateParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.HybridAksClustersUpdate(ctx=self.ctx)()
    ...
    class HybridAksClustersUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_node_configuration_read(control_plane_nodes.Element)
            ...
            _UpdateHelper._build_schema_node_configuration_read(worker_nodes.Element)

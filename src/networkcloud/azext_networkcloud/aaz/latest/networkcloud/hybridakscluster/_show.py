...
class Show(AAZCommand):
    ...
    class HybridAksClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_node_configuration_read(control_plane_nodes.Element)
            ...
            _ShowHelper._build_schema_node_configuration_read(worker_nodes.Element)

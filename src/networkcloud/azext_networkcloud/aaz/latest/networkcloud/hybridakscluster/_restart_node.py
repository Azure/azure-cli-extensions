...
@register_command(
    "networkcloud hybridakscluster restart-node",
    is_experimental=True,
)
class RestartNode(AAZCommand):
    """Restart a targeted node of the Hybrid AKS provisioned cluster.

    :example: Restart a Hybrid AKS cluster node
        az networkcloud hybridakscluster restart-node --name "hybridAksClusterName" --node-name "nodeName" --resource-group "resourceGroupName"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "HybridAksClusterRestartNodeParameters"

        _args_schema = cls._args_schema
        _args_schema.node_name = AAZStrArg(
            options=["--node-name"],
            arg_group="HybridAksClusterRestartNodeParameters",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.HybridAksClustersRestartNode(ctx=self.ctx)()
    ...
    class HybridAksClustersRestartNode(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RestartNodeHelper._build_schema_operation_status_result_read(cls._schema_on_200)

...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.networkcloud/volumes", "2026-07-01"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/volumes", "2026-07-01"],
        ]
    }

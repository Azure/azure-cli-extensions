...
class List(AAZCommand):
    ...
    :example: List volumes for resource group
        az networkcloud volume list --resource-group "resourceGroupName"

    :example: List volumes for  subscription
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.networkcloud/volumes", "2026-01-01-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.networkcloud/volumes", "2026-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.VolumesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.VolumesListByResourceGroup(ctx=self.ctx)()
    ...
    class VolumesListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            attached_to = cls._schema_on_200.value.Element.properties.attached_to
    ...
    class VolumesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

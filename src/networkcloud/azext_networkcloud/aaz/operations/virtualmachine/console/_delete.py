...
"""
Provides VirtualMachine Console delete customization

"""

from azext_networkcloud.aaz.latest.networkcloud.virtualmachine.console._delete import \
    Delete
...
class VirtualMachineConsoleDelete(Delete):
    '''

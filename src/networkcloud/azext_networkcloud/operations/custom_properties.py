...
# pylint: disable=too-many-statements,too-few-public-methods,unused-wildcard-import,wildcard-import
# flake8: noqa
...
class CustomActionProperties:
    ...
    def _build_schema_operation_status_result_read(cls, _schema):
        ...
        cls._schema_operation_status_result_read = _schema_operation_status_result_read \
            = AAZObjectType()
        ...
        cls._build_schema_properties_read(
            operation_status_result_read.properties)

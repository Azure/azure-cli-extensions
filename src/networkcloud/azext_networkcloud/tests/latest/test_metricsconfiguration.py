...
def step_create(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud cluster metricsconfiguration create --cluster-name {clusterName} '
...
class MetricsConfigurationScenarioTest(ScenarioTest):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs.update({
            ...
            'extendedLocation': CONFIG.get('METRICSCONFIGURATION', 'extended_location'),
            'tags': CONFIG.get('METRICSCONFIGURATION', 'tags'),
            'collectionInterval': CONFIG.get('METRICSCONFIGURATION', 'collection_interval'),

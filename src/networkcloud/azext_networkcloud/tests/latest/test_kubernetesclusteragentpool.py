...
class KubernetesClusterAgentPoolScenarioTest(ScenarioTest):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs.update({
            ...
            'clusterName': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'cluster_name'),
            'rg': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'resource_group'),
            'location': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'location'),
            'extendedLocation': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'extended_location'),
            ...
            'adminUsername': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'admin_username'),
            ...
            'agentOptions': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'agent_options'),
            ...
            'availabilityZones': CONFIG.get('KUBERNETESCLUSTER_AGENTPOOL', 'availability_zones'),

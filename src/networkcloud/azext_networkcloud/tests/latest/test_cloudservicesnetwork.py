...
def step_create(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud cloudservicesnetwork create --name {name} --extended-location '
...
class CloudServicesNetworkScenarioTest(ScenarioTest):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs.update({
            ...
            'extendedLocation': CONFIG.get('CLOUD_SERVICES_NETWORK', 'extended_location'),
            'additionalEgressEndpoint': CONFIG.get('CLOUD_SERVICES_NETWORK', 'additional_egress_endpoint'),
            'defaultEgressEndpoint': CONFIG.get('CLOUD_SERVICES_NETWORK', 'default_egress_endpoint'),

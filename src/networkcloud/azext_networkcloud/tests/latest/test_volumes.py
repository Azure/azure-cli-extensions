...
def step_create(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud volume create --resource-group {resourceGroup} '
...
def step_update(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud volume update --resource-group {resourceGroup} '
...
def step_show(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud volume show --resource-group {resourceGroup} '
             '--name {name}',
             checks=checks)
...
def step_list_by_resource_group(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud volume list --resource-group {resourceGroup}',
             checks=checks)
...
def step_delete(test, checks=None):
    ...
    if checks is None:
        checks = []
    test.cmd('az networkcloud volume delete --resource-group {resourceGroup} '
             ' --name {name} -y')

...
class TestCustomProperties(unittest.TestCase):
    ...
    def test_output(self):
        ...
        self.cmd.ctx.vars.instance.properties.output_head.to_serialized_data = mock.Mock(side_effect='HEADER')
        ...
        self.cmd.ctx.vars.instance.properties.result_url.to_serialized_data = mock.Mock(side_effect=test_url)

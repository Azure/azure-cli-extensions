...
class TestKubernetesClusterCreate(unittest.TestCase):
    ...
    def test_build_arguments_schema(self):
        ...
        self.assertIsNotNone(results_args_schema.control_plane_node_configuration.ssh_key_values)
        self.assertIsNotNone(results_args_schema.initial_agent_pool_configurations.Element.ssh_key_values)

        # valdiate registered parameters        
        self.assertFalse(results_args_schema.ssh_public_keys._registered)
        self.assertFalse(results_args_schema.initial_agent_pool_configurations.Element.ssh_public_keys._registered)
        self.assertFalse(results_args_schema.control_plane_node_configuration.ssh_public_keys._registered)        

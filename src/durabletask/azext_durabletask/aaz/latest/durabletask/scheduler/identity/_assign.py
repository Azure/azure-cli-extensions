...
@register_command(
    "durabletask scheduler identity assign",
    is_preview=True,
)
class Assign(AAZCommand):
    """Assign the user or system managed identities.

    :example: Assign User Managed Identity
        az durabletask scheduler identity assign --resource-group rgopenapi --name testscheduler --user-assigned /subscriptions/EE9BD735-67CE-4A90-89C4-439D3F6A4C93/resourceGroups/rgcopilot/providers/Microsoft.ManagedIdentity/userAssignedIdentities/testidentity
    """
    ...
    class SchedulersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_scheduler_read(cls._schema_on_200)
    ...
    class SchedulersCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_scheduler_read(cls._schema_on_200_201)

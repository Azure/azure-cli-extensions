...
@register_command(
    "durabletask scheduler transparent-data-encryption update",
    is_preview=True,
)
class Update(AAZCommand):
    """Update a Transparent Data Encryption

    :example: Update Transparent Data Encryption
    ...
    class TransparentDataEncryptionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_transparent_data_encryption_read(cls._schema_on_200)
    ...
    class TransparentDataEncryptionsCreateOrReplace(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_transparent_data_encryption_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_transparent_data_encryption_read = None

    @classmethod
    def _build_schema_transparent_data_encryption_read(cls, _schema):
        if cls._schema_transparent_data_encryption_read is not None:
            _schema.id = cls._schema_transparent_data_encryption_read.id
            _schema.name = cls._schema_transparent_data_encryption_read.name
            _schema.properties = cls._schema_transparent_data_encryption_read.properties
            _schema.system_data = cls._schema_transparent_data_encryption_read.system_data
            _schema.type = cls._schema_transparent_data_encryption_read.type
            return

        cls._schema_transparent_data_encryption_read = _schema_transparent_data_encryption_read = AAZObjectType()

        transparent_data_encryption_read = _schema_transparent_data_encryption_read
        transparent_data_encryption_read.id = AAZStrType(
            flags={"read_only": True},
        )
        transparent_data_encryption_read.name = AAZStrType(
            flags={"read_only": True},
        )
        transparent_data_encryption_read.properties = AAZObjectType()
        transparent_data_encryption_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        transparent_data_encryption_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_transparent_data_encryption_read.properties
        ...
        system_data = _schema_transparent_data_encryption_read.system_data

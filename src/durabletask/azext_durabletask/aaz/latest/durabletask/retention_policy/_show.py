...
@register_command(
    "durabletask retention-policy show",
)
class Show(AAZCommand):
    ...
    class RetentionPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            retention_policies = cls._schema_on_200.properties.retention_policies
            retention_policies.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.retention_policies.Element

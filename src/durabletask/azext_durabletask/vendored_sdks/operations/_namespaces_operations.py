...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DurableTask/namespaces")
...
class NamespacesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Namespace"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.durabletask.models.Namespace]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Namespace"]:
    ...
    def get(self, resource_group_name: str, namespace_name: str, **kwargs: Any) -> _models.Namespace:
        ...
        :rtype: ~azure.mgmt.durabletask.models.Namespace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def _create_or_update_initial(
        ...
        namespace_name: str,
        resource: Union[_models.Namespace, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.durabletask.models.Namespace
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Namespace or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.durabletask.models.Namespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Namespace type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.durabletask.models.Namespace or IO[bytes]
        :return: An instance of LROPoller that returns either Namespace or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.durabletask.models.Namespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        namespace_name: str,
        properties: Union[_models.NamespaceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.durabletask.models.NamespaceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Namespace or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.durabletask.models.NamespaceUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Namespace or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.durabletask.models.Namespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

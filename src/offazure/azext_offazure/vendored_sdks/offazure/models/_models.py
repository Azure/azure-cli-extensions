...
class AgentConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.dependency_agent_id = kwargs.get('dependency_agent_id', None)
        self.dependency_agent_version = kwargs.get('dependency_agent_version', None)
        self.dependency_agent_revision = kwargs.get('dependency_agent_revision', None)
        self.reboot_status = kwargs.get('reboot_status', None)
        self.clock_granularity = kwargs.get('clock_granularity', None)
...
class HyperVClusterProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.host_fqdn_list = kwargs.get('host_fqdn_list', None)
        self.errors = None
...
class HypervisorConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.hypervisor_type = kwargs.get('hypervisor_type', None)
        self.native_host_machine_id = kwargs.get('native_host_machine_id', None)
...
class HyperVSiteUsage(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.run_as_account_count = kwargs.get('run_as_account_count', None)
        self.host_count = kwargs.get('host_count', None)
        self.cluster_count = kwargs.get('cluster_count', None)
...
class Machine(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.properties_timestamp = kwargs.get('properties_timestamp', None)
        self.properties_monitoring_state = kwargs.get('properties_monitoring_state', None)
        self.properties_virtualization_state = kwargs.get('properties_virtualization_state', None)
        self.properties_display_name = kwargs.get('properties_display_name', None)
        self.properties_computer_name = kwargs.get('properties_computer_name', None)
        self.properties_fully_qualified_domain_name = kwargs.get('properties_fully_qualified_domain_name', None)
        self.properties_boot_time = kwargs.get('properties_boot_time', None)
        self.properties_timezone = kwargs.get('properties_timezone', None)
        self.properties_agent = kwargs.get('properties_agent', None)
        self.properties_resources = kwargs.get('properties_resources', None)
        self.properties_networking = kwargs.get('properties_networking', None)
        self.properties_operating_system = kwargs.get('properties_operating_system', None)
        self.properties_virtual_machine = kwargs.get('properties_virtual_machine', None)
        self.properties_hypervisor = kwargs.get('properties_hypervisor', None)
        self.properties_hosting = kwargs.get('properties_hosting', None)
...
class MachineResourcesConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.physical_memory = kwargs.get('physical_memory', None)
        self.cpus = kwargs.get('cpus', None)
        self.cpu_speed = kwargs.get('cpu_speed', None)
        self.cpu_speed_accuracy = kwargs.get('cpu_speed_accuracy', None)
...
class NetworkConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ipv4_interfaces = kwargs.get('ipv4_interfaces', None)
        self.ipv6_interfaces = kwargs.get('ipv6_interfaces', None)
        self.default_ipv4_gateways = kwargs.get('default_ipv4_gateways', None)
        self.mac_addresses = kwargs.get('mac_addresses', None)
        self.dns_names = kwargs.get('dns_names', None)
        self.dns_questions = kwargs.get('dns_questions', None)
        self.dns_canonical_names = kwargs.get('dns_canonical_names', None)
...
class OperatingSystemConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.bitness = kwargs.get('bitness', None)
...
class SiteHealthSummary(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.affected_objects_count = kwargs.get('affected_objects_count', None)
        self.hit_count = kwargs.get('hit_count', None)
        self.severity = None
        self.remediation_guidance = None
        self.affected_resource_type = None
        self.affected_resources = kwargs.get('affected_resources', None)
...
class SiteProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.service_principal_identity_details = kwargs.get('service_principal_identity_details', None)
        self.agent_details = kwargs.get('agent_details', None)
        self.service_endpoint = None
        self.discovery_solution_id = kwargs.get('discovery_solution_id', None)
        self.appliance_name = kwargs.get('appliance_name', None)
...
class VirtualMachineConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.virtual_machine_type = kwargs.get('virtual_machine_type', None)
        self.native_machine_id = kwargs.get('native_machine_id', None)
...
class VMwareSiteUsage(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.machine_count = kwargs.get('machine_count', None)
        self.run_as_account_count = kwargs.get('run_as_account_count', None)
        self.v_center_count = kwargs.get('v_center_count', None)

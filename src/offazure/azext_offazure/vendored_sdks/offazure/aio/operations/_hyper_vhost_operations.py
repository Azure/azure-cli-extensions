...
class HyperVHostOperations:
    """HyperVHostOperations async operations.
    ...
    def get_all_hosts_in_site(
        ...
        **kwargs
    ) -> AsyncIterable["models.HyperVHostCollection"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_migrate_v2.models.HyperVHostCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

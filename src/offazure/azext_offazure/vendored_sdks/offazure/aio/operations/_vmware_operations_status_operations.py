...
class VMwareOperationsStatusOperations:
    """VMwareOperationsStatusOperations async operations.
    ...
    async def get_operation_status(
        ...
        **kwargs
        ...
        return deserialized
    get_operation_status.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/VMwareSites/{siteName}/operationsStatus/{operationStatusName}'}  # type: ignore

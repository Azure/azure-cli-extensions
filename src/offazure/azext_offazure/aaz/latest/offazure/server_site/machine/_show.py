...
@register_command(
    "offazure server-site machine show",
)
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServersControllerGetMachine(ctx=self.ctx)()
    ...
    class ServersControllerGetMachine(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_web_app_discovery_read(properties.iis_discovery)
            ...
            _ShowHelper._build_schema_web_app_discovery_read(properties.tomcat_discovery)
            ...
            _ShowHelper._build_schema_web_app_discovery_read(properties.web_app_discovery)
            ...
            _ShowHelper._build_schema_health_error_details_read(errors.Element)

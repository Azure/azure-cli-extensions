...
helps['eventgrid event-subscription create'] = """
    ...
    parameters:
        ...
        - name: --endpoint-type
          short-summary: The type of the destination endpoint. It is expected that the destination endpoint to be created and available for use before executing any Event Grid command.

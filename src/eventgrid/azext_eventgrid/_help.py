...
examples:
  - name: Create a new partner namespace.
    text: az eventgrid partner namespace create -g rg1 --name namespaceName1 -l westus2
"""
...
examples:
  - name: List shared access keys of a partner namespace (autogenerated)
    text: az eventgrid namespace key list --name MyNamespace --resource-group MyResourceGroup
    crafted: true
"""

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ClientsListByNamespace(ctx=self.ctx)()
    ...
    class ClientsListByNamespace(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            certificate_subject = cls._schema_on_200.value.Element.properties.authentication.certificate_subject
            ...
            certificate_thumbprint = cls._schema_on_200.value.Element.properties.authentication.certificate_thumbprint
            certificate_thumbprint.primary = AAZStrType()
            certificate_thumbprint.secondary = AAZStrType()

            client_certificate_authentication = cls._schema_on_200.value.Element.properties.client_certificate_authentication
            ...
            allowed_thumbprints = cls._schema_on_200.value.Element.properties.client_certificate_authentication.allowed_thumbprints

...
@register_command(
    "eventgrid namespace ca-certificate show",
    is_preview=True,
)
class Show(AAZCommand):
    """Show a CA certificate.

    :example: Show CA certificate
        az eventgrid namespace ca-certificate show -g rg --namespace-name name -n certificate-name
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CaCertificatesGet(ctx=self.ctx)()
    ...
    class CaCertificatesGet(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    :example: List CA certificate
        az eventgrid namespace ca-certificate list -g rg --namespace-name name
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CaCertificatesListByNamespace(ctx=self.ctx)()
    ...
    class CaCertificatesListByNamespace(AAZHttpOperation):

...
@register_command(
    "eventgrid namespace client-group delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.client_group_name = AAZStrArg(
            options=["-n", "--name", "--client-group-name"],
            help="Name of the client group.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ClientGroupsDelete(ctx=self.ctx)()
    ...
    class ClientGroupsDelete(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "clientGroupName", self.ctx.args.client_group_name,
                    required=True,
                ),
                **self.serialize_url_param(

...
@register_command(
    "eventgrid namespace client-group list",
    is_preview=True,
)
class List(AAZCommand):
    """List all the client groups under a namespace.

    :example: List client group
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ClientGroupsListByNamespace(ctx=self.ctx)()
    ...
    class ClientGroupsListByNamespace(AAZHttpOperation):

...
@register_command(
    "eventgrid namespace topic event-subscription delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete event subscription
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NamespaceTopicEventSubscriptionsDelete(ctx=self.ctx)()
    ...
    class NamespaceTopicEventSubscriptionsDelete(AAZHttpOperation):

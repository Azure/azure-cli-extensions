...
class RegenerateKey(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "RegenerateKeyRequest"

        _args_schema = cls._args_schema
        _args_schema.key_name = AAZStrArg(
            options=["--key-name"],
            arg_group="RegenerateKeyRequest",
            help="Key name to regenerate key1 or key2",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NamespaceTopicsRegenerateKey(ctx=self.ctx)()
    ...
    class NamespaceTopicsRegenerateKey(AAZHttpOperation):

...
class Create(AAZCommand):
    ...
    :example: Create event subscription
    ...
    class NamespaceTopicEventSubscriptionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            delivery_configuration = cls._schema_on_200_201.properties.delivery_configuration
            delivery_configuration.delivery_mode = AAZStrType(
                serialized_name="deliveryMode",
            )
            delivery_configuration.queue = AAZObjectType()

            queue = cls._schema_on_200_201.properties.delivery_configuration.queue
            ...
            dead_letter_destination_with_resource_identity = cls._schema_on_200_201.properties.delivery_configuration.queue.dead_letter_destination_with_resource_identity
            ...
            dead_letter_destination = cls._schema_on_200_201.properties.delivery_configuration.queue.dead_letter_destination_with_resource_identity.dead_letter_destination
            dead_letter_destination.endpoint_type = AAZStrType(
                serialized_name="endpointType",
                flags={"required": True},
            )

            disc_storage_blob = cls._schema_on_200_201.properties.delivery_configuration.queue.dead_letter_destination_with_resource_identity.dead_letter_destination.discriminate_by("endpoint_type", "StorageBlob")
            disc_storage_blob.properties = AAZObjectType(
                flags={"client_flatten": True},
            )

            properties = cls._schema_on_200_201.properties.delivery_configuration.queue.dead_letter_destination_with_resource_identity.dead_letter_destination.discriminate_by("endpoint_type", "StorageBlob").properties
            ...
            identity = cls._schema_on_200_201.properties.delivery_configuration.queue.dead_letter_destination_with_resource_identity.identity
            identity.type = AAZStrType()
            identity.user_assigned_identity = AAZStrType(
                serialized_name="userAssignedIdentity",
            )

            filters_configuration = cls._schema_on_200_201.properties.filters_configuration
            ...
            filters = cls._schema_on_200_201.properties.filters_configuration.filters
            filters.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.filters_configuration.filters.Element
            ...
            disc_bool_equals = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "BoolEquals")
            disc_bool_equals.value = AAZBoolType()

            disc_number_greater_than = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberGreaterThan")
            disc_number_greater_than.value = AAZFloatType()

            disc_number_greater_than_or_equals = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberGreaterThanOrEquals")
            disc_number_greater_than_or_equals.value = AAZFloatType()

            disc_number_in = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberIn")
            disc_number_in.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberIn").values
            values.Element = AAZFloatType()

            disc_number_in_range = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberInRange")
            disc_number_in_range.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberInRange").values
            values.Element = AAZListType()

            _element = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberInRange").values.Element
            _element.Element = AAZFloatType()

            disc_number_less_than = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberLessThan")
            disc_number_less_than.value = AAZFloatType()

            disc_number_less_than_or_equals = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberLessThanOrEquals")
            disc_number_less_than_or_equals.value = AAZFloatType()

            disc_number_not_in = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberNotIn")
            disc_number_not_in.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberNotIn").values
            values.Element = AAZFloatType()

            disc_number_not_in_range = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberNotInRange")
            disc_number_not_in_range.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberNotInRange").values
            values.Element = AAZListType()

            _element = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "NumberNotInRange").values.Element
            _element.Element = AAZFloatType()

            disc_string_begins_with = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringBeginsWith")
            disc_string_begins_with.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringBeginsWith").values
            values.Element = AAZStrType()

            disc_string_contains = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringContains")
            disc_string_contains.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringContains").values
            values.Element = AAZStrType()

            disc_string_ends_with = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringEndsWith")
            disc_string_ends_with.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringEndsWith").values
            values.Element = AAZStrType()

            disc_string_in = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringIn")
            disc_string_in.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringIn").values
            values.Element = AAZStrType()

            disc_string_not_begins_with = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotBeginsWith")
            disc_string_not_begins_with.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotBeginsWith").values
            values.Element = AAZStrType()

            disc_string_not_contains = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotContains")
            disc_string_not_contains.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotContains").values
            values.Element = AAZStrType()

            disc_string_not_ends_with = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotEndsWith")
            disc_string_not_ends_with.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotEndsWith").values
            values.Element = AAZStrType()

            disc_string_not_in = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotIn")
            disc_string_not_in.values = AAZListType()

            values = cls._schema_on_200_201.properties.filters_configuration.filters.Element.discriminate_by("operator_type", "StringNotIn").values
            values.Element = AAZStrType()

            included_event_types = cls._schema_on_200_201.properties.filters_configuration.included_event_types

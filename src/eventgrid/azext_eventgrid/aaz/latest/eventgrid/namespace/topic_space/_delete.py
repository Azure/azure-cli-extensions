...
@register_command(
    "eventgrid namespace topic-space delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete topic space
        az eventgrid namespace topic-space delete -g rg --namespace-name name -n topic-space
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.topic_space_name = AAZStrArg(
            options=["-n", "--name", "--topic-space-name"],
            help="Name of the Topic space.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.TopicSpacesDelete(ctx=self.ctx)()
    ...
    class TopicSpacesDelete(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "topicSpaceName", self.ctx.args.topic_space_name,
                    required=True,
                ),
            }
            return parameters

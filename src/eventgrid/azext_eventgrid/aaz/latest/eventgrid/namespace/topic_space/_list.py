...
@register_command(
    "eventgrid namespace topic-space list",
    is_preview=True,
)
class List(AAZCommand):
    """List all the topic spaces under a namespace.

    :example: List topic space
        az eventgrid namespace topic-space list -g rg --namespace-name name
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TopicSpacesListByNamespace(ctx=self.ctx)()
    ...
    class TopicSpacesListByNamespace(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.topic_templates = AAZListType(
                serialized_name="topicTemplates",
            )

            topic_templates = cls._schema_on_200.value.Element.properties.topic_templates
            topic_templates.Element = AAZStrType()

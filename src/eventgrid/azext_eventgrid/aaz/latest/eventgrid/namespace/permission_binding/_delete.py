...
@register_command(
    "eventgrid namespace permission-binding delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete permission binding
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PermissionBindingsDelete(ctx=self.ctx)()
    ...
    class PermissionBindingsDelete(AAZHttpOperation):

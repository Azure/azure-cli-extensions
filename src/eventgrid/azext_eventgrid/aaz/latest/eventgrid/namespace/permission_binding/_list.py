...
@register_command(
    "eventgrid namespace permission-binding list",
    is_preview=True,
)
class List(AAZCommand):
    """List all the permission bindings under a namespace.

    :example: List permission binding
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PermissionBindingsListByNamespace(ctx=self.ctx)()
    ...
    class PermissionBindingsListByNamespace(AAZHttpOperation):

...
name_arg_type = CLIArgumentType(options_list=('--name', '-n'), help='Name of the VM or VMSS')
vmss_instance_arg_type = CLIArgumentType(options_list=('--vmss-instance'),  help='ID of VMSS instance. Not needed when connecting to the serial port of a VM')
sysrq_input_arg_type = CLIArgumentType(options_list=('--input'), help='SysRq Input Key')

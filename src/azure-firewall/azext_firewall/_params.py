...
def load_arguments(self, _):
    ...
    with self.argument_context('network firewall') as c:
        ...
        c.argument('source_ip_groups', nargs='+', help='Space-separated list of source IpGroups.')
        c.argument('destination_ip_groups',nargs='+', help='Space-separated list of destination IpGroups')

...
def load_arguments(self, _):
    ...
    with self.argument_context('network firewall policy idps', min_api='2020-07-01') as c:
        c.argument('firewall_policy_name', options_list=['--policy-name'], help='The name of the Firewall Policy.')

    with self.argument_context('network firewall policy idps', min_api='2020-07-01', arg_group='IDPS Signature Override') as c:
    ...
    with self.argument_context('network firewall policy idps', min_api='2020-07-01', arg_group='IDPS Bypass Rule') as c:

...
class NetworkManagementClientOperationsMixin(object):
    ...
    async def list_active_connectivity_configurations(
        ...
        **kwargs: Any
        ...
        if api_version == '2021-05-01-preview':
            from ..v2021_05_01_preview.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
    ...
    async def list_active_security_user_rules(
        ...
        **kwargs: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = self._get_api_version('list_active_security_user_rules')
        if api_version == '2021-05-01-preview':
            from ..v2021_05_01_preview.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
            raise ValueError("API version {} does not have operation 'list_active_security_user_rules'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.list_active_security_user_rules(resource_group_name, network_manager_name, parameters, **kwargs)

...
class NetworkManagementClientOperationsMixin(object):
    ...
    def list_active_connectivity_configurations(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2021-05-01-preview':
            from .v2021_05_01_preview.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
    ...
    def list_active_security_user_rules(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.list_active_security_user_rules(resource_group_name, network_manager_name, parameters, **kwargs)

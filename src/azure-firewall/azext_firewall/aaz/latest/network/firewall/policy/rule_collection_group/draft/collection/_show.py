...
@register_command(
    "network firewall policy rule-collection-group draft collection show",
)
class Show(AAZCommand):
    ...
    class FirewallPolicyRuleCollectionGroupDraftsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_firewall_policy_rule_collection_group_draft_read(cls._schema_on_200)

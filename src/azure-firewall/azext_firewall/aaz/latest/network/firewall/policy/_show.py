...
class Show(AAZCommand):
    ...
    class FirewallPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_sub_resource_read(child_policies.Element)
            ...
            _ShowHelper._build_schema_sub_resource_read(firewalls.Element)
            ...
            _ShowHelper._build_schema_sub_resource_read(rule_collection_groups.Element)

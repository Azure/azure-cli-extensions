...
@register_command(
    "network firewall policy rule-collection-group collection update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _element = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element
        ...
        application_rule = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule
        ...
        destination_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        fqdn_tags = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.fqdn_tags
        fqdn_tags.Element = AAZStrArg(
            nullable=True,
        )

        protocols = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.protocols
        protocols.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.protocols.Element
        ...
        source_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        target_fqdns = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.target_fqdns
        target_fqdns.Element = AAZStrArg(
            nullable=True,
        )

        target_urls = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.target_urls
        target_urls.Element = AAZStrArg(
            nullable=True,
        )

        web_categories = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.application_rule.web_categories
        web_categories.Element = AAZStrArg(
            nullable=True,
        )

        nat_rule = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule
        ...
        destination_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        destination_ports = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule.destination_ports
        destination_ports.Element = AAZStrArg(
            nullable=True,
        )

        ip_protocols = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            nullable=True,
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.nat_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        network_rule = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule
        ...
        destination_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        destination_fqdns = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.destination_fqdns
        destination_fqdns.Element = AAZStrArg(
            nullable=True,
        )

        destination_ip_groups = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.destination_ip_groups
        destination_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        destination_ports = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.destination_ports
        destination_ports.Element = AAZStrArg(
            nullable=True,
        )

        ip_protocols = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            nullable=True,
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_filter_rule_collection.rules.Element.network_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )
        ...
        _element = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element
        _element.application_rule = AAZObjectArg(
            options=["application-rule"],
        )
        _element.nat_rule = AAZObjectArg(
        ...
        application_rule = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule
        application_rule.destination_addresses = AAZListArg(
            options=["destination-addresses"],
            nullable=True,
        )
        ...
        destination_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        fqdn_tags = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.fqdn_tags
        fqdn_tags.Element = AAZStrArg(
            nullable=True,
        )

        protocols = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.protocols
        protocols.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.protocols.Element
        _element.port = AAZIntArg(
            options=["port"],
            nullable=True,
            fmt=AAZIntArgFormat(
        ...
        source_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        target_fqdns = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.target_fqdns
        target_fqdns.Element = AAZStrArg(
            nullable=True,
        )

        target_urls = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.target_urls
        target_urls.Element = AAZStrArg(
            nullable=True,
        )

        web_categories = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.application_rule.web_categories
        web_categories.Element = AAZStrArg(
            nullable=True,
        )

        nat_rule = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule
        nat_rule.destination_addresses = AAZListArg(
            options=["destination-addresses"],
            nullable=True,
        )
        ...
        destination_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        destination_ports = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule.destination_ports
        destination_ports.Element = AAZStrArg(
            nullable=True,
        )

        ip_protocols = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            nullable=True,
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.nat_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        network_rule = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule
        network_rule.destination_addresses = AAZListArg(
            options=["destination-addresses"],
            nullable=True,
        )
        ...
        destination_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.destination_addresses
        destination_addresses.Element = AAZStrArg(
            nullable=True,
        )

        destination_fqdns = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.destination_fqdns
        destination_fqdns.Element = AAZStrArg(
            nullable=True,
        )

        destination_ip_groups = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.destination_ip_groups
        destination_ip_groups.Element = AAZStrArg(
            nullable=True,
        )

        destination_ports = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.destination_ports
        destination_ports.Element = AAZStrArg(
            nullable=True,
        )

        ip_protocols = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            nullable=True,
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.source_addresses
        source_addresses.Element = AAZStrArg(
            nullable=True,
        )

        source_ip_groups = cls._args_schema.firewall_policy_nat_rule_collection.rules.Element.network_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg(
            nullable=True,
        )
        return cls._args_schema
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            _elements = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]")
            ...
            disc_application_rule = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            fqdn_tags = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.fqdnTags")
            if fqdn_tags is not None:
                fqdn_tags.set_elements(AAZStrType, ".")

            protocols = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.protocols")
            if protocols is not None:
                protocols.set_elements(AAZObjectType, ".")

            _elements = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.protocols[]")
            if _elements is not None:
                _elements.set_prop("port", AAZIntType, ".port")
                _elements.set_prop("protocolType", AAZStrType, ".protocol_type")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")

            target_fqdns = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.targetFqdns")
            if target_fqdns is not None:
                target_fqdns.set_elements(AAZStrType, ".")

            target_urls = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.targetUrls")
            if target_urls is not None:
                target_urls.set_elements(AAZStrType, ".")

            web_categories = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:ApplicationRule}.webCategories")
            if web_categories is not None:
                web_categories.set_elements(AAZStrType, ".")

            disc_nat_rule = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            destination_ports = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}.destinationPorts")
            if destination_ports is not None:
                destination_ports.set_elements(AAZStrType, ".")

            ip_protocols = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}.ipProtocols")
            if ip_protocols is not None:
                ip_protocols.set_elements(AAZStrType, ".")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NatRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")

            disc_network_rule = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            destination_fqdns = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.destinationFqdns")
            if destination_fqdns is not None:
                destination_fqdns.set_elements(AAZStrType, ".")

            destination_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.destinationIpGroups")
            if destination_ip_groups is not None:
                destination_ip_groups.set_elements(AAZStrType, ".")

            destination_ports = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.destinationPorts")
            if destination_ports is not None:
                destination_ports.set_elements(AAZStrType, ".")

            ip_protocols = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.ipProtocols")
            if ip_protocols is not None:
                ip_protocols.set_elements(AAZStrType, ".")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyFilterRuleCollection}.rules[]{ruleType:NetworkRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")
            ...
            _elements = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]")
            if _elements is not None:
                _elements.set_prop("description", AAZStrType, ".description")
                _elements.set_prop("name", AAZStrType, ".name")
                _elements.set_const("ruleType", "ApplicationRule", AAZStrType, ".application_rule", typ_kwargs={"flags": {"required": True}})
            ...
            disc_application_rule = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}")
            if disc_application_rule is not None:
                disc_application_rule.set_prop("destinationAddresses", AAZListType, ".application_rule.destination_addresses")
                disc_application_rule.set_prop("fqdnTags", AAZListType, ".application_rule.fqdn_tags")
                disc_application_rule.set_prop("protocols", AAZListType, ".application_rule.protocols")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            fqdn_tags = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.fqdnTags")
            if fqdn_tags is not None:
                fqdn_tags.set_elements(AAZStrType, ".")

            protocols = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.protocols")
            if protocols is not None:
                protocols.set_elements(AAZObjectType, ".")

            _elements = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.protocols[]")
            if _elements is not None:
                _elements.set_prop("port", AAZIntType, ".port")
                _elements.set_prop("protocolType", AAZStrType, ".protocol_type")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")

            target_fqdns = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.targetFqdns")
            if target_fqdns is not None:
                target_fqdns.set_elements(AAZStrType, ".")

            target_urls = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.targetUrls")
            if target_urls is not None:
                target_urls.set_elements(AAZStrType, ".")

            web_categories = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:ApplicationRule}.webCategories")
            if web_categories is not None:
                web_categories.set_elements(AAZStrType, ".")

            disc_nat_rule = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}")
            if disc_nat_rule is not None:
                disc_nat_rule.set_prop("destinationAddresses", AAZListType, ".nat_rule.destination_addresses")
                disc_nat_rule.set_prop("destinationPorts", AAZListType, ".nat_rule.destination_ports")
                disc_nat_rule.set_prop("ipProtocols", AAZListType, ".nat_rule.ip_protocols")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            destination_ports = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}.destinationPorts")
            if destination_ports is not None:
                destination_ports.set_elements(AAZStrType, ".")

            ip_protocols = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}.ipProtocols")
            if ip_protocols is not None:
                ip_protocols.set_elements(AAZStrType, ".")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NatRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")

            disc_network_rule = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}")
            if disc_network_rule is not None:
                disc_network_rule.set_prop("destinationAddresses", AAZListType, ".network_rule.destination_addresses")
                disc_network_rule.set_prop("destinationFqdns", AAZListType, ".network_rule.destination_fqdns")
                disc_network_rule.set_prop("destinationIpGroups", AAZListType, ".network_rule.destination_ip_groups")
            ...
            destination_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.destinationAddresses")
            if destination_addresses is not None:
                destination_addresses.set_elements(AAZStrType, ".")

            destination_fqdns = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.destinationFqdns")
            if destination_fqdns is not None:
                destination_fqdns.set_elements(AAZStrType, ".")

            destination_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.destinationIpGroups")
            if destination_ip_groups is not None:
                destination_ip_groups.set_elements(AAZStrType, ".")

            destination_ports = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.destinationPorts")
            if destination_ports is not None:
                destination_ports.set_elements(AAZStrType, ".")

            ip_protocols = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.ipProtocols")
            if ip_protocols is not None:
                ip_protocols.set_elements(AAZStrType, ".")

            source_addresses = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.sourceAddresses")
            if source_addresses is not None:
                source_addresses.set_elements(AAZStrType, ".")

            source_ip_groups = _builder.get("{ruleCollectionType:FirewallPolicyNatRuleCollection}.rules[]{ruleType:NetworkRule}.sourceIpGroups")
            if source_ip_groups is not None:
                source_ip_groups.set_elements(AAZStrType, ".")

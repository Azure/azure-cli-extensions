...
@register_command(
    "network firewall policy draft intrusion-detection update",
)
class Update(AAZCommand):
    ...
    class FirewallPolicyDraftsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_firewall_policy_draft_read(cls._schema_on_200)
    ...
    class FirewallPolicyDraftsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_firewall_policy_draft_read(cls._schema_on_200_201)

...
@register_command(
    "network firewall policy intrusion-detection delete",
...
class Delete(AAZCommand):
    ...
    class FirewallPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _DeleteHelper._build_schema_firewall_policy_read(cls._schema_on_200)
    ...
    class FirewallPoliciesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _DeleteHelper._build_schema_firewall_policy_read(cls._schema_on_200_201)

...
class Deploy(AAZCommand):
    """Deploy an Azure firewall policy.
    """

    _aaz_info = {
        "version": "2023-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/firewallpolicies/{}", "2023-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.FirewallPoliciesPost(ctx=self.ctx)()
    ...
    class FirewallPoliciesPost(AAZHttpOperation):

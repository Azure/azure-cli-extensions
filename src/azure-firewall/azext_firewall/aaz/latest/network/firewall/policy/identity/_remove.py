...
@register_command(
    "network firewall policy identity remove",
)
class Remove(AAZCommand):
    ...
    class FirewallPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_firewall_policy_read(cls._schema_on_200)
    ...
    class FirewallPoliciesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_firewall_policy_read(cls._schema_on_200_201)

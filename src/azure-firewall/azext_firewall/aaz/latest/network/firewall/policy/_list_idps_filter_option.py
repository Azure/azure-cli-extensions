...
@register_command(
    "network firewall policy list-idps-filter-option",
)
class ListIdpsFilterOption(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.filter_name = AAZStrArg(
            ...
            help="Describes the name of the column which values will be returned",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.FirewallPolicyIdpsSignaturesFilterValuesList(ctx=self.ctx)()
    ...
    class FirewallPolicyIdpsSignaturesFilterValuesList(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("filterName", AAZStrType, ".filter_name")
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.filter_values = AAZListType(
                serialized_name="filterValues",
            )

            filter_values = cls._schema_on_200.filter_values
            filter_values.Element = AAZStrType()

            return cls._schema_on_200


class _ListIdpsFilterOptionHelper:
    """Helper class for ListIdpsFilterOption"""


__all__ = ["ListIdpsFilterOption"]

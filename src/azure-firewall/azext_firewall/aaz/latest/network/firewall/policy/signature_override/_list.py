...
@register_command(
    "network firewall policy signature-override list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirewallPolicyIdpsSignaturesOverridesList(ctx=self.ctx)()
    ...
    class FirewallPolicyIdpsSignaturesOverridesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            signatures = cls._schema_on_200.value.Element.properties.signatures

...
class Create(AAZCommand):
    ...
    _args_firewall_policy_rule_collection_group_draft_create = None

    @classmethod
    def _build_args_firewall_policy_rule_create(cls, _schema):
        if cls._args_firewall_policy_rule_collection_group_draft_create is not None:
            _schema.application_rule = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule
            _schema.description = cls._args_firewall_policy_rule_collection_group_draft_create.description
            _schema.name = cls._args_firewall_policy_rule_collection_group_draft_create.name
            _schema.nat_rule = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule
            _schema.network_rule = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule
            return

        cls._args_firewall_policy_rule_collection_group_draft_create = AAZObjectArg()

        firewall_policy_rule_create = cls._args_firewall_policy_rule_collection_group_draft_create
        ...
        application_rule = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule
        ...
        destination_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.destination_addresses
        destination_addresses.Element = AAZStrArg()

        fqdn_tags = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.fqdn_tags
        fqdn_tags.Element = AAZStrArg()

        protocols = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.protocols
        protocols.Element = AAZObjectArg()

        _element = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.protocols.Element
        ...
        source_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.source_addresses
        source_addresses.Element = AAZStrArg()

        source_ip_groups = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg()

        target_fqdns = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.target_fqdns
        target_fqdns.Element = AAZStrArg()

        target_urls = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.target_urls
        target_urls.Element = AAZStrArg()

        web_categories = cls._args_firewall_policy_rule_collection_group_draft_create.application_rule.web_categories
        web_categories.Element = AAZStrArg()

        nat_rule = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule
        ...
        destination_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule.destination_addresses
        destination_addresses.Element = AAZStrArg()

        destination_ports = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule.destination_ports
        destination_ports.Element = AAZStrArg()

        ip_protocols = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule.source_addresses
        source_addresses.Element = AAZStrArg()

        source_ip_groups = cls._args_firewall_policy_rule_collection_group_draft_create.nat_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg()

        network_rule = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule
        ...
        destination_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.destination_addresses
        destination_addresses.Element = AAZStrArg()

        destination_fqdns = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.destination_fqdns
        destination_fqdns.Element = AAZStrArg()

        destination_ip_groups = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.destination_ip_groups
        destination_ip_groups.Element = AAZStrArg()

        destination_ports = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.destination_ports
        destination_ports.Element = AAZStrArg()

        ip_protocols = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.ip_protocols
        ip_protocols.Element = AAZStrArg(
            enum={"Any": "Any", "ICMP": "ICMP", "TCP": "TCP", "UDP": "UDP"},
        )

        source_addresses = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.source_addresses
        source_addresses.Element = AAZStrArg()

        source_ip_groups = cls._args_firewall_policy_rule_collection_group_draft_create.network_rule.source_ip_groups
        source_ip_groups.Element = AAZStrArg()

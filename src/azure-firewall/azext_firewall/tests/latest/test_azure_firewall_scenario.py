...
class AzureFirewallScenario(ScenarioTest):
    ...
    def test_azure_firewall_packet_capture(self, resource_group, resource_group_location):
        ...
        self.cmd('az network vnet create -g {rg} -n {vnet_name} --location {location} --address-prefixes 10.0.0.0/16 --subnet-name AzureFirewallSubnet --subnet-prefix 10.0.0.0/24')

...
def load_command_table(self, _):
    ...
    with self.command_group('network firewall threat-intel-whitelist', network_firewall_sdk) as g:
        ...
        g.generic_update_command('update', custom_func_name='show_azure_firewall_threat_intel_whitelist')

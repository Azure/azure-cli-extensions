...
def load_command_table(self, _):
    ...
    network_firewall_sdk = CliCommandType(
        operations_tmpl='azext_firewall.vendored_sdks.v2021_05_01.operations#AzureFirewallsOperations.{}',
    ...
    network_firewall_fqdn_tags_sdk = CliCommandType(
        operations_tmpl='azext_firewall.vendored_sdks.v2021_05_01.operations#AzureFirewallFqdnTagsOperations.{}',
    ...
    network_firewall_policies_sdk = CliCommandType(
        operations_tmpl='azext_firewall.vendored_sdks.v2021_05_01.operations#FirewallPoliciesOperations.{}',
    ...
    network_firewall_policy_rule_groups = CliCommandType(
        operations_tmpl='azext_firewall.vendored_sdks.v2021_05_01.operations#FirewallPolicyRuleCollectionGroupsOperations.{}',

...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.x_ms_delete_volumegroups = AAZBoolArg(
            options=["--x-ms-delete-volumegroups"],
            help="Required if the San has associated Volume Groups",
        )
        ...
        def header_parameters(self):
            parameters = {
                **self.serialize_header_param(
                    "x-ms-delete-volumegroups", self.ctx.args.x_ms_delete_volumegroups,
                ),
            }
            return parameters

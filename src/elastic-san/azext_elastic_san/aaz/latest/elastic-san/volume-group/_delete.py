...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.x_ms_delete_volumes = AAZBoolArg(
            options=["--x-ms-delete-volumes"],
            help="Required if the Volume Group has associated volumes",
        )
        ...
        def header_parameters(self):
            parameters = {
                **self.serialize_header_param(
                    "x-ms-delete-volumes", self.ctx.args.x_ms_delete_volumes,
                ),
            }
            return parameters

...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.size_gi_b = AAZIntArg(
            options=["--size-gi-b"],
            arg_group="Parameters",
            help="Volume size.",
        )
        ...
        creation_data.create_source = AAZStrArg(
            ...
            required=True,
            enum={"Export": "Export", "FromDiskSnapshot": "FromDiskSnapshot", "FromVolume": "FromVolume", "None": "None"},
        )
    ...
    class VolumesCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("sizeGiB", AAZIntType, ".size_gi_b")
...
def _build_schema_volume_read(_schema):
    ...
    if _schema_volume_read is not None:
        ...
        _schema.location = _schema_volume_read.location

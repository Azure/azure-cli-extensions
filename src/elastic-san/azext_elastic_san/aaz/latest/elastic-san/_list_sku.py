...
class ListSku(AAZCommand):
    """Gets a list of ElasticSan skus.
    """
    ...
    class SkusList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            san = cls._schema_on_200.value.Element.san
            san.iops_per_base_ti_b = AAZIntType(
                serialized_name="iopsPerBaseTiB",
                flags={"read_only": True},
            )
            san.max_iops = AAZIntType(
                serialized_name="maxIops",
                flags={"read_only": True},
            )
            san.max_m_bps = AAZIntType(
                serialized_name="maxMBps",
                flags={"read_only": True},
            )
            san.max_size_ti_b = AAZIntType(
                serialized_name="maxSizeTiB",
                flags={"read_only": True},
            )
            san.max_volume_group_count = AAZIntType(
                serialized_name="maxVolumeGroupCount",
                flags={"read_only": True},
            )
            san.mbps_per_base_ti_b = AAZIntType(
                serialized_name="mbpsPerBaseTiB",
                flags={"read_only": True},
            )
            san.min_increment_size_ti_b = AAZIntType(
                serialized_name="minIncrementSizeTiB",
                flags={"read_only": True},
            )
            san.min_size_ti_b = AAZIntType(
            ...
            volume.max_connected_client_count = AAZIntType(
                serialized_name="maxConnectedClientCount",
                flags={"read_only": True},
            )
            ...
            volume.max_iops_per_gi_b = AAZIntType(
                serialized_name="maxIopsPerGiB",
                flags={"read_only": True},
            )
            ...
            volume.max_m_bps_per_gi_b = AAZIntType(
                serialized_name="maxMBpsPerGiB",
                flags={"read_only": True},
            )

...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.elastic_san_name = AAZStrArg(
            options=["--elastic-san-name", "--name", "-n"],
        ...
        _args_schema.availability_zones = AAZListArg(
            ...
            singular_options=["--availability-zone"],
        ...
        sku.tier = AAZStrArg(
            options=["tier"],
            help="The sku tier.",
            enum={"Hero": "Hero", "Hub": "Hub", "Satellite": "Satellite"},
        )
...
def _build_schema_elastic_san_read(_schema):
    ...
    properties.provisioned_m_bps = AAZIntType(
        serialized_name="provisionedMBps",
        flags={"read_only": True},
    )

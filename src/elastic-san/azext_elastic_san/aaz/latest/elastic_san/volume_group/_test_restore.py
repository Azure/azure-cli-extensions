...
class TestRestore(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.elasticsan/elasticsans/{}/volumegroups/{}/prerestore", "2026-04-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.disk_snapshot_ids = AAZListArg(
            options=["--disk-snapshot-ids"],
            arg_group="Parameters",
            help="array of DiskSnapshot ARM IDs",
            required=True,
        )

        disk_snapshot_ids = cls._args_schema.disk_snapshot_ids
        disk_snapshot_ids.Element = AAZResourceIdArg()
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesPreRestore(ctx=self.ctx)()
    ...
    class VolumesPreRestore(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("diskSnapshotIds", AAZListType, ".disk_snapshot_ids", typ_kwargs={"flags": {"required": True}})

            disk_snapshot_ids = _builder.get(".diskSnapshotIds")
            if disk_snapshot_ids is not None:
                disk_snapshot_ids.set_elements(AAZStrType, ".")
...
class _TestRestoreHelper:
    """Helper class for TestRestore"""

...
def postgresqlhsc_server_group_create(client,
                                      ...
                                      private_dns_zone_arm_resource_id=None,
                                      subnet_arm_resource_id=None,
                                      no_wait=False):
    parameters = {}
    parameters['tags'] = tags
    parameters['location'] = location
    parameters['create_mode'] = create_mode
    parameters['administrator_login'] = administrator_login
    parameters['administrator_login_password'] = administrator_login_password
    parameters['backup_retention_days'] = backup_retention_days
    parameters['postgresql_version'] = postgresql_version
    parameters['citus_version'] = citus_version
    parameters['enable_mx'] = enable_mx
    parameters['enable_zfs'] = enable_zfs
    parameters['enable_shards_on_coordinator'] = enable_shards_on_coordinator
    parameters['server_role_groups'] = server_role_groups
    parameters['maintenance_window'] = maintenance_window
    parameters['availability_zone'] = availability_zone
    parameters['standby_availability_zone'] = standby_availability_zone
    parameters['source_subscription_id'] = source_subscription_id
    parameters['source_resource_group_name'] = source_resource_group_name
    parameters['source_server_group_name'] = source_server_group_name
    parameters['source_location'] = source_location
    parameters['point_in_time_utc'] = point_in_time_utc
    parameters['private_dns_zone_arguments'] = {}
    parameters['private_dns_zone_arguments']['private_dns_zone_arm_resource_id'] = private_dns_zone_arm_resource_id
    parameters['delegated_subnet_arguments'] = {}
    parameters['delegated_subnet_arguments']['subnet_arm_resource_id'] = subnet_arm_resource_id
...
def postgresqlhsc_configuration_update(client,
                                       ...
                                       no_wait=False):
    parameters = {}
    parameters['server_role_group_configurations'] = server_role_group_configurations
    return sdk_no_wait(no_wait,
                       client.begin_update,
                       resource_group_name=resource_group_name,
                       server_group_name=server_group_name,
...
def postgresqlhsc_firewall_rule_create(client,
                                       ...
                                       no_wait=False):
    parameters = {}
    parameters['start_ip_address'] = start_ip_address
    parameters['end_ip_address'] = end_ip_address
    return sdk_no_wait(no_wait,
                       client.begin_create_or_update,
                       resource_group_name=resource_group_name,
                       server_group_name=server_group_name,
...
def postgresqlhsc_firewall_rule_update(instance,
                                       resource_group_name,
                                       server_group_name,
                                       firewall_rule_name,
                                       start_ip_address,

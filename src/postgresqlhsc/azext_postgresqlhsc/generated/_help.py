...
helps['postgresqlhsc server-group'] = """
    type: group
    short-summary: Manage server group with postgresqlhsc
"""
...
--subnet-arm-resource-id "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft\
.Network/virtualNetworks/test-vnet/subnets/test-vnet-subnet" --enable-mx true --enable-zfs false --postgresql-version \
"12" --private-dns-zone-arm-resource-id "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/prov\
iders/Microsoft.Network/privateDnsZones/test-private-dns-zone" --server-role-groups name="" enable-ha=true \
...
--source-subscription-id "dddddddd-dddd-dddd-dddd-dddddddddddd" --resource-group "TestGroup" --name "hsctestsg"
      - name: Create a new server group as a read replica
        text: |-
               az postgresqlhsc server-group create --location "westus" --create-mode "ReadReplica" --source-location \
"eastus" --source-resource-group-name "SourceGroup" --source-server-group-name "pgtests-source-server-group" \
--source-subscription-id "dddddddd-dddd-dddd-dddd-dddddddddddd" --resource-group "TestGroup" --name "hsctestsg"
"""
...
helps['postgresqlhsc server'] = """
    type: group
    short-summary: Manage server with postgresqlhsc
"""
...
helps['postgresqlhsc configuration'] = """
    type: group
    short-summary: Manage configuration with postgresqlhsc
"""
...
helps['postgresqlhsc firewall-rule'] = """
    type: group
    short-summary: Manage firewall rule with postgresqlhsc
"""
...
helps['postgresqlhsc role'] = """
    type: group
    short-summary: Manage role with postgresqlhsc
"""

...
def load_command_table(self, _):
    ...
    postgresqlhsc_server_group = CliCommandType(
        operations_tmpl='azext_postgresqlhsc.vendored_sdks.postgresqlhsc.operations._server_groups_operations#ServerGro'
        'upsOperations.{}',
        client_factory=cf_server_group)
    with self.command_group('postgresqlhsc server-group', postgresqlhsc_server_group,
                            client_factory=cf_server_group) as g:
    ...
    postgresqlhsc_server = CliCommandType(
        operations_tmpl='azext_postgresqlhsc.vendored_sdks.postgresqlhsc.operations._servers_operations#ServersOperatio'
        'ns.{}',
        client_factory=cf_server)
    with self.command_group('postgresqlhsc server', postgresqlhsc_server, client_factory=cf_server) as g:
    ...
    postgresqlhsc_configuration = CliCommandType(
        operations_tmpl='azext_postgresqlhsc.vendored_sdks.postgresqlhsc.operations._configurations_operations#Configur'
        'ationsOperations.{}',
        client_factory=cf_configuration)
    with self.command_group('postgresqlhsc configuration', postgresqlhsc_configuration,
                            client_factory=cf_configuration) as g:
    ...
    postgresqlhsc_firewall_rule = CliCommandType(
        operations_tmpl='azext_postgresqlhsc.vendored_sdks.postgresqlhsc.operations._firewall_rules_operations#Firewall'
        'RulesOperations.{}',
        client_factory=cf_firewall_rule)
    with self.command_group('postgresqlhsc firewall-rule', postgresqlhsc_firewall_rule,
                            client_factory=cf_firewall_rule) as g:
        ...
        g.generic_update_command('update', setter_name='begin_create_or_update',
                                 custom_func_name='postgresqlhsc_firewall_rule_update', supports_no_wait=True)
    ...
    postgresqlhsc_role = CliCommandType(
        operations_tmpl='azext_postgresqlhsc.vendored_sdks.postgresqlhsc.operations._roles_operations#RolesOperations.{'
        '}',
        client_factory=cf_role)
    with self.command_group('postgresqlhsc role', postgresqlhsc_role, client_factory=cf_role) as g:
    ...
    with self.command_group('postgresqlhsc', is_experimental=True):
        pass

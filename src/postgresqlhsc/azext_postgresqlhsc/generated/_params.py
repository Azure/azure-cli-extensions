...
def load_arguments(self, _):
    ...
    with self.argument_context('postgresqlhsc server-group create') as c:
        ...
        c.argument('create_mode', arg_type=get_enum_type(['Default', 'PointInTimeRestore', 'ReadReplica']), help='The '
                   'mode to create a new server group.')
        ...
        c.argument('private_dns_zone_arm_resource_id', type=str, help='private dns zone arm resource id.',
                   arg_group='Private Dns Zone Arguments')

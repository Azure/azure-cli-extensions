...
def ssh_vm(cmd, resource_group, vm_name, ssh_ip, public_key_file, private_key_file):
    _do_ssh_op(cmd, resource_group, vm_name, ssh_ip,
               public_key_file, private_key_file, ssh_utils.start_ssh_connection)


def ssh_config(cmd, config_path, resource_group, vm_name, ssh_ip, public_key_file, private_key_file):
    op_call = functools.partial(ssh_utils.write_ssh_config, config_path, resource_group, vm_name)
    _do_ssh_op(cmd, resource_group, vm_name, ssh_ip, public_key_file, private_key_file, op_call)

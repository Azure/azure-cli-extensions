...
class MoveCollectionsOperations(object):
    ...
    def _bulk_remove_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.BulkRemoveRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
    ...
    def list_required_for(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.RequiredForResourcesCollection"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RequiredForResourcesCollection"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

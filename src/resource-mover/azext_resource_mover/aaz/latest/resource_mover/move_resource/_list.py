...
@register_command(
    "resource-mover move-resource list",
)
class List(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.filter = AAZStrArg(
            options=["--filter"],
            help="The filter to apply on the operation. For example, you can use $filter=Properties/ProvisioningState eq 'Succeeded'.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.MoveResourcesList(ctx=self.ctx)()
    ...
    class MoveResourcesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_resource_settings_read(properties.resource_settings)
            ...
            _ListHelper._build_schema_resource_settings_read(properties.source_resource_settings)

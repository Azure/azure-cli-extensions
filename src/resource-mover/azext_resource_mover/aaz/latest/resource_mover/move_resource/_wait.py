...
@register_command(
    "resource-mover move-resource wait",
)
class Wait(AAZWaitCommand):
    ...
    class MoveResourcesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_resource_settings_read(properties.resource_settings)
            ...
            _WaitHelper._build_schema_resource_settings_read(properties.source_resource_settings)
            ...
            _WaitHelper._build_schema_move_resource_error_body_read(errors.properties)

...
@register_command(
    "resource-mover move-collection commit",
)
class Commit(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MoveCollectionsCommit(ctx=self.ctx)()
    ...
    class MoveCollectionsCommit(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _CommitHelper._build_schema_operation_status_error_read(_schema_on_200.error)

...
class AppsOperations(object):
    ...
    def create_or_update(
        ...
        :type app_resource:
         ~azure.mgmt.appplatform.v2021_06_01_preview.models.AppResource
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.appplatform.v2021_06_01_preview.models.AppResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.appplatform.v2021_06_01_preview.models.AppResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_06_01_preview.models.AppResourcePaged[~azure.mgmt.appplatform.v2021_06_01_preview.models.AppResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_resource_upload_url(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_06_01_preview.models.ResourceUploadDefinition
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_resource_upload_url.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
    ...
    def validate_domain(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_06_01_preview.models.CustomDomainValidateResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        # Construct URL
        url = self.validate_domain.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
        ...
        return deserialized
    validate_domain.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/validateDomain'}

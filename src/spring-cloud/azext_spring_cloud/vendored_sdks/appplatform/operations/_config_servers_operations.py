...
class ConfigServersOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.models.ConfigServerResource or
    ...
    def update_put(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.appplatform.models.ConfigServerResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.appplatform.models.ConfigServerResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """

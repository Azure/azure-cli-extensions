...
class Operations(object):
    ...
    def list(
        ...
        deserialized = models.OperationDetailPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.OperationDetailPaged(internal_paging, self._deserialize.dependencies, header_dict)

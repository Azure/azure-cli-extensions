...
class ApiPortalProperties(msrest.serialization.Model):
    ...
    :type sso_properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.SsoProperties
...
class ApiPortalResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ApiPortalProperties
    :param sku: Sku of the API portal resource.
    :type sku: ~azure.mgmt.appplatform.v2022_03_01_preview.models.Sku
    """
...
class ApiPortalResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.ApiPortalResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class AppResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.AppResourceProperties
    :param identity: The Managed Identity type of the app resource.
    :type identity: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ManagedIdentityProperties
...
class AppResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.AppResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class AppResourceProperties(msrest.serialization.Model):
    ...
    :type temporary_disk: ~azure.mgmt.appplatform.v2022_03_01_preview.models.TemporaryDisk
    :param persistent_disk: Persistent disk settings.
    :type persistent_disk: ~azure.mgmt.appplatform.v2022_03_01_preview.models.PersistentDisk
...
class AvailableOperations(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.OperationDetail]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class CustomPersistentDiskProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.Type
...
class BindingResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BindingResourceProperties
    """
...
class BindingResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BindingResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class Build(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildProperties
    """
...
class BuildCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.Build]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuilderProperties(msrest.serialization.Model):
    ...
    :type stack: ~azure.mgmt.appplatform.v2022_03_01_preview.models.StackProperties
...
class BuilderResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuilderProperties
    """
...
class BuilderResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuilderResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildpackBindingProperties(msrest.serialization.Model):
    ...
    :type binding_type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.BindingType
...
class BuildpackBindingResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildpackBindingProperties
    """
...
class BuildpackBindingResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildpackBindingResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildpacksGroupProperties(msrest.serialization.Model):
    ...
    :type buildpacks: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildpackProperties]
    """
...
class BuildResult(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildResultProperties
    """
...
class BuildResultCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildResult]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildService(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.appplatform.v2022_03_01_preview.models.SystemData
    :param properties: Properties of the build resource.
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildServiceProperties
    """
...
class BuildServiceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildService]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class CertificateResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.CertificateProperties
    """
...
class CertificateResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.CertificateResource]
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.CloudErrorBody]
    """
...
class ClusterResourceProperties(msrest.serialization.Model):
    ...
    :type network_profile: ~azure.mgmt.appplatform.v2022_03_01_preview.models.NetworkProfile
...
class ConfigServerProperties(msrest.serialization.Model):
    ...
    :type error: ~azure.mgmt.appplatform.v2022_03_01_preview.models.Error
    :param config_server: Settings of config server.
    :type config_server: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerSettings
    """
...
class ConfigServerResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerProperties
    """
...
class ConfigServerSettings(msrest.serialization.Model):
    ...
    :type git_property: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerGitProperty
    """
...
class CustomContainer(msrest.serialization.Model):
    ...
    :param language_framework: Language framework of the container image uploaded.
    :type language_framework: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.language_framework = kwargs.get('language_framework', None)
...
class CustomContainerUserSourceInfo(UserSourceInfo):
    ...
    :type custom_container: ~azure.mgmt.appplatform.v2022_03_01_preview.models.CustomContainer
    """
...
class CustomDomainResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.CustomDomainProperties
    """
...
class CustomDomainResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.CustomDomainResource]
...
class DeploymentResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.DeploymentResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class DeploymentResourceProperties(msrest.serialization.Model):
    ...
    :type source: ~azure.mgmt.appplatform.v2022_03_01_preview.models.UserSourceInfo
...
class DeploymentSettings(msrest.serialization.Model):
    ...
    :type resource_requests: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ResourceRequests
...
class GatewayProperties(msrest.serialization.Model):
    ...
    :type cors_properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayCorsProperties
...
class GatewayResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayProperties
...
class GatewayResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class GatewayRouteConfigProperties(msrest.serialization.Model):
    ...
    :type routes: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayApiRoute]
    """
...
class ManagedIdentityProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.ManagedIdentityType
    :param principal_id: Principal Id of system-assigned managed identity.
    :type principal_id: str
    :param tenant_id: Tenant Id of system-assigned managed identity.
    :type tenant_id: str
    :param user_assigned_identities: Properties of user-assigned managed identities.
...
class MetricSpecification(msrest.serialization.Model):
    ...
    :type dimensions: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.MetricDimension]
...
class OperationDetail(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.appplatform.v2022_03_01_preview.models.OperationDisplay
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.OperationProperties
    """
...
class RegenerateTestKeyRequestPayload(msrest.serialization.Model):
    ...
    :param key_type: Required. Type of the test key. Possible values include: "Primary",
     "Secondary".
    :type key_type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.TestKeyType
    """
...
class ResourceSku(msrest.serialization.Model):
    ...
    :type capacity: ~azure.mgmt.appplatform.v2022_03_01_preview.models.SkuCapacity
...
class ResourceSkuCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.ResourceSku]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class ServiceRegistryResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ServiceRegistryProperties
    """
...
class ServiceRegistryResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.ServiceRegistryResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class ServiceResource(TrackedResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ClusterResourceProperties
...
class ServiceResourceList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.ServiceResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class SkuCapacity(msrest.serialization.Model):
    ...
    :param scale_type: Gets or sets the type of the scale. Possible values include: "None",
     "Manual", "Automatic".
    :type scale_type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.SkuScaleType
    """
...
class StorageProperties(msrest.serialization.Model):
    ...
    :type storage_type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.StorageType
    """
...
class StorageResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_03_01_preview.models.StorageProperties
    """
...
class StorageResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.StorageResource]
...
class SupportedRuntimeVersion(msrest.serialization.Model):
    ...
    :type value: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.SupportedRuntimeValue
...
class SupportedStacksCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_03_01_preview.models.SupportedStackResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or ~azure.mgmt.appplatform.v2022_03_01_preview.models.CreatedByType

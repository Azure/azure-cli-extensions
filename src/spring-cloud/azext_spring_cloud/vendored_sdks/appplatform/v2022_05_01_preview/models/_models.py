...
class ApiPortalProperties(msrest.serialization.Model):
    ...
    :type sso_properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.SsoProperties
...
class ApiPortalResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.ApiPortalProperties
...
class ApiPortalResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.ApiPortalResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class CustomPersistentDiskProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.appplatform.v2022_05_01_preview.models.Type
...
class BuildCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.Build]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuilderProperties(msrest.serialization.Model):
    ...
    :type stack: ~azure.mgmt.appplatform.v2022_05_01_preview.models.StackProperties
...
class BuilderResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.BuilderProperties
    """
...
class BuilderResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuilderResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildpackBindingResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackBindingProperties
    """
...
class BuildpackBindingResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackBindingResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildpacksGroupProperties(msrest.serialization.Model):
    ...
    :type buildpacks: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackProperties]
    """
...
class BuildProperties(msrest.serialization.Model):
    ...
    :param resource_requests: The customized build resource for this build.
...
class BuildResourceRequests(msrest.serialization.Model):
    ...
    :param cpu: Optional Cpu allocated to the build resource. 1 core can be represented by 1 or
     1000m.
     The default value is 1, this should not exceed build service agent pool cpu size.
    :type cpu: str
    :param memory: Optional Memory allocated to the build resource. 1 GB can be represented by 1Gi
     or 1024Mi.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.memory = kwargs.get('memory', "2Gi")
...
class BuildResultCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildResult]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BuildServiceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildService]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class CustomContainerUserSourceInfo(UserSourceInfo):
    ...
    :type custom_container: ~azure.mgmt.appplatform.v2022_05_01_preview.models.CustomContainer
    """
...
class GatewayProperties(msrest.serialization.Model):
    ...
    :type cors_properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.GatewayCorsProperties
...
class GatewayResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.GatewayProperties
...
class GatewayResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.GatewayResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class GatewayRouteConfigProperties(msrest.serialization.Model):
    ...
    :type routes: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.GatewayApiRoute]
    """
...
class IngressConfig(msrest.serialization.Model):
    """Ingress configuration payload for Azure Spring Cloud instance.

    :param read_timeout_in_seconds: Ingress read time out in seconds.
    :type read_timeout_in_seconds: int
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.read_timeout_in_seconds = kwargs.get('read_timeout_in_seconds', None)
...
class NetworkProfile(msrest.serialization.Model):
    ...
    :param ingress_config: Ingress configuration payload for Azure Spring Cloud instance.
    :type ingress_config: ~azure.mgmt.appplatform.v2022_05_01_preview.models.IngressConfig
    """
...
class Plan(msrest.serialization.Model):
    """Purchasing 3rd Party product for one Azure Spring Cloud instance.

    :param name: A publisher defined name of the 3rd Party Artifact that is being procured.
    :type name: str
    :param publisher: The publisher of the 3rd Party Artifact that is being bought.
    :type publisher: str
...
class ServiceRegistryResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceRegistryResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class ServiceResource(TrackedResource):
    ...
    :type sku: ~azure.mgmt.appplatform.v2022_05_01_preview.models.Sku
    :param plan: Purchasing 3rd party product of the Service resource.
    :type plan: ~azure.mgmt.appplatform.v2022_05_01_preview.models.Plan
    """
...
class StorageProperties(msrest.serialization.Model):
    ...
    :type storage_type: str or ~azure.mgmt.appplatform.v2022_05_01_preview.models.StorageType
    """
...
class StorageResource(ProxyResource):
    ...
    :type properties: ~azure.mgmt.appplatform.v2022_05_01_preview.models.StorageProperties
    """
...
class StorageResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.StorageResource]
...
class SupportedStacksCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.v2022_05_01_preview.models.SupportedStackResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """

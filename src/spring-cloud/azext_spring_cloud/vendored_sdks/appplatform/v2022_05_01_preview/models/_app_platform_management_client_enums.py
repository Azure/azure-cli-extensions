...
class CertificateResourceProvisioningState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class CustomDomainResourceProvisioningState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

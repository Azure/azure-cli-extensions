...
class AppPlatformManagementClient(MultiApiClientMixin, SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2021-03-03-preview: :mod:`v2021_03_03_preview.models<azure.mgmt.appplatform.v2021_03_03_preview.models>`
        """
    ...
    def apps(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`AppsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.AppsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import AppsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
    ...
    def bindings(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`BindingsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.BindingsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import BindingsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def certificates(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`CertificatesOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.CertificatesOperations>`
        """
    ...
    def config_servers(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`ConfigServersOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.ConfigServersOperations>`
        """
        ...
        if api_version == '2020-07-01':
            ...
            from .v2021_03_03_preview.operations import ConfigServersOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def custom_domains(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`CustomDomainsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.CustomDomainsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import CustomDomainsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def deployments(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`DeploymentsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.DeploymentsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import DeploymentsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def monitoring_settings(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`MonitoringSettingsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.MonitoringSettingsOperations>`
        """
        ...
        if api_version == '2020-07-01':
            ...
            from .v2021_03_03_preview.operations import MonitoringSettingsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`Operations<azure.mgmt.appplatform.v2021_03_03_preview.operations.Operations>`
        """
    ...
    def runtime_versions(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`RuntimeVersionsOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.RuntimeVersionsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import RuntimeVersionsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def services(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`ServicesOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.ServicesOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from .v2021_03_03_preview.operations import ServicesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def skus(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`SkusOperations<azure.mgmt.appplatform.v2021_03_03_preview.operations.SkusOperations>`
        """
        ...
        if api_version == '2020-07-01':
            ...
            from .v2021_03_03_preview.operations import SkusOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))

...
def load_command_table(self, _):
    ...
    with self.command_group('spring-cloud test-endpoint', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app log', client_factory=cf_spring_cloud_20220501preview,
    ...
    with self.command_group('spring-cloud app deployment', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app binding', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud storage', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud certificate', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app custom-domain', client_factory=cf_spring_cloud_20220501preview,
                            exception_handler=handle_asc_exception) as g:

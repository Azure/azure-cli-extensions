...
from ._client_factory import (cf_app_services,
                              ...
                              cf_spring_cloud_20210303preview,
                              cf_bindings,
                              cf_config_servers)
...
def load_command_table(self, _):
    ...
    with self.command_group('spring-cloud app', client_factory=cf_spring_cloud_20210303preview) as g:
    ...
    with self.command_group('spring-cloud app deployment', client_factory=cf_spring_cloud_20210303preview) as g:

...
def load_arguments(self, _):
    ...
    with self.argument_context('spring-cloud create') as c:
        ...
        c.argument('app_subnet', help='The name or ID of an existing subnet in "vnet" into which to deploy the Spring Cloud app. Required when deploying into a Virtual Network. Smaller subnet sizes are supported. '
                                      'A subnet of size /28 can hold 24 app instances of 4 vCPU, or 32 app instances of 3 vCPU, or 48 app instances of 2 vCPU, or 96 app instances of 1 vCPU. '
                                      'A subnet of size /27 can hold 72 app instances of 4 vCPU, or 96 app instances of 3 vCPU, or 144 app instances of 2 vCPU, or 288 app instances of 1 vCPU. '
                                      'A subnet of size /26 can hold 168 app instances of 4 vCPU, or 224 app instances of 3 vCPU, or 336 app instances of 2 vCPU, or 500 app instances of 1 vCPU. '
                                      'A subnet of size /25 can hold 360 app instances of 4 vCPU, or 480 app instances of 3 vCPU, or 500 app instances of 2 vCPU, or 500 app instances of 1 vCPU. '
                                      'A subnet of size /24 can hold 500 app instances of 4 vCPU, or 500 app instances of 3 vCPU, or 500 app instances of 2 vCPU, or 500 app instances of 1 vCPU. ', validator=validate_vnet_required_parameters)

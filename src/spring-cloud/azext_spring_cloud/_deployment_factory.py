...
class DefaultDeployment:
    ...
    def _format_readiness_probe(self, enable_readiness_probe=None, readiness_probe_config_file_path=None, **_):
        ...
        if not enable_readiness_probe:
            return models_20220501preview.Probe(disable_probe=True, probe_action=NULL, 
            initial_delay_seconds=NULL, period_seconds=NULL, timeout_seconds=NULL, 
            failure_threshold=NULL, success_threshold=NULL)

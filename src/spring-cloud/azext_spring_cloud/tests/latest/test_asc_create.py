...
class TestSpringCloudCreateWithIngressConfig(BasicTest):
    def test_asc_create_basic_with_ingress_config(self):
    ...
    def test_asc_create_standard_with_ingress_config(self):
    ...
    def test_asc_create_enterprise_with_ingress_config(self):

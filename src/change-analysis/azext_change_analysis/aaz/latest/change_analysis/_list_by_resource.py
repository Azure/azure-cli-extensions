...
@register_command(
    "change-analysis list-by-resource",
    is_preview=True,
)
class ListByResource(AAZCommand):
    ...
    :example: List the changes of a resource within the specified time range
    ...
    def _execute_operations(self):
        self.ResourceChangesList(ctx=self.ctx)()
    ...
    class ResourceChangesList(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "resourceId", self.ctx.args.resource,
                    required=True,
                ),
            }
            return parameters

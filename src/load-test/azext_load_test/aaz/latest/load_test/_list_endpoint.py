...
class ListEndpoint(AAZCommand):
    """List the endpoints that agents may call as part of load testing.
    """

    _aaz_info = {
        "version": "2022-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.loadtestservice/loadtests/{}/outboundnetworkdependenciesendpoints", "2022-12-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LoadTestsListOutboundNetworkDependenciesEndpoints(ctx=self.ctx)()
    ...
    class LoadTestsListOutboundNetworkDependenciesEndpoints(AAZHttpOperation):

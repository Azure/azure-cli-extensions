...
name\\":{}}" --location "eastus" --ak-s-properties "{\\"remoteLoginPortPublicAccess\\":\\"NotSpecified\\",\\"scaleSetti\
ngs\\":{\\"maxNodeCount\\":1,\\"minNodeCount\\":0,\\"nodeIdleTimeBeforeScaleDown\\":\\"PT5M\\"},\\"vmPriority\\":\\"Ded\
icated\\",\\"vmSize\\":\\"STANDARD_NC6\\"}" --resource-group "testrg123" --workspace-name "workspaces123"
...
"eastus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AKS Compute
        text: |-
               az machinelearningservices machine-learning-compute aks create --compute-name "compute123" --location \
"eastus" --ak-s-description "some compute" --ak-s-properties "{\\"agentCount\\":4}" --ak-s-resource-id \
...
--identity-type "SystemAssigned,UserAssigned" --identity-user-assigned-identities "{\\"/subscriptions/00000000-0000-000\
0-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-\
name\\":{}}" --location "eastus" --ak-s-properties "{\\"scaleSettings\\":{\\"maxNodeCount\\":1,\\"minNodeCount\\":0,\\"\
...
--identity-type "SystemAssigned,UserAssigned" --identity-user-assigned-identities "{\\"/subscriptions/00000000-0000-000\
0-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-\
name\\":{}}" --location "eastus" --aml-compute-properties "{\\"remoteLoginPortPublicAccess\\":\\"NotSpecified\\",\\"sca\
...
--location "eastus" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AKS Compute
        text: |-
               az machinelearningservices machine-learning-compute aml-compute create --compute-name "compute123" \
--location "eastus" --description "some compute" --aml-compute-properties "{\\"agentCount\\":4}" --resource-id \
"/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourcegroups/testrg123/providers/Microsoft.ContainerService/mana\
gedClusters/compute123-56826-c9b00420020b2" --resource-group "testrg123" --workspace-name "workspaces123"
      - name: Update a AML Compute
        text: |-
...
--identity-type "SystemAssigned,UserAssigned" --identity-user-assigned-identities "{\\"/subscriptions/00000000-0000-000\
0-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-\
name\\":{}}" --location "eastus" --aml-compute-properties "{\\"scaleSettings\\":{\\"maxNodeCount\\":1,\\"minNodeCount\\\

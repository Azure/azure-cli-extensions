...
class Compute(msrest.serialization.Model):
    ...
    :param compute_type: Required. The type of compute.Constant filled by server.  Possible values
     include: "AKS", "AmlCompute", "DataFactory", "VirtualMachine", "HDInsight", "Databricks",
     "DataLakeAnalytics".
...
class AksProperties(msrest.serialization.Model):
    ...
    :param cluster_purpose:  Possible values include: "FastProd", "DenseProd", "DevTest".
    :type cluster_purpose: str or
     ~azure_machine_learning_workspaces.models.AksPropertiesClusterPurpose
    """
...
class QuotaBaseProperties(msrest.serialization.Model):
    ...
    :type limit: long
    :ivar unit: An enum describing the unit of quota measurement. Default value: "Count".
    :vartype unit: str
    """
...
class ResourceQuota(msrest.serialization.Model):
    ...
    _validation = {
        ...
        'name': {'readonly': True},
        'limit': {'readonly': True},
        'unit': {'readonly': True, 'constant': True},
    }
...
class SslConfiguration(msrest.serialization.Model):
    ...
    :param overwrite_existing_domain: Boolean value for overwriting the domain.
...
class Usage(msrest.serialization.Model):
    ...
    :ivar type: Specifies the resource type.
    :vartype type: str
    :ivar unit: An enum describing the unit of usage measurement. Default value: "Count".
    :vartype unit: str

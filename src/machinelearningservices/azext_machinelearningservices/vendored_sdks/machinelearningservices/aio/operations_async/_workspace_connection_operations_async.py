...
class WorkspaceConnectionOperations:
    """WorkspaceConnectionOperations async operations.
    ...
    async def create(
        ...
        **kwargs
        ...
        _parameters = models.WorkspaceConnectionDto(name=name, category=category, target=target, auth_type=auth_type, value=value)
        api_version = "2020-06-01"
        ...
        body_content = self._serialize.body(_parameters, 'WorkspaceConnectionDto')

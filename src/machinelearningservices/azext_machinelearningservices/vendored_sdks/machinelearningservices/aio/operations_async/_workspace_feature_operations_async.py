...
class WorkspaceFeatureOperations:
    """WorkspaceFeatureOperations async operations.
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs
    ) -> "models.ListAmlUserFeatureResult":
        ...
        :return: ListAmlUserFeatureResult or the result of cls(response)
        :rtype: ~azure.mgmt.machinelearningservices.models.ListAmlUserFeatureResult

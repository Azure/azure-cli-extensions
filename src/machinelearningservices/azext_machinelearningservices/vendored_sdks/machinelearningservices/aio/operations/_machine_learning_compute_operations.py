...
class MachineLearningComputeOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        parameters = models.ComputeResource(location=location, tags=tags, sku=sku, type_identity_type=type, user_assigned_identities=user_assigned_identities, properties=properties)
        api_version = "2020-08-01"

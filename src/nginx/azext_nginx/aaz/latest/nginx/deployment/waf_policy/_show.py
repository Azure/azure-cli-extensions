...
@register_command(
    "nginx deployment waf-policy show",
)
class Show(AAZCommand):
    ...
    class WafPolicyGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            applying_state = cls._schema_on_200.properties.applying_state
            ...
            compiling_state = cls._schema_on_200.properties.compiling_state

...
@register_command(
    "nginx deployment waf-policy list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WafPolicyList(ctx=self.ctx)()
    ...
    class WafPolicyList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            applying_state = cls._schema_on_200.value.Element.properties.applying_state
            ...
            compiling_state = cls._schema_on_200.value.Element.properties.compiling_state

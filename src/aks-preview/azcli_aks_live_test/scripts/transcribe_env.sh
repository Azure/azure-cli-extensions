...
# shared identities
echo "USE_SHARED_IDENTITY=${USE_SHARED_IDENTITY}" >> env.list
echo "SHARED_CP_IDENTITY_TEMPLATE=${SHARED_CP_IDENTITY_TEMPLATE}" >> env.list
echo "SHARED_CP_IDENTITY_PREFIX=${SHARED_CP_IDENTITY_PREFIX}" >> env.list
echo "SHARED_CP_IDENTITY_MAX_ID=${SHARED_CP_IDENTITY_MAX_ID}" >> env.list
echo "SHARED_KUBELET_IDENTITY_TEMPLATE=${SHARED_KUBELET_IDENTITY_TEMPLATE}" >> env.list
echo "SHARED_KUBELET_IDENTITY_PREFIX=${SHARED_KUBELET_IDENTITY_PREFIX}" >> env.list
echo "SHARED_KUBELET_IDENTITY_MAX_ID=${SHARED_KUBELET_IDENTITY_MAX_ID}" >> env.list
# sp client & object id
echo "AZURE_CLI_TEST_DEV_SP_CLIENT_ID=${AZCLI_ALT_CLIENT_ID}" >> env.list
echo "AZURE_CLI_TEST_DEV_SP_OBJECT_ID=${AZURE_CLI_TEST_DEV_SP_OBJECT_ID}" >> env.list

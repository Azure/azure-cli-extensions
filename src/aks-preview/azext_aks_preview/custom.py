...
def aks_stop(cmd, client, resource_group_name, name, aks_custom_headers=None, no_wait=False, yes=False):
    headers = get_aks_custom_headers(aks_custom_headers)
    ...
    if check_is_private_link_cluster(instance):
        ...
        if not yes and not prompt_y_n(msg, default="n"):
            return None
    return sdk_no_wait(no_wait, client.begin_stop, resource_group_name, name, headers=headers)

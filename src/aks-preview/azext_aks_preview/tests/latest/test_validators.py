...
class TestValidateAzureContainerStorage(unittest.TestCase):
    def test_conflicting_flags_for_enable_disable(self):
        ...
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, True, None, None, None, None, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_disable_flag_with_storage_pool_name(self):
        ...
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(None, True, storage_pool_name, None, None, None, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_disable_flag_with_storage_pool_sku(self):
        ...
        err = 'Conflicting flags. Cannot define --storage-pool-sku value ' \
              'when --disable-azure-container-storage is set.'
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(None, True, None, None, storage_pool_sku, None, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_disable_flag_with_storage_pool_size(self):
        ...
        err = 'Conflicting flags. Cannot define --storage-pool-size value ' \
              'when --disable-azure-container-storage is set.'
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(None, True, None, None, None, None, storage_pool_size, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_disable_flag_with_storage_pool_option(self):
        ...
        err = 'Conflicting flags. Cannot define --storage-pool-option value ' \
              'when --disable-azure-container-storage is set.'
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(None, True, None, None, None, storage_pool_option, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_disable_flag_with_nodepool_list(self):
        ...
        err = 'Conflicting flags. Cannot define --azure-container-storage-nodepools value ' \
              'when --disable-azure-container-storage is set.'
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            acstor_validator.validate_azure_container_storage_params(None, True, None, None, None, None, None, nodepool_list, None)
        self.assertEqual(str(cm.exception), err)

    def test_valid_disable(self):
        acstor_validator.validate_azure_container_storage_params(None, True, None, None, None, None, None, None, None)
    ...
    def test_enable_with_invalid_storage_pool_name(self):
        ...
        with self.assertRaises(InvalidArgumentValueError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, None, None, None, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_enable_with_sku_and_ephemeral_disk_pool(self):
        ...
        with self.assertRaises(ArgumentUsageError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, storage_pool_type, storage_pool_sku, None, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_enable_with_option_and_non_ephemeral_disk_pool(self):
        ...
        with self.assertRaises(ArgumentUsageError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, storage_pool_type, None, storage_pool_option, None, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_enable_with_invalid_storage_pool_size(self):
        ...
        with self.assertRaises(ArgumentUsageError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, None, None, None, storage_pool_size, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_enable_with_invalid_size_for_esan_storage_pool(self):
        ...
        with self.assertRaises(ArgumentUsageError) as cm:
            acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, storage_pool_type, None, None, storage_pool_size, None, None)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_valid_enable_for_azure_disk_pool(self):
        ...
        agentpools = ["nodepool1", "nodepool2"]
        acstor_validator.validate_azure_container_storage_params(True, None, storage_pool_name, storage_pool_type, storage_pool_sku, None, storage_pool_size, nodepool_list, agentpools)

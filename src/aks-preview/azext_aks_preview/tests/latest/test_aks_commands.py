...
class AzureKubernetesServiceScenarioTest(ScenarioTest):
    ...
    def test_aks_create_and_update_with_http_proxy_config(self, resource_group, resource_group_location):
        ...
        try:
            ...
            # expect previous to fail
            pass

        self.cmd(show_cmd, checks=[
            self.check('httpProxyConfig.httpProxy', 'http://myproxy.server.com:8080/'),
            self.check('httpProxyConfig.httpsProxy', 'https://myproxy.server.com:8080/'),
            self.check('httpProxyConfig.trustedCa', '')
        ])

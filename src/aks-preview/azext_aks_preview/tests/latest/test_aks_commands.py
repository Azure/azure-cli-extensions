...
class AzureKubernetesServiceScenarioTest(ScenarioTest):
    ...
    # # These tests require subscription-level feature flags to be set by AKS and Azure Monitor. The features will be 
    # # broadly rolling out soon, then these tests can be uncommented. (written on 6/29/2021)
    # @live_only()
    # @AllowLargeResponse()
    # @AKSCustomResourceGroupPreparer(random_name_length=17, name_prefix='clitest', location='westus2')

...
class AzureKubernetesServiceScenarioTest(ScenarioTest):
    ...
    def test_aks_update_with_crg_id(self, resource_group, resource_group_location):
        # reset the count so in replay mode the random names will start with 0
        self.test_resources_count = 0
        # kwargs for string formatting
        aks_name = self.create_random_name("cliakstest", 16)
        ...
        node_pool_name_second = self.create_random_name("c", 6)
        crg_id = (
            "/subscriptions/26fe00f8-9173-4872-9134-bb1d2e00343a/resourceGroups/jizenCRGTestRG/providers"
            "/Microsoft.Compute/capacityReservationGroups/jizenCRGTest"
        )
        vm_size = "Standard_D4s_v3"
        count = 1
        #identity = "/subscriptions/26fe00f8-9173-4872-9134-bb1d2e00343a/resourceGroups/staging-crg-rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/crg-rg-id"
        identity = "/subscriptions/26fe00f8-9173-4872-9134-bb1d2e00343a/resourceGroups/jizenCRGTestRG/providers/Microsoft.ManagedIdentity/userAssignedIdentities/jizenCRGTestMSI"
        ...
        self.kwargs.update(
            {
                ...
                "crg_id": "/subscriptions/26fe00f8-9173-4872-9134-bb1d2e00343a/resourceGroups/JIZENCRGTESTRG/providers/Microsoft.Compute/capacityReservationGroups/jizenCRGTest",
            }
        )

        # nodepool update to add crg_id
        update_cmd = (
            "aks nodepool update "
            "--resource-group={resource_group} "
            "--cluster-name={name} "

...
class TestAksAgentStatusCommand(unittest.TestCase):
    ...
    def test_aks_agent_status_function_signature(self):
        ...
        # Verify verbose parameter is no longer present (removed to avoid conflicts)
    ...
    def test_aks_agent_status_basic_execution(self):
        ...
        with patch('azext_aks_preview.agent.binary_manager.AksMcpBinaryManager') as mock_binary_manager_class, \
             patch('azure.cli.core._environment.get_config_dir') as mock_get_config_dir, \
    ...
    def test_aks_agent_status_with_binary_available(self):
        ...
        # Mock all the imports that happen inside the function
        with patch('azext_aks_preview.agent.binary_manager.AksMcpBinaryManager') as mock_binary_manager_class, \
             patch('azext_aks_preview.agent.mcp_manager.MCPManager') as mock_mcp_manager_class, \
             patch('azure.cli.core._environment.get_config_dir') as mock_get_config_dir, \
             patch('rich.console.Console') as mock_console_class:
    ...
    def test_aks_agent_status_error_handling(self):
        ...
        with patch('azure.cli.core._environment.get_config_dir') as mock_get_config_dir, \
             patch('rich.console.Console') as mock_console_class:
    ...
    def test_command_registration(self):
        ...
        # This is more of an integration test to verify command registration
        # We can't easily test the actual command table loading without more setup,
        # but we can verify the function is importable and has correct structure

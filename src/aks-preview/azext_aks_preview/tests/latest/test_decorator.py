...
class AKSPreviewUpdateDecoratorTestCase(unittest.TestCase):
    ...
    def test_update_custom_ca_trust(self):
        ...
        dec_1.context.attach_mc(mock_existing_mc)
        dec_mc_1 = dec_1.update_custom_ca_trust(mock_existing_mc)
        ...
        ground_truth_mc_1 = self.models.ManagedCluster(
            location="test_location",
            agent_pool_profiles=[ground_truth_agent_pool_profile_1, ground_truth_agent_pool_profile_2],
        )
        self.assertEqual(dec_mc_1, ground_truth_mc_1)

        # custom value
        # fail on conflicting flags
        dec_2 = AKSPreviewUpdateDecorator(
            self.cmd,
            self.client,
            {
        ...
        dec_2.context.attach_mc(mock_existing_mc)
        with self.assertRaises(InvalidArgumentValueError):
            dec_mc_2 = dec_2.update_custom_ca_trust(mock_existing_mc)

        # custom value
        mock_existing_mc_enabled = self.models.ManagedCluster(
            location="test_location",
            agent_pool_profiles=[
                self.models.ManagedClusterAgentPoolProfile(
                    name="nodepool1",
        ...
        dec_3.context.attach_mc(mock_existing_mc_enabled)
        dec_mc_3 = dec_3.update_custom_ca_trust(mock_existing_mc_enabled)

        ground_truth_agent_pool_profile_enable_1 = (
            self.models.ManagedClusterAgentPoolProfile(
                name="nodepool1",
                enable_custom_ca_trust=True,
            )
        )
        ground_truth_agent_pool_profile_enable_2 = (
            self.models.ManagedClusterAgentPoolProfile(
                name="nodepool2",
                enable_custom_ca_trust=True,
            )
        ...
        ground_truth_mc_3 = self.models.ManagedCluster(
            location="test_location",
            agent_pool_profiles=[ground_truth_agent_pool_profile_enable_1, ground_truth_agent_pool_profile_enable_2],
        )
        self.assertEqual(dec_mc_3, ground_truth_mc_3)
        ...
        dec_4.context.attach_mc(mock_existing_mc_enabled)
        dec_mc_4 = dec_4.update_custom_ca_trust(mock_existing_mc_enabled)

        ground_truth_agent_pool_profile_disable_1 = (
            self.models.ManagedClusterAgentPoolProfile(
                name="nodepool1",
                enable_custom_ca_trust=False,
            )
        )
        ground_truth_agent_pool_profile_disable_2 = (
            self.models.ManagedClusterAgentPoolProfile(
                name="nodepool2",
                enable_custom_ca_trust=False,
            )
        ...
        ground_truth_mc_4 = self.models.ManagedCluster(
            location="test_location",
            agent_pool_profiles=[ground_truth_agent_pool_profile_disable_1, ground_truth_agent_pool_profile_disable_2],
        )
        self.assertEqual(dec_mc_4, ground_truth_mc_4)

...
helps['aks nodepool add'] = """
    ...
    parameters:
        ...
        - name: --os-sku
          type: string
          short-summary: The os-sku of the agent node pool. Ubuntu, CBLMariner or Ubuntu2204 when os-type is Linux, default is Ubuntu if not set; Windows2019, Windows2022 or WindowsAnnual when os-type is Windows, the current default is Windows2022 if not set.
        - name: --enable-fips-image
          type: bool
          short-summary: Use FIPS-enabled OS on agent nodes.
        - name: --enable-cluster-autoscaler -e

...
helps['aks maintenanceconfiguration add'] = """
    ...
    examples:
        - name: Add a maintenance configuration with --weekday and --start-hour.
          text: |
            az aks maintenanceconfiguration add -g xiazhan-mtc-stg -n test1 --config-name default --weekday Monday  --start-hour 1
        ...
        - name: Add a maintenance configuration with --weekday.The maintenance is allowd on any time of that day.
          text: |
            az aks maintenanceconfiguration add -g xiazhan-mtc-stg -n test1 --config-name default --weekday Monday
              The maintenance is allowed on Monday.
        - name: Add a maintenance configuration with maintenance configuration json file
          text: |
            az aks maintenanceconfiguration add -g xiazhan-mtc-stg -n test1 --config-name default --config-file ./test.json

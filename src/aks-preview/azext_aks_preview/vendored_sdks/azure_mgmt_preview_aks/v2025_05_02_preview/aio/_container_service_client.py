...
class ContainerServiceClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.Operations
    :ivar managed_clusters: ManagedClustersOperations operations
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.ManagedClustersOperations
    :ivar container_service: ContainerServiceOperations operations
    :vartype container_service:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.ContainerServiceOperations
    :ivar maintenance_configurations: MaintenanceConfigurationsOperations operations
    :vartype maintenance_configurations:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.MaintenanceConfigurationsOperations
    :ivar managed_namespaces: ManagedNamespacesOperations operations
    :vartype managed_namespaces:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.ManagedNamespacesOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.AgentPoolsOperations
    :ivar machines: MachinesOperations operations
    :vartype machines:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.MachinesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.PrivateLinkResourcesOperations
    ...
    :vartype resolve_private_link_service_id:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.ResolvePrivateLinkServiceIdOperations
    :ivar operation_status_result: OperationStatusResultOperations operations
    :vartype operation_status_result:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.OperationStatusResultOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.SnapshotsOperations
    :ivar managed_cluster_snapshots: ManagedClusterSnapshotsOperations operations
    :vartype managed_cluster_snapshots:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.ManagedClusterSnapshotsOperations
    :ivar trusted_access_roles: TrustedAccessRolesOperations operations
    :vartype trusted_access_roles:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.TrustedAccessRolesOperations
    :ivar trusted_access_role_bindings: TrustedAccessRoleBindingsOperations operations
    :vartype trusted_access_role_bindings:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.TrustedAccessRoleBindingsOperations
    :ivar load_balancers: LoadBalancersOperations operations
    :vartype load_balancers:
     azure.mgmt.containerservice.v2025_05_02_preview.aio.operations.LoadBalancersOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2025-05-02-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(
            self._client, self._config, self._serialize, self._deserialize, "2025-05-02-preview"
        )

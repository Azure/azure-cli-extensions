...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_05_02_preview.models.Machine]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Machine
        ...
        :return: An instance of AsyncLROPoller that returns either Machine or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2025_05_02_preview.models.Machine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The machine to create or update. Is either a Machine type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Machine or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

...
class PrivateEndpointConnectionsOperations:
    ...
    async def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2022_07_02_preview.models.PrivateEndpointConnectionListResult
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_07_02_preview.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_07_02_preview.models.PrivateEndpointConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateEndpointConnection, or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_07_02_preview.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError

...
class AgentPoolAvailableVersions(_serialization.Model):
    ...
    :vartype agent_pool_versions:
     list[~azure.mgmt.containerservice.v2025_01_02_preview.models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem]
    """
...
class ManagedClusterAzureMonitorProfileAppMonitoring(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype auto_instrumentation:
     ~azure.mgmt.containerservice.v2025_01_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentation
    ...
    :vartype open_telemetry_logs:
     ~azure.mgmt.containerservice.v2025_01_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogs
    """
...
class ManagedClusterSecurityProfileDefenderSecurityGating(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar identities: List of identities that the admission controller will make use of in order to
     ...
     attached to it.
    :vartype identities:
     list[~azure.mgmt.containerservice.v2025_01_02_preview.models.ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesItem]
...
class ManagedClusterWorkloadAutoScalerProfile(_serialization.Model):
    ...
    :vartype vertical_pod_autoscaler:
     ~azure.mgmt.containerservice.v2025_01_02_preview.models.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler
    """
...
class SafeguardsProfile(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        super().__init__(**kwargs)
        self.system_excluded_namespaces: Optional[List[str]] = None
        self.version = version
        self.level = level

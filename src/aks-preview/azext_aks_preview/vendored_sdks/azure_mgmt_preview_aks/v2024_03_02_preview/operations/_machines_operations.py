...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2024_03_02_preview.models.Machine]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_03_02_preview.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,

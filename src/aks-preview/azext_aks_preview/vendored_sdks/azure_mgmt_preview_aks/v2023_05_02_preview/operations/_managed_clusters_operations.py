...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def get_os_options(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.OSOptionProfile
    ...
    def list_kubernetes_versions(self, location: str, **kwargs: Any) -> _models.KubernetesVersionListResult:
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.KubernetesVersionListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ManagedCluster"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedClusterUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_access_profile(
        ...
        **WARNING**\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedClusterAccessProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_cluster_admin_credentials(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_cluster_user_credentials(
        ...
        **kwargs: Any
        ...
        :type format: str or ~azure.mgmt.containerservice.v2023_05_02_preview.models.Format
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CredentialResults or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedCluster:
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedCluster
        ...
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param parameters: The managed cluster to create or update. Is either a ManagedCluster type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedCluster or IO
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_05_02_preview.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_05_02_preview.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedClusterServicePrincipalProfile
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_reset_aad_profile(
        ...
        **WARNING**\ : This API will be deprecated. Please see `AKS-managed Azure Active Directory
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedClusterAADProfile
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_reset_aad_profile(
        ...
        **WARNING**\ : This API will be deprecated. Please see `AKS-managed Azure Active Directory
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_05_02_preview.models.ManagedClusterAADProfile or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2023_05_02_preview.models.RunCommandRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2023_05_02_preview.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :param request_payload: The run command request. Is either a RunCommandRequest type or a IO
         type. Required.
        :type request_payload:
         ~azure.mgmt.containerservice.v2023_05_02_preview.models.RunCommandRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_command_result(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.RunCommandResult or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_05_02_preview.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

...
class ResolvePrivateLinkServiceIdOperations:
    ...
    def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_05_02_preview.models.PrivateLinkResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_05_02_preview.models.PrivateLinkResource

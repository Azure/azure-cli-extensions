...
class AgentPool(SubResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.message_of_the_day = kwargs.get('message_of_the_day', None)
        ...
        self.capacity_reservation_group_id = kwargs.get('capacity_reservation_group_id', None)
...
class ManagedCluster(Resource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.oidc_issuer_profile = kwargs.get('oidc_issuer_profile', None)
        ...
        self.enable_namespace_resources = kwargs.get('enable_namespace_resources', None)

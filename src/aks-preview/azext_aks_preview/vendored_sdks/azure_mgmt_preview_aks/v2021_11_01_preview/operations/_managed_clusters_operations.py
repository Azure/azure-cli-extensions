...
def build_list_cluster_admin_credentials_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    server_fqdn = kwargs.pop('server_fqdn', None)  # type: Optional[str]
...
class ManagedClustersOperations(object):
    ...
    def get_os_options(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.OSOptionProfile
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ManagedClusterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedClusterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_upgrade_profile(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedClusterUpgradeProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_access_profile(
        ...
        **WARNING**\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedClusterAccessProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_cluster_admin_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.CredentialResults
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedCluster
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def begin_reset_service_principal_profile(
        ...
        **kwargs  # type: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedClusterServicePrincipalProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def begin_reset_aad_profile(
        ...
        **kwargs  # type: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2021_11_01_preview.models.ManagedClusterAADProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def begin_run_command(
        ...
        **kwargs  # type: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2021_11_01_preview.models.RunCommandRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2021_11_01_preview.models.RunCommandResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def get_command_result(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2021_11_01_preview.models.RunCommandResult or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.RunCommandResult"]]
        error_map = {
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2021_11_01_preview.models.OutboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

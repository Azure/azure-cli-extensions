...
class ManagedClustersOperations(object):
    ...
    :ivar api_version: Client Api Version. Constant value: "2021-05-01".
    """
    ...
    def get_os_options(
        ...
        :type location: str
        :param resource_type: resource type for which the OS options needs to
         be returned
        ...
        :return: OSOptionProfile or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.OSOptionProfile or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_os_options.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('OSOptionProfile', response)
        ...
        return deserialized
    get_os_options.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/locations/{location}/osOptions/default'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.ManagedClusterPaged[~azure.mgmt.containerservice.v2021_05_01.models.ManagedCluster]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_upgrade_profile(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.ManagedClusterUpgradeProfile
    ...
    def get_access_profile(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.ManagedClusterAccessProfile
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_cluster_admin_credentials(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.CredentialResults or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2021_05_01.models.ManagedCluster
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerservice.v2021_05_01.models.ManagedCluster]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerservice.v2021_05_01.models.ManagedCluster]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _run_command_initial(
            self, resource_group_name, resource_name, request_payload, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def run_command(
            self, resource_group_name, resource_name, request_payload, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param resource_name: The name of the managed cluster resource.
        :type resource_name: str
        :param request_payload: Parameters supplied to the RunCommand
         operation.
        :type request_payload:
         ~azure.mgmt.containerservice.v2021_05_01.models.RunCommandRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerservice.v2021_05_01.models.RunCommandResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerservice.v2021_05_01.models.RunCommandResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    run_command.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/runCommand'}

    def get_command_result(
            self, resource_group_name, resource_name, command_id, custom_headers=None, raw=False, **operation_config):
        """Get command result.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: RunCommandResult or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.RunCommandResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_command_result.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', min_length=1),
            'resourceName': self._serialize.url("resource_name", resource_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9]$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,61}[a-zA-Z0-9]$'),
        ...
        return deserialized
    get_command_result.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/commandResults/{commandId}'}
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2021_05_01.models.OutboundEnvironmentEndpointPaged[~azure.mgmt.containerservice.v2021_05_01.models.OutboundEnvironmentEndpoint]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_outbound_network_dependencies_endpoints.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', min_length=1),
                    'resourceName': self._serialize.url("resource_name", resource_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9]$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,61}[a-zA-Z0-9]$')
        ...
        return deserialized
    list_outbound_network_dependencies_endpoints.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/outboundNetworkDependenciesEndpoints'}

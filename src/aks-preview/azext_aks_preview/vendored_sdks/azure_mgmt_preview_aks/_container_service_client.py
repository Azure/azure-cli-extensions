...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2025-04-02-preview: :mod:`v2025_04_02_preview.models<azure.mgmt.containerservice.v2025_04_02_preview.models>`
        """
    ...
    def agent_pools(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`AgentPoolsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.AgentPoolsOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from .v2025_04_02_preview.operations import AgentPoolsOperations as OperationClass
        else:
    ...
    def container_service(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`ContainerServiceOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.ContainerServiceOperations>`
        """
        api_version = self._get_api_version('container_service')
        if api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import ContainerServiceOperations as OperationClass
        else:
    ...
    def load_balancers(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`LoadBalancersOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.LoadBalancersOperations>`
        """
        api_version = self._get_api_version('load_balancers')
        if api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import LoadBalancersOperations as OperationClass
        else:
    ...
    def machines(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`MachinesOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.MachinesOperations>`
        """
        api_version = self._get_api_version('machines')
        if api_version == '2025-04-01':
            from .v2025_04_01.operations import MachinesOperations as OperationClass
        elif api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import MachinesOperations as OperationClass
        else:
    ...
    def maintenance_configurations(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`MaintenanceConfigurationsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.MaintenanceConfigurationsOperations>`
        """
        ...
        if api_version == '2025-04-01':
            ...
            from .v2025_04_02_preview.operations import MaintenanceConfigurationsOperations as OperationClass
        else:
    ...
    def managed_cluster_snapshots(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`ManagedClusterSnapshotsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.ManagedClusterSnapshotsOperations>`
        """
        api_version = self._get_api_version('managed_cluster_snapshots')
        if api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import ManagedClusterSnapshotsOperations as OperationClass
        else:
    ...
    def managed_clusters(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`ManagedClustersOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.ManagedClustersOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from .v2025_04_02_preview.operations import ManagedClustersOperations as OperationClass
        else:
    ...
    def managed_namespaces(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`ManagedNamespacesOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.ManagedNamespacesOperations>`
        """
        api_version = self._get_api_version('managed_namespaces')
        if api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import ManagedNamespacesOperations as OperationClass
        else:
    ...
    def operation_status_result(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`OperationStatusResultOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.OperationStatusResultOperations>`
        """
        api_version = self._get_api_version('operation_status_result')
        if api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import OperationStatusResultOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`Operations<azure.mgmt.containerservice.v2025_04_02_preview.operations.Operations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from .v2025_04_02_preview.operations import Operations as OperationClass
        else:
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from .v2025_04_02_preview.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`PrivateLinkResourcesOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.PrivateLinkResourcesOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from .v2025_04_02_preview.operations import PrivateLinkResourcesOperations as OperationClass
        else:
    ...
    def resolve_private_link_service_id(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`ResolvePrivateLinkServiceIdOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.ResolvePrivateLinkServiceIdOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from .v2025_04_02_preview.operations import ResolvePrivateLinkServiceIdOperations as OperationClass
        else:
    ...
    def snapshots(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`SnapshotsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.SnapshotsOperations>`
        """
        api_version = self._get_api_version('snapshots')
        if api_version == '2025-04-01':
            from .v2025_04_01.operations import SnapshotsOperations as OperationClass
        elif api_version == '2025-04-02-preview':
            from .v2025_04_02_preview.operations import SnapshotsOperations as OperationClass
        else:
    ...
    def trusted_access_role_bindings(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`TrustedAccessRoleBindingsOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.TrustedAccessRoleBindingsOperations>`
        """
        ...
        if api_version == '2025-04-01':
            ...
            from .v2025_04_02_preview.operations import TrustedAccessRoleBindingsOperations as OperationClass
        else:
    ...
    def trusted_access_roles(self):
        """Instance depends on the API version:
           ...
           * 2025-04-02-preview: :class:`TrustedAccessRolesOperations<azure.mgmt.containerservice.v2025_04_02_preview.operations.TrustedAccessRolesOperations>`
        """
        ...
        if api_version == '2025-04-01':
            ...
            from .v2025_04_02_preview.operations import TrustedAccessRolesOperations as OperationClass
        else:

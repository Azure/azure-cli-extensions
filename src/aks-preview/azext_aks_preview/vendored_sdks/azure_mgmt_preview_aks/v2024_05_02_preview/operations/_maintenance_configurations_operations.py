...
def build_list_by_managed_cluster_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-05-02-preview"))
...
class MaintenanceConfigurationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2024_05_02_preview.ContainerServiceClient`'s
    ...
    def list_by_managed_cluster(
        ...
        :return: An iterator like instance of either MaintenanceConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2024_05_02_preview.models.MaintenanceConfiguration]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_05_02_preview.models.MaintenanceConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2024_05_02_preview.models.MaintenanceConfiguration
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2024_05_02_preview.models.MaintenanceConfiguration or IO[bytes]
        :return: MaintenanceConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2024_05_02_preview.models.MaintenanceConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """

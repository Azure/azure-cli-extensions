...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    async def list_kubernetes_versions(self, location: str, **kwargs: Any) -> _models.KubernetesVersionListResult:
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.KubernetesVersionListResult
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedClusterUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_access_profile(
        ...
        **WARNING**\\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedClusterAccessProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_cluster_admin_credentials(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_cluster_user_credentials(
        ...
        **kwargs: Any
        ...
        :type format: str or ~azure.mgmt.containerservice.v2025_04_02_preview.models.Format
        :return: CredentialResults or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedCluster:
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedCluster
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedCluster or
         IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
    ...
    async def begin_reset_aad_profile(
        ...
        **WARNING**\\ : This API will be deprecated. Please see `AKS-managed Azure Active Directory
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.ManagedClusterAADProfile or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.RunCommandRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2025_04_02_preview.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.RunCommandRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2025_04_02_preview.models.RunCommandResult]
    ...
    async def get_command_result(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.RunCommandResult or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_guardrails_versions(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.GuardrailsAvailableVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_guardrails_versions(
        ...
        :return: An iterator like instance of either GuardrailsAvailableVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.GuardrailsAvailableVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_safeguards_versions(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.SafeguardsAvailableVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_safeguards_versions(
        ...
        :return: An iterator like instance of either SafeguardsAvailableVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.SafeguardsAvailableVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_mesh_revision_profiles(self, location: str, **kwargs: Any) -> AsyncIterable["_models.MeshRevisionProfile"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.MeshRevisionProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_mesh_revision_profile(self, location: str, mode: str, **kwargs: Any) -> _models.MeshRevisionProfile:
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.MeshRevisionProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_mesh_upgrade_profiles(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.MeshUpgradeProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_mesh_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.MeshUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_rebalance_load_balancers(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.RebalanceLoadBalancersRequestBody
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
    ...
    async def begin_rebalance_load_balancers(
        ...
        **kwargs: Any
        ...
        :param parameters: The names of the load balancers to be rebalanced. If set to empty, all load
         ...
         type. Required.
        :type parameters:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.RebalanceLoadBalancersRequestBody or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:

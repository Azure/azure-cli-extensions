    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "machineName": _SERIALIZER.url(
            "machine_name", machine_name, "str", pattern=r"^[a-z][a-z0-9]{0,11}$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,39}$"
        ),
    }
...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.Machine]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _create_or_update_initial(
        ...
        agent_pool_name: str,
        machine_name: str,
        parameters: Union[_models.Machine, IO[bytes]],
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.Machine
        ...
        :return: An instance of LROPoller that returns either Machine or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2025_04_02_preview.models.Machine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The machine to create or update. Is either a Machine type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.Machine or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

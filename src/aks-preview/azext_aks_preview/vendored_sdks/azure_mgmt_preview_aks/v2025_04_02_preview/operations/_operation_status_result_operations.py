...
class OperationStatusResultOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either OperationStatusResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.OperationStatusResult]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.OperationStatusResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,

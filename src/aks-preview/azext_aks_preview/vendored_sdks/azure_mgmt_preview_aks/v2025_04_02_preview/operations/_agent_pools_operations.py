...
def build_abort_latest_operation_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-04-02-preview"))
...
class AgentPoolsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2025_04_02_preview.ContainerServiceClient`'s
    ...
    def _abort_latest_operation_initial(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2025-04-02-preview")
        )
    ...
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> Iterable["_models.AgentPool"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPool
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPool
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPool or
         IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
    ...
    def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPoolUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_delete_machines(
        ...
        **kwargs: Any
        ...
        :type machines:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPoolDeleteMachinesParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
    ...
    def begin_delete_machines(
        ...
        **kwargs: Any
        ...
        :type machines:
         ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPoolDeleteMachinesParameter or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_available_agent_pool_versions(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_02_preview.models.AgentPoolAvailableVersions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,

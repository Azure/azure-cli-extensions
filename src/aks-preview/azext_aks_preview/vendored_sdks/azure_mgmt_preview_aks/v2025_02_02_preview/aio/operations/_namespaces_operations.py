...
class NamespacesOperations:
    ...
    def list_by_managed_cluster(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_02_02_preview.models.Namespace]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Namespace or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2025_02_02_preview.models.Namespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
def load_arguments(self, _):
    ...
    with self.argument_context('aks command') as c:
        c.argument('command_string', type=str, options_list=["--command_string"], help='the command to run')
        c.argument('context', type=str, options_list=["--context"], required=False, help='attach any files the command may use, or use \'.\' to upload the current folder.')

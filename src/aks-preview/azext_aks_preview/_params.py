...
def load_arguments(self, _):
    ...
    with self.argument_context('aks trustedaccess rolebinding create') as c:
        ...
        c.argument('source_resource_id', options_list=['--source-resource-id', '-r', c.deprecate(target='-s', redirect='--source-resource-id', expiration='2.47.0', hide=True)], help='The source resource id of the binding')

...
from azure.cli.core.commands.parameters import (
    file_type, get_resource_name_completion_list, get_three_state_flag, name_type, tags_type, zones_type,
    edge_zone_type, get_enum_type)
...
from ._consts import CONST_GPU_INSTANCE_PROFILE_MIG1_G, CONST_GPU_INSTANCE_PROFILE_MIG2_G, \
...
from ._consts import CONST_OUTBOUND_TYPE_LOAD_BALANCER, CONST_OUTBOUND_TYPE_USER_DEFINED_ROUTING, \
    ...
    CONST_RAPID_UPGRADE_CHANNEL, CONST_STABLE_UPGRADE_CHANNEL, CONST_PATCH_UPGRADE_CHANNEL, \
...
from ._validators import (
    ...
    validate_nodepool_name, validate_vm_set_type, validate_load_balancer_sku, validate_nodepool_id,
    validate_snapshot_id, validate_crg_id,
    ...
    validate_load_balancer_outbound_ports, validate_load_balancer_idle_timeout, validate_nat_gateway_idle_timeout,
    validate_nodepool_tags, validate_addon,
    validate_nodepool_labels, validate_vnet_subnet_id, validate_pod_subnet_id, validate_max_surge,
    validate_assign_identity, validate_addons,

...
class ResourceById(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServerlessRuntimesServerlessResourceById(ctx=self.ctx)()
    ...
    class ServerlessRuntimesServerlessResourceById(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ResourceByIdHelper._build_schema_cdi_config_props_read(cdi_config_props.Element)
            ...
            _ResourceByIdHelper._build_schema_cdi_config_props_read(cdie_config_props.Element)
...
class _ResourceByIdHelper:
    """Helper class for ResourceById"""

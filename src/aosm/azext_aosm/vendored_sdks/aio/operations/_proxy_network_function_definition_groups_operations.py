...
from ...operations._proxy_network_function_definition_groups_operations import build_get_request, build_list_by_publisher_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ProxyNetworkFunctionDefinitionGroupsOperations:
    """ProxyNetworkFunctionDefinitionGroupsOperations async operations.
    ...
    def list_by_publisher(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.NetworkFunctionDefinitionGroupOverviewListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~Microsoft.HybridNetwork.models.NetworkFunctionDefinitionGroupOverviewListResult]

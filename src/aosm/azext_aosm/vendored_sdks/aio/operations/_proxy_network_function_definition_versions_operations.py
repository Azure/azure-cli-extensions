...
from ...operations._proxy_network_function_definition_versions_operations import build_get_request, build_list_by_network_function_definition_group_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ProxyNetworkFunctionDefinitionVersionsOperations:
    """ProxyNetworkFunctionDefinitionVersionsOperations async operations.
    ...
    def list_by_network_function_definition_group(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.NetworkFunctionDefinitionVersionOverviewListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~Microsoft.HybridNetwork.models.NetworkFunctionDefinitionVersionOverviewListResult]

...
class HybridNetworkManagementClient(HybridNetworkManagementClientOperationsMixin):    # pylint: disable=too-many-instance-attributes
    ...
    :vartype preview_subscriptions:
     Microsoft.HybridNetwork.aio.operations.PreviewSubscriptionsOperations
    ...
    :vartype network_function_ready_k8_s:
     Microsoft.HybridNetwork.aio.operations.NetworkFunctionReadyK8SOperations
    ...
    :vartype proxy_publisher: Microsoft.HybridNetwork.aio.operations.ProxyPublisherOperations
    ...
    :vartype proxy_network_function_definition_groups:
     Microsoft.HybridNetwork.aio.operations.ProxyNetworkFunctionDefinitionGroupsOperations

...
def build_list_by_network_function_definition_group_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers/{proxyPublisherName}/networkFunctionDefinitionGroups/{networkFunctionDefinitionGroupName}/networkFunctionDefinitionVersions")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers/{proxyPublisherName}/networkFunctionDefinitionGroups/{networkFunctionDefinitionGroupName}/networkFunctionDefinitionVersions/{networkFunctionDefinitionVersionName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "proxyPublisherName": _SERIALIZER.url("proxy_publisher_name", proxy_publisher_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
        "networkFunctionDefinitionGroupName": _SERIALIZER.url("network_function_definition_group_name", network_function_definition_group_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
...
# fmt: on
class ProxyNetworkFunctionDefinitionVersionsOperations(object):
    ...
    def list_by_network_function_definition_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.NetworkFunctionDefinitionVersionOverviewListResult"]
        ...
        :return: An iterator like instance of either NetworkFunctionDefinitionVersionOverviewListResult
         or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~Microsoft.HybridNetwork.models.NetworkFunctionDefinitionVersionOverviewListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.NetworkFunctionDefinitionVersionOverviewListResult"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkFunctionDefinitionVersionOverviewListResult", pipeline_response)
    ...
    list_by_network_function_definition_group.metadata = {'url': "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers/{proxyPublisherName}/networkFunctionDefinitionGroups/{networkFunctionDefinitionGroupName}/networkFunctionDefinitionVersions"}  # type: ignore
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.NetworkFunctionDefinitionVersionOverview"
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkFunctionDefinitionVersionOverview, or the result of cls(response)
        :rtype: ~Microsoft.HybridNetwork.models.NetworkFunctionDefinitionVersionOverview
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.NetworkFunctionDefinitionVersionOverview"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers/{proxyPublisherName}/networkFunctionDefinitionGroups/{networkFunctionDefinitionGroupName}/networkFunctionDefinitionVersions/{networkFunctionDefinitionVersionName}"}  # type: ignore

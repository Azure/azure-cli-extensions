...
def build_list_by_location_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers")
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/proxyPublishers/{proxyPublisherName}")  # pylint: disable=line-too-long
    path_format_arguments = {
...
# fmt: on
class ProxyPublisherOperations(object):
    """ProxyPublisherOperations operations.
    ...
    def list_by_location(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ProxyPublisherOverviewListResult"]
        ...
        :return: An iterator like instance of either ProxyPublisherOverviewListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~Microsoft.HybridNetwork.models.ProxyPublisherOverviewListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ProxyPublisherOverview"

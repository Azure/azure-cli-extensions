...
class TestDefinitionFolderBuilder(TestCase):
    ...
    @patch("azext_aosm.definition_folder.reader.definition_folder.BicepDefinitionElement")
    @patch("azext_aosm.definition_folder.reader.definition_folder.ArtifactDefinitionElement")
    ...
    def test_deploy(self, mock_read_text, mock_artifact_element, mock_bicep_element):
        ...
        # Check that the elements were created and deployed in the expected order.
    ...
    @patch("azext_aosm.definition_folder.reader.definition_folder.ArtifactDefinitionElement")
    @patch("pathlib.Path.read_text")
    def test_delete_clean(self, mock_read_text, mock_artifact_element, mock_bicep_element):
        """Test creating and deploying a definition folder."""

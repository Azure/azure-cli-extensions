...
@register_command(
    "aosm publisher artifact-manifest update-state",
    is_preview=True,
)
class UpdateState(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ArtifactManifestsUpdateState(ctx=self.ctx)()
    ...
    class ArtifactManifestsUpdateState(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.artifact_manifest_state = AAZStrType(

...
@register_command(
    "aosm publisher artifact-manifest list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ArtifactManifestsListByArtifactStore(ctx=self.ctx)()
    ...
    class ArtifactManifestsListByArtifactStore(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            artifacts = cls._schema_on_200.value.Element.properties.artifacts
            artifacts.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.artifacts.Element

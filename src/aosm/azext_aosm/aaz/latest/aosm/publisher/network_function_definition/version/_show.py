...
@register_command(
    "aosm publisher network-function-definition version show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_function_definition_version_name = AAZStrArg(
            options=["-n", "--name", "--network-function-definition-version-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkFunctionDefinitionVersionsGet(ctx=self.ctx)()
    ...
    class NetworkFunctionDefinitionVersionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_containerized_network_function = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction")
            disc_containerized_network_function.network_function_template = AAZObjectType(
                serialized_name="networkFunctionTemplate",
            )

            network_function_template = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template
            network_function_template.nfvi_type = AAZStrType(
                serialized_name="nfviType",
                flags={"required": True},
            )

            disc_azure_arc_kubernetes = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes")
            disc_azure_arc_kubernetes.network_function_applications = AAZListType(
                serialized_name="networkFunctionApplications",
            )

            network_function_applications = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications
            network_function_applications.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element
            ...
            _ShowHelper._build_schema_depends_on_profile_read(_element.depends_on_profile)
            _element.name = AAZStrType()

            disc_helm_package = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage")
            ...
            artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage").artifact_profile
            artifact_profile.artifact_store = AAZObjectType(
                serialized_name="artifactStore",
            )
            _ShowHelper._build_schema_referenced_resource_read(artifact_profile.artifact_store)
            artifact_profile.helm_artifact_profile = AAZObjectType(
                serialized_name="helmArtifactProfile",
            )

            helm_artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage").artifact_profile.helm_artifact_profile
            ...
            options = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage").deploy_parameters_mapping_rule_profile.helm_mapping_rule_profile.options
            ...
            install_options = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage").deploy_parameters_mapping_rule_profile.helm_mapping_rule_profile.options.install_options
            install_options.atomic = AAZStrType()
            install_options.timeout = AAZStrType()
            install_options.wait = AAZStrType()

            upgrade_options = cls._schema_on_200.properties.discriminate_by("network_function_type", "ContainerizedNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureArcKubernetes").network_function_applications.Element.discriminate_by("artifact_type", "HelmPackage").deploy_parameters_mapping_rule_profile.helm_mapping_rule_profile.options.upgrade_options
            upgrade_options.atomic = AAZStrType()
            upgrade_options.timeout = AAZStrType()
            upgrade_options.wait = AAZStrType()

            disc_virtual_network_function = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction")
            disc_virtual_network_function.network_function_template = AAZObjectType(
                serialized_name="networkFunctionTemplate",
            )

            network_function_template = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template
            network_function_template.nfvi_type = AAZStrType(
                serialized_name="nfviType",
                flags={"required": True},
            )

            disc_azure_core = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore")
            disc_azure_core.network_function_applications = AAZListType(
                serialized_name="networkFunctionApplications",
            )

            network_function_applications = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications
            network_function_applications.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element
            _element.artifact_type = AAZStrType(
                serialized_name="artifactType",
                flags={"required": True},
            )
            ...
            disc_arm_template = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate")
            ...
            artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate").artifact_profile
            artifact_profile.artifact_store = AAZObjectType(
                serialized_name="artifactStore",
            )
            _ShowHelper._build_schema_referenced_resource_read(artifact_profile.artifact_store)
            ...
            _ShowHelper._build_schema_arm_template_artifact_profile_read(artifact_profile.template_artifact_profile)

            deploy_parameters_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate").deploy_parameters_mapping_rule_profile
            deploy_parameters_mapping_rule_profile.application_enablement = AAZStrType(
                serialized_name="applicationEnablement",
            )
            ...
            _ShowHelper._build_schema_arm_template_mapping_rule_profile_read(deploy_parameters_mapping_rule_profile.template_mapping_rule_profile)

            disc_vhd_image_file = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "VhdImageFile")
            ...
            artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "VhdImageFile").artifact_profile
            artifact_profile.artifact_store = AAZObjectType(
                serialized_name="artifactStore",
            )
            _ShowHelper._build_schema_referenced_resource_read(artifact_profile.artifact_store)
            ...
            vhd_artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "VhdImageFile").artifact_profile.vhd_artifact_profile
            ...
            deploy_parameters_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "VhdImageFile").deploy_parameters_mapping_rule_profile
            deploy_parameters_mapping_rule_profile.application_enablement = AAZStrType(
                serialized_name="applicationEnablement",
            )
            ...
            vhd_image_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureCore").network_function_applications.Element.discriminate_by("artifact_type", "VhdImageFile").deploy_parameters_mapping_rule_profile.vhd_image_mapping_rule_profile
            vhd_image_mapping_rule_profile.user_configuration = AAZStrType(
                serialized_name="userConfiguration",
            )

            disc_azure_operator_nexus = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus")
            disc_azure_operator_nexus.network_function_applications = AAZListType(
                serialized_name="networkFunctionApplications",
            )

            network_function_applications = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications
            network_function_applications.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element
            _element.artifact_type = AAZStrType(
                serialized_name="artifactType",
                flags={"required": True},
            )
            ...
            disc_arm_template = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate")
            disc_arm_template.artifact_profile = AAZObjectType(
                serialized_name="artifactProfile",
            )
            disc_arm_template.deploy_parameters_mapping_rule_profile = AAZObjectType(
            ...
            artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate").artifact_profile
            artifact_profile.artifact_store = AAZObjectType(
                serialized_name="artifactStore",
            )
            _ShowHelper._build_schema_referenced_resource_read(artifact_profile.artifact_store)
            ...
            deploy_parameters_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ArmTemplate").deploy_parameters_mapping_rule_profile
            deploy_parameters_mapping_rule_profile.application_enablement = AAZStrType(
                serialized_name="applicationEnablement",
            )
            deploy_parameters_mapping_rule_profile.template_mapping_rule_profile = AAZObjectType(
            ...
            disc_image_file = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ImageFile")
            ...
            artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ImageFile").artifact_profile
            artifact_profile.artifact_store = AAZObjectType(
                serialized_name="artifactStore",
            )
            _ShowHelper._build_schema_referenced_resource_read(artifact_profile.artifact_store)
            ...
            image_artifact_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ImageFile").artifact_profile.image_artifact_profile
            ...
            deploy_parameters_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ImageFile").deploy_parameters_mapping_rule_profile
            deploy_parameters_mapping_rule_profile.application_enablement = AAZStrType(
                serialized_name="applicationEnablement",
            )
            ...
            image_mapping_rule_profile = cls._schema_on_200.properties.discriminate_by("network_function_type", "VirtualNetworkFunction").network_function_template.discriminate_by("nfvi_type", "AzureOperatorNexus").network_function_applications.Element.discriminate_by("artifact_type", "ImageFile").deploy_parameters_mapping_rule_profile.image_mapping_rule_profile

...
class UpdateState(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.version_state = AAZStrArg(
            ...
            help="The network service design version state.",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkServiceDesignVersionsUpdateState(ctx=self.ctx)()
    ...
    class NetworkServiceDesignVersionsUpdateState(AAZHttpOperation):

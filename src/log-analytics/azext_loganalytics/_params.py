...
def load_arguments(self, _):
    with self.argument_context('monitor log-analytics query') as c:
        ...
        c.argument('timespan', options_list=['--timespan', '-t'],
                   help='Timespan over which to query. Defaults to querying all available data.')
        c.argument('workspaces', nargs='+', help='Additional workspaces to union data for querying. Please use '
                   'workspace CustomerId. Specify additional workspace CustomerIds separated by space.')

...
@register_command(
    "standby-pool standby-virtual-machine-pool standby-virtual-machine show",
)
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.standby_virtual_machine_name = AAZStrArg(
            options=["-n", "--name", "--standby-virtual-machine-name"],
            help="Name of the standby virtual machine",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.StandbyVirtualMachinesGet(ctx=self.ctx)()
    ...
    class StandbyVirtualMachinesGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "standbyVirtualMachineName", self.ctx.args.standby_virtual_machine_name,
                    required=True,
                ),
                **self.serialize_url_param(

    ...
    def validate(resource):
        ...
        match resourceSubType:
            case 'servers/databases':
                ...
                return ZoneRedundancyValidationResult.Yes if resource['properties']['zoneRedundant'] == True else ZoneRedundancyValidationResult.No

            case 'servers':
                # Zone Redundancy for SQL is set at the database level, see above

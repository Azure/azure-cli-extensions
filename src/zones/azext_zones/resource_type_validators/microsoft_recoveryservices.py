    ...
    def validate(resource):
        ...
        match resourceSubType:
            case 'vaults':
                ...
                return ZoneRedundancyValidationResult.Yes if resource['redundancySettings']['standardTierStorageRedundancy'] == 'ZoneRedundant' else ZoneRedundancyValidationResult.No

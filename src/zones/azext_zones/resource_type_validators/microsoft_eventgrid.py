...
class microsoft_eventgrid:
    ...
    def validate(resource):
        ...
        _logger.debug("Validating Microsoft.eventgrid resource type: %s", resourceSubType)

        # EventGrid resources are zone redundant by default
        # https://learn.microsoft.com/azure/reliability/reliability-event-grid#availability-zone-support return ZoneRedundancyValidationResult.Always

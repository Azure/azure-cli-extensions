    ...
    def validate(resource):
        ...
        match resourceSubType:
            case 'databaseaccounts':
                ...
                # CosmosDB databases are zone redundant if then have the setting enabled on the region
                return ZoneRedundancyValidationResult.Yes if resource['properties']['locations'][0]['isZoneRedundant'] else ZoneRedundancyValidationResult.No                

...
from ...operations._vmm_servers_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request_initial
T = TypeVar('T')
...
class VmmServersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VMMServer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~scvmm.models.VMMServer]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-06-05-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.VMMServerListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~scvmm.models.VMMServerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-06-05-preview")  # type: str

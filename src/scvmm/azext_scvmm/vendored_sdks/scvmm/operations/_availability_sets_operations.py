...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/availabilitySets/{availabilitySetName}")  # pylint: disable=line-too-long
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either AvailabilitySet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~scvmm.models.AvailabilitySet]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AvailabilitySetListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~scvmm.models.AvailabilitySetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str

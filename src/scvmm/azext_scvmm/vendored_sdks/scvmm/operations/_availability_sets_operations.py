...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/availabilitySets")
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/availabilitySets")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_request(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    availability_set_resource_name,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-10-07")  # type: str
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/availabilitySets/{availabilitySetResourceName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "availabilitySetResourceName": _SERIALIZER.url("availability_set_resource_name", availability_set_resource_name, 'str', max_length=54, min_length=1, pattern=r'[a-zA-Z0-9-_\.]'),
    }
...
class AvailabilitySetsOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AvailabilitySetListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.scvmm.models.AvailabilitySetListResult]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        availability_set_resource_name,  # type: str
        resource,  # type: "_models.AvailabilitySet"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AvailabilitySet"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AvailabilitySet"]
        ...
        _json = self._serialize.body(resource, 'AvailabilitySet')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AvailabilitySet"]
        ...
        :return: An instance of LROPoller that returns either AvailabilitySet or the result of
         cls(response)
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        availability_set_resource_name,  # type: str
        properties,  # type: "_models.AvailabilitySetTagsUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.AvailabilitySet"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.AvailabilitySet"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        _json = self._serialize.body(properties, 'AvailabilitySetTagsUpdate')

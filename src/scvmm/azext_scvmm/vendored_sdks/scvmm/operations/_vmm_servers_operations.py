...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/vmmServers')
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/vmmServers')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/vmmServers/{vmmServerName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
...
class VmmServersOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VmmServerListResult"]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        vmm_server_name,  # type: str
        resource,  # type: "_models.VmmServer"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VmmServer"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VmmServer"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VmmServer"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        vmm_server_name,  # type: str
        properties,  # type: "_models.VmmServerTagsUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.VmmServer"]

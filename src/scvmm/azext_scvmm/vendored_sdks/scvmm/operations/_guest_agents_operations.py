...
def build_list_by_virtual_machine_instance_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents/default')
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, 'str', skip_quote=True),
    }

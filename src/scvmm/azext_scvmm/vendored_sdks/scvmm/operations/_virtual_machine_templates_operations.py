...
class VirtualMachineTemplatesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~scvmm.models.VirtualMachineTemplate
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        virtual_machine_template_name,  # type: str
        body,  # type: "_models.VirtualMachineTemplate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineTemplate"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualMachineTemplate"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~scvmm.models.VirtualMachineTemplate
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either VirtualMachineTemplate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~scvmm.models.VirtualMachineTemplate]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either VirtualMachineTemplateListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~scvmm.models.VirtualMachineTemplateListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str

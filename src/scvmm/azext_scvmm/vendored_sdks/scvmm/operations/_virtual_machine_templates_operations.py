...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/virtualMachineTemplates')
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates/{virtualMachineTemplateName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "virtualMachineTemplateName": _SERIALIZER.url("virtual_machine_template_name", virtual_machine_template_name, 'str', max_length=54, min_length=1, pattern=r'[a-zA-Z0-9-_\.]'),
    }
...
class VirtualMachineTemplatesOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualMachineTemplateListResult"]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        virtual_machine_template_name,  # type: str
        resource,  # type: "_models.VirtualMachineTemplate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineTemplate"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualMachineTemplate"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        virtual_machine_template_name,  # type: str
        properties,  # type: "_models.VirtualMachineTemplateTagsUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.VirtualMachineTemplate"]

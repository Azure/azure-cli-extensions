...
from ...operations._virtual_machine_instances_operations import build_create_checkpoint_request_initial, build_create_or_update_request_initial, build_delete_checkpoint_request_initial, build_delete_request_initial, build_get_request, build_list_request, build_restart_request_initial, build_restore_checkpoint_request_initial, build_start_request_initial, build_stop_request_initial, build_update_request_initial
T = TypeVar('T')
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualMachineInstance or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~scvmm.models.VirtualMachineInstance]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]

...
from ...operations._hybrid_identity_metadatas_operations import build_create_request, build_delete_request, build_get_request, build_list_by_vm_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class HybridIdentityMetadatasOperations:
    """HybridIdentityMetadatasOperations async operations.
    ...
    def list_by_vm(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either HybridIdentityMetadataList or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~scvmm.models.HybridIdentityMetadataList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-04-01-preview")  # type: str

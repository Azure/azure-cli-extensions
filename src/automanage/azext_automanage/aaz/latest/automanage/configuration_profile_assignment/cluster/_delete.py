...
@register_command(
    "automanage configuration-profile-assignment cluster delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationProfileHCIAssignmentsDelete(ctx=self.ctx)()
    ...
    class ConfigurationProfileHCIAssignmentsDelete(AAZHttpOperation):

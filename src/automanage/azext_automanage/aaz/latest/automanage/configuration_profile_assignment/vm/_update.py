...
@register_command(
    "automanage configuration-profile-assignment vm update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        self.ConfigurationProfileAssignmentsCreateOrUpdate(ctx=self.ctx)()
    ...
    class ConfigurationProfileAssignmentsCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

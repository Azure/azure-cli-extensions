...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServicePrincipalsListBySubscription(ctx=self.ctx)()
    ...
    class ServicePrincipalsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.authorization_set = AAZBoolType(
                serialized_name="authorizationSet",
                flags={"read_only": True},
            )
            properties.service_principal_id = AAZStrType(
                serialized_name="servicePrincipalId",
                flags={"read_only": True},
            )

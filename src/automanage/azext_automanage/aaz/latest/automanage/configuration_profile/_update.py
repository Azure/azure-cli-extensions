...
@register_command(
    "automanage configuration-profile update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.configuration_profile_name = AAZStrArg(
            options=["-n", "--name", "--configuration-profile-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationProfilesGet(ctx=self.ctx)()
        self.pre_instance_update(self.ctx.vars.instance)
        self.InstanceUpdateByJson(ctx=self.ctx)()
        self.InstanceUpdateByGeneric(ctx=self.ctx)()
        self.post_instance_update(self.ctx.vars.instance)
        self.ConfigurationProfilesCreateOrUpdate(ctx=self.ctx)()
    ...
    class ConfigurationProfilesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_configuration_profile_read(cls._schema_on_200)

            return cls._schema_on_200

    class ConfigurationProfilesCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _build_schema_configuration_profile_read(cls._schema_on_200_201)
...
def _build_schema_configuration_profile_read(_schema):
    global _schema_configuration_profile_read
    if _schema_configuration_profile_read is not None:
    ...
    _schema_configuration_profile_read = AAZObjectType()

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ConfigurationProfilesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.ConfigurationProfilesListBySubscription(ctx=self.ctx)()
    ...
    class ConfigurationProfilesListByResourceGroup(AAZHttpOperation):
    ...
    class ConfigurationProfilesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
class AccessPoliciesOperations(object):
    ...
    def create_or_update(
        ...
        parameters,  # type: "models.AccessPolicyCreateOrUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AccessPolicyResource"
        ...
        :type parameters: ~time_series_insights_client.models.AccessPolicyCreateOrUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AccessPolicyResource, or the result of cls(response)
        :rtype: ~time_series_insights_client.models.AccessPolicyResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AccessPolicyResource"]
        error_map = {
    ...
    def update(
        ...
        environment_name,  # type: str
        access_policy_name,  # type: str
        access_policy_update_parameters,  # type: "models.AccessPolicyUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AccessPolicyResource"
        ...
        :type access_policy_update_parameters: ~time_series_insights_client.models.AccessPolicyUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AccessPolicyResource, or the result of cls(response)
        :rtype: ~time_series_insights_client.models.AccessPolicyResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_environment(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.AccessPolicyListResponse"
        ...
        :rtype: ~time_series_insights_client.models.AccessPolicyListResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AccessPolicyListResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class TimeSeriesInsightsClient(object):
    ...
    :vartype operations: time_series_insights_client.aio.operations.Operations
    :ivar environments: EnvironmentsOperations operations
    :vartype environments: time_series_insights_client.aio.operations.EnvironmentsOperations
    :ivar event_sources: EventSourcesOperations operations
    :vartype event_sources: time_series_insights_client.aio.operations.EventSourcesOperations
    :ivar reference_data_sets: ReferenceDataSetsOperations operations
    :vartype reference_data_sets: time_series_insights_client.aio.operations.ReferenceDataSetsOperations
    :ivar access_policies: AccessPoliciesOperations operations
    :vartype access_policies: time_series_insights_client.aio.operations.AccessPoliciesOperations

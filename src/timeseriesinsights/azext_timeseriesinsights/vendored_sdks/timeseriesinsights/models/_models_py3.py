...
class AccessPolicyCreateOrUpdateParameters(msrest.serialization.Model):
    ...
    :type roles: list[str or ~time_series_insights_client.models.AccessPolicyRole]
    """
...
class AccessPolicyListResponse(msrest.serialization.Model):
    ...
    :type value: list[~time_series_insights_client.models.AccessPolicyResource]
    """
...
class ResourceProperties(msrest.serialization.Model):
    ...
    :vartype provisioning_state: str or ~time_series_insights_client.models.ProvisioningState
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~time_series_insights_client.models.CloudErrorBody]
    """
...
class EnvironmentCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    :param kind: Required. The kind of the environment.Constant filled by server.  Possible values
     include: "Gen1", "Gen2".
    :type kind: str or ~time_series_insights_client.models.EnvironmentKind
    ...
    :type sku: ~time_series_insights_client.models.Sku
    """
...
class EnvironmentListResponse(msrest.serialization.Model):
    ...
    :type value: list[~time_series_insights_client.models.EnvironmentResource]
    """
...
class EnvironmentResource(TrackedResource):
    ...
    :param kind: Required. The kind of the environment.Constant filled by server.  Possible values
     include: "Gen1", "Gen2".
    :type kind: str or ~time_series_insights_client.models.EnvironmentResourceKind
    """
...
class EnvironmentResourceProperties(ResourceProperties):
    ...
    :vartype status: ~time_series_insights_client.models.EnvironmentStatus
    """
...
class EnvironmentStatus(msrest.serialization.Model):
    ...
    :vartype ingress: ~time_series_insights_client.models.IngressEnvironmentStatus
    :ivar warm_storage: An object that represents the status of warm storage on an environment.
    :vartype warm_storage: ~time_series_insights_client.models.WarmStorageEnvironmentStatus
    """
...
class EventSourceCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    :type kind: str or ~time_series_insights_client.models.EventSourceKind
    ...
    :type local_timestamp: ~time_series_insights_client.models.LocalTimestamp
    """
...
class EventSourceResource(TrackedResource):
    ...
    :param kind: Required. The kind of the event source.Constant filled by server.  Possible values
     include: "Microsoft.EventHub", "Microsoft.IoTHub".
    :type kind: str or ~time_series_insights_client.models.EventSourceResourceKind
    """
...
class EventSourceListResponse(msrest.serialization.Model):
    ...
    :type value: list[~time_series_insights_client.models.EventSourceResource]
    """
...
class Gen1EnvironmentCreateOrUpdateParameters(EnvironmentCreateOrUpdateParameters):
    ...
    :type partition_key_properties: list[~time_series_insights_client.models.TimeSeriesIdProperty]
    """
...
class Gen2EnvironmentCreateOrUpdateParameters(EnvironmentCreateOrUpdateParameters):
    ...
    :type time_series_id_properties: list[~time_series_insights_client.models.TimeSeriesIdProperty]
    ...
    :type storage_configuration: ~time_series_insights_client.models.Gen2StorageConfigurationInput
...
class Gen2EnvironmentResource(EnvironmentResource):
    ...
    :param storage_configuration: Required. The storage configuration provides the connection
     details that allows the Time Series Insights service to connect to the customer storage account
     that is used to store the environment's data.
    :type storage_configuration: ~time_series_insights_client.models.Gen2StorageConfigurationOutput
    :param warm_store_configuration: The warm store configuration provides the details to create a
     warm store cache that will retain a copy of the environment's data available for faster query.
    :type warm_store_configuration:
     ~time_series_insights_client.models.WarmStoreConfigurationProperties
...
class Gen2EnvironmentUpdateParameters(EnvironmentUpdateParameters):
    ...
    :type storage_configuration:
     ~time_series_insights_client.models.Gen2StorageConfigurationMutableProperties
    :param warm_store_configuration: The warm store configuration provides the details to create a
     warm store cache that will retain a copy of the environment's data available for faster query.
    :type warm_store_configuration:
     ~time_series_insights_client.models.WarmStoreConfigurationProperties
...
class IngressEnvironmentStatus(msrest.serialization.Model):
    ...
    :type state: str or ~time_series_insights_client.models.IngressState
    :ivar state_details: An object that contains the details about an environment's state.
    :vartype state_details: ~time_series_insights_client.models.EnvironmentStateDetails
    """
...
class LocalTimestamp(msrest.serialization.Model):
    ...
    :type format: str or ~time_series_insights_client.models.LocalTimestampFormat
    ...
    :type time_zone_offset: ~time_series_insights_client.models.LocalTimestampTimeZoneOffset
    """
...
class Operation(msrest.serialization.Model):
    ...
    :ivar display: Contains the localized display information for this particular operation /
     action.
    :vartype display: ~time_series_insights_client.models.OperationDisplay
    """
...
class OperationListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~time_series_insights_client.models.Operation]
...
class ReferenceDataSetCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    :type data_string_comparison_behavior: str or
     ~time_series_insights_client.models.DataStringComparisonBehavior
    """
...
class ReferenceDataSetKeyProperty(msrest.serialization.Model):
    ...
    :param type: The type of the key property. Possible values include: "String", "Double", "Bool",
     "DateTime".
    :type type: str or ~time_series_insights_client.models.ReferenceDataKeyPropertyType
    """
...
class ReferenceDataSetListResponse(msrest.serialization.Model):
    ...
    :type value: list[~time_series_insights_client.models.ReferenceDataSetResource]
    """
...
class Sku(msrest.serialization.Model):
    ...
    :type name: str or ~time_series_insights_client.models.SkuName
...
class TimeSeriesIdProperty(msrest.serialization.Model):
    ...
    :type type: str or ~time_series_insights_client.models.PropertyType
    """
...
class WarmStorageEnvironmentStatus(msrest.serialization.Model):
    ...
    :type state: str or ~time_series_insights_client.models.WarmStoragePropertiesState

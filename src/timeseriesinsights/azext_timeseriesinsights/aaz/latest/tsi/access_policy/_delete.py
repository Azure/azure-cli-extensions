...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.access_policy_name = AAZStrArg(
            ...
            help="The name of the Time Series Insights access policy associated with the specified environment.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessPoliciesDelete(ctx=self.ctx)()

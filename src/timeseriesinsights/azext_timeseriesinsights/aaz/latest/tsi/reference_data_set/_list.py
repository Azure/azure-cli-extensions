...
class List(AAZCommand):
    ...
    :example: ReferenceDataSetsListByEnvironment
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReferenceDataSetsListByEnvironment(ctx=self.ctx)()
    ...
    class ReferenceDataSetsListByEnvironment(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            key_properties = cls._schema_on_200.value.Element.properties.key_properties
            key_properties.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.key_properties.Element
            _element.name = AAZStrType()
            _element.type = AAZStrType()

...
@register_command(
    "workload-orchestration target solution create",
    is_preview=True,
)
class Create(AAZCommand):
    ...
    class SolutionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            available_solution_template_versions = cls._schema_on_200_201.properties.available_solution_template_versions
            available_solution_template_versions.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.available_solution_template_versions.Element

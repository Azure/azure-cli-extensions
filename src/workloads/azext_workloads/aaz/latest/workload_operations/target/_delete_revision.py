...
@register_command(
    "workload-operations target delete-revision",
    is_preview=True,
)
class DeleteRevision(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/targets/{}/deleterevision", "2025-01-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.TargetsDeleteRevision(ctx=self.ctx)()
    ...
    class TargetsDeleteRevision(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/targets/{targetName}/deleteRevision",
                **self.url_parameters
            )
...
class _DeleteRevisionHelper:
    """Helper class for DeleteRevision"""


__all__ = ["DeleteRevision"]

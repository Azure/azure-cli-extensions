...
@register_command(
    "workload-operations target solution version list",
    is_preview=True,
)
    ...
    class SolutionVersionsListBySolution(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/targets/{targetName}/solutions/{solutionName}/versions",
                **self.url_parameters
            )

...
@register_command(
    "workload-operations config-template delete-version",
    is_preview=True,
)
class DeleteVersion(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.edge/configtemplates/{}/deleteversion", "2025-01-01-preview"],
        ]
    }

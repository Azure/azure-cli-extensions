...
@register_command(
    "workload-operations workflow version execution list",
    is_preview=True,
)
    ...
    class ExecutionsListByWorkflowVersion(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/workflows/{workflowName}/versions/{versionName}/executions",
                **self.url_parameters
            )

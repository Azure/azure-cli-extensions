...
@register_command(
    "workload-orchestration solution-template version deprecate",
    is_preview=True,
)
class Deprecate(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SolutionTemplateVersionsDeprecate(ctx=self.ctx)()
    ...
    class SolutionTemplateVersionsDeprecate(AAZHttpOperation):

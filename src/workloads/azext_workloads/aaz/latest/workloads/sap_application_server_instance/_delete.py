...
@register_command(
    "workloads sap-application-server-instance delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SAPApplicationServerInstancesDelete(ctx=self.ctx)()
    ...
    class SAPApplicationServerInstancesDelete(AAZHttpOperation):

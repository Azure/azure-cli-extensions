...
class Show(AAZCommand):
    ...
    :example: Show workloads monitor sap landscape monitor
    ...
    class SapLandscapeMonitorGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            grouping = cls._schema_on_200.properties.grouping
            grouping.landscape = AAZListType()
            grouping.sap_application = AAZListType(
                serialized_name="sapApplication",
            )

            landscape = cls._schema_on_200.properties.grouping.landscape
            landscape.Element = AAZObjectType()
            _ShowHelper._build_schema_sap_landscape_monitor_sid_mapping_read(landscape.Element)

            sap_application = cls._schema_on_200.properties.grouping.sap_application
            sap_application.Element = AAZObjectType()
            _ShowHelper._build_schema_sap_landscape_monitor_sid_mapping_read(sap_application.Element)

            top_metrics_thresholds = cls._schema_on_200.properties.top_metrics_thresholds
            top_metrics_thresholds.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.top_metrics_thresholds.Element

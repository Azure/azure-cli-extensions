...
@register_command(
    "workloads monitor provider-instance delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete a provider instance for the specified subscription, resource group, SAP monitor name, and resource name.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ProviderInstancesDelete(ctx=self.ctx)()
    ...
    class ProviderInstancesDelete(AAZHttpOperation):

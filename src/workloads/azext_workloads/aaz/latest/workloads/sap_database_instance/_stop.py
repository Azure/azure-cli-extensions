...
class Stop(AAZCommand):
    ...
    :example: Stop Database instance of the SAP system with Virtual Machine: Currently stop action is supported for SAP HANA Database only.
    ...
    :example: Soft Stop Database instance of the SAP system: Currently stop action is supported for SAP HANA Database only.

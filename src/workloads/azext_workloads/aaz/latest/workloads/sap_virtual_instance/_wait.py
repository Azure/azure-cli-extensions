...
@register_command(
    "workloads sap-virtual-instance wait",
)
class Wait(AAZWaitCommand):
    ...
    class SAPVirtualInstancesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_infrastructure_configuration_read(disc_deployment.infrastructure_configuration)
            disc_deployment.software_configuration = AAZObjectType(
                serialized_name="softwareConfiguration",
            )
            _WaitHelper._build_schema_software_configuration_read(disc_deployment.software_configuration)
            ...
            _WaitHelper._build_schema_infrastructure_configuration_read(disc_deployment_with_os_config.infrastructure_configuration)
            ...
            _WaitHelper._build_schema_software_configuration_read(disc_deployment_with_os_config.software_configuration)

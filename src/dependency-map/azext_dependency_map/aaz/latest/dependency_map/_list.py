...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.MapsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.MapsListByResourceGroup(ctx=self.ctx)()
    ...
    class MapsListBySubscription(AAZHttpOperation):
    ...
    class MapsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

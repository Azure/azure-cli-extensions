...
class GetDependencyViewForFocusedMachine(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MapsGetDependencyViewForFocusedMachine(ctx=self.ctx)()
    ...
    class MapsGetDependencyViewForFocusedMachine(AAZHttpOperation):
...
class _GetDependencyViewForFocusedMachineHelper:
    """Helper class for GetDependencyViewForFocusedMachine"""


__all__ = ["GetDependencyViewForFocusedMachine"]

...
@register_command(
    "dependency-map discovery-source create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.source_id = AAZStrArg(
            ...
            help="Source ArmId of Discovery Source resource",
        )
        _args_schema.source_type = AAZStrArg(
            options=["--source-type"],
            arg_group="Properties",
            help="Source type of Discovery Source resource.",
            enum={"OffAzure": "OffAzure"},
        )
    ...
    class DiscoverySourcesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("sourceType", AAZStrType, ".source_type", typ_kwargs={"flags": {"required": True}})

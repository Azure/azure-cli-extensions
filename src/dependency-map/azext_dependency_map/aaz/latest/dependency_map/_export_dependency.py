...
class ExportDependency(AAZCommand):
    ...
    :example: Export dependencies
        az dependency-map export-dependency --resource-group rgdependencyMap --map-name mapsTest1 --focused-machine-id qzjpilzxpurauwfwwanpiiafvz
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MapsExportDependencies(ctx=self.ctx)()
    ...
    class MapsExportDependencies(AAZHttpOperation):
...
class _ExportDependencyHelper:
    """Helper class for ExportDependency"""


__all__ = ["ExportDependency"]

...
class GetConnectionsForProcessOnFocusedMachine(AAZCommand):
    ...
    :example: Get network connections of a process
        az dependency-map get-connections-for-process-on-focused-machine --resource-group rgdependencyMap --map-name mapsTest1 --focused-machine-id abjy --process-id-on-focused-machine yzldgsfupsfvzlztqoqpiv --start-date-time-utc 2024-03-29T07:35:15.336Z --end-date-time-utc 2024-03-29T07:35:15.336Z
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.process_id_on_focused_machine = AAZStrArg(
            options=["--process-mid", "--process-id-on-focused-machine"],
            arg_group="Body",
            help="Process id",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MapsGetConnectionsForProcessOnFocusedMachine(ctx=self.ctx)()
    ...
    class MapsGetConnectionsForProcessOnFocusedMachine(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("processIdOnFocusedMachine", AAZStrType, ".process_id_on_focused_machine", typ_kwargs={"flags": {"required": True}})
...
class _GetConnectionsForProcessOnFocusedMachineHelper:
    """Helper class for GetConnectionsForProcessOnFocusedMachine"""


__all__ = ["GetConnectionsForProcessOnFocusedMachine"]

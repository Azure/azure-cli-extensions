...
class List(AAZCommand):
    ...
    :example: List all dashboards in a subscription
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.DashboardsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.DashboardsListByResourceGroup(ctx=self.ctx)()
    ...
    class DashboardsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            lenses = cls._schema_on_200.value.Element.properties.lenses
            lenses.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.lenses.Element
            ...
            parts = cls._schema_on_200.value.Element.properties.lenses.Element.parts
    ...
    class DashboardsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

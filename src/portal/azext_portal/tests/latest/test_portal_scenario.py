...
def step__dashboards_put_create_or_update_a_dashboard(test, rg):
    test.cmd('az portal dashboard create '
             ...
             checks=[
                 ...
                 test.check("lenses.aLens.order", 1),
                 test.check("lenses.aLens.parts.aPart.position.colSpan", 3),
                 test.check("lenses.aLens.parts.aPart.position.rowSpan", 4),
                 test.check("lenses.aLens.parts.aPart.position.x", 1),
                 test.check("lenses.aLens.parts.aPart.position.y", 2),
                 test.check("lenses.aLens.parts.bPart.position.colSpan", 6),
                 test.check("lenses.aLens.parts.bPart.position.rowSpan", 6),
                 test.check("lenses.aLens.parts.bPart.position.x", 5),
                 test.check("lenses.aLens.parts.bPart.position.y", 5),
                 test.check("lenses.bLens.order", 2),
                 test.check("lenses.bLens.parts.", {}),

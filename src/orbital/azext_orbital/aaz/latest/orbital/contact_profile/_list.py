...
class List(AAZCommand):
    ...
    :example: List Contact Profiles by resource group
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ContactProfilesList(ctx=self.ctx)()
        if condition_1:
            self.ContactProfilesListBySubscription(ctx=self.ctx)()
    ...
    class ContactProfilesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            channels = cls._schema_on_200.value.Element.properties.links.Element.channels
            channels.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.links.Element.channels.Element
            ...
            end_point = cls._schema_on_200.value.Element.properties.links.Element.channels.Element.end_point
    ...
    class ContactProfilesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
def load_arguments(self, _):
    ...
    with self.argument_context('search-scenario') as c:
        c.positional('search_keyword', help="Keywords for search. If there are multiple keywords, please separate them with spaces. Fuzzy search is supported, and the returned results are sorted by keyword matching degree.")

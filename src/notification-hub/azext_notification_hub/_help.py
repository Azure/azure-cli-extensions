    ...
    examples:
      - name: Create a namespace
        text: |-
               ...
               nk-sdk-ns --location "South Central US" --sku Standard
"""
    ...
    examples:
      - name: List keys of the namesapce authorization rule
        text: |-
               ...
               nk-sdk-ns --name "RootManageSharedAccessKey"
"""
    ...
    examples:
      - name: Regenerate keys of the namesapce authorization rule
        text: |-
               ...
               nk-sdk-ns --name "RootManageSharedAccessKey" --policy-key "Secondary Key"
"""
    ...
    examples:
      - name: Show namespace authorization rule info
        text: |-
               ...
               --namespace-name nk-sdk-ns --name "RootManageSharedAccessKey"
"""
    ...
    examples:
      - name: Create a namespace authorization rule
        text: |-
               ...
               MyResourceGroup --namespace-name nk-sdk-ns --name "sdk-AuthRules-1788" --rights Listen Send
"""
...
helps['notification-hub create'] = """
    ...
    examples:
      - name: Create a Notification Hub
        text: |-
               az notification-hub create --resource-group MyResourceGroup --namespace-name nk-sdk-ns \\
               --name nk-sdk-hub --location "South Central US" --sku "Free"
"""
    ...
    examples:
      - name: Update the Notification Hub
        text: |-
               ...
               nk-sdk-ns --name "sdk-notificationHubs-8708"
"""
...
helps['notification-hub delete'] = """
    ...
    examples:
      - name: Delete a notification hub
        text: |-
               az notification-hub delete --resource-group MyResourceGroup --namespace-name nk-sdk-ns \\
               --name nk-sdk-hub
"""
...
helps['notification-hub show'] = """
    ...
    examples:
      - name: Show the Notification Hub info
        text: |-
               az notification-hub show --resource-group MyResourceGroup --namespace-name nk-sdk-ns \\
               --name nk-sdk-hub
"""
...
helps['notification-hub list'] = """
    ...
    examples:
      - name: List the notification hubs
        text: |-
               az notification-hub list --resource-group MyResourceGroup --namespace-name nk-sdk-ns
"""
    ...
    examples:
      - name: Check the availability of the given notificationHub name
        text: |-
               ...
               --namespace-name "locp-newns" --name nk-sdk-hub
"""
    ...
    examples:
      - name: Regenerate the Notification Hub authorization rule
        text: |-
               ...
               nk-sdk-ns --notification-hub-name nk-sdk-hub --name \\
    ...
    examples:
      - name: List the PNS Credentials
        text: |-
               ...
               nk-sdk-ns --notification-hub-name nk-sdk-hub
"""
...
helps['notification-hub authorization-rule list-keys'] = """
    ...
    examples:
      - name: List connectionStrings of the authorization rule
        text: |-
               az notification-hub authorization-rule list-keys --resource-group MyResourceGroup --namespace-name nk-sdk-ns \\
               --notification-hub-name nk-sdk-hub --name "sdk-AuthRules-5800"
"""
    ...
    examples:
      - name: test send notification with message body
        text: |-
               ...
               nk-sdk-ns --notification-hub-name nk-sdk-hub --notification-format gcm \\
    ...
    examples:
      - name: List authorization rules
        text: |-
               ...
               --namespace-name nk-sdk-ns --notification-hub-name nk-sdk-hub
"""
    ...
    examples:
      - name: Show the authorization rule information
        text: |-
               ...
               --namespace-name nk-sdk-ns --notification-hub-name nk-sdk-hub --name \\
    ...
    examples:
      - name: Update gcm key
        text: |-
               ...
               --namespace-name nk-sdk-ns --notification-hub-name nk-sdk-hub --google-api-key \\
               "xxxxxxxxx"
"""
...
helps['notification-hub credential apns update'] = """
    ...
    examples:
      - name: Update APNS certificate
        text: |-
               az notification-hub credential apns update --namespace-name nk-sdk-ns \\
               --notification-hub-name nk-sdk-hub --apns-certificate "/path/to/certificate" \\

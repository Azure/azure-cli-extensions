...
class CheckAvailability(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NotificationHubsCheckNotificationHubAvailability(ctx=self.ctx)()
...
class _CheckAvailabilityHelper:
    """Helper class for CheckAvailability"""

...
class TestSend(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NotificationHubsDebugSend(ctx=self.ctx)()
    ...
    class NotificationHubsDebugSend(AAZHttpOperation):
        ...
        def _build_schema_on_201(cls):
            ...
            _schema_on_201.sku = AAZObjectType()
            ...
            properties.failure = AAZFloatType()
            properties.success = AAZFloatType()

            sku = cls._schema_on_201.sku
...
class _TestSendHelper:
    """Helper class for TestSend"""

...
@register_command(
    "network cross-connection summarize-route-table",
)
class SummarizeRouteTable(AAZCommand):
...
class _SummarizeRouteTableHelper:
    """Helper class for SummarizeRouteTable"""


__all__ = ["SummarizeRouteTable"]

...
class Create(AAZCommand):
    ...
    def _build_args_express_route_circuit_peering_config_create(cls, _schema):
        if cls._args_express_route_circuit_peering_config_create is not None:
            ...
            _schema.advertised_public_prefixes_state = cls._args_express_route_circuit_peering_config_create.advertised_public_prefixes_state
        ...
        express_route_circuit_peering_config_create.advertised_public_prefixes_state = AAZStrArg(
    ...
    _args_ipv6_express_route_circuit_peering_config_create = None

    @classmethod
    def _build_args_ipv6_express_route_circuit_peering_config_create(cls, _schema):
        if cls._args_ipv6_express_route_circuit_peering_config_create is not None:
            _schema.microsoft_peering_config = cls._args_ipv6_express_route_circuit_peering_config_create.microsoft_peering_config
            _schema.primary_peer_address_prefix = cls._args_ipv6_express_route_circuit_peering_config_create.primary_peer_address_prefix
            _schema.route_filter = cls._args_ipv6_express_route_circuit_peering_config_create.route_filter
            _schema.secondary_peer_address_prefix = cls._args_ipv6_express_route_circuit_peering_config_create.secondary_peer_address_prefix
            _schema.state = cls._args_ipv6_express_route_circuit_peering_config_create.state
            return

        cls._args_ipv6_express_route_circuit_peering_config_create = AAZObjectArg()

        ipv6_express_route_circuit_peering_config_create = cls._args_ipv6_express_route_circuit_peering_config_create
        ipv6_express_route_circuit_peering_config_create.microsoft_peering_config = AAZObjectArg(
            options=["microsoft-peering-config"],
        )
        cls._build_args_express_route_circuit_peering_config_create(ipv6_express_route_circuit_peering_config_create.microsoft_peering_config)
        ipv6_express_route_circuit_peering_config_create.primary_peer_address_prefix = AAZStrArg(
            options=["primary-peer-address-prefix"],
        )
        ipv6_express_route_circuit_peering_config_create.route_filter = AAZObjectArg(
            options=["route-filter"],
        )
        cls._build_args_route_filter_create(ipv6_express_route_circuit_peering_config_create.route_filter)
        ipv6_express_route_circuit_peering_config_create.secondary_peer_address_prefix = AAZStrArg(
            options=["secondary-peer-address-prefix"],
        )
        ipv6_express_route_circuit_peering_config_create.state = AAZStrArg(
            options=["state"],
    ...
    _args_route_filter_create = None

    @classmethod
    def _build_args_route_filter_create(cls, _schema):
        if cls._args_route_filter_create is not None:
            _schema.id = cls._args_route_filter_create.id
            _schema.location = cls._args_route_filter_create.location
            _schema.peerings = cls._args_route_filter_create.peerings
            _schema.rules = cls._args_route_filter_create.rules
            _schema.tags = cls._args_route_filter_create.tags
            return

        cls._args_route_filter_create = AAZObjectArg()

        route_filter_create = cls._args_route_filter_create
        route_filter_create.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/routeFilters/{}",
            ),
        )
        route_filter_create.location = AAZResourceLocationArg(
            options=["l", "location"],
            required=True,
        ...
        route_filter_create.peerings = AAZListArg(
            options=["peerings"],
        )
        route_filter_create.rules = AAZListArg(
            options=["rules"],
        )
        route_filter_create.tags = AAZDictArg(
            options=["tags"],
        )

        peerings = cls._args_route_filter_create.peerings
        peerings.Element = AAZObjectArg()

        _element = cls._args_route_filter_create.peerings.Element
        ...
        cls._build_args_ipv6_express_route_circuit_peering_config_create(_element.ipv6_peering_config)
        ...
        cls._build_args_express_route_circuit_peering_config_create(_element.microsoft_peering_config)
        ...
        cls._build_args_route_filter_create(_element.route_filter)
        ...
        connections = cls._args_route_filter_create.peerings.Element.connections
        connections.Element = AAZObjectArg()

        _element = cls._args_route_filter_create.peerings.Element.connections.Element
        _element.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
        ...
        cls._build_args_sub_resource_create(_element.express_route_circuit_peering)
        _element.peer_express_route_circuit_peering = AAZObjectArg(
            options=["peer-express-route-circuit-peering"],
        )
        cls._build_args_sub_resource_create(_element.peer_express_route_circuit_peering)

        stats = cls._args_route_filter_create.peerings.Element.stats
        ...
        rules = cls._args_route_filter_create.rules
        rules.Element = AAZObjectArg()

        _element = cls._args_route_filter_create.rules.Element
        _element.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
        ...
        communities = cls._args_route_filter_create.rules.Element.communities
        communities.Element = AAZStrArg()

        tags = cls._args_route_filter_create.tags
    ...
    class ExpressRouteCrossConnectionPeeringsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_ipv6_express_route_circuit_peering_config_read(properties.ipv6_peering_config)
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_ipv6_express_route_circuit_peering_config_create(cls, _builder):
        if _builder is None:
            return
        cls._build_schema_express_route_circuit_peering_config_create(_builder.set_prop("microsoftPeeringConfig", AAZObjectType, ".microsoft_peering_config"))
        _builder.set_prop("primaryPeerAddressPrefix", AAZStrType, ".primary_peer_address_prefix")
        cls._build_schema_route_filter_create(_builder.set_prop("routeFilter", AAZObjectType, ".route_filter"))
    ...
    @classmethod
    def _build_schema_route_filter_create(cls, _builder):
        if _builder is None:
            return
        ...
        if properties is not None:
            ...
            cls._build_schema_ipv6_express_route_circuit_peering_config_create(properties.set_prop("ipv6PeeringConfig", AAZObjectType, ".ipv6_peering_config"))
            properties.set_prop("lastModifiedBy", AAZStrType, ".last_modified_by")
            cls._build_schema_express_route_circuit_peering_config_create(properties.set_prop("microsoftPeeringConfig", AAZObjectType, ".microsoft_peering_config"))
            properties.set_prop("peerASN", AAZIntType, ".peer_asn")
            properties.set_prop("peeringType", AAZStrType, ".peering_type")
            ...
            cls._build_schema_route_filter_create(properties.set_prop("routeFilter", AAZObjectType, ".route_filter"))
        ...
        if properties is not None:
            ...
            cls._build_schema_sub_resource_create(properties.set_prop("expressRouteCircuitPeering", AAZObjectType, ".express_route_circuit_peering"))
            cls._build_schema_sub_resource_create(properties.set_prop("peerExpressRouteCircuitPeering", AAZObjectType, ".peer_express_route_circuit_peering"))

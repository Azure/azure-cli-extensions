...
@register_command(
    "network cross-connection list",
)
class List(AAZCommand):
    """List all express route cross-connections for the current subscription.

    :example: List all express route cross connections for the current subscription.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ExpressRouteCrossConnectionsListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.ExpressRouteCrossConnectionsList(ctx=self.ctx)()
    ...
    class ExpressRouteCrossConnectionsListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            express_route_circuit = cls._schema_on_200.value.Element.properties.express_route_circuit
            ...
            _ListHelper._build_schema_ipv6_express_route_circuit_peering_config_read(properties.ipv6_peering_config)
    ...
    class ExpressRouteCrossConnectionsList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

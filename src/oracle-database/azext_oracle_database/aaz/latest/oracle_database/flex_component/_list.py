...
@register_command(
    "oracle-database flex-component list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FlexComponentsListByParent(ctx=self.ctx)()
    ...
    class FlexComponentsListByParent(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/flexComponents",
                **self.url_parameters
            )

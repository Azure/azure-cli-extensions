...
@register_command(
    "oracle-database db-system-shape show",
)
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.dbsystemshapename = AAZStrArg(
            options=["-n", "--name", "--dbsystemshapename"],
            help="DbSystemShape name",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DbSystemShapesGet(ctx=self.ctx)()
    ...
    class DbSystemShapesGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "dbsystemshapename", self.ctx.args.dbsystemshapename,
                    required=True,
                ),
                **self.serialize_url_param(

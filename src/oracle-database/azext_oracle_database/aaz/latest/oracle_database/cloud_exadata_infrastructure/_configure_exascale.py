...
@register_command(
    "oracle-database cloud-exadata-infrastructure configure-exascale",
)
class ConfigureExascale(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/oracle.database/cloudexadatainfrastructures/{}/configureexascale", "2026-06-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.total_storage_in_gbs = AAZIntArg(
            options=["--total-storage-in-gbs"],
            arg_group="Body",
            help="Storage size needed for Exascale in GBs.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CloudExadataInfrastructuresConfigureExascale(ctx=self.ctx)()
    ...
    class CloudExadataInfrastructuresConfigureExascale(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/cloudExadataInfrastructures/{cloudexadatainfrastructurename}/configureExascale",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("totalStorageInGbs", AAZIntType, ".total_storage_in_gbs", typ_kwargs={"flags": {"required": True}})
...
class _ConfigureExascaleHelper:
    """Helper class for ConfigureExascale"""


__all__ = ["ConfigureExascale"]

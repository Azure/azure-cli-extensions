...
@register_command(
    "oracle-database cloud-exadata-infrastructure add-storage-capacity",
)
class AddStorageCapacity(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CloudExadataInfrastructuresAddStorageCapacity(ctx=self.ctx)()
    ...
    class CloudExadataInfrastructuresAddStorageCapacity(AAZHttpOperation):
...
class _AddStorageCapacityHelper:
    """Helper class for AddStorageCapacity"""


__all__ = ["AddStorageCapacity"]

...
@register_command(
    "oracle-database cloud-exadata-infrastructure database-server show",
)
class Show(AAZCommand):
    """Get a DbServer

    :example: Get Exa Infra Database Server
        az oracle-database cloud-exadata-infrastructure database-server show --cloudexadatainfrastructurename <name> --resource-group <RG name> --dbserverocid <ocid of the db server>
    """

    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/oracle.database/cloudexadatainfrastructures/{}/dbservers/{}", "2026-06-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.dbserverocid = AAZStrArg(
            options=["-n", "--name", "--dbserverocid"],
            help="DbServer OCID.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DbServersGet(ctx=self.ctx)()
    ...
    class DbServersGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "dbserverocid", self.ctx.args.dbserverocid,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            autonomous_virtual_machine_ids = cls._schema_on_200.properties.autonomous_virtual_machine_ids
            autonomous_virtual_machine_ids.Element = AAZStrType()

            autonomous_vm_cluster_ids = cls._schema_on_200.properties.autonomous_vm_cluster_ids
            autonomous_vm_cluster_ids.Element = AAZStrType()

            db_node_ids = cls._schema_on_200.properties.db_node_ids
            db_node_ids.Element = AAZStrType()

            db_server_patching_details = cls._schema_on_200.properties.db_server_patching_details
            ...
            vm_cluster_ids = cls._schema_on_200.properties.vm_cluster_ids

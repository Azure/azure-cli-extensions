...
@register_command(
    "oracle-database autonomous-db-version show",
)
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AutonomousDatabaseVersionsGet(ctx=self.ctx)()
    ...
    class AutonomousDatabaseVersionsGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "autonomousdbversionsname", self.ctx.args.autonomousdbversionsname,
                    required=True,
                ),
                **self.serialize_url_param(

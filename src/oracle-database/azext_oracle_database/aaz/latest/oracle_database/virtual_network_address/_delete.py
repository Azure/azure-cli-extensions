...
@register_command(
    "oracle-database virtual-network-address delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkAddressesDelete(ctx=self.ctx)()
    ...
    class VirtualNetworkAddressesDelete(AAZHttpOperation):

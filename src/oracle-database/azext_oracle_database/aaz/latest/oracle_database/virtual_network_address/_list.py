...
@register_command(
    "oracle-database virtual-network-address list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VirtualNetworkAddressesListByParent(ctx=self.ctx)()
    ...
    class VirtualNetworkAddressesListByParent(AAZHttpOperation):

...
@register_command(
    "oracle-database db-system update",
)
class Update(AAZCommand):
    ...
    class DbSystemsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_db_system_read(cls._schema_on_200)
    ...
    class DbSystemsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_db_system_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_db_system_read = None

    @classmethod
    def _build_schema_db_system_read(cls, _schema):
        if cls._schema_db_system_read is not None:
            _schema.id = cls._schema_db_system_read.id
            _schema.location = cls._schema_db_system_read.location
            _schema.name = cls._schema_db_system_read.name
            _schema.properties = cls._schema_db_system_read.properties
            _schema.system_data = cls._schema_db_system_read.system_data
            _schema.tags = cls._schema_db_system_read.tags
            _schema.type = cls._schema_db_system_read.type
            _schema.zones = cls._schema_db_system_read.zones
            return

        cls._schema_db_system_read = _schema_db_system_read = AAZObjectType()

        db_system_read = _schema_db_system_read
        db_system_read.id = AAZStrType(
            flags={"read_only": True},
        )
        db_system_read.location = AAZStrType(
            flags={"required": True},
        )
        db_system_read.name = AAZStrType(
            flags={"read_only": True},
        )
        db_system_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        db_system_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        db_system_read.tags = AAZDictType()
        db_system_read.type = AAZStrType(
            flags={"read_only": True},
        )
        ...
        scan_ips = _schema_db_system_read.properties.scan_ips
        scan_ips.Element = AAZStrType()

        ssh_public_keys = _schema_db_system_read.properties.ssh_public_keys
        ssh_public_keys.Element = AAZStrType()

        system_data = _schema_db_system_read.system_data
        ...
        tags = _schema_db_system_read.tags
        tags.Element = AAZStrType()

        zones = _schema_db_system_read.zones

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ExascaleDbStorageVaultsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.ExascaleDbStorageVaultsListByResourceGroup(ctx=self.ctx)()
    ...
    class ExascaleDbStorageVaultsListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Oracle.Database/exascaleDbStorageVaults",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            attached_shape_attributes = cls._schema_on_200.value.Element.properties.attached_shape_attributes
            attached_shape_attributes.Element = AAZStrType()

            high_capacity_database_storage = cls._schema_on_200.value.Element.properties.high_capacity_database_storage
    ...
    class ExascaleDbStorageVaultsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

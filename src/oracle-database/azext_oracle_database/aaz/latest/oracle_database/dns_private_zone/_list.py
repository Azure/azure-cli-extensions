...
@register_command(
    "oracle-database dns-private-zone list",
)
class List(AAZCommand):
    """List DnsPrivateZone resources by Location

    :example: List DNS Private Zones
        az oracle-database dns-private-zone list --location <location>
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DnsPrivateZonesListByLocation(ctx=self.ctx)()
    ...
    class DnsPrivateZonesListByLocation(AAZHttpOperation):

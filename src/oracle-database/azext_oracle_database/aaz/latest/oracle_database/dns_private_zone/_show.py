...
@register_command(
    "oracle-database dns-private-zone show",
)
class Show(AAZCommand):
    """Get a DnsPrivateZone

    :example: Get DNS Private Zone
        az oracle-database dns-private-zone show --location <location> --name <zone name>
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.dnsprivatezonename = AAZStrArg(
            options=["-n", "--name", "--dnsprivatezonename"],
            help="DnsPrivateZone name",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DnsPrivateZonesGet(ctx=self.ctx)()
    ...
    class DnsPrivateZonesGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "dnsprivatezonename", self.ctx.args.dnsprivatezonename,
                    required=True,
                ),
                **self.serialize_url_param(

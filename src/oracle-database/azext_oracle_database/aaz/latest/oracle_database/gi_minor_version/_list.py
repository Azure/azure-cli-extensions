...
@register_command(
    "oracle-database gi-minor-version list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GiMinorVersionsListByParent(ctx=self.ctx)()
    ...
    class GiMinorVersionsListByParent(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/giVersions/{giversionname}/giMinorVersions",
                **self.url_parameters
            )

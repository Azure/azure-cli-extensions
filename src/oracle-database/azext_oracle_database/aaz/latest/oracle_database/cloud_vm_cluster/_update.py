...
class _UpdateHelper:
    ...
    def _build_schema_cloud_vm_cluster_read(cls, _schema):
        ...
        file_system_configuration_details = _schema_cloud_vm_cluster_read.properties.file_system_configuration_details
        file_system_configuration_details.Element = AAZObjectType()

        _element = _schema_cloud_vm_cluster_read.properties.file_system_configuration_details.Element
        ...
        proximity_placement_group = _schema_cloud_vm_cluster_read.properties.proximity_placement_group

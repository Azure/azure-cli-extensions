...
@register_command(
    "oracle-database cloud-vm-cluster list-private-ip-address",
)
class ListPrivateIpAddress(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/oracle.database/cloudvmclusters/{}/listprivateipaddresses", "2025-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.vnic_id = AAZStrArg(
            options=["--vnic-id"],
            arg_group="Body",
            help="VCN OCID",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CloudVmClustersListPrivateIpAddresses(ctx=self.ctx)()
    ...
    class CloudVmClustersListPrivateIpAddresses(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("vnicId", AAZStrType, ".vnic_id", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200(cls):
            ...
            _element.hostname_label = AAZStrType(
                serialized_name="hostnameLabel",
                flags={"required": True},
            )
...
class _ListPrivateIpAddressHelper:
    """Helper class for ListPrivateIpAddress"""


__all__ = ["ListPrivateIpAddress"]

...
@register_command(
    "oracle-database cloud-vm-cluster database-node show",
)
class Show(AAZCommand):
    """Get a DbNode

    :example: Get a DB Node
        az oracle-database cloud-vm-cluster database-node show --cloudvmclustername <VM Cluster Name> --resource-group <resource group> --dbnodeocid <ocid of the node>
    """
    ...
    class DbNodesGet(AAZHttpOperation):

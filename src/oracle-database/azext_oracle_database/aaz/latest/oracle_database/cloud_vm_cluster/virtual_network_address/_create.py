...
@register_command(
    "oracle-database cloud-vm-cluster virtual-network-address create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.ip_address = AAZStrArg(
            ...
            help="Virtual network Address address.",
        )
        _args_schema.vm_ocid = AAZStrArg(
            options=["--vm-ocid"],
            arg_group="Properties",
            help="Virtual Machine OCID.",
            fmt=AAZStrArgFormat(
                max_length=255,
                min_length=1,
            ),
    ...
    class VirtualNetworkAddressesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("vmOcid", AAZStrType, ".vm_ocid")

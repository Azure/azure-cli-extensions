...
@register_command(
    "oracle-database autonomous-database action",
)
class Action(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.action = AAZStrArg(
            options=["--action"],
            arg_group="Body",
            help="Autonomous Database lifecycle action",
            required=True,
            enum={"Restart": "Restart", "Start": "Start", "Stop": "Stop"},
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.AutonomousDatabasesAction(ctx=self.ctx)()
    ...
    class AutonomousDatabasesAction(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/autonomousDatabases/{autonomousdatabasename}/action",
                **self.url_parameters
            )

...
class ChangeDisasterRecoveryConfiguration(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.disaster_recovery_type = AAZStrArg(
            options=["--disaster-recovery-type"],
            arg_group="Body",
            help="Indicates the disaster recovery (DR) type of the Autonomous Database Serverless instance. Autonomous Data Guard (ADG) DR type provides business critical DR with a faster recovery time objective (RTO) during failover or switchover. Backup-based DR type provides lower cost DR with a slower RTO during failover or switchover.",
            enum={"Adg": "Adg", "BackupBased": "BackupBased"},
        )
        _args_schema.is_replicate_automatic_backups = AAZBoolArg(
        ...
        _args_schema.is_snapshot_standby = AAZBoolArg(
            options=["--is-snapshot-standby"],
            arg_group="Body",
            help="Indicates if user wants to convert to a snapshot standby. For example, true would set a standby database to snapshot standby database. False would set a snapshot standby database back to regular standby database.",
        )
        _args_schema.time_snapshot_standby_enabled_till = AAZDateTimeArg(
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AutonomousDatabasesChangeDisasterRecoveryConfiguration(ctx=self.ctx)()
    ...
    class AutonomousDatabasesChangeDisasterRecoveryConfiguration(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("disasterRecoveryType", AAZStrType, ".disaster_recovery_type")
            _builder.set_prop("isReplicateAutomaticBackups", AAZBoolType, ".is_replicate_automatic_backups")
            _builder.set_prop("isSnapshotStandby", AAZBoolType, ".is_snapshot_standby")
            _builder.set_prop("timeSnapshotStandbyEnabledTill", AAZStrType, ".time_snapshot_standby_enabled_till")
...
class _ChangeDisasterRecoveryConfigurationHelper:
    """Helper class for ChangeDisasterRecoveryConfiguration"""


__all__ = ["ChangeDisasterRecoveryConfiguration"]

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.AutonomousDatabasesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.AutonomousDatabasesListByResourceGroup(ctx=self.ctx)()
    ...
    class AutonomousDatabasesListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            remote_disaster_recovery_configuration = cls._schema_on_200.value.Element.properties.remote_disaster_recovery_configuration
            ...
            scheduled_operations_list = cls._schema_on_200.value.Element.properties.scheduled_operations_list
            scheduled_operations_list.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.scheduled_operations_list.Element
            ...
            day_of_week = cls._schema_on_200.value.Element.properties.scheduled_operations_list.Element.day_of_week
            ...
            disc_clone_from_backup_timestamp = cls._schema_on_200.value.Element.properties.discriminate_by("data_base_type", "CloneFromBackupTimestamp")
            disc_clone_from_backup_timestamp.source_id = AAZStrType(
                serialized_name="sourceId",
                flags={"required": True},
            )

            disc_cross_region_disaster_recovery = cls._schema_on_200.value.Element.properties.discriminate_by("data_base_type", "CrossRegionDisasterRecovery")
    ...
    class AutonomousDatabasesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

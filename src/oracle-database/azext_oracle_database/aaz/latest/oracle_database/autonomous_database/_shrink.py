...
@register_command(
    "oracle-database autonomous-database shrink",
)
class Shrink(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/oracle.database/autonomousdatabases/{}/shrink", "2026-06-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AutonomousDatabasesShrink(ctx=self.ctx)()
    ...
    class AutonomousDatabasesShrink(AAZHttpOperation):

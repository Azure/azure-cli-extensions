...
@register_command(
    "oracle-database autonomous-database failover",
)
class Failover(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/oracle.database/autonomousdatabases/{}/failover", "2026-06-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.peer_db_location = AAZStrArg(
            options=["--peer-db-location"],
            arg_group="Body",
            help="The location of the Disaster Recovery peer database.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AutonomousDatabasesFailover(ctx=self.ctx)()
    ...
    class AutonomousDatabasesFailover(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("peerDbLocation", AAZStrType, ".peer_db_location")
            _builder.set_prop("peerDbOcid", AAZStrType, ".peer_db_ocid")

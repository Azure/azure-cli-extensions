...
@register_command(
    "oracle-database autonomous-database restore",
)
class Restore(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AutonomousDatabasesRestore(ctx=self.ctx)()
    ...
    class AutonomousDatabasesRestore(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("timestamp", AAZStrType, ".timestamp", typ_kwargs={"flags": {"required": True}})
...
class _RestoreHelper:
    """Helper class for Restore"""

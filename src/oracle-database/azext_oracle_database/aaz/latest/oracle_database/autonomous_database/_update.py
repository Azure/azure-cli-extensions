...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.is_schedule_az_update_to_earliest = AAZBoolArg(
            options=["--is-schedule-az-update-to-earliest"],
            arg_group="Properties",
            help="Update AZ at the earliest available opportunity",
            nullable=True,
        )
        ...
        _args_schema.time_scheduled_az_update = AAZStrArg(
            options=["--time-scheduled-az-update"],
            arg_group="Properties",
            help="The date and time when the Autonomous Database availability zone is to be updated.",
            nullable=True,
        )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("isScheduleAzUpdateToEarliest", AAZBoolType, ".is_schedule_az_update_to_earliest")
                ...
                properties.set_prop("timeScheduledAzUpdate", AAZStrType, ".time_scheduled_az_update")
...
class _UpdateHelper:
    ...
    def _build_schema_autonomous_database_read(cls, _schema):
        ...
        remote_disaster_recovery_configuration = _schema_autonomous_database_read.properties.remote_disaster_recovery_configuration
        ...
        scheduled_operations_list = _schema_autonomous_database_read.properties.scheduled_operations_list
        scheduled_operations_list.Element = AAZObjectType()

        _element = _schema_autonomous_database_read.properties.scheduled_operations_list.Element
        ...
        day_of_week = _schema_autonomous_database_read.properties.scheduled_operations_list.Element.day_of_week
        ...
        disc_clone_from_backup_timestamp = _schema_autonomous_database_read.properties.discriminate_by("data_base_type", "CloneFromBackupTimestamp")
        disc_clone_from_backup_timestamp.source_id = AAZStrType(
            serialized_name="sourceId",
            flags={"required": True},
        )

        disc_cross_region_disaster_recovery = _schema_autonomous_database_read.properties.discriminate_by("data_base_type", "CrossRegionDisasterRecovery")

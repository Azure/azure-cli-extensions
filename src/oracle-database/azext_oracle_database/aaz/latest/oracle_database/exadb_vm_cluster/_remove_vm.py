...
@register_command(
    "oracle-database exadb-vm-cluster remove-vm",
)
class RemoveVm(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.db_nodes = AAZListArg(
            options=["--db-nodes"],
            arg_group="Body",
            help="The list of ExaCS DB nodes for the Exadata VM cluster on Exascale Infrastructure to be removed.",
            required=True,
        )

        db_nodes = cls._args_schema.db_nodes
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExadbVmClustersRemoveVms(ctx=self.ctx)()
    ...
    class ExadbVmClustersRemoveVms(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/exadbVmClusters/{exadbVmClusterName}/removeVms",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("dbNodes", AAZListType, ".db_nodes", typ_kwargs={"flags": {"required": True}})

            db_nodes = _builder.get(".dbNodes")
            if db_nodes is not None:
                db_nodes.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".dbNodes[]")
            if _elements is not None:
                _elements.set_prop("dbNodeId", AAZStrType, ".db_node_id", typ_kwargs={"flags": {"required": True}})

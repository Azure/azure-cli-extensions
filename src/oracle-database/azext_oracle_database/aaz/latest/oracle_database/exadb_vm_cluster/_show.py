...
class Show(AAZCommand):
    ...
    class ExadbVmClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_exadb_vm_cluster_storage_details_read(properties.snapshot_file_system_storage)
            ...
            _ShowHelper._build_schema_exadb_vm_cluster_storage_details_read(properties.total_file_system_storage)

...
@register_command(
    "oracle-database exadb-vm-cluster show",
)
class Show(AAZCommand):
    ...
    class ExadbVmClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_exadbvmclusterstoragedetails_read(properties.snapshot_file_system_storage)
            ...
            _ShowHelper._build_schema_exadbvmclusterstoragedetails_read(properties.total_file_system_storage)
            ...
            _ShowHelper._build_schema_exadbvmclusterstoragedetails_read(properties.vm_file_system_storage)

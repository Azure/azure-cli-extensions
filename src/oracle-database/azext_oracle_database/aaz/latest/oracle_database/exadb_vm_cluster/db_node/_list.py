...
@register_command(
    "oracle-database exadb-vm-cluster db-node list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExascaleDbNodesListByParent(ctx=self.ctx)()
    ...
    class ExascaleDbNodesListByParent(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/exadbVmClusters/{exadbVmClusterName}/dbNodes",
                **self.url_parameters
            )

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ExadbVmClustersListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.ExadbVmClustersListByResourceGroup(ctx=self.ctx)()
    ...
    class ExadbVmClustersListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Oracle.Database/exadbVmClusters",
                **self.url_parameters
            )
    ...
    class ExadbVmClustersListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

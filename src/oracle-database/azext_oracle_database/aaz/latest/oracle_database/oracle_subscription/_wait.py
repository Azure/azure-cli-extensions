...
@register_command(
    "oracle-database oracle-subscription wait",
)
class Wait(AAZWaitCommand):
    ...
    class OracleSubscriptionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.add_subscription_operation_state = AAZStrType(
                serialized_name="addSubscriptionOperationState",
                flags={"read_only": True},
            )
            properties.azure_subscription_ids = AAZListType(
                serialized_name="azureSubscriptionIds",
                flags={"read_only": True},
            )
            ...
            properties.last_operation_status_detail = AAZStrType(
                serialized_name="lastOperationStatusDetail",
                flags={"read_only": True},
            )
            ...
            azure_subscription_ids = cls._schema_on_200.properties.azure_subscription_ids
            azure_subscription_ids.Element = AAZStrType()

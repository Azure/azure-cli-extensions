...
@register_command(
    "oracle-database oracle-subscription list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.OracleSubscriptionsListBySubscription(ctx=self.ctx)()
    ...
    class OracleSubscriptionsListBySubscription(AAZHttpOperation):

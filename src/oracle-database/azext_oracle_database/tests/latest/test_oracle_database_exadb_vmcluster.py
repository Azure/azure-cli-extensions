...
class OracleExaDbVmclusterScenarioTest(ScenarioTest):
    def setUp(self):
        ...
        self.kwargs.update({
            ...
            'node_count': 2,
            'shape': 'EXADBXS',
            'vnet_id': '/subscriptions/fd42b73d-5f28-4a23-ae7c-ca08c625fe07/resourceGroups/PowerShellTestRg/providers/Microsoft.Network/virtualNetworks/PSTestVnet',
            'subnet_id': '/subscriptions/fd42b73d-5f28-4a23-ae7c-ca08c625fe07/resourceGroups/PowerShellTestRg/providers/Microsoft.Network/virtualNetworks/PSTestVnet/subnets/delegated',
            'total_ecpu_count': 32,

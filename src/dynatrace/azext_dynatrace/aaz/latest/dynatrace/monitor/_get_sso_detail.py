...
class GetSsoDetail(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/dynatrace.observability/monitors/{}/getssodetails", "2021-09-01-preview"],
        ]
    }
    ...
    class MonitorsGetSSODetails(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.aad_domains = AAZListType(
                serialized_name="aadDomains",
            )
            _schema_on_200.admin_users = AAZListType(
                serialized_name="adminUsers",
            )
            _schema_on_200.is_sso_enabled = AAZStrType(
                serialized_name="isSsoEnabled",
            )
            _schema_on_200.metadata_url = AAZStrType(
                serialized_name="metadataUrl",
            )
            _schema_on_200.single_sign_on_url = AAZStrType(
                serialized_name="singleSignOnUrl",
            )

            aad_domains = cls._schema_on_200.aad_domains
            aad_domains.Element = AAZStrType()

            admin_users = cls._schema_on_200.admin_users

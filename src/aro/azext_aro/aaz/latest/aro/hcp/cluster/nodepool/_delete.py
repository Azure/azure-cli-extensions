...
@register_command(
    "aro hcp cluster nodepool delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete a node pool
        az aro hcp cluster nodepool delete --resource-group MyResourceGroup --cluster-name MyCluster --name MyNodePool --yes
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NodePoolsDelete(ctx=self.ctx)()
    ...
    class NodePoolsDelete(AAZHttpOperation):

...
helps['aro identity'] = """
  type: group
  short-summary: Manage identities related to Azure Red Hat OpenShift Standard clusters.
"""

helps['aro identity get-required'] = """
  type: command
  short-summary: Get required identities
  long-summary: Get required identities for creating a Standard cluster with managed identities.
"""

helps['aro identity create-required'] = """
  type: command
  short-summary: Create required identities
  long-summary: Create required identities to prepare for creating a Standard cluster with managed identities.
"""

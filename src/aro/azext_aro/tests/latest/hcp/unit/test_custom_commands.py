...
from azext_aro.azext_aro_hcp.custom import ClusterCreate, ClusterUpdate, GetVersions, RequestCredential
...
class GetVersionsTest(unittest.TestCase):
    ...
    @mock.patch("azext_aro.azext_aro_hcp.custom.has_value", return_value=True)
...
class RequestCredentialTest(unittest.TestCase):
    ...
    @mock.patch(
        "azext_aro.azext_aro_hcp._kubeconfig._generate_admin_credential_request",
    ...
    @mock.patch("azext_aro.azext_aro_hcp._kubeconfig.print_or_merge_credentials")
    @mock.patch("azext_aro.azext_aro_hcp._kubeconfig._embed_private_key", return_value="embedded")
    @mock.patch.object(RequestCredential, "deserialize_output", return_value={"kubeconfig": "config\\n"})
    @mock.patch("azext_aro.azext_aro_hcp.custom.has_value", return_value=False)

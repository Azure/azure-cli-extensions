...
from azext_aro.azext_aro_hcp.commands import load_command_table
...
class CommandTableTest(unittest.TestCase):
    ...
    @mock.patch("azext_aro.azext_aro_hcp.custom.GetVersions", autospec=True)
    @mock.patch("azext_aro.aaz.latest.aro.hcp.cluster.nodepool._show.Show", autospec=True)
    @mock.patch("azext_aro.aaz.latest.aro.hcp.cluster.nodepool._list.List", autospec=True)
    @mock.patch("azext_aro.aaz.latest.aro.hcp.cluster._show.Show", autospec=True)
    @mock.patch("azext_aro.aaz.latest.aro.hcp.cluster._list.List", autospec=True)
    @mock.patch("azext_aro.azext_aro_hcp.custom.RequestCredential", autospec=True)
    @mock.patch("azext_aro.azext_aro_hcp.custom.ClusterUpdate", autospec=True)
    @mock.patch("azext_aro.azext_aro_hcp.custom.ClusterCreate", autospec=True)
    def test_load_command_table_registers_custom_commands_and_transformers(
        ...
        from azext_aro.azext_aro_hcp._format import (

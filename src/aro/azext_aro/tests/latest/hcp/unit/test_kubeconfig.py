...
from azext_aro.azext_aro_hcp._kubeconfig import (
    _embed_private_key,
...
class LoadKubernetesConfigurationTest(unittest.TestCase):
    ...
    @mock.patch(
        "azext_aro.azext_aro_hcp._kubeconfig.open",
...
class HandleMergeTest(unittest.TestCase):
    ...
    @mock.patch("azext_aro.azext_aro_hcp._kubeconfig.prompt_y_n", return_value=False)

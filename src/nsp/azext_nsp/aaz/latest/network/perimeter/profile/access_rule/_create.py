...
class Create(AAZCommand):
    ...
    :example: Create ServiceTag based access rule
        az network perimeter profile access-rule create -n MyAccessRule --profile-name MyProfile --perimeter-name MyPerimeter -g MyResourceGroup --service-tags "['st1']"
    """

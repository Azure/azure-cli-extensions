...
@register_command(
    "network perimeter profile access-rule reconcile",
)
class Reconcile(AAZCommand):
    """Reconcile NSP access rules

    :example: Reconcile NSP access rule
        az network perimeter profile access-rule reconcile -n MyAccessRule --profile-name MyProfile --perimeter-name MyPerimeter -g MyResourceGroup
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NspAccessRulesReconcilePost(ctx=self.ctx)()
    ...
    class NspAccessRulesReconcilePost(AAZHttpOperation):

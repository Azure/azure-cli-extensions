...
from azext_cdn.aaz.latest.afd.route import Show as _AFDRouteShow, \
    Create as _AFDRouteCreate, Update as _AFDRouteUpdate
from azext_cdn.aaz.latest.afd.rule import Show as _RuleShow, \
    Create as _AFDRuleCreate, Update as _AFDRuleUpdate
from azext_cdn.aaz.latest.afd.secret import Show as _AFDSecretShow, \
    Create as _AFDSecretCreate, Update as _AFDSecretUpdate
from azext_cdn.aaz.latest.afd.security_policy import Show as _AFDSecurityPolicyShow, \
...
from azext_cdn.aaz.latest.afd.endpoint import Show as _AFDEndpointShow, \
...
class AFDOriginUpdate(_AFDOriginUpdate):
    ...
    def pre_operations(self):
        args = self.ctx.args
        from azext_cdn.aaz.latest.afd.origin import Show

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RoutesListByEndpoint(ctx=self.ctx)()
    ...
    class RoutesListByEndpoint(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cache_configuration = cls._schema_on_200.value.Element.properties.cache_configuration
            ...
            compression_settings = cls._schema_on_200.value.Element.properties.cache_configuration.compression_settings
            ...
            content_types_to_compress = cls._schema_on_200.value.Element.properties.cache_configuration.compression_settings.content_types_to_compress
            content_types_to_compress.Element = AAZStrType()

            custom_domains = cls._schema_on_200.value.Element.properties.custom_domains
            custom_domains.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.custom_domains.Element
            _element.id = AAZStrType()
            ...
            patterns_to_match = cls._schema_on_200.value.Element.properties.patterns_to_match
            patterns_to_match.Element = AAZStrType()

            rule_sets = cls._schema_on_200.value.Element.properties.rule_sets
            rule_sets.Element = AAZObjectType()
            _ListHelper._build_schema_resource_reference_read(rule_sets.Element)

            supported_protocols = cls._schema_on_200.value.Element.properties.supported_protocols

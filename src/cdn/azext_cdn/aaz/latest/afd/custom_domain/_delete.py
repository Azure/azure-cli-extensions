...
class Delete(AAZCommand):
    ...
    :example: AFDCustomDomains_Delete
        az afd custom-domain delete --resource-group RG --profile-name profile1 --custom-domain-name domain1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AFDCustomDomainsDelete(ctx=self.ctx)()
    ...
    class AFDCustomDomainsDelete(AAZHttpOperation):

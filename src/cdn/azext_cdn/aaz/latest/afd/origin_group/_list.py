...
class List(AAZCommand):
    ...
    :example: AFDOriginGroups_ListByProfile
        az afd origin-group list --resource-group RG --profile-name profile1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AFDOriginGroupsListByProfile(ctx=self.ctx)()
    ...
    class AFDOriginGroupsListByProfile(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            load_balancing_settings = cls._schema_on_200.value.Element.properties.load_balancing_settings

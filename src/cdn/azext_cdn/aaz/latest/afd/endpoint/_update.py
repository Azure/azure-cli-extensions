...
class Update(AAZCommand):
    ...
    :example: AFDEndpoints_Create
        az afd endpoint update --resource-group RG --profile-name profile1 --endpoint-name endpoint1 --name-reuse-scope TenantReuse --enabled-state Enabled --enforce-mtls Disabled --tags "{}"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.enforce_mtls = AAZStrArg(
            options=["--enforce-mtls"],
            arg_group="Properties",
            help="Set to Disabled by default. If set to Enabled, only custom domains with mTLS enabled can be added to child Route resources.",
            nullable=True,
            enum={"Disabled": "Disabled", "Enabled": "Enabled"},
        )
        return cls._args_schema
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("enforceMtls", AAZStrType, ".enforce_mtls")

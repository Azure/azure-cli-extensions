...
class List(AAZCommand):
    ...
    :example: LogAnalytics_GetLogAnalyticsMetrics
        az afd log-analytic metric list --resource-group RG --profile-name profile1 --metrics "[clientRequestCount]" --date-time-begin 2020-11-04T04:30:00.000Z --date-time-end 2020-11-04T05:00:00.000Z --granularity PT5M --group-by "[protocol]" --custom-domains "[customdomain1.azurecdn.net,customdomain2.azurecdn.net]" --protocols "[https]"
    """

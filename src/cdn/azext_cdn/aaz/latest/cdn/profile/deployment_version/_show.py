...
@register_command(
    "cdn profile deployment-version show",
)
class Show(AAZCommand):
    ...
    :example: DeploymentVersions_Get
        az cdn profile deployment-version show --resource-group RG --profile-name profile1 --version-name dv1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DeploymentVersionsGet(ctx=self.ctx)()
    ...
    class DeploymentVersionsGet(AAZHttpOperation):

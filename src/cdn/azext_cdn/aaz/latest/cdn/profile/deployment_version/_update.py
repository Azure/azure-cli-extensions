...
@register_command(
    "cdn profile deployment-version update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DeploymentVersionsUpdate(ctx=self.ctx)()
    ...
    class DeploymentVersionsUpdate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/deploymentVersions/{versionName}",
                **self.url_parameters
            )

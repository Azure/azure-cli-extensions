...
class NameExists(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CheckNameAvailabilityWithSubscription(ctx=self.ctx)()
    ...
    class CheckNameAvailabilityWithSubscription(AAZHttpOperation):
...
class _NameExistsHelper:
    """Helper class for NameExists"""

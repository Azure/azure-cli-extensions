...
class Usage(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.cdn/checkresourceusage", "2026-04-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ResourceUsageList(ctx=self.ctx)()
    ...
    class ResourceUsageList(AAZHttpOperation):

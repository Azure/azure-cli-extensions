...
class Load(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.cdn/profiles/{}/endpoints/{}/load", "2025-09-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.content_paths = AAZListArg(
            ...
            help="The path to the content to be loaded. Path should be a relative file URL of the origin.",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.EndpointsLoadContent(ctx=self.ctx)()
    ...
    class EndpointsLoadContent(AAZHttpOperation):

...
from azext_cdn.vendored_sdks.models import AfdQueryStringCachingBehavior, DeliveryRuleAction, DeliveryRuleCondition
from azext_cdn.vendored_sdks.models import ForwardingProtocol, QueryStringCachingBehavior, Transform

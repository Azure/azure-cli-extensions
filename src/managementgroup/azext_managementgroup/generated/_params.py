...
def load_arguments(self, _):
    ...
    with self.argument_context('managementgroup management-group list') as c:
        c.argument('cache_control', type=str, help='Indicates that the request shouldn\'t utilize any caches.')
    ...
    with self.argument_context('managementgroup management-group show') as c:
        ...
        c.argument('expand', arg_type=get_enum_type(['children', 'path']), help='The $expand=children query string '
                   'parameter allows clients to request inclusion of children in the response payload.  $expand=path '
    ...
    with self.argument_context('managementgroup management-group create') as c:
        ...
        c.argument('details_parent_id', type=str, help='The fully qualified ID for the parent management group.  For '

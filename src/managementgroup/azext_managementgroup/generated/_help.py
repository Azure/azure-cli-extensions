...
helps['managementgroup management-group create'] = """
    type: command
    short-summary: "Create or update a management group. If a management group is already created and a subsequent \
create request is issued with different properties, the management group properties will be updated."
    examples:
      - name: PutManagementGroup
        text: |-
               az managementgroup management-group create --cache-control "no-cache" --display-name "ChildGroup" \
--details-parent-id "/providers/Microsoft.Management/managementGroups/RootGroup" --group-id "ChildGroup"
"""
...
helps['managementgroup management-group-subscription get-subscription-under-management-group'] = """
    ...
    examples:
      - name: GetAllSubscriptionsFromManagementGroup
        text: |-
               az managementgroup management-group-subscription get-subscription-under-management-group --group-id \
"Group"
"""

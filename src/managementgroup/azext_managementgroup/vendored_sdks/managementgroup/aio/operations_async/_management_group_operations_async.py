...
class ManagementGroupOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(_create_management_group_request, 'CreateManagementGroupRequest')
    ...
    create_or_update.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_patch_group_request, 'PatchManagementGroupRequest')
        body_content_kwargs['content'] = body_content
    ...
    async def _delete_initial(
        ...
        cache_control: Optional[str] = "no-cache",
        **kwargs
    ) -> "models.AzureAsyncOperationResults":
    ...
    If a management group contains child resources, the request will fail.
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: AzureAsyncOperationResults, or the result of cls(response)
        :rtype: ~management_groups_api.models.AzureAsyncOperationResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AzureAsyncOperationResults"]
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}'}  # type: ignore

...
manage access control, policies, alerting and reporting for those resources.
    ...
    :vartype management_group: management_groups_api.aio.operations.ManagementGroupOperations
    :ivar management_group_subscription: ManagementGroupSubscriptionOperations operations
    :vartype management_group_subscription: management_groups_api.aio.operations.ManagementGroupSubscriptionOperations
    :ivar hierarchy_setting: HierarchySettingOperations operations
    :vartype hierarchy_setting: management_groups_api.aio.operations.HierarchySettingOperations
    :ivar operation: OperationOperations operations
    :vartype operation: management_groups_api.aio.operations.OperationOperations
    :ivar entity: EntityOperations operations
    :vartype entity: management_groups_api.aio.operations.EntityOperations

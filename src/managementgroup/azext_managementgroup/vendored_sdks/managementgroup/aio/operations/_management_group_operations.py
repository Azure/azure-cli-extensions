...
class ManagementGroupOperations:
    """ManagementGroupOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        create_management_group_request = models.CreateManagementGroupRequest(name=name, display_name_properties_display_name=display_name, id_details_parent_id=id)
        api_version = "2020-05-01"
    ...
    async def update(
        ...
        **kwargs
        ...
        patch_group_request = models.PatchManagementGroupRequest(display_name=display_name, parent_group_id=parent_group_id)
        api_version = "2020-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def get_descendant(
        ...
        **kwargs
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.get_descendant.metadata['url']  # type: ignore
                path_format_arguments = {
                    'groupId': self._serialize.url("group_id", group_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    get_descendant.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}/descendants'}  # type: ignore

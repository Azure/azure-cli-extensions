...
class ManagementGroupOperations(object):
    """ManagementGroupOperations operations.
    ...
    def update(
        ...
        cache_control="no-cache",  # type: Optional[str]
        display_name=None,  # type: Optional[str]
        parent_group_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagementGroup"
    ...
    def _delete_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.AzureAsyncOperationResults"

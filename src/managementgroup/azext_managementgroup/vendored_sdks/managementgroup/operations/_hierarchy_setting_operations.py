...
class HierarchySettingOperations(object):
    """HierarchySettingOperations operations.
    ...
    def create_or_update(
        self,
        group_id,  # type: str
        require_authorization_for_group_creation=None,  # type: Optional[bool]
        default_management_group=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.HierarchySettings"
        ...
        create_tenant_settings_request = models.CreateOrUpdateSettingsRequest(require_authorization_for_group_creation=require_authorization_for_group_creation, default_management_group=default_management_group)
        api_version = "2020-05-01"

...
class CreateManagementGroupRequest(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        name: Optional[str] = None,
        display_name_properties_display_name: Optional[str] = None,
        id_properties_details_parent_id: Optional[str] = None,
        **kwargs
    ):
        ...
        self.name = name
        self.tenant_id = None
        self.display_name_properties_display_name = display_name_properties_display_name
        self.children = None
        self.version = None
        self.updated_time = None
        self.updated_by = None
        self.id_properties_details_parent_id = id_properties_details_parent_id

...
class CreateManagementGroupRequest(msrest.serialization.Model):
    ...
    :param display_name_properties_display_name: The friendly name of the management group. If no
     value is passed then this  field will be set to the groupId.
    :type display_name_properties_display_name: str
    :ivar children: The list of children.
    :vartype children: list[~management_groups_api.models.CreateManagementGroupChildInfo]
    ...
    :param id_properties_details_parent_id: The fully qualified ID for the parent management group.
     For example,
     /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000.
    :type id_properties_details_parent_id: str
    :ivar name_properties_details_parent_name: The name of the parent management group.
    :vartype name_properties_details_parent_name: str
    :ivar display_name_properties_details_parent_display_name: The friendly name of the parent
     management group.
    :vartype display_name_properties_details_parent_display_name: str
    """
    ...
    _validation = {
        ...
        'name_properties_details_parent_name': {'readonly': True},
        'display_name_properties_details_parent_display_name': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'name': {'key': 'name', 'type': 'str'},
        'tenant_id': {'key': 'properties.tenantId', 'type': 'str'},
        'display_name_properties_display_name': {'key': 'properties.displayName', 'type': 'str'},
        'children': {'key': 'properties.children', 'type': '[CreateManagementGroupChildInfo]'},
        'version': {'key': 'properties.details.version', 'type': 'int'},
        'updated_time': {'key': 'properties.details.updatedTime', 'type': 'iso-8601'},
        'updated_by': {'key': 'properties.details.updatedBy', 'type': 'str'},
        'id_properties_details_parent_id': {'key': 'properties.details.parent.id', 'type': 'str'},
        'name_properties_details_parent_name': {'key': 'properties.details.parent.name', 'type': 'str'},
        'display_name_properties_details_parent_display_name': {'key': 'properties.details.parent.displayName', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.name = kwargs.get('name', None)
        self.tenant_id = None
        self.display_name_properties_display_name = kwargs.get('display_name_properties_display_name', None)
        self.children = None
        self.version = None
        self.updated_time = None
        self.updated_by = None
        self.id_properties_details_parent_id = kwargs.get('id_properties_details_parent_id', None)
        self.name_properties_details_parent_name = None
        self.display_name_properties_details_parent_display_name = None

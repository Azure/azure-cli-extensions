...
class CreateManagementGroupRequest(msrest.serialization.Model):
    ...
    :param id_details_parent_id: The fully qualified ID for the parent management group.  For
     example, /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000.
    :type id_details_parent_id: str
    :ivar name_details_parent_name: The name of the parent management group.
    :vartype name_details_parent_name: str
    :ivar display_name_details_parent_display_name: The friendly name of the parent management
     group.
    :vartype display_name_details_parent_display_name: str
    """
    ...
    _validation = {
        ...
        'name_details_parent_name': {'readonly': True},
        'display_name_details_parent_display_name': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'version': {'key': 'details.version', 'type': 'int'},
        'updated_time': {'key': 'details.updatedTime', 'type': 'iso-8601'},
        'updated_by': {'key': 'details.updatedBy', 'type': 'str'},
        'id_details_parent_id': {'key': 'details.parent.id', 'type': 'str'},
        'name_details_parent_name': {'key': 'details.parent.name', 'type': 'str'},
        'display_name_details_parent_display_name': {'key': 'details.parent.displayName', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.id_details_parent_id = kwargs.get('id_details_parent_id', None)
        self.name_details_parent_name = None
        self.display_name_details_parent_display_name = None

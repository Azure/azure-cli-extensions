...
@try_manual
def step__managementgroupsubscriptions_put_addsubscriptiontomanagementgroup(test):
...
@try_manual
def step__managementgroups_get_getmanagementgroupwithexpand(test):
    test.cmd('az managementgroup management-group show '
             '--expand "children" '
             '--cache-control "no-cache" '
             '--group-id "20000000-0001-0000-0000-000000000000"',
...
@try_manual
def step__managementgroups_get_getmanagementgroupswithexpandandrecurse(test):
    test.cmd('az managementgroup management-group show '
             '--expand "children" '
             '--recurse true '
             '--cache-control "no-cache" '
...
def step__hierarchysettings_delete_getgroupsettings(test):
    test.cmd('az managementgroup hierarchy-setting delete '
             '--group-id "root"',
             checks=[])
...
@try_manual
def step__managementgroupsubscriptions_delete_deletesubscriptionfrommanagementgroup(test):
    test.cmd('az managementgroup management-group-subscription delete '
             '--cache-control "no-cache" '
             '--group-id "Group" '
             '--subscription-id "728bcbe4-8d56-4510-86c2-4921b8beefbc"',
             checks=[])
...
@try_manual
def step__managementgroups_delete_deletemanagementgroup(test):
    test.cmd('az managementgroup management-group delete '
             '--cache-control "no-cache" '
...
def call_scenario(test):
    ...
    step__managementgroups_get_getmanagementgroupwithexpand(test)
    step__managementgroups_get_getmanagementgroupswithexpandandrecurse(test)
    ...
    step__managementgroupsubscriptions_delete_deletesubscriptionfrommanagementgroup(test)
    step__managementgroups_delete_deletemanagementgroup(test)
    cleanup(test)

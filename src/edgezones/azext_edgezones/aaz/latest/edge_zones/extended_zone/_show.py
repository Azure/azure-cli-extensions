...
class Show(AAZCommand):
    ...
    :example: Get an Azure Extended Zone for a subscription
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.extended_zone_name = AAZStrArg(
            options=["-n", "--name", "--extended-zone-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExtendedZonesGet(ctx=self.ctx)()
    ...
    class ExtendedZonesGet(AAZHttpOperation):

...
@register_command(
    "resource-mover-2 move-collection list-required-for",
)
class ListRequiredFor(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.source_id = AAZStrArg(
            options=["--source-id"],
            help="The sourceId for which the api is invoked.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MoveCollectionsListRequiredFor(ctx=self.ctx)()
...
class _ListRequiredForHelper:
    """Helper class for ListRequiredFor"""


__all__ = ["ListRequiredFor"]

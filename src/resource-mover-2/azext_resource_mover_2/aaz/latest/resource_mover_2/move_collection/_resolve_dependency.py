...
@register_command(
    "resource-mover-2 move-collection resolve-dependency",
)
class ResolveDependency(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MoveCollectionsResolveDependencies(ctx=self.ctx)()
    ...
    class MoveCollectionsResolveDependencies(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ResolveDependencyHelper._build_schema_operation_status_error_read(_schema_on_200.error)
...
class _ResolveDependencyHelper:
    """Helper class for ResolveDependency"""

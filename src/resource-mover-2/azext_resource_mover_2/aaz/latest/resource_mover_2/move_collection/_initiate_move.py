...
@register_command(
    "resource-mover-2 move-collection initiate-move",
)
class InitiateMove(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MoveCollectionsInitiateMove(ctx=self.ctx)()
    ...
    class MoveCollectionsInitiateMove(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _InitiateMoveHelper._build_schema_operation_status_error_read(_schema_on_200.error)
...
class _InitiateMoveHelper:
    """Helper class for InitiateMove"""

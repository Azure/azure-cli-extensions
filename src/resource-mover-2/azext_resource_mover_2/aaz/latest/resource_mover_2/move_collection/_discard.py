...
@register_command(
    "resource-mover-2 move-collection discard",
)
class Discard(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.MoveCollectionsDiscard(ctx=self.ctx)()
    ...
    class MoveCollectionsDiscard(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _DiscardHelper._build_schema_operation_status_error_read(_schema_on_200.error)
...
class _DiscardHelper:
    """Helper class for Discard"""

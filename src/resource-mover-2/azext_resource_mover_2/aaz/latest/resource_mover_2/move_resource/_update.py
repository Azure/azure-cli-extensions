...
@register_command(
    "resource-mover-2 move-resource update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_subnet_reference_update(_element.subnet)
    ...
    _args_subnet_reference_update = None

    @classmethod
    def _build_args_subnet_reference_update(cls, _schema):
        if cls._args_subnet_reference_update is not None:
            _schema.name = cls._args_subnet_reference_update.name
            _schema.source_arm_resource_id = cls._args_subnet_reference_update.source_arm_resource_id
            return

        cls._args_subnet_reference_update = AAZObjectArg(
            nullable=True,
        )

        subnet_reference_update = cls._args_subnet_reference_update
        subnet_reference_update.name = AAZStrArg(
            options=["name"],
            help="Gets the name of the proxy resource on the target side.",
            nullable=True,
        )
        subnet_reference_update.source_arm_resource_id = AAZStrArg(
            options=["source-arm-resource-id"],
            help="Gets the ARM resource ID of the tracked resource being referenced.",
        )
    ...
    class MoveResourcesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_move_resource_read(cls._schema_on_200)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if _elements is not None:
                ...
                _UpdateHelper._build_schema_subnet_reference_update(_elements.set_prop("subnet", AAZObjectType, ".subnet"))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_subnet_reference_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_move_resource_read = None

    @classmethod
    def _build_schema_move_resource_read(cls, _schema):
        if cls._schema_move_resource_read is not None:
            _schema.id = cls._schema_move_resource_read.id
            _schema.name = cls._schema_move_resource_read.name
            _schema.properties = cls._schema_move_resource_read.properties
            _schema.system_data = cls._schema_move_resource_read.system_data
            _schema.type = cls._schema_move_resource_read.type
            return

        cls._schema_move_resource_read = _schema_move_resource_read = AAZObjectType()

        move_resource_read = _schema_move_resource_read
        move_resource_read.id = AAZStrType(
            flags={"read_only": True},
        )
        move_resource_read.name = AAZStrType(
            flags={"read_only": True},
        )
        move_resource_read.properties = AAZObjectType()
        move_resource_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        move_resource_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_move_resource_read.properties
        ...
        cls._build_schema_resource_settings_read(properties.resource_settings)
        ...
        cls._build_schema_resource_settings_read(properties.source_resource_settings)
        properties.target_id = AAZStrType(
            serialized_name="targetId",
            flags={"read_only": True},
        )

        depends_on = _schema_move_resource_read.properties.depends_on
        depends_on.Element = AAZObjectType()

        _element = _schema_move_resource_read.properties.depends_on.Element
        ...
        automatic_resolution = _schema_move_resource_read.properties.depends_on.Element.automatic_resolution
        automatic_resolution.move_resource_id = AAZStrType(
            serialized_name="moveResourceId",
        )

        manual_resolution = _schema_move_resource_read.properties.depends_on.Element.manual_resolution
        manual_resolution.target_id = AAZStrType(
            serialized_name="targetId",
        )

        depends_on_overrides = _schema_move_resource_read.properties.depends_on_overrides
        depends_on_overrides.Element = AAZObjectType()

        _element = _schema_move_resource_read.properties.depends_on_overrides.Element
        _element.id = AAZStrType()
        _element.target_id = AAZStrType(
            serialized_name="targetId",
        )

        errors = _schema_move_resource_read.properties.errors
        errors.properties = AAZObjectType()
        cls._build_schema_move_resource_error_body_read(errors.properties)

        move_status = _schema_move_resource_read.properties.move_status
        ...
        errors = _schema_move_resource_read.properties.move_status.errors
        errors.properties = AAZObjectType()
        cls._build_schema_move_resource_error_body_read(errors.properties)

        job_status = _schema_move_resource_read.properties.move_status.job_status
        ...
        system_data = _schema_move_resource_read.system_data

...
class Show(AAZCommand):
    ...
    :example: Get Cloud HSM backup job status
        az cloudhsm backup show --resource-group rgcloudhsm --cluster-name chsm1 --job-id 572a45927fc240e1ac075de27371680b
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CloudHsmClusterBackupStatusGet(ctx=self.ctx)()
    ...
    class CloudHsmClusterBackupStatusGet(AAZHttpOperation):

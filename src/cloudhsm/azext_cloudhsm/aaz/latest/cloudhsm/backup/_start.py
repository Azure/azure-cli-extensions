...
@register_command(
    "cloudhsm backup start",
)
class Start(AAZCommand):
    """Begin a backup of the Cloud HSM.

    :example: Start Cloud HSM Backup
        az cloudhsm backup start --resource-group rgcloudhsm --cluster-name chsm1 --blob-container-uri "https://cli.blob.core.windows.net/testbackup"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.blob_container_uri = AAZStrArg(
            ...
            arg_group="BackupRequestProperties",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CloudHsmClustersBackup(ctx=self.ctx)()
    ...
    class CloudHsmClustersBackup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.azure_storage_blob_container_uri = AAZStrType(

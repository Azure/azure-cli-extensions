...
class List(AAZCommand):
    ...
    :example: Show all cloud HSMs in the selected subscription
        az cloudhsm list
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.CloudHsmClustersListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.CloudHsmClustersListByResourceGroup(ctx=self.ctx)()
    ...
    class CloudHsmClustersListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            hsms = cls._schema_on_200.value.Element.properties.hsms
            hsms.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.hsms.Element
    ...
    class CloudHsmClustersListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

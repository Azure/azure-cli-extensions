...
class FileSystemOperations:
    ...
    async def create(
        ...
        **kwargs
        ...
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a href="https://learn.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-
    ...
    async def set_properties(
        ...
        **kwargs
        ...
        <https://learn.microsoft.com/en-us/rest/api/storageservices/specifying-conditional-headers-for-

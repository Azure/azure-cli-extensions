...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        :type account_name: ~azure.mgmt.storage.v2021_08_01.models.StorageAccountCheckNameAvailabilityParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResult, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.CheckNameAvailabilityResult
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_08_01.models.StorageAccountCreateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2021_08_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_properties(
        ...
        **kwargs  # type: Any
        ...
        :type expand: str or ~azure.mgmt.storage.v2021_08_01.models.StorageAccountExpand
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccount, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.StorageAccount"]
        error_map = {
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_08_01.models.StorageAccountUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccount, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_08_01.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_account_sas(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_08_01.models.AccountSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListAccountSasResponse, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.ListAccountSasResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_service_sas(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_08_01.models.ServiceSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListServiceSasResponse, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.ListServiceSasResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _hierarchical_namespace_migration_initial(
        self,
        resource_group_name,  # type: str
        account_name,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._hierarchical_namespace_migration_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
        ...
        query_parameters = {}  # type: Dict[str, Any]
        query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
        query_parameters['requestType'] = self._serialize.query("request_type", request_type, 'str')
    ...
    def _abort_hierarchical_namespace_migration_initial(
        self,
        resource_group_name,  # type: str
        account_name,  # type: str
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._abort_hierarchical_namespace_migration_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
    ...
    def begin_restore_blob_ranges(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_08_01.models.BlobRestoreParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2021_08_01.models.BlobRestoreStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.BlobRestoreStatus"]

...
class LocalUsersOperations(object):
    ...
    def regenerate_password(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.LocalUserProperties"
        ...
        :type username: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: LocalUserProperties, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.LocalUserProperties
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.LocalUserProperties"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        # Construct URL
        url = self.regenerate_password.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
        ...
        deserialized = self._deserialize('LocalUserProperties', pipeline_response)

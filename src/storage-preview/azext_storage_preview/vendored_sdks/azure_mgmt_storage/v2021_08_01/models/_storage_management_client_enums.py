...
class AccountImmutabilityPolicyState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ActiveDirectoryPropertiesAccountType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class AllowedCopyScope(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class LeaseShareAction(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Specifies the lease action. Can be one of the available actions.
    """
...
class Schedule(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

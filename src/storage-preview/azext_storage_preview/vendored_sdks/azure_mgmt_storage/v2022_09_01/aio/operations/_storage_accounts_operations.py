...
class StorageAccountsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2022_09_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either BlobRestoreStatus or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2022_09_01.models.BlobRestoreStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._restore_blob_ranges_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                parameters=parameters,
                api_version=api_version,

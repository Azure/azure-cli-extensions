...
class BlobClient(StorageAccountHostsMixin):  # pylint: disable=too-many-public-methods
    ...
    def query_blob(self, query_expression, **kwargs):
        ...
        :keyword Callable[~.BlobQueryError] on_error:
        ...
        :paramtype blob_format: ~.DelimitedTextDialect or ~.DelimitedJsonDialect
        ...
        :paramtype output_format: ~.DelimitedTextDialect, ~.DelimitedJsonDialect
            or list[~.ArrowDialect]
        :keyword lease:
    ...
    def start_copy_from_url(self, source_url, metadata=None, incremental_copy=False, **kwargs):
        ...
        :paramtype destination_lease: ~.BlobLeaseClient or str
        :keyword source_lease:
            Specify this to perform the Copy Blob operation only if
            the lease ID given matches the active lease ID of the source blob.
        :paramtype source_lease: ~.BlobLeaseClient or str
        :keyword int timeout:
            The timeout parameter is expressed in seconds.
        :keyword ~.PremiumPageBlobTier premium_page_blob_tier:
            A page blob tier value to set the blob to. The tier correlates to the size of the
    ...
    def abort_copy(self, copy_id, **kwargs):
        ...
        :type copy_id: str or ~.BlobProperties
        :rtype: None

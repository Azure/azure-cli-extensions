...
@register_command(
    "dns-resolver forwarding-rule list",
)
class List(AAZCommand):
    """Lists forwarding rules in a DNS forwarding ruleset.

    :example: List forwarding rules in a DNS forwarding ruleset
    ...
    def _execute_operations(self):
        self.ForwardingRulesList(ctx=self.ctx)()
    ...
    class ForwardingRulesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            target_dns_servers = cls._schema_on_200.value.Element.properties.target_dns_servers
            target_dns_servers.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.target_dns_servers.Element

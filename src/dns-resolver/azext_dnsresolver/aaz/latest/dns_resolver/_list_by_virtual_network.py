...
@register_command(
    "dns-resolver list-by-virtual-network",
)
class ListByVirtualNetwork(AAZCommand):
    """Lists DNS resolver resource IDs linked to a virtual network.

    :example: List DNS resolvers by virtual network
    ...
    def _execute_operations(self):
        self.DnsResolversListByVirtualNetwork(ctx=self.ctx)()
    ...
    class DnsResolversListByVirtualNetwork(AAZHttpOperation):

...
@register_command(
    "dns-resolver inbound-endpoint list",
)
class List(AAZCommand):
    """Lists inbound endpoints for a DNS resolver.

    :example: List inbound endpoints by DNS resolver
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.InboundEndpointsList(ctx=self.ctx)()
    ...
    class InboundEndpointsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            subnet = cls._schema_on_200.value.Element.properties.ip_configurations.Element.subnet

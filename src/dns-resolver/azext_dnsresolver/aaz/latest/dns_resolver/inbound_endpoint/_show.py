...
@register_command(
    "dns-resolver inbound-endpoint show",
)
class Show(AAZCommand):
    """Gets properties of an inbound endpoint for a DNS resolver.

    :example: Retrieve inbound endpoint for DNS resolver
    ...
    class InboundEndpointsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            subnet = cls._schema_on_200.properties.ip_configurations.Element.subnet

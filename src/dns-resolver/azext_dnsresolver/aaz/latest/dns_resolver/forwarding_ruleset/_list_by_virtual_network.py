...
@register_command(
    "dns-resolver forwarding-ruleset list-by-virtual-network",
)
class ListByVirtualNetwork(AAZCommand):
    ...
    class DnsForwardingRulesetsListByVirtualNetwork(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.virtual_network_link = AAZObjectType(
                serialized_name="virtualNetworkLink",
            )

            virtual_network_link = cls._schema_on_200.value.Element.properties.virtual_network_link
            virtual_network_link.id = AAZStrType(
                flags={"required": True},
            )

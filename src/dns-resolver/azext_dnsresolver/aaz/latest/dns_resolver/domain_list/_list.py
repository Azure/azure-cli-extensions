...
class List(AAZCommand):
    ...
    :example: List DNS resolver domain lists by subscription
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.DnsResolverDomainListsList(ctx=self.ctx)()
        if condition_1:
            self.DnsResolverDomainListsListByResourceGroup(ctx=self.ctx)()
    ...
    class DnsResolverDomainListsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            domains = cls._schema_on_200.value.Element.properties.domains
    ...
    class DnsResolverDomainListsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

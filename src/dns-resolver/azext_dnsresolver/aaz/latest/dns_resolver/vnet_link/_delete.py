...
class Delete(AAZCommand):
    ...
    :example: Delete virtual network link to a DNS forwarding ruleset
    ...
    def _execute_operations(self):
        yield self.VirtualNetworkLinksDelete(ctx=self.ctx)()

    class VirtualNetworkLinksDelete(AAZHttpOperation):

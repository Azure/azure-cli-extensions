...
@register_command(
    "dns-resolver policy dns-security-rule list",
)
class List(AAZCommand):
    """List DNS security rules for a DNS resolver policy.

    :example: List DNS security rules by DNS resolver policy
        az dns-resolver policy dns-security-rule list --resource-group sampleResourceGroup --dns-resolver-policy-name sampleDnsResolverPolicy
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DnsSecurityRulesList(ctx=self.ctx)()
    ...
    class DnsSecurityRulesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.dns_resolver_domain_lists.Element
            _element.id = AAZStrType(
                flags={"required": True},
            )

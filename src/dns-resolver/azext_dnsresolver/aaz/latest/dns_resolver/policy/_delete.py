...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DnsResolverPoliciesDelete(ctx=self.ctx)()
    ...
    class DnsResolverPoliciesDelete(AAZHttpOperation):

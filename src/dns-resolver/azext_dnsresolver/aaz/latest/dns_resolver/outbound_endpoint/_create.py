...
@register_command(
    "dns-resolver outbound-endpoint create",
)
class Create(AAZCommand):
    """Create an outbound endpoint for a DNS resolver.

    :example: Upsert outbound endpoint for DNS resolver
    ...
    class OutboundEndpointsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("subnet", AAZObjectType, ".", typ_kwargs={"flags": {"required": True}})

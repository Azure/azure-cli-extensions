...
@register_command(
    "dns-resolver outbound-endpoint list",
)
class List(AAZCommand):
    """Lists outbound endpoints for a DNS resolver.

    :example: List outbound endpoints by DNS resolver
    ...
    def _execute_operations(self):
        self.OutboundEndpointsList(ctx=self.ctx)()
    ...
    class OutboundEndpointsList(AAZHttpOperation):

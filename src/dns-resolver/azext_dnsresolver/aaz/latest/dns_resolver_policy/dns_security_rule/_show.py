...
@register_command(
    "dns-resolver-policy dns-security-rule show",
)
class Show(AAZCommand):
    """Get properties of a DNS security rule for a DNS resolver policy.

    :example: Retrieve DNS security rule for DNS resolver policy
        az dns-resolver-policy dns-security-rule show --resource-group sampleResourceGroup --dns-resolver-policy-name sampleDnsResolverPolicy --dns-security-rule-name sampleDnsSecurityRule
    """

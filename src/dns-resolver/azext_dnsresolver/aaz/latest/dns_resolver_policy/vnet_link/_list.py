...
@register_command(
    "dns-resolver-policy vnet-link list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DnsResolverPolicyVirtualNetworkLinksList(ctx=self.ctx)()
    ...
    class DnsResolverPolicyVirtualNetworkLinksList(AAZHttpOperation):

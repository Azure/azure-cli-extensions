...
class DnsForwardingRulesetsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        parameters,  # type: "models.DnsForwardingRuleset"
        if_match=None,  # type: Optional[str]
        if_none_match=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.DnsForwardingRuleset"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DnsForwardingRuleset"]]
        error_map = {
        ...
        body_content = self._serialize.body(parameters, 'DnsForwardingRuleset')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.DnsForwardingRuleset"]
        ...
        :return: An instance of LROPoller that returns either DnsForwardingRuleset or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.dnsresolver.models.DnsForwardingRuleset]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DnsForwardingRuleset"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        dns_forwarding_ruleset_name,  # type: str
        parameters,  # type: "models.DnsForwardingRulesetPatch"
        if_match=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.DnsForwardingRuleset"]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'DnsForwardingRulesetPatch')
        body_content_kwargs['content'] = body_content
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DnsForwardingRuleset"
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.DnsForwardingRulesetListResult"]
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either DnsForwardingRulesetListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.dnsresolver.models.DnsForwardingRulesetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DnsForwardingRulesetListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_by_virtual_network(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.VirtualNetworkDnsForwardingRulesetListResult"]
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either VirtualNetworkDnsForwardingRulesetListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.dnsresolver.models.VirtualNetworkDnsForwardingRulesetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkDnsForwardingRulesetListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_virtual_network.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),

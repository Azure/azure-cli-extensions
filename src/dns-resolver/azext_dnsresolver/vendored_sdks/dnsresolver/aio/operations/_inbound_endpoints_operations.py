...
class InboundEndpointsOperations:
    """InboundEndpointsOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        parameters: "models.InboundEndpoint",
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.InboundEndpoint"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.InboundEndpoint"]]
        error_map = {
        ...
        path_format_arguments = {
            ...
            'inboundEndpointName': self._serialize.url("inbound_endpoint_name", inbound_endpoint_name, 'str'),
        }
        ...
        body_content = self._serialize.body(parameters, 'InboundEndpoint')
    ...
    async def begin_create_or_update(
        ...
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.InboundEndpoint"]:
        ...
        :return: An instance of AsyncLROPoller that returns either InboundEndpoint or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.dnsresolver.models.InboundEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.InboundEndpoint"]
    ...
    async def _update_initial(
        ...
        dns_resolver_name: str,
        inbound_endpoint_name: str,
        parameters: "models.InboundEndpointPatch",
        if_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.InboundEndpoint"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.InboundEndpoint"]]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'InboundEndpointPatch')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.InboundEndpointListResult"]:
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either InboundEndpointListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.InboundEndpointListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.InboundEndpointListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

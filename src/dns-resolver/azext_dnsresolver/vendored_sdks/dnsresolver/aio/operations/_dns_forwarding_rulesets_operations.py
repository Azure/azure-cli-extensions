...
class DnsForwardingRulesetsOperations:
    ...
    async def _create_or_update_initial(
        ...
        parameters: "models.DnsForwardingRuleset",
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.DnsForwardingRuleset"]:
    ...
    async def begin_create_or_update(
        ...
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.DnsForwardingRuleset"]:
        ...
        :return: An instance of AsyncLROPoller that returns either DnsForwardingRuleset or the result of cls(response)
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        dns_forwarding_ruleset_name: str,
        parameters: "models.DnsForwardingRulesetPatch",
        if_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.DnsForwardingRuleset"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DnsForwardingRuleset"]]
    ...
    def list_by_resource_group(
        ...
        **kwargs
    ) -> AsyncIterable["models.DnsForwardingRulesetListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.DnsForwardingRulesetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_by_virtual_network(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.VirtualNetworkDnsForwardingRulesetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

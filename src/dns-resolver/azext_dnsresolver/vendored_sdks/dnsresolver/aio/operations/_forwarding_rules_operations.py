...
class ForwardingRulesOperations:
    ...
    async def create_or_update(
        ...
        parameters: "models.ForwardingRule",
        ...
        **kwargs
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ForwardingRule"]
        error_map = {
        ...
        path_format_arguments = {
            ...
            'forwardingRuleName': self._serialize.url("forwarding_rule_name", forwarding_rule_name, 'str'),
        }
        ...
        body_content = self._serialize.body(parameters, 'ForwardingRule')
    ...
    async def update(
        ...
        dns_forwarding_ruleset_name: str,
        forwarding_rule_name: str,
        parameters: "models.ForwardingRulePatch",
        if_match: Optional[str] = None,
        **kwargs
    ) -> "models.ForwardingRule":
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ForwardingRulePatch')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.ForwardingRuleListResult"]:
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ForwardingRuleListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.ForwardingRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ForwardingRuleListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class VirtualNetworkLinksOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.VirtualNetworkLink"]:
    ...
    async def begin_create_or_update(
        ...
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.VirtualNetworkLink"]:
    ...
    async def _update_initial(
        ...
        dns_forwarding_ruleset_name: str,
        virtual_network_link_name: str,
        parameters: "models.VirtualNetworkLinkPatch",
        if_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.VirtualNetworkLink"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.VirtualNetworkLink"]]
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.VirtualNetworkLinkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

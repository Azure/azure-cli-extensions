...
class OutboundEndpointsOperations:
    """OutboundEndpointsOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        parameters: "models.OutboundEndpoint",
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.OutboundEndpoint"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OutboundEndpoint"]]
        error_map = {
        ...
        path_format_arguments = {
            ...
            'outboundEndpointName': self._serialize.url("outbound_endpoint_name", outbound_endpoint_name, 'str'),
        }
        ...
        body_content = self._serialize.body(parameters, 'OutboundEndpoint')
    ...
    async def begin_create_or_update(
        ...
        if_none_match: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.OutboundEndpoint"]:
        ...
        :return: An instance of AsyncLROPoller that returns either OutboundEndpoint or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.dnsresolver.models.OutboundEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.OutboundEndpoint"]
    ...
    async def _update_initial(
        ...
        dns_resolver_name: str,
        outbound_endpoint_name: str,
        parameters: "models.OutboundEndpointPatch",
        if_match: Optional[str] = None,
        **kwargs
    ) -> Optional["models.OutboundEndpoint"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OutboundEndpoint"]]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'OutboundEndpointPatch')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.OutboundEndpointListResult"]:
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OutboundEndpointListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.OutboundEndpointListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.OutboundEndpointListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

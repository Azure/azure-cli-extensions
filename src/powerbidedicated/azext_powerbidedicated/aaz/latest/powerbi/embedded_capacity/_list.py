...
class List(AAZCommand):
    ...
    :example: List all capacities in default subscription.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.CapacitiesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.CapacitiesList(ctx=self.ctx)()
    ...
    class CapacitiesListByResourceGroup(AAZHttpOperation):
    ...
    class CapacitiesList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

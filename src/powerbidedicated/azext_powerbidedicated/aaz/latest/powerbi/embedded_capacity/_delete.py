...
class Delete(AAZCommand):
    ...
    :example: Delete a capacity in specified resource group.
        az powerbi embedded-capacity delete --resource-group "TestRG" --name "azsdktest"

    :example: Delete a capacity in specified resource group without prompt.
        az powerbi embedded-capacity delete --resource-group "TestRG" --name "azsdktest" -y

    :example: Delete a capacity in specified resource group without waiting.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CapacitiesDelete(ctx=self.ctx)()
    ...
    class CapacitiesDelete(AAZHttpOperation):

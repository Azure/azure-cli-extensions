...
class Create(AAZCommand):
    ...
    _args_cdi_config_props_create = None

    @classmethod
    def _build_args_cdi_config_props_create(cls, _schema):
        if cls._args_cdi_config_props_create is not None:
            _schema.application_configs = cls._args_cdi_config_props_create.application_configs
            _schema.engine_name = cls._args_cdi_config_props_create.engine_name
            _schema.engine_version = cls._args_cdi_config_props_create.engine_version
            return

        cls._args_cdi_config_props_create = AAZObjectArg()

        cdi_config_props_create = cls._args_cdi_config_props_create
        cdi_config_props_create.application_configs = AAZListArg(
            options=["application-configs"],
            help="ApplicationConfigs of the CDI or CDIE.",
            required=True,
        )
        cdi_config_props_create.engine_name = AAZStrArg(
            options=["engine-name"],
            help="EngineName of the application config.",
            required=True,
        )
        cdi_config_props_create.engine_version = AAZStrArg(
            options=["engine-version"],
            help="EngineVersion of the application config.",
            required=True,
        )

        application_configs = cls._args_cdi_config_props_create.application_configs
        application_configs.Element = AAZObjectArg()

        _element = cls._args_cdi_config_props_create.application_configs.Element
    ...
    class ServerlessRuntimesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if cdi_config_props is not None:
                _CreateHelper._build_schema_cdi_config_props_create(cdi_config_props.set_elements(AAZObjectType, "."))

            cdie_config_props = _builder.get(".properties.serverlessRuntimeConfig.cdieConfigProps")
            if cdie_config_props is not None:
                _CreateHelper._build_schema_cdi_config_props_create(cdie_config_props.set_elements(AAZObjectType, "."))
        ...
        def _build_schema_on_200_201(cls):
            ...
            advanced_custom_properties = cls._schema_on_200_201.properties.advanced_custom_properties
            advanced_custom_properties.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.advanced_custom_properties.Element
            _element.key = AAZStrType()
            _element.value = AAZStrType()

            serverless_runtime_config = cls._schema_on_200_201.properties.serverless_runtime_config
            ...
            cdi_config_props = cls._schema_on_200_201.properties.serverless_runtime_config.cdi_config_props
            cdi_config_props.Element = AAZObjectType()
            _CreateHelper._build_schema_cdi_config_props_read(cdi_config_props.Element)

            cdie_config_props = cls._schema_on_200_201.properties.serverless_runtime_config.cdie_config_props
            cdie_config_props.Element = AAZObjectType()
            _CreateHelper._build_schema_cdi_config_props_read(cdie_config_props.Element)

            serverless_runtime_network_profile = cls._schema_on_200_201.properties.serverless_runtime_network_profile
            ...
            network_interface_configuration = cls._schema_on_200_201.properties.serverless_runtime_network_profile.network_interface_configuration
            ...
            serverless_runtime_tags = cls._schema_on_200_201.properties.serverless_runtime_tags
            serverless_runtime_tags.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.serverless_runtime_tags.Element
            _element.name = AAZStrType()
            _element.value = AAZStrType()

            serverless_runtime_user_context_properties = cls._schema_on_200_201.properties.serverless_runtime_user_context_properties
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_cdi_config_props_create(cls, _builder):
        if _builder is None:
            return

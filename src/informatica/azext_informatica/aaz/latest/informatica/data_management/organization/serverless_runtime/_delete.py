...
@register_command(
    "informatica data-management organization serverless-runtime delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ServerlessRuntimesDelete(ctx=self.ctx)()
    ...
    class ServerlessRuntimesDelete(AAZHttpOperation):

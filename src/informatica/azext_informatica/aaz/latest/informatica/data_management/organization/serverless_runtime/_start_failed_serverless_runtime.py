...
@register_command(
    "informatica data-management organization serverless-runtime start-failed-serverless-runtime",
)
class StartFailedServerlessRuntime(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServerlessRuntimesStartFailedServerlessRuntime(ctx=self.ctx)()
    ...
    class ServerlessRuntimesStartFailedServerlessRuntime(AAZHttpOperation):
...
class _StartFailedServerlessRuntimeHelper:
    """Helper class for StartFailedServerlessRuntime"""


__all__ = ["StartFailedServerlessRuntime"]

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        condition_0 = has_value(self.ctx.args.rg) and has_value(self.ctx.subscription_id)
        condition_1 = has_value(self.ctx.subscription_id) and has_value(self.ctx.args.rg) is not True
        if condition_0:
    ...
    class OrganizationsListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            informatica_properties = cls._schema_on_200.value.Element.properties.informatica_properties
            ...
            link_organization = cls._schema_on_200.value.Element.properties.link_organization

...
@register_command(
    "informatica data-management organization serverless-runtime check-dependency",
)
class CheckDependency(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.serverless_runtime_name = AAZStrArg(
            options=["--serverless-runtime-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServerlessRuntimesCheckDependencies(ctx=self.ctx)()
    ...
    class ServerlessRuntimesCheckDependencies(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.references = AAZListType(
                flags={"required": True},
            )

            references = cls._schema_on_200.references
            references.Element = AAZObjectType()

            _element = cls._schema_on_200.references.Element
            _element.app_context_id = AAZStrType(
                serialized_name="appContextId",
                flags={"required": True},
            )
            _element.description = AAZStrType(
                flags={"required": True},
            )
            _element.document_type = AAZStrType(
...
class _CheckDependencyHelper:
    """Helper class for CheckDependency"""


__all__ = ["CheckDependency"]

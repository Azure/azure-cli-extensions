...
class AddWindowsVirtualDesktopHostpoolCreateRegistrationInfo(argparse.Action):
...
class AddWindowsVirtualDesktopHostpoolUpdateRegistrationInfo(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        action = self.get_action(values, option_string)
        namespace.registration_info = action

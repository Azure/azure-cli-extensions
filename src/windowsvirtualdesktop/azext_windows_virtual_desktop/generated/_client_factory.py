...
def cf_windows_virtual_desktop(cli_ctx, *_):
...
def cf_workspace(cli_ctx, *_):
    return cf_windows_virtual_desktop(cli_ctx).workspace


def cf_application_group(cli_ctx, *_):
    return cf_windows_virtual_desktop(cli_ctx).application_group


def cf_host_pool(cli_ctx, *_):
    return cf_windows_virtual_desktop(cli_ctx).host_pool

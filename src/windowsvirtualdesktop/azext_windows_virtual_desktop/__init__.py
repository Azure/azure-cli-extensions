...
from azext_windows_virtual_desktop.generated._help import helps  # pylint: disable=unused-import
...
class DesktopVirtualizationAPIClientCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_windows_virtual_desktop.generated._client_factory import cf_windows_virtual_desktop
    ...
    def load_command_table(self, args):
        ...
        try:
            from azext_windows_virtual_desktop.manual.commands import load_command_table as load_command_table_manual
    ...
    def load_arguments(self, command):
        from azext_windows_virtual_desktop.generated._params import load_arguments
        load_arguments(self, command)
        try:
            from azext_windows_virtual_desktop.manual._params import load_arguments as load_arguments_manual

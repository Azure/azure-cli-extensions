...
class VirtualNetworkGatewayNatRulesOperations:
    """VirtualNetworkGatewayNatRulesOperations async operations.
    ...
    async def get(
        ...
        nat_rule_name: str,
        **kwargs: Any
    ) -> "_models.VirtualNetworkGatewayNatRule":
        ...
        :rtype: ~azure.mgmt.network.v2021_03_01.models.VirtualNetworkGatewayNatRule
    ...
    async def _create_or_update_initial(
        ...
        virtual_network_gateway_name: str,
        nat_rule_name: str,
        nat_rule_parameters: "_models.VirtualNetworkGatewayNatRule",
        **kwargs: Any
    ) -> "_models.VirtualNetworkGatewayNatRule":
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualNetworkGatewayNatRule"]
        error_map = {
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type nat_rule_parameters: ~azure.mgmt.network.v2021_03_01.models.VirtualNetworkGatewayNatRule
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkGatewayNatRule or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_03_01.models.VirtualNetworkGatewayNatRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_virtual_network_gateway(
        ...
        virtual_network_gateway_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ListVirtualNetworkGatewayNatRulesResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ListVirtualNetworkGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class ServiceTagInformationOperations(object):
    ...
    def list(
        self,
        location,  # type: str
        no_address_prefixes=None,  # type: Optional[bool]
        tag_name=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.ServiceTagInformationListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_03_01.models.ServiceTagInformationListResult]

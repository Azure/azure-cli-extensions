...
try:
    ...
    from ._models import ApplicationGatewayGlobalConfiguration  # type: ignore
    ...
    from ._models import ApplicationGatewayLoadDistributionPolicy  # type: ignore
    from ._models import ApplicationGatewayLoadDistributionTarget  # type: ignore
    ...
    from ._models import LoadBalancerVipSwapRequest  # type: ignore

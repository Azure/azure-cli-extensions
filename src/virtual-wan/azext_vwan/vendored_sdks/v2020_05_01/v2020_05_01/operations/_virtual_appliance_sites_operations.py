...
class VirtualApplianceSitesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.VirtualApplianceSite"
    ...
    def _create_or_update_initial(
        ...
        network_virtual_appliance_name,  # type: str
        site_name,  # type: str
        parameters,  # type: "_models.VirtualApplianceSite"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualApplianceSite"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualApplianceSite"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VirtualApplianceSite"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either VirtualApplianceSite or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_05_01.models.VirtualApplianceSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualApplianceSite"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.NetworkVirtualApplianceSiteListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_05_01.models.NetworkVirtualApplianceSiteListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

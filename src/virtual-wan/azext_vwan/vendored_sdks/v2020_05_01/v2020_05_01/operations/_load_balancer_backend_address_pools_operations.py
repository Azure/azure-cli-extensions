...
class LoadBalancerBackendAddressPoolsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_05_01.models.LoadBalancerBackendAddressPoolListResult]
    ...
    def _create_or_update_initial(
        ...
        load_balancer_name,  # type: str
        backend_address_pool_name,  # type: str
        parameters,  # type: "_models.BackendAddressPool"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BackendAddressPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.BackendAddressPool"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.BackendAddressPool"]
        ...
        :return: An instance of LROPoller that returns either BackendAddressPool or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_05_01.models.BackendAddressPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
class FirewallPolicyRuleCollectionGroupsOperations(object):
    ...
    def _delete_initial(
        ...
        rule_collection_group_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.FirewallPolicyRuleCollectionGroup"
    ...
    def _create_or_update_initial(
        ...
        firewall_policy_name,  # type: str
        rule_collection_group_name,  # type: str
        parameters,  # type: "_models.FirewallPolicyRuleCollectionGroup"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.FirewallPolicyRuleCollectionGroup"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.FirewallPolicyRuleCollectionGroup"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.FirewallPolicyRuleCollectionGroup"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either FirewallPolicyRuleCollectionGroup or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_05_01.models.FirewallPolicyRuleCollectionGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.FirewallPolicyRuleCollectionGroup"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.FirewallPolicyRuleCollectionGroupListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_05_01.models.FirewallPolicyRuleCollectionGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class VirtualNetworkTapsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_05_01.models.VirtualNetworkTap
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_05_01.models.VirtualNetworkTap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualNetworkTap"]
    ...
    def update_tags(
        ...
        **kwargs  # type: Any
        ...
        :type tap_parameters: ~azure.mgmt.network.v2020_05_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkTap, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_05_01.models.VirtualNetworkTap
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_05_01.models.VirtualNetworkTapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

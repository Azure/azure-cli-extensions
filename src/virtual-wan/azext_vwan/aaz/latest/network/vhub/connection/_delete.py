...
class Delete(AAZCommand):
    ...
    :example: Delete a virtual hub VNet connection.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.HubVirtualNetworkConnectionsDelete(ctx=self.ctx)()
    ...
    class HubVirtualNetworkConnectionsDelete(AAZHttpOperation):

...
class List(AAZCommand):
    ...
    :example: List VNet connections in a given virtual hub.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.HubVirtualNetworkConnectionsList(ctx=self.ctx)()
    ...
    class HubVirtualNetworkConnectionsList(AAZHttpOperation):

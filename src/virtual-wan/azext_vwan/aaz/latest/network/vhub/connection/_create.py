...
class Create(AAZCommand):
    ...
    :example: Create a virtual hub VNet connection without routing configuration.
        az network vhub connection create -n MyConnection --vhub-name MyHub -g MyRG --remote-vnet MyVNet

    :example: Create a virtual hub VNet connection with routing configuration.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.remote_vnet_transit = AAZBoolArg(
            options=["--remote-vnet-transit"],
            help="Deprecated: Enable hub to remote VNet transit.",
        )
        _args_schema.use_hub_vnet_gateways = AAZBoolArg(
            options=["--use-hub-vnet-gateways"],
            help="Deprecated: Allow remote VNet to use hub's VNet gateways.",
        )
        ...
        _args_schema.static_routes = AAZListArg(
        ...
        address_prefixes = cls._args_schema.static_routes.Element.address_prefixes
        address_prefixes.Element = AAZStrArg()

        # define Arg Group "VnetRoutes"
        return cls._args_schema
    ...
    class HubVirtualNetworkConnectionsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("allowHubToRemoteVnetTransit", AAZBoolType, ".remote_vnet_transit")
                properties.set_prop("allowRemoteVnetToUseHubVnetGateways", AAZBoolType, ".use_hub_vnet_gateways")
            ...
            if routing_configuration is not None:
                ...
                routing_configuration.set_prop("vnetRoutes", AAZObjectType)
            ...
            if _elements is not None:
                ...
                _elements.set_prop("name", AAZStrType, ".route_name")
                _elements.set_prop("nextHopIpAddress", AAZStrType, ".next_hop")

...
@register_command(
    "network vhub routing-intent show",
    is_preview=True,
)
class Show(AAZCommand):
    """Retrieve the details of a routing intent.

    :example: Retrieve the details of a routing intent.
    ...
    def _execute_operations(self):
        self.RoutingIntentGet(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class RoutingIntentGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            routing_policies = cls._schema_on_200.properties.routing_policies
            routing_policies.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.routing_policies.Element
            ...
            destinations = cls._schema_on_200.properties.routing_policies.Element.destinations

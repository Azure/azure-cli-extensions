...
@register_command(
    "network vhub routing-intent update",
    is_preview=True,
)
class Update(AAZCommand):
    """Update a routing intent in the virtual hub.

    :example: Update a routing intent in the virtual hub.
    ...
    class RoutingIntentGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_routing_intent_read(cls._schema_on_200)
    ...
    class RoutingIntentCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _build_schema_routing_intent_read(cls._schema_on_200_201)
...
_schema_routing_intent_read = None


def _build_schema_routing_intent_read(_schema):
    global _schema_routing_intent_read
    if _schema_routing_intent_read is not None:
        _schema.etag = _schema_routing_intent_read.etag
        _schema.id = _schema_routing_intent_read.id
        _schema.name = _schema_routing_intent_read.name
        _schema.properties = _schema_routing_intent_read.properties
        _schema.type = _schema_routing_intent_read.type
        return

    _schema_routing_intent_read = AAZObjectType()

    routing_intent_read = _schema_routing_intent_read
    routing_intent_read.etag = AAZStrType(
        flags={"read_only": True},
    )
    routing_intent_read.id = AAZStrType()
    routing_intent_read.name = AAZStrType()
    routing_intent_read.properties = AAZObjectType(
        flags={"client_flatten": True},
    )
    routing_intent_read.type = AAZStrType(
        flags={"read_only": True},
    )

    properties = _schema_routing_intent_read.properties
    ...
    routing_policies = _schema_routing_intent_read.properties.routing_policies
    routing_policies.Element = AAZObjectType()

    _element = _schema_routing_intent_read.properties.routing_policies.Element
    ...
    destinations = _schema_routing_intent_read.properties.routing_policies.Element.destinations

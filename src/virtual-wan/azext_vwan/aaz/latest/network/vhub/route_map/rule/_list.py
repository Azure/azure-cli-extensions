...
@register_command(
    "network vhub route-map rule list",
)
class List(AAZCommand):
    """List route map rules

    :example: List route map rules
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.rules

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.rules = value
            return
    ...
    class RouteMapsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_route_map_read(cls._schema_on_200)

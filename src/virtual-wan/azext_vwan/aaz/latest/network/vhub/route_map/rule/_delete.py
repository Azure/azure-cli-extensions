...
@register_command(
    "network vhub route-map rule delete",
...
class Delete(AAZCommand):
    ...
    class RouteMapsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _DeleteHelper._build_schema_route_map_read(cls._schema_on_200)
    ...
    class RouteMapsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _DeleteHelper._build_schema_route_map_read(cls._schema_on_200_201)

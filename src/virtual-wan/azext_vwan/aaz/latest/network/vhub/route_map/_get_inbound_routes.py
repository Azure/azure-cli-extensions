...
@register_command(
    "network vhub route-map get-inbound-routes",
)
class GetInboundRoutes(AAZCommand):
    """Get the inbound routes configured for the Virtual Hub on a particular connection.

    :example: Get inbound routes
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "GetInboundRoutesParameters"

        _args_schema = cls._args_schema
        _args_schema.connection_type = AAZStrArg(
            options=["--connection-type"],
            arg_group="GetInboundRoutesParameters",
        ...
        _args_schema.resource_uri = AAZStrArg(
            ...
            arg_group="GetInboundRoutesParameters",
            help="The connection resource whose inbound routes are being requested.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualHubsGetInboundRoutes(ctx=self.ctx)()
    ...
    class VirtualHubsGetInboundRoutes(AAZHttpOperation):
...
class _GetInboundRoutesHelper:
    """Helper class for GetInboundRoutes"""


__all__ = ["GetInboundRoutes"]

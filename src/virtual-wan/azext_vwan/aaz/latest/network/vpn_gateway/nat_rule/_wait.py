...
@register_command(
    "network vpn-gateway nat-rule wait",
)
class Wait(AAZWaitCommand):
    ...
    class NatRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_sub_resource_read(egress_vpn_site_link_connections.Element)
            ...
            _WaitHelper._build_schema_sub_resource_read(ingress_vpn_site_link_connections.Element)

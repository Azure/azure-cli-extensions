...
class List(AAZCommand):
    ...
    :example: List site-to-site VPN gateways.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.VpnGatewaysListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.VpnGatewaysList(ctx=self.ctx)()
    ...
    class VpnGatewaysListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.connections.Element
            _element.etag = AAZStrType(
                flags={"read_only": True},
            )
            _element.id = AAZStrType()
            ...
            properties = cls._schema_on_200.value.Element.properties.connections.Element.properties
            ...
            ipsec_policies = cls._schema_on_200.value.Element.properties.connections.Element.properties.ipsec_policies
            ipsec_policies.Element = AAZObjectType()
            _build_schema_ipsec_policy_read(ipsec_policies.Element)

            routing_configuration = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration
            ...
            propagated_route_tables = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.propagated_route_tables
            propagated_route_tables.ids = AAZListType()
            propagated_route_tables.labels = AAZListType()

            ids = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.propagated_route_tables.ids
            ids.Element = AAZObjectType()
            _build_schema_sub_resource_read(ids.Element)

            labels = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.propagated_route_tables.labels
            labels.Element = AAZStrType()

            vnet_routes = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes
            ...
            bgp_connections = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes.bgp_connections
            bgp_connections.Element = AAZObjectType()
            _build_schema_sub_resource_read(bgp_connections.Element)

            static_routes = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes.static_routes
            static_routes.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes.static_routes.Element
            ...
            address_prefixes = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes.static_routes.Element.address_prefixes
            address_prefixes.Element = AAZStrType()

            static_routes_config = cls._schema_on_200.value.Element.properties.connections.Element.properties.routing_configuration.vnet_routes.static_routes_config
            ...
            traffic_selector_policies = cls._schema_on_200.value.Element.properties.connections.Element.properties.traffic_selector_policies
            traffic_selector_policies.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.connections.Element.properties.traffic_selector_policies.Element
            ...
            local_address_ranges = cls._schema_on_200.value.Element.properties.connections.Element.properties.traffic_selector_policies.Element.local_address_ranges
            local_address_ranges.Element = AAZStrType()

            remote_address_ranges = cls._schema_on_200.value.Element.properties.connections.Element.properties.traffic_selector_policies.Element.remote_address_ranges
            remote_address_ranges.Element = AAZStrType()

            vpn_link_connections = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections
            vpn_link_connections.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element
            _element.etag = AAZStrType(
                flags={"read_only": True},
            )
            _element.id = AAZStrType()
            ...
            properties = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties
            properties.connection_bandwidth = AAZIntType(
                serialized_name="connectionBandwidth",
            )
            properties.connection_status = AAZStrType(
            ...
            egress_nat_rules = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties.egress_nat_rules
            egress_nat_rules.Element = AAZObjectType()
            _build_schema_sub_resource_read(egress_nat_rules.Element)

            ingress_nat_rules = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties.ingress_nat_rules
            ingress_nat_rules.Element = AAZObjectType()
            _build_schema_sub_resource_read(ingress_nat_rules.Element)

            ipsec_policies = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties.ipsec_policies
            ipsec_policies.Element = AAZObjectType()
            _build_schema_ipsec_policy_read(ipsec_policies.Element)

            vpn_gateway_custom_bgp_addresses = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties.vpn_gateway_custom_bgp_addresses
            vpn_gateway_custom_bgp_addresses.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.connections.Element.properties.vpn_link_connections.Element.properties.vpn_gateway_custom_bgp_addresses.Element
            ...
            egress_vpn_site_link_connections = cls._schema_on_200.value.Element.properties.nat_rules.Element.properties.egress_vpn_site_link_connections
            ...
            ingress_vpn_site_link_connections = cls._schema_on_200.value.Element.properties.nat_rules.Element.properties.ingress_vpn_site_link_connections
    ...
    class VpnGatewaysList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
def load_command_table(self, _):
    ...
    network_vhub_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VirtualHubsOperations.{}',
    ...
    network_vhub_connection_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#HubVirtualNetworkConnectionsOperations.{}',
    ...
    network_vhub_bgpconnection_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VirtualHubBgpConnectionOperations.{}',
        client_factory=cf_virtual_hub_bgpconnection,
        resource_type=CUSTOM_VWAN
    )

    network_vhub_route_table_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VirtualHubRouteTableV2SOperations.{}',
    ...
    network_vwan_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VirtualWansOperations.{}',
    ...
    network_vpn_gateway_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VpnGatewaysOperations.{}',
        client_factory=cf_vpn_gateways,
        min_api='2018-08-01'
    )

    network_vpn_gateway_connection_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VpnConnectionsOperations.{}',
        client_factory=cf_vpn_gateway_connection,
        min_api='2020-05-01'
    )

    network_vpn_site_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VpnSitesOperations.{}',
        client_factory=cf_vpn_sites,
        min_api='2018-08-01'
    )

    network_vpn_site_config_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VpnSitesConfigurationOperations.{}',
        client_factory=cf_vpn_site_configs,
        min_api='2018-08-01'
    )

    network_vpn_server_config_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#VpnServerConfigurationsOperations.{}',
    ...
    network_p2s_vpn_gateway_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_03_01.operations#P2SVpnGatewaysOperations.{}',

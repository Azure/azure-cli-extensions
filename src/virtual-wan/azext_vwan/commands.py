...
from .profiles import CUSTOM_VWAN, CUSTOM_VWAN_2021_02_01
...
def load_command_table(self, _):
    ...
    network_vhub_bgpconnection_sdk = CliCommandType(
        operations_tmpl='azext_vwan.vendored_sdks.v2021_02_01.v2021_02_01.operations#VirtualHubBgpConnectionOperations.{}',
        client_factory=cf_virtual_hub_bgpconnection,
        resource_type=CUSTOM_VWAN_2021_02_01
    )

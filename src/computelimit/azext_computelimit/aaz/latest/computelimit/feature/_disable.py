...
class Disable(AAZCommand):
    ...
    :example: Disable a compute limit feature
        az computelimit feature disable --location eastus --feature-name SharedComputeLimit
    """

    _aaz_info = {
        "version": "2026-07-31",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.computelimit/locations/{}/features/{}/disable", "2026-07-31"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.FeaturesDisable(ctx=self.ctx)()
    ...
    class FeaturesDisable(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeLimit/locations/{location}/features/{featureName}/disable",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _DisableHelper._build_schema_operation_status_result_read(cls._schema_on_200)

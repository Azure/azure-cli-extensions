...
class Enable(AAZCommand):
    ...
    :example: Enable a compute limit feature
        az computelimit feature enable --location eastus --feature-name SharedComputeLimit
    """

    _aaz_info = {
        "version": "2026-07-31",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.computelimit/locations/{}/features/{}/enable", "2026-07-31"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.service_tree_id = AAZStrArg(
            options=["--service-tree-id"],
            arg_group="Body",
            help="The Service Tree identifier associated with this feature action.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.FeaturesEnable(ctx=self.ctx)()
    ...
    class FeaturesEnable(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeLimit/locations/{location}/features/{featureName}/enable",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("serviceTreeId", AAZStrType, ".service_tree_id")
        ...
        def _build_schema_on_200(cls):
            ...
            _EnableHelper._build_schema_operation_status_result_read(cls._schema_on_200)

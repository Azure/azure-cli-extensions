...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GuestSubscriptionsListBySubscriptionLocationResource(ctx=self.ctx)()
    ...
    class GuestSubscriptionsListBySubscriptionLocationResource(AAZHttpOperation):

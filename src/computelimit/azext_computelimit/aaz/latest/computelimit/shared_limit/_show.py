...
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SharedLimitsGet(ctx=self.ctx)()
    ...
    class SharedLimitsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            resource_name = cls._schema_on_200.properties.resource_name

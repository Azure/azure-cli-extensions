...
class List(AAZCommand):
    ...
    :example: List all shared limits
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SharedLimitsListBySubscriptionLocationResource(ctx=self.ctx)()
    ...
    class SharedLimitsListBySubscriptionLocationResource(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            resource_name = cls._schema_on_200.value.Element.properties.resource_name

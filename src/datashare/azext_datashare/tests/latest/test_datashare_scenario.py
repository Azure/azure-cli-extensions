...
def step__datasetmappings_put_datasetmappings_sqldwdatasettoadlsgen2file_create(test, rg):
    test.cmd('az datashare data-set-mapping create '
             '--account-name "{Account1}" '
             '--a-d-l-s-gen2-file-data-set-mapping data-set-id="a08f184b-0567-4b11-ba22-a1199336d226" file-path="file21'
             '" file-system="fileSystem" output-type="Csv" resource-group="SampleResourceGroup" storage-account-name="s'
             'torage2" subscription-id="433a8dfd-e5d5-4e77-ad86-90acdc75eb1a" '
             '--name "{DatasetMapping1}" '
             '--resource-group "{rg}" '
             '--share-subscription-name "{ShareSubscription1}"',
             checks=[])
...
def step__datasetmappings_put_datasetmappings_sqldw_create(test, rg):
    test.cmd('az datashare data-set-mapping create '
             '--account-name "{Account1}" '
             '--sql-d-w-table-data-set-mapping data-set-id="a08f184b-0567-4b11-ba22-a1199336d226" data-warehouse-name="'
             'DataWarehouse1" schema-name="dbo" sql-server-resource-id="/subscriptions/{subscription_id}/resourceGroups'
...
def step__datasets_put_datasets_sqldwtable_create(test, rg):
    test.cmd('az datashare data-set create '
             '--account-name "{Account1}" '
             '--sql-d-w-table-data-set data-warehouse-name="DataWarehouse1" schema-name="dbo" sql-server-resource-id="/'
             'subscriptions/{subscription_id}/resourceGroups/{rg}/providers/Microsoft.Sql/servers/Server1" table-name="'
             'Table1" '
             '--name "{Dataset1}" '
             '--resource-group "{rg}" '
             '--share-name "{Share1}"',
...
class DataShareManagementClientScenarioTest(ScenarioTest):
    ...
    def test_datashare(self, rg):
        ...
        self.kwargs.update({
            ...
            'ShareSubscriptions_2': 'Share1',
            'ShareSubscriptions_3': 'ShareSub1',
            'Dataset1': 'Dataset1',
            'SynchronizationSettings_2': 'SyncrhonizationSetting1',
            'Trigger1': 'Trigger1',
            'Dataset1': 'Dataset1',

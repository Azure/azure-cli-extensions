...
class DataShareManagementClientScenarioTest(ScenarioTest):
    ...
    def test_datashare(self, resource_group):
        ...
        datashareAccount = self.cmd('az datashare account create '
                                    ...
                                    '--name "{Account1}" '
                                    '--resource-group "{rg}"',
                                    checks=[JMESPathCheck('name', self.kwargs.get('Account1', '')),
                                            JMESPathCheck('location', 'westus2'),
                                            #  JMESPathCheck('provisioningState', 'Succeeded'),
                                            JMESPathCheck('resourceGroup', self.kwargs.get('rg', '')),
                                            JMESPathCheck('tags', '{\'tag1\': \'Red\', \'tag2\': \'White\'}'),
                                            ]).get_output_in_json()
        ...
        self.cmd('az datashare account list '
                 '--resource-group "{rg}"',
                 checks=[JMESPathCheck("[?id=='{}'].name | [0]".format(accountId), self.kwargs.get('Account1', '')),
                         JMESPathCheck("[?id=='{}'].location | [0]".format(accountId), 'westus2'),
                        #  JMESPathCheck("[?id=='{}'].provisioningState | [0]".format(accountId), 'Succeeded'),
                         JMESPathCheck("[?id=='{}'].resourceGroup | [0]".format(accountId), self.kwargs.get('rg', '')),
                         JMESPathCheck("[?id=='{}'].tags | [0]".format(accountId), '{\'tag1\': \'Red\', \'tag2\': \'White\'}'),
                         ])

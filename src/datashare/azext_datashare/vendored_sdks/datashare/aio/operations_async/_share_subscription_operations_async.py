...
class ShareSubscriptionOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.ShareSubscription"] = kwargs.pop('cls', None )
    ...
    def list_by_account(
        ...
        **kwargs
        ...
        :raises: ~data_share_management_client.models.DataShareErrorException:
        """
        cls: ClsType["models.ShareSubscriptionList"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-11-01"
    ...
    def list_source_share_synchronization_setting(
        ...
        **kwargs
        ...
        :raises: ~data_share_management_client.models.DataShareErrorException:
        """
        cls: ClsType["models.SourceShareSynchronizationSettingList"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-11-01"
    ...
    def list_synchronization(
        ...
        **kwargs
        ...
        :raises: ~data_share_management_client.models.DataShareErrorException:
        """
        cls: ClsType["models.ShareSubscriptionSynchronizationList"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2019-11-01"
    ...
    def list_synchronization_detail(
        ...
        **kwargs
        ...
        :raises: ~data_share_management_client.models.DataShareErrorException:
        """
        cls: ClsType["models.SynchronizationDetailsList"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
    ...
    async def _synchronize_initial(
        ...
        **kwargs
        ...
        cls: ClsType["models.ShareSubscriptionSynchronization"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})

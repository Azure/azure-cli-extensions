    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'account-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter adls-gen1-file-data-set. All possible keys are:'
                    ' account-name, file-name, folder-path, resource-group, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'account-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter adls-gen1-folder-data-set. All possible keys are:'
                    ' account-name, folder-path, resource-group, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'file-path':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter adls-gen2-file-data-set. All possible keys are:'
                    ' file-path, file-system, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'file-system':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter adls-gen2-file-system-data-set. All possible keys'
                    ' are: file-system, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'file-system':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter adls-gen2-folder-data-set. All possible keys are:'
                    ' file-system, folder-path, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'container-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter blob-container-data-set. All possible keys are:'
                    ' container-name, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'container-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter blob-data-set. All possible keys are: container-name,'
                    ' file-path, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'container-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter blob-folder-data-set. All possible keys are:'
                    ' container-name, prefix, resource-group, storage-account-name, subscription-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'kusto-cluster-resource-id':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter kusto-cluster-data-set. All possible keys are:'
                    ' kusto-cluster-resource-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'kusto-database-resource-id':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter kusto-database-data-set. All possible keys are:'
                    ' kusto-database-resource-id'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'database-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter sqldb-table-data-set. All possible keys are:'
                    ' database-name, schema-name, sql-server-resource-id, table-name'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'data-warehouse-name':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter sqldw-table-data-set. All possible keys are:'
                    ' data-warehouse-name, schema-name, sql-server-resource-id, table-name'.format(k)
                )
    ...
    def get_action(self, values, option_string):
        ...
        for k in properties:
            ...
            if kl == 'synapse-workspace-sql-pool-table-resource-id':
                ...
                raise CLIError(
                    'Unsupported Key {} is provided for parameter synapse-workspace-sql-pool-table-data-set. All'
                    ' possible keys are: synapse-workspace-sql-pool-table-resource-id'.format(k)
                )

...
helps['datashare share show'] = """
    ...
    examples:
      - name: Shares_Get
        text: |-
               az datashare share show --account-name "Account1" --resource-group "SampleResourceGroup" --name \
"Share1"
"""
...
helps['datashare share create'] = """
    ...
    examples:
      - name: Shares_Create
        text: |-
               az datashare share create --account-name "Account1" --resource-group "SampleResourceGroup" \
--description "share description" --share-kind "CopyBased" --terms "Confidential" --name "Share1"
"""
...
helps['datashare share delete'] = """
    ...
    examples:
      - name: Shares_Delete
        text: |-
               az datashare share delete --account-name "Account1" --resource-group "SampleResourceGroup" --name \
"Share1"
"""
...
helps['datashare share wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datashare share is successfully deleted.
        text: |-
               az datashare share wait --account-name "Account1" --resource-group "SampleResourceGroup" --name \
"Share1" --deleted
"""
...
helps['datashare provider-share-subscription get-by-share'] = """
    ...
    examples:
      - name: ProviderShareSubscriptions_GetByShare
        text: |-
               az datashare provider-share-subscription get-by-share --account-name "Account1" \
...
"SampleResourceGroup" --share-name "Share1" --name "SyncrhonizationSetting1"
"""
...
"SampleResourceGroup" --share-name "Share1" --name "SyncrhonizationSetting1" --deleted
"""

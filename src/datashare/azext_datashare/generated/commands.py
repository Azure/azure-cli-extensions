...
def load_command_table(self, _):
    ...
    with self.command_group('datashare data-set-mapping', datashare_data_set_mapping,
                            client_factory=cf_data_set_mapping, is_experimental=True) as g:
    ...
    with self.command_group('datashare share', datashare_share, client_factory=cf_share, is_experimental=True) as g:
        ...
        g.custom_wait_command('wait', 'datashare_share_show')
    ...
    with self.command_group('datashare provider-share-subscription', datashare_provider_share_subscription,
        ...
        g.custom_command('get-by-share', 'datashare_provider_share_subscription_get_by_share')
        g.custom_command('reinstate', 'datashare_provider_share_subscription_reinstate')
        g.custom_command('revoke', 'datashare_provider_share_subscription_revoke')
    ...
    with self.command_group('datashare share-subscription', datashare_share_subscription,
                            client_factory=cf_share_subscription, is_experimental=True) as g:
    ...
    with self.command_group('datashare consumer-source-data-set', datashare_consumer_source_data_set,
                            client_factory=cf_consumer_source_data_set, is_experimental=True) as g:
    ...
    with self.command_group('datashare trigger', datashare_trigger, client_factory=cf_trigger,
                            is_experimental=True) as g:

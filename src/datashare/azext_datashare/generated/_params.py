...
def load_arguments(self, _):
    ...
    with self.argument_context('datashare data-set-mapping show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the share account.', id_part='name')
        c.argument('share_subscription_name', type=str, help='The name of the shareSubscription.', id_part=''
                   'child_name_1')
        c.argument('data_set_mapping_name', options_list=['--name', '-n', '--data-set-mapping-name'], type=str, help=''
                   'The name of the dataSetMapping.', id_part='child_name_2')
    ...
    with self.argument_context('datashare provider-share-subscription get-by-share') as c:
        ...
        c.argument('account_name', type=str, help='The name of the share account.', id_part='name')
        c.argument('share_name', type=str, help='The name of the share.', id_part='child_name_1')
        c.argument('provider_share_subscription_id', type=str, help='To locate shareSubscription', id_part=''
                   'child_name_2')

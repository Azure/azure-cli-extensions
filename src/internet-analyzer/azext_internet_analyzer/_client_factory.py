...
def cf_internet-analyzer(cli_ctx, *_):
...
def cf_network_experiment_profiles(cli_ctx, *_):
    return cf_internet-analyzer(cli_ctx).network_experiment_profiles


def cf_experiments(cli_ctx, *_):
    return cf_internet-analyzer(cli_ctx).experiments


def cf_front_doors(cli_ctx, *_):
    return cf_internet-analyzer(cli_ctx).front_doors


def cf_policies(cli_ctx, *_):
    return cf_internet-analyzer(cli_ctx).policies

...
class ConnectToSourceOracleTaskProperties(ProjectTaskProperties):
    ...
    :type input:
     ~azure.mgmt.datamigration.models.ConnectToSourceOracleTaskInput
    ...
    _attribute_map = {
        ...
        'input': {'key': 'input', 'type': 'ConnectToSourceOracleTaskInput'},
        'output': {'key': 'output', 'type': '[ConnectToSourceNonSqlTaskOutput]'},
    }

    def __init__(self, input=None):
        super(ConnectToSourceOracleTaskProperties, self).__init__()
        self.input = input
        self.output = None
        self.task_type = 'ConnectToSource.Oracle'

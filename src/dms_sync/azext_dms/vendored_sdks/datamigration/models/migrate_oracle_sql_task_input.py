...
class MigrateOracleSqlTaskInput(NonSqlMigrationTaskInput):
    ...
    def __init__(self, target_connection_info, target_database_name, project_name, project_location, selected_tables, source_connection_info):
        super(MigrateOracleSqlTaskInput, self).__init__(target_connection_info=target_connection_info, target_database_name=target_database_name, project_name=project_name, project_location=project_location, selected_tables=selected_tables)

...
class OracleDataMigrationProjectMetadata(DataMigrationProjectMetadata):
    ...
    :ivar source_sid: Oracle server SID
    :vartype source_sid: str
    """
    ...
    _attribute_map = {
        ...
        'source_sid': {'key': 'sourceSID', 'type': 'str'},
    }

    def __init__(self):
        super(OracleDataMigrationProjectMetadata, self).__init__()

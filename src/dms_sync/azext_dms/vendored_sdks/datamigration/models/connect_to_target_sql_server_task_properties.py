...
class ConnectToTargetSqlServerTaskProperties(ProjectTaskProperties):
    """Properties for the task that validates connection to SQL Server and target
    server requirements.
    ...
    :type input:
     ~azure.mgmt.datamigration.models.ConnectToTargetSqlServerTaskInput
    :ivar output: Task output. This is ignored if submitted.
    :vartype output:
     list[~azure.mgmt.datamigration.models.ConnectToTargetSqlServerTaskOutput]
    """
    ...
    _attribute_map = {
        ...
        'input': {'key': 'input', 'type': 'ConnectToTargetSqlServerTaskInput'},
        'output': {'key': 'output', 'type': '[ConnectToTargetSqlServerTaskOutput]'},
    }

    def __init__(self, input=None):
        super(ConnectToTargetSqlServerTaskProperties, self).__init__()
        self.input = input
        self.output = None
        self.task_type = 'ConnectToTarget.SqlServer'

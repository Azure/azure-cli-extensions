<<<<<<< HEAD:src/vm-repair/azext_vm_repair/scripts/mount-encrypted-disk.sh
#!/bin/bash
setlog () {
...
mount_encrypted
remount_boot
>>>>>>> 65cec441c03bf85e88bf28dc0ae76727eaadecf4:src/vm-repair/azext_vm_repair/scripts/linux-mount-encrypted-disk.sh

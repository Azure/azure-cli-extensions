...
helps['vm repair'] = """
    ...
    long-summary: |
        VM repair scripts will enable Azure users to self-repair non-connectable VMs by copying the source VM's OS disk and attaching it to a newly created repair VM.
"""

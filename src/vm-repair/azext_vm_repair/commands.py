...
def load_command_table(self, _):
    ...
    with self.command_group('vm repair') as g:
        ...
        g.custom_command('reset-nic', 'reset_nic', validator=validate_reset_nic)
        g.custom_command('repair-and-restore', 'repair_and_restore')
        g.custom_command('repair-button', 'repair_button')

...
class SourceConfiguration(msrest.serialization.Model):
    ...
    :param type: The type of setting. One of appSettings, connectionStrings, serviceBindings.
     Possible values include: "appSettings", "connectionStrings", "serviceBindings".
    :type type: str or ~microsoft_service_linker.models.Type
    :param link_config: The configuration of the linker for appSettings or connectionStrings or
     serviceBindings.
    :type link_config: object
    """

    _attribute_map = {
        'type': {'key': 'type', 'type': 'str'},
        'link_config': {'key': 'linkConfig', 'type': 'object'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        link_config: Optional[object] = None,
        **kwargs
    ):
...
class SourceConfigurationResult(msrest.serialization.Model):
    ...
    :param source_configurations: The configuration properties for source resource.
    :type source_configurations: list[~microsoft_service_linker.models.SourceConfiguration]
    """

    _attribute_map = {
        'source_configurations': {'key': 'sourceConfigurations', 'type': '[SourceConfiguration]'},
    }

    def __init__(
        self,
        *,
        source_configurations: Optional[List["SourceConfiguration"]] = None,
        **kwargs
    ):

...
class SourceConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.link_config = kwargs.get('link_config', None)
...
class SourceConfigurationResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.source_configurations = kwargs.get('source_configurations', None)
...
class ValidateResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.link_status = kwargs.get('link_status', None)

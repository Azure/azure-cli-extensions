...
class WebTest(WebtestsResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype kind: str or ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestKind
    ...
    :vartype web_test_kind: str or
     ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestKind
    ...
    :vartype locations:
     list[~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestGeolocation]
    :ivar configuration: An XML configuration specification for a WebTest.
    :vartype configuration:
     ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestPropertiesConfiguration
    ...
    :vartype request:
     ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestPropertiesRequest
    :ivar validation_rules: The collection of validation rule properties.
    :vartype validation_rules:
     ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestPropertiesValidationRules
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword kind: The kind of WebTest that this web test watches. Choices are ping, multistep and
         standard. Known values are: "ping", "multistep", and "standard".
        :paramtype kind: str or ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestKind
...
class WebTestListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTest]
    ...
    def __init__(self, *, value: List["_models.WebTest"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTest]
...
class WebTestPropertiesRequest(msrest.serialization.Model):
    ...
    :vartype headers: list[~azure.mgmt.applicationinsights.v2022_06_15_only.models.HeaderField]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype headers: list[~azure.mgmt.applicationinsights.v2022_06_15_only.models.HeaderField]
...
class WebTestPropertiesValidationRules(msrest.serialization.Model):
    ...
    :vartype content_validation:
     ~azure.mgmt.applicationinsights.v2022_06_15_only.models.WebTestPropertiesValidationRulesContentValidation

...
class WorkItemConfigurationsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either WorkItemConfigurationsListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.applicationinsights.v2015_05_01.models.WorkItemConfigurationsListResult]
    ...
    async def create(
        ...
        **kwargs
        ...
        :type work_item_configuration_properties: ~azure.mgmt.applicationinsights.v2015_05_01.models.WorkItemCreateConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response

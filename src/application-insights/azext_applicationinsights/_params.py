...
def load_arguments(self, _):
    ...
    with self.argument_context('monitor app-insights component connect-webapp') as c:
        ...
        c.argument('enable_snapshot_debugger', help='Enable snapshot debugger when an exception is thrown. Currently it is only supported for .NET/.NET Core Web Apps.', arg_type=get_three_state_flag())

...
def update_component(_, client, application, resource_group_name, kind=None):
...
def update_component_tags(_, client, application, resource_group_name, tags):
...
def show_components(_, client, application=None, resource_group_name=None):
    if application:
...
def delete_component(_, client, application, resource_group_name):
...
def show_api_key(_, client, application, resource_group_name, api_key=None):
    if api_key is None:
...
def delete_api_key(_, client, application, resource_group_name, api_key):

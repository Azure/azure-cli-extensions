...
def load_arguments(self, _):
    ...
    with self.argument_context('acr cache') as c:
        ...
        c.argument('sync', arg_type=get_enum_type(['enabled', 'disabled']), help='Enabled or disabled artifact sync on the cache rule. Default is disabled.')
        ...
        c.argument('sync_referrers', arg_type=get_enum_type(['enabled', 'disabled']), help='Enabled or disabled syncing the referrers of the artifacts. Default is disabled.')

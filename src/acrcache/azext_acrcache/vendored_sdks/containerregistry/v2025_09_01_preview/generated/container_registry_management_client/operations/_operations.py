...
class RegistriesOperations:
    ...
    def check_cache_rule_artifact_sync_estimate(
        ...
        **kwargs: Any
        ...
        """Checks the upstream repository for artifacts that match the cache rule's sync scope filter and
        estimates the number of artifacts that would be synchronized if the rule is applied.

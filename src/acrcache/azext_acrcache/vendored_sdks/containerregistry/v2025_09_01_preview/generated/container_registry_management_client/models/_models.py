...
class ArtifactSyncFilterProperties(_serialization.Model):
    ...
    :ivar tags: Specifies a query to filter tags in the upstream repository. Tags are user-defined
     labels for OCI artifacts or images. This enables selection of content based on tag values.
    :vartype tags: ~container_registry_management_client.models.TagFilter
    :ivar platforms: Specifies the platform attributes (such as operating system, architecture, and
     variant) to include or exclude in the filter. This allows selection of OCI artifacts or images
     that match specific platform requirements, such as linux/amd64 or windows/arm64.
    :vartype platforms: ~container_registry_management_client.models.PlatformFilter
    :ivar image_types: Specifies the types of OCI images to include or exclude in the filter. OCI
     images are container images that follow the OCI image specification, typically used for running
     containers.
    :vartype image_types: ~container_registry_management_client.models.ImageTypeFilter
    :ivar artifact_types: Specifies the types of OCI artifacts to include or exclude in the filter.
     OCI artifacts can be images, Helm charts, SBOMs, signatures, or any content conforming to the
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword tags: Specifies a query to filter tags in the upstream repository. Tags are
         user-defined labels for OCI artifacts or images. This enables selection of content based on tag
         values.
        :paramtype tags: ~container_registry_management_client.models.TagFilter
        :keyword platforms: Specifies the platform attributes (such as operating system, architecture,
         and variant) to include or exclude in the filter. This allows selection of OCI artifacts or
         images that match specific platform requirements, such as linux/amd64 or windows/arm64.
        :paramtype platforms: ~container_registry_management_client.models.PlatformFilter
        :keyword image_types: Specifies the types of OCI images to include or exclude in the filter.
         OCI images are container images that follow the OCI image specification, typically used for
         running containers.
        :paramtype image_types: ~container_registry_management_client.models.ImageTypeFilter
        :keyword artifact_types: Specifies the types of OCI artifacts to include or exclude in the
         filter. OCI artifacts can be images, Helm charts, SBOMs, signatures, or any content conforming
         to the OCI artifact specification.
...
class ArtifactTypeFilter(_serialization.Model):
    """Specifies the types of OCI artifacts to include or exclude in the filter. OCI artifacts can be
    images, Helm charts, SBOMs, signatures, or any content conforming to the OCI artifact
    specification.
...
class AuthCredential(_serialization.Model):
    ...
    :ivar type: The type of the credential. "KeyVaultSecrets"
    :vartype type: str or ~container_registry_management_client.models.CredentialType
    ...
    def __init__(
        ...
        *,
        ...
        type: Optional[Union[str, "_models.CredentialType"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword type: The type of the credential. "KeyVaultSecrets"
        :paramtype type: str or ~container_registry_management_client.models.CredentialType
...
class CacheRule(ProxyResource):
    ...
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~container_registry_management_client.models.SystemData
    :ivar identity: Managed Identity associated with the resource.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword identity: Managed Identity associated with the resource.
...
class CacheRuleProperties(_serialization.Model):
    ...
    :ivar sync_mode: The sync mode of the cache rule that controls its synchronization behavior.
     PassiveSync indicates the rule behaves as a pull-through cache, preserving upstream pull
     behavior. ActiveSync indicates the rule actively synchronizes artifacts from the upstream
     repository according to the configured artifact sync filters. Known values are: "PassiveSync"
     and "ActiveSync".
    :vartype sync_mode: str or ~container_registry_management_client.models.CacheRuleSyncMode
    ...
    :ivar sync_referrers: Indicates whether OCI referrers are synchronized for artifacts matching
     the cache rule. Valid values are 'Enabled' or 'Disabled'. Known values are: "Enabled" and
     "Disabled".
    ...
    def __init__(
        self,
        *,
        sync_mode: Optional[Union[str, "_models.CacheRuleSyncMode"]] = None,
        ...
        **kwargs: Any
        ...
        """
        :keyword sync_mode: The sync mode of the cache rule that controls its synchronization behavior.
         PassiveSync indicates the rule behaves as a pull-through cache, preserving upstream pull
         behavior. ActiveSync indicates the rule actively synchronizes artifacts from the upstream
         repository according to the configured artifact sync filters. Known values are: "PassiveSync"
         and "ActiveSync".
        :paramtype sync_mode: str or ~container_registry_management_client.models.CacheRuleSyncMode
        :keyword artifact_sync_filters: The filter properties of artifact sync.
        :paramtype artifact_sync_filters:
         ~container_registry_management_client.models.ArtifactSyncFilterProperties
        :keyword sync_referrers: Indicates whether OCI referrers are synchronized for artifacts
         matching the cache rule. Valid values are 'Enabled' or 'Disabled'. Known values are: "Enabled"
         and "Disabled".
...
class CacheRuleUpdateProperties(_serialization.Model):
    ...
    :vartype artifact_sync_filters:
     ~container_registry_management_client.models.ArtifactSyncFilterProperties
    :ivar sync_referrers: The status of syncing referrers. Known values are: "Enabled" and
     "Disabled".
    :vartype sync_referrers: str or
     ~container_registry_management_client.models.ReferrersSyncStatus
    :ivar credential_set_resource_id: The ARM resource ID of the credential store which is
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype artifact_sync_filters:
         ~container_registry_management_client.models.ArtifactSyncFilterProperties
        :keyword sync_referrers: The status of syncing referrers. Known values are: "Enabled" and
         "Disabled".
        :paramtype sync_referrers: str or
         ~container_registry_management_client.models.ReferrersSyncStatus
        :keyword credential_set_resource_id: The ARM resource ID of the credential store which is
...
class ImageTypeFilter(_serialization.Model):
    """Specifies the types of OCI images to include or exclude in the filter. OCI images are container
    images that follow the OCI image specification, typically used for running containers.

    :ivar type: The type of values. Allowed values are either 'include' or 'exclude'. Known values
     are: "include" and "exclude".
    :vartype type: str or ~container_registry_management_client.models.ImageTypeFilterType
    :ivar values: The list of image types to include or exclude from the filter.
    :vartype values: list[str]
    """
    ...
    def __init__(
        self,
        *,
        type: Optional[Union[str, "_models.ImageTypeFilterType"]] = None,
        values: Optional[list[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword type: The type of values. Allowed values are either 'include' or 'exclude'. Known
         values are: "include" and "exclude".
        :paramtype type: str or ~container_registry_management_client.models.ImageTypeFilterType
        :keyword values: The list of image types to include or exclude from the filter.
        :paramtype values: list[str]
        """
        super().__init__(**kwargs)
        self.type = type
...
class PlatformFilter(_serialization.Model):
    """Specifies the platform attributes (such as operating system, architecture, and variant) to
    include or exclude in the filter. This allows selection of OCI artifacts or images that match
    specific platform requirements, such as linux/amd64 or windows/arm64.
...
class PrivateLinkResource(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: str
        :keyword properties: A resource that supports private link capabilities.
        :paramtype properties:
...
class TagFilter(_serialization.Model):
    """Specifies a query to filter tags in the upstream repository. Tags are user-defined labels for
    OCI artifacts or images. This enables selection of content based on tag values.

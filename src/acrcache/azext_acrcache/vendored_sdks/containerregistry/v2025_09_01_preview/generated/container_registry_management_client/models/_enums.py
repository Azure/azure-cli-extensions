...
class CacheRuleSyncMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The sync mode of the cache rule that controls its synchronization behavior. PassiveSync
    indicates the rule behaves as a pull-through cache, preserving upstream pull behavior.
    ActiveSync indicates the rule actively synchronizes artifacts from the upstream repository
    according to the configured artifact sync filters.
    """
...
class CredentialType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    KEY_VAULT_SECRETS = "KeyVaultSecrets"
...
class ReferrersSyncStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Indicates whether OCI referrers are synchronized for artifacts matching the cache rule. Valid

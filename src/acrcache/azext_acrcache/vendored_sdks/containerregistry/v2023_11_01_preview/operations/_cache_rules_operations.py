...
def build_create_request(
    resource_group_name: str, registry_name: str, cache_rule_name: str, subscription_id: str, dry_run: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    if dry_run:
        _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/checkCacheRuleArtifactSyncEstimate"  # pylint: disable=line-too-long
...
class CacheRulesOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.CacheRule"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def _create_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            if dry_run:
                deserialized = self._deserialize("ArtifactSyncPreviewResults", pipeline_response)
            else:
                deserialized = self._deserialize("CacheRule", pipeline_response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule or IO
        ...
        def get_long_running_preview(pipeline_response):
            deserialized = self._deserialize("ArtifactSyncPreviewResults", pipeline_response)
            if cls:
                return cls(pipeline_response, deserialized, {})
            return deserialized
        ...
        if cont_token:
            return LROPoller.from_continuation_token(
                ...
                client=self._client,
                deserialization_callback=get_long_running_preview if dry_run else get_long_running_output,
            )
        return LROPoller(self._client, raw_result, get_long_running_preview if dry_run else get_long_running_output, polling_method)  # type: ignore
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRuleUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRuleUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response

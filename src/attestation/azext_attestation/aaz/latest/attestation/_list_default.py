...
class ListDefault(AAZCommand):
    """Get the default provider.

    :example: AttestationProviders_GetDefault
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AttestationProvidersListDefault(ctx=self.ctx)()
    ...
    class AttestationProvidersListDefault(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListDefaultHelper._build_schema_system_data_read(_schema_on_200.system_data)
            ...
            _ListDefaultHelper._build_schema_system_data_read(_element.system_data)
...
class _ListDefaultHelper:
    """Helper class for ListDefault"""

...
@register_command(
    "attestation signer remove",
)
class Remove(AAZCommand):
    """Removes the specified policy management certificate.

    :example: Removes the specified policy management certificate.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.signer = AAZStrArg(
            options=["--signer"],
            help="The policy certificate to remove. An RFC7519 JSON Web Token containing a claim named \"maa-policyCertificate\" whose value is an RFC7517 JSON Web Key which specifies a new key to update. The RFC7519 JWT must be signed with one of the existing signing certificates.",
            required=True,
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PolicyCertificatesRemove(ctx=self.ctx)()
    ...
    class PolicyCertificatesRemove(AAZHttpOperation):

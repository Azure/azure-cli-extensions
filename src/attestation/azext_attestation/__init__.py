...
class AttestationCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        super(AttestationCommandsLoader, self).__init__(cli_ctx=cli_ctx,
...
COMMAND_LOADER_CLS = AttestationCommandsLoader

...
"""Bootstrap Device run-ro-command customization."""
...
from azext_managednetworkfabric.aaz.latest.networkfabric.bootstrapdevice import (
    RunRoCommand as _RunRoCommand,
)


class RunRoCommand(_RunRoCommand):
    ...
    class NetworkBootstrapDevicesRunRoCommand(
        _RunRoCommand.NetworkBootstrapDevicesRunRoCommand
    ):

...
@register_command(
    "nf internalnetwork update-admin-state",
)
class UpdateAdminState(AAZCommand):
    ...
    :example: Update admin state of Internal Network
        az nf internalnetwork update-admin-state --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-internalNetwork" --state "Enable"
    """

...
class Delete(AAZCommand):
    ...
    :example: Delete the Internal Network
        az nf internalnetwork delete --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-internalnetwork"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.InternalNetworksDelete(ctx=self.ctx)()
    ...
    class InternalNetworksDelete(AAZHttpOperation):

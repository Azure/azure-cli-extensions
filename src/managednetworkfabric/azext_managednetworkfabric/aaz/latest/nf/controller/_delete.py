...
@register_command(
    "nf controller delete",
)
class Delete(AAZCommand):
    """Delete the Network Fabric Controller resource.

    :example: Delete the Network Fabric Controller
        az nf controller delete --resource-group "example-rg" --resource-name "example-nfc"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricControllersDelete(ctx=self.ctx)()
    ...
    class NetworkFabricControllersDelete(AAZHttpOperation):

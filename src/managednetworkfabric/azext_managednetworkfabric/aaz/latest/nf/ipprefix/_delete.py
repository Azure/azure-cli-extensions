...
class Delete(AAZCommand):
    ...
    :example: Delete the Ip Prefix
        az nf ipprefix delete --resource-group "example-rg" --resource-name "example-ipprefix"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.IpPrefixesDelete(ctx=self.ctx)()
    ...
    class IpPrefixesDelete(AAZHttpOperation):

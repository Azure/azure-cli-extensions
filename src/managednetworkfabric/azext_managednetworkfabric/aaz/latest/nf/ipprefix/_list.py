...
class List(AAZCommand):
    ...
    :example: List the Ip Prefixes for Resource Group
        az nf ipprefix list --resource-group "example-rg"

    :example: List the Ip Prefixes for Subscription
        az nf ipprefix list --subscription "<subscriptionId>"
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.IpPrefixesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.IpPrefixesListBySubscription(ctx=self.ctx)()
    ...
    class IpPrefixesListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            ip_prefix_rules = cls._schema_on_200.value.Element.properties.ip_prefix_rules
            ip_prefix_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.ip_prefix_rules.Element
    ...
    class IpPrefixesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

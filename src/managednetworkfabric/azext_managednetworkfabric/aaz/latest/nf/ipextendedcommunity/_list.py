...
class List(AAZCommand):
    ...
    :example: List the Ip Extended Communities for Resource Group
        az nf ipextendedcommunity list --resource-group "example-rg"

    :example: List the Ip Extended Communities for Subscription
        az nf ipextendedcommunity list --subscription "<subscriptionId>"
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.IpExtendedCommunitiesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.IpExtendedCommunitiesListBySubscription(ctx=self.ctx)()
    ...
    class IpExtendedCommunitiesListByResourceGroup(AAZHttpOperation):
    ...
    class IpExtendedCommunitiesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
@register_command(
    "nf ipextendedcommunity create",
)
class Create(AAZCommand):
    """Create a Ip Extended Community resource.

    :example: Create a Ip Extended Community
        az nf ipextendedcommunity create --resource-group "example-rg" --location "westus3" --resource-name "example-ipextendedcommunity" --action "Deny" --route-targets "1024:219" "1001:200"
    """

...
@register_command(
    "nf ipextendedcommunity delete",
)
class Delete(AAZCommand):
    """Delete the Ip Extended Community resource.

    :example: Delete the Ip Extended Community
        az nf ipextendedcommunity delete --resource-group "example-rg" --resource-name "example-ipextendedcommunity"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.IpExtendedCommunitiesDelete(ctx=self.ctx)()
    ...
    class IpExtendedCommunitiesDelete(AAZHttpOperation):

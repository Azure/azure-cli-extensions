...
class Update(AAZCommand):
    ...
    :example: Update the Network Device
        az nf device update --resource-group "example-rg" --resource-name "example-device" --host-name "AustinNF-AR-CE1" --serial-number "Arista;DCS-7280DR3-24;12.05;JPE21115446"
    """

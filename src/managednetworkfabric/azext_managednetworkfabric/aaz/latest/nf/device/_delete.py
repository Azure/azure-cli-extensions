...
class Delete(AAZCommand):
    ...
    :example: Delete the Network Device
        az nf device delete --resource-group "example-rg" --resource-name "example-device"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkDevicesDelete(ctx=self.ctx)()

...
class List(AAZCommand):
    ...
    :example: List the L2 Isolation Domains for Resource Group
        az nf l2domain list --resource-group "example-rg"

    :example: List the L2 Isolation Domains for Subscription
        az nf l2domain list --subscription "<subscriptionId>"
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.L2IsolationDomainsListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.L2IsolationDomainsListBySubscription(ctx=self.ctx)()
    ...
    class L2IsolationDomainsListByResourceGroup(AAZHttpOperation):
    ...
    class L2IsolationDomainsListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

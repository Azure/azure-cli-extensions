...
class Create(AAZCommand):
    ...
    :example: Create a Network Rack
        az nf rack create --resource-group "example-rg" --location "westus3" --network-rack-sku "rackskuname" --nf-id "/subscriptions/xxxxx-xxxx-xxxx-xxxx-xxxxx/resourceGroups/example-rg/providers/Microsoft.ManagedNetworkFabric/NetworkFabrics/example-fabricName" --resource-name "example-rack"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_rack_sku = AAZStrArg(
            options=["--network-rack-sku"],
            arg_group="Properties",
            help="Network Rack SKU name.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkRacksCreate(ctx=self.ctx)()
    ...
    class NetworkRacksCreate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "networkRackName", self.ctx.args.resource_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("networkRackSku", AAZStrType, ".network_rack_sku", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200_201(cls):
            ...
            network_devices = cls._schema_on_200_201.properties.network_devices

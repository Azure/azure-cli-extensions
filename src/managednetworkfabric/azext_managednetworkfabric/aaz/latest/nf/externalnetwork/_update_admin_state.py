...
@register_command(
    "nf externalnetwork update-admin-state",
)
class UpdateAdminState(AAZCommand):
    ...
    :example: Update admin state of External Network
        az nf externalnetwork update-admin-state --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalNetwork" --state "Enable"
    """

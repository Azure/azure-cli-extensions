...
@register_command(
    "nf externalnetwork create",
)
class Create(AAZCommand):
    """Create a External Network resource

    :example: Create a External Network with option B properties
        az nf externalnetwork create --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalNetwork" --peering-option "OptionB" --import-route-policy-id "/subscriptions/xxxxx-xxxx-xxxx-xxxx-xxxxx/resourceGroups/example-rg/providers/microsoft.managednetworkfabric/routePolicies/example-routepolicy" --export-route-policy-id "/subscriptions/xxxxx-xxxx-xxxx-xxxx-xxxxx/resourceGroups/example-rg/providers/microsoft.managednetworkfabric/routePolicies/example-routepolicy" --option-b-properties '{"importRouteTargets": ["65541:2001","65542:2002"], "exportRouteTargets": ["65531:2001","65532:2002"]}'

    :example: Create a External Network with option A properties
        az nf externalnetwork create --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalNetwork" --peering-option "OptionA" --import-route-policy-id "/subscriptions/xxxxx-xxxx-xxxx-xxxx-xxxxx/resourceGroups/example-rg/providers/microsoft.managednetworkfabric/routePolicies/example-routepolicy" --export-route-policy-id "/subscriptions/xxxxx-xxxx-xxxx-xxxx-xxxxx/resourceGroups/example-rg/providers/microsoft.managednetworkfabric/routePolicies/example-routepolicy" --option-a-properties '{"peerASN": 65234, "vlanId": 501, "mtu": 1500, "primaryIpv4Prefix": "172.23.1.0/31", "secondaryIpv4Prefix": "172.23.1.2/31"}'
    ...
    :example: Help text for sub parameters under the specific parent can be viewed by using the shorthand syntax '??'. See https://github.com/Azure/azure-cli/tree/dev/doc/shorthand_syntax.md for more about shorthand syntax.
        az nf externalnetwork create --option-a-properties '??'
    """

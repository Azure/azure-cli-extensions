...
@register_command(
    "nf externalnetwork delete",
)
class Delete(AAZCommand):
    """Delete the External Network resource.

    :example: Delete the External Network
        az nf externalnetwork delete --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalnetwork"
    """
    ...
    class ExternalNetworksDelete(AAZHttpOperation):

...
@register_command(
    "nf interface update-admin-state",
)
class UpdateAdminState(AAZCommand):
    ...
    :example: Update admin state of Network Interface
        az nf interface update-admin-state -g "example-rg" --network-device-name "example-device" --resource-name "example-interface" --state "Enable"
    """

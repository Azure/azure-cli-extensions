...
@register_command(
    "nf routepolicy delete",
)
class Delete(AAZCommand):
    """Delete the Route Policy resource.

    :example: Delete the Route Policy
        az nf routepolicy delete --resource-group "example-rg" --resource-name "example-routepolicy"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RoutePoliciesDelete(ctx=self.ctx)()
    ...
    class RoutePoliciesDelete(AAZHttpOperation):

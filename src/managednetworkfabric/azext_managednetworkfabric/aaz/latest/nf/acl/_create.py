...
class Create(AAZCommand):
    ...
    :example: Creates a Access Control List resource.
        az nf acl create --resource-group "example-rg" --location "westus3" --resource-name "example-accesscontrollist" --address-family "ipv4" --conditions '[{"sequenceNumber": 123, "action": "allow", "destinationAddress": "1.1.10.10", "destinationPort": "1254", "sourceAddress": "1.1.1.0/24", "sourcePort": "1276", "protocol": "255", "annotation": "asdf"}]'

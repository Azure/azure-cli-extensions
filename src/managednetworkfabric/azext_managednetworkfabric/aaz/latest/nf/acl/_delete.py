...
class Delete(AAZCommand):
    ...
    :example: Delete a Access Control List resource
        az nf acl delete --resource-group "example-rg" --resource-name "example-acl"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessControlListsDelete(ctx=self.ctx)()

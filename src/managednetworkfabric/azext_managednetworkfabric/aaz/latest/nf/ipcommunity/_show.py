...
class Show(AAZCommand):
    ...
    :example: Show the Ip Community
        az nf ipcommunity show --resource-group "example-rg" --resource-name "example-ipcommunity"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IpCommunitiesGet(ctx=self.ctx)()
    ...
    class IpCommunitiesGet(AAZHttpOperation):

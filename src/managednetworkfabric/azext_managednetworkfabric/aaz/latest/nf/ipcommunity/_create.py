...
@register_command(
    "nf ipcommunity create",
)
class Create(AAZCommand):
    """Create a Ip Community resource.

    :example: Create a Ip Community
        az nf ipcommunity create --resource-group "example-rg" --location "westus3" --resource-name "example-ipcommunity" --action "Deny" --well-known-communities "LocalAS" "GShut" --community-members "100:200" "101:201"
    """

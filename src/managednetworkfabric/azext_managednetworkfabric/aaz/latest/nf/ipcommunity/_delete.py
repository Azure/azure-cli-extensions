...
@register_command(
    "nf ipcommunity delete",
)
class Delete(AAZCommand):
    """Delete the Ip Community resource.

    :example: Delete the Ip Community
        az nf ipcommunity delete --resource-group "example-rg" --resource-name "example-ipcommunity"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.IpCommunitiesDelete(ctx=self.ctx)()
    ...
    class IpCommunitiesDelete(AAZHttpOperation):

...
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.resource_name = AAZStrArg(
            ...
            help="Name of the Network Rack Sku",
            required=True,
            id_part="name",
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkRackSkusGet(ctx=self.ctx)()
    ...
    class NetworkRackSkusGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.properties.network_devices.Element

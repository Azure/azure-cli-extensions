...
class Delete(AAZCommand):
    ...
    :example: Delete the Network Rack
        az networkfabric rack delete --resource-group "example-rg" --resource-name "example-rack"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkRacksDelete(ctx=self.ctx)()
    ...
    class NetworkRacksDelete(AAZHttpOperation):

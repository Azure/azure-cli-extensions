...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.managednetworkfabric/networkracks", "2026-07-15-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkracks", "2026-07-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.NetworkRacksListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.NetworkRacksListByResourceGroup(ctx=self.ctx)()
    ...
    class NetworkRacksListBySubscription(AAZHttpOperation):
    ...
    class NetworkRacksListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
@register_command(
    "networkfabric bootstrapinterface update-administrative-state",
)
class UpdateAdministrativeState(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_bootstrap_interface_name = AAZStrArg(
            options=["--resource-name", "--network-bootstrap-interface-name"],
    ...
    class NetworkBootstrapInterfacesUpdateAdministrativeState(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "networkBootstrapInterfaceName", self.ctx.args.network_bootstrap_interface_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateAdministrativeStateHelper._build_schema_error_detail_read(_schema_on_200.error)

            return cls._schema_on_200


class _UpdateAdministrativeStateHelper:
    """Helper class for UpdateAdministrativeState"""
...
__all__ = ["UpdateAdministrativeState"]

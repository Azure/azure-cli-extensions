...
@register_command(
    "networkfabric bootstrapinterface update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.additional_description = AAZStrArg(
        ...
        _args_schema.serial_number = AAZStrArg(
            ...
            arg_group="Properties",
            help="Serial number of the interface. Format of serial Number - Make;Model;HardwareRevisionId;SerialNumber.",
            fmt=AAZStrArgFormat(
                min_length=1,
            ),
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapInterfacesUpdate(ctx=self.ctx)()
    ...
    class NetworkBootstrapInterfacesUpdate(AAZHttpOperation):

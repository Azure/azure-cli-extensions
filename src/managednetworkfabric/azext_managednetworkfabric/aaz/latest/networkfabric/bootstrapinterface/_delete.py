...
@register_command(
    "networkfabric bootstrapinterface delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapInterfacesDelete(ctx=self.ctx)()
    ...
    class NetworkBootstrapInterfacesDelete(AAZHttpOperation):

...
@register_command(
    "networkfabric bootstrapinterface create",
)
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapInterfacesCreate(ctx=self.ctx)()
    ...
    class NetworkBootstrapInterfacesCreate(AAZHttpOperation):

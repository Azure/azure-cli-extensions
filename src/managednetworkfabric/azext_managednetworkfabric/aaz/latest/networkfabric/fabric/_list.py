...
class List(AAZCommand):
    ...
    class NetworkFabricsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.fabric_locks.Element
            ...
            feature_flags = cls._schema_on_200.value.Element.properties.feature_flags
            feature_flags.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.feature_flags.Element
            ...
            public_connectivity = cls._schema_on_200.value.Element.properties.public_connectivity
            ...
            infra_vpn_tunnels = cls._schema_on_200.value.Element.properties.public_connectivity.infra_vpn_tunnels
            infra_vpn_tunnels.Element = AAZObjectType()
            _ListHelper._build_schema_vpn_tunnel_read(infra_vpn_tunnels.Element)

            peering = cls._schema_on_200.value.Element.properties.public_connectivity.peering
            ...
            public_peering_configuration = cls._schema_on_200.value.Element.properties.public_connectivity.peering.public_peering_configuration
            ...
            _ListHelper._build_schema_public_peering_local_network_gateways_read(public_peering_configuration.infrastructure_local_network_gateways)
            public_peering_configuration.tenant_local_network_gateways = AAZObjectType(
                serialized_name="tenantLocalNetworkGateways",
                flags={"required": True},
            )
            _ListHelper._build_schema_public_peering_local_network_gateways_read(public_peering_configuration.tenant_local_network_gateways)

            tenant_vpn_tunnels = cls._schema_on_200.value.Element.properties.public_connectivity.tenant_vpn_tunnels
            tenant_vpn_tunnels.Element = AAZObjectType()
            _ListHelper._build_schema_vpn_tunnel_read(tenant_vpn_tunnels.Element)

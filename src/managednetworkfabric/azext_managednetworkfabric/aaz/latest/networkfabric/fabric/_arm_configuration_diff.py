...
@register_command(
    "networkfabric fabric arm-configuration-diff",
)
class ArmConfigurationDiff(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsArmConfigurationDiff(ctx=self.ctx)()
    ...
    class NetworkFabricsArmConfigurationDiff(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ArmConfigurationDiffHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _ArmConfigurationDiffHelper._build_schema_operation_status_result_read(operations.Element)

            properties = cls._schema_on_200.properties
            properties.configuration_diff_url = AAZStrType(
                serialized_name="configurationDiffUrl",
            )

            return cls._schema_on_200


class _ArmConfigurationDiffHelper:
    """Helper class for ArmConfigurationDiff"""

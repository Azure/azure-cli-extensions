...
class ResyncPassword(AAZCommand):
    ...
    :example: Updates the Terminal Server and all Network Devices to use the latest passwords
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsResyncPasswords(ctx=self.ctx)()
    ...
    class NetworkFabricsResyncPasswords(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabrics/{networkFabricName}/resyncPasswords",
                **self.url_parameters
            )

...
class Upgrade(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/upgrade", "2026-01-15-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.action = AAZStrArg(
            options=["--action"],
            arg_group="Body",
            help="Action to be performed while upgrading the fabric.",
            enum={"Complete": "Complete", "Start": "Start"},
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsUpgrade(ctx=self.ctx)()
    ...
    class NetworkFabricsUpgrade(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpgradeHelper._build_schema_operation_status_result_read(cls._schema_on_200)

...
class RotateCertificate(AAZCommand):
    ...
    :example: Create new certificates, then updates the Network Devices to use the new certificates
        az networkfabric fabric rotate-certificate --resource-group example-rg --resource-name example-fabric
    """

    _aaz_info = {
        "version": "2026-01-15-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/rotatecertificates", "2026-01-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsRotateCertificates(ctx=self.ctx)()
    ...
    class NetworkFabricsRotateCertificates(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabrics/{networkFabricName}/rotateCertificates",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _RotateCertificateHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _RotateCertificateHelper._build_schema_operation_status_result_read(operations.Element)

            return cls._schema_on_200


class _RotateCertificateHelper:
    """Helper class for RotateCertificate"""

    ...
    class NetworkFabricsUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("managementNetworkConfiguration", AAZObjectType, ".management_network_configuration")
                ...
                properties.set_prop("terminalServerConfiguration", AAZObjectType, ".terminal_server_configuration")

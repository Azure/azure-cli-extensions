...
class LockFabric(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/lockfabric", "2026-01-15-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.action = AAZStrArg(
            options=["--action"],
            arg_group="Body",
            help="Action to be performed on the lock",
            enum={"Lock": "Lock", "Unlock": "Unlock"},
        )
        _args_schema.lock_type = AAZStrArg(
            options=["--lock-type"],
            arg_group="Body",
            help="Type of lock to be applied",
            enum={"Administrative": "Administrative", "Configuration": "Configuration"},
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsLockFabric(ctx=self.ctx)()
    ...
    class NetworkFabricsLockFabric(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("lockType", AAZStrType, ".lock_type")
        ...
        def _build_schema_on_200(cls):
            ...
            _LockFabricHelper._build_schema_operation_status_result_read(cls._schema_on_200)

            return cls._schema_on_200


class _LockFabricHelper:
    """Helper class for LockFabric"""

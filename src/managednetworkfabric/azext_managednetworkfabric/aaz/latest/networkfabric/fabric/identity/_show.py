...
@register_command(
    "networkfabric fabric identity show",
)
class Show(AAZCommand):
    """Show the details of managed identities.

    :example: Show identity on the Network Fabric
        az networkfabric fabric identity show --resource-group example-rg --network-fabric-name example-fabric
    """
    ...
    class NetworkFabricsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_network_fabric_read(cls._schema_on_200)

...
class RotatePassword(AAZCommand):
    ...
    :example: Create new passwords, then updates the Terminal Server and Network Devices to use the new passwords
        az networkfabric fabric rotate-password --resource-group example-rg --resource-name example-fabric
    """

    _aaz_info = {
        "version": "2026-07-15-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/rotatepasswords", "2026-07-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsRotatePasswords(ctx=self.ctx)()
    ...
    class NetworkFabricsRotatePasswords(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabrics/{networkFabricName}/rotatePasswords",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _RotatePasswordHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _RotatePasswordHelper._build_schema_operation_status_result_read(operations.Element)

            return cls._schema_on_200


class _RotatePasswordHelper:
    """Helper class for RotatePassword"""

...
class CommitBatchStatus(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/commitbatchstatus", "2026-01-15-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.commit_batch_id = AAZStrArg(
            options=["--commit-batch-id"],
            arg_group="Body",
            help="Commit Batch Identifier. If not provided, the latest commit batch status will be returned.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsCommitBatchStatus(ctx=self.ctx)()
    ...
    class NetworkFabricsCommitBatchStatus(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("commitBatchId", AAZStrType, ".commit_batch_id")
        ...
        def _build_schema_on_200(cls):
            ...
            _CommitBatchStatusHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _CommitBatchStatusHelper._build_schema_operation_status_result_read(operations.Element)

            properties = cls._schema_on_200.properties
            properties.commit_batch_details = AAZObjectType(
                serialized_name="commitBatchDetails",
            )
            properties.commit_batch_id = AAZStrType(
                serialized_name="commitBatchId",
            )
            properties.commit_batch_state = AAZStrType(
                serialized_name="commitBatchState",
                flags={"read_only": True},
            )

            commit_batch_details = cls._schema_on_200.properties.commit_batch_details
            commit_batch_details.failed_devices = AAZListType(
                serialized_name="failedDevices",
            )

            failed_devices = cls._schema_on_200.properties.commit_batch_details.failed_devices
            failed_devices.Element = AAZStrType()

            return cls._schema_on_200


class _CommitBatchStatusHelper:
    """Helper class for CommitBatchStatus"""

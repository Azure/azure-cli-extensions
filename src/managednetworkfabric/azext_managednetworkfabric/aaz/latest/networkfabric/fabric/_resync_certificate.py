...
class ResyncCertificate(AAZCommand):
    ...
    :example: Updates all Network Devices to use the latest certificates
        az networkfabric fabric resync-certificate --resource-group example-rg --resource-name example-fabric
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsResyncCertificates(ctx=self.ctx)()
    ...
    class NetworkFabricsResyncCertificates(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabrics/{networkFabricName}/resyncCertificates",
                **self.url_parameters
            )

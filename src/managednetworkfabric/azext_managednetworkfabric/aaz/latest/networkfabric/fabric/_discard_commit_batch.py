...
class DiscardCommitBatch(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkfabrics/{}/discardcommitbatch", "2026-01-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkFabricsDiscardCommitBatch(ctx=self.ctx)()
    ...
    class NetworkFabricsDiscardCommitBatch(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _DiscardCommitBatchHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _DiscardCommitBatchHelper._build_schema_operation_status_result_read(operations.Element)
...
class _DiscardCommitBatchHelper:
    """Helper class for DiscardCommitBatch"""

...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/l2isolationdomains/{}", "2026-07-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.L2IsolationDomainsDelete(ctx=self.ctx)()
    ...
    class L2IsolationDomainsDelete(AAZHttpOperation):

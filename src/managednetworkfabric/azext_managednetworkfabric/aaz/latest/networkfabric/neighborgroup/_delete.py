...
@register_command(
    "networkfabric neighborgroup delete",
)
class Delete(AAZCommand):
    """Delete the Neighbor Group resource

    :example: Delete the Neighbor Group
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/neighborgroups/{}", "2026-01-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NeighborGroupsDelete(ctx=self.ctx)()
    ...
    class NeighborGroupsDelete(AAZHttpOperation):

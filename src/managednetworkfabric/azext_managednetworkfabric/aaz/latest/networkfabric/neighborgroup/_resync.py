...
@register_command(
    "networkfabric neighborgroup resync",
)
class Resync(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.neighbor_group_name = AAZStrArg(
            options=["--resource-name", "--neighbor-group-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NeighborGroupsResync(ctx=self.ctx)()
    ...
    class NeighborGroupsResync(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/neighborGroups/{neighborGroupName}/resync",
                **self.url_parameters
            )
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "neighborGroupName", self.ctx.args.neighbor_group_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _ResyncHelper._build_schema_operation_status_result_read(operations.Element)

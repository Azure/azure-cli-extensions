...
@register_command(
    "networkfabric neighborgroup create",
)
class Create(AAZCommand):
    """Create a Neighbor Group resource

    :example: Create a Neighbor Group
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NeighborGroupsCreate(ctx=self.ctx)()
    ...
    class NeighborGroupsCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            ipv4_addresses = cls._schema_on_200_201.properties.destination.ipv4_addresses

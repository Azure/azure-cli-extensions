...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        static_route_configuration.bfd_configuration = AAZObjectArg(
            options=["bfd-configuration"],
            help="Bidirectional Forwarding Detection (BFD) configuration properties",
        )
    ...
    class NetworkToNetworkInterconnectsUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_bfd_configuration_read(npb_static_route_configuration.bfd_configuration)

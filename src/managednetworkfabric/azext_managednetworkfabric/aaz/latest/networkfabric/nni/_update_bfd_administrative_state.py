...
@register_command(
    "networkfabric nni update-bfd-administrative-state",
)
class UpdateBfdAdministrativeState(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_fabric_name = AAZStrArg(
            options=["--fabric", "--fabric-name", "--network-fabric-name"],
        ...
        _args_schema.administrative_state = AAZStrArg(
            ...
            arg_group="Body",
            help="State. Select either enable or disable.",
            enum={"Disabled": "Disabled", "Enabled": "Enabled", "MAT": "MAT", "RMA": "RMA"},
        )
        _args_schema.route_type = AAZStrArg(
            options=["--route-type"],
            arg_group="Body",
            help="Route Type. Choose either Static or OptionA.",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkToNetworkInterconnectsUpdateBfdAdministrativeState(ctx=self.ctx)()
    ...
    class NetworkToNetworkInterconnectsUpdateBfdAdministrativeState(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateBfdAdministrativeStateHelper._build_schema_operation_status_result_read(operations.Element)

            properties = cls._schema_on_200.properties
            properties.administrative_state = AAZStrType(
                serialized_name="administrativeState",
            )
            properties.route_type = AAZStrType(

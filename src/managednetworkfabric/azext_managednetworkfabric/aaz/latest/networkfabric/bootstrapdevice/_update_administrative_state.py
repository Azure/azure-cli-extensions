...
@register_command(
    "networkfabric bootstrapdevice update-administrative-state",
)
class UpdateAdministrativeState(AAZCommand):
    ...
    class NetworkBootstrapDevicesUpdateAdministrativeState(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateAdministrativeStateHelper._build_schema_operation_status_result_read(operations.Element)

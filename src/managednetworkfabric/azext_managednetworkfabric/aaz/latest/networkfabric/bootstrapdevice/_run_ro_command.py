...
@register_command(
    "networkfabric bootstrapdevice run-ro-command",
)
class RunRoCommand(AAZCommand):
    """Run the RO Command on the Network Bootstrap Device.

    :example: Run a read-only command on a Network Bootstrap Device.
        az networkfabric bootstrapdevice run-ro-command --resource-group example-rg --network-bootstrap-device-name example-device --command show version
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapDevicesRunRoCommand(ctx=self.ctx)()
    ...
    class NetworkBootstrapDevicesRunRoCommand(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkBootstrapDevices/{networkBootstrapDeviceName}/runRoCommand",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _RunRoCommandHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _RunRoCommandHelper._build_schema_operation_status_result_read(operations.Element)
...
class _RunRoCommandHelper:
    """Helper class for RunRoCommand"""

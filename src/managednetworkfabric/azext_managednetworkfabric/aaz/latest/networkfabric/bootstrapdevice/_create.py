...
@register_command(
    "networkfabric bootstrapdevice create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_device_sku = AAZStrArg(
            options=["--network-device-sku"],
            arg_group="Properties",
            help="Network Bootstrap Device SKU name.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapDevicesCreate(ctx=self.ctx)()
    ...
    class NetworkBootstrapDevicesCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("networkDeviceSku", AAZStrType, ".network_device_sku")

...
@register_command(
    "networkfabric bootstrapdevice refresh-config",
)
class RefreshConfig(AAZCommand):
    """Refreshes the configuration of Network Bootstrap Device.

    :example: Run refresh configuration on the Boostrap Device
        az networkfabric bootstrapdevice refresh-config --resource-group example-rg --resource-name example-device
    """

    _aaz_info = {
        "version": "2026-07-15-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/networkbootstrapdevices/{}/refreshconfiguration", "2026-07-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapDevicesRefreshConfiguration(ctx=self.ctx)()
    ...
    class NetworkBootstrapDevicesRefreshConfiguration(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkBootstrapDevices/{networkBootstrapDeviceName}/refreshConfiguration",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _RefreshConfigHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _RefreshConfigHelper._build_schema_operation_status_result_read(operations.Element)

            return cls._schema_on_200


class _RefreshConfigHelper:
    """Helper class for RefreshConfig"""

...
@register_command(
    "networkfabric bootstrapdevice run-rw-command",
)
class RunRwCommand(AAZCommand):
    """Run the RW Command on the Network Bootstrap Device.

    :example: Run a read-write command on a Network Bootstrap Device.
        az networkfabric bootstrapdevice run-rw-command --resource-group example-rg --network-bootstrap-device-name example-device --command show running-config --command-url https://example.blob.core.windows.net/commands/config.txt
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.command = AAZStrArg(
            options=["--command"],
            arg_group="Body",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapDevicesRunRwCommand(ctx=self.ctx)()
    ...
    class NetworkBootstrapDevicesRunRwCommand(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkBootstrapDevices/{networkBootstrapDeviceName}/runRwCommand",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("command", AAZStrType, ".command")
        ...
        def _build_schema_on_200(cls):
            ...
            _RunRwCommandHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _RunRwCommandHelper._build_schema_operation_status_result_read(operations.Element)
...
class _RunRwCommandHelper:
    """Helper class for RunRwCommand"""

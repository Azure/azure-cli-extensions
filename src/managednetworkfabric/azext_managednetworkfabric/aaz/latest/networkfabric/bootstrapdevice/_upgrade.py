...
@register_command(
    "networkfabric bootstrapdevice upgrade",
)
class Upgrade(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.network_bootstrap_device_name = AAZStrArg(
            options=["--resource-name", "--network-bootstrap-device-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkBootstrapDevicesUpgrade(ctx=self.ctx)()
    ...
    class NetworkBootstrapDevicesUpgrade(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkBootstrapDevices/{networkBootstrapDeviceName}/upgrade",
                **self.url_parameters
            )

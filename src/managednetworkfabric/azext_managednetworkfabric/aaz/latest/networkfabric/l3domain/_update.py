...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_route_prefix_limit_patch_properties_update(_args_schema.v4route_prefix_limit)
        _args_schema.v6route_prefix_limit = AAZObjectArg(
            options=["--v6route-prefix-limit"],
            arg_group="Properties",
            help="IPv6 VRF Limit configuration.",
        )
        cls._build_args_route_prefix_limit_patch_properties_update(_args_schema.v6route_prefix_limit)
    ...
    _args_route_prefix_limit_patch_properties_update = None

    @classmethod
    def _build_args_route_prefix_limit_patch_properties_update(cls, _schema):
        if cls._args_route_prefix_limit_patch_properties_update is not None:
            _schema.hard_limit = cls._args_route_prefix_limit_patch_properties_update.hard_limit
            _schema.threshold = cls._args_route_prefix_limit_patch_properties_update.threshold
            return

        cls._args_route_prefix_limit_patch_properties_update = AAZObjectArg()

        route_prefix_limit_patch_properties_update = cls._args_route_prefix_limit_patch_properties_update
        route_prefix_limit_patch_properties_update.hard_limit = AAZIntArg(
            options=["hard-limit"],
            help="Hard limit for the routes.",
        )
        route_prefix_limit_patch_properties_update.threshold = AAZIntArg(
            options=["threshold"],
    ...
    class L3IsolationDomainsUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_route_prefix_limit_patch_properties_update(properties.set_prop("v4routePrefixLimit", AAZObjectType, ".v4route_prefix_limit"))
                _UpdateHelper._build_schema_route_prefix_limit_patch_properties_update(properties.set_prop("v6routePrefixLimit", AAZObjectType, ".v6route_prefix_limit"))
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_route_prefix_limit_properties_read(properties.v4route_prefix_limit)
            properties.v6route_prefix_limit = AAZObjectType(
                serialized_name="v6routePrefixLimit",
            )
            _UpdateHelper._build_schema_route_prefix_limit_properties_read(properties.v6route_prefix_limit)
            ...
            export_policy_configuration = cls._schema_on_200.properties.export_policy_configuration
            export_policy_configuration.export_policies = AAZListType(
                serialized_name="exportPolicies",
            )

            export_policies = cls._schema_on_200.properties.export_policy_configuration.export_policies
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_route_prefix_limit_patch_properties_update(cls, _builder):
        if _builder is None:
            return

...
@register_command(
    "networkfabric l3domain update-admin-state",
)
class UpdateAdminState(AAZCommand):
    """Enables racks for this Isolation Domain.

    :example: Update admin state of L3 Isolation Domain
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/l3isolationdomains/{}/updateadministrativestate", "2026-01-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.L3IsolationDomainsUpdateAdministrativeState(ctx=self.ctx)()

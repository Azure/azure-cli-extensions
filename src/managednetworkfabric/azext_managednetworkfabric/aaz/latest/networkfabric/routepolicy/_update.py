...
@register_command(
    "networkfabric routepolicy update",
)
class Update(AAZCommand):
    """Update the Route Policy resource.

    :example: Update Route Policy with IP Community ids
    ...
    :example: Update Route Policy with IP Extended Community ids
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_ip_community_id_list_update(ip_community_properties.add)
        ip_community_properties.delete = AAZObjectArg(
            options=["delete"],
            help="List of IP Community IDs.",
        )
        cls._build_args_ip_community_id_list_update(ip_community_properties.delete)
        ip_community_properties.set = AAZObjectArg(
            options=["set"],
            help="List of IP Community IDs.",
        )
        cls._build_args_ip_community_id_list_update(ip_community_properties.set)
        ...
        cls._build_args_ip_extended_community_id_list_update(ip_extended_community_properties.add)
        ip_extended_community_properties.delete = AAZObjectArg(
            options=["delete"],
            help="List of IP Extended Community IDs.",
        )
        cls._build_args_ip_extended_community_id_list_update(ip_extended_community_properties.delete)
        ip_extended_community_properties.set = AAZObjectArg(
            options=["set"],
            help="List of IP Extended Community IDs.",
        )
        cls._build_args_ip_extended_community_id_list_update(ip_extended_community_properties.set)
    ...
    @classmethod
    def _build_args_ip_community_id_list_update(cls, _schema):
        if cls._args_ip_community_id_list_update is not None:
            _schema.ip_community_ids = cls._args_ip_community_id_list_update.ip_community_ids
            return

        cls._args_ip_community_id_list_update = AAZObjectArg()

        ip_community_id_list_update = cls._args_ip_community_id_list_update
        ip_community_id_list_update.ip_community_ids = AAZListArg(
            options=["ip-community-ids"],
            help="List of IP Community resource IDs.",
        )

        ip_community_ids = cls._args_ip_community_id_list_update.ip_community_ids
        ip_community_ids.Element = AAZStrArg()

        _schema.ip_community_ids = cls._args_ip_community_id_list_update.ip_community_ids

    _args_ip_extended_community_id_list_update = None

    @classmethod
    def _build_args_ip_extended_community_id_list_update(cls, _schema):
        if cls._args_ip_extended_community_id_list_update is not None:
            _schema.ip_extended_community_ids = cls._args_ip_extended_community_id_list_update.ip_extended_community_ids
            return

        cls._args_ip_extended_community_id_list_update = AAZObjectArg()

        ip_extended_community_id_list_update = cls._args_ip_extended_community_id_list_update
        ip_extended_community_id_list_update.ip_extended_community_ids = AAZListArg(
            options=["ip-extended-community-ids"],
            help="List of IP Extended Community resource IDs.",
        )

        ip_extended_community_ids = cls._args_ip_extended_community_id_list_update.ip_extended_community_ids
        ip_extended_community_ids.Element = AAZStrArg()
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RoutePoliciesUpdate(ctx=self.ctx)()
    ...
    class RoutePoliciesUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if ip_community_properties is not None:
                _UpdateHelper._build_schema_ip_community_id_list_update(ip_community_properties.set_prop("add", AAZObjectType, ".add"))
                _UpdateHelper._build_schema_ip_community_id_list_update(ip_community_properties.set_prop("delete", AAZObjectType, ".delete"))
                _UpdateHelper._build_schema_ip_community_id_list_update(ip_community_properties.set_prop("set", AAZObjectType, ".set"))
            ...
            if ip_extended_community_properties is not None:
                _UpdateHelper._build_schema_ip_extended_community_id_list_update(ip_extended_community_properties.set_prop("add", AAZObjectType, ".add"))
                _UpdateHelper._build_schema_ip_extended_community_id_list_update(ip_extended_community_properties.set_prop("delete", AAZObjectType, ".delete"))
                _UpdateHelper._build_schema_ip_extended_community_id_list_update(ip_extended_community_properties.set_prop("set", AAZObjectType, ".set"))
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_ip_community_id_list_read(ip_community_properties.add)
            ip_community_properties.delete = AAZObjectType()
            _UpdateHelper._build_schema_ip_community_id_list_read(ip_community_properties.delete)
            ip_community_properties.set = AAZObjectType()
            _UpdateHelper._build_schema_ip_community_id_list_read(ip_community_properties.set)
            ...
            _UpdateHelper._build_schema_ip_extended_community_id_list_read(ip_extended_community_properties.add)
            ip_extended_community_properties.delete = AAZObjectType()
            _UpdateHelper._build_schema_ip_extended_community_id_list_read(ip_extended_community_properties.delete)
            ip_extended_community_properties.set = AAZObjectType()
            _UpdateHelper._build_schema_ip_extended_community_id_list_read(ip_extended_community_properties.set)
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_ip_community_id_list_update(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_ip_extended_community_id_list_update(cls, _builder):
        if _builder is None:
            return

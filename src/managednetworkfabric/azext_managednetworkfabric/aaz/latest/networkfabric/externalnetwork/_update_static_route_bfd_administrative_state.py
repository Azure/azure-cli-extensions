...
@register_command(
    "networkfabric externalnetwork update-static-route-bfd-administrative-state",
)
class UpdateStaticRouteBfdAdministrativeState(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExternalNetworksUpdateStaticRouteBfdAdministrativeState(ctx=self.ctx)()
    ...
    class ExternalNetworksUpdateStaticRouteBfdAdministrativeState(AAZHttpOperation):

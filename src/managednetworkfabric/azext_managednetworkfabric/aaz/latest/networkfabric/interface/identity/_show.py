...
@register_command(
    "networkfabric interface identity show",
)
...
class _ShowHelper:
    ...
    def _build_schema_network_interface_read(cls, _schema):
        if cls._schema_network_interface_read is not None:
            ...
            _schema.identity = cls._schema_network_interface_read.identity
            _schema.name = cls._schema_network_interface_read.name
            _schema.properties = cls._schema_network_interface_read.properties
            _schema.system_data = cls._schema_network_interface_read.system_data
        ...
        network_interface_read.identity = AAZIdentityObjectType()
        ...
        network_interface_read.system_data = AAZObjectType(
        ...
        identity = _schema_network_interface_read.identity
        ...
        user_assigned_identities = _schema_network_interface_read.identity.user_assigned_identities
        user_assigned_identities.Element = AAZObjectType(
            nullable=True,
        )

        _element = _schema_network_interface_read.identity.user_assigned_identities.Element
        ...
        last_operation = _schema_network_interface_read.properties.last_operation
        last_operation.details = AAZStrType(
            flags={"read_only": True},
        )

        system_data = _schema_network_interface_read.system_data

...
@register_command(
    "networkfabric interface identity assign",
)
class Assign(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.NetworkInterfacesUpdate(ctx=self.ctx)()
    ...
    class NetworkInterfacesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_network_interface_read(cls._schema_on_200)

            return cls._schema_on_200

    class NetworkInterfacesUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
@register_command(
    "networkfabric internalnetwork update-static-route-bfd-administrative-state",
)
class UpdateStaticRouteBfdAdministrativeState(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.internal_network_name = AAZStrArg(
            options=["--resource-name", "--internal-network-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.InternalNetworksUpdateStaticRouteBfdAdministrativeState(ctx=self.ctx)()
    ...
    class InternalNetworksUpdateStaticRouteBfdAdministrativeState(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "internalNetworkName", self.ctx.args.internal_network_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateStaticRouteBfdAdministrativeStateHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _UpdateStaticRouteBfdAdministrativeStateHelper._build_schema_operation_status_result_read(operations.Element)

            properties = cls._schema_on_200.properties
            properties.failed_resources = AAZListType(
                serialized_name="failedResources",
            )
            properties.successful_resources = AAZListType(
                serialized_name="successfulResources",
            )

            failed_resources = cls._schema_on_200.properties.failed_resources
            failed_resources.Element = AAZStrType()

            successful_resources = cls._schema_on_200.properties.successful_resources
            successful_resources.Element = AAZStrType()

            return cls._schema_on_200


class _UpdateStaticRouteBfdAdministrativeStateHelper:
    """Helper class for UpdateStaticRouteBfdAdministrativeState"""
...
__all__ = ["UpdateStaticRouteBfdAdministrativeState"]

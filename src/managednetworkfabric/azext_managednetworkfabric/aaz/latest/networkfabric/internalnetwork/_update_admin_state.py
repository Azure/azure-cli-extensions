...
class UpdateAdminState(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.managednetworkfabric/l3isolationdomains/{}/internalnetworks/{}/updateadministrativestate", "2026-01-15-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.InternalNetworksUpdateAdministrativeState(ctx=self.ctx)()
    ...
    class InternalNetworksUpdateAdministrativeState(AAZHttpOperation):

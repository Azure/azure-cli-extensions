...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.NetworkTapsListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.NetworkTapsListBySubscription(ctx=self.ctx)()
    ...
    class NetworkTapsListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.destinations.Element
            ...
            isolation_domain_properties = cls._schema_on_200.value.Element.properties.destinations.Element.isolation_domain_properties
            ...
            neighbor_group_ids = cls._schema_on_200.value.Element.properties.destinations.Element.isolation_domain_properties.neighbor_group_ids
    ...
    class NetworkTapsListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

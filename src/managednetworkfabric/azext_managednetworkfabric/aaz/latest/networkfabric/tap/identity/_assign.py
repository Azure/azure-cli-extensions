...
@register_command(
    "networkfabric tap identity assign",
)
class Assign(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.NetworkTapsUpdate(ctx=self.ctx)()
    ...
    class NetworkTapsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_network_tap_read(cls._schema_on_200)

            return cls._schema_on_200

    class NetworkTapsUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

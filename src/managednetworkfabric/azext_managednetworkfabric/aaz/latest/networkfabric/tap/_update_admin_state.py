...
@register_command(
    "networkfabric tap update-admin-state",
)
class UpdateAdminState(AAZCommand):
    """Enable/Disable a network tap

    :example: Update admin state of the Network Tap
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkTapsUpdateAdministrativeState(ctx=self.ctx)()
    ...
    class NetworkTapsUpdateAdministrativeState(AAZHttpOperation):

...
@register_command(
    "networkfabric device resync-certificate",
)
class ResyncCertificate(AAZCommand):
    ...
    :example: Updates the Network Device to use the latest certificates
        az networkfabric device resync-certificate --resource-group example-rg --resource-name example-device
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkDevicesResyncCertificates(ctx=self.ctx)()
    ...
    class NetworkDevicesResyncCertificates(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkDevices/{networkDeviceName}/resyncCertificates",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _ResyncCertificateHelper._build_schema_error_detail_read(_schema_on_200.error)
            ...
            _ResyncCertificateHelper._build_schema_operation_status_result_read(operations.Element)

            return cls._schema_on_200


class _ResyncCertificateHelper:
    """Helper class for ResyncCertificate"""

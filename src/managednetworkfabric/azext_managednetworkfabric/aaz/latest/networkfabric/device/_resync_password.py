...
@register_command(
    "networkfabric device resync-password",
)
class ResyncPassword(AAZCommand):
    ...
    :example: Updates the Network Device to use the latest passwords
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkDevicesResyncPasswords(ctx=self.ctx)()
    ...
    class NetworkDevicesResyncPasswords(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkDevices/{networkDeviceName}/resyncPasswords",
                **self.url_parameters
            )

...
#         checks = []
#     test.cmd(
#         "az networkfabric internalnetwork update-static-route-bfd-administrative-state --resource-name {name}"
...
#         checks = []
#     test.cmd(
#         "az networkfabric internalnetwork update-static-route-bfd-administrative-state --internal-network-name {name}"
...
#         checks = []
#     test.cmd(
#         "az networkfabric internalnetwork update-static-route-bfd-administrative-state"
...
#                 "state": CONFIG.get("INTERNAL_NETWORK", "npb_route_bfd_state"),
#             }
#         )

#     @AllowLargeResponse()
#     def test_GA_internalnetwork_update_npb_static_bfd_admin_state_scenario1(self):

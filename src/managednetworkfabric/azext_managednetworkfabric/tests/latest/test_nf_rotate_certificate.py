...
#     """Testcase: scenario1"""
#     setup_scenario(test)
#     step_rotate_certificate_scenario1(test)
...
#     """Testcase: scenario2"""
#     setup_scenario(test)
#     step_rotate_certificate_scenario2(test)
#     cleanup_scenario(test)
...
#         checks = []
#     test.cmd(
#         "az networkfabric fabric rotate-certificate --resource-name {name} --resource-group {resourceGroup}"
#     )
...
#         checks = []
#     test.cmd(
#         "az networkfabric fabric rotate-certificate --network-fabric-name {name} --resource-group {resourceGroup}"
#     )


# class GA_NFRotatePasswordScenarioTest1(ScenarioTest):
#     """NFScenario test"""

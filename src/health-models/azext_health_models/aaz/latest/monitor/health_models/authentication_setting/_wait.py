...
@register_command(
    "monitor health-models authentication-setting wait",
)
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AuthenticationSettingsGet(ctx=self.ctx)()
    ...
    class AuthenticationSettingsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            disc_managed_identity = cls._schema_on_200.properties.discriminate_by("authentication_kind", "ManagedIdentity")

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DiscoveryRulesListByHealthModel(ctx=self.ctx)()
    ...
    class DiscoveryRulesListByHealthModel(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            context = cls._schema_on_200.value.Element.properties.error.context
            ...
            disc_application_insights_topology = cls._schema_on_200.value.Element.properties.specification.discriminate_by("kind", "ApplicationInsightsTopology")
            ...
            disc_resource_graph_query = cls._schema_on_200.value.Element.properties.specification.discriminate_by("kind", "ResourceGraphQuery")

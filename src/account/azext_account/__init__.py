...
from azext_account._help import helps  # pylint: disable=unused-import
...
class SubscriptionClientCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_account._client_factory import cf_account
    ...
    def load_command_table(self, args):
        from azext_account.commands import load_command_table
        load_command_table(self, args)
        return self.command_table

    def load_arguments(self, command):
        from azext_account._params import load_arguments

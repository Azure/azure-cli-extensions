...
class SubscriptionClientScenarioTest(ScenarioTest):
    ...
    def test_account(self, resource_group):
        ...
        self.cmd('az account subscription-factory create-csp-subscription '
        ...
        self.cmd('az account subscription-factory create-subscription '
        ...
        self.cmd('az account subscriptions enable',
                 checks=[])

        self.cmd('az account subscriptions cancel',
                 checks=[])

        self.cmd('az account subscriptions rename',
                 checks=[])
        ...
        self.cmd('az account subscription-operations list',
                 checks=[])

...
def load_arguments(self, _):
    ...
    with self.argument_context('fleet create') as c:
        ...
        c.argument('enable_vnet', arg_type=get_three_state_flag(), is_preview=True, help='Whether to enable apiserver vnet integration for the Fleet hub or not.')
        ...
        c.argument('enable_managed_identity', options_list=['--enable-managed-identity', '-enable-msi'], arg_type=get_three_state_flag(), is_preview=True, help='Using managed identity to manage the Fleet\'s Hub cluster. This value is not set by default, which implies a hubless Fleet.')

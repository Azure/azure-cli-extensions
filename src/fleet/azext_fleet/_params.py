...
def load_arguments(self, _):
    ...
    with self.argument_context('fleet create') as c:
        ...
        c.argument('enable_msi', arg_type=get_three_state_flag(), is_preview=True, help='Use managed identity (MSI) to manage the Fleet\'s Hub cluster. This value is not set by default, which implies a hubless Fleet.')

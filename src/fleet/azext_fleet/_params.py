...
def load_arguments(self, _):
    ...
    with self.argument_context('fleet namespace create') as c:
        ...
        c.argument('cluster_update_strategy', help='Name of an existing cluster staged update strategy. When specified, rollout strategy is automatically set to External; otherwise defaults to RollingUpdate.')
    ...
    with self.argument_context('fleet namespace update') as c:
        ...
        c.argument('member_cluster_names', nargs='*', validator=validate_member_cluster_names, help='Space-separated list of member cluster names to apply the namespace to.')
        c.argument('cluster_update_strategy', help='Name of the cluster update strategy. When specified, rollout strategy is automatically set to External; otherwise defaults to RollingUpdate.')

...
def create_update_run(cmd,
    ...
    if stages:
        ...
        update_run_strategy = update_run_strategy_model(stages=update_stages)
    ...
    managed_cluster_upgrade_spec = managed_cluster_upgrade_spec_model(type=upgrade_type, kubernetes_version=kubernetes_version)

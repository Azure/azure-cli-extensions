...
class AutoUpgradeNodeImageSelection(_serialization.Model):
    ...
    :vartype type: str or ~container_service_fleet_client.models.AutoUpgradeNodeImageSelectionType
    """
    ...
    def __init__(self, *, type: Union[str, "_models.AutoUpgradeNodeImageSelectionType"], **kwargs: Any) -> None:
        ...
        :paramtype type: str or
         ~container_service_fleet_client.models.AutoUpgradeNodeImageSelectionType
        """
        super().__init__(**kwargs)
        self.type = type
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~container_service_fleet_client.models.SystemData
    """
...
class AutoUpgradeProfile(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.AutoUpgradeProfileProvisioningState
    ...
    :vartype channel: str or ~container_service_fleet_client.models.UpgradeChannel
    ...
    :vartype node_image_selection:
     ~container_service_fleet_client.models.AutoUpgradeNodeImageSelection
    ...
    :vartype auto_upgrade_profile_status:
     ~container_service_fleet_client.models.AutoUpgradeProfileStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword channel: Configures how auto-upgrade will be run. Known values are: "Stable", "Rapid",
         "NodeImage", and "TargetKubernetesVersion".
        :paramtype channel: str or ~container_service_fleet_client.models.UpgradeChannel
...
class AutoUpgradeProfileListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.AutoUpgradeProfile]
    ...
    def __init__(
        ...
        :paramtype value: list[~container_service_fleet_client.models.AutoUpgradeProfile]
...
class AutoUpgradeProfileStatus(_serialization.Model):
    ...
    :vartype last_trigger_status: str or
     ~container_service_fleet_client.models.AutoUpgradeLastTriggerStatus
    :ivar last_trigger_error: The error details of the last trigger.
    :vartype last_trigger_error: ~container_service_fleet_client.models.ErrorDetail
...
class ClusterMeshProfile(ProxyResource):
    ...
    :vartype properties: ~container_service_fleet_client.models.ClusterMeshProfileProperties
    :ivar e_tag: If eTag is provided in the response body, it may also be provided as a header per
     the normal etag convention.  Entity tags are used for comparing two or more entities from the
     same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match
     (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
    ...
    def __init__(self, *, properties: Optional["_models.ClusterMeshProfileProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~container_service_fleet_client.models.ClusterMeshProfileProperties
        """
        super().__init__(**kwargs)
...
class ClusterMeshProfileListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.ClusterMeshProfile]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~container_service_fleet_client.models.ClusterMeshProfile]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ClusterMeshProfileProperties(_serialization.Model):
    ...
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.ClusterMeshProfileProvisioningState
    ...
    :vartype member_selector: ~container_service_fleet_client.models.MemberSelector
    :ivar status: The cluster mesh profile status.
    :vartype status: ~container_service_fleet_client.models.ClusterMeshProfileStatus
    """
    ...
    def __init__(self, *, member_selector: Optional["_models.MemberSelector"] = None, **kwargs: Any) -> None:
        ...
        :keyword member_selector: Select the members of the mesh.
          ...
          * Only key/value pairs with the ``=`` operator are accepted in the label selector.
          * If empty or not specified, no Fleet members will be selected to join the mesh.
        :paramtype member_selector: ~container_service_fleet_client.models.MemberSelector
        """
        super().__init__(**kwargs)
...
class ClusterMeshProfileStatus(_serialization.Model):
    ...
    :vartype state: str or ~container_service_fleet_client.models.ClusterMeshState
    :ivar last_applied_member_selector: The last applied MemberSelector for the cluster mesh
     profile.
    :vartype last_applied_member_selector: ~container_service_fleet_client.models.MemberSelector
    ...
    :vartype last_operation_error: ~container_service_fleet_client.models.ErrorDetail
    """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~container_service_fleet_client.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~container_service_fleet_client.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~container_service_fleet_client.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~container_service_fleet_client.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Fleet(TrackedResource):
    ...
    :vartype identity: ~container_service_fleet_client.models.ManagedServiceIdentity
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", and "Deleting".
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.FleetProvisioningState
    :ivar hub_profile: The FleetHubProfile configures the Fleet's hub.
    :vartype hub_profile: ~container_service_fleet_client.models.FleetHubProfile
    :ivar status: Status information for the fleet.
    :vartype status: ~container_service_fleet_client.models.FleetStatus
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~container_service_fleet_client.models.ManagedServiceIdentity
        :keyword hub_profile: The FleetHubProfile configures the Fleet's hub.
        :paramtype hub_profile: ~container_service_fleet_client.models.FleetHubProfile
        """
...
class FleetCredentialResults(_serialization.Model):
    ...
    :vartype kubeconfigs: list[~container_service_fleet_client.models.FleetCredentialResult]
    """
...
class FleetHubProfile(_serialization.Model):
    ...
    :vartype api_server_access_profile:
     ~container_service_fleet_client.models.APIServerAccessProfile
    :ivar agent_profile: The agent profile for the Fleet hub.
    :vartype agent_profile: ~container_service_fleet_client.models.AgentProfile
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype agent_profile: ~container_service_fleet_client.models.AgentProfile
        """
        super().__init__(**kwargs)
...
class FleetListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.Fleet]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: list["_models.Fleet"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~container_service_fleet_client.models.Fleet]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FleetManagedNamespace(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~container_service_fleet_client.models.FleetManagedNamespaceProperties
    :ivar e_tag: If eTag is provided in the response body, it may also be provided as a header per
     the normal etag convention.  Entity tags are used for comparing two or more entities from the
     same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match
     (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~container_service_fleet_client.models.FleetManagedNamespaceProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties
        self.e_tag: Optional[str] = None
...
class FleetManagedNamespaceListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.FleetManagedNamespace]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~container_service_fleet_client.models.FleetManagedNamespace]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FleetManagedNamespacePatch(_serialization.Model):
    ...
    :vartype properties:
     ~container_service_fleet_client.models.FleetManagedNamespacePropertiesPatch
    """
...
class FleetManagedNamespaceProperties(_serialization.Model):
    ...
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", and "Deleting".
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.FleetManagedNamespaceProvisioningState
    ...
    :vartype managed_namespace_properties:
     ~container_service_fleet_client.models.ManagedNamespaceProperties
    ...
    :vartype adoption_policy: str or ~container_service_fleet_client.models.AdoptionPolicy
    :ivar delete_policy: Delete options of a fleet managed namespace. Default is Keep. Required.
     Known values are: "Keep" and "Delete".
    :vartype delete_policy: str or ~container_service_fleet_client.models.DeletePolicy
    :ivar propagation_policy: The profile of the propagation to create the namespace.
    :vartype propagation_policy: ~container_service_fleet_client.models.PropagationPolicy
    :ivar status: Status information of the last operation for fleet managed namespace.
    :vartype status: ~container_service_fleet_client.models.FleetManagedNamespaceStatus
    :ivar portal_fqdn: The Azure Portal FQDN of the Fleet hub.
    :vartype portal_fqdn: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword adoption_policy: Action if the managed namespace with the same name already exists.
         Default is Never. Required. Known values are: "Never", "IfIdentical", and "Always".
        :paramtype adoption_policy: str or ~container_service_fleet_client.models.AdoptionPolicy
        :keyword delete_policy: Delete options of a fleet managed namespace. Default is Keep. Required.
         Known values are: "Keep" and "Delete".
        :paramtype delete_policy: str or ~container_service_fleet_client.models.DeletePolicy
        :keyword propagation_policy: The profile of the propagation to create the namespace.
        :paramtype propagation_policy: ~container_service_fleet_client.models.PropagationPolicy
        """
        super().__init__(**kwargs)
...
class FleetMember(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.FleetMemberProvisioningState
    ...
    :vartype status: ~container_service_fleet_client.models.FleetMemberStatus
    :ivar mesh_properties: The Mesh Member Properties associated with this Fleet Member.
    :vartype mesh_properties: ~container_service_fleet_client.models.MeshProperties
    """
...
class FleetMemberListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.FleetMember]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: list["_models.FleetMember"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~container_service_fleet_client.models.FleetMember]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FleetUpdateStrategy(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.FleetUpdateStrategyProvisioningState
    :ivar strategy: Defines the update sequence of the clusters.
    :vartype strategy: ~container_service_fleet_client.models.UpdateRunStrategy
    """
    ...
    def __init__(self, *, strategy: Optional["_models.UpdateRunStrategy"] = None, **kwargs: Any) -> None:
        ...
        :paramtype strategy: ~container_service_fleet_client.models.UpdateRunStrategy
        """
        super().__init__(**kwargs)
        self.e_tag: Optional[str] = None
...
class FleetUpdateStrategyListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.FleetUpdateStrategy]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~container_service_fleet_client.models.FleetUpdateStrategy]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class Gate(ProxyResource):
    ...
    :ivar provisioning_state: The provisioning state of the Gate resource. Known values are:
     "Succeeded", "Failed", and "Canceled".
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.GateProvisioningState
    ...
    :vartype gate_type: str or ~container_service_fleet_client.models.GateType
    :ivar scheduled_start_properties: Details for ScheduledStart gate.
    :vartype scheduled_start_properties:
     ~container_service_fleet_client.models.ScheduledStartProperties
    :ivar target: The target that the Gate is controlling, e.g. an Update Run.
    :vartype target: ~container_service_fleet_client.models.GateTarget
    :ivar state: The state of the Gate. Known values are: "Pending", "Skipped", and "Completed".
    :vartype state: str or ~container_service_fleet_client.models.GateState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword gate_type: The type of the Gate determines how it is completed. Known values are:
         "Approval" and "ScheduledStart".
        :paramtype gate_type: str or ~container_service_fleet_client.models.GateType
        ...
        :paramtype target: ~container_service_fleet_client.models.GateTarget
        :keyword state: The state of the Gate. Known values are: "Pending", "Skipped", and "Completed".
        :paramtype state: str or ~container_service_fleet_client.models.GateState
        """
        super().__init__(**kwargs)
        self.e_tag: Optional[str] = None
...
class GateConfiguration(_serialization.Model):
    ...
    :ivar type: The type of the Gate determines how it is completed. Required. Known values are:
     "Approval" and "ScheduledStart".
    :vartype type: str or ~container_service_fleet_client.models.GateType
    :ivar scheduled_start_configuration: Scheduled start configuration for gates of type
     ScheduledStart.
    :vartype scheduled_start_configuration:
     ~container_service_fleet_client.models.ScheduledStartConfiguration
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of the Gate determines how it is completed. Required. Known values are:
         "Approval" and "ScheduledStart".
        :paramtype type: str or ~container_service_fleet_client.models.GateType
...
class GateListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.Gate]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: list["_models.Gate"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~container_service_fleet_client.models.Gate]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class GatePatch(_serialization.Model):
    ...
    :vartype properties: ~container_service_fleet_client.models.GatePatchProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.GatePatchProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~container_service_fleet_client.models.GatePatchProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class GateTarget(_serialization.Model):
    ...
    :vartype update_run_properties:
     ~container_service_fleet_client.models.UpdateRunGateTargetProperties
    """
...
class ManagedClusterUpdate(_serialization.Model):
    ...
    :vartype upgrade: ~container_service_fleet_client.models.ManagedClusterUpgradeSpec
    :ivar node_image_selection: The node image upgrade to be applied to the target nodes in update
     run.
    :vartype node_image_selection: ~container_service_fleet_client.models.NodeImageSelection
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype upgrade: ~container_service_fleet_client.models.ManagedClusterUpgradeSpec
        :keyword node_image_selection: The node image upgrade to be applied to the target nodes in
         update run.
        :paramtype node_image_selection: ~container_service_fleet_client.models.NodeImageSelection
        """
        super().__init__(**kwargs)
...
class ManagedClusterUpgradeSpec(_serialization.Model):
    ...
    :vartype type: str or ~container_service_fleet_client.models.ManagedClusterUpgradeType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: ManagedClusterUpgradeType is the type of upgrade to be applied. Required. Known
         values are: "Full", "NodeImageOnly", and "ControlPlaneOnly".
        :paramtype type: str or ~container_service_fleet_client.models.ManagedClusterUpgradeType
...
class ManagedNamespaceProperties(_serialization.Model):
    ...
    :vartype default_resource_quota: ~container_service_fleet_client.models.ResourceQuota
    :ivar default_network_policy: The default network policy for the fleet managed namespace.
    :vartype default_network_policy: ~container_service_fleet_client.models.NetworkPolicy
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype default_resource_quota: ~container_service_fleet_client.models.ResourceQuota
        :keyword default_network_policy: The default network policy for the fleet managed namespace.
        :paramtype default_network_policy: ~container_service_fleet_client.models.NetworkPolicy
        """
        super().__init__(**kwargs)
        self.labels = labels
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~container_service_fleet_client.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~container_service_fleet_client.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned, UserAssigned".
        :paramtype type: str or ~container_service_fleet_client.models.ManagedServiceIdentityType
...
class MemberUpdateStatus(_serialization.Model):
    ...
    :vartype status: ~container_service_fleet_client.models.UpdateStatus
...
class MeshMemberStatus(_serialization.Model):
    ...
    :vartype state: str or ~container_service_fleet_client.models.MeshMemberState
...
class MeshProperties(_serialization.Model):
    ...
    :vartype cilium_properties: ~container_service_fleet_client.models.CiliumProperties
    :ivar status: The status of the mesh member. Required.
    :vartype status: ~container_service_fleet_client.models.MeshMemberStatus
...
class MetaV1LabelSelector(_serialization.Model):
    ...
    :vartype match_expressions:
     list[~container_service_fleet_client.models.MetaV1LabelSelectorRequirement]
    """
...
class MetaV1LabelSelectorRequirement(_serialization.Model):
    ...
    :ivar operator: operator represents a key's relationship to a set of values. Valid operators
     ...
     and "DoesNotExist".
    :vartype operator: str or ~container_service_fleet_client.models.LabelSelectorOperator
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword operator: operator represents a key's relationship to a set of values. Valid operators
         are In, NotIn, Exists and DoesNotExist. Required. Known values are: "In", "NotIn", "Exists",
         and "DoesNotExist".
        :paramtype operator: str or ~container_service_fleet_client.models.LabelSelectorOperator
...
class NetworkPolicy(_serialization.Model):
    ...
    :vartype ingress: str or ~container_service_fleet_client.models.PolicyRule
    :ivar egress: The egress policy for the managed namespace. Known values are: "AllowAll",
     "DenyAll", and "AllowSameNamespace".
    :vartype egress: str or ~container_service_fleet_client.models.PolicyRule
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword ingress: The ingress policy for the managed namespace. Known values are: "AllowAll",
         "DenyAll", and "AllowSameNamespace".
        :paramtype ingress: str or ~container_service_fleet_client.models.PolicyRule
        :keyword egress: The egress policy for the managed namespace. Known values are: "AllowAll",
         "DenyAll", and "AllowSameNamespace".
        :paramtype egress: str or ~container_service_fleet_client.models.PolicyRule
        """
        super().__init__(**kwargs)
...
class NodeImageSelection(_serialization.Model):
    ...
    :ivar type: The node image upgrade type. Required. Known values are: "Latest", "Consistent",
     and "Custom".
    :vartype type: str or ~container_service_fleet_client.models.NodeImageSelectionType
    ...
    :vartype custom_node_image_versions:
     list[~container_service_fleet_client.models.NodeImageVersion]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The node image upgrade type. Required. Known values are: "Latest", "Consistent",
         and "Custom".
        :paramtype type: str or ~container_service_fleet_client.models.NodeImageSelectionType
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~container_service_fleet_client.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~container_service_fleet_client.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~container_service_fleet_client.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~container_service_fleet_client.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name: Optional[str] = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.Operation]
...
class PlacementProfile(_serialization.Model):
    ...
    :vartype default_cluster_resource_placement:
     ~container_service_fleet_client.models.PlacementV1ClusterResourcePlacementSpec
    """
...
class PlacementV1Affinity(_serialization.Model):
    ...
    :ivar cluster_affinity: ClusterAffinity contains cluster affinity scheduling rules for the
     selected resources.
    :vartype cluster_affinity: ~container_service_fleet_client.models.PlacementV1ClusterAffinity
    """
    ...
    def __init__(
        ...
        :keyword cluster_affinity: ClusterAffinity contains cluster affinity scheduling rules for the
         selected resources.
        :paramtype cluster_affinity: ~container_service_fleet_client.models.PlacementV1ClusterAffinity
        """
        super().__init__(**kwargs)
...
class PlacementV1ClusterAffinity(_serialization.Model):
    ...
    :vartype required_during_scheduling_ignored_during_execution:
     ~container_service_fleet_client.models.PlacementV1ClusterSelector
    """
...
class PlacementV1ClusterResourcePlacementSpec(_serialization.Model):
    ...
    :vartype policy: ~container_service_fleet_client.models.PlacementV1PlacementPolicy
    :ivar rollout_strategy: The rollout strategy configuration for the cluster resource placement.
    :vartype rollout_strategy: ~container_service_fleet_client.models.PlacementV1RolloutStrategy
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype policy: ~container_service_fleet_client.models.PlacementV1PlacementPolicy
        :keyword rollout_strategy: The rollout strategy configuration for the cluster resource
         placement.
        :paramtype rollout_strategy: ~container_service_fleet_client.models.PlacementV1RolloutStrategy
        """
        super().__init__(**kwargs)
        self.policy = policy
...
class PlacementV1ClusterSelector(_serialization.Model):
    ...
    :vartype cluster_selector_terms:
     list[~container_service_fleet_client.models.PlacementV1ClusterSelectorTerm]
    """
...
class PlacementV1ClusterSelectorTerm(_serialization.Model):
    ...
    :vartype label_selector: ~container_service_fleet_client.models.MetaV1LabelSelector
    ...
    :vartype property_selector: ~container_service_fleet_client.models.PlacementV1PropertySelector
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword label_selector: LabelSelector is a label query over all the joined member clusters.
         Clusters matching the query are selected. If you specify both label and property selectors in
         the same term, the results are AND'd.
        :paramtype label_selector: ~container_service_fleet_client.models.MetaV1LabelSelector
        ...
        :paramtype property_selector:
         ~container_service_fleet_client.models.PlacementV1PropertySelector
        """
        super().__init__(**kwargs)
...
class PlacementV1ClusterUpdateStrategyReference(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar name: The name of an existing cluster staged update strategy. Required.
    :vartype name: str
    """
    ...
    def __init__(self, *, name: str, **kwargs: Any) -> None:
        """
        :keyword name: The name of an existing cluster staged update strategy. Required.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class PlacementV1PlacementPolicy(_serialization.Model):
    ...
    :vartype placement_type: str or ~container_service_fleet_client.models.PlacementType
    ...
    :ivar affinity: Affinity contains cluster affinity scheduling rules. Defines which member
     ...
     "PickN".
    :vartype affinity: ~container_service_fleet_client.models.PlacementV1Affinity
    ...
    :vartype tolerations: list[~container_service_fleet_client.models.PlacementV1Toleration]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype placement_type: str or ~container_service_fleet_client.models.PlacementType
        ...
        :keyword affinity: Affinity contains cluster affinity scheduling rules. Defines which member
         clusters to place the selected resources. Only valid if the placement type is "PickAll" or
         "PickN".
        :paramtype affinity: ~container_service_fleet_client.models.PlacementV1Affinity
        :keyword tolerations: If specified, the ClusterResourcePlacement's Tolerations. Tolerations
         ...
         feature.
        :paramtype tolerations: list[~container_service_fleet_client.models.PlacementV1Toleration]
        """
        super().__init__(**kwargs)
...
class PlacementV1PropertySelector(_serialization.Model):
    ...
    :vartype match_expressions:
     list[~container_service_fleet_client.models.PlacementV1PropertySelectorRequirement]
    """
...
class PlacementV1PropertySelectorRequirement(_serialization.Model):
    ...
    :ivar operator: Operator specifies the relationship between a cluster's observed value of the
     ...
     "Ge", "Eq", "Ne", "Lt", and "Le".
    :vartype operator: str or ~container_service_fleet_client.models.PropertySelectorOperator
    ...
    def __init__(
        ...
        :paramtype operator: str or ~container_service_fleet_client.models.PropertySelectorOperator
...
class PlacementV1RolloutStrategy(_serialization.Model):
    ...
    :vartype type: str or ~container_service_fleet_client.models.RolloutStrategyType
    ...
    :vartype cluster_update_strategy:
     ~container_service_fleet_client.models.PlacementV1ClusterUpdateStrategyReference
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of rollout strategy. Default is RollingUpdate. Known values are:
         "RollingUpdate" and "External".
        :paramtype type: str or ~container_service_fleet_client.models.RolloutStrategyType
...
class PlacementV1Toleration(_serialization.Model):
    ...
    :ivar operator: Operator represents a key's relationship to the value. Valid operators are
     ...
     "Exists" and "Equal".
    :vartype operator: str or ~container_service_fleet_client.models.TolerationOperator
    ...
    :vartype effect: str or ~container_service_fleet_client.models.TaintEffect
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword operator: Operator represents a key's relationship to the value. Valid operators are
         ...
         ClusterResourcePlacement can tolerate all taints of a particular category. Known values are:
         "Exists" and "Equal".
        :paramtype operator: str or ~container_service_fleet_client.models.TolerationOperator
        ...
        :paramtype effect: str or ~container_service_fleet_client.models.TaintEffect
        """
        super().__init__(**kwargs)
        self.key = key
        self.operator = operator
...
class PropagationPolicy(_serialization.Model):
    ...
    :vartype type: str or ~container_service_fleet_client.models.PropagationType
    :ivar placement_profile: The profile to be used for propagation via placement.
    :vartype placement_profile: ~container_service_fleet_client.models.PlacementProfile
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~container_service_fleet_client.models.PropagationType
        :keyword placement_profile: The profile to be used for propagation via placement.
        :paramtype placement_profile: ~container_service_fleet_client.models.PlacementProfile
        """
        super().__init__(**kwargs)
        self.type = type
...
class ScheduledStartConfiguration(_serialization.Model):
    ...
    :vartype start_day: str or ~container_service_fleet_client.models.DayOfWeek
    ...
    def __init__(
        ...
        :keyword start_day: The day of the week when the scheduled start occurs. Required. Known values
         are: "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", and "Sunday".
        :paramtype start_day: str or ~container_service_fleet_client.models.DayOfWeek
...
class SkipProperties(_serialization.Model):
    ...
    :vartype targets: list[~container_service_fleet_client.models.SkipTarget]
    """
    ...
    def __init__(self, *, targets: list["_models.SkipTarget"], **kwargs: Any) -> None:
        ...
        :paramtype targets: list[~container_service_fleet_client.models.SkipTarget]
        """
        super().__init__(**kwargs)
...
class SkipTarget(_serialization.Model):
    ...
    :ivar type: The skip target type. Required. Known values are: "Member", "Group", "Stage", and
     "AfterStageWait".
    :vartype type: str or ~container_service_fleet_client.models.TargetType
    ...
    def __init__(self, *, type: Union[str, "_models.TargetType"], name: str, **kwargs: Any) -> None:
        ...
        :keyword type: The skip target type. Required. Known values are: "Member", "Group", "Stage",
         and "AfterStageWait".
        :paramtype type: str or ~container_service_fleet_client.models.TargetType
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~container_service_fleet_client.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~container_service_fleet_client.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~container_service_fleet_client.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~container_service_fleet_client.models.CreatedByType
...
class UpdateGroup(_serialization.Model):
    ...
    :ivar max_allowed_failures: Limits the number of member (cluster) upgrade failures tolerated
     ...
     upgrade failures are tolerated within this group. The 4th failure would cause the entire stage
     to fail. • "25%" --> up to 25% of the members in this group can fail their upgrade before the
     group is considered failed.
    ...
    :vartype before_gates: list[~container_service_fleet_client.models.GateConfiguration]
    :ivar after_gates: A list of Gates that will be created after this Group is executed.
    :vartype after_gates: list[~container_service_fleet_client.models.GateConfiguration]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype before_gates: list[~container_service_fleet_client.models.GateConfiguration]
        :keyword after_gates: A list of Gates that will be created after this Group is executed.
        :paramtype after_gates: list[~container_service_fleet_client.models.GateConfiguration]
        """
        super().__init__(**kwargs)
        self.name = name
...
class UpdateGroupStatus(_serialization.Model):
    ...
    :vartype members: list[~container_service_fleet_client.models.MemberUpdateStatus]
    :ivar before_gates: The list of Gates that will run before this UpdateGroup.
    :vartype before_gates: list[~container_service_fleet_client.models.UpdateRunGateStatus]
    :ivar after_gates: The list of Gates that will run after this UpdateGroup.
    :vartype after_gates: list[~container_service_fleet_client.models.UpdateRunGateStatus]
    """
...
class UpdateRun(ProxyResource):
    ...
    :ivar provisioning_state: The provisioning state of the UpdateRun resource. Known values are:
     "Succeeded", "Failed", and "Canceled".
    :vartype provisioning_state: str or
     ~container_service_fleet_client.models.UpdateRunProvisioningState
    ...
    :vartype managed_cluster_update: ~container_service_fleet_client.models.ManagedClusterUpdate
    :ivar status: The status of the UpdateRun.
    :vartype status: ~container_service_fleet_client.models.UpdateRunStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword managed_cluster_update: The update to be applied to all clusters in the UpdateRun. The
         managedClusterUpdate can be modified until the run is started.
        :paramtype managed_cluster_update: ~container_service_fleet_client.models.ManagedClusterUpdate
        """
        super().__init__(**kwargs)
        self.e_tag: Optional[str] = None
...
class UpdateRunGateTargetProperties(_serialization.Model):
    ...
    :vartype timing: str or ~container_service_fleet_client.models.Timing
    """
    ...
    def __init__(self, *, timing: Union[str, "_models.Timing"], **kwargs: Any) -> None:
        ...
        :keyword timing: Whether the Gate is placed before or after the update itself. Required. Known
         values are: "Before" and "After".
        :paramtype timing: str or ~container_service_fleet_client.models.Timing
        """
        super().__init__(**kwargs)
        self.name: Optional[str] = None
...
class UpdateRunListResult(_serialization.Model):
    ...
    :vartype value: list[~container_service_fleet_client.models.UpdateRun]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: list["_models.UpdateRun"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~container_service_fleet_client.models.UpdateRun]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class UpdateRunStatus(_serialization.Model):
    ...
    :ivar stages: The stages composing an update run. Stages are run sequentially withing an
     UpdateRun.
    :vartype stages: list[~container_service_fleet_client.models.UpdateStageStatus]
    ...
    :vartype node_image_selection: ~container_service_fleet_client.models.NodeImageSelectionStatus
...
class UpdateRunStrategy(_serialization.Model):
    ...
    :vartype stages: list[~container_service_fleet_client.models.UpdateStage]
    """
    ...
    def __init__(self, *, stages: list["_models.UpdateStage"], **kwargs: Any) -> None:
        ...
        :paramtype stages: list[~container_service_fleet_client.models.UpdateStage]
        """
        super().__init__(**kwargs)
        self.stages = stages
...
class UpdateStage(_serialization.Model):
    ...
    :vartype groups: list[~container_service_fleet_client.models.UpdateGroup]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype groups: list[~container_service_fleet_client.models.UpdateGroup]
...
class UpdateStageStatus(_serialization.Model):
    ...
    :vartype groups: list[~container_service_fleet_client.models.UpdateGroupStatus]
    ...
    :vartype after_stage_wait_status: ~container_service_fleet_client.models.WaitStatus
    """
...
class UpdateStatus(_serialization.Model):
    ...
    :vartype state: str or ~container_service_fleet_client.models.UpdateState

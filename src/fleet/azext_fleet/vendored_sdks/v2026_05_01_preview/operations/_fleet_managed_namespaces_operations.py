...
class FleetManagedNamespacesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~container_service_fleet_client.ContainerServiceFleetClient`'s
    ...
    def list_by_fleet(
        ...
        :return: An iterator like instance of either FleetManagedNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~container_service_fleet_client.models.FleetManagedNamespace]
    ...
    def get(
        ...
        :rtype: ~container_service_fleet_client.models.FleetManagedNamespace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.FleetManagedNamespace
        ...
        :return: An instance of LROPoller that returns either FleetManagedNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~container_service_fleet_client.models.FleetManagedNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.FleetManagedNamespace or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~container_service_fleet_client.models.FleetManagedNamespacePatch
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~container_service_fleet_client.models.FleetManagedNamespacePatch or
         IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str

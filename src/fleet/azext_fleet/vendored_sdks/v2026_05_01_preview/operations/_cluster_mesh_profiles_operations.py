...
class ClusterMeshProfilesOperations:
    ...
    def list_by_fleet(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_service_fleet_client.models.ClusterMeshProfile]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ClusterMeshProfile or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~container_service_fleet_client.models.ClusterMeshProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

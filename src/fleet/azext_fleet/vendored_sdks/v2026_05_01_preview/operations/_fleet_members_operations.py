...
class FleetMembersOperations:
    ...
    def list_by_fleet(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~container_service_fleet_client.models.FleetMember]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~container_service_fleet_client.models.FleetMember]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

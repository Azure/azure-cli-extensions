...
def build_generate_update_run_request(
...
class AutoUpgradeProfileOperationsOperations:
    ...
    def begin_generate_update_run(
        ...
        :return: An instance of LROPoller that returns either GenerateResponse or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~container_service_fleet_client.models.GenerateResponse]

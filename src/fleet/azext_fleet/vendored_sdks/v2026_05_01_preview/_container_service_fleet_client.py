...
class ContainerServiceFleetClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: container_service_fleet_client.operations.Operations
    :ivar fleets: FleetsOperations operations
    :vartype fleets: container_service_fleet_client.operations.FleetsOperations
    :ivar auto_upgrade_profiles: AutoUpgradeProfilesOperations operations
    :vartype auto_upgrade_profiles:
     container_service_fleet_client.operations.AutoUpgradeProfilesOperations
    ...
    :vartype auto_upgrade_profile_operations:
     container_service_fleet_client.operations.AutoUpgradeProfileOperationsOperations
    :ivar cluster_mesh_profiles: ClusterMeshProfilesOperations operations
    :vartype cluster_mesh_profiles:
     container_service_fleet_client.operations.ClusterMeshProfilesOperations
    :ivar gates: GatesOperations operations
    :vartype gates: container_service_fleet_client.operations.GatesOperations
    :ivar fleet_managed_namespaces: FleetManagedNamespacesOperations operations
    :vartype fleet_managed_namespaces:
     container_service_fleet_client.operations.FleetManagedNamespacesOperations
    :ivar fleet_members: FleetMembersOperations operations
    :vartype fleet_members: container_service_fleet_client.operations.FleetMembersOperations
    :ivar update_runs: UpdateRunsOperations operations
    :vartype update_runs: container_service_fleet_client.operations.UpdateRunsOperations
    :ivar fleet_update_strategies: FleetUpdateStrategiesOperations operations
    :vartype fleet_update_strategies:
     container_service_fleet_client.operations.FleetUpdateStrategiesOperations

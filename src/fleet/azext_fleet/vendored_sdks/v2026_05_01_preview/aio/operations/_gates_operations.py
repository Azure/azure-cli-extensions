...
class GatesOperations:
    ...
    def list_by_fleet(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~container_service_fleet_client.models.Gate]
    ...
    async def get(self, resource_group_name: str, fleet_name: str, gate_name: str, **kwargs: Any) -> _models.Gate:
        ...
        :rtype: ~container_service_fleet_client.models.Gate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~container_service_fleet_client.models.GatePatch
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~container_service_fleet_client.models.Gate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~container_service_fleet_client.models.GatePatch or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

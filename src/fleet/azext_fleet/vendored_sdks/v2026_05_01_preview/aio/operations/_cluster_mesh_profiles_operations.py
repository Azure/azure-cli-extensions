...
class ClusterMeshProfilesOperations:
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~container_service_fleet_client.models.ClusterMeshProfile]
    ...
    async def get(
        ...
        :rtype: ~container_service_fleet_client.models.ClusterMeshProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.ClusterMeshProfile
        ...
        :return: An instance of AsyncLROPoller that returns either ClusterMeshProfile or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~container_service_fleet_client.models.ClusterMeshProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a ClusterMeshProfile type or a IO[bytes]
         type. Required.
        :type resource: ~container_service_fleet_client.models.ClusterMeshProfile or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

...
class FleetUpdateStrategiesOperations:
    ...
    def list_by_fleet(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~container_service_fleet_client.models.FleetUpdateStrategy]
    ...
    async def get(
        ...
        :rtype: ~container_service_fleet_client.models.FleetUpdateStrategy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.FleetUpdateStrategy
        ...
        :return: An instance of AsyncLROPoller that returns either FleetUpdateStrategy or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~container_service_fleet_client.models.FleetUpdateStrategy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.FleetUpdateStrategy or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

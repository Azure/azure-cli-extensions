...
class UpdateRunsOperations:
    ...
    def list_by_fleet(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~container_service_fleet_client.models.UpdateRun]
    ...
    async def get(
        ...
        :rtype: ~container_service_fleet_client.models.UpdateRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~container_service_fleet_client.models.UpdateRun
        ...
        :return: An instance of AsyncLROPoller that returns either UpdateRun or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~container_service_fleet_client.models.UpdateRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a UpdateRun type or a IO[bytes] type.
         Required.
        :type resource: ~container_service_fleet_client.models.UpdateRun or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    async def begin_skip(
        ...
        **kwargs: Any
        ...
        :type body: ~container_service_fleet_client.models.SkipProperties
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def begin_skip(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a SkipProperties type or a IO[bytes]
         type. Required.
        :type body: ~container_service_fleet_client.models.SkipProperties or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :return: An instance of AsyncLROPoller that returns either UpdateRun or the result of

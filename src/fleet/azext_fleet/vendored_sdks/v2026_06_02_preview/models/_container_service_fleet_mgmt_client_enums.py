...
class UpgradeChannel(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    N-1, where N is the latest supported minor version. For example, if a cluster runs version
    1.17.7 and versions 1.17.9, 1.18.4, 1.18.6, and 1.19.1 are available, the cluster upgrades to
    1.18.6."""
    RAPID = "Rapid"

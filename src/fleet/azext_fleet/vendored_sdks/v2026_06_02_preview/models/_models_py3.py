    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword disabled: If set to False: the auto upgrade has effect - target managed clusters will
         be upgraded on schedule. If set to True: the auto upgrade has no effect - no upgrade will be
         run on the target managed clusters. This is a boolean and not an enum because enabled/disabled
         are all available states of the auto upgrade profile. By default, this is set to False.
...
class FleetManagedNamespace(TrackedResource):
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "FleetManagedNamespaceProperties"},
        "e_tag": {"key": "eTag", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.containerservicefleet.models.FleetManagedNamespaceProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties
        self.e_tag: Optional[str] = None
...
class FleetManagedNamespaceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.models.FleetManagedNamespace]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.containerservicefleet.models.FleetManagedNamespace]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FleetManagedNamespacePatch(_serialization.Model):
    ...
    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "FleetManagedNamespacePropertiesPatch"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword properties: The updatable properties of the fleet managed namespace.
...
class FleetManagedNamespaceProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword adoption_policy: Action if the managed namespace with the same name already exists.
         Default is Never. Required. Known values are: "Never", "IfIdentical", and "Always".
        :paramtype adoption_policy: str or ~azure.mgmt.containerservicefleet.models.AdoptionPolicy
        :keyword delete_policy: Delete options of a fleet managed namespace. Default is Keep. Required.
         Known values are: "Keep" and "Delete".
...
class FleetManagedNamespacePropertiesPatch(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype adoption_policy: str or ~azure.mgmt.containerservicefleet.models.AdoptionPolicy
        :keyword delete_policy: Delete options of a fleet managed namespace. Known values are: "Keep"
         and "Delete".
        :paramtype delete_policy: str or ~azure.mgmt.containerservicefleet.models.DeletePolicy
        :keyword propagation_policy: The profile of the propagation to create the namespace.
        :paramtype propagation_policy: ~azure.mgmt.containerservicefleet.models.PropagationPolicy
...
class Gate(ProxyResource):
    ...
    :ivar gate_type: The type of the Gate determines how it is completed. Known values are:
    ...
    _attribute_map = {
        ...
        "scheduled_start_properties": {
            "key": "properties.scheduledStartProperties",
            "type": "ScheduledStartProperties",
        },
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword gate_type: The type of the Gate determines how it is completed. Known values are:
         "Approval" and "ScheduledStart".
        :paramtype gate_type: str or ~azure.mgmt.containerservicefleet.models.GateType
        :keyword scheduled_start_properties: Details for ScheduledStart gate.
        :paramtype scheduled_start_properties:
         ~azure.mgmt.containerservicefleet.models.ScheduledStartProperties
        :keyword target: The target that the Gate is controlling, e.g. an Update Run.
        :paramtype target: ~azure.mgmt.containerservicefleet.models.GateTarget
        :keyword state: The state of the Gate. Known values are: "Pending", "Skipped", and "Completed".
        :paramtype state: str or ~azure.mgmt.containerservicefleet.models.GateState
        """
        super().__init__(**kwargs)
        self.e_tag: Optional[str] = None
        ...
        self.scheduled_start_properties = scheduled_start_properties
        self.target = target
        self.state = state
...
class GateConfiguration(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "scheduled_start_configuration": {"key": "scheduledStartConfiguration", "type": "ScheduledStartConfiguration"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword display_name: The human-readable display name of the Gate.
        :paramtype display_name: str
        :keyword type: The type of the Gate determines how it is completed. Required. Known values are:
         "Approval" and "ScheduledStart".
        :paramtype type: str or ~azure.mgmt.containerservicefleet.models.GateType
        :keyword scheduled_start_configuration: Scheduled start configuration for gates of type
         ScheduledStart.
        :paramtype scheduled_start_configuration:
         ~azure.mgmt.containerservicefleet.models.ScheduledStartConfiguration
        """
        super().__init__(**kwargs)
        self.display_name = display_name
        self.type = type
        self.scheduled_start_configuration = scheduled_start_configuration
...
class GateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.models.Gate]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
...
class GatePatch(_serialization.Model):
    ...
    def __init__(self, *, properties: Optional["_models.GatePatchProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.containerservicefleet.models.GatePatchProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class ManagedNamespaceProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype default_resource_quota: ~azure.mgmt.containerservicefleet.models.ResourceQuota
        :keyword default_network_policy: The default network policy for the fleet managed namespace.
        :paramtype default_network_policy: ~azure.mgmt.containerservicefleet.models.NetworkPolicy
        """
        super().__init__(**kwargs)
        self.labels = labels
...
class MetaV1LabelSelector(_serialization.Model):
    ...
    :vartype match_expressions:
     list[~azure.mgmt.containerservicefleet.models.MetaV1LabelSelectorRequirement]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword ingress: The ingress policy for the managed namespace. Known values are: "AllowAll",
         "DenyAll", and "AllowSameNamespace".
        :paramtype ingress: str or ~azure.mgmt.containerservicefleet.models.PolicyRule
        :keyword egress: The egress policy for the managed namespace. Known values are: "AllowAll",
         "DenyAll", and "AllowSameNamespace".
        :paramtype egress: str or ~azure.mgmt.containerservicefleet.models.PolicyRule
        """
        super().__init__(**kwargs)
...
class PlacementProfile(_serialization.Model):
    ...
    :vartype default_cluster_resource_placement:
     ~azure.mgmt.containerservicefleet.models.PlacementV1ClusterResourcePlacementSpec
    """
...
class PlacementV1Affinity(_serialization.Model):
    ...
    :ivar cluster_affinity: ClusterAffinity contains cluster affinity scheduling rules for the
     selected resources.
    :vartype cluster_affinity: ~azure.mgmt.containerservicefleet.models.PlacementV1ClusterAffinity
    """
...
class PlacementV1ClusterAffinity(_serialization.Model):
    ...
    :vartype required_during_scheduling_ignored_during_execution:
     ~azure.mgmt.containerservicefleet.models.PlacementV1ClusterSelector
    """
...
class PlacementV1ClusterResourcePlacementSpec(_serialization.Model):
    ...
    :vartype policy: ~azure.mgmt.containerservicefleet.models.PlacementV1PlacementPolicy
    ...
    def __init__(
        self,
        *,
        policy: Optional["_models.PlacementV1PlacementPolicy"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype policy: ~azure.mgmt.containerservicefleet.models.PlacementV1PlacementPolicy
        :keyword rollout_strategy: The rollout strategy configuration for the cluster resource
         placement.
...
class PlacementV1ClusterSelectorTerm(_serialization.Model):
    ...
    :vartype label_selector: ~azure.mgmt.containerservicefleet.models.MetaV1LabelSelector
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword label_selector: LabelSelector is a label query over all the joined member clusters.
         Clusters matching the query are selected. If you specify both label and property selectors in
         the same term, the results are AND'd.
        :paramtype label_selector: ~azure.mgmt.containerservicefleet.models.MetaV1LabelSelector
...
class PlacementV1ClusterUpdateStrategyReference(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(self, *, name: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword name: The name of an existing cluster staged update strategy.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class PlacementV1PlacementPolicy(_serialization.Model):
    ...
    :ivar affinity: Affinity contains cluster affinity scheduling rules. Defines which member
     ...
     "PickN".
    :vartype affinity: ~azure.mgmt.containerservicefleet.models.PlacementV1Affinity
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword affinity: Affinity contains cluster affinity scheduling rules. Defines which member
         clusters to place the selected resources. Only valid if the placement type is "PickAll" or
         "PickN".
        :paramtype affinity: ~azure.mgmt.containerservicefleet.models.PlacementV1Affinity
...
class PlacementV1RolloutStrategy(_serialization.Model):
    ...
    :vartype cluster_update_strategy:
     ~azure.mgmt.containerservicefleet.models.PlacementV1ClusterUpdateStrategyReference
    """

    _attribute_map = {
        "type": {"key": "type", "type": "str"},
        "cluster_update_strategy": {
            "key": "clusterUpdateStrategy",
            "type": "PlacementV1ClusterUpdateStrategyReference",
        },
    }
    ...
    def __init__(
        ...
        *,
        ...
        cluster_update_strategy: Optional["_models.PlacementV1ClusterUpdateStrategyReference"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword type: The type of rollout strategy. Default is RollingUpdate. Known values are:
         "RollingUpdate" and "External".
        :paramtype type: str or ~azure.mgmt.containerservicefleet.models.RolloutStrategyType
        :keyword cluster_update_strategy: Reference to an existing cluster update strategy. Required
         when type is External.
        :paramtype cluster_update_strategy:
         ~azure.mgmt.containerservicefleet.models.PlacementV1ClusterUpdateStrategyReference
        """
        super().__init__(**kwargs)
        self.type = type
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword operator: Operator represents a key's relationship to the value. Valid operators are
         ...
         ClusterResourcePlacement can tolerate all taints of a particular category. Known values are:
         "Exists" and "Equal".
        :paramtype operator: str or ~azure.mgmt.containerservicefleet.models.TolerationOperator
        ...
        :paramtype effect: str or ~azure.mgmt.containerservicefleet.models.TaintEffect
        """
        super().__init__(**kwargs)
        self.key = key
        self.operator = operator
...
class ScheduledStartConfiguration(_serialization.Model):
    ...
    def __init__(
        self, *, start_day: Union[str, "_models.DayOfWeek"], start_time: str, utc_offset: str, **kwargs: Any
    ) -> None:
        """
        :keyword start_day: The day of the week when the scheduled start occurs. Required. Known values
         are: "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", and "Sunday".
        :paramtype start_day: str or ~azure.mgmt.containerservicefleet.models.DayOfWeek
        :keyword start_time: The local time of day when the scheduled start occurs in 24-hour (HH:mm)
         format. Required.
        :paramtype start_time: str
        :keyword utc_offset: The UTC offset for the scheduled time in HH:mm format, -14:00 to +14:00.
         Required.
...
class ScheduledStartProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "start_time": {"key": "startTime", "type": "str"},
        "utc_offset": {"key": "utcOffset", "type": "str"},
        "absolute_start_time": {"key": "absoluteStartTime", "type": "iso-8601"},
    }
    ...
    def __init__(
        ...
        self.start_time = start_time
        self.utc_offset = utc_offset
        self.absolute_start_time: Optional[datetime.datetime] = None
...
class SkipTarget(_serialization.Model):
    ...
    def __init__(self, *, type: Union[str, "_models.TargetType"], name: str, **kwargs: Any) -> None:
        ...
        :keyword name: The skip target's name. To skip a member/group/stage, use the
         member/group/stage's name; Tp skip an after stage wait, use the parent stage's name. Required.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.type = type
...
class UpdateGroup(_serialization.Model):
    ...
    _validation = {
        ...
        "max_allowed_failures": {"pattern": r"^(?:0|[1-9]\d*|(?:0|[1-9]\d?|100)%)$"},
        "max_concurrency": {"pattern": r"^(?:([1-9]\d*)|([1-9]\d?|100)%)$"},
    }

    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "max_allowed_failures": {"key": "maxAllowedFailures", "type": "str"},
        "max_concurrency": {"key": "maxConcurrency", "type": "str"},
        "member_selector": {"key": "memberSelector", "type": "MemberSelector"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype after_gates: list[~azure.mgmt.containerservicefleet.models.GateConfiguration]
        """
        super().__init__(**kwargs)
        self.name = name
...
class UpdateGroupStatus(_serialization.Model):
    ...
    _validation = {
        ...
        "max_allowed_failures": {"readonly": True},
        "max_concurrency": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "max_allowed_failures": {"key": "maxAllowedFailures", "type": "int"},
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.max_allowed_failures: Optional[int] = None
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword update_strategy_id: The resource id of the FleetUpdateStrategy resource to reference.
         ...
         UpdateRun.
        :paramtype update_strategy_id: str
        :keyword strategy: The strategy defines the order in which the clusters will be updated. If not
         set, all members will be updated sequentially. The UpdateRun status will show a single
         UpdateStage and a single UpdateGroup targeting all members. The strategy of the UpdateRun can
         be modified until the run is started.
        :paramtype strategy: ~azure.mgmt.containerservicefleet.models.UpdateRunStrategy
...
class UpdateRunGateTargetProperties(_serialization.Model):
    ...
    def __init__(self, *, timing: Union[str, "_models.Timing"], **kwargs: Any) -> None:
        ...
        :keyword timing: Whether the Gate is placed before or after the update itself. Required. Known
         values are: "Before" and "After".
        :paramtype timing: str or ~azure.mgmt.containerservicefleet.models.Timing
        """
        super().__init__(**kwargs)
        self.name: Optional[str] = None
...
class UpdateStage(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword member_selector: Select the members of the stage.

          * If specified without UpdateGroup, one implicit group containing the selected members
            will be created.
          * If specified with UpdateGroup, members will be pre-filtered before group-level
        ...
        :keyword max_allowed_failures: Limits the number of member (cluster) upgrade failures tolerated
         ...
         fail their upgrade before the stage is considered failed.
        :paramtype max_allowed_failures: str
        :keyword max_concurrency: The max number of upgrades that can run concurrently across all
         groups in this stage. Acts as a ceiling (and not a quota) for the number of concurrent upgrades
         within the stage you want to tolerate at a time. Actual concurrency may be lower depending on
         group-level concurrency limits or individual member conditions. Stage maxConcurrency has a min
         value of "1". Accepts either: • A fixed count, e.g., "3" • A percentage, e.g., "25%" (range
         1–100). Percentage is of the total number of clusters across all groups in the stage.
         Fractional results are rounded down. A minimum of 1 upgrade is enforced. Examples: • "3"

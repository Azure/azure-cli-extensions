...
from ...operations._fleet_managed_namespaces_operations import (
...
class FleetManagedNamespacesOperations:
    ...
    def list_by_fleet(
        ...
        :return: An iterator like instance of either FleetManagedNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservicefleet.v2025_08_01_preview.models.FleetManagedNamespace]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either FleetManagedNamespace or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservicefleet.v2025_08_01_preview.models.FleetManagedNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

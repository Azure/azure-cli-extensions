...
class FleetUpdateStrategiesOperations:
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservicefleet.v2025_04_01_preview.models.FleetUpdateStrategy]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservicefleet.v2025_04_01_preview.models.FleetUpdateStrategy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource:
         ~azure.mgmt.containerservicefleet.v2025_04_01_preview.models.FleetUpdateStrategy
        ...
        :return: An instance of AsyncLROPoller that returns either FleetUpdateStrategy or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservicefleet.v2025_04_01_preview.models.FleetUpdateStrategy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource:
         ~azure.mgmt.containerservicefleet.v2025_04_01_preview.models.FleetUpdateStrategy or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default

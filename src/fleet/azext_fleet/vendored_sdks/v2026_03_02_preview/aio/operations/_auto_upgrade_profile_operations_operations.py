...
from ...operations._auto_upgrade_profile_operations_operations import build_generate_update_run_request
...
class AutoUpgradeProfileOperationsOperations:
    ...
    async def _generate_update_run_initial(
        ...
        _request = build_generate_update_run_request(
    ...
    async def begin_generate_update_run(
        ...
        :return: An instance of AsyncLROPoller that returns either GenerateResponse or the result of
         cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("GenerateResponse", pipeline_response.http_response)
            if cls:

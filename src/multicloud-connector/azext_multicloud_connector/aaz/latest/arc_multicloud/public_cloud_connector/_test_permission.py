...
class TestPermission(AAZCommand):
    ...
    _aaz_info = {
        "version": "2027-01-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.hybridconnectivity/publiccloudconnectors/{}/testpermissions", "2027-01-01"],
        ]
    }
    ...
    class PublicCloudConnectorsTestPermissions(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _TestPermissionHelper._build_schema_operation_status_result_read(cls._schema_on_200)

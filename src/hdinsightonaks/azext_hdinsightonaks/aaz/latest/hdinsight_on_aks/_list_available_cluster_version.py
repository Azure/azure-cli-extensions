...
@register_command(
    "hdinsight-on-aks list-available-cluster-version",
    is_preview=True,
)
class ListAvailableClusterVersion(AAZCommand):
    """Get all hdinsightonaks available-cluster version.

    :example: Returns a list of available cluster versions.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvailableClusterVersionsListByLocation(ctx=self.ctx)()
    ...
    class AvailableClusterVersionsListByLocation(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.components = AAZListType(
                flags={"read_only": True},
            )
            properties.is_preview = AAZBoolType(
                serialized_name="isPreview",
            )
            properties.oss_version = AAZStrType(
                serialized_name="ossVersion",
            )

            components = cls._schema_on_200.value.Element.properties.components
            components.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.components.Element
            _element.name = AAZStrType()
...
class _ListAvailableClusterVersionHelper:
    """Helper class for ListAvailableClusterVersion"""


__all__ = ["ListAvailableClusterVersion"]

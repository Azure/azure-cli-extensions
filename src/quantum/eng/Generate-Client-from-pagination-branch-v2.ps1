...
Param (
    ...
    [string] $SwaggerRepoBranch = "quantum/pagination",
...
if ([string]::IsNullOrEmpty($ClientToGenerate) -or ($ClientToGenerate -eq "data-plane"))
{
    ...
    # $AutoRestConfig = "https://github.com/Azure/azure-rest-api-specs-pr/blob/quantum/pagination/specification/quantum/data-plane/readme.md"
...
Write-Host "Deleting previous output folder contents"

...
{
    [SourceLocation("/home/cloudtest/.nuget/packages/microsoft.quantum.qsharp.foundation/0.25.218240/lib/netstandard2.1/Microsoft.Quantum.QSharp.Foundation.dll", OperationFunctor.Body, 26, 26)]
    internal partial class _193ad00b502e41959f16032a21c1f934_IndexRange : Function<IQArray<Qubit>, QRange>, ICallable
    {
        public _193ad00b502e41959f16032a21c1f934_IndexRange(IOperationFactory m) : base(m)
        {
        }

        String ICallable.Name => "_193ad00b502e41959f16032a21c1f934_IndexRange";
        String ICallable.FullName => "Microsoft.Quantum.Arrays._193ad00b502e41959f16032a21c1f934_IndexRange";
        ...
        {
            var array = __in__;
#line 27 "/home/cloudtest/.nuget/packages/microsoft.quantum.qsharp.foundation/0.25.218240/lib/netstandard2.1/Microsoft.Quantum.QSharp.Foundation.dll"
        ...
        {
            return __m__.Run<_193ad00b502e41959f16032a21c1f934_IndexRange, IQArray<Qubit>, QRange>(array);
        }
    }
}

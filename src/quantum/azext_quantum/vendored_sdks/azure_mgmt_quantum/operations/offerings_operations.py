...
class OfferingsOperations(object):
    ...
    def list(
        ...
        deserialized = models.ProviderDescriptionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ProviderDescriptionPaged(internal_paging, self._deserialize.dependencies, header_dict)

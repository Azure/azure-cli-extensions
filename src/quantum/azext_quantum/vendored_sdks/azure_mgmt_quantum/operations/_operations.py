...
class WorkspacesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> JSON:
...
class OfferingsOperations:
    ...
    @distributed_trace
    def list(self, location_name: str, **kwargs: Any) -> Iterable[JSON]:
        # pylint: disable=line-too-long
...
class WorkspaceOperations:
    ...
    @distributed_trace
    def list_keys(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> JSON:

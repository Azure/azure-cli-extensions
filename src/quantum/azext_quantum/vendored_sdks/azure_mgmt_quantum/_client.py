...
class AzureQuantumMgmtClient:
    ...
    :vartype suite_offers: azure.mgmt.quantum.operations.SuiteOffersOperations
    ...
    :keyword api_version: Api Version. Default value is "2026-06-15-preview". Note that overriding

...
from ...operations._operations import (
    ...
    build_suite_offers_list_by_subscription_request,
    build_workspaces_check_name_availability_request,
    ...
    build_workspaces_list_keys_request,
    build_workspaces_regenerate_keys_request,
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.QuantumWorkspace"]:
    ...
    ) -> AsyncItemPaged["_models.QuantumWorkspace"]:
...
class OfferingsOperations:
    ...
    ) -> AsyncItemPaged["_models.ProviderDescription"]:
...
class SuiteOffersOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.QuantumSuiteOffer"]:
        """Returns the SuiteOffer resource associated with the given name.

        :return: An iterator like instance of QuantumSuiteOffer
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quantum.models.QuantumSuiteOffer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

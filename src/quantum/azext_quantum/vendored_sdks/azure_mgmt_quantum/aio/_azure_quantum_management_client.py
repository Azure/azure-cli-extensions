...
class AzureQuantumManagementClient(object):
    ...
    :vartype workspaces: azure.quantum.aio.operations.WorkspacesOperations
    :ivar offerings: OfferingsOperations operations
    :vartype offerings: azure.quantum.aio.operations.OfferingsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.quantum.aio.operations.Operations
    :ivar workspace: WorkspaceOperations operations
    :vartype workspace: azure.quantum.aio.operations.WorkspaceOperations

...
* Providers participating in the "Credits for All" program will automatically be added when you create a workspace with the CLI. See https://learn.microsoft.com/en-us/azure/quantum/credits-faq

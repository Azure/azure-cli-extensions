...
@register_command(
    "purestorageblock storagepool avs-storage-container volume list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: AvsStorageContainerVolumes_ListByAvsStorageContainer
        az purestorageblock storagepool avs-storage-container volume list --resource-group rgpurestorage --storage-pool-name storagePoolname --storage-container-name name
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsStorageContainerVolumesListByAvsStorageContainer(ctx=self.ctx)()
    ...
    class AvsStorageContainerVolumesListByAvsStorageContainer(AAZHttpOperation):

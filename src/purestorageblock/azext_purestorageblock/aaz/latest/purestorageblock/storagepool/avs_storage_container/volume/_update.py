...
@register_command(
    "purestorageblock storagepool avs-storage-container volume update",
    is_preview=True,
)
class Update(AAZCommand):
    """Update a volume in an AVS storage container

    :example: ContainerUpdateExample
        az purestorageblock storagepool avs-storage-container volume update --resource-group rgpurestorage --storage-pool-name storagePoolname --storage-container-name name --volume-id id1 --soft-deletion {"destroyed": false}
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.volume_id = AAZStrArg(
            options=["-n", "--name", "--volume-id"],
            help="ID of the volume in the storage container",
            required=True,
        ...
        _args_schema.soft_deletion = AAZObjectArg(
            ...
            help="Volume's soft-deletion state",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AvsStorageContainerVolumesUpdate(ctx=self.ctx)()
    ...
    class AvsStorageContainerVolumesUpdate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "volumeId", self.ctx.args.volume_id,
                    required=True,
                ),
            }
            return parameters
        ...
        def _build_schema_on_200(cls):
            ...
            properties.provisioned_size = AAZIntType(
            ...
            properties.volume_internal_id = AAZStrType(
                serialized_name="volumeInternalId",
                flags={"read_only": True},
            )
            ...
            avs.avs_storage_container_resource_id = AAZStrType(
                serialized_name="avsStorageContainerResourceId",
                flags={"required": True},
            )
            ...
            avs.avs_vm_name = AAZStrType(
                serialized_name="avsVmName",
                flags={"required": True},
            )
            avs.avs_vm_resource_id = AAZStrType(
                serialized_name="avsVmResourceId",
                flags={"required": True},
            )
            avs.disk_id = AAZStrType(
                serialized_name="diskId",
                flags={"required": True},
            )
            avs.disk_name = AAZStrType(
                serialized_name="diskName",
                flags={"required": True},
            )
            avs.folder = AAZStrType(
                flags={"required": True},
            )

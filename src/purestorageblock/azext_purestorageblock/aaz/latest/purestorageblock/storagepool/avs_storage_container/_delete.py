...
@register_command(
    "purestorageblock storagepool avs-storage-container delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: AvsStorageContainers_Delete
        az purestorageblock storagepool avs-storage-container delete --resource-group rgpurestorage --storage-pool-name storagePoolName --storage-container-name storageContainerName
    """

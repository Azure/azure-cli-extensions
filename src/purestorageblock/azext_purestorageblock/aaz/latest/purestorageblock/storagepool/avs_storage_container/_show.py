...
@register_command(
    "purestorageblock storagepool avs-storage-container show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get an AVS storage container

    :example: AvsStorageContainers_Get
        az purestorageblock storagepool avs-storage-container show --resource-group rgpurestorage --storage-pool-name storagePoolName --storage-container-name storageContainerName
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsStorageContainersGet(ctx=self.ctx)()
    ...
    class AvsStorageContainersGet(AAZHttpOperation):

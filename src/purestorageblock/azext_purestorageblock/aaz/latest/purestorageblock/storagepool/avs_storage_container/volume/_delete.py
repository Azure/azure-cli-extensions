...
@register_command(
    "purestorageblock storagepool avs-storage-container volume delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: AvsStorageContainerVolumes_Delete
        az purestorageblock storagepool avs-storage-container volume delete --resource-group rgpurestorage --storage-pool-name storagePoolname --storage-container-name name --volume-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AvsStorageContainerVolumesDelete(ctx=self.ctx)()

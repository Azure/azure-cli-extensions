...
@register_command(
    "purestorageblock storagepool avs-storage-container volume show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a volume in an AVS storage container

    :example: AvsStorageContainerVolumes_Get
        az purestorageblock storagepool avs-storage-container volume show --resource-group rgpurestorage --storage-pool-name storagePoolname --storage-container-name name --volume-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsStorageContainerVolumesGet(ctx=self.ctx)()
    ...
    class AvsStorageContainerVolumesGet(AAZHttpOperation):

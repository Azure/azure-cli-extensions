...
@register_command(
    "purestorageblock storagepool repair-avs-connection",
    is_preview=True,
)
class RepairAvsConnection(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StoragePoolsRepairAvsConnection(ctx=self.ctx)()
    ...
    class StoragePoolsRepairAvsConnection(AAZHttpOperation):
...
class _RepairAvsConnectionHelper:
    """Helper class for RepairAvsConnection"""


__all__ = ["RepairAvsConnection"]

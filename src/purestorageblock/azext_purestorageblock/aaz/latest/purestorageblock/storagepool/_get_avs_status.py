...
@register_command(
    "purestorageblock storagepool get-avs-status",
    is_preview=True,
)
class GetAvsStatus(AAZCommand):
    ...
    :example: StoragePools_GetAvsStatus
        az purestorageblock storage-pool get-avs-status --resource-group rgpurestorage --storage-pool-name storagePoolname
    """

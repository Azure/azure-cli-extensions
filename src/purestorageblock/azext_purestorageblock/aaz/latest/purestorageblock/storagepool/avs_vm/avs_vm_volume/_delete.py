...
@register_command(
    "purestorageblock storagepool avs-vm avs-vm-volume delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: AvsVmVolumes_Delete
        az purestorageblock storagepool avs-vm avs-vm-volume delete --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb --volume-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AvsVmVolumesDelete(ctx=self.ctx)()
    ...
    class AvsVmVolumesDelete(AAZHttpOperation):

...
@register_command(
    "purestorageblock storagepool avs-vm avs-vm-volume list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: AvsVmVolumes_ListByAvsVm
        az purestorageblock storagepool avs-vm avs-vm-volume list --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb
    """

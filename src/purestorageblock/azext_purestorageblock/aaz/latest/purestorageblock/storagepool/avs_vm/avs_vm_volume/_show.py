...
@register_command(
    "purestorageblock storagepool avs-vm avs-vm-volume show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a volume in an AVS VM

    :example: AvsVmVolumes_Get
        az purestorageblock storagepool avs-vm avs-vm-volume show --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb --volume-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsVmVolumesGet(ctx=self.ctx)()
    ...
    class AvsVmVolumesGet(AAZHttpOperation):

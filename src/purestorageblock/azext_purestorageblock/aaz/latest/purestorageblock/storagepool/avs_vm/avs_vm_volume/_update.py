...
@register_command(
    "purestorageblock storagepool avs-vm avs-vm-volume update",
    is_preview=True,
)
class Update(AAZCommand):
    """Update a volume in an AVS VM

    :example: AVSVMVolumeUpdateExample
        az purestorageblock storagepool avs-vm avs-vm-volume update --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb --volume-id cbdec-ddbb --soft-deletion {"destroyed":false}
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.volume_id = AAZStrArg(
            ...
            help="ID of the volume in the AVS VM",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AvsVmVolumesUpdate(ctx=self.ctx)()
    ...
    class AvsVmVolumesUpdate(AAZHttpOperation):

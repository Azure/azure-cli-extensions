...
@register_command(
    "purestorageblock storagepool avs-vm show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    :example: AvsVms_Get
        az purestorageblock storage-pool avs-vm show --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb
    """

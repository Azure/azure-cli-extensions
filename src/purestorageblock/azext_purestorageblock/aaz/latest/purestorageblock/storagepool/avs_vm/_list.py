...
@register_command(
    "purestorageblock storagepool avs-vm list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: AvsVms_ListByStoragePool
        az purestorageblock storagepool avs-vm list --resource-group rgpurestorage --storage-pool-name storagePoolname
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsVmsListByStoragePool(ctx=self.ctx)()
    ...
    class AvsVmsListByStoragePool(AAZHttpOperation):

...
@register_command(
    "purestorageblock storagepool avs-vm delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: AvsVms_Delete
        az purestorageblock storagepool avs-vm delete --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AvsVmsDelete(ctx=self.ctx)()
    ...
    class AvsVmsDelete(AAZHttpOperation):

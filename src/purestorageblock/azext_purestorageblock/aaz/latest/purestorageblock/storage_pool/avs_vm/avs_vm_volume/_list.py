...
@register_command(
    "purestorageblock storage-pool avs-vm avs-vm-volume list",
    is_preview=True,
)
class List(AAZCommand):
    """List volumes in an AVS VM

    :example: AvsVmVolumes_ListByAvsVm
        az purestorageblock storage-pool avs-vm avs-vm-volume list --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvsVmVolumesListByAvsVm(ctx=self.ctx)()
    ...
    class AvsVmVolumesListByAvsVm(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            soft_deletion = cls._schema_on_200.value.Element.properties.soft_deletion
            ...
            space = cls._schema_on_200.value.Element.properties.space

...
@register_command(
    "purestorageblock storage-pool disable-avs-connection",
    is_preview=True,
)
class DisableAvsConnection(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StoragePoolsDisableAvsConnection(ctx=self.ctx)()
...
class _DisableAvsConnectionHelper:
    """Helper class for DisableAvsConnection"""


__all__ = ["DisableAvsConnection"]

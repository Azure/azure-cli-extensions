...
@register_command(
    "purestorageblock storage-pool identity remove",
)
class Remove(AAZCommand):
    ...
    class StoragePoolsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_storage_pool_read(cls._schema_on_200)
    ...
    class StoragePoolsCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_storage_pool_read(cls._schema_on_200_201)
...
class _RemoveHelper:
    ...
    _schema_storage_pool_read = None

    @classmethod
    def _build_schema_storage_pool_read(cls, _schema):
        if cls._schema_storage_pool_read is not None:
            _schema.id = cls._schema_storage_pool_read.id
            _schema.identity = cls._schema_storage_pool_read.identity
            _schema.location = cls._schema_storage_pool_read.location
            _schema.name = cls._schema_storage_pool_read.name
            _schema.properties = cls._schema_storage_pool_read.properties
            _schema.system_data = cls._schema_storage_pool_read.system_data
            _schema.tags = cls._schema_storage_pool_read.tags
            _schema.type = cls._schema_storage_pool_read.type
            return

        cls._schema_storage_pool_read = _schema_storage_pool_read = AAZObjectType()

        storage_pool_read = _schema_storage_pool_read
        storage_pool_read.id = AAZStrType(
            flags={"read_only": True},
        )
        storage_pool_read.identity = AAZIdentityObjectType()
        storage_pool_read.location = AAZStrType(
            flags={"required": True},
        )
        storage_pool_read.name = AAZStrType(
            flags={"read_only": True},
        )
        storage_pool_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        storage_pool_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        storage_pool_read.tags = AAZDictType()
        storage_pool_read.type = AAZStrType(
            flags={"read_only": True},
        )

        identity = _schema_storage_pool_read.identity
        ...
        user_assigned_identities = _schema_storage_pool_read.identity.user_assigned_identities
        user_assigned_identities.Element = AAZObjectType(
            nullable=True,
        )

        _element = _schema_storage_pool_read.identity.user_assigned_identities.Element
        ...
        properties = _schema_storage_pool_read.properties
        ...
        avs = _schema_storage_pool_read.properties.avs
        ...
        vnet_injection = _schema_storage_pool_read.properties.vnet_injection
        ...
        system_data = _schema_storage_pool_read.system_data
        ...
        tags = _schema_storage_pool_read.tags

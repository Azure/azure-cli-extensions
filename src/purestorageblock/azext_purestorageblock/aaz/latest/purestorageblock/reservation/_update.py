...
class Update(AAZCommand):
    ...
    :example: ReservationUpdateExample
        az purestorageblock reservation show --resource-group rgpurestorage --reservation-name storagePoolname --subscription sub1 --tags {"aa":"bb"}
    """

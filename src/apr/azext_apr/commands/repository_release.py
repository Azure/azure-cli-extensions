...
helps["apr repository release"] = """
type: group
short-summary: Manage the apt releases (dists) of a repository.
"""

helps["apr repository release list"] = """
type: command
short-summary: List releases.
examples:
  - name: List all releases in a repository.
    text: az apr repository release list -g myrg -r myregistry --repository myrepo
"""

helps["apr repository release create"] = """
type: command
short-summary: Create a release.
examples:
  - name: Create a release with default components and architectures.
    text: |
      az apr repository release create -g myrg -r myregistry --repository myrepo \
        -n jammy
...
helps["apr repository release delete"] = """
type: command
short-summary: Delete a release.
examples:
  - name: Delete a release by name.
    text: az apr repository release delete -g myrg -r myregistry --repository myrepo -n jammy
"""

helps["apr repository release component"] = """
type: group
short-summary: Manage the components of an apt release.
"""

helps["apr repository release component list"] = """
type: command
short-summary: List the components of a release.
examples:
  - name: List the components of a release.
    text: |
      az apr repository release component list -g myrg -r myregistry --repository myrepo \
        --release jammy
"""

helps["apr repository release component create"] = """
type: command
short-summary: Create a release component.
examples:
  - name: Add a component to an existing release.
    text: |
      az apr repository release component create -g myrg -r myregistry --repository myrepo \
        --release jammy -n contrib
"""

helps["apr repository release component delete"] = """
type: command
short-summary: Delete a release component.
examples:
  - name: Delete a component from a release by name.
    text: |
      az apr repository release component delete -g myrg -r myregistry --repository myrepo \
        --release jammy -n contrib
"""
...
def register_commands(loader):
    repository_release_type = CliCommandType(
        operations_tmpl="azext_apr.commands.repository_release#{}"
    )
    with loader.command_group(
        "apr repository release", custom_command_type=repository_release_type, is_preview=True
    ) as g:
...
def load_arguments(loader, _command):
    with loader.argument_context("apr repository release") as c:
    ...
    with loader.argument_context("apr repository release create") as c:
        c.argument(
            "release_name",
            options_list=["--name", "-n"],
    ...
    with loader.argument_context("apr repository release list") as c:
        c.argument(
            "release_name",
            options_list=["--name", "-n"],
    ...
    with loader.argument_context("apr repository release component") as c:
        c.argument(
            "release",
    ...
    with loader.argument_context("apr repository release component list") as c:
        c.argument(
            "limit",
            type=int,

...
helps["apr repository"] = """
type: group
short-summary: Manage repositories within an APR registry.
"""

helps["apr repository list"] = """
type: command
short-summary: List repositories in a registry.
examples:
  - name: List all repositories in a registry.
    text: az apr repository list -g myrg -r myregistry
"""

helps["apr repository create"] = """
type: command
short-summary: Create a new repository (apt, yum, or file) within a registry.
examples:
  - name: Create an apt repository.
    text: az apr repository create -g myrg -r myregistry -n myrepo --type apt
  - name: Create a repository that keeps the last 10 versions.
    text: az apr repository create -g myrg -r myregistry -n myrepo --type apt --retain-versions 10
  - name: Create a repository that keeps every version.
    text: az apr repository create -g myrg -r myregistry -n myrepo --type apt --retain-all
"""

helps["apr repository show"] = """
type: command
short-summary: Show repository details.
examples:
  - name: Show a repository by name.
    text: az apr repository show -g myrg -r myregistry -n myrepo
"""

helps["apr repository update"] = """
type: command
short-summary: Update repository configuration.
examples:
  - name: Bind a repository to a remote it syncs from.
    text: az apr repository update -g myrg -r myregistry -n myrepo --remote myremote
  - name: Unset the remote.
    text: az apr repository update -g myrg -r myregistry -n myrepo --remote ""
  - name: Change how many versions the repository keeps.
    text: az apr repository update -g myrg -r myregistry -n myrepo --retain-versions 3
  - name: Keep every version.
    text: az apr repository update -g myrg -r myregistry -n myrepo --retain-all
"""

helps["apr repository delete"] = """
type: command
short-summary: Delete a repository and its contents.
examples:
  - name: Delete a repository by name.
    text: az apr repository delete -g myrg -r myregistry -n myrepo
"""

helps["apr repository sync"] = """
type: command
short-summary: Sync packages from an upstream remote into this repository.
examples:
  - name: Sync a repository from its bound remote.
    text: az apr repository sync -g myrg -r myregistry -n myrepo
  - name: Add upstream content without removing existing packages.
    text: az apr repository sync -g myrg -r myregistry -n myrepo --sync-mode additive
  - name: Make the repository match the remote, removing anything not upstream.
    text: az apr repository sync -g myrg -r myregistry -n myrepo --sync-mode mirror
"""

helps["apr repository publish"] = """
type: command
short-summary: Publish repository metadata (regenerate, sign, push to CDN).
examples:
  - name: Publish a repository.
    text: az apr repository publish -g myrg -r myregistry -n myrepo
  - name: Publish even when no changes are detected.
    text: az apr repository publish -g myrg -r myregistry -n myrepo --force
"""
...
def register_commands(loader):
    repository_type = CliCommandType(operations_tmpl="azext_apr.commands.repository#{}")
    with loader.command_group(
        "apr repository", custom_command_type=repository_type, is_preview=True
    ) as g:
...
def load_arguments(loader, _command):
    with loader.argument_context("apr repository") as c:
    ...
    with loader.argument_context("apr repository create") as c:
        c.argument(
            "repository_type",
            options_list=["--type"],
    ...
    with loader.argument_context("apr repository update") as c:
        c.argument(
            "remote_name",
            options_list=["--remote"],
    ...
    with loader.argument_context("apr repository list") as c:
    ...
    with loader.argument_context("apr repository publish") as c:
        c.argument(
            "force",
            options_list=["--force"],
            action="store_true",
    ...
    with loader.argument_context("apr repository sync") as c:
        c.argument(
            "sync_mode",

...
def test_generated_registry_commands_use_the_expected_api_contract():
    from azext_apr.aaz.latest.apr.registry._create import Create
    from azext_apr.aaz.latest.apr.registry._delete import Delete
    from azext_apr.aaz.latest.apr.registry._list import List
    from azext_apr.aaz.latest.apr.registry._show import Show
    from azext_apr.aaz.latest.apr.registry._update import Update
...
def test_generated_registry_commands_block_dev_builds(monkeypatch):
    ...
    from azext_apr.aaz.latest.apr.registry._show import Show
    from azext_apr.aaz.latest.apr.registry._update import Update
    from azext_apr.aaz.latest.apr.registry._wait import Wait
    ...
    commands = [
        ...
        Wait(AprCommandsLoader(cli_ctx=DummyCli())),
    ]
    for command in commands:

...
class List(AAZCommand):
    ...
    :example: List discovered resources for a workspace.
        az chaos discovered-resource list --resource-group exampleRG --workspace-name exampleWorkspace
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DiscoveredResourcesListByWorkspace(ctx=self.ctx)()
    ...
    class DiscoveredResourcesListByWorkspace(AAZHttpOperation):

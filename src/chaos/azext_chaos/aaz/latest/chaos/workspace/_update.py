...
class Update(AAZCommand):
    ...
    :example: Create/update a workspace in a resource group.
        az chaos workspace update --resource-group exampleRG --workspace-name exampleWorkspace
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.scopes = AAZListArg(
            ...
            help="The intended workspace-level resource scope to be used by child scenarios.",
        )

        scopes = cls._args_schema.scopes
        scopes.Element = AAZResourceIdArg(
            nullable=True,
        )

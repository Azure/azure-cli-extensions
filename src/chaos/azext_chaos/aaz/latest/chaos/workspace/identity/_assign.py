...
@register_command(
    "chaos workspace identity assign",
    is_preview=True,
)
class Assign(AAZCommand):
    """Assign the user or system managed identities.

    :example: Create/update a workspace in a resource group.
        az chaos workspace identity assign --resource-group exampleRG --workspace-name exampleWorkspace
    """
    ...
    class WorkspacesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_workspace_read(cls._schema_on_200)
    ...
    class WorkspacesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_workspace_read(cls._schema_on_200_201)

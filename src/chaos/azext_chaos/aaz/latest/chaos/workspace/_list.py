...
class List(AAZCommand):
    ...
    :example: List Workspaces in a resource group.
        az chaos workspace list --resource-group exampleRG

    :example: List all Workspaces in a subscription.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.continuation_token = AAZStrArg(
            ...
            help="String that sets the continuation token.",
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.WorkspacesListAll(ctx=self.ctx)()
        if condition_1:
    ...
    class WorkspacesListAll(AAZHttpOperation):

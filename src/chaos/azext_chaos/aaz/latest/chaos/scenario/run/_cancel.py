...
class Cancel(AAZCommand):
    ...
    :example: Cancel a running scenario run.
        az chaos scenario run cancel --resource-group exampleRG --workspace-name exampleWorkspace --scenario-name ZoneDown-1.0 --run-id abcd1234-5678-9012-3456-789012345678
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ScenarioRunsCancel(ctx=self.ctx)()
    ...
    class ScenarioRunsCancel(AAZHttpOperation):

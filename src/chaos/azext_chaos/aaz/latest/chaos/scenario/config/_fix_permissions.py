...
class FixPermissions(AAZCommand):
    ...
    :example: Fix resource permissions required to run a scenario configuration.
        az chaos scenario config fix-permissions --resource-group exampleRG --workspace-name exampleWorkspace --scenario-name ZoneDown-1.0 -n my-config
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.what_if = AAZBoolArg(
            options=["--what-if"],
            arg_group="Body",
            help="Optional value that indicates whether to run a \"dry run\" of fixing resource permissions.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.ScenarioConfigurationsFixResourcePermissions(ctx=self.ctx)()
    ...
    class ScenarioConfigurationsFixResourcePermissions(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("whatIf", AAZBoolType, ".what_if")

            return self.serialize_content(_content_value)


class _FixPermissionsHelper:
    """Helper class for FixPermissions"""


__all__ = ["FixPermissions"]

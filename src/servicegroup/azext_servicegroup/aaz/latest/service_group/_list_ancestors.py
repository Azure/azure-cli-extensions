...
@register_command(
    "service-group list-ancestors",
)
class ListAncestors(AAZCommand):
    """Get the details of a service group's ancestors.

    :example: List ancestors of a service group
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ServiceGroupsListAncestors(ctx=self.ctx)()
    ...
    class ServiceGroupsListAncestors(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            parent = cls._schema_on_200.value.Element.properties.parent
...
class _ListAncestorsHelper:
    """Helper class for ListAncestors"""


__all__ = ["ListAncestors"]

...
class Update(AAZCommand):
    ...
    :example: Update the display name of a service group
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        parent.resource_id = AAZStrArg(
            options=["resource-id"],
            help="The fully qualified ID of the parent service group.",
            nullable=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ServiceGroupsUpdate(ctx=self.ctx)()
    ...
    class ServiceGroupsUpdate(AAZHttpOperation):

...
class ServicesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        parameters,  # type: "models.DataMigrationService"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.DataMigrationService"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DataMigrationService"]]
        error_map = {
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.DataMigrationService"]
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataMigrationService"]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DataMigrationService"
    ...
    def check_status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DataMigrationServiceStatusResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataMigrationServiceStatusResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_skus(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ServiceSkuList"]
        """Get compatible SKUs.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServiceSkuList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def check_children_name_availability(
        ...
        group_name,  # type: str
        service_name,  # type: str
        parameters,  # type: "models.NameAvailabilityRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NameAvailabilityResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NameAvailabilityResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.DataMigrationServiceList"]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataMigrationServiceList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class DatabaseMigrationsSqlDbOperations(object):
    ...
    def _create_or_update_initial(
        ...
        sql_db_instance_name,  # type: str
        target_db_name,  # type: str
        parameters,  # type: "models.DatabaseMigrationSqlDb"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DatabaseMigrationSqlDb"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DatabaseMigrationSqlDb"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either DatabaseMigrationSqlDb or the result of cls(response)

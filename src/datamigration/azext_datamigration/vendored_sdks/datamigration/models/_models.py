...
class AuthenticationKeys(msrest.serialization.Model):
    ...
    :param auth_key1: The first authentication key.
    :type auth_key1: str
    :param auth_key2: The second authentication key.
    :type auth_key2: str
    """
...
class AvailableServiceSku(msrest.serialization.Model):
    ...
    :type sku: ~azure.mgmt.datamigration.models.AvailableServiceSkuautogenerated
    ...
    _attribute_map = {
        ...
        'sku': {'key': 'sku', 'type': 'AvailableServiceSkuautogenerated'},
...
class AvailableServiceSkuautogenerated(msrest.serialization.Model):
    """SKU name, tier, etc.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AvailableServiceSkuautogenerated, self).__init__(**kwargs)
...
class AzureActiveDirectoryApp(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ignore_azure_permissions = kwargs.get('ignore_azure_permissions', None)


class AzureBlob(msrest.serialization.Model):
    """Azure Blob Details.

    :param storage_account_resource_id: Resource Id of the storage account where backups are
     stored.
...
class BackupConfiguration(msrest.serialization.Model):
    ...
    :param source_location: Source location of backups.
    :type source_location: ~azure.mgmt.datamigration.models.SourceLocation
    :param target_location: Target location for copying backups.
    :type target_location: ~azure.mgmt.datamigration.models.TargetLocation
    """
...
class ProjectTaskProperties(msrest.serialization.Model):
    ...
    :param task_type: Required. Task type.Constant filled by server.  Possible values include:
    ...
    :type task_type: str or ~azure.mgmt.datamigration.models.TaskType
...
class CommandProperties(msrest.serialization.Model):
    ...
    :param command_type: Required. Command type.Constant filled by server.  Possible values
     include: "Migrate.Sync.Complete.Database", "Migrate.SqlServer.AzureDbSqlMi.Complete", "cancel",
     "finish", "restart".
    :type command_type: str or ~azure.mgmt.datamigration.models.CommandType
    :ivar errors: Array of errors. This is ignored if submitted.
    :vartype errors: list[~azure.mgmt.datamigration.models.ODataError]
...
class ConnectToSourceSqlServerTaskInput(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.encrypted_key_for_secure_fields = kwargs.get('encrypted_key_for_secure_fields', None)
...
class ConnectToTargetSqlDbTaskInput(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.target_connection_info = kwargs['target_connection_info']
        self.query_object_counts = kwargs.get('query_object_counts', None)
...
class DatabaseMigration(ProxyResource):
    ...
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~azure.mgmt.datamigration.models.SystemData
    :param properties: Database Migration Resource properties.
    :type properties: ~azure.mgmt.datamigration.models.DatabaseMigrationProperties
    """
...
class DatabaseMigrationProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ended_on = None
        self.source_sql_connection = kwargs.get('source_sql_connection', None)
        self.source_database_name = kwargs.get('source_database_name', None)
        self.source_server_name = None
        self.migration_service = kwargs.get('migration_service', None)
        self.migration_operation_id = None
        self.migration_failure_error = None
        self.target_database_collation = kwargs.get('target_database_collation', None)
...
class DatabaseMigrationPropertiesSqlDb(DatabaseMigrationProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DatabaseMigrationPropertiesSqlDb, self).__init__(**kwargs)
        self.kind = 'SqlDb'  # type: str
        self.migration_status_details = None
        self.target_sql_connection = kwargs.get('target_sql_connection', None)
...
class DatabaseMigrationPropertiesSqlMi(DatabaseMigrationProperties):
    ...
    :type offline_configuration: ~azure.mgmt.datamigration.models.OfflineConfiguration
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DatabaseMigrationPropertiesSqlMi, self).__init__(**kwargs)
        self.kind = 'SqlMi'  # type: str
        self.migration_status_details = None
        self.backup_configuration = kwargs.get('backup_configuration', None)
        self.offline_configuration = kwargs.get('offline_configuration', None)
...
class DatabaseMigrationPropertiesSqlVm(DatabaseMigrationProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DatabaseMigrationPropertiesSqlVm, self).__init__(**kwargs)
...
class DatabaseMigrationSqlMi(ProxyResource):
    ...
    :type properties: ~azure.mgmt.datamigration.models.DatabaseMigrationPropertiesSqlMi
    """
...
class DatabaseMigrationSqlVm(ProxyResource):
    ...
    :type properties: ~azure.mgmt.datamigration.models.DatabaseMigrationPropertiesSqlVm
    """
...
class DataMigrationService(TrackedResource):
    ...
    :param auto_stop_delay: The time delay before the service is auto-stopped when idle.
    :type auto_stop_delay: str
    :param delete_resources_on_stop: Whether service resources should be deleted when stopped.
     (Turned on by default).
    :type delete_resources_on_stop: bool
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.auto_stop_delay = kwargs.get('auto_stop_delay', None)
        self.delete_resources_on_stop = kwargs.get('delete_resources_on_stop', None)
...
class DeleteNode(msrest.serialization.Model):
    ...
    :param node_name: The name of node to delete.
    :type node_name: str
    :param integration_runtime_name: The name of integration runtime.
...
class MigrateMySqlAzureDbForMySqlOfflineTaskProperties(ProjectTaskProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.input = kwargs.get('input', None)
        self.output = None
        self.is_cloneable = kwargs.get('is_cloneable', None)
        self.task_id = kwargs.get('task_id', None)
...
class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevel(MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput):
    ...
    :param database_count: Number of databases to include.
    :type database_count: float
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.state = None
        self.database_count = kwargs.get('database_count', None)
...
class MigrateSchemaSqlServerSqlDbDatabaseInput(msrest.serialization.Model):
    ...
    :type name: str
    :param id: Id of the source database.
    :type id: str
...
class MigrateSchemaSqlServerSqlDbTaskInput(SqlMigrationTaskInput):
    ...
    :param encrypted_key_for_secure_fields: encrypted key for secure fields.
    :type encrypted_key_for_secure_fields: str
    :param started_on: Migration start time.
    :type started_on: str
    """
...
class MigrateSqlServerSqlDbDatabaseInput(msrest.serialization.Model):
    ...
    :param table_map: Mapping of source to target tables.
    :type table_map: dict[str, str]
    :param schema_setting: Settings selected for DB schema migration.
    :type schema_setting: object
...
class MigrateSqlServerSqlDbTaskInput(SqlMigrationTaskInput):
    ...
    :param validation_options: Options for enabling various post migration validations. Available
     ...
     database.
    :type validation_options: ~azure.mgmt.datamigration.models.MigrationValidationOptions
    :param started_on: Date and time relative to UTC when the migration was started on.
    :type started_on: str
    :param encrypted_key_for_secure_fields: encrypted key for secure fields.
    :type encrypted_key_for_secure_fields: str
    """
...
class MigrateSqlServerSqlMiSyncTaskInput(SqlServerSqlMiSyncTaskInput):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.number_of_parallel_database_migrations = kwargs.get('number_of_parallel_database_migrations', None)
...
class MigrationOperationInput(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.migration_operation_id = kwargs['migration_operation_id']
...
class MongoDbConnectionInfo(ConnectionInfo):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.encrypt_connection = kwargs.get('encrypt_connection', None)
        self.server_brand_version = kwargs.get('server_brand_version', None)
        self.server_version = kwargs.get('server_version', None)
        self.server_name = kwargs.get('server_name', None)
        self.trust_server_certificate = kwargs.get('trust_server_certificate', False)
        self.enforce_ssl = kwargs.get('enforce_ssl', None)
...
class NodeMonitoringData(msrest.serialization.Model):
    ...
    :ivar additional_properties: Unmatched properties from the message are deserialized in this
     collection.
    :vartype additional_properties: dict[str, object]
...
class OfflineConfiguration(msrest.serialization.Model):
    ...
    :param offline: Offline migration.
    :type offline: bool
    :param last_backup_name: Last backup name for offline migration. This is optional for
...
class Project(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.azure_authentication_info = kwargs.get('azure_authentication_info', None)
        self.target_platform = kwargs.get('target_platform', None)
...
class RegenAuthKeys(msrest.serialization.Model):
    ...
    :param key_name: The name of authentication key to generate.
    :type key_name: str
    :param auth_key1: The first authentication key.
    :type auth_key1: str
    :param auth_key2: The second authentication key.
...
class SchemaMigrationSetting(msrest.serialization.Model):
    ...
    :type file_id: str
    :param file_name: Name of the file resource containing the uploaded schema file.
    :type file_name: str
    """
...
class SourceLocation(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.azure_blob = kwargs.get('azure_blob', None)
...
class SqlConnectionInformation(msrest.serialization.Model):
    ...
    :param user_name: User name to connect to source SQL.
    :type user_name: str
    :param password: Password to connect to source SQL.
    :type password: str
    :param encrypt_connection: Whether to encrypt connection or not.
    :type encrypt_connection: bool
    :param trust_server_certificate: Whether to trust server certificate or not.
    :type trust_server_certificate: bool
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.password = kwargs.get('password', None)
        self.encrypt_connection = kwargs.get('encrypt_connection', None)
        self.trust_server_certificate = kwargs.get('trust_server_certificate', None)
...
class SqlFileShare(msrest.serialization.Model):
    ...
    :param path: Location as SMB share or local drive where backups are placed.
    :type path: str
    :param username: Username to access the file share location for backups.
    :type username: str
    :param password: Password for username to access file share location.
    :type password: str
    """
...
class SqlMigrationService(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SqlMigrationService, self).__init__(**kwargs)
        self.provisioning_state = None
...
class SystemData(msrest.serialization.Model):
    ...
    :param created_by:
    :type created_by: str
    :param created_by_type:  Possible values include: "User", "Application", "ManagedIdentity",
     "Key".
    ...
    :param last_modified_by_type:  Possible values include: "User", "Application",
     "ManagedIdentity", "Key".
...
class TargetLocation(msrest.serialization.Model):
    ...
    :param storage_account_resource_id: Resource Id of the storage account copying backups.
    :type storage_account_resource_id: str
    :param account_key: Storage Account Key.
    :type account_key: str
    """

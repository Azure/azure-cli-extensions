...
from .operations import SqlMigrationServicesOperations
...
class DataMigrationManagementClient(object):
    ...
    :vartype database_migrations_sql_vm: azure.mgmt.datamigration.aio.operations.DatabaseMigrationsSqlVmOperations
    ...
    :vartype sql_migration_services: azure.mgmt.datamigration.aio.operations.SqlMigrationServicesOperations

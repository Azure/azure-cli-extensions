...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-06-30",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.sqlvirtualmachine/sqlvirtualmachines/{}/providers/microsoft.datamigration/databasemigrations/{}", "2025-06-30"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DatabaseMigrationsSqlVmDelete(ctx=self.ctx)()
    ...
    class DatabaseMigrationsSqlVmDelete(AAZHttpOperation):

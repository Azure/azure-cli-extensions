...
class MigrateOracleSqlTaskProperties(ProjectTaskProperties):
    """Properties for task that migrates Oracle databases to Azure and SQL Server
    databases.
    ...
    :type input: ~azure.mgmt.datamigration.models.MigrateOracleSqlTaskInput
    :ivar output: Task output. This is ignored if submitted.
    :vartype output:
     list[~azure.mgmt.datamigration.models.MigrateOracleSqlTaskOutput]
    """
    ...
    _attribute_map = {
        ...
        'input': {'key': 'input', 'type': 'MigrateOracleSqlTaskInput'},
        'output': {'key': 'output', 'type': '[MigrateOracleSqlTaskOutput]'},
    }

    def __init__(self, client_data=None, input=None):
        super(MigrateOracleSqlTaskProperties, self).__init__(client_data=client_data)
        self.input = input
        self.output = None
        self.task_type = 'Migrate.Oracle.Sql'

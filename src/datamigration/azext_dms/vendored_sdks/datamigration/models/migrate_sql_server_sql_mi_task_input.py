...
class MigrateSqlServerSqlMITaskInput(SqlMigrationTaskInput):
    ...
    def __init__(self, source_connection_info, target_connection_info, selected_databases, backup_blob_share, selected_logins=None, selected_agent_jobs=None, backup_file_share=None):

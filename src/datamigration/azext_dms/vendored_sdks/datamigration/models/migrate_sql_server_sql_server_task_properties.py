...
class MigrateSqlServerSqlServerTaskProperties(ProjectTaskProperties):
    """Properties for the task that migrates on-prem SQL Server databases to SQL
    on VM.
    ...
    :type input:
     ~azure.mgmt.datamigration.models.MigrateSqlServerSqlServerTaskInput
    :ivar output: Task output. This is ignored if submitted.
    :vartype output:
     list[~azure.mgmt.datamigration.models.MigrateSqlServerSqlServerTaskOutput]
    """
    ...
    _attribute_map = {
        ...
        'input': {'key': 'input', 'type': 'MigrateSqlServerSqlServerTaskInput'},
        'output': {'key': 'output', 'type': '[MigrateSqlServerSqlServerTaskOutput]'},
    }

    def __init__(self, client_data=None, input=None):
        super(MigrateSqlServerSqlServerTaskProperties, self).__init__(client_data=client_data)
        self.input = input
        self.output = None
        self.task_type = 'Migrate.SqlServer.SqlServer'

...
class ConnectToTargetSqlServerTaskInput(Model):
    """Input for the task that validates connection to SQL Server and target
    server requirements.

    :param target_connection_info: Connection information for target SQL
     Server
    ...
    def __init__(self, target_connection_info):
        super(ConnectToTargetSqlServerTaskInput, self).__init__()

...
class GetProjectDetailsOracleSqlTaskProperties(ProjectTaskProperties):
    ...
    :vartype output:
     list[~azure.mgmt.datamigration.models.GetProjectDetailsOracleSqlTaskOutput]
    """
    ...
    _attribute_map = {
        ...
        'output': {'key': 'output', 'type': '[GetProjectDetailsOracleSqlTaskOutput]'},
    }

    def __init__(self, client_data=None, input=None):
        super(GetProjectDetailsOracleSqlTaskProperties, self).__init__(client_data=client_data)
        self.input = input
        self.output = None
        self.task_type = 'GetProjectDetails.Oracle.Sql'

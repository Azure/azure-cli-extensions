...
class MigrateSqlServerSqlServerTaskOutputMigrationLevel(MigrateSqlServerSqlServerTaskOutput):
    ...
    _attribute_map = {
        ...
        'database_summary': {'key': 'databaseSummary', 'type': '{DataItemMigrationSummaryResult}'},
    ...
    def __init__(self):
        super(MigrateSqlServerSqlServerTaskOutputMigrationLevel, self).__init__()

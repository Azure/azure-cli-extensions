...
class MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevel(MigrateMySqlAzureDbForMySqlSyncTaskOutput):
    ...
    :ivar full_load_total_volume_bytes: Total size of full load in bytes
    :vartype full_load_total_volume_bytes: long
    ...
    _validation = {
        ...
        'full_load_total_volume_bytes': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'full_load_total_volume_bytes': {'key': 'fullLoadTotalVolumeBytes', 'type': 'long'},
    ...
    def __init__(self):
        super(MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevel, self).__init__()
        ...
        self.full_load_total_volume_bytes = None

...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.VirtualNetworkTapsListAll(ctx=self.ctx)()
        if condition_1:
            self.VirtualNetworkTapsListByResourceGroup(ctx=self.ctx)()
    ...
    class VirtualNetworkTapsListAll(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_virtual_network_tap_read(value.Element)

            return cls._schema_on_200

    class VirtualNetworkTapsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

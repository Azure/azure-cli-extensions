...
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VirtualNetworkTapsGet(ctx=self.ctx)()
    ...
    class VirtualNetworkTapsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_virtual_network_tap_read(cls._schema_on_200)

...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.lb_id = AAZResourceIdArg(
            options=["--lb-id"],
            arg_group="Destination",
            help="ID of the ILB IP configuration to receive the tap.",
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/loadBalancers/{}/frontendIPConfigurations/{}",
            ),
        )
        _args_schema.nic_id = AAZResourceIdArg(
            options=["--nic-id"],
            arg_group="Destination",
            help="ID of the NIC IP configuration to receive the tap.",
            fmt=AAZResourceIdArgFormat(
        ...
        _args_schema.port = AAZIntArg(
            options=["--port"],
            arg_group="Destination",
            help="The VXLAN port that will receive the tapped traffic.",
        )

        # define Arg Group "LbIpConfiguration"

        # define Arg Group "NicIpConfiguration"
    ...
    class VirtualNetworkTapsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("destinationLoadBalancerFrontEndIPConfiguration", AAZObjectType)
                properties.set_prop("destinationNetworkInterfaceIPConfiguration", AAZObjectType)
                properties.set_prop("destinationPort", AAZIntType, ".port")
            ...
            if destination_load_balancer_front_end_ip_configuration is not None:
                destination_load_balancer_front_end_ip_configuration.set_prop("id", AAZStrType, ".lb_id")
            ...
            if destination_network_interface_ip_configuration is not None:
                destination_network_interface_ip_configuration.set_prop("id", AAZStrType, ".nic_id")
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_virtual_network_tap_read(cls._schema_on_200_201)

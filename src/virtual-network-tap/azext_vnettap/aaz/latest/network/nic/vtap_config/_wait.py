...
class Wait(AAZWaitCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the virtual network tap configuration.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkInterfaceTapConfigurationsGet(ctx=self.ctx)()
    ...
    class NetworkInterfaceTapConfigurationsGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "tapConfigurationName", self.ctx.args.name,
                    required=True,
                ),
            }
            return parameters
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_network_interface_tap_configuration_read(cls._schema_on_200)

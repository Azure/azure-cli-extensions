...
@register_command(
    "network nic vtap-config delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkInterfaceTapConfigurationsDelete(ctx=self.ctx)()
    ...
    class NetworkInterfaceTapConfigurationsDelete(AAZHttpOperation):

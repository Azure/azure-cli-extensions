...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkInterfaceTapConfigurationsList(ctx=self.ctx)()
    ...
    class NetworkInterfaceTapConfigurationsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_network_interface_tap_configuration_read(value.Element)

...
@register_command(
    "network nic vtap-config create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "TapConfigurationParameters"

        # define Arg Group "VirtualNetworkTap"

        _args_schema = cls._args_schema
        _args_schema.vtap_id = AAZResourceIdArg(
            options=["--vtap-id"],
            arg_group="VirtualNetworkTap",
            help="vnet tap's resource id",
    ...
    def _build_args_virtual_network_tap_create(cls, _schema):
        ...
        destination_load_balancer_front_end_ip_configuration.gateway_load_balancer = AAZObjectArg(
            options=["gateway-load-balancer"],
        )
        cls._build_args_sub_resource_create(destination_load_balancer_front_end_ip_configuration.gateway_load_balancer)
        destination_load_balancer_front_end_ip_configuration.private_ip_address = AAZStrArg(
            options=["private-ip-address"],
        )
        destination_load_balancer_front_end_ip_configuration.private_ip_address_version = AAZStrArg(
        ...
        destination_network_interface_ip_configuration = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration
        destination_network_interface_ip_configuration.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/networkInterfaces/{}/ipConfigurations/{}",
            ),
        )
        destination_network_interface_ip_configuration.name = AAZStrArg(
            options=["name"],
        )
        destination_network_interface_ip_configuration.application_gateway_backend_address_pools = AAZListArg(
            options=["application-gateway-backend-address-pools"],
        )
        destination_network_interface_ip_configuration.application_security_groups = AAZListArg(
            options=["application-security-groups"],
        )
        destination_network_interface_ip_configuration.gateway_load_balancer = AAZObjectArg(
            options=["gateway-load-balancer"],
        )
        cls._build_args_sub_resource_create(destination_network_interface_ip_configuration.gateway_load_balancer)
        destination_network_interface_ip_configuration.load_balancer_backend_address_pools = AAZListArg(
            options=["load-balancer-backend-address-pools"],
        )
        destination_network_interface_ip_configuration.load_balancer_inbound_nat_rules = AAZListArg(
            options=["load-balancer-inbound-nat-rules"],
        )
        destination_network_interface_ip_configuration.primary = AAZBoolArg(
            options=["primary"],
        )
        destination_network_interface_ip_configuration.private_ip_address = AAZStrArg(
            options=["private-ip-address"],
        )
        destination_network_interface_ip_configuration.private_ip_address_prefix_length = AAZIntArg(
        ...
        destination_network_interface_ip_configuration.private_ip_address_version = AAZStrArg(
            options=["private-ip-address-version"],
            enum={"IPv4": "IPv4", "IPv6": "IPv6"},
        )
        destination_network_interface_ip_configuration.private_ip_allocation_method = AAZStrArg(
            options=["private-ip-allocation-method"],
            enum={"Dynamic": "Dynamic", "Static": "Static"},
        )
        destination_network_interface_ip_configuration.public_ip_address = AAZObjectArg(
            options=["public-ip-address"],
        )
        cls._build_args_public_ip_address_create(destination_network_interface_ip_configuration.public_ip_address)
        destination_network_interface_ip_configuration.subnet = AAZObjectArg(
            options=["subnet"],
        )
        cls._build_args_subnet_create(destination_network_interface_ip_configuration.subnet)
        destination_network_interface_ip_configuration.virtual_network_taps = AAZListArg(
            options=["virtual-network-taps"],
        )
        destination_network_interface_ip_configuration.type = AAZStrArg(
            options=["type"],
        )

        application_gateway_backend_address_pools = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.application_gateway_backend_address_pools
        application_gateway_backend_address_pools.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.application_gateway_backend_address_pools.Element
        _element.id = AAZStrArg(
            options=["id"],
        )
        _element.name = AAZStrArg(
        ...
        backend_addresses = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.application_gateway_backend_address_pools.Element.backend_addresses
        backend_addresses.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.application_gateway_backend_address_pools.Element.backend_addresses.Element
        ...
        application_security_groups = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.application_security_groups
        ...
        load_balancer_backend_address_pools = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools
        load_balancer_backend_address_pools.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools.Element
        _element.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
        ...
        load_balancer_backend_addresses = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools.Element.load_balancer_backend_addresses
        load_balancer_backend_addresses.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools.Element.load_balancer_backend_addresses.Element
        _element.name = AAZStrArg(
            options=["name"],
        )
        ...
        tunnel_interfaces = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools.Element.tunnel_interfaces
        tunnel_interfaces.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_backend_address_pools.Element.tunnel_interfaces.Element
        ...
        load_balancer_inbound_nat_rules = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_inbound_nat_rules
        load_balancer_inbound_nat_rules.Element = AAZObjectArg()

        _element = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.load_balancer_inbound_nat_rules.Element
        _element.id = AAZResourceIdArg(
            options=["id"],
            fmt=AAZResourceIdArgFormat(
        ...
        virtual_network_taps = cls._args_virtual_network_tap_create.destination_network_interface_ip_configuration.virtual_network_taps
        virtual_network_taps.Element = AAZObjectArg()
        cls._build_args_virtual_network_tap_create(virtual_network_taps.Element)
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkInterfaceTapConfigurationsCreateOrUpdate(ctx=self.ctx)()
    ...
    class NetworkInterfaceTapConfigurationsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("virtualNetworkTap", AAZObjectType)

            virtual_network_tap = _builder.get(".properties.virtualNetworkTap")
            if virtual_network_tap is not None:
                virtual_network_tap.set_prop("id", AAZStrType, ".vtap_id")
                virtual_network_tap.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_network_interface_tap_configuration_read(cls._schema_on_200_201)
...
class _CreateHelper:
    ...
    def _build_schema_subnet_create(cls, _builder):
        ...
        if _elements is not None:
            ...
            cls._build_schema_sub_resource_create(_elements.set_prop("networkIdentifier", AAZObjectType, ".network_identifier"))
    ...
    def _build_schema_virtual_network_tap_create(cls, _builder):
        ...
        if properties is not None:
            ...
            properties.set_prop("destinationNetworkInterfaceIPConfiguration", AAZObjectType, ".destination_network_interface_ip_configuration")
        ...
        destination_network_interface_ip_configuration = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration")
        if destination_network_interface_ip_configuration is not None:
            destination_network_interface_ip_configuration.set_prop("id", AAZStrType, ".id")
            destination_network_interface_ip_configuration.set_prop("name", AAZStrType, ".name")
            destination_network_interface_ip_configuration.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})
            destination_network_interface_ip_configuration.set_prop("type", AAZStrType, ".type")

        properties = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties")
        if properties is not None:
        ...
        application_gateway_backend_address_pools = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationGatewayBackendAddressPools")
        if application_gateway_backend_address_pools is not None:
            application_gateway_backend_address_pools.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationGatewayBackendAddressPools[]")
        if _elements is not None:
            _elements.set_prop("id", AAZStrType, ".id")
            _elements.set_prop("name", AAZStrType, ".name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationGatewayBackendAddressPools[].properties")
        if properties is not None:
            properties.set_prop("backendAddresses", AAZListType, ".backend_addresses")

        backend_addresses = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationGatewayBackendAddressPools[].properties.backendAddresses")
        if backend_addresses is not None:
            backend_addresses.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationGatewayBackendAddressPools[].properties.backendAddresses[]")
        if _elements is not None:
            _elements.set_prop("fqdn", AAZStrType, ".fqdn")
            _elements.set_prop("ipAddress", AAZStrType, ".ip_address")

        application_security_groups = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.applicationSecurityGroups")
        if application_security_groups is not None:
            cls._build_schema_application_security_group_create(application_security_groups.set_elements(AAZObjectType, "."))

        load_balancer_backend_address_pools = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools")
        if load_balancer_backend_address_pools is not None:
            load_balancer_backend_address_pools.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[]")
        if _elements is not None:
            _elements.set_prop("id", AAZStrType, ".id")
            _elements.set_prop("name", AAZStrType, ".name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties")
        if properties is not None:
        ...
        load_balancer_backend_addresses = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties.loadBalancerBackendAddresses")
        if load_balancer_backend_addresses is not None:
            load_balancer_backend_addresses.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties.loadBalancerBackendAddresses[]")
        if _elements is not None:
            _elements.set_prop("name", AAZStrType, ".name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties.loadBalancerBackendAddresses[].properties")
        if properties is not None:
        ...
        tunnel_interfaces = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties.tunnelInterfaces")
        if tunnel_interfaces is not None:
            tunnel_interfaces.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerBackendAddressPools[].properties.tunnelInterfaces[]")
        if _elements is not None:
        ...
        load_balancer_inbound_nat_rules = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerInboundNatRules")
        if load_balancer_inbound_nat_rules is not None:
            load_balancer_inbound_nat_rules.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerInboundNatRules[]")
        if _elements is not None:
            _elements.set_prop("id", AAZStrType, ".id")
            _elements.set_prop("name", AAZStrType, ".name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.loadBalancerInboundNatRules[].properties")
        if properties is not None:
        ...
        virtual_network_taps = _builder.get(".properties.destinationNetworkInterfaceIPConfiguration.properties.virtualNetworkTaps")
        if virtual_network_taps is not None:
            cls._build_schema_virtual_network_tap_create(virtual_network_taps.set_elements(AAZObjectType, "."))

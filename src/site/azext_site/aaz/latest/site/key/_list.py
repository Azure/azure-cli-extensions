...
class List(AAZCommand):
    ...
    :example: List site keys at resource group scope
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SiteKeysListByResourceGroup(ctx=self.ctx)()
    ...
    class SiteKeysListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/siteKeys",
                **self.url_parameters
            )

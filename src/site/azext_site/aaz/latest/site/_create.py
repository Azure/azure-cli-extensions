...
class Create(AAZCommand):
    ...
    :example: Create a Site at subscription scope
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.display_name = AAZStrArg(
            ...
            arg_group="Properties",
            help="Display name of site resource",
        )
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            yield self.SitesByServiceGroupCreateOrUpdate(ctx=self.ctx)()
        elif condition_1:
            yield self.SitesBySubscriptionCreateOrUpdate(ctx=self.ctx)()
        elif condition_2:
    ...
    class SitesByServiceGroupCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            site_address = cls._schema_on_200_201.properties.site_address
    ...
    class SitesBySubscriptionCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

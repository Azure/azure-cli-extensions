...
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SitesByServiceGroupGet(ctx=self.ctx)()
        elif condition_1:
            self.SitesBySubscriptionGet(ctx=self.ctx)()
        elif condition_2:
    ...
    class SitesByServiceGroupGet(AAZHttpOperation):
    ...
    class SitesBySubscriptionGet(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

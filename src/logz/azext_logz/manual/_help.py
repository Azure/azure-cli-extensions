...
helps['logz monitor create'] = """
    type: command
    short-summary: "Create a monitor resource. This create operation can take Get to complete."
    parameters:
      - name: --org-properties
        long-summary: |
...
helps['logz sub-account list-payload'] = """
    type: command
    short-summary: "List the payload that needs to be passed as a request for installing Logz.io agent on a VM."
    examples:

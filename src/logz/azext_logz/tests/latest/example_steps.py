...
# EXAMPLE: /Monitors/post/MainAccount_VMHosts_Update
@try_manual
def step_monitor_list_user_role(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz monitor list-user-role '
             '--name "{myMonitor}" '
             '--resource-group "{rg}"',
             checks=checks)
...
# EXAMPLE: /Monitor/post/MainAccount_VMHosts_List
@try_manual
def step_monitor_list_vm_host(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz monitor list-vm-host '
             '--name "{myMonitor}" '
             '--resource-group "{rg}"',
             checks=checks)


# EXAMPLE: /Monitor/post/MainAccount_VMHosts_Payload
@try_manual
def step_monitor_vm_host_payload(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz monitor vm-host-payload '
             '--name "{myMonitor}" '
             '--resource-group "{rg}"',
             checks=checks)


# EXAMPLE: /Monitor/post/MainAccount_VMHosts_Update
@try_manual
def step_monitor_list_vm_host_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz monitor list-vm-host-update '
             '--name "{myMonitor}" '
             '--state "Install" '
             '--resource-group "{rg}"',
             checks=checks)
...
# EXAMPLE: /SubAccount/post/SubAccount_VMHosts_List
@try_manual
def step_sub_account_list_vm_host(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz sub-account list-vm-host '
             '--monitor-name "{myMonitor}" '
             '--resource-group "{rg}" '
             '--name "{mySubAccount}"',
             checks=checks)
...
# EXAMPLE: /SubAccount/post/SubAccount_VMHosts_Payload
@try_manual
def step_sub_account_vm_host_payload(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz sub-account vm-host-payload '
             '--monitor-name "{myMonitor}" '
             '--resource-group "{rg}" '
             '--name "{mySubAccount}"',
             checks=checks)
...
# EXAMPLE: /SubAccount/post/SubAccount_VMHosts_Update
@try_manual
def step_sub_account_list_vm_host_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az logz sub-account list-vm-host-update '
             '--monitor-name "{myMonitor}" '
             '--state "Install" '
             '--resource-group "{rg}" '
             '--name "{mySubAccount}"',

...
helps['logz monitor create'] = """
    ...
    parameters:
      - name: --logz-organization-properties
        long-summary: |
            Usage: --logz-organization-properties company-name=XX enterprise-app-id=XX single-sign-on-url=XX
...
helps['logz monitor list-user-role'] = """
    type: command
...
helps['logz sub-account list-vm-host'] = """
    type: command
    ...
    examples:
      - name: SubAccount_VMHosts_List
        text: |-
               az logz sub-account list-vm-host --monitor-name "myMonitor" --resource-group "myResourceGroup" --name \
"SubAccount1"
"""

helps['logz sub-account list-vm-host-update'] = """
    type: command
...
helps['logz sub-account vm-host-payload'] = """
    type: command
    ...
    examples:
      - name: SubAccount_VMHosts_Payload
        text: |-
               az logz sub-account vm-host-payload --monitor-name "myMonitor" --resource-group "myResourceGroup" \
--name "SubAccount1"
"""
...
helps['logz monitor list-vm-host'] = """
    type: command
...
helps['logz monitor list-vm-host-update'] = """
    type: command
    short-summary: "Sending request to update the collection when Logz.io agent has been installed on a VM for a given \
monitor."
    parameters:
    ...
    examples:
      - name: MainAccount_VMHosts_Update
        text: |-
               az logz monitor list-vm-host-update --name "myMonitor" --state "Install" --resource-group \
"myResourceGroup"
"""

helps['logz monitor vm-host-payload'] = """
    type: command

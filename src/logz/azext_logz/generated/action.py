    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'company-name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter logz_organization_properties. All '
                               'possible keys are: company-name, enterprise-app-id, single-sign-on-url'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'first-name':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter user_info. All possible keys are: '
                               'first-name, last-name, email-address, phone-number'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'usage-type':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter plan_data. All possible keys are: '
                               'usage-type, billing-cycle, plan-details, effective-date'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'id':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter vm_resource_ids. All possible keys are: '
                               'id, agent-version'.format(k))
        return d

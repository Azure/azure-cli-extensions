...
def load_arguments(self, _):
    ...
    with self.argument_context('logz monitor list-user-role') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', options_list=['--name', '-n', '--monitor-name'], type=str, help='Monitor resource '
                   'name')
    ...
    with self.argument_context('logz sub-account list-vm-host') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', type=str, help='Monitor resource name')
        c.argument('sub_account_name', options_list=['--name', '-n', '--sub-account-name'], type=str, help='Sub '
                   'Account resource name')

    with self.argument_context('logz sub-account list-vm-host-update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', type=str, help='Monitor resource name')
        c.argument('sub_account_name', options_list=['--name', '-n', '--sub-account-name'], type=str, help='Sub '
                   'Account resource name')
    ...
    with self.argument_context('logz sub-account vm-host-payload') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', type=str, help='Monitor resource name', id_part='name')
        c.argument('sub_account_name', options_list=['--name', '-n', '--sub-account-name'], type=str, help='Sub '
                   'Account resource name', id_part='child_name_1')
    ...
    with self.argument_context('logz monitor list-vm-host') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', options_list=['--name', '-n', '--monitor-name'], type=str, help='Monitor resource '
                   'name')

    with self.argument_context('logz monitor list-vm-host-update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', options_list=['--name', '-n', '--monitor-name'], type=str, help='Monitor resource '
                   'name')
        c.argument('vm_resource_ids', action=AddVmResourceIds, nargs='+', help='Request of a list vm host update '
    ...
    with self.argument_context('logz monitor vm-host-payload') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('monitor_name', options_list=['--name', '-n', '--monitor-name'], type=str, help='Monitor resource '
                   'name', id_part='name')

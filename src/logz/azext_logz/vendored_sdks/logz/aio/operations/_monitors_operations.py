...
class MonitorsOperations:
    ...
    def list_monitored_resources(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_logz.models.MonitoredResourceListResponse]
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.LogzMonitorResourceListResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_logz.models.LogzMonitorResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogzMonitorResourceListResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogzMonitorResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def _create_initial(
        ...
        resource_group_name: str,
        monitor_name: str,
        body: Optional["models.LogzMonitorResource"] = None,
        **kwargs
    ) -> "models.LogzMonitorResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogzMonitorResource"]
        error_map = {
    ...
    async def begin_create(
        ...
        body: Optional["models.LogzMonitorResource"] = None,
        **kwargs
    ) -> AsyncLROPoller["models.LogzMonitorResource"]:
        ...
        :return: An instance of AsyncLROPoller that returns either LogzMonitorResource or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft_logz.models.LogzMonitorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        resource_group_name: str,
        monitor_name: str,
        body: Optional["models.LogzMonitorResourceUpdateParameters"] = None,
        **kwargs
    ) -> "models.LogzMonitorResource":
    ...
    async def vm_host_payload(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VmExtensionPayload"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_vm_host_update(
        ...
        resource_group_name: str,
        monitor_name: str,
        body: Optional["models.VmHostUpdateRequest"] = None,
        **kwargs
    ) -> AsyncIterable["models.VmResourcesListResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_logz.models.VmResourcesListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VmResourcesListResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_user_roles(
        ...
        resource_group_name: str,
        monitor_name: str,
        body: Optional["models.UserRoleRequest"] = None,
        **kwargs
    ) -> AsyncIterable["models.UserRoleListResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_logz.models.UserRoleListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.UserRoleListResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
@register_command(
    "health-data-ai-services deid-services job update",
)
class Update(AAZCommand):
    ...
    class GetJob(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_azure_core_foundations_error_read(_schema_on_200.error)
    ...
    class DeidentifyDocuments(AAZHttpOperation):
        ...
        def _build_schema_on_201_200(cls):
            ...
            _UpdateHelper._build_schema_azure_core_foundations_error_read(_schema_on_201_200.error)

...
from .example_steps import step_workspace_iot_connector
from .example_steps import step_workspace_iot_connector_fhir_destination_show
from .example_steps import step_workspace_iot_connector2
...
def step_all(test, rg):
    ...
    step_workspace_iot_connector(test, checks=[])
    step_workspace_iot_connector_fhir_destination_show(test, checks=[])
    step_workspace_iot_connector2(test, checks=[])

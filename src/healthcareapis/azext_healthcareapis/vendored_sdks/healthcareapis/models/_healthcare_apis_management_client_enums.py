...
class FhirResourceVersionPolicy(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ServiceEventState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ServiceManagedIdentityType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Type of identity being specified, currently SystemAssigned and None are allowed.
    """

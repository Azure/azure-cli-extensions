...
class ServiceManagedIdentity(msrest.serialization.Model):
    ...
    :param identity: Setting indicating whether the service has a managed identity associated with
     it.
    :type identity: ~azure.mgmt.healthcareapis.models.ServiceManagedIdentityautogenerated
    """

    _attribute_map = {
        'identity': {'key': 'identity', 'type': 'ServiceManagedIdentityautogenerated'},
    }

    def __init__(
        self,
        *,
        identity: Optional["ServiceManagedIdentityautogenerated"] = None,
        **kwargs
    ):
...
class FhirService(TaggedResource, ServiceManagedIdentity):
    ...
    :param resource_version_policy_configuration: Determines tracking of history for resources.
    :type resource_version_policy_configuration:
...
class FhirServiceAcrConfiguration(msrest.serialization.Model):
    ...
    :param oci_artifacts: The list of Open Container Initiative (OCI) artifacts.
    :type oci_artifacts: list[~azure.mgmt.healthcareapis.models.ServiceOciArtifactEntry]
    """
...
class MetricSpecification(msrest.serialization.Model):
    ...
    :type dimensions: list[~azure.mgmt.healthcareapis.models.MetricDimension]
...
class OperationDetail(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.healthcareapis.models.OperationProperties
    """
...
class OperationProperties(msrest.serialization.Model):
    ...
    :type service_specification: ~azure.mgmt.healthcareapis.models.ServiceSpecification
    """
...
class ResourceVersionPolicyConfiguration(msrest.serialization.Model):
    ...
    :param default: The default value for tracking history across all resources. Possible values
     include: "no-version", "versioned", "versioned-update".
    :type default: str or ~azure.mgmt.healthcareapis.models.FhirResourceVersionPolicy
    :param resource_type_overrides: A list of FHIR Resources and their version policy overrides.
    :type resource_type_overrides: dict[str, str or
...
class ServiceManagedIdentityautogenerated(msrest.serialization.Model):
    ...
    :param type: Required. Type of identity being specified, currently SystemAssigned and None are
     allowed. Possible values include: "None", "SystemAssigned", "UserAssigned",
     "SystemAssigned,UserAssigned".
    :type type: str or ~azure.mgmt.healthcareapis.models.ServiceManagedIdentityType
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ServiceManagedIdentityautogenerated, self).__init__(**kwargs)
        self.type = type
...
class ServiceOciArtifactEntry(msrest.serialization.Model):
    ...
    :param login_server: The Azure Container Registry login server.
    :type login_server: str
    :param image_name: The artifact name.
    :type image_name: str
...
class ServiceSpecification(msrest.serialization.Model):
    ...
    :type log_specifications: list[~azure.mgmt.healthcareapis.models.LogSpecification]
    :param metric_specifications: Specifications of the Metrics for Azure Monitoring.
    :type metric_specifications: list[~azure.mgmt.healthcareapis.models.MetricSpecification]
    """

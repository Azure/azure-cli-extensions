...
class WorkspacesOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.healthcareapis.models.WorkspaceList]
    ...
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.HealthcareApis/workspaces'}  # type: ignore
    ...
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces'}  # type: ignore
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        workspace_name: str,
        workspace_patch_resource: "models.ResourceTags",
        **kwargs
    ) -> "models.Workspace":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Workspace"]
        error_map = {
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(workspace_patch_resource, 'ResourceTags')
        body_content_kwargs['content'] = body_content
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :param workspace_name: The name of workspace resource.
        :type workspace_name: str
        :param workspace_patch_resource: The parameters for updating a specified workspace.
        :type workspace_patch_resource: ~azure.mgmt.healthcareapis.models.ResourceTags
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy

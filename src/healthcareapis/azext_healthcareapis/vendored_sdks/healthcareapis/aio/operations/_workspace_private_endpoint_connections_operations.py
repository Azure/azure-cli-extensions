...
class WorkspacePrivateEndpointConnectionsOperations:
    ...
    def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.PrivateEndpointConnectionListResultDescription"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.healthcareapis.models.PrivateEndpointConnectionListResultDescription]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PrivateEndpointConnectionListResultDescription"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.PrivateEndpointConnectionDescription":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PrivateEndpointConnectionDescription"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def _create_or_update_initial(
        ...
        workspace_name: str,
        private_endpoint_connection_name: str,
        properties: "models.PrivateEndpointConnectionDescription",
        **kwargs
    ) -> "models.PrivateEndpointConnectionDescription":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PrivateEndpointConnectionDescription"]
        error_map = {
    ...
    async def begin_create_or_update(
        ...
        properties: "models.PrivateEndpointConnectionDescription",
        **kwargs
    ) -> AsyncLROPoller["models.PrivateEndpointConnectionDescription"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.healthcareapis.models.PrivateEndpointConnectionDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

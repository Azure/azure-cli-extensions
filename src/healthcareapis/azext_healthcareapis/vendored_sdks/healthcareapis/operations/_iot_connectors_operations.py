...
class IotConnectorsOperations(object):
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.IotConnectorCollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.IotConnectorCollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.IotConnector"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def _create_or_update_initial(
        ...
        workspace_name,  # type: str
        iot_connector_name,  # type: str
        iot_connector,  # type: "models.IotConnector"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.IotConnector"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.IotConnector"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.IotConnector"]
    ...
    def _update_initial(
        ...
        iot_connector_name,  # type: str
        workspace_name,  # type: str
        iot_connector_patch_resource,  # type: "models.IotConnectorPatchResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.IotConnector"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.IotConnector"]

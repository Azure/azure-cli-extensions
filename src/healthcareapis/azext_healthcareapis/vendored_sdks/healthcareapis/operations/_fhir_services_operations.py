...
class FhirServicesOperations(object):
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.FhirServiceCollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FhirServiceCollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FhirService"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def _create_or_update_initial(
        ...
        workspace_name,  # type: str
        fhir_service_name,  # type: str
        fhirservice,  # type: "models.FhirService"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.FhirService"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FhirService"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.FhirService"]
    ...
    def _update_initial(
        ...
        fhir_service_name,  # type: str
        workspace_name,  # type: str
        fhirservice_patch_resource,  # type: "models.FhirServicePatchResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.FhirService"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FhirService"]

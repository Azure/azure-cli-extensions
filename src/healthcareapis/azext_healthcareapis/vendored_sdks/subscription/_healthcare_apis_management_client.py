...
class HealthcareApisManagementClient(object):
    ...
    :vartype service: healthcare_apis_management_client.operations.ServiceOperations
    :ivar operation: OperationOperations operations
    :vartype operation: healthcare_apis_management_client.operations.OperationOperations
    :ivar operation_result: OperationResultOperations operations
    :vartype operation_result: healthcare_apis_management_client.operations.OperationResultOperations
    :ivar private_endpoint_connection: PrivateEndpointConnectionOperations operations
    :vartype private_endpoint_connection: healthcare_apis_management_client.operations.PrivateEndpointConnectionOperations
    :ivar private_link_resource: PrivateLinkResourceOperations operations
    :vartype private_link_resource: healthcare_apis_management_client.operations.PrivateLinkResourceOperations

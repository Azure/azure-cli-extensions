...
class List(AAZCommand):
    ...
    class JobsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            delay_information = cls._schema_on_200.value.Element.properties.details.job_stages.Element.delay_information
            delay_information.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.details.job_stages.Element.delay_information.Element
            ...
            job_stage_details = cls._schema_on_200.value.Element.properties.details.job_stages.Element.job_stage_details

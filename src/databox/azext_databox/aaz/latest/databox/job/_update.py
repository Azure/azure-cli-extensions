...
class Update(AAZCommand):
    ...
    class JobsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_job_resource_read(cls._schema_on_200)
...
class _UpdateHelper:
    ...
    _schema_job_resource_read = None

    @classmethod
    def _build_schema_job_resource_read(cls, _schema):
        if cls._schema_job_resource_read is not None:
            _schema.id = cls._schema_job_resource_read.id
            _schema.identity = cls._schema_job_resource_read.identity
            _schema.location = cls._schema_job_resource_read.location
            _schema.name = cls._schema_job_resource_read.name
            _schema.properties = cls._schema_job_resource_read.properties
            _schema.sku = cls._schema_job_resource_read.sku
            _schema.system_data = cls._schema_job_resource_read.system_data
            _schema.tags = cls._schema_job_resource_read.tags
            _schema.type = cls._schema_job_resource_read.type
            return

        cls._schema_job_resource_read = _schema_job_resource_read = AAZObjectType()

        job_resource_read = _schema_job_resource_read
        job_resource_read.id = AAZStrType(
            flags={"read_only": True},
        )
        job_resource_read.identity = AAZObjectType()
        job_resource_read.location = AAZStrType(
            flags={"required": True},
        )
        job_resource_read.name = AAZStrType(
            flags={"read_only": True},
        )
        job_resource_read.properties = AAZObjectType(
            flags={"required": True, "client_flatten": True},
        )
        job_resource_read.sku = AAZObjectType(
            flags={"required": True},
        )
        job_resource_read.system_data = AAZObjectType(
            serialized_name="systemData",
        )
        job_resource_read.tags = AAZDictType()
        job_resource_read.type = AAZStrType(
            flags={"read_only": True},
        )

        identity = _schema_job_resource_read.identity
        ...
        user_assigned_identities = _schema_job_resource_read.identity.user_assigned_identities
        user_assigned_identities.Element = AAZObjectType()

        _element = _schema_job_resource_read.identity.user_assigned_identities.Element
        ...
        properties = _schema_job_resource_read.properties
        ...
        cls._build_schema_cloud_error_read(properties.error)
        ...
        delivery_info = _schema_job_resource_read.properties.delivery_info
        delivery_info.scheduled_date_time = AAZStrType(
            serialized_name="scheduledDateTime",
        )

        details = _schema_job_resource_read.properties.details
        ...
        cls._build_schema_package_shipping_details_read(details.delivery_package)
        ...
        cls._build_schema_package_shipping_details_read(details.return_package)
        ...
        cls._build_schema_shipping_address_read(details.shipping_address)

        actions = _schema_job_resource_read.properties.details.actions
        actions.Element = AAZStrType()

        contact_details = _schema_job_resource_read.properties.details.contact_details
        ...
        email_list = _schema_job_resource_read.properties.details.contact_details.email_list
        email_list.Element = AAZStrType()

        notification_preference = _schema_job_resource_read.properties.details.contact_details.notification_preference
        notification_preference.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.contact_details.notification_preference.Element
        ...
        copy_log_details = _schema_job_resource_read.properties.details.copy_log_details
        copy_log_details.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.copy_log_details.Element
        _element.copy_log_details_type = AAZStrType(
            serialized_name="copyLogDetailsType",
            flags={"required": True},
        )

        disc_data_box = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBox")
        ...
        disc_data_box_customer_disk = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBoxCustomerDisk")
        ...
        disc_data_box_disk = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBoxDisk")
        ...
        disc_data_box_heavy = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBoxHeavy")
        ...
        copy_log_link = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBoxHeavy").copy_log_link
        copy_log_link.Element = AAZStrType()

        copy_verbose_log_link = _schema_job_resource_read.properties.details.copy_log_details.Element.discriminate_by("copy_log_details_type", "DataBoxHeavy").copy_verbose_log_link
        copy_verbose_log_link.Element = AAZStrType()

        data_export_details = _schema_job_resource_read.properties.details.data_export_details
        data_export_details.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.data_export_details.Element
        _element.account_details = AAZObjectType(
            serialized_name="accountDetails",
            flags={"required": True},
        )
        cls._build_schema_data_account_details_read(_element.account_details)
        ...
        transfer_configuration = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration
        ...
        transfer_all_details = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_all_details
        transfer_all_details.include = AAZObjectType()

        include = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_all_details.include
        ...
        transfer_filter_details = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details
        transfer_filter_details.include = AAZObjectType()

        include = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include
        ...
        azure_file_filter_details = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.azure_file_filter_details
        ...
        file_path_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.azure_file_filter_details.file_path_list
        file_path_list.Element = AAZStrType()

        file_prefix_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.azure_file_filter_details.file_prefix_list
        file_prefix_list.Element = AAZStrType()

        file_share_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.azure_file_filter_details.file_share_list
        file_share_list.Element = AAZStrType()

        blob_filter_details = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.blob_filter_details
        ...
        blob_path_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.blob_filter_details.blob_path_list
        blob_path_list.Element = AAZStrType()

        blob_prefix_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.blob_filter_details.blob_prefix_list
        blob_prefix_list.Element = AAZStrType()

        container_list = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.blob_filter_details.container_list
        container_list.Element = AAZStrType()

        filter_file_details = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.filter_file_details
        filter_file_details.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.data_export_details.Element.transfer_configuration.transfer_filter_details.include.filter_file_details.Element
        ...
        data_import_details = _schema_job_resource_read.properties.details.data_import_details
        data_import_details.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.data_import_details.Element
        _element.account_details = AAZObjectType(
            serialized_name="accountDetails",
            flags={"required": True},
        )
        ...
        datacenter_address = _schema_job_resource_read.properties.details.datacenter_address
        ...
        supported_carriers_for_return_shipment = _schema_job_resource_read.properties.details.datacenter_address.supported_carriers_for_return_shipment
        supported_carriers_for_return_shipment.Element = AAZStrType()

        disc_datacenter_address_instruction = _schema_job_resource_read.properties.details.datacenter_address.discriminate_by("datacenter_address_type", "DatacenterAddressInstruction")
        disc_datacenter_address_instruction.communication_instruction = AAZStrType(
            serialized_name="communicationInstruction",
            flags={"read_only": True},
        )

        disc_datacenter_address_location = _schema_job_resource_read.properties.details.datacenter_address.discriminate_by("datacenter_address_type", "DatacenterAddressLocation")
        ...
        device_erasure_details = _schema_job_resource_read.properties.details.device_erasure_details
        ...
        job_stages = _schema_job_resource_read.properties.details.job_stages
        job_stages.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.job_stages.Element
        ...
        key_encryption_key = _schema_job_resource_read.properties.details.key_encryption_key
        ...
        identity_properties = _schema_job_resource_read.properties.details.key_encryption_key.identity_properties
        identity_properties.type = AAZStrType()
        identity_properties.user_assigned = AAZObjectType(
            serialized_name="userAssigned",
        )

        user_assigned = _schema_job_resource_read.properties.details.key_encryption_key.identity_properties.user_assigned
        user_assigned.resource_id = AAZStrType(
            serialized_name="resourceId",
        )

        last_mitigation_action_on_job = _schema_job_resource_read.properties.details.last_mitigation_action_on_job
        ...
        preferences = _schema_job_resource_read.properties.details.preferences
        ...
        cls._build_schema_transport_preferences_read(preferences.reverse_transport_preferences)
        ...
        cls._build_schema_transport_preferences_read(preferences.transport_preferences)

        encryption_preferences = _schema_job_resource_read.properties.details.preferences.encryption_preferences
        ...
        preferred_data_center_region = _schema_job_resource_read.properties.details.preferences.preferred_data_center_region
        preferred_data_center_region.Element = AAZStrType()

        storage_account_access_tier_preferences = _schema_job_resource_read.properties.details.preferences.storage_account_access_tier_preferences
        storage_account_access_tier_preferences.Element = AAZStrType()

        reverse_shipping_details = _schema_job_resource_read.properties.details.reverse_shipping_details
        ...
        cls._build_schema_shipping_address_read(reverse_shipping_details.shipping_address)

        contact_details = _schema_job_resource_read.properties.details.reverse_shipping_details.contact_details
        contact_details.contact_name = AAZStrType(
            serialized_name="contactName",
            flags={"required": True},
        )
        ...
        disc_data_box = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBox")
        ...
        copy_progress = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBox").copy_progress
        copy_progress.Element = AAZObjectType()
        cls._build_schema_copy_progress_read(copy_progress.Element)

        disc_data_box_customer_disk = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk")
        ...
        copy_progress = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").copy_progress
        copy_progress.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").copy_progress.Element
        ...
        cls._build_schema_cloud_error_read(_element.error)
        ...
        actions = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").copy_progress.Element.actions
        actions.Element = AAZStrType()

        deliver_to_dc_package_details = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").deliver_to_dc_package_details
        ...
        export_disk_details_collection = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").export_disk_details_collection
        export_disk_details_collection.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").export_disk_details_collection.Element
        ...
        import_disk_details_collection = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").import_disk_details_collection
        import_disk_details_collection.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").import_disk_details_collection.Element
        _element.backup_manifest_cloud_path = AAZStrType(
            serialized_name="backupManifestCloudPath",
            flags={"read_only": True},
        )
        ...
        return_to_customer_package_details = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxCustomerDisk").return_to_customer_package_details
        ...
        disc_data_box_disk = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk")
        ...
        copy_progress = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").copy_progress
        copy_progress.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").copy_progress.Element
        _element.actions = AAZListType(
            flags={"read_only": True},
        )
        ...
        actions = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").copy_progress.Element.actions
        actions.Element = AAZStrType()

        disks_and_size_details = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").disks_and_size_details
        disks_and_size_details.Element = AAZIntType()

        granular_copy_log_details = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").granular_copy_log_details
        granular_copy_log_details.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").granular_copy_log_details.Element
        _element.account_id = AAZStrType(
            serialized_name="accountId",
            flags={"read_only": True},
        )
        ...
        granular_copy_progress = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").granular_copy_progress
        granular_copy_progress.Element = AAZObjectType()

        _element = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").granular_copy_progress.Element
        _element.account_id = AAZStrType(
            serialized_name="accountId",
            flags={"read_only": True},
        )
        ...
        actions = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").granular_copy_progress.Element.actions
        actions.Element = AAZStrType()

        preferred_disks = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxDisk").preferred_disks
        preferred_disks.Element = AAZIntType()

        disc_data_box_heavy = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxHeavy")
        ...
        copy_progress = _schema_job_resource_read.properties.details.discriminate_by("job_details_type", "DataBoxHeavy").copy_progress
        copy_progress.Element = AAZObjectType()
        cls._build_schema_copy_progress_read(copy_progress.Element)

        sku = _schema_job_resource_read.sku
        ...
        system_data = _schema_job_resource_read.system_data
        ...
        tags = _schema_job_resource_read.tags

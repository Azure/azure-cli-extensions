...
class DataBoxManagementClient(object):
    ...
    :vartype operation: data_box_management_client.aio.operations.OperationOperations
    :ivar job: JobOperations operations
    :vartype job: data_box_management_client.aio.operations.JobOperations
    :ivar service: ServiceOperations operations
    :vartype service: data_box_management_client.aio.operations.ServiceOperations

...
class JobOperations:
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}  # type: ignore
    ...
    async def delete(
     ...
     must be between 3 and 24 characters in length and use any alphanumeric and underscore only.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}  # type: ignore
    ...
    async def _update_initial(
        ...
        destination_account_details: Optional[List["models.DestinationAccountDetails"]] = None,
        **kwargs
    ) -> "models.JobResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.JobResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def update(
     ...
     viewing and grouping this resource (across resource groups).
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}  # type: ignore

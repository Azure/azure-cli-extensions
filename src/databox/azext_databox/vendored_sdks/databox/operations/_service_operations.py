...
class ServiceOperations(object):
    ...
    def list_available_skus_by_resource_group(
        ...
        location,  # type: str
        available_sku_request,  # type: "models.AvailableSkuRequest"
        **kwargs  # type: Any
    ):
    ...
    def validate_address(
        self,
        location,  # type: str
        validate_address,  # type: "models.ValidateAddress"
        **kwargs  # type: Any
    ):
    ...
    def region_configuration(
        self,
        location,  # type: str
        region_configuration_request,  # type: "models.RegionConfigurationRequest"
        **kwargs  # type: Any
    ):

...
class JobOperations(object):
    ...
    def _create_initial(
        ...
        **kwargs  # type: Any
        ...
        _job_resource = models.JobResource(location=location, tags=tags, sku=sku, details=details, delivery_type=delivery_type, scheduled_date_time=scheduled_date_time)
        api_version = "2019-09-01"
    ...
    def _update_initial(
        ...
        destination_account_details=None,  # type: Optional[List["models.DestinationAccountDetails"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.JobResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.JobResource"]
    ...
    def begin_update(
     ...
     viewing and grouping this resource (across resource groups).
        ...
        :type destination_account_details: list[~data_box_management_client.models.DestinationAccountDetails]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod

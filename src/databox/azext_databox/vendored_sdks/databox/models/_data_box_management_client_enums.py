...
class CustomerResolutionCode(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

    NONE = "None"  #: No Resolution Yet.
    MOVE_TO_CLEAN_UP_DEVICE = "MoveToCleanUpDevice"  #: Clean the device.
    RESUME = "Resume"  #: Resume the job to same stage.
...
class DoubleEncryption(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Defines secondary layer of software-based encryption enablement.
    """

    ENABLED = "Enabled"  #: Software-based encryption is enabled.
    DISABLED = "Disabled"  #: Software-based encryption is disabled.

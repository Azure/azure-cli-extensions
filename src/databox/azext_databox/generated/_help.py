...
ST\\",\\"streetAddress2\\":\\"Unit 1\\"}}" --sku name="DataBox" --resource-group "SdkRg8091"
      - name: JobsCreateWithUserAssignedIdentity
        text: |-
               az databox job create --name "SdkJob5337" --identity-type "UserAssigned" --identity-user-assigned-identi\
ties "{\\"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsoft.ManagedIdenti\
ty/userAssignedIdentities/sdkIdentity\\":{}}" --location "westus" --transfer-type "ImportToAzure" --details \
"{\\"contactDetails\\":{\\"contactName\\":\\"Public SDK Test\\",\\"emailList\\":[\\"testing@microsoft.com\\"],\\"phone\
\\":\\"1234567890\\",\\"phoneExtension\\":\\"1234\\"},\\"dataImportDetails\\":[{\\"accountDetails\\":{\\"dataAccountTyp\
e\\":\\"StorageAccount\\",\\"storageAccountId\\":\\"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/\
...
helps['databox job update'] = """
    ...
    parameters:
      - name: --details-shipping-address
        short-summary: "Shipping address of the customer."
        long-summary: |
            Usage: --details-shipping-address street-address1=XX street-address2=XX street-address3=XX city=XX \
state-or-province=XX country=XX postal-code=XX zip-extended-code=XX company-name=XX address-type=XX
      ...
      - name: --details-key-encryption-key-identity-properties-user-assigned
        short-summary: "User assigned identity properties."
        long-summary: |
            Usage: --details-key-encryption-key-identity-properties-user-assigned resource-id=XX

            resource-id: Arm resource id for user assigned identity to be used to fetch MSI token.
      - name: --details-contact-details-notification-preference
        short-summary: "Notification preference for a job stage."
        long-summary: |
            Usage: --details-contact-details-notification-preference stage-name=XX send-notification=XX

            stage-name: Required. Name of the stage.
            send-notification: Required. Notification is required or not.

            Multiple actions can be specified by using more than one --details-contact-details-notification-preference \
argument.
    examples:
      - name: JobsPatch
        text: |-
      ...
      - name: JobsPatchSystemAssignedToUserAssigned
        text: |-
               az databox job update --name "SdkJob2965" --identity-user-assigned-identities \
"{\\"/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/akvenkat/providers/Microsoft.ManagedIdentity/us\
erAssignedIdentities/sdkIdentity\\":{}}" --resource-group "SdkRg9765"
"""

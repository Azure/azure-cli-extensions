...
helps['databox job'] = """
    type: group
    short-summary: Manage job with databox
"""

helps['databox job list'] = """
    type: command
    short-summary: "Lists all the jobs available under the given resource group. And Lists all the jobs available \
...
helps['databox job show'] = """
    ...
    examples:
      ...
      - name: JobsGetCopyStuck
        text: |-
               az databox job show --expand "details" --name "TJx-637505258985313014" --resource-group \
"dmstestresource"
      - name: JobsGetExport
        text: |-
...
ST\\",\\"streetAddress2\\":\\"Unit 1\\"}}" --sku name="DataBox" --resource-group "SdkRg7478"
      - name: JobsCreateDoubleEncryption
        text: |-
...
ST\\",\\"streetAddress2\\":\\"Unit 1\\"}}" --sku name="DataBox" --resource-group "SdkRg8091"
      - name: JobsCreateWithUserAssignedIdentity
        text: |-
...
state-or-province=XX country=XX postal-code=XX zip-extended-code=XX company-name=XX address-type=XX
      ...
      - name: --user-assigned
        short-summary: "User assigned identity properties."
        long-summary: |
            Usage: --user-assigned resource-id=XX

            resource-id: Arm resource id for user assigned identity to be used to fetch MSI token.
      - name: --notification-preference
        short-summary: "Notification preference for a job stage."
        long-summary: |
            Usage: --notification-preference stage-name=XX send-notification=XX

            stage-name: Required. Name of the stage.
            send-notification: Required. Notification is required or not.

            Multiple actions can be specified by using more than one --notification-preference argument.
    examples:
      - name: JobsPatch
        text: |-
               az databox job update --name "SdkJob952" --contact-name "Update Job" --email-list \
"testing@microsoft.com" --phone "1234567890" --phone-extension "1234" --shipping-address address-type="Commercial" \
city="San Francisco" company-name="Microsoft" country="US" postal-code="94107" state-or-province="CA" \
street-address1="16 TOWNSEND ST" street-address2="Unit 1" --resource-group "SdkRg5154"
      - name: JobsPatchCmk
        text: |-
               az databox job update --name "SdkJob1735" --kek-type "CustomerManaged" --kek-url \
"https://sdkkeyvault.vault.azure.net/keys/SSDKEY/" --kek-vault-resource-id "/subscriptions/fa68082f-8ff7-4a25-95c7-ce9d\
a541242f/resourceGroups/akvenkat/providers/Microsoft.KeyVault/vaults/SDKKeyVault" --resource-group "SdkRg7937"
      - name: JobsPatchSystemAssignedToUserAssigned
        text: |-
...
helps['databox'] = """
    type: group
    short-summary: Manage  with databox
"""

helps['databox mitigate'] = """
    type: command
    short-summary: "Request to mitigate for a given job."
    examples:
      - name: Mitigate
        text: |-
               az databox mitigate --job-name "SdkJob8367" --customer-resolution-code "MoveToCleanUpDevice" \
--resource-group "SdkRg9836"
"""

helps['databox service'] = """
    type: group
    short-summary: Manage service with databox
"""
...
https://management.azure.com/subscriptions/SUBSCRIPTIONID/locations?api-version=2018-01-01
      ...
      - name: --disk-schedule-availability-request
        ...
        long-summary: |
            Usage: --disk-schedule-availability-request expected-data-size-in-tera-bytes=XX storage-location=XX \
sku-name=XX country=XX

            expected-data-size-in-tera-bytes: Required. The expected size of the data, which needs to be transferred \
in this job, in terabytes.
            storage-location: Required. Location for data transfer. For locations check: \
https://management.azure.com/subscriptions/SUBSCRIPTIONID/locations?api-version=2018-01-01
            sku-name: Required. Sku Name for which the order is to be scheduled.
            country: Country in which storage location should be supported.

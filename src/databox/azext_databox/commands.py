...
from azext_databox._validators import validate_destination_account_details
...
def load_command_table(self, _):
    ...
    with self.command_group('databox job', databox_jobs, client_factory=cf_jobs) as g:
        g.custom_command('create', 'create_databox_job', validator=validate_destination_account_details)

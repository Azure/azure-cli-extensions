...
class SparkServicePluginInformation(Model):
    ...
    def __init__(self, *, preparation_started_at=None, resource_acquisition_started_at=None, submission_started_at=None, monitoring_started_at=None, cleanup_started_at=None, current_state=None, **kwargs) -> None:

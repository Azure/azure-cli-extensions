...
from .operations.big_data_pools_operations import BigDataPoolsOperations
from .operations.operations import Operations
from .operations.ip_firewall_rules_operations import IpFirewallRulesOperations
from .operations.sql_pools_operations import SqlPoolsOperations
from .operations.sql_pool_metadata_sync_configs_operations import SqlPoolMetadataSyncConfigsOperations
from .operations.sql_pool_operation_results_operations import SqlPoolOperationResultsOperations
from .operations.sql_pool_geo_backup_policies_operations import SqlPoolGeoBackupPoliciesOperations
from .operations.sql_pool_data_warehouse_user_activities_operations import SqlPoolDataWarehouseUserActivitiesOperations
from .operations.sql_pool_restore_points_operations import SqlPoolRestorePointsOperations
from .operations.sql_pool_replication_links_operations import SqlPoolReplicationLinksOperations
from .operations.sql_pool_transparent_data_encryptions_operations import SqlPoolTransparentDataEncryptionsOperations
from .operations.sql_pool_blob_auditing_policies_operations import SqlPoolBlobAuditingPoliciesOperations
from .operations.sql_pool_operations import SqlPoolOperations
from .operations.sql_pool_usages_operations import SqlPoolUsagesOperations
from .operations.sql_pool_sensitivity_labels_operations import SqlPoolSensitivityLabelsOperations
from .operations.sql_pool_schemas_operations import SqlPoolSchemasOperations
from .operations.sql_pool_tables_operations import SqlPoolTablesOperations
from .operations.sql_pool_table_columns_operations import SqlPoolTableColumnsOperations
from .operations.sql_pool_connection_policies_operations import SqlPoolConnectionPoliciesOperations
from .operations.sql_pool_vulnerability_assessments_operations import SqlPoolVulnerabilityAssessmentsOperations
from .operations.sql_pool_vulnerability_assessment_scans_operations import SqlPoolVulnerabilityAssessmentScansOperations
from .operations.sql_pool_security_alert_policies_operations import SqlPoolSecurityAlertPoliciesOperations
from .operations.sql_pool_vulnerability_assessment_rule_baselines_operations import SqlPoolVulnerabilityAssessmentRuleBaselinesOperations
from .operations.workspaces_operations import WorkspacesOperations
from .operations.workspace_aad_admins_operations import WorkspaceAadAdminsOperations
from .operations.workspace_managed_identity_sql_control_settings_operations import WorkspaceManagedIdentitySqlControlSettingsOperations
from . import models


class SynapseManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        super(SynapseManagementClientConfiguration, self).__init__(base_url)

        self.add_user_agent('azure-mgmt-synapse/{}'.format(VERSION))

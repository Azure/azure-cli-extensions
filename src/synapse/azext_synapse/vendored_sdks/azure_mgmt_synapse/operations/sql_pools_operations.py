...
class SqlPoolsOperations(object):
    ...
    def list_by_workspace(
        ...
        deserialized = models.SqlPoolPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlPoolPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

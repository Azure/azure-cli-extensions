...
class SqlPoolUsagesOperations(object):
    ...
    def list(
        ...
        deserialized = models.SqlPoolUsagePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlPoolUsagePaged(internal_paging, self._deserialize.dependencies, header_dict)

...
class SqlPoolTablesOperations(object):
    ...
    def list_by_schema(
        ...
        deserialized = models.SqlPoolTablePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SqlPoolTablePaged(internal_paging, self._deserialize.dependencies, header_dict)

...
class IpFirewallRulesOperations(object):
    ...
    def list_by_workspace(
        ...
        deserialized = models.IpFirewallRuleInfoPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IpFirewallRuleInfoPaged(internal_paging, self._deserialize.dependencies, header_dict)

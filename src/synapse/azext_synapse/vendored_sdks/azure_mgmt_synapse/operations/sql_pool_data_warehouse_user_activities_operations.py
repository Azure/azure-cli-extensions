...
class SqlPoolDataWarehouseUserActivitiesOperations(object):
    ...
    :ivar data_warehouse_user_activity_name: The activity name of the Sql pool. . Constant value: "current".
    """
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.synapse.models.DataWarehouseUserActivities or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/dataWarehouseUserActivities/{dataWarehouseUserActivityName}'}

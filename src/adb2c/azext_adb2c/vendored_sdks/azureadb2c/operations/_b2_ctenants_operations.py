...
class B2CTenantsOperations(object):
    ...
    def check_name_availability(
        self,
        check_name_availability_request_body=None,  # type: Optional["models.CheckNameAvailabilityRequestBody"]
        **kwargs  # type: Any
    ):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.B2CTenantResourceList"]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.B2CTenantResourceList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.B2CTenantResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def update(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        update_tenant_request_body=None,  # type: Optional["models.B2CTenantUpdateRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.B2CTenantResource"
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        create_tenant_request_body=None,  # type: Optional["models.CreateTenantRequestBody"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.B2CTenantResource"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.B2CTenantResource"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.B2CTenantResource"]

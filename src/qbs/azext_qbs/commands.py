...
def load_command_table(self, _):
    ...
    with self.command_group('qbs member api-keys') as m:
        m.custom_command('list', 'get_member_api_keys')
        m.custom_command('regenerate', 'get_member_regenerate_api_keys')
    with self.command_group('qbs consortium') as m:
        m.custom_command('list', 'get_consortium_members')
        m.custom_command('get-genesis', 'get_consortium_genesis')
    ...
    with self.command_group('qbs transaction-node api-keys') as m:
        m.custom_command('list', 'get_transaction_list_api_keys')
        m.custom_command('regenerate', 'post_transaction_regenerate_api_keys')

...
@register_command(
    "edge-action version swap-default",
)
class SwapDefault(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.EdgeActionVersionsSwapDefault(ctx=self.ctx)()
    ...
    class EdgeActionVersionsSwapDefault(AAZHttpOperation):
...
class _SwapDefaultHelper:
    """Helper class for SwapDefault"""

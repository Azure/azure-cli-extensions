...
helps['connectedk8s troubleshoot'] = """
  ...
  examples:
      - name: using storage account name and a shared access signature token with write permission
        text: az connectedk8s troubleshoot -g MyResourceGroup -n ConnectedCluster --storage-account MyStorageAccount --sas-token "MySasToken" --container-name "mycontainername"
      - name: using the resource id of a storage account resource you own.
        text: az connectedk8s troubleshoot -g MyResourceGroup -n ConnectedCluster --storage-account "MyStoreageAccountResourceId" --container-name "mycontainername"

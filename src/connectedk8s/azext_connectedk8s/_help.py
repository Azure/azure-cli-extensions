...
helps['connectedk8s connect'] = """
    ...
    - name: Onboard a connected kubernetes cluster with custom onboarding timeout.
      text: az connectedk8s connect -g resourceGroupName -n connectedClusterName --onboarding-timeout 10
...
helps['connectedk8s upgrade'] = """
    ...
    - name: Upgrade the agents with custom upgrade timeout.
      text: az connectedk8s upgrade -g resourceGroupName -n connectedClusterName --upgrade-timeout 10
"""

...
class ConnectedCluster(TrackedResource):
    ...
    def __init__(self, *, location: str, identity, agent_public_key_certificate: str, tags=None, provisioning_state=None, distribution: str=None, infrastructure: str=None, private_link_state="Disabled", private_link_scope_resource_id: str=None, **kwargs) -> None:

...
Install_HelmLogin_Fault_Type = 'helm-login-error'
...
Custom_Registry_Disable_Auto_Upgrade_Fault_Type = 'Auto upgrade should be disabled when using custom container registry for Arc agents and extensions.'
Custom_Registry_Agent_Version_Required_Fault_Type = 'Agent version needs to be provided when using custom container registry for Arc agents and extensions.'
Custom_Repository_Disable_Auto_Upgrade_Fault_Type = 'Auto upgrade should be disabled when using custom repository.'
Custom_Registry_Default_Registry_Fault_Type = '--registry-repository must not be provided with --default-registry'
Custom_Registry_Anonymous_Pull_Fault_Type = '--anonymous-pull must be provided without --registry-username and --registry-password'

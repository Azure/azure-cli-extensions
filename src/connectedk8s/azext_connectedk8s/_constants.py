...
Arc_Agent_Helm_Chart_Name_Least_Privileges = 'azure-arc-k8sagents-leastprivileges'
Stable_Release_Train_Name = 'stable'
Least_Privilege_Stable_Release_Train_Name = 'least-privilege-stable'
Dogfood_Release_Train_Name = 'dev'
Least_Privilege_Dogfood_Release_Train_Name = 'least-privilege-dev'

...
Check_AzureCliVersion_Fault_Type = 'azure-version-check-error'
...
Client_Details_Not_Provided_For_Azure_RBAC_Fault = 'Client ID or secret not provided for Azure RBAC'

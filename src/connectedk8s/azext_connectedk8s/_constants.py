...
Pre_Onboarding_Helm_Charts_Folder_Name = 'PreOnboardingCharts'
...
Cluster_Diagnostic_Checks_Job_Registry_Path = "arck8sdiagnoser.azurecr.io/public/azurearck8s/helmchart/stable/clusterdiagnosticchecks:0.1.0"

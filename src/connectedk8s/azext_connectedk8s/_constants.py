...
Helm_Values_Save_Failed_Error = "Error occured while doing helm get values for azure-arc release"
Helm_Values_Save_Failed_Exception = "Exception occured while doing helm get values for azure-arc release"
Metadata_CR_Save_Failed_Error = "Error occured while fetching metadata CR snapshot"
Metadata_CR_Save_Failed_Exception = "Exception occured while fetching metadata CR snapshot"
KAP_CR_Save_Failed_Error = "Error occured while fetching KAP CR snapshot"
KAP_CR_Save_Failed_Exception = "Exception occured while fetching KAP CR snapshot"

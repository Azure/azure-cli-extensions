...
MSI_Cert_Check_Fault_Type = "Error occurred while trying to perform MSI ceritificate presence check right"
Cluster_Security_Policy_Check_Fault_Type = "Error occured while performing cluster security policy check"
KAP_Cert_Check_Fault_Type = "Error occurred while trying to perform KAP ceritificate presence check right"
MSI_Cert_Expiry_Check_Fault_Type = "Error occured while trying to perform the MSI cert expiry check"
Connected_Cluster_Logger_Fault_Type = "Error occured in connected cluster resource logger"
...
Troubleshoot_Execution_Fault_Type = "Error occured while performing Troubleshoot command"

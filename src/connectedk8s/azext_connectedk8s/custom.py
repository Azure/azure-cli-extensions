...
def create_connectedk8s(cmd, client, resource_group_name, cluster_name, correlation_id=None, https_proxy="", http_proxy="", no_proxy="", proxy_cert="", location=None,
    ...
    if all_checks_passed is False:
        raise CLIError("One or more cluster diagnostic checks failed and hence the cluster cannot be onboarded. Please refer to the troubleshooting docs for the diagnostic checks and try onboarding again.")

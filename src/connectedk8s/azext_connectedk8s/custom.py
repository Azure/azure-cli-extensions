...
def create_connectedk8s(
    ...
    configuration_settings, configuration_protected_settings, protected_helm_values = (
...
def generate_arc_agent_configuration(
    ...
    for feature in set(
        list(configuration_settings.keys())
        + list(configuration_protected_settings.keys())
    ):

...
def create_connectedk8s(cmd, client, resource_group_name, cluster_name, correlation_id=None, https_proxy="", http_proxy="", no_proxy="", proxy_cert="", location=None,
    ...
    try:
        ...
        diagnostic_checks = precheckutils.check_preonboarding_inspector_container(api_instance, batchv1_api_instance, absolute_path, helm_client_location, kubectl_client_location, kube_config, kube_context, http_proxy, https_proxy, no_proxy, proxy_cert)
    ...
    if all_checks_passed is False:
        raise UnclassifiedUserFault("One or more cluster diagnostic checks failed and hence the cluster cannot be onboarded. Please refer to the troubleshooting docs for the diagnostic checks and try onboarding again.")

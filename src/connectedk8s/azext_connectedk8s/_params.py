...
def load_arguments(self, _):
    ...
    with self.argument_context('connectedk8s connect') as c:
        ...
        c.argument('enable_azure_rbac', options_list=['--enable-azure-rbac'], action='store_true', help='Enable azure rbac for authorization')
        c.argument('enable_azure_rbac', options_list=['--enable-azure-rbac'], action='store_true', help='Enable azure rbac for authorization')
        c.argument('guard_client_id', options_list=['--client-id'], help='Client id for the Guard Authorization webhook. Specify when using enable-azure-rbac.')
        c.argument('guard_client_secret', options_list=['--client-secret'], help='Client secret for the Guard Authorization webhook. Specify when using enable-azure-rbac.')
    ...
    with self.argument_context('connectedk8s update') as c:
        ...
        c.argument('azure_rbac', options_list=['--azure-rbac'], help='Flag to enable/disable azure rbac for authorization')
        c.argument('guard_client_id', options_list=['--client-id'], help='Client id for the Guard Authorization webhook. Specify when enabling azure-rbac.')
        c.argument('guard_client_secret', options_list=['--client-secret'], help='Client secret for the Guard Authorization webhook. Specify when enabling azure-rbac.')

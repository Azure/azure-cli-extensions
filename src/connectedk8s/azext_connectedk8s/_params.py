...
def load_arguments(self, _):
    ...
    with self.argument_context('connectedk8s connect') as c:
        ...
        c.argument('correlation_id', options_list=['--correlation-id'], help='A guid that is used to track the source of cluster onboarding', validator=override_client_request_id_header)

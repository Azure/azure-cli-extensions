...
def load_arguments(self, _):
    ...
    with self.argument_context('connectedk8s troubleshoot') as c:
        ...
        c.argument('container_name', options_list=['--container-name'], arg_group='Storage Account', help='The name of the storage container.', default="connectedk8s_troubleshoot")

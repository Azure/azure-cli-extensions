...
def load_arguments(self, _):
    ...
    with self.argument_context('connectedk8s enable-features') as c:
        ...
        c.argument('azrbac_client_id', options_list=['--app-id'], arg_group='Azure RBAC', help='To be deprecated soon. Application ID for enabling Azure RBAC.', deprecate_info=c.deprecate(hide=True))
        c.argument('azrbac_client_secret', options_list=['--app-secret'], arg_group='Azure RBAC', help='To be deprecated soon. Application secret for enabling Azure RBAC.', deprecate_info=c.deprecate(hide=True))

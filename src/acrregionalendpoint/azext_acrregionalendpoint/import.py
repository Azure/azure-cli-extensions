...
def acr_import_preview(cmd,  # pylint: disable=too-many-locals
                       client,
                       registry_name,
                       source_image,
...
def _split_registry_and_image(source_image):
    """
    Copied from azure.cli.command_modules.acr.import.py since direct import is not possible
    due to 'import' being a Python reserved keyword.
    """

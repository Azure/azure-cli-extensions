...
class List(AAZCommand):
    ...
    :example: List network manager connections in a network manager
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SubscriptionNetworkManagerConnectionsList(ctx=self.ctx)()
    ...
    class SubscriptionNetworkManagerConnectionsList(AAZHttpOperation):

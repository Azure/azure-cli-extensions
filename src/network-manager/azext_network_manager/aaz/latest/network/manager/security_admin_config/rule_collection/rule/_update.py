...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_address_prefix_item_update(destinations.Element)
        ...
        cls._build_args_address_prefix_item_update(sources.Element)
    ...
    _args_address_prefix_item_update = None

    @classmethod
    def _build_args_address_prefix_item_update(cls, _schema):
        if cls._args_address_prefix_item_update is not None:
            _schema.address_prefix = cls._args_address_prefix_item_update.address_prefix
            _schema.address_prefix_type = cls._args_address_prefix_item_update.address_prefix_type
            return

        cls._args_address_prefix_item_update = AAZObjectArg(
            nullable=True,
        )

        address_prefix_item_update = cls._args_address_prefix_item_update
        address_prefix_item_update.address_prefix = AAZStrArg(
            options=["address-prefix"],
            help="Address prefix.",
            nullable=True,
        )
        address_prefix_item_update.address_prefix_type = AAZStrArg(
    ...
    class AdminRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_base_admin_rule_read(cls._schema_on_200)
    ...
    class AdminRulesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_base_admin_rule_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if destinations is not None:
                _UpdateHelper._build_schema_address_prefix_item_update(destinations.set_elements(AAZObjectType, "."))
            ...
            if sources is not None:
                _UpdateHelper._build_schema_address_prefix_item_update(sources.set_elements(AAZObjectType, "."))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_address_prefix_item_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_base_admin_rule_read = None
    ...
    def _build_schema_base_admin_rule_read(cls, _schema):
        if cls._schema_base_admin_rule_read is not None:
            ...
            _schema.system_data = cls._schema_base_admin_rule_read.system_data
            _schema.type = cls._schema_base_admin_rule_read.type
            _schema.discriminate_by(
                "kind",
                "Custom",
                cls._schema_base_admin_rule_read.discriminate_by(
                    "kind",
                    "Custom",
                )
            )
        ...
        base_admin_rule_read.kind = AAZStrType(
            flags={"required": True},
        )
        base_admin_rule_read.name = AAZStrType(
            flags={"read_only": True},
        )
        base_admin_rule_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        base_admin_rule_read.type = AAZStrType(
            flags={"read_only": True},
        )

        system_data = _schema_base_admin_rule_read.system_data
        ...
        destination_port_ranges = _schema_base_admin_rule_read.discriminate_by("kind", "Custom").properties.destination_port_ranges
        destination_port_ranges.Element = AAZStrType()

        destinations = _schema_base_admin_rule_read.discriminate_by("kind", "Custom").properties.destinations
        destinations.Element = AAZObjectType()
        cls._build_schema_address_prefix_item_read(destinations.Element)

        source_port_ranges = _schema_base_admin_rule_read.discriminate_by("kind", "Custom").properties.source_port_ranges
        source_port_ranges.Element = AAZStrType()

        sources = _schema_base_admin_rule_read.discriminate_by("kind", "Custom").properties.sources
        sources.Element = AAZObjectType()
        cls._build_schema_address_prefix_item_read(sources.Element)

        disc_default = _schema_base_admin_rule_read.discriminate_by("kind", "Default")
        ...
        destination_port_ranges = _schema_base_admin_rule_read.discriminate_by("kind", "Default").properties.destination_port_ranges
        destination_port_ranges.Element = AAZStrType()

        destinations = _schema_base_admin_rule_read.discriminate_by("kind", "Default").properties.destinations
        destinations.Element = AAZObjectType()
        cls._build_schema_address_prefix_item_read(destinations.Element)

        source_port_ranges = _schema_base_admin_rule_read.discriminate_by("kind", "Default").properties.source_port_ranges
        source_port_ranges.Element = AAZStrType()

        sources = _schema_base_admin_rule_read.discriminate_by("kind", "Default").properties.sources
        sources.Element = AAZObjectType()
        cls._build_schema_address_prefix_item_read(sources.Element)

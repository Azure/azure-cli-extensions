...
class NetworkScenarioTest(ScenarioTest):
    ...
    def test_network_manager_routing_config_crud(self, resource_group):
        ...
        self.cmd('az network manager routing-config rule-collection create --config-name {routing_config} --manager-name {manager_name} --name {rule_collection} --resource-group {rg} --local-route-setting NotSpecified --applies-to [{{"network_group_id":{manager_id}}}] --disable-bgp-route-propagation true')

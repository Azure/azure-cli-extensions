...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityAdminConfigurations/{configurationName}/ruleCollections/{ruleCollectionName}/rules')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityAdminConfigurations/{configurationName}/ruleCollections/{ruleCollectionName}/rules/{ruleName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "networkManagerName": _SERIALIZER.url("network_manager_name", network_manager_name, 'str'),
...
class AdminRulesOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01_preview.models.AdminRuleListResult]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01_preview.models.BaseAdminRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type admin_rule: ~azure.mgmt.network.v2021_05_01_preview.models.BaseAdminRule
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BaseAdminRule, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2021_05_01_preview.models.BaseAdminRule
        :raises: ~azure.core.exceptions.HttpResponseError

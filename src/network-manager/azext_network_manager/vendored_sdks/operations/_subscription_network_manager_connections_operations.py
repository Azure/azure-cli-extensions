...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections/{networkManagerConnectionName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "networkManagerConnectionName": _SERIALIZER.url("network_manager_connection_name", network_manager_connection_name, 'str'),
    }
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class SubscriptionNetworkManagerConnectionsOperations(object):
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections/{networkManagerConnectionName}'}  # type: ignore
    ...
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections/{networkManagerConnectionName}'}  # type: ignore
    ...
    def delete(
        ...
        **kwargs: Any
        ...
        """Delete specified pending connection created by this subscription.
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections/{networkManagerConnectionName}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkManagerConnectionListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01_preview.models.NetworkManagerConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkManagerConnections'}  # type: ignore

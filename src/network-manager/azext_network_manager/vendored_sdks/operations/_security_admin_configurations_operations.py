...
class SecurityAdminConfigurationsOperations(object):
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.SecurityAdminConfigurationListResult"]:
        ...
        :return: An iterator like instance of either SecurityAdminConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.SecurityAdminConfigurationListResult]

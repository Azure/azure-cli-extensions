...
class UserRuleCollectionsOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RuleCollectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01_preview.models.RuleCollectionListResult]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type user_rule_collection: ~azure.mgmt.network.v2021_05_01_preview.models.RuleCollection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RuleCollection, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2021_05_01_preview.models.RuleCollection
        :raises: ~azure.core.exceptions.HttpResponseError

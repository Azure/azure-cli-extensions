...
from ...operations._effective_virtual_networks_operations import build_list_by_network_manager_request
T = TypeVar('T')
...
class EffectiveVirtualNetworksOperations:
    ...
    async def list_by_network_manager(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.network.v2022_02_01_preview.models.EffectiveVirtualNetworksParameter
        ...
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.EffectiveVirtualNetworksListResult

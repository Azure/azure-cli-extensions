...
class EffectiveVirtualNetworksOperations:
    ...
    def list_by_network_manager(
        ...
        parameters: Optional["_models.EffectiveVirtualNetworksParameter"] = None,
        **kwargs
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_preview.models.EffectiveVirtualNetworksParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either EffectiveVirtualNetworksListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_preview.models.EffectiveVirtualNetworksListResult]

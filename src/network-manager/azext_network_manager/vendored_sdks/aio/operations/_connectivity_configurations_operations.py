...
class ConnectivityConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.ConnectivityConfiguration
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type connectivity_configuration:
         ~azure.mgmt.network.v2022_02_01_preview.models.ConnectivityConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ConnectivityConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.ConnectivityConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConnectivityConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.ConnectivityConfigurationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01-preview")  # type: str

...
from ...operations._network_managers_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_subscription_request, build_list_request, build_patch_request
T = TypeVar('T')
...
class NetworkManagersOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManager
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManager
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkManager, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManager
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def patch(
        ...
        **kwargs: Any
        ...
        :type network_manager_name: str
        :param parameters: Parameters supplied to specify which network manager is.
        :type parameters: ~azure.mgmt.network.v2022_02_01_preview.models.PatchObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkManager, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManager
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkManagerListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.NetworkManagerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01-preview")  # type: str

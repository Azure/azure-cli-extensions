...
from ...operations._admin_rule_collections_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class AdminRuleCollectionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.AdminRuleCollectionListResult"]:
        ...
        :return: An iterator like instance of either AdminRuleCollectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.AdminRuleCollectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AdminRuleCollectionListResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AdminRuleCollectionListResult", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.AdminRuleCollection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AdminRuleCollection"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize('AdminRuleCollection', pipeline_response)
    ...
    async def create_or_update(
        ...
        configuration_name: str,
        rule_collection_name: str,
        rule_collection: "_models.AdminRuleCollection",
        **kwargs: Any
    ) -> "_models.AdminRuleCollection":
        ...
        :type rule_collection: ~azure.mgmt.network.v2022_02_01_preview.models.AdminRuleCollection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AdminRuleCollection, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.AdminRuleCollection
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _json = self._serialize.body(rule_collection, 'AdminRuleCollection')

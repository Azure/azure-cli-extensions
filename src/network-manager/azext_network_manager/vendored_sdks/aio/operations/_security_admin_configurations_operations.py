...
from ...operations._security_admin_configurations_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class SecurityAdminConfigurationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.SecurityAdminConfigurationListResult"]:
        ...
        :return: An iterator like instance of either SecurityAdminConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.SecurityAdminConfigurationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SecurityAdminConfigurationListResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("SecurityAdminConfigurationListResult", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.SecurityAdminConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SecurityAdminConfiguration"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def create_or_update(
        ...
        network_manager_name: str,
        configuration_name: str,
        security_admin_configuration: "_models.SecurityAdminConfiguration",
        **kwargs: Any
    ) -> "_models.SecurityAdminConfiguration":
        ...
        :type security_admin_configuration:
         ~azure.mgmt.network.v2022_02_01_preview.models.SecurityAdminConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SecurityAdminConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.SecurityAdminConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _json = self._serialize.body(security_admin_configuration, 'SecurityAdminConfiguration')

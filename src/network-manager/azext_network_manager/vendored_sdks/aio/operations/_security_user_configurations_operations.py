...
class SecurityUserConfigurationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.SecurityUserConfigurationListResult"]:
        ...
        :return: An iterator like instance of either SecurityUserConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_02_01_preview.models.SecurityUserConfigurationListResult]

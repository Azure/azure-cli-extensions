...
from ...operations._list_effective_virtual_networks_operations import build_by_network_group_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ListEffectiveVirtualNetworksOperations:
    """ListEffectiveVirtualNetworksOperations async operations.

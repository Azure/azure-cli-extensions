...
class ActiveConfigurationsOperations:
    """ActiveConfigurationsOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_preview.models.ActiveConfigurationListResult]

...
class NetworkManagerDeploymentStatusOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["_models.NetworkManagerDeploymentStatusListResult"]:
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_preview.models.NetworkManagerDeploymentStatusParameter
        ...
        :return: An iterator like instance of either NetworkManagerDeploymentStatusListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_preview.models.NetworkManagerDeploymentStatusListResult]

...
from ...operations._network_manager_commits_operations import build_post_request
T = TypeVar('T')
...
class NetworkManagerCommitsOperations:
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_05_01_preview.models.NetworkManagerCommit
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkManagerCommit, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2021_05_01_preview.models.NetworkManagerCommit

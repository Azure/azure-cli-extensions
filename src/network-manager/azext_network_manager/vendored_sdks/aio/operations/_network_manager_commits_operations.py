...
class NetworkManagerCommitsOperations:
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManagerCommit
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkManagerCommit, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2022_02_01_preview.models.NetworkManagerCommit

...
class SecurityConfigurationsOperations:
    """SecurityConfigurationsOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_preview.models.SecurityConfigurationListResult]
    ...
    async def import_method(
        ...
        parameters: "_models.NetworkManagerSecurityConfigurationImport",
        **kwargs
    ) -> "_models.SecurityConfigurationImportResult":
    ...
    def evaluate_import(
        ...
        skip_token: Optional[str] = None,
        **kwargs
    ) -> AsyncIterable["_models.SecurityConfigurationRuleListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_preview.models.SecurityConfigurationRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        network_manager_name: str,
        configuration_name: str,
        security_configuration: "_models.SecurityConfiguration",
        **kwargs
    ) -> "_models.SecurityConfiguration":

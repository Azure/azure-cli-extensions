...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.initiator_id = AAZStrArg(
            options=["--initiator-id"],
            arg_group="Properties",
            help="The initiator of the FileShareSnapshot. This is a user-defined value.",
        )
    ...
    class FileShareSnapshotCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("initiatorId", AAZStrType, ".initiator_id")

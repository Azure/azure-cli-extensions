...
nfs3_usage_model_type = CLIArgumentType(
    help='Identify the primary usage model to be used for this Storage Target. '
         ...
         'For more details about usage models, please refer to https://docs.microsoft.com/en-us/azure/hpc-cache/hpc-cache-add-storage?tabs=azure-cli#choose-a-usage-model')

...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WatchersUpdate(ctx=self.ctx)()
    ...
    class WatchersUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if datastore is not None:
                ...
                datastore.set_prop("kustoClusterUri", AAZStrType, ".kusto_cluster_uri")
                datastore.set_prop("kustoDataIngestionUri", AAZStrType, ".kusto_data_ingestion_uri")
                datastore.set_prop("kustoDatabaseName", AAZStrType, ".kusto_database_name")
                datastore.set_prop("kustoManagementUrl", AAZStrType, ".kusto_management_url")
                datastore.set_prop("kustoOfferingType", AAZStrType, ".kusto_offering_type")

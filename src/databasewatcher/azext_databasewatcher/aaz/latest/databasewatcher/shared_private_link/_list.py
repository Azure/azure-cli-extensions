...
@register_command(
    "databasewatcher shared-private-link list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SharedPrivateLinkResourcesListByWatcher(ctx=self.ctx)()
    ...
    class SharedPrivateLinkResourcesListByWatcher(AAZHttpOperation):

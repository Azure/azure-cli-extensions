...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.include_country = AAZBoolArg(
            options=["--include-country", "--country"],
            arg_group="Properties",
    ...
    class CertificateProfilesCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("identityValidationId", AAZStrType, ".identity_validation_id", typ_kwargs={"flags": {"required": True}})

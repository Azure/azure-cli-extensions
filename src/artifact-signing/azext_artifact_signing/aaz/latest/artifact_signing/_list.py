...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.CodeSigningAccountsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.CodeSigningAccountsListByResourceGroup(ctx=self.ctx)()
    ...
    class CodeSigningAccountsListBySubscription(AAZHttpOperation):
    ...
    class CodeSigningAccountsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

...
class List(AAZCommand):
    ...
    :example: UsagePlans_ListBySubscription_MaximumSet
        az resiliency usage-plan list

    :example: UsagePlans_ListByResourceGroup_MaximumSet
        az resiliency usage-plan list --resource-group MyResourceGroup
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.UsagePlansListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.UsagePlansListByResourceGroup(ctx=self.ctx)()
    ...
    class UsagePlansListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Microsoft.AzureResilienceManagement/usagePlans",
                **self.url_parameters
            )
    ...
    class UsagePlansListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureResilienceManagement/usagePlans",
                **self.url_parameters
            )

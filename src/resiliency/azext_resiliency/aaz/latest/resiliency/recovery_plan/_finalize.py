...
@register_command(
    "resiliency recovery-plan finalize",
)
class Finalize(AAZCommand):
    """This action finalizes the recovery orchestration plan, ensuring all necessary configurations are in place.

    :example: RecoveryPlanActions_Finalize_MaximumSet
        az resiliency recovery-plan finalize --service-group-name sampleServiceGroupName --operation-id qmn --recovery-plan-name samplePlanName
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RecoveryPlanActionsFinalize(ctx=self.ctx)()
    ...
    class RecoveryPlanActionsFinalize(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/providers/Microsoft.AzureResilienceManagement/recoveryPlans/{recoveryPlanName}/finalize",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _FinalizeHelper._build_schema_error_response_read(cls._schema_on_200)

            return cls._schema_on_200


class _FinalizeHelper:
    """Helper class for Finalize"""

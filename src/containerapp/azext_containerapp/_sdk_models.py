...
class DestinationsConfiguration(_serialization.Model):
    ...
    def __init__(
        self, *, data_dog_configuration: Optional["_models.DataDogConfiguration"] = None, **kwargs: Any
    ) -> None:
        """
...
class DaprComponentResiliency(_serialization.Model):
    """The Dapr component resiliency policy.
    :ivar inbound_policy: Inbound Policy
    :vartype inbound_policy: ~azure.mgmt.appcontainers.models.InboundPolicy
    :ivar outbound_policy: Outbound Policy
    :vartype outbound_policy: ~azure.mgmt.appcontainers.models.OutboundPolicy
    """

    _attribute_map = {
        "inbound_policy": {"key": "properties.inboundPolicy", "type": "InboundPolicy"},
        "outbound_policy": {"key": "properties.outboundPolicy", "type": "OutboundPolicy"},
    }

    def __init__(
            self,
            *,
            inbound_policy: Optional["_models.InboundPolicy"] = None,
            outbound_policy: Optional["_models.OutboundPolicy"] = None,
            **kwargs: Any
    ) -> None:
        """
        :keyword inbound_policy: Optional. Inbound Policy.
        :paramtype ~azure.mgmt.appcontainers.models.InboundPolicy
        :keyword outbound_policy: Optional. Outbound Policy.
        :paramtype ~azure.mgmt.appcontainers.models.OutboundPolicy
        """
        super().__init__(**kwargs)
        self.inbound_policy = inbound_policy
        self.outbound_policy = outbound_policy
...
class InboundPolicy(_serialization.Model):
    """The inbound policy.
    :ivar http_retry_policy: HttpRetryPolicy.
    :vartype http_retry_policy: ~azure.mgmt.appcontainers.models.HttpRetryPolicy
    :ivar timeout_policy: Timeout Policy.
    :vartype timeout_policy: ~azure.mgmt.appcontainers.models.TimeoutPolicy
    """

    _attribute_map = {
        "timeout_policy": {"key": "timeoutPolicy", "type": "TimeoutPolicy"},
        "http_retry_policy": {"key": "httpRetryPolicy", "type": "HttpRetryPolicy"},
    }
    ...
    def __init__(
        ...
        """
        :keyword timeout_policy: Optional. Timeout Policy.
        :paramtype ~azure.mgmt.appcontainers.models.TimeoutPolicy
        :keyword http_retry_policy: Optional. HttpRetryPolicy.
        :paramtype ~azure.mgmt.appcontainers.models.HttpRetryPolicy
        """
        super().__init__(**kwargs) 
        self.timeout_policy = timeout_policy
        self.http_retry_policy = http_retry_policy
...
class OutboundPolicy(_serialization.Model):
    """The outbound policy.
    :ivar http_retry_policy: HttpRetryPolicy.
    :vartype http_retry_policy: ~azure.mgmt.appcontainers.models.HttpRetryPolicy
    :ivar timeout_policy: Timeout Policy.
...
class ContainerAppsResiliency(_serialization.Model):
    """The app resiliency policy.
    :ivar timeout_policy: Timeout Policy.
    :vartype timeout_policy: ~azure.mgmt.appcontainers.models.TimeoutPolicy
    :ivar http_retry_policy: HttpRetryPolicy.
    :vartype http_retry_policy: ~azure.mgmt.appcontainers.models.HttpRetryPolicy
    :ivar tcp_retry_policy: TcpRetryPolicy.
    :vartype tcp_retry_policy: ~azure.mgmt.appcontainers.models.TcpRetryPolicy
    :ivar circuit_breaker_policy: CircuitBreakerPolicy.
    :vartype circuit_breaker_policy: ~azure.mgmt.appcontainers.models.CircuitBreakerPolicy
    :ivar tcp_connection_pool: TcpConnectionPool.
    :vartype tcp_connection_pool: ~azure.mgmt.appcontainers.models.TcpConnectionPool
    :ivar http_connection_pool: HttpConnectionPool.
    :vartype http_connection_pool: ~azure.mgmt.appcontainers.models.HttpConnectionPool
    """
    ...
    def __init__(
        ...
        :keyword http_retry_policy: Optional. HttpRetryPolicy.
        :paramtype ~azure.mgmt.appcontainers.models.HttpRetryPolicy
        :keyword tcp_retry_policy: Optional. TcpRetryPolicy.
        :paramtype ~azure.mgmt.appcontainers.models.TcpRetryPolicy
        :keyword circuit_breaker_policy: Optional. CircuitBreakerPolicy.
        :paramtype ~azure.mgmt.appcontainers.models.CircuitBreakerPolicy
        :keyword tcp_connection_pool: Optional. TcpConnectionPool.
        :paramtype ~azure.mgmt.appcontainers.models.TcpConnectionPool
        :keyword http_connection_pool: Optional. HttpConnectionPool.
        :paramtype ~azure.mgmt.appcontainers.models.HttpConnectionPool
        """
        super().__init__(**kwargs)
        self.timeout_policy = timeout_policy
        self.http_retry_policy = http_retry_policy
...
class CircuitBreakerPolicy(_serialization.Model):
    ...
    :ivar consecutive_errors: Consecutive Errors.
    :vartype consecutive_errors: int
    :ivar interval_in_seconds: Interval in Seconds.
    :vartype interval_in_seconds: int
    :ivar max_ejection_percent: Max Ejection Percent.
    :vartype max_ejection_percent: int
    """
    ...
    def __init__(
        ...
        """
        :keyword consecutive_errors: Consecutive Errors
        :paramtype consecutive_errors: int
        :keyword interval_in_seconds: Interval in Seconds
        :paramtype interval_in_seconds: int
        :keyword max_ejection_percent: Max Ejection Percent
        :paramtype max_ejection_percent: int
        """
        super().__init__(**kwargs)
        self.consecutive_errors = consecutive_errors
...
class TimeoutPolicy(_serialization.Model):
    """The Timeout policy.
    :ivar response_timeout_in_seconds: Response Timeout in Seconds.
    :vartype response_timeout_in_seconds: int
    :ivar connection_timeout_in_seconds: Connection Timeout in Seconds.
    ...
    def __init__(
        ...
        """
        :keyword response_timeout_in_seconds: Response Timeout in Seconds
        :paramtype response_timeout_in_seconds: int
        :keyword connection_timeout_in_seconds: Connection Timeout in Seconds
...
class HttpConnectionPool(_serialization.Model):
    """The HttpConnectionPool policy.
    :ivar http1_max_pending_requests: HTTP1 Max Pending Requests.
    :vartype http1_max_pending_requests: int
    :ivar http2_max_requests: HTTP2 Max Requests.
    :vartype http2_max_requests: int
    """
    ...
    def __init__(
        ...
        """
        :keyword http1_max_pending_requests: HTTP1 Max Pending Requests
        :paramtype http1_max_pending_requests: int
        :keyword http2_max_requests: HTTP2 Max Requests
        :paramtype http2_max_requests: int
        """
        super().__init__(**kwargs)
        self.http1_max_pending_requests = http1_max_pending_requests
...
class TcpConnectionPool(_serialization.Model):
    """The TcpConnectionPool policy.
    :ivar max_connections: Max Connections.
    ...
    def __init__(
        ...
        """
        :keyword max_connections: Max Connections
...
class TcpRetryPolicy(_serialization.Model):
    """The TcpRetryPolicy policy.
    :ivar max_connect_attempts: Max Connect Attempts.
    ...
    def __init__(
        ...
        """
        :keyword max_connect_attempts: Max Connect Attempts
...
class HttpRetryPolicy(_serialization.Model):
    ...
    :ivar max_retries: Maximum number of retries.
    :vartype max_retries: int
    :ivar retry_back_off: Retry back off.
    :vartype retry_back_off: ~azure.mgmt.appcontainers.models.RetryBackOff
    :ivar matches: Retry matches.
    :vartype matches: ~azure.mgmt.appcontainers.models.RetryMatches
    """

    _attribute_map = {
        "max_retries": {"key": "maxRetries", "type": "int"},
        "retry_back_off": {"key": "retryBackOff", "type": "RetryBackOff"},
        "matches": {"key": "matches", "type": "RetryMatches"},
    }
    ...
    def __init__(
        ...
        *,
        max_retries: Optional[int] = None,
        retry_back_off: Optional["_models.RetryBackOff"] = None,
        matches: Optional["_models.RetryMatches"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword max_retries: Maximum number of retries.
        :paramtype max_retries: int
        :keyword retry_back_off: Retry back off.
        :paramtype retry_back_off: ~azure.mgmt.appcontainers.models.RetryBackOff
        :keyword matches: Retry matches.
        :paramtype matches: ~azure.mgmt.appcontainers.models.RetryMatches
        """
        super().__init__(**kwargs)
        self.max_retries = max_retries
        self.retry_back_off = retry_back_off
...
class RetryBackOff(_serialization.Model):
    """Retry back off.

    :ivar initial_delay_in_milliseconds: Initial delay in milliseconds. 
    :vartype initial_delay_in_milliseconds: int
    :ivar max_interval_in_milliseconds: Maximum interval in milliseconds.
    :vartype max_interval_in_milliseconds: int
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword initial_delay_in_milliseconds: Initial delay in milliseconds.
        :paramtype initial_delay_in_milliseconds: int
        :keyword max_interval_in_milliseconds: Maximum interval in milliseconds.
        :paramtype max_interval_in_milliseconds: int
        """
        super().__init__(**kwargs)
        self.initial_delay_in_milliseconds = initial_delay_in_milliseconds
...
class RetryMatches(_serialization.Model):
    """Retry matches.

    :ivar headers: Headers for the retry matches.
    :vartype headers: list[~azure.mgmt.appcontainers.models.RetryMatchHeaders]
    :ivar http_status_codes: Http status codes for the retry matches.
    :vartype http_status_codes: list[int]
    :ivar errors: Errors for the retry matches.
    :vartype errors: list[str]
    """

    _attribute_map = {
        "headers": {"key": "headers", "type": "[RetryMatchHeaders]"},
        "http_status_codes": {"key": "httpStatusCodes", "type": "[int]"},
    ...
    def __init__(
        self,
        *,
        headers: Optional[List["_models.RetryMatchHeaders"]] = None,
        http_status_codes: Optional[List[int]] = None,
        errors: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword headers: Headers for the retry matches.
        :paramtype headers: list[~azure.mgmt.appcontainers.models.RetryMatchHeaders]
        :keyword http_status_codes: Http status codes for the retry matches.
        :paramtype http_status_codes: list[int]
        :keyword errors: Errors for the retry matches.
        :paramtype errors: list[str]
        """
        super().__init__(**kwargs)
        self.headers = headers
...
class RetryMatchHeaders(_serialization.Model):
    """Retry match headers.

    :ivar header: Header for the retry match.
    :vartype header: str
    :ivar match: Match for the retry match.
    :vartype match: ~azure.mgmt.appcontainers.models.RetryMatch
    """

    _attribute_map = {
        "header": {"key": "header", "type": "str"},
        "match": {"key": "match", "type": "RetryMatch"},
    }
    ...
    def __init__(
        ...
        *,
        header: Optional[str] = None,
        match: Optional["_models.RetryMatch"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword header: Header for the retry match.
        :paramtype header: str
        :keyword match: Match for the retry match.
        :paramtype match: ~azure.mgmt.appcontainers.models.RetryMatch
        """
        super().__init__(**kwargs)
        self.header = header
        self.match = match
...
class RetryMatch(_serialization.Model):
    """Retry match.

    :ivar prefix_match: Prefix match.
    :vartype prefix_match: str
    :ivar suffix_match: Suffix match.
    :vartype suffix_match: str
    :ivar exact_match: Exact match.
    :vartype exact_match: str
    :ivar regex_match: Regex match.
    :vartype regex_match: str
    """

    _attribute_map = {
        "prefix_match": {"key": "prefixMatch", "type": "str"},
        "suffix_match": {"key": "suffixMatch", "type": "str"},
        "exact_match": {"key": "exactMatch", "type": "str"},
        "regex_match": {"key": "regexMatch", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword prefix_match: Prefix match.
        :paramtype prefix_match: str
        :keyword suffix_match: Suffix match.
        :paramtype suffix_match: str
        :keyword exact_match: Exact match.
        :paramtype exact_match: str
        :keyword regex_match: Regex match.
        :paramtype regex_match: str
        """
        super().__init__(**kwargs)
        self.prefix_match = prefix_match

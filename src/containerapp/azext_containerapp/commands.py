...
def load_command_table(self, args):
    ...
    if is_cloud_supported_by_connected_env(self.cli_ctx):
        ...
        with self.command_group('containerapp connected-env dapr-component', is_preview=True) as g:
            ...
            g.custom_command('remove', 'connected_env_remove_dapr_component', supports_no_wait=True, confirmation=True, exception_handler=ex_handler_factory())
        ...
        with self.command_group('containerapp connected-env certificate', is_preview=True) as g:
            ...
            g.custom_command('delete', 'connected_env_delete_certificate', supports_no_wait=True, exception_handler=ex_handler_factory())

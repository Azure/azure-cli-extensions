...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp env', arg_group='Virtual Network') as c:
        ...
        c.argument('infrastructure_resource_group', options_list=['--infrastructure-resource-group'], help='Name for resource group that contains infrastructure resources. If not provided, the default resource group name will be used.')

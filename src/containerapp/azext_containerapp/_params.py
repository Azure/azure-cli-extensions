...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp', arg_group='Container (Creates new revision)') as c:
        ...
        c.argument('env_vars', nargs='*', options_list=['--env-vars', '--environment-variables'], help="A list of environment variable(s) for the containerapp. Space-separated values in 'key=value' format.")

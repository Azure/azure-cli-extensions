...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp', arg_group='Scale') as c:
        ...
        c.argument('scale_rule_type', options_list=['--scale-rule-type', '--srt'], help="The type of the scale rule. Default: http. For more information visit https://learn.microsoft.com/en-us/azure/container-apps/scale-app#scale-triggers")

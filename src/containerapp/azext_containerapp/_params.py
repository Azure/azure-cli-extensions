...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp env storage') as c:
        ...
        c.argument('azure_file_key_vault_secret_url', options_list=["--azure-file-key-vault-secret-url"],
                   help="Azure Key Vault secret URL containing the Azure Files storage account key.", is_preview=True)
        c.argument('azure_file_key_vault_identity', options_list=["--azure-file-key-vault-identity"],

...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp sessionpool', arg_group='Container') as c:
        ...
        c.argument('container_name', help="Name of the container. On create if no container name is provided, the name of the session pool coverted to lower case will be used.")

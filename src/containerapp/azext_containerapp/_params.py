...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp session code-interpreter', arg_group='execute') as c:
        ...
        c.argument('timeout_in_seconds', type=int, validator=validate_timeout_in_seconds, default=60, help="Duration in seconds code in session can run prior to timing out 1 - 240 secs, e.g. 30")

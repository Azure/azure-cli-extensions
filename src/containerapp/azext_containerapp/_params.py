...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp sessionpool') as c:
        ...
        c.argument('resource_group_name', arg_type=resource_group_name_type, id_part=None)
        c.argument('mi-system_assigned', options_list=['--mi-system-assigned'], help='Boolean indicating whether to assign system-assigned identity.', action='store_true')
        c.argument('mi-user_assigned', options_list=['--mi-user-assigned'], nargs='+', help='Space-separated user identities to be assigned.')

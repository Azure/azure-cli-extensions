...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp', arg_group='Scale') as c:
        ...
        c.argument('scale_rule_http_concurrency', type=int, options_list=['--scale-rule-http-concurrency', '--srhc'], help="The maximum number of concurrent http requests before scale out.")
        c.argument('scale_rule_tcp_concurrency', type=int, options_list=['--scale-rule-tcp-concurrency', '--srtc'], help="The maximum number of concurrent tcp requests before scale out.")

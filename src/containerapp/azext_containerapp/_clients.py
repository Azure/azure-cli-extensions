...
class DaprComponentClient():
    ...
    def create_or_update(cls, cmd, resource_group_name, environment_name, name, dapr_component_envelope, no_wait=False,
        ...
        api_version = STABLE_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/daprComponents/{}?api-version={}"
        request_url = url_fmt.format(
            management_hostname.strip('/'),
            sub_id,
            resource_group_name,
    ...
    @classmethod
    def delete(cls, cmd, resource_group_name, environment_name, name, no_wait=False, environment_type="managedEnvironments"):
        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = STABLE_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/daprComponents/{}?api-version={}"
    ...
    @classmethod
    def show(cls, cmd, resource_group_name, environment_name, name, environment_type="managedEnvironments"):
        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = STABLE_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/daprComponents/{}?api-version={}"
    ...
    @classmethod
    def list(cls, cmd, resource_group_name, environment_name, formatter=lambda x: x, environment_type="managedEnvironments"):
        app_list = []

        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = PREVIEW_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        request_url = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/daprComponents?api-version={}".format(
            management_hostname.strip('/'),
            sub_id,
            resource_group_name,
            environment_type,
...
class StorageClient():
    @classmethod
    def create_or_update(cls, cmd, resource_group_name, env_name, name, storage_envelope, no_wait=False, environment_type="managedEnvironments"):
        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = PREVIEW_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/storages/{}?api-version={}"
        request_url = url_fmt.format(
            management_hostname.strip('/'),
            sub_id,
            resource_group_name,
    ...
    @classmethod
    def delete(cls, cmd, resource_group_name, env_name, name, no_wait=False, environment_type="managedEnvironments"):
        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = PREVIEW_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/storages/{}?api-version={}"
    ...
    @classmethod
    def show(cls, cmd, resource_group_name, env_name, name, environment_type="managedEnvironments"):
        management_hostname = cmd.cli_ctx.cloud.endpoints.resource_manager
        api_version = PREVIEW_API_VERSION
        sub_id = get_subscription_id(cmd.cli_ctx)
        url_fmt = "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.App/{}/{}/storages/{}?api-version={}"
    ...
    @classmethod
    def list(cls, cmd, resource_group_name, env_name, formatter=lambda x: x, environment_type="managedEnvironments"):
        env_list = []

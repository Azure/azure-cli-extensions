...
class ContainerappScenarioTest(ScenarioTest):
    ...
    def test_container_acr(self, resource_group):
        ...
        self.cmd('containerapp env create -g {} -n {} --logs-workspace-id {} --logs-workspace-key {} -l eastus2'.format(resource_group, env_name, logs_workspace_id, logs_workspace_key))
    ...
    def test_containerapp_update_containers(self, resource_group):
        ...
        self.cmd('containerapp env create -g {} -n {} --logs-workspace-id {} --logs-workspace-key {} -l northeurope'.format(resource_group, env_name, logs_workspace_id, logs_workspace_key))
    ...
    def test_containerapp_registry_msi(self, resource_group):
        ...
        self.cmd(f'containerapp env create -g {resource_group} -n {env} --logs-workspace-id {logs_id} --logs-workspace-key {logs_key} -l northeurope')

...
class ContainerAppJobsCRUDOperationsTest(ScenarioTest):
    ...
    def test_containerapp_manualjob_withsecret_crudoperations_e2e2(self, resource_group):
        self.cmd("az containerapp job create --resource-group a --name b --environment c --replica-timeout 200 --replica-retry-limit 2 --trigger-type manual --parallelism 1  --image mcr.microsoft.com/k8se/quickstart-jobs:latest --cpu '0.25' --memory '0.5Gi'")

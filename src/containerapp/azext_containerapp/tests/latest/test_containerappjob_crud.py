...
class ContainerAppJobsCRUDOperationsTest(ScenarioTest):
    ...
    def test_containerappjob_update_min_max_executions_zero_e2e(self, resource_group):
        ...
        # Test 1: Update min_executions to 0 (this was the bug - boolean evaluation would skip this)
        ...
        # Test 2: Update max_executions to 0 (this was the bug - boolean evaluation would skip this)
        ...
        # Now set both to 0 in a single command

...
class ContainerAppPatchApplyTest(ScenarioTest):
    @live_only()
    @ResourceGroupPreparer(location = "eastus2")
    def test_containerapp_patch_apply_with_resource_group_e2e(self, resource_group):
        ...
        # Re-tag image to an older version to simulate patch apply
        ...
        # Execute and verify patch apply
    ...
    @live_only()
    @ResourceGroupPreparer(location = "eastus2")
    def test_containerapp_patch_apply_with_environment_e2e(self, resource_group):
        source_path = os.path.join(TEST_DIR, os.path.join("data", "source_built_using_buildpack"))
        ingress = 'external'
        target_port = '80'
         # Configure the default location
    ...
    @live_only()
    @ResourceGroupPreparer(location = "eastus2")
    def test_containerapp_patch_apply_with_show_all_e2e(self, resource_group):
    ...
    @live_only()
    @ResourceGroupPreparer(location = "eastus2")
    def test_containerapp_patch_apply_without_arguments_e2e(self, resource_group):
        source_path = os.path.join(TEST_DIR, os.path.join("data", "source_built_using_buildpack"))
        ingress = 'external'
        target_port = '80'
         # Configure the default location

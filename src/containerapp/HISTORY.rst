...
* 'az containerapp connected-env': Hide command group when cloud in AzureChinaCloud or AzureUSGovernment which is not supported
* 'az containerapp up': Fix InvalidResourceType error when cloud in AzureChinaCloud or AzureUSGovernment

...
* 'az containerapp connected-env': Hide command group when cloud not in AzureCloud
* 'az containerapp up': Fix InvalidResourceType error when cloud not in AzureCloud

...
@register_command(
    "self-help troubleshooter create",
    is_preview=True,
)
class Create(AAZCommand):
    ...
    :example: Create Troubleshooter at Resource Level
        az self-help troubleshooter create --troubleshooter-name {troubleshooter-name} --solution-id {solution-id} --parameters {ResourceURI:subscriptions/mySubscription/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-rp} --scope {scope}
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.parameters = AAZDictArg(
            ...
            help="Client input parameters to run Troubleshooter Resource",
        )
        _args_schema.solution_id = AAZStrArg(
            options=["--solution-id"],
            arg_group="Properties",
            help="Solution Id to identify single troubleshooter.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TroubleshootersCreate(ctx=self.ctx)()

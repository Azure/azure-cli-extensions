...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_replacement_maps_create(_args_schema.replacement_maps)
        ...
        cls._build_args_replacement_maps_create(_element.replacement_maps)
    ...
    _args_replacement_maps_create = None

    @classmethod
    def _build_args_replacement_maps_create(cls, _schema):
        if cls._args_replacement_maps_create is not None:
            _schema.diagnostics = cls._args_replacement_maps_create.diagnostics
            _schema.metrics_based_charts = cls._args_replacement_maps_create.metrics_based_charts
            _schema.troubleshooters = cls._args_replacement_maps_create.troubleshooters
            _schema.video_groups = cls._args_replacement_maps_create.video_groups
            _schema.videos = cls._args_replacement_maps_create.videos
            _schema.web_results = cls._args_replacement_maps_create.web_results
            return

        cls._args_replacement_maps_create = AAZObjectArg()

        replacement_maps_create = cls._args_replacement_maps_create
        replacement_maps_create.diagnostics = AAZListArg(
            options=["diagnostics"],
            help="Solution diagnostics results.",
        )
        replacement_maps_create.metrics_based_charts = AAZListArg(
            options=["metrics-based-charts"],
            help="Solution metrics based charts",
        )
        replacement_maps_create.troubleshooters = AAZListArg(
            options=["troubleshooters"],
            help="Solutions Troubleshooters",
        )
        replacement_maps_create.video_groups = AAZListArg(
            options=["video-groups"],
            help="Group of Videos",
        )
        replacement_maps_create.videos = AAZListArg(
            options=["videos"],
            help="Video solutions, which have the power to engage the customer by stimulating their senses",
        )
        replacement_maps_create.web_results = AAZListArg(
            options=["web-results"],
            help="Solution AzureKB results",
        )

        diagnostics = cls._args_replacement_maps_create.diagnostics
        diagnostics.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.diagnostics.Element
        ...
        insights = cls._args_replacement_maps_create.diagnostics.Element.insights
        insights.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.diagnostics.Element.insights.Element
        ...
        required_parameters = cls._args_replacement_maps_create.diagnostics.Element.required_parameters
        required_parameters.Element = AAZStrArg()

        metrics_based_charts = cls._args_replacement_maps_create.metrics_based_charts
        metrics_based_charts.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.metrics_based_charts.Element
        ...
        filter_group = cls._args_replacement_maps_create.metrics_based_charts.Element.filter_group
        filter_group.filter = AAZListArg(
            options=["filter"],
            help="List of filters",
        )

        filter = cls._args_replacement_maps_create.metrics_based_charts.Element.filter_group.filter
        filter.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.metrics_based_charts.Element.filter_group.filter.Element
        _element.name = AAZStrArg(
            options=["name"],
            help="Filter name",
        )
        ...
        troubleshooters = cls._args_replacement_maps_create.troubleshooters
        troubleshooters.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.troubleshooters.Element
        _element.solution_id = AAZStrArg(
            options=["solution-id"],
        ...
        video_groups = cls._args_replacement_maps_create.video_groups
        video_groups.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.video_groups.Element
        _element.replacement_key = AAZStrArg(
            options=["replacement-key"],
        ...
        videos = cls._args_replacement_maps_create.video_groups.Element.videos
        videos.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.video_groups.Element.videos.Element
        ...
        videos = cls._args_replacement_maps_create.videos
        videos.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.videos.Element
        _element.replacement_key = AAZStrArg(
            options=["replacement-key"],
            help="Place holder used in HTML Content replace control with the insight content",
        )
        ...
        web_results = cls._args_replacement_maps_create.web_results
        web_results.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.web_results.Element
        _element.replacement_key = AAZStrArg(
            options=["replacement-key"],
            help="Place holder used in HTML Content replace control with the content",
        )
        ...
        search_results = cls._args_replacement_maps_create.web_results.Element.search_results
        search_results.Element = AAZObjectArg()

        _element = cls._args_replacement_maps_create.web_results.Element.search_results.Element
    ...
    class SolutionCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                _CreateHelper._build_schema_replacement_maps_create(properties.set_prop("replacementMaps", AAZObjectType, ".replacement_maps"))
            ...
            if _elements is not None:
                ...
                _CreateHelper._build_schema_replacement_maps_create(_elements.set_prop("replacementMaps", AAZObjectType, ".replacement_maps"))
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_replacement_maps_read(properties.replacement_maps)
            ...
            _CreateHelper._build_schema_replacement_maps_read(_element.replacement_maps)
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_replacement_maps_create(cls, _builder):
        if _builder is None:
            return

...
class Show(AAZCommand):
    ...
    class SolutionGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_replacement_maps_read(properties.replacement_maps)
            ...
            _ShowHelper._build_schema_replacement_maps_read(_element.replacement_maps)

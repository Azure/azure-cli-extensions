...
@register_command(
    "playwright-testing auth-manager account access-token list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessTokensList(ctx=self.ctx)()
    ...
    class AccessTokensList(AAZHttpOperation):

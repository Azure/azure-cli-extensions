...
class Create(AAZCommand):
    ...
    :example: Deploy a Managed CCF instance with the sample JS application
        az confidentialledger managedccfs create --name "myMccf" --resource-group "myResourceGroup" --subscription <subscription-id> --location "southcentralus" --tags Dept=Finance --deployment-type language-run-time="JS" app-source-uri="sample" --member-identity-certificates certificate="<public certificate in PEM format>" encryption-key="" tags identifier=financemanager

    :example: Deploy a Managed CCF instance with a custom JS application
        az confidentialledger managedccfs create --name "myMccf" --resource-group "myResourceGroup" --subscription <subscription-id> --location "southcentralus" --tags Dept=Finance --deployment-type language-run-time="JS" --member-identity-certificates certificate="<public certificate in PEM format>" encryption-key="" tags identifier=financemanager
    """

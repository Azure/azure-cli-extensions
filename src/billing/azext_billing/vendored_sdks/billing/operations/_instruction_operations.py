...
class InstructionOperations(object):
    """InstructionOperations operations.
    ...
    def list_by_billing_profile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.InstructionListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~billing_management_client.models.InstructionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.InstructionListResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~billing_management_client.models.Instruction
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Instruction"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def put(
        ...
        **kwargs  # type: Any
        ...
        parameters = models.Instruction(amount=amount, start_date=start_date, end_date=end_date, creation_date=creation_date)
        api_version = "2020-05-01"

...
class BillingSubscriptionsOperations(object):
    ...
    def list_by_customer(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.BillingSubscriptionsListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~billing_management_client.models.BillingSubscriptionsListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.BillingSubscription"
    ...
    def update(
        self,
        billing_account_name,  # type: str
        parameters,  # type: "models.BillingSubscription"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BillingSubscription"
        ...
        :param parameters: Request parameters that are provided to the update billing subscription
         operation.
        :type parameters: ~billing_management_client.models.BillingSubscription
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BillingSubscription, or the result of cls(response)
        :rtype: ~billing_management_client.models.BillingSubscription
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def _move_initial(
        self,
        billing_account_name,  # type: str
        parameters,  # type: "models.TransferBillingSubscriptionRequestProperties"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.BillingSubscription"]
    ...
    def begin_move(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.BillingSubscription"]
        ...
        :type parameters: ~billing_management_client.models.TransferBillingSubscriptionRequestProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~billing_management_client.models.BillingSubscription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def validate_move(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ValidateSubscriptionTransferEligibilityResult"

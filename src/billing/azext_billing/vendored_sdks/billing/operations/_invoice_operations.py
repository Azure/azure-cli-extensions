...
class InvoiceOperations(object):
    ...
    def _download_multiple_billing_profile_invoice_initial(
        self,
        billing_account_name,  # type: str
    ...
    def begin_download_multiple_billing_profile_invoice(
        self,
        billing_account_name,  # type: str
        download_urls,  # type: List[str]
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._download_multiple_billing_profile_invoice_initial(
                billing_account_name=billing_account_name,
    ...
    def begin_download_multiple_billing_subscription_invoice(
        self,
        download_urls,  # type: List[str]
        **kwargs  # type: Any
    ):

...
class BillingProfileOperations(object):
    """BillingProfileOperations operations.
    ...
    def list_by_billing_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.BillingProfileListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~billing_management_client.models.BillingProfileListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~billing_management_client.models.BillingProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        bill_to=None,  # type: Optional["models.AddressDetails"]
        invoice_email_opt_in=None,  # type: Optional[bool]
        enabled_azure_plans=None,  # type: Optional[List["models.AzurePlan"]]
        value=None,  # type: Optional[List["models.InvoiceSection"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.BillingProfile"]
        ...
        parameters = models.BillingProfile(display_name=display_name, po_number=po_number, bill_to=bill_to, invoice_email_opt_in=invoice_email_opt_in, enabled_azure_plans=enabled_azure_plans, value=value)
        api_version = "2020-05-01"
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.BillingProfile"]
        ...
        :type bill_to: ~billing_management_client.models.AddressDetails
        ...
        :type enabled_azure_plans: list[~billing_management_client.models.AzurePlan]
        :param value: The invoice sections associated to the billing profile.
        :type value: list[~billing_management_client.models.InvoiceSection]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~billing_management_client.models.BillingProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

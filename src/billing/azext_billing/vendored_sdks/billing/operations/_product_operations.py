...
class ProductOperations(object):
    ...
    def list_by_customer(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ProductsListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~billing_management_client.models.ProductsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ProductsListResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~billing_management_client.models.Product
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update(
        ...
        billing_account_name,  # type: str
        product_name,  # type: str
        auto_renew=None,  # type: Optional[Union[str, "models.AutoRenew"]]
        status=None,  # type: Optional[Union[str, "models.ProductStatusType"]]
        billing_frequency=None,  # type: Optional[Union[str, "models.BillingFrequency"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Product"
        ...
        :param product_name: The ID that uniquely identifies a product.
        :type product_name: str
        :param auto_renew: Indicates whether auto renewal is turned on or off for a product.
        ...
        :param billing_frequency: The frequency at which the product will be billed.
        ...
        parameters = models.Product(auto_renew=auto_renew, status=status, billing_frequency=billing_frequency)
        api_version = "2020-05-01"
    ...
    def move(
        ...
        billing_account_name,  # type: str
        product_name,  # type: str
        destination_invoice_section_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Product, or the result of cls(response)
        :rtype: ~billing_management_client.models.Product or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def validate_move(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ValidateProductTransferEligibilityResult"
        ...
        :rtype: ~billing_management_client.models.ValidateProductTransferEligibilityResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ValidateProductTransferEligibilityResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

...
class PolicyOperations(object):
    ...
    def get_by_billing_profile(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~billing_management_client.models.Policy
    ...
    def update(
        ...
        billing_account_name,  # type: str
        billing_profile_name,  # type: str
        marketplace_purchases=None,  # type: Optional[Union[str, "models.MarketplacePurchasesPolicy"]]
        reservation_purchases=None,  # type: Optional[Union[str, "models.ReservationPurchasesPolicy"]]
        view_charges=None,  # type: Optional[Union[str, "models.ViewChargesPolicy"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Policy"
        ...
        :param marketplace_purchases: The policy that controls whether Azure marketplace purchases are
         allowed for a billing profile.
        :type marketplace_purchases: str or ~billing_management_client.models.MarketplacePurchasesPolicy
        :param reservation_purchases: The policy that controls whether Azure reservation purchases are
         allowed for a billing profile.
        :type reservation_purchases: str or ~billing_management_client.models.ReservationPurchasesPolicy
        :param view_charges: The policy that controls whether users with Azure RBAC access to a
         subscription can view its charges.
        :type view_charges: str or ~billing_management_client.models.ViewChargesPolicy
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Policy, or the result of cls(response)
        :rtype: ~billing_management_client.models.Policy
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        parameters = models.Policy(marketplace_purchases=marketplace_purchases, reservation_purchases=reservation_purchases, view_charges=view_charges)
        api_version = "2020-05-01"
    ...
    def get_by_customer(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~billing_management_client.models.CustomerPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomerPolicy"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def update_customer(
        ...
        billing_account_name,  # type: str
        customer_name,  # type: str
        view_charges=None,  # type: Optional[Union[str, "models.ViewCharges"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomerPolicy"
        ...
        :type view_charges: str or ~billing_management_client.models.ViewCharges
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CustomerPolicy, or the result of cls(response)
        :rtype: ~billing_management_client.models.CustomerPolicy
        :raises: ~azure.core.exceptions.HttpResponseError

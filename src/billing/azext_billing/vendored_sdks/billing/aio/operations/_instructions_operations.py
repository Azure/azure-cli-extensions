...
class InstructionsOperations:
    ...
    def list_by_billing_profile(
        ...
        **kwargs
    ) -> AsyncIterable["models.InstructionListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.InstructionListResult]
    ...
    async def put(
        ...
        **kwargs
        ...
        :type parameters: ~billing_management_client.models.Instruction
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Instruction, or the result of cls(response)
        :rtype: ~billing_management_client.models.Instruction
        :raises: ~azure.core.exceptions.HttpResponseError

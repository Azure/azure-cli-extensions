...
class BillingPermissionOperations:
    """BillingPermissionOperations async operations.
    ...
    def list_by_customer(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.BillingPermissionsListResult]

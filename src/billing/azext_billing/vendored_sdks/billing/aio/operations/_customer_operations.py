...
class CustomerOperations:
    """CustomerOperations async operations.
    ...
    def list_by_billing_profile(
        ...
        **kwargs
    ) -> AsyncIterable["models.CustomerListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.CustomerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomerListResult"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~billing_management_client.models.Customer
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Customer"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

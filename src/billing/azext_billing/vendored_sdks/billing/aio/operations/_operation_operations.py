...
class OperationOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.OperationListResult]
    ...
    list.metadata = {'url': '/providers/Microsoft.Billing/operations'}  # type: ignore

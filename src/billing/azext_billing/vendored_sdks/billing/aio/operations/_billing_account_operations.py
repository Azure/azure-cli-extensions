...
class BillingAccountOperations:
    """BillingAccountOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.BillingAccountListResult]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~billing_management_client.models.BillingAccount
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _update_initial(
        ...
        sold_to: Optional["models.AddressDetails"] = None,
        departments: Optional[List["models.Department"]] = None,
        enrollment_accounts: Optional[List["models.EnrollmentAccount"]] = None,
        value: Optional[List["models.BillingProfile"]] = None,
        **kwargs
        ...
        parameters = models.BillingAccountUpdateRequest(display_name=display_name, sold_to=sold_to, departments=departments, enrollment_accounts=enrollment_accounts, value=value)
        api_version = "2020-05-01"
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :param sold_to: The address of the individual or organization that is responsible for the
         billing account.
        :type sold_to: ~billing_management_client.models.AddressDetails
        :param departments: The departments associated to the enrollment.
        :type departments: list[~billing_management_client.models.Department]
        :param enrollment_accounts: The accounts associated to the enrollment.
        :type enrollment_accounts: list[~billing_management_client.models.EnrollmentAccount]
        :param value: The billing profiles associated with the billing account.
        :type value: list[~billing_management_client.models.BillingProfile]
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~billing_management_client.models.BillingAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_invoice_section_by_create_subscription_permission(
        self,
        billing_account_name: str,
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.InvoiceSectionListWithCreateSubPermissionResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_invoice_section_by_create_subscription_permission.metadata['url']  # type: ignore
                path_format_arguments = {
                    'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    list_invoice_section_by_create_subscription_permission.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/listInvoiceSectionsWithCreateSubscriptionPermission'}  # type: ignore

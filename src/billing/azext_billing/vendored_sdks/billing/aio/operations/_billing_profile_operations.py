...
class BillingProfileOperations:
    """BillingProfileOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        bill_to: Optional["models.AddressDetails"] = None,
        invoice_email_opt_in: Optional[bool] = None,
        enabled_azure_plans: Optional[List["models.AzurePlan"]] = None,
        value: Optional[List["models.InvoiceSection"]] = None,
        **kwargs

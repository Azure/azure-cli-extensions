...
class BillingPeriodOperations:
    """BillingPeriodOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.BillingPeriodsListResult]

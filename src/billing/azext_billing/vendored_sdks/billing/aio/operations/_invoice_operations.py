...
class InvoiceOperations:
    """InvoiceOperations async operations.
    ...
    def list_by_billing_account(
        ...
        period_end_date: str,
        **kwargs
    ) -> AsyncIterable["models.InvoiceListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~billing_management_client.models.InvoiceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.InvoiceListResult"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~billing_management_client.models.Invoice
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Invoice"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def _download_invoice_initial(
        ...
        download_token: str,
        **kwargs
    ) -> Optional["models.DownloadUrl"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DownloadUrl"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def begin_download_invoice(
        ...
        download_token: str,
        **kwargs
    ) -> AsyncLROPoller["models.DownloadUrl"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~billing_management_client.models.DownloadUrl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _download_multiple_billing_profile_invoice_initial(
        self,
        billing_account_name: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self._download_multiple_billing_profile_invoice_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    _download_multiple_billing_profile_invoice_initial.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/downloadDocuments'}  # type: ignore

    async def begin_download_multiple_billing_profile_invoice(
        self,
        billing_account_name: str,
        download_urls: List[str],
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._download_multiple_billing_profile_invoice_initial(
                billing_account_name=billing_account_name,
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_download_multiple_billing_profile_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/downloadDocuments'}  # type: ignore
    ...
    async def _download_multiple_billing_subscription_invoice_initial(
        self,
        download_urls: List[str],
        **kwargs
    ) -> Optional["models.DownloadUrl"]:
        ...
        # Construct URL
        url = self._download_multiple_billing_subscription_invoice_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    _download_multiple_billing_subscription_invoice_initial.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/downloadDocuments'}  # type: ignore

    async def begin_download_multiple_billing_subscription_invoice(
        self,
        download_urls: List[str],
        **kwargs
    ) -> AsyncLROPoller["models.DownloadUrl"]:
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._download_multiple_billing_subscription_invoice_initial(
                download_urls=download_urls,
                cls=lambda x,y,z: x,
                **kwargs
            )
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_download_multiple_billing_subscription_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/downloadDocuments'}  # type: ignore

...
@register_command(
    "billing role-definition list-by-invoice-section",
)
class ListByInvoiceSection(AAZCommand):
    """List the role definitions for an invoice section. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement or Microsoft Customer Agreement.

    :example: BillingRoleDefinitionListByInvoiceSection
        az billing role-definition list-by-invoice-section --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name yyyy-yyyy-yyy-yyy
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionListByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionListByInvoiceSection(AAZHttpOperation):

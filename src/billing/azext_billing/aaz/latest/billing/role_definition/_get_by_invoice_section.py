...
@register_command(
    "billing role-definition get-by-invoice-section",
)
class GetByInvoiceSection(AAZCommand):
    """Get the definition for a role on an invoice section. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: BillingRoleDefinitionGetByInvoiceSection
        az billing role-definition get-by-invoice-section --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name yyyy-yyyy-yyy-yyy --role-definition-name 30000000-aaaa-bbbb-cccc-100000000000
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/billingroledefinitions/{}", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionGetByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionGetByInvoiceSection(AAZHttpOperation):

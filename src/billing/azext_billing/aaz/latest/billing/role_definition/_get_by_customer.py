...
@register_command(
    "billing role-definition get-by-customer",
)
class GetByCustomer(AAZCommand):
    """Get the definition for a role on a customer. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: BillingRoleDefinitionGetByCustomer
        az billing role-definition get-by-customer --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111 --role-definition-name 30000000-aaaa-bbbb-cccc-100000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionGetByCustomer(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionGetByCustomer(AAZHttpOperation):

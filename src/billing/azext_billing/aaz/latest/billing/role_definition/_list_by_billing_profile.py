...
@register_command(
    "billing role-definition list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the role definitions for a billing profile. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement, Microsoft Customer Agreement or Enterprise Agreement.

    :example: BillingRoleDefinitionListByBillingProfile
        az billing role-definition list-by-billing-profile --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/billingroledefinitions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionListByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionListByBillingProfile(AAZHttpOperation):

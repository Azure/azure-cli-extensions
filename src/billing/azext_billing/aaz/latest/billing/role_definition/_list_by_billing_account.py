...
class ListByBillingAccount(AAZCommand):
    """List the role definitions for a billing account. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement, Microsoft Customer Agreement or Enterprise Agreement.

    :example: BillingRoleDefinitionListByBillingAccount
        az billing role-definition list-by-billing-account --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionListByBillingAccount(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionListByBillingAccount(AAZHttpOperation):

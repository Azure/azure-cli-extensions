...
class GetByBillingProfile(AAZCommand):
    """Get the definition for a role on a billing profile. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement or Microsoft Customer Agreement.

    :example: BillingRoleDefinitionGetByBillingProfile
        az billing role-definition get-by-billing-profile --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --role-definition-name 40000000-aaaa-bbbb-cccc-100000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionGetByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionGetByBillingProfile(AAZHttpOperation):

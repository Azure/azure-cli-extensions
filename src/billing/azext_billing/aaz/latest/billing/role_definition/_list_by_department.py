...
class ListByDepartment(AAZCommand):
    ...
    :example: BillingRoleDefinitionListByDepartment
        az billing role-definition list-by-department --billing-account-name 123456 --department-name 7368531
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionListByDepartment(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionListByDepartment(AAZHttpOperation):

...
@register_command(
    "billing role-definition get-by-enrollment-account",
)
class GetByEnrollmentAccount(AAZCommand):
    """Get the definition for a role on an enrollment account. The operation is supported for billing accounts with agreement type Enterprise Agreement.

    :example: BillingRoleDefinitionGetByEnrollmentAccount
        az billing role-definition get-by-enrollment-account --billing-account-name 123456 --enrollment-account-name 4568789 --role-definition-name 50000000-aaaa-bbbb-cccc-100000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleDefinitionGetByEnrollmentAccount(ctx=self.ctx)()
    ...
    class BillingRoleDefinitionGetByEnrollmentAccount(AAZHttpOperation):

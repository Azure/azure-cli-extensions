...
@register_command(
    "billing recipient-transfer decline",
)
class Decline(AAZCommand):
    """Declines a transfer request.

    :example: DeclineTransfer
        az billing recipient-transfer decline --transfer-name aabb123
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/transfers/{}/decline", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RecipientTransfersDecline(ctx=self.ctx)()
    ...
    class RecipientTransfersDecline(AAZHttpOperation):
...
class _DeclineHelper:
    """Helper class for Decline"""

...
@register_command(
    "billing recipient-transfer list",
)
class List(AAZCommand):
    """List the transfer requests received by the caller.

    :example: RecipientTransfersList
        az billing recipient-transfer list
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/transfers", "2024-04-01"],
        ]
    }
    ...
    class RecipientTransfersList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            supported_accounts = cls._schema_on_200.value.Element.properties.supported_accounts

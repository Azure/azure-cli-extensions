...
@register_command(
    "billing reservation-order list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List all the `ReservationOrders in the billing account.

    :example: reservationOrderListByBillingAccount
        az billing reservation-order list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/reservationorders", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReservationOrdersListByBillingAccount(ctx=self.ctx)()
    ...
    class ReservationOrdersListByBillingAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingAccountHelper._build_schema_system_data_read(_element.system_data)
            _element.tags = AAZDictType()
            _ListByBillingAccountHelper._build_schema_tags_read(_element.tags)
            ...
            _ListByBillingAccountHelper._build_schema_reservation_extended_status_info_read(properties.extended_status_info)
            ...
            _ListByBillingAccountHelper._build_schema_price_read(plan_information.pricing_currency_total)
            ...
            _ListByBillingAccountHelper._build_schema_reservation_extended_status_info_read(_element.extended_status_info)
            ...
            _ListByBillingAccountHelper._build_schema_price_read(_element.pricing_currency_total)
            ...
            _ListByBillingAccountHelper._build_schema_reservation_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            applied_scopes = cls._schema_on_200.value.Element.properties.reservations.Element.properties.applied_scopes
            ...
            _ListByBillingAccountHelper._build_schema_price_read(renew_properties.billing_currency_total)
            renew_properties.pricing_currency_total = AAZObjectType(
                serialized_name="pricingCurrencyTotal",
            )
            _ListByBillingAccountHelper._build_schema_price_read(renew_properties.pricing_currency_total)
            ...
            applied_scopes = cls._schema_on_200.value.Element.properties.reservations.Element.properties.renew_properties.purchase_properties.properties.applied_scopes
            applied_scopes.Element = AAZStrType()
            ...
            sku = cls._schema_on_200.value.Element.properties.reservations.Element.properties.renew_properties.purchase_properties.sku
            sku.name = AAZStrType()
            ...
            sku = cls._schema_on_200.value.Element.properties.reservations.Element.sku
            sku.name = AAZStrType(
                flags={"read_only": True},
            )
...
class _ListByBillingAccountHelper:
    ...
    _schema_reservation_extended_status_info_read = None

    @classmethod
    def _build_schema_reservation_extended_status_info_read(cls, _schema):
        if cls._schema_reservation_extended_status_info_read is not None:
            _schema.message = cls._schema_reservation_extended_status_info_read.message
            _schema.properties = cls._schema_reservation_extended_status_info_read.properties
            _schema.status_code = cls._schema_reservation_extended_status_info_read.status_code
            return

        cls._schema_reservation_extended_status_info_read = _schema_reservation_extended_status_info_read = AAZObjectType()

        reservation_extended_status_info_read = _schema_reservation_extended_status_info_read
        reservation_extended_status_info_read.message = AAZStrType()
        reservation_extended_status_info_read.properties = AAZObjectType()
        reservation_extended_status_info_read.status_code = AAZStrType(
            serialized_name="statusCode",
        )

        properties = _schema_reservation_extended_status_info_read.properties
    ...
    _schema_tags_read = None

    @classmethod
    def _build_schema_tags_read(cls, _schema):
        if cls._schema_tags_read is not None:
            _schema.Element = cls._schema_tags_read.Element
            return

        cls._schema_tags_read = _schema_tags_read = AAZDictType()

        tags_read = _schema_tags_read
        tags_read.Element = AAZStrType()

...
@register_command(
    "billing request list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List list of billing requests submitted for the billing account.

    :example: BillingRequestsListByBillingAccount
        az billing request list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingrequests", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRequestsListByBillingAccount(ctx=self.ctx)()
    ...
    class BillingRequestsListByBillingAccount(AAZHttpOperation):

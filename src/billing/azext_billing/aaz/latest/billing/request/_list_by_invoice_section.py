...
@register_command(
    "billing request list-by-invoice-section",
)
class ListByInvoiceSection(AAZCommand):
    """List list of billing requests submitted for the invoice section.

    :example: BillingRequestsListByInvoiceSection
        az billing request list-by-invoice-section --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name yyyy-yyyy-yyy-yyy
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/billingrequests", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRequestsListByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRequestsListByInvoiceSection(AAZHttpOperation):

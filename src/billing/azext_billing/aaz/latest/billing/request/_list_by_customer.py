...
@register_command(
    "billing request list-by-customer",
)
class ListByCustomer(AAZCommand):
    """List list of billing requests submitted for the customer.

    :example: BillingRequestsListByCustomer
        az billing request list-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/billingrequests", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRequestsListByCustomer(ctx=self.ctx)()
    ...
    class BillingRequestsListByCustomer(AAZHttpOperation):

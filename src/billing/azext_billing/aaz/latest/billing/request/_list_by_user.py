...
@register_command(
    "billing request list-by-user",
)
class ListByUser(AAZCommand):
    """List list of billing requests submitted by a user.

    :example: BillingRequestsListByUser
        az billing request list-by-user
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRequestsListByUser(ctx=self.ctx)()
    ...
    class BillingRequestsListByUser(AAZHttpOperation):

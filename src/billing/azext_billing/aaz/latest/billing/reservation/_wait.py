...
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReservationsGetByReservationOrder(ctx=self.ctx)()
    ...
    class ReservationsGetByReservationOrder(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_reservation_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _WaitHelper._build_schema_price_read(renew_properties.billing_currency_total)
            renew_properties.pricing_currency_total = AAZObjectType(
                serialized_name="pricingCurrencyTotal",
            )
            _WaitHelper._build_schema_price_read(renew_properties.pricing_currency_total)

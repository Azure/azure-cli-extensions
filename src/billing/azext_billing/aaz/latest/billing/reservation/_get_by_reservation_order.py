...
@register_command(
    "billing reservation get-by-reservation-order",
)
class GetByReservationOrder(AAZCommand):
    """Get specific Reservation details in the billing account.

    :example: reservationGetByBillingAccount
        az billing reservation get-by-reservation-order --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --reservation-order-id 20000000-0000-0000-0000-000000000000 --reservation-id 30000000-0000-0000-0000-000000000000
    """
    ...
    class ReservationsGetByReservationOrder(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _GetByReservationOrderHelper._build_schema_reservation_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _GetByReservationOrderHelper._build_schema_price_read(renew_properties.billing_currency_total)
            renew_properties.pricing_currency_total = AAZObjectType(
                serialized_name="pricingCurrencyTotal",
            )
            _GetByReservationOrderHelper._build_schema_price_read(renew_properties.pricing_currency_total)
...
class _GetByReservationOrderHelper:
    """Helper class for GetByReservationOrder"""

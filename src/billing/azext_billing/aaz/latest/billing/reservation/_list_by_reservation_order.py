...
@register_command(
    "billing reservation list-by-reservation-order",
)
class ListByReservationOrder(AAZCommand):
    """List Reservations within a single ReservationOrder in the billing account.

    :example: reservationsGetFromOrderByBillingAccount
        az billing reservation list-by-reservation-order --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --reservation-order-id 20000000-0000-0000-0000-000000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ReservationsListByReservationOrder(ctx=self.ctx)()
    ...
    class ReservationsListByReservationOrder(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByReservationOrderHelper._build_schema_reservation_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _ListByReservationOrderHelper._build_schema_price_read(renew_properties.billing_currency_total)
            renew_properties.pricing_currency_total = AAZObjectType(
                serialized_name="pricingCurrencyTotal",
            )
            _ListByReservationOrderHelper._build_schema_price_read(renew_properties.pricing_currency_total)
...
class _ListByReservationOrderHelper:
    """Helper class for ListByReservationOrder"""
...
__all__ = ["ListByReservationOrder"]

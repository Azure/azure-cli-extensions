...
@register_command(
    "billing reservation list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    ...
    :example: reservationsListByBillingAccount
        az billing reservation list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --selected-state Succeeded
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/reservations", "2024-04-01"],
        ]
    }

...
@register_command(
    "billing invoice download-by-billing-subscription",
)
class DownloadByBillingSubscription(AAZCommand):
    ...
    :example: InvoicesDownloadByBillingSubscription
        az billing invoice download-by-billing-subscription --invoice-name E123456789 --document-name 12345678
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/default/billingsubscriptions/{}/invoices/{}/download", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.InvoicesDownloadByBillingSubscription(ctx=self.ctx)()
    ...
    class InvoicesDownloadByBillingSubscription(AAZHttpOperation):
...
class _DownloadByBillingSubscriptionHelper:
    """Helper class for DownloadByBillingSubscription"""


__all__ = ["DownloadByBillingSubscription"]

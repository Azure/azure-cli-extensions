...
@register_command(
    "billing invoice list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    ...
    :example: InvoicesListByBillingProfile
        az billing invoice list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --period-start-date 2023-01-01 --period-end-date 2023-06-30
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoices", "2024-04-01"],
        ]
    }
    ...
    class InvoicesListByBillingProfile(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingProfileHelper._build_schema_rebill_details_read(properties.rebill_details)

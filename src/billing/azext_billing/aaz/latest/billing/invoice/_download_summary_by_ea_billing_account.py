...
@register_command(
    "billing invoice download-summary-by-ea-billing-account",
)
class DownloadSummaryByEaBillingAccount(AAZCommand):
    ...
    :example: InvoicesDownloadSummaryByBillingAccount
        az billing invoice download-summary-by-ea-billing-account --billing-account-name 123456789 --invoice-name G123456789
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/invoices/{}/downloadsummary", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.InvoicesDownloadSummaryByBillingAccount(ctx=self.ctx)()
    ...
    class InvoicesDownloadSummaryByBillingAccount(AAZHttpOperation):
...
class _DownloadSummaryByEaBillingAccountHelper:
    """Helper class for DownloadSummaryByEaBillingAccount"""


__all__ = ["DownloadSummaryByEaBillingAccount"]

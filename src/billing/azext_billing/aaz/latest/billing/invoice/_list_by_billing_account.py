...
@register_command(
    "billing invoice list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List the invoices for a billing account for a given start date and end date. The operation is supported for all billing account types.

    :example: InvoicesListByBillingAccount
        az billing invoice list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --period-start-date 2023-01-01 --period-end-date 2023-06-30
    """
    ...
    class InvoicesListByBillingAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingAccountHelper._build_schema_rebill_details_read(properties.rebill_details)

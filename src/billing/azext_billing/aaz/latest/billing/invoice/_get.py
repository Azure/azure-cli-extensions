...
class Get(AAZCommand):
    """Get an invoice by ID. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement or Microsoft Customer Agreement.

    :example: InvoicesGet
        az billing invoice get --invoice-name G123456789
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/default/invoices/{}", "2024-04-01"],
        ]
    }
    ...
    class InvoicesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _GetHelper._build_schema_rebill_details_read(properties.rebill_details)

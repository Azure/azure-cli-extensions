...
@register_command(
    "billing department list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List the departments that a user has access to. The operation is supported only for billing accounts with agreement type Enterprise Agreement.

    :example: DepartmentsListByBillingAccount
        az billing department list-by-billing-account --billing-account-name 456598
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DepartmentsListByBillingAccount(ctx=self.ctx)()
    ...
    class DepartmentsListByBillingAccount(AAZHttpOperation):

...
@register_command(
    "billing transaction list-by-invoice",
)
class ListByInvoice(AAZCommand):
    """List the transactions for an invoice. Transactions include purchases, refunds and Azure usage charges.

    :example: TransactionsListByInvoice
        az billing transaction list-by-invoice --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --invoice-name G123456789
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/invoices/{}/transactions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TransactionsListByInvoice(ctx=self.ctx)()
    ...
    class TransactionsListByInvoice(AAZHttpOperation):
...
class _ListByInvoiceHelper:
    """Helper class for ListByInvoice"""


__all__ = ["ListByInvoice"]

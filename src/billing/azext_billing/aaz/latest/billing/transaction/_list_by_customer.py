...
@register_command(
    "billing transaction list-by-customer",
)
class ListByCustomer(AAZCommand):
    """List the billed or unbilled transactions by customer id for given start date and end date. Transactions include purchases, refunds and Azure usage charges. Unbilled transactions are listed under pending invoice Id and do not include tax. Tax is added to the amount once an invoice is generated.

    :example: TransactionsListByCustomer
        az billing transaction list-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 22000000-0000-0000-0000-000000000000 --period-start-date 2024-04-01 --period-end-date 2023-05-30 --type Billed --filter properties/date gt '2020-10-01' --search storage
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/transactions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TransactionsListByCustomer(ctx=self.ctx)()
    ...
    class TransactionsListByCustomer(AAZHttpOperation):

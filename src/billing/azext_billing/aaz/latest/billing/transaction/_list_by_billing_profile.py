...
@register_command(
    "billing transaction list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the billed or unbilled transactions by billing profile name for given start and end date. Transactions include purchases, refunds and Azure usage charges. Unbilled transactions are listed under pending invoice Id and do not include tax. Tax is added to the amount once an invoice is generated.

    :example: TransactionsListByBillingProfile
        az billing transaction list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --period-start-date 2024-04-01 --period-end-date 2023-05-30 --type Billed --filter properties/date gt '2020-10-01' --search storage
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/transactions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TransactionsListByBillingProfile(ctx=self.ctx)()
    ...
    class TransactionsListByBillingProfile(AAZHttpOperation):

...
@register_command(
    "billing enrollment-account get-by-department",
)
class GetByDepartment(AAZCommand):
    """Get an enrollment account by department. The operation is supported only for billing accounts with agreement type Enterprise Agreement.

    :example: EnrollmentAccountByDepartment
        az billing enrollment-account get-by-department --billing-account-name 6564892 --department-name 164821 --enrollment-account-name 257698
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/departments/{}/enrollmentaccounts/{}", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnrollmentAccountsGetByDepartment(ctx=self.ctx)()
    ...
    class EnrollmentAccountsGetByDepartment(AAZHttpOperation):

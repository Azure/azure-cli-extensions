...
@register_command(
    "billing enrollment-account get",
)
class Get(AAZCommand):
    """Get an enrollment account by ID. The operation is supported only for billing accounts with agreement type Enterprise Agreement.

    :example: EnrollmentAccountGet
        az billing enrollment-account get --billing-account-name 6564892 --enrollment-account-name 257698
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnrollmentAccountsGet(ctx=self.ctx)()
    ...
    class EnrollmentAccountsGet(AAZHttpOperation):

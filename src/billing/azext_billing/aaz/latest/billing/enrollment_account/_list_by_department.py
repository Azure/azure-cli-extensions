...
@register_command(
    "billing enrollment-account list-by-department",
)
class ListByDepartment(AAZCommand):
    """List the enrollment accounts for a department. The operation is supported only for billing accounts with agreement type Enterprise Agreement.

    :example: EnrollmentAccountsListByDepartment
        az billing enrollment-account list-by-department --billing-account-name 6564892 --department-name 164821
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnrollmentAccountsListByDepartment(ctx=self.ctx)()
    ...
    class EnrollmentAccountsListByDepartment(AAZHttpOperation):

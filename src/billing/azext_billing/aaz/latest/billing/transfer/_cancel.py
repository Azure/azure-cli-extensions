...
class Cancel(AAZCommand):
    ...
    :example: TransferCancel
        az billing transfer cancel --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name yyyy-yyyy-yyy-yyy --transfer-name aabb123
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/transfers/{}/cancel", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TransfersCancel(ctx=self.ctx)()
    ...
    class TransfersCancel(AAZHttpOperation):

...
@register_command(
    "billing transfer update",
)
class Update(AAZCommand):
    """Update a request to a user in another billing account to transfer billing ownership of their subscriptions. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TransfersGet(ctx=self.ctx)()
    ...
    class TransfersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_transfer_details_read(cls._schema_on_200)
    ...
    class TransfersInitiate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_transfer_details_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_transfer_details_read = None

    @classmethod
    def _build_schema_transfer_details_read(cls, _schema):
        if cls._schema_transfer_details_read is not None:
            _schema.id = cls._schema_transfer_details_read.id
            _schema.name = cls._schema_transfer_details_read.name
            _schema.properties = cls._schema_transfer_details_read.properties
            _schema.system_data = cls._schema_transfer_details_read.system_data
            _schema.tags = cls._schema_transfer_details_read.tags
            _schema.type = cls._schema_transfer_details_read.type
            return

        cls._schema_transfer_details_read = _schema_transfer_details_read = AAZObjectType()

        transfer_details_read = _schema_transfer_details_read
        transfer_details_read.id = AAZStrType(
            flags={"read_only": True},
        )
        transfer_details_read.name = AAZStrType(
            flags={"read_only": True},
        )
        transfer_details_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        transfer_details_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        transfer_details_read.tags = AAZDictType()
        transfer_details_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_transfer_details_read.properties
        ...
        detailed_transfer_status = _schema_transfer_details_read.properties.detailed_transfer_status
        detailed_transfer_status.Element = AAZObjectType()

        _element = _schema_transfer_details_read.properties.detailed_transfer_status.Element
        ...
        error_details = _schema_transfer_details_read.properties.detailed_transfer_status.Element.error_details
        ...
        system_data = _schema_transfer_details_read.system_data
        ...
        tags = _schema_transfer_details_read.tags

...
@register_command(
    "billing profile validate-delete-eligibility",
)
class ValidateDeleteEligibility(AAZCommand):
    ...
    :example: BillingProfilesValidateDeleteEligibilitySuccess
        az billing profile validate-delete-eligibility --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/validatedeleteeligibility", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingProfilesValidateDeleteEligibility(ctx=self.ctx)()
    ...
    class BillingProfilesValidateDeleteEligibility(AAZHttpOperation):
...
class _ValidateDeleteEligibilityHelper:
    """Helper class for ValidateDeleteEligibility"""


__all__ = ["ValidateDeleteEligibility"]

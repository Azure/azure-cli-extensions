...
class Delete(AAZCommand):
    """Delete a billing profile. The operation is supported for billing accounts with agreement type Microsoft Customer Agreement and Microsoft Partner Agreement.

    :example: BillingProfilesDelete
        az billing profile delete --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingProfilesDelete(ctx=self.ctx)()
    ...
    class BillingProfilesDelete(AAZHttpOperation):

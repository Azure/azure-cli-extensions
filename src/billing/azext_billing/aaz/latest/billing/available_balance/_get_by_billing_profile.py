...
@register_command(
    "billing available-balance get-by-billing-profile",
)
class GetByBillingProfile(AAZCommand):
    """Get Available Credit or Payment on Account Balance for a billing profile. The credit balance can be used to settle due or past due invoices and is supported for billing accounts with agreement type Microsoft Customer Agreement. The payment on account balance is supported for billing accounts with agreement type Microsoft Customer Agreement.

    :example: AvailableBalanceGetByBillingProfile
        az billing available-balance get-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/availablebalance/default", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvailableBalancesGetByBillingProfile(ctx=self.ctx)()
    ...
    class AvailableBalancesGetByBillingProfile(AAZHttpOperation):

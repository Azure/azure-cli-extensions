...
@register_command(
    "billing savings-plan update-by-billing-account",
)
class UpdateByBillingAccount(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_sku_update(purchase_properties.sku)
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SavingsPlansUpdateByBillingAccount(ctx=self.ctx)()
    ...
    class SavingsPlansUpdateByBillingAccount(AAZHttpOperation):
        ...
        def content(self):
            ...
            _UpdateByBillingAccountHelper._build_schema_sku_update(_builder.set_prop("sku", AAZObjectType, ".sku"))
            _builder.set_prop("tags", AAZDictType, ".tags")

            properties = _builder.get(".properties")
            if properties is not None:
                _UpdateByBillingAccountHelper._build_schema_applied_scope_properties_update(properties.set_prop("appliedScopeProperties", AAZObjectType, ".applied_scope_properties"))
            ...
            if purchase_properties is not None:
                ...
                _UpdateByBillingAccountHelper._build_schema_sku_update(purchase_properties.set_prop("sku", AAZObjectType, ".sku"))
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateByBillingAccountHelper._build_schema_sku_read(_schema_on_200.sku)
            ...
            _UpdateByBillingAccountHelper._build_schema_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _UpdateByBillingAccountHelper._build_schema_commitment_read(properties.commitment)
            ...
            _UpdateByBillingAccountHelper._build_schema_sku_read(purchase_properties.sku)

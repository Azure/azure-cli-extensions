...
class ValidateUpdateByBillingAccount(AAZCommand):
    """Validate savings plan patch by billing account.

    :example: SavingsPlanValidateUpdate
        az billing savings-plan validate-update-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --savings-plan-order-id 20000000-0000-0000-0000-000000000000 --savings-plan-id 30000000-0000-0000-0000-000000000000 --benefits "[{applied-scope-type:Single,applied-scope-properties:{subscriptionId:/subscriptions/50000000-0000-0000-0000-000000000000}}]"
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/savingsplanorders/{}/savingsplans/{}/validate", "2024-04-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.benefits = AAZListArg(
            options=["--benefits"],
            arg_group="Body",
            help="The benefits of a savings plan.",
        )
        ...
        _element.renew_properties = AAZObjectArg(
            ...
            help="Properties specific to renew.",
        )
        ...
        purchase_properties.billing_plan = AAZStrArg(
            ...
            help="Represents the billing plan in ISO 8601 format. Required only for monthly purchases.",
            enum={"P1M": "P1M"},
        )
        purchase_properties.billing_scope_id = AAZStrArg(
            options=["billing-scope-id"],
            help="Subscription that will be charged for purchasing SavingsPlan",
        )
        ...
        purchase_properties.term = AAZStrArg(
            options=["term"],
            help="Represents the Savings plan term in ISO 8601 format.",
    ...
    def _build_args_applied_scope_properties_create(cls, _schema):
        ...
        applied_scope_properties_create.management_group_id = AAZStrArg(
            ...
            help="Fully-qualified identifier of the management group where the benefit is applied.",
        )
        applied_scope_properties_create.resource_group_id = AAZStrArg(
            options=["resource-group-id"],
            help="Fully-qualified identifier of the resource group where the benefit is applied.",
        )
        applied_scope_properties_create.subscription_id = AAZStrArg(
            options=["subscription-id"],
            help="Fully-qualified identifier of the subscription where the benefit is applied.",
        )
        applied_scope_properties_create.tenant_id = AAZStrArg(
            options=["tenant-id"],
            help="Tenant ID where the savings plan where the benefit is applied.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SavingsPlansValidateUpdateByBillingAccount(ctx=self.ctx)()
    ...
    class SavingsPlansValidateUpdateByBillingAccount(AAZHttpOperation):
        ...
        def content(self):
            ...
            if _elements is not None:
                _ValidateUpdateByBillingAccountHelper._build_schema_applied_scope_properties_create(_elements.set_prop("appliedScopeProperties", AAZObjectType, ".applied_scope_properties"))
            ...
            if properties is not None:
                _ValidateUpdateByBillingAccountHelper._build_schema_applied_scope_properties_create(properties.set_prop("appliedScopeProperties", AAZObjectType, ".applied_scope_properties"))
...
class _ValidateUpdateByBillingAccountHelper:
    """Helper class for ValidateUpdateByBillingAccount"""
...
__all__ = ["ValidateUpdateByBillingAccount"]

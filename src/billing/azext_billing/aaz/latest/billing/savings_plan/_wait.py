...
class Wait(AAZWaitCommand):
    ...
    class SavingsPlansGetByBillingAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_sku_read(_schema_on_200.sku)
            ...
            _WaitHelper._build_schema_commitment_read(properties.commitment)
            ...
            _WaitHelper._build_schema_sku_read(purchase_properties.sku)

...
@register_command(
    "billing savings-plan list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List savings plans by billing account.

    :example: SavingsPlansList
        az billing savings-plan list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --take 3 --selected-state Succeeded --refresh-summary true
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/savingsplans", "2024-04-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.take = AAZFloatArg(
            options=["--take"],
            help="The number of savings plans to return",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.SavingsPlansListByBillingAccount(ctx=self.ctx)()
    ...
    class SavingsPlansListByBillingAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingAccountHelper._build_schema_sku_read(_element.sku)
            ...
            _ListByBillingAccountHelper._build_schema_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _ListByBillingAccountHelper._build_schema_commitment_read(properties.commitment)
            ...
            _ListByBillingAccountHelper._build_schema_sku_read(purchase_properties.sku)

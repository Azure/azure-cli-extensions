...
@register_command(
    "billing savings-plan list-by-savings-plan-order",
)
class ListBySavingsPlanOrder(AAZCommand):
    """List savings plans in an order by billing account.

    :example: SavingsPlansInOrderList
        az billing savings-plan list-by-savings-plan-order --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --savings-plan-order-id 20000000-0000-0000-0000-000000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SavingsPlansListBySavingsPlanOrder(ctx=self.ctx)()
    ...
    class SavingsPlansListBySavingsPlanOrder(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListBySavingsPlanOrderHelper._build_schema_sku_read(_element.sku)
            ...
            _ListBySavingsPlanOrderHelper._build_schema_applied_scope_properties_read(properties.applied_scope_properties)
            ...
            _ListBySavingsPlanOrderHelper._build_schema_commitment_read(properties.commitment)
            ...
            _ListBySavingsPlanOrderHelper._build_schema_sku_read(purchase_properties.sku)
...
class _ListBySavingsPlanOrderHelper:
    """Helper class for ListBySavingsPlanOrder"""
...
__all__ = ["ListBySavingsPlanOrder"]

...
class Wait(AAZWaitCommand):
    ...
    class BillingSubscriptionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _WaitHelper._build_schema_amount_read(properties.month_to_date_charges)

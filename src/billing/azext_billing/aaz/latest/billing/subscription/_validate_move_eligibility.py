...
@register_command(
    "billing subscription validate-move-eligibility",
)
class ValidateMoveEligibility(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingsubscriptions/{}/validatemoveeligibility", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsValidateMoveEligibility(ctx=self.ctx)()
    ...
    class BillingSubscriptionsValidateMoveEligibility(AAZHttpOperation):

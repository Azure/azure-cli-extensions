...
@register_command(
    "billing subscription list-by-customer-at-billing-account",
)
class ListByCustomerAtBillingAccount(AAZCommand):
    """List the subscriptions for a customer at billing account level. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: BillingSubscriptionsListByCustomerAtBillingAccount
        az billing subscription list-by-customer-at-billing-account --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --customer-name Q7GV-UUVA-PJA-TGB
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/customers/{}/billingsubscriptions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsListByCustomerAtBillingAccount(ctx=self.ctx)()
    ...
    class BillingSubscriptionsListByCustomerAtBillingAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByCustomerAtBillingAccountHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _ListByCustomerAtBillingAccountHelper._build_schema_amount_read(properties.month_to_date_charges)

...
@register_command(
    "billing subscription list-by-customer",
)
class ListByCustomer(AAZCommand):
    """List the subscriptions for a customer. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: BillingSubscriptionsListByCustomer
        az billing subscription list-by-customer --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --billing-profile-name ea36e548-1505-41db-bebc-46fff3d37998 --customer-name Q7GV-UUVA-PJA-TGB
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/billingsubscriptions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsListByCustomer(ctx=self.ctx)()
    ...
    class BillingSubscriptionsListByCustomer(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByCustomerHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _ListByCustomerHelper._build_schema_amount_read(properties.month_to_date_charges)

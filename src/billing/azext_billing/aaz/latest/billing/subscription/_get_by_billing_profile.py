...
@register_command(
    "billing subscription get-by-billing-profile",
)
class GetByBillingProfile(AAZCommand):
    """Get a subscription by its billing profile and ID. The operation is supported for billing accounts with agreement type Enterprise Agreement.

    :example: BillingSubscriptionGetByBillingProfile
        az billing subscription get-by-billing-profile --billing-account-name pcn.94077792 --billing-profile-name 6478903 --billing-subscription-name 6b96d3f2-9008-4a9d-912f-f87744185aa3
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/billingsubscriptions/{}", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsGetByBillingProfile(ctx=self.ctx)()
    ...
    class BillingSubscriptionsGetByBillingProfile(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/billingSubscriptions/{billingSubscriptionName}",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            _GetByBillingProfileHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _GetByBillingProfileHelper._build_schema_amount_read(properties.month_to_date_charges)

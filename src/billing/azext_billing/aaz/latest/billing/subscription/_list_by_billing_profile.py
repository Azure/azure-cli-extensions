...
@register_command(
    "billing subscription list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the subscriptions that are billed to a billing profile. The operation is supported for billing accounts with agreement type Microsoft Customer Agreement or Microsoft Partner Agreement.

    :example: BillingSubscriptionsListByBillingProfileMCA
        az billing subscription list-by-billing-profile --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --billing-profile-name ea36e548-1505-41db-bebc-46fff3d37998
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsListByBillingProfile(ctx=self.ctx)()
    ...
    class BillingSubscriptionsListByBillingProfile(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingProfileHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _ListByBillingProfileHelper._build_schema_amount_read(properties.month_to_date_charges)

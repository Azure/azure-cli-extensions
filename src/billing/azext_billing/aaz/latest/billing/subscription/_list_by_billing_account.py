...
@register_command(
    "billing subscription list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List the subscriptions for a billing account.

    :example: BillingSubscriptionsListByBillingAccount
        az billing subscription list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --include-deleted False --include-tenant-subscriptions False
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.include_deleted = AAZBoolArg(
            ...
            help="Can be used to get deleted billing subscriptions.",
            default=False,
        )
        _args_schema.include_failed = AAZBoolArg(
            options=["--include-failed"],
            help="Can be used to get failed billing subscriptions.",
            default=False,
        )
        _args_schema.include_tenant_subscriptions = AAZBoolArg(
            options=["--include-tenant-subscriptions"],
            help="Can be used to get tenant-owned billing subscriptions. This field is only applies to Microsoft Online Services Program billing accounts.",
            default=False,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsListByBillingAccount(ctx=self.ctx)()
    ...
    class BillingSubscriptionsListByBillingAccount(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "includeFailed", self.ctx.args.include_failed,
                ),
                **self.serialize_query_param(
                    "includeTenantSubscriptions", self.ctx.args.include_tenant_subscriptions,
                ),
                **self.serialize_query_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingAccountHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _ListByBillingAccountHelper._build_schema_amount_read(properties.month_to_date_charges)

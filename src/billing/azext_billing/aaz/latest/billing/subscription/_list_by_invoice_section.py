...
@register_command(
    "billing subscription list-by-invoice-section",
)
class ListByInvoiceSection(AAZCommand):
    """List the subscriptions that are billed to an invoice section. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: BillingSubscriptionsListByInvoiceSection
        az billing subscription list-by-invoice-section --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --billing-profile-name ea36e548-1505-41db-bebc-46fff3d37998 --invoice-section-name Q7GV-UUVA-PJA-TGB
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/billingsubscriptions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingSubscriptionsListByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingSubscriptionsListByInvoiceSection(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByInvoiceSectionHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _ListByInvoiceSectionHelper._build_schema_amount_read(properties.month_to_date_charges)

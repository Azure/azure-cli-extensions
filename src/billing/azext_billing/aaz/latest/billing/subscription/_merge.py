...
@register_command(
    "billing subscription merge",
)
class Merge(AAZCommand):
    """Merges the billing subscription provided in the request with a target billing subscription.

    :example: BillingSubscriptionsMerge
        az billing subscription merge --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-subscription-name 11111111-1111-1111-1111-111111111111 --target-billing-subscription-name 22222222-2222-2222-2222-222222222222 --quantity 1
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingsubscriptions/{}/merge", "2024-04-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.quantity = AAZIntArg(
            ...
            help="The quantity of the source billing subscription that will be merged with the target billing subscription.",
        )
        _args_schema.target_billing_subscription_name = AAZStrArg(
            options=["--target-billing-subscription-name"],
            arg_group="Parameters",
            help="The ID of the target billing subscription that will be merged with the source subscription provided in the request.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingSubscriptionsMerge(ctx=self.ctx)()
    ...
    class BillingSubscriptionsMerge(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("targetBillingSubscriptionName", AAZStrType, ".target_billing_subscription_name")
        ...
        def _build_schema_on_200(cls):
            ...
            _MergeHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _MergeHelper._build_schema_amount_read(properties.month_to_date_charges)

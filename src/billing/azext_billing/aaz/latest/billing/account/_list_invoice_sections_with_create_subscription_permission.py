...
@register_command(
    "billing account list-invoice-sections-with-create-subscription-permission",
)
class ListInvoiceSectionsWithCreateSubscriptionPermission(AAZCommand):
    ...
    :example: InvoiceSectionsWithCreateSubscriptionPermissionList
        az billing account list-invoice-sections-with-create-subscription-permission --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/listinvoicesectionswithcreatesubscriptionpermission", "2024-04-01"],
        ]
    }
...
class _ListInvoiceSectionsWithCreateSubscriptionPermissionHelper:
    """Helper class for ListInvoiceSectionsWithCreateSubscriptionPermission"""


__all__ = ["ListInvoiceSectionsWithCreateSubscriptionPermission"]

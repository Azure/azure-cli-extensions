...
@register_command(
    "billing account cancel-payment-term",
)
class CancelPaymentTerm(AAZCommand):
    ...
    :example: PaymentTermsCancel
        az billing account cancel-payment-term --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --parameters 2023-01-05T22:39:34.2606750Z
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/cancelpaymentterms", "2024-04-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.parameters = AAZDateTimeArg(
            options=["--parameters"],
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingAccountsCancelPaymentTerms(ctx=self.ctx)()
    ...
    class BillingAccountsCancelPaymentTerms(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/cancelPaymentTerms",
                **self.url_parameters
            )
...
class _CancelPaymentTermHelper:
    """Helper class for CancelPaymentTerm"""


__all__ = ["CancelPaymentTerm"]

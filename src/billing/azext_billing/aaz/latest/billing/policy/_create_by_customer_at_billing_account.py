...
@register_command(
    "billing policy create-by-customer-at-billing-account",
)
class CreateByCustomerAtBillingAccount(AAZCommand):
    """Create the policies for a customer at billing account scope. This operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: PoliciesPutByCustomerAtBillingAccount
        az billing policy create-by-customer-at-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --customer-name 11111111-1111-1111-1111-111111111111 --view-charges Allowed
    """
...
class _CreateByCustomerAtBillingAccountHelper:
    """Helper class for CreateByCustomerAtBillingAccount"""


__all__ = ["CreateByCustomerAtBillingAccount"]

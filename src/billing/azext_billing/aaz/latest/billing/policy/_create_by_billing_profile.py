...
@register_command(
    "billing policy create-by-billing-profile",
)
class CreateByBillingProfile(AAZCommand):
    """Create the policies for a billing profile. This operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: PoliciesPutByBillingProfile
        az billing policy create-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-label-management Allowed --marketplace-purchases AllAllowed --reservation-purchases Allowed --savings-plan-purchases Allowed
    """

...
@register_command(
    "billing policy update-by-billing-profile",
)
class UpdateByBillingProfile(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.invoice_section_label_management = AAZStrArg(
            options=["--invoice-section-label-management"],
            arg_group="Properties",
            help="The policy that controls invoice section label management at invoice section scope. This is allowed by default.",
            nullable=True,
    ...
    def _execute_operations(self):
        ...
        yield self.PoliciesCreateOrUpdateByBillingProfile(ctx=self.ctx)()
    ...
    class PoliciesGetByBillingProfile(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateByBillingProfileHelper._build_schema_billing_profile_policy_read(cls._schema_on_200)

            return cls._schema_on_200

    class PoliciesCreateOrUpdateByBillingProfile(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateByBillingProfileHelper._build_schema_billing_profile_policy_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("invoiceSectionLabelManagement", AAZStrType, ".invoice_section_label_management")
                ...
                properties.set_prop("viewCharges", AAZStrType, ".view_charges")
...
class _UpdateByBillingProfileHelper:
    """Helper class for UpdateByBillingProfile"""

    _schema_billing_profile_policy_read = None

    @classmethod
    def _build_schema_billing_profile_policy_read(cls, _schema):
        if cls._schema_billing_profile_policy_read is not None:
            _schema.id = cls._schema_billing_profile_policy_read.id
            _schema.name = cls._schema_billing_profile_policy_read.name
            _schema.properties = cls._schema_billing_profile_policy_read.properties
            _schema.system_data = cls._schema_billing_profile_policy_read.system_data
            _schema.tags = cls._schema_billing_profile_policy_read.tags
            _schema.type = cls._schema_billing_profile_policy_read.type
            return

        cls._schema_billing_profile_policy_read = _schema_billing_profile_policy_read = AAZObjectType()

        billing_profile_policy_read = _schema_billing_profile_policy_read
        billing_profile_policy_read.id = AAZStrType(
            flags={"read_only": True},
        )
        billing_profile_policy_read.name = AAZStrType(
            flags={"read_only": True},
        )
        billing_profile_policy_read.properties = AAZObjectType()
        billing_profile_policy_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        billing_profile_policy_read.tags = AAZDictType()
        billing_profile_policy_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_billing_profile_policy_read.properties
        ...
        enterprise_agreement_policies = _schema_billing_profile_policy_read.properties.enterprise_agreement_policies
        ...
        policies = _schema_billing_profile_policy_read.properties.policies
        policies.Element = AAZObjectType()

        _element = _schema_billing_profile_policy_read.properties.policies.Element
        ...
        system_data = _schema_billing_profile_policy_read.system_data
        ...
        tags = _schema_billing_profile_policy_read.tags
...
__all__ = ["UpdateByBillingProfile"]

...
@register_command(
    "billing policy create-by-customer",
)
class CreateByCustomer(AAZCommand):
    """Create the policies for a customer. This operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: PoliciesPutByCustomer
        az billing policy create-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111 --view-charges Allowed
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/policies/default", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PoliciesCreateOrUpdateByCustomer(ctx=self.ctx)()
    ...
    class PoliciesCreateOrUpdateByCustomer(AAZHttpOperation):

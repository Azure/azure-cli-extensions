...
@register_command(
    "billing policy get-by-customer",
)
class GetByCustomer(AAZCommand):
    """Get the policies for a customer. This operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: PoliciesGetByCustomer
        az billing policy get-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111 --policy-name default
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/policies/{}", "2024-04-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.policy_name = AAZStrArg(
            options=["--policy-name"],
            help="Service-defined resource names such as 'default' which are reserved resource names.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PoliciesGetByCustomer(ctx=self.ctx)()
    ...
    class PoliciesGetByCustomer(AAZHttpOperation):

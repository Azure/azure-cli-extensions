...
@register_command(
    "billing payment-method get-by-billing-account",
)
class GetByBillingAccount(AAZCommand):
    """Get a payment method available for a billing account. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: PaymentMethodGetAtBillingProfile
        az billing payment-method get-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000032:00000000-0000-0000-0000-000000000099_2019-05-31 --payment-method-name 21dd9edc-af71-4d62-80ce-37151d475326
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PaymentMethodsGetByBillingAccount(ctx=self.ctx)()
    ...
    class PaymentMethodsGetByBillingAccount(AAZHttpOperation):

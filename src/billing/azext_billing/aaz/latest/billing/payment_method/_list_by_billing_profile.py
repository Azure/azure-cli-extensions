...
@register_command(
    "billing payment-method list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List payment methods attached to a billing profile. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: PaymentMethodsListByBillingProfile
        az billing payment-method list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000032:00000000-0000-0000-0000-000000000099_2019-05-31 --billing-profile-name ABC1-A1CD-AB1-BP1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PaymentMethodsListByBillingProfile(ctx=self.ctx)()
    ...
    class PaymentMethodsListByBillingProfile(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByBillingProfileHelper._build_schema_payment_method_logo_read(logos.Element)

            payment_method = cls._schema_on_200.value.Element.properties.payment_method
            ...
            logos = cls._schema_on_200.value.Element.properties.payment_method.logos
            logos.Element = AAZObjectType()
            _ListByBillingProfileHelper._build_schema_payment_method_logo_read(logos.Element)

...
class CheckAccessByDepartment(AAZCommand):
    """Provides a list of check access response objects for a department.

    :example: CheckAccessByDepartment
        az billing permission check-access-by-department --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --department-name 12345 --actions "[Microsoft.Billing/billingAccounts/read,Microsoft.Subscription/subscriptions/write]"
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/departments/{}/checkaccess", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsCheckAccessByDepartment(ctx=self.ctx)()
    ...
    class BillingPermissionsCheckAccessByDepartment(AAZHttpOperation):
...
class _CheckAccessByDepartmentHelper:
    """Helper class for CheckAccessByDepartment"""


__all__ = ["CheckAccessByDepartment"]

...
@register_command(
    "billing permission list-by-invoice-section",
)
class ListByInvoiceSection(AAZCommand):
    """List the billing permissions the caller has for an invoice section.

    :example: BillingPermissionsListByInvoiceSection
        az billing permission list-by-invoice-section --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name XXXX-XXXX-XXX-XXX
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/billingpermissions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsListByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingPermissionsListByInvoiceSection(AAZHttpOperation):

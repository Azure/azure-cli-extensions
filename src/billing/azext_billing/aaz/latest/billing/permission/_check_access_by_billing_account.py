...
class CheckAccessByBillingAccount(AAZCommand):
    """Provides a list of check access response objects for a billing account.

    :example: CheckAccessByBillingAccount
        az billing permission check-access-by-billing-account --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --actions "[Microsoft.Billing/billingAccounts/read,Microsoft.Subscription/subscriptions/write]"
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/checkaccess", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsCheckAccessByBillingAccount(ctx=self.ctx)()
    ...
    class BillingPermissionsCheckAccessByBillingAccount(AAZHttpOperation):
...
class _CheckAccessByBillingAccountHelper:
    """Helper class for CheckAccessByBillingAccount"""


__all__ = ["CheckAccessByBillingAccount"]

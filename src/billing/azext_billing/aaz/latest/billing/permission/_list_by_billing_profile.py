...
@register_command(
    "billing permission list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the billing permissions the caller has on a billing profile.

    :example: BillingPermissionsListByBillingProfile
        az billing permission list-by-billing-profile --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/billingpermissions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsListByBillingProfile(ctx=self.ctx)()
    ...
    class BillingPermissionsListByBillingProfile(AAZHttpOperation):

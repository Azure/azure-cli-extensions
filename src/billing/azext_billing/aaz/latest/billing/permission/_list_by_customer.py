...
@register_command(
    "billing permission list-by-customer",
)
class ListByCustomer(AAZCommand):
    """List the billing permissions the caller has for a customer.

    :example: BillingPermissionsListByCustomer
        az billing permission list-by-customer --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name BKM6-54VH-BG7-PGB --customer-name 11111111-1111-1111-1111-111111111111
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/billingpermissions", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsListByCustomer(ctx=self.ctx)()
    ...
    class BillingPermissionsListByCustomer(AAZHttpOperation):

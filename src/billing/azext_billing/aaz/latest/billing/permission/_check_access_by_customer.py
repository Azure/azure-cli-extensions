...
@register_command(
    "billing permission check-access-by-customer",
)
class CheckAccessByCustomer(AAZCommand):
    """Provides a list of check access response objects for a customer.

    :example: CheckAccessByCustomer
        az billing permission check-access-by-customer --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 703ab484-dda2-4402-827b-a74513b61e2d --actions "[Microsoft.Billing/billingAccounts/read,Microsoft.Subscription/subscriptions/write]"
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/checkaccess", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsCheckAccessByCustomer(ctx=self.ctx)()
    ...
    class BillingPermissionsCheckAccessByCustomer(AAZHttpOperation):
...
class _CheckAccessByCustomerHelper:
    """Helper class for CheckAccessByCustomer"""


__all__ = ["CheckAccessByCustomer"]

...
class ListByEnrollmentAccount(AAZCommand):
    ...
    :example: BillingPermissionsListByEnrollmentAccount
    ...
    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/enrollmentaccounts/{}/billingpermissions", "2024-04-01"],
        ]
    }

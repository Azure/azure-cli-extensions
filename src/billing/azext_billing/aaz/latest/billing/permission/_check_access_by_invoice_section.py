...
@register_command(
    "billing permission check-access-by-invoice-section",
)
class CheckAccessByInvoiceSection(AAZCommand):
    """Provides a list of check access response objects for an invoice section.

    :example: CheckAccessByInvoiceSection
        az billing permission check-access-by-invoice-section --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name Q7GV-UUVA-PJA-TGB --actions "[Microsoft.Billing/billingAccounts/read,Microsoft.Subscription/subscriptions/write]"
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/checkaccess", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingPermissionsCheckAccessByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingPermissionsCheckAccessByInvoiceSection(AAZHttpOperation):
...
class _CheckAccessByInvoiceSectionHelper:
    """Helper class for CheckAccessByInvoiceSection"""


__all__ = ["CheckAccessByInvoiceSection"]

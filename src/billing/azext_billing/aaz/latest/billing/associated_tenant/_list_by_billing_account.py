...
@register_command(
    "billing associated-tenant list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List the associated tenants that can collaborate with the billing account on commerce activities like viewing and downloading invoices, managing payments, making purchases, and managing or provisioning licenses.

    :example: AssociatedTenantsListByBillingAccount
        az billing associated-tenant list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.include_revoked = AAZBoolArg(
            options=["--include-revoked"],
            help="Can be used to get revoked associated tenants.",
            default=False,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AssociatedTenantsListByBillingAccount(ctx=self.ctx)()
    ...
    class AssociatedTenantsListByBillingAccount(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "includeRevoked", self.ctx.args.include_revoked,
                ),
                **self.serialize_query_param(

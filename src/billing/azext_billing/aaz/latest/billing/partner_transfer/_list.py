...
@register_command(
    "billing partner-transfer list",
)
class List(AAZCommand):
    """List the transfer requests sent to a customer. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: PartnerTransfersList
        az billing partner-transfer list --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PartnerTransfersList(ctx=self.ctx)()
    ...
    class PartnerTransfersList(AAZHttpOperation):

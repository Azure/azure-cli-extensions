...
@register_command(
    "billing partner-transfer initiate",
)
class Initiate(AAZCommand):
    """Create a request to a user in a customer's billing account to transfer billing ownership of their subscriptions. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: InitiatePartnerTransfer
        az billing partner-transfer initiate --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111 --transfer-name aabb123 --recipient-email-id user@contoso.com
    """

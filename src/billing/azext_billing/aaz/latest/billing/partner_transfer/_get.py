...
@register_command(
    "billing partner-transfer get",
)
class Get(AAZCommand):
    """Get a transfer request by ID. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: PartnerTransferGet
        az billing partner-transfer get --billing-account-name 10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 11111111-1111-1111-1111-111111111111 --transfer-name aabb123
    """

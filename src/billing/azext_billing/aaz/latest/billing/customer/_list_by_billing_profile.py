...
@register_command(
    "billing customer list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the customers that are billed to a billing profile. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: CustomersListByBillingProfile
        az billing customer list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomersListByBillingProfile(ctx=self.ctx)()
    ...
    class CustomersListByBillingProfile(AAZHttpOperation):

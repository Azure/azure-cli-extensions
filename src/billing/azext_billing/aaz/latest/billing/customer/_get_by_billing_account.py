...
@register_command(
    "billing customer get-by-billing-account",
)
class GetByBillingAccount(AAZCommand):
    """Get a customer by its ID at billing account level. The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: CustomersGetByBillingAccount
        az billing customer get-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --customer-name 11111111-1111-1111-1111-111111111111
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomersGetByBillingAccount(ctx=self.ctx)()
    ...
    class CustomersGetByBillingAccount(AAZHttpOperation):

...
@register_command(
    "billing product list-by-invoice-section",
)
class ListByInvoiceSection(AAZCommand):
    """List the products for an invoice section. These don't include products billed based on usage. The operation is supported only for billing accounts with agreement type Microsoft Customer Agreement.

    :example: ProductsListByInvoiceSection
        az billing product list-by-invoice-section --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --billing-profile-name ea36e548-1505-41db-bebc-46fff3d37998 --invoice-section-name Q7GV-UUVA-PJA-TGB
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/products", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProductsListByInvoiceSection(ctx=self.ctx)()
    ...
    class ProductsListByInvoiceSection(AAZHttpOperation):

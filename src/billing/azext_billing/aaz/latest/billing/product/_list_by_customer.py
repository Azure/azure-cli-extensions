...
@register_command(
    "billing product list-by-customer",
)
class ListByCustomer(AAZCommand):
    """List the products for a customer. These don't include products billed based on usage.The operation is supported only for billing accounts with agreement type Microsoft Partner Agreement.

    :example: ProductsListByCustomer
        az billing product list-by-customer --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --customer-name Q7GV-UUVA-PJA-TGB
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/customers/{}/products", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProductsListByCustomer(ctx=self.ctx)()
    ...
    class ProductsListByCustomer(AAZHttpOperation):

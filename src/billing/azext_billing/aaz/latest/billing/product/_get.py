...
class Get(AAZCommand):
    ...
    :example: ProductsGet
        az billing product get --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --product-name 11111111-1111-1111-1111-111111111111
    """
    ...
    class ProductsGet(AAZHttpOperation):

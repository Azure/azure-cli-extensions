...
@register_command(
    "billing product list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the products for a billing profile. These don't include products billed based on usage. The operation is supported for billing accounts with agreement type Microsoft Customer Agreement or Microsoft Partner Agreement.

    :example: ProductsListByBillingProfile
        az billing product list-by-billing-profile --billing-account-name a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31 --billing-profile-name ea36e548-1505-41db-bebc-46fff3d37998
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/products", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProductsListByBillingProfile(ctx=self.ctx)()
    ...
    class ProductsListByBillingProfile(AAZHttpOperation):

...
@register_command(
    "billing role-assignment get-by-enrollment-account",
)
class GetByEnrollmentAccount(AAZCommand):
    """Get a role assignment for the caller on a enrollment Account. The operation is supported only for billing accounts with agreement type Enterprise Agreement.

    :example: BillingRoleAssignmentGetByEnrollmentAccount
        az billing role-assignment get-by-enrollment-account --billing-account-name 7898901 --enrollment-account-name 225314 --billing-role-assignment-name 9dfd08c2-62a3-4d47-85bd-1cdba1408402
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsGetByEnrollmentAccount(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsGetByEnrollmentAccount(AAZHttpOperation):
...
class _GetByEnrollmentAccountHelper:
    """Helper class for GetByEnrollmentAccount"""


__all__ = ["GetByEnrollmentAccount"]

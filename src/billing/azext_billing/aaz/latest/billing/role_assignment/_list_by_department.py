...
@register_command(
    "billing role-assignment list-by-department",
)
class ListByDepartment(AAZCommand):
    """List the role assignments for the caller on a department. The operation is supported for billing accounts of type Enterprise Agreement.

    :example: BillingRoleAssignmentListByDepartment
        az billing role-assignment list-by-department --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --department-name 12345
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsListByDepartment(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsListByDepartment(AAZHttpOperation):

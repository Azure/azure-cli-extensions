...
@register_command(
    "billing role-assignment resolve-by-billing-profile",
)
class ResolveByBillingProfile(AAZCommand):
    ...
    :example: ResolveBillingRoleAssignmentByBillingProfile
        az billing role-assignment resolve-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/resolvebillingroleassignments", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsResolveByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsResolveByBillingProfile(AAZHttpOperation):
...
class _ResolveByBillingProfileHelper:
    """Helper class for ResolveByBillingProfile"""


__all__ = ["ResolveByBillingProfile"]

...
@register_command(
    "billing role-assignment resolve-by-invoice-section",
)
class ResolveByInvoiceSection(AAZCommand):
    ...
    :example: ResolveBillingRoleAssignmentByInvoiceSection
        az billing role-assignment resolve-by-invoice-section --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name BKM6-54VH-BG7-PGB --invoice-section-name xxxx-xxxx-xxx-xxx
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/resolvebillingroleassignments", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsResolveByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsResolveByInvoiceSection(AAZHttpOperation):
...
class _ResolveByInvoiceSectionHelper:
    """Helper class for ResolveByInvoiceSection"""


__all__ = ["ResolveByInvoiceSection"]

...
@register_command(
    "billing role-assignment create-by-customer",
)
class CreateByCustomer(AAZCommand):
    ...
    :example: BillingRoleAssignmentCreateByCustomer
        az billing role-assignment create-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name BKM6-54VH-BG7-PGB --customer-name 703ab484-dda2-4402-827b-a74513b61e2d --principal-id 00000000-0000-0000-0000-000000000000 --principal-tenant-id 076915e7-de10-4323-bb34-a58c904068bb --role-definition-id /providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30/billingProfileName/BKM6-54VH-BG7-PGB/customers/703ab484-dda2-4402-827b-a74513b61e2d/billingRoleDefinitions/30000000-aaaa-bbbb-cccc-100000000000 --user-email-address john@contoso.com
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/createbillingroleassignment", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsCreateByCustomer(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsCreateByCustomer(AAZHttpOperation):
...
class _CreateByCustomerHelper:
    """Helper class for CreateByCustomer"""


__all__ = ["CreateByCustomer"]

...
@register_command(
    "billing role-assignment create-by-billing-profile",
)
class CreateByBillingProfile(AAZCommand):
    ...
    :example: BillingRoleAssignmentCreateByBillingProfile
        az billing role-assignment create-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name BKM6-54VH-BG7-PGB --principal-id 00000000-0000-0000-0000-000000000000 --principal-tenant-id 076915e7-de10-4323-bb34-a58c904068bb --role-definition-id /providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30/billingProfiles/BKM6-54VH-BG7-PGB/billingRoleDefinitions/10000000-aaaa-bbbb-cccc-100000000000 --user-email-address john@contoso.com
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/createbillingroleassignment", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsCreateByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsCreateByBillingProfile(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("principalId", AAZStrType, ".principal_id")
            _builder.set_prop("principalPuid", AAZStrType, ".principal_puid")
            _builder.set_prop("principalTenantId", AAZStrType, ".principal_tenant_id")
            _builder.set_prop("roleDefinitionId", AAZStrType, ".role_definition_id", typ_kwargs={"flags": {"required": True}})
            _builder.set_prop("scope", AAZStrType, ".scope")
            _builder.set_prop("userAuthenticationType", AAZStrType, ".user_authentication_type")
            _builder.set_prop("userEmailAddress", AAZStrType, ".user_email_address")
...
class _CreateByBillingProfileHelper:
    """Helper class for CreateByBillingProfile"""


__all__ = ["CreateByBillingProfile"]

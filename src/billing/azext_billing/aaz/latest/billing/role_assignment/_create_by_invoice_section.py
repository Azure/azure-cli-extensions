...
@register_command(
    "billing role-assignment create-by-invoice-section",
)
class CreateByInvoiceSection(AAZCommand):
    ...
    :example: BillingRoleAssignmentCreateByInvoiceSection
        az billing role-assignment create-by-invoice-section --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name BKM6-54VH-BG7-PGB --invoice-section-name xxxx-xxxx-xxx-xxx --principal-id 00000000-0000-0000-0000-000000000000 --principal-tenant-id 076915e7-de10-4323-bb34-a58c904068bb --role-definition-id /providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30/billingProfiles/BKM6-54VH-BG7-PGB/invoiceSections/xxxx-xxxx-xxx-xxx/billingRoleDefinitions/10000000-aaaa-bbbb-cccc-100000000000 --user-email-address john@contoso.com
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/createbillingroleassignment", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsCreateByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsCreateByInvoiceSection(AAZHttpOperation):
...
class _CreateByInvoiceSectionHelper:
    """Helper class for CreateByInvoiceSection"""


__all__ = ["CreateByInvoiceSection"]

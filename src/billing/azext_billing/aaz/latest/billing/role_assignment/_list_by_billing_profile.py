...
@register_command(
    "billing role-assignment list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    """List the role assignments for the caller on a billing profile. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement or Microsoft Customer Agreement.

    :example: BillingRoleAssignmentListByBillingProfile
        az billing role-assignment list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name xxxx-xxxx-xxx-xxx
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsListByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsListByBillingProfile(AAZHttpOperation):

...
@register_command(
    "billing role-assignment list-by-billing-account",
)
class ListByBillingAccount(AAZCommand):
    """List the role assignments for the caller on a billing account. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement, Microsoft Customer Agreement or Enterprise Agreement.

    :example: BillingRoleAssignmentListByBillingAccount
        az billing role-assignment list-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsListByBillingAccount(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsListByBillingAccount(AAZHttpOperation):

...
@register_command(
    "billing role-assignment list-by-enrollment-account",
)
class ListByEnrollmentAccount(AAZCommand):
    """List the role assignments for the caller on a enrollment account. The operation is supported for billing accounts of type Enterprise Agreement.

    :example: BillingRoleAssignmentListByEnrollmentAccount
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsListByEnrollmentAccount(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsListByEnrollmentAccount(AAZHttpOperation):

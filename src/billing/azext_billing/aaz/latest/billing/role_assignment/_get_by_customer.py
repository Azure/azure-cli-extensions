...
@register_command(
    "billing role-assignment get-by-customer",
)
class GetByCustomer(AAZCommand):
    """Get a role assignment for the caller on a customer. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement.

    :example: BillingRoleAssignmentGetByCustomer
        az billing role-assignment get-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 703ab484-dda2-4402-827b-a74513b61e2d --billing-role-assignment-name 30000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsGetByCustomer(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsGetByCustomer(AAZHttpOperation):
...
class _GetByCustomerHelper:
    """Helper class for GetByCustomer"""


__all__ = ["GetByCustomer"]

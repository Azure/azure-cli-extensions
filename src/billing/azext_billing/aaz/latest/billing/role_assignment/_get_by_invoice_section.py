...
@register_command(
    "billing role-assignment get-by-invoice-section",
)
class GetByInvoiceSection(AAZCommand):
    """Get a role assignment for the caller on an invoice section. The operation is supported for billing accounts with agreement type Microsoft Customer Agreement.

    :example: BillingRoleAssignmentGetByInvoiceSection
        az billing role-assignment get-by-invoice-section --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name BKM6-54VH-BG7-PGB --invoice-section-name xxxx-xxxx-xxx-xxx --billing-role-assignment-name 10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsGetByInvoiceSection(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsGetByInvoiceSection(AAZHttpOperation):
...
class _GetByInvoiceSectionHelper:
    """Helper class for GetByInvoiceSection"""


__all__ = ["GetByInvoiceSection"]

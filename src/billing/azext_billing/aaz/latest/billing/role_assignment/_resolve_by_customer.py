...
@register_command(
    "billing role-assignment resolve-by-customer",
)
class ResolveByCustomer(AAZCommand):
    ...
    :example: ResolveBillingRoleAssignmentByCustomer
        az billing role-assignment resolve-by-customer --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name xxxx-xxxx-xxx-xxx --customer-name 703ab484-dda2-4402-827b-a74513b61e2d
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/customers/{}/resolvebillingroleassignments", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsResolveByCustomer(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsResolveByCustomer(AAZHttpOperation):
...
class _ResolveByCustomerHelper:
    """Helper class for ResolveByCustomer"""


__all__ = ["ResolveByCustomer"]

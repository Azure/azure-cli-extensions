...
@register_command(
    "billing role-assignment create-by-billing-account",
)
class CreateByBillingAccount(AAZCommand):
    ...
    :example: BillingRoleAssignmentCreateByBillingAccount
        az billing role-assignment create-by-billing-account --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --principal-id 00000000-0000-0000-0000-000000000000 --principal-tenant-id 076915e7-de10-4323-bb34-a58c904068bb --role-definition-id /providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30/billingRoleDefinitions/10000000-aaaa-bbbb-cccc-100000000000 --user-email-address john@contoso.com
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/createbillingroleassignment", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsCreateByBillingAccount(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsCreateByBillingAccount(AAZHttpOperation):
...
class _CreateByBillingAccountHelper:
    """Helper class for CreateByBillingAccount"""


__all__ = ["CreateByBillingAccount"]

...
@register_command(
    "billing role-assignment create-by-department",
)
class CreateByDepartment(AAZCommand):
    ...
    :example: BillingRoleAssignmentCreateOrUpdateByDepartment
        az billing role-assignment create-by-department --billing-account-name 7898901 --department-name 12345 --billing-role-assignment-name 9dfd08c2-62a3-4d47-85bd-1cdba1408402 --principal-id 00000000-0000-0000-0000-000000000000 --principal-tenant-id 076915e7-de10-4323-bb34-a58c904068bb --role-definition-id /providers/Microsoft.Billing/billingAccounts/7898901/departments/12345/billingRoleDefinitions/9f1983cb-2574-400c-87e9-34cf8e2280db --user-email-address john@contoso.com
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BillingRoleAssignmentsCreateOrUpdateByDepartment(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsCreateOrUpdateByDepartment(AAZHttpOperation):
...
class _CreateByDepartmentHelper:
    """Helper class for CreateByDepartment"""


__all__ = ["CreateByDepartment"]

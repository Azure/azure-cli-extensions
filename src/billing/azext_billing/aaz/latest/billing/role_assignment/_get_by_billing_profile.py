...
@register_command(
    "billing role-assignment get-by-billing-profile",
)
class GetByBillingProfile(AAZCommand):
    """Get a role assignment for the caller on a billing profile. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement or Microsoft Customer Agreement.

    :example: BillingRoleAssignmentGetByBillingProfile
        az billing role-assignment get-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2018-09-30 --billing-profile-name xxxx-xxxx-xxx-xxx --billing-role-assignment-name 10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BillingRoleAssignmentsGetByBillingProfile(ctx=self.ctx)()
    ...
    class BillingRoleAssignmentsGetByBillingProfile(AAZHttpOperation):

...
@register_command(
    "billing billing-subscription-aliases create",
)
class Create(AAZCommand):
    """Create a billing subscription by its alias ID.  The operation is supported for seat based billing subscriptions.

    :example: BillingSubscriptionAliasCreateOrUpdate
        az billing billing-subscription-aliases create --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --alias-name c356b7c7-7545-4686-b843-c1a49cf853fc --billing-frequency P1M --display-name Subscription 3 --quantity 1 --sku-id 0001 --term-duration P1M
    """
    ...
    class BillingSubscriptionsAliasesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_amount_read(properties.last_month_charges)
            properties.month_to_date_charges = AAZObjectType(
                serialized_name="monthToDateCharges",
                flags={"read_only": True},
            )
            _CreateHelper._build_schema_amount_read(properties.month_to_date_charges)
            ...
            beneficiary = cls._schema_on_200_201.properties.beneficiary
            ...
            billing_policies = cls._schema_on_200_201.properties.billing_policies
            billing_policies.Element = AAZStrType()

            enrollment_account_subscription_details = cls._schema_on_200_201.properties.enrollment_account_subscription_details
            ...
            next_billing_cycle_details = cls._schema_on_200_201.properties.next_billing_cycle_details
            next_billing_cycle_details.billing_frequency = AAZStrType(
                serialized_name="billingFrequency",
                flags={"read_only": True},
            )

            renewal_term_details = cls._schema_on_200_201.properties.renewal_term_details
            ...
            reseller = cls._schema_on_200_201.properties.reseller
            ...
            suspension_reason_details = cls._schema_on_200_201.properties.suspension_reason_details
            suspension_reason_details.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.suspension_reason_details.Element
            ...
            suspension_reasons = cls._schema_on_200_201.properties.suspension_reasons
            suspension_reasons.Element = AAZStrType()

            system_overrides = cls._schema_on_200_201.properties.system_overrides

...
@register_command(
    "billing billing-subscription-aliases get",
)
class Get(AAZCommand):
    """Get a subscription by its alias ID.  The operation is supported for seat based billing subscriptions.

    :example: BillingSubscriptionAliasGet
        az billing billing-subscription-aliases get --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --alias-name c356b7c7-7545-4686-b843-c1a49cf853fc
    """

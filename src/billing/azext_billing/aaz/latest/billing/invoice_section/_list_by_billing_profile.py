...
@register_command(
    "billing invoice-section list-by-billing-profile",
)
class ListByBillingProfile(AAZCommand):
    ...
    :example: InvoiceSectionsListByBillingProfile
        az billing invoice-section list-by-billing-profile --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --include-deleted True
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.include_deleted = AAZBoolArg(
            ...
            help="Can be used to get deleted invoice sections.",
            default=False,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.InvoiceSectionsListByBillingProfile(ctx=self.ctx)()
    ...
    class InvoiceSectionsListByBillingProfile(AAZHttpOperation):

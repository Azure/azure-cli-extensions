...
@register_command(
    "billing invoice-section validate-delete-eligibility",
)
class ValidateDeleteEligibility(AAZCommand):
    ...
    :example: InvoiceSectionsValidateDeleteEligibilitySuccess
        az billing invoice-section validate-delete-eligibility --billing-account-name 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31 --billing-profile-name xxxx-xxxx-xxx-xxx --invoice-section-name yyyy-yyyy-yyy-yyy
    """

    _aaz_info = {
        "version": "2024-04-01",
        "resources": [
            ["mgmt-plane", "/providers/microsoft.billing/billingaccounts/{}/billingprofiles/{}/invoicesections/{}/validatedeleteeligibility", "2024-04-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.InvoiceSectionsValidateDeleteEligibility(ctx=self.ctx)()
    ...
    class InvoiceSectionsValidateDeleteEligibility(AAZHttpOperation):

...
def cf_instruction(cli_ctx, *_):
    return cf_billing_cl(cli_ctx).instruction
...
def cf_permission(cli_ctx, *_):
    return cf_billing_cl(cli_ctx).billing_permission
...
def cf_role_definition(cli_ctx, *_):
    return cf_billing_cl(cli_ctx).billing_role_definition


def cf_role_assignment(cli_ctx, *_):
    return cf_billing_cl(cli_ctx).billing_role_assignment


def cf_agreement(cli_ctx, *_):
    return cf_billing_cl(cli_ctx).agreement

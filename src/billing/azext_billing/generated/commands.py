...
def load_command_table(self, _):
    ...
    from azext_billing.generated._client_factory import cf_account
    billing_account = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_account_operations#BillingAccountOpera'
        'tions.{}',
    ...
    from azext_billing.generated._client_factory import cf_balance
    billing_balance = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._available_balance_operations#AvailableBalanceO'
        'perations.{}',
    ...
    billing_instruction = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._instruction_operations#InstructionOperations.{'
        '}',
    ...
    from azext_billing.generated._client_factory import cf_profile
    billing_profile = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_profile_operations#BillingProfileOpera'
        'tions.{}',
    ...
    billing_customer = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._customer_operations#CustomerOperations.{}',
    ...
    billing_invoice_section = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._invoice_section_operations#InvoiceSectionOpera'
        'tions.{}',
    ...
    from azext_billing.generated._client_factory import cf_permission
    billing_permission = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_permission_operations#BillingPermissio'
        'nOperations.{}',
    ...
    from azext_billing.generated._client_factory import cf_subscription
    billing_subscription = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_subscription_operations#BillingSubscri'
        'ptionOperations.{}',
    ...
    billing_product = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._product_operations#ProductOperations.{}',
    ...
    billing_invoice = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._invoice_operations#InvoiceOperations.{}',
    ...
    billing_transaction = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._transaction_operations#TransactionOperations.{'
        '}',
    ...
    billing_policy = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._policy_operations#PolicyOperations.{}',
    ...
    from azext_billing.generated._client_factory import cf_property
    ...
    from azext_billing.generated._client_factory import cf_role_definition
    billing_role_definition = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_role_definition_operations#BillingRole'
    ...
    from azext_billing.generated._client_factory import cf_role_assignment
    billing_role_assignment = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._billing_role_assignment_operations#BillingRole'
    ...
    billing_agreement = CliCommandType(
        operations_tmpl='azext_billing.vendored_sdks.billing.operations._agreement_operations#AgreementOperations.{}',

...
1.20.2
---
* Command `az spring create` and `az spring update` include a new argument "--enable-private-storage-access" to set whether private network access to underlying storage in vnet injection instance.

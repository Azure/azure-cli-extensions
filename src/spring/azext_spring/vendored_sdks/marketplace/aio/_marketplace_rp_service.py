...
class MarketplaceRPService(MultiApiClientMixin, _SDKClient):
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        self._config = MarketplaceRPServiceConfiguration(credential, market, include_stop_sold_plans, **kwargs)
    ...
    def offer(self):
        """Instance depends on the API version:
           ...
           * 2018-08-01-beta: :class:`OfferOperations<azure.mgmt.marketplace.v2018_08_01_beta.aio.operations.OfferOperations>`
        """
        api_version = self._get_api_version('offer')
        if api_version == '2018-08-01-beta':
            from ..v2018_08_01_beta.aio.operations import OfferOperations as OperationClass
        else:

...
class IncludedQuantityProperty(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.term_id = kwargs.get('term_id', None)
...
class Meter(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.included_quantity_properties = kwargs.get('included_quantity_properties', None)
...
class Price(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.list_price = kwargs.get('list_price', None)

...
class AppsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.v2022_05_01_preview.models.AppResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.AppResource]
    ...
    async def begin_set_active_deployments(
        ...
        **kwargs: Any
        ...
        :type active_deployment_collection:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.ActiveDeploymentCollection or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.AppResource]
    ...
    async def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.CustomDomainValidatePayload or IO[bytes]
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
class CertificatesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_resource:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.CertificateResource or IO[bytes]
        :return: An instance of LROPoller that returns either CertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.CertificateResource]
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_05_01_preview.models.CertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

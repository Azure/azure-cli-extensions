...
class EurekaServersOperations:
    ...
    async def list(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResourceCollection
    ...
    async def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.EurekaServerResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type eureka_server_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResource
        ...
        :return: An instance of AsyncLROPoller that returns either EurekaServerResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type eureka_server_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either EurekaServerResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.EurekaServerResource]

...
class ContainerRegistriesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ContainerRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(container_registry_resource, (IO, bytes)):
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryResource or IO
    ...
    async def _validate_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(container_registry_properties, (IO, bytes)):
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.ContainerRegistryProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response

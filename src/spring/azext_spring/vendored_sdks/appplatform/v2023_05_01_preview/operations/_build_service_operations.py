...
class BuildServiceOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type build_service: ~azure.mgmt.appplatform.v2023_05_01_preview.models.BuildService or
         IO[bytes]
        :return: An instance of LROPoller that returns either BuildService or the result of
         cls(response)
        :rtype:
    ...
    def create_or_update_build(
        ...
        **kwargs: Any
        ...
        :param build: Parameters for the create or update operation. Is either a Build type or a
         IO[bytes] type. Required.
        :type build: ~azure.mgmt.appplatform.v2023_05_01_preview.models.Build or IO[bytes]
        :return: Build or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.Build
        :raises ~azure.core.exceptions.HttpResponseError:
        """

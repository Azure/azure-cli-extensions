...
class ServicesOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ServiceResource or IO[bytes]
        :return: An instance of LROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ServiceResource]
    ...
    def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.RegenerateTestKeyRequestPayload or IO[bytes]
        :return: TestKeys or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_enable_apm_globally(
        ...
        :param apm: The target APM for the enable operation. Is either a ApmReference type or a
         IO[bytes] type. Required.
        :type apm: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ApmReference or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.NameAvailabilityParameters or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_supported_server_versions(
        ...
        :return: An iterator like instance of either SupportedServerVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_09_01_preview.models.SupportedServerVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

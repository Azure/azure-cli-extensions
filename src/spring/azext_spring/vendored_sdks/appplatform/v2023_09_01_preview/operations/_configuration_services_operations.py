...
def build_get_request(
    resource_group_name: str, service_name: str, configuration_service_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "configurationServiceName": _SERIALIZER.url(
            "configuration_service_name", configuration_service_name, "str", pattern=r"^[a-z][a-z0-9]*$"
        ),
    }
...
def build_validate_resource_request(
    resource_group_name: str, service_name: str, configuration_service_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfigurationServicesOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ConfigurationServiceResource]:
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource or IO[bytes]
        :return: An instance of LROPoller that returns either ConfigurationServiceResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource]
        ...
        if cont_token:
            return LROPoller[_models.ConfigurationServiceResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ConfigurationServiceResource](
    ...
    def list(
    ...
    ) -> Iterable["_models.ConfigurationServiceResource"]:
        ...
        :return: An iterator like instance of either ConfigurationServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_validate(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ConfigurationServiceSettingsValidateResult]:
        ...
        :type settings: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceSettings
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigurationServiceSettingsValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ConfigurationServiceSettingsValidateResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ConfigurationServiceSettingsValidateResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    def _validate_resource_initial(
        self,
        resource_group_name: str,
        service_name: str,
        configuration_service_name: str,
    ...
    def begin_validate_resource(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._validate_resource_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                configuration_service_name=configuration_service_name,
                configuration_service_resource=configuration_service_resource,

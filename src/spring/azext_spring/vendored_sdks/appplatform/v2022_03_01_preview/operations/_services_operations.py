...
class ServicesOperations:
    ...
    def begin_create_or_update(
        ...
        :param resource: Parameters for the create or update operation. Is either a model type or a IO
         type. Required.
        :type resource: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ServiceResource or IO
    ...
    def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :param regenerate_test_key_request: Parameters for the operation. Is either a model type or a
         IO type. Required.
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.RegenerateTestKeyRequestPayload or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def check_name_availability(
        ...
        :param availability_parameters: Parameters supplied to the operation. Is either a model type or
         a IO type. Required.
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.NameAvailabilityParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_03_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

...
class BuildServiceAgentPoolOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BuildServiceAgentPoolResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildServiceAgentPoolResource]
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :param agent_pool_resource: Parameters for the update operation. Is either a model type or a IO
         type. Required.
        :type agent_pool_resource:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuildServiceAgentPoolResource or IO

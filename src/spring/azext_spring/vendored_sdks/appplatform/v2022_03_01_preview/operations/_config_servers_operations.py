...
class ConfigServersOperations:
    ...
    def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.ConfigServerResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerResource
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type config_server_resource:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerResource
        ...
        :return: An instance of LROPoller that returns either ConfigServerResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :param config_server_resource: Parameters for the update operation. Is either a model type or a
         IO type. Required.
        :type config_server_resource:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerResource or IO
        ...
        if cont_token is None:
            raw_result = self._update_put_initial(  # type: ignore
                resource_group_name=resource_group_name,
                service_name=service_name,
    ...
    def begin_update_patch(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_patch_initial(  # type: ignore
                resource_group_name=resource_group_name,
                service_name=service_name,
                config_server_resource=config_server_resource,
                api_version=api_version,
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerSettingsValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :type config_server_settings:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.ConfigServerSettings or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response

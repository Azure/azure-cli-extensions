...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "predefinedAcceleratorName": _SERIALIZER.url(
            "predefined_accelerator_name", predefined_accelerator_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"
        ),
    }
...
class PredefinedAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either PredefinedAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.PredefinedAcceleratorResource]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.PredefinedAcceleratorResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,

...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"),
        "devToolPortalName": _SERIALIZER.url(
            "dev_tool_portal_name", dev_tool_portal_name, "str", pattern=r"^[a-z][a-z0-9]*$"
        ),
    }
...
class DevToolPortalsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type dev_tool_portal_resource:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource
        ...
        :return: An instance of LROPoller that returns either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type dev_tool_portal_resource:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource or IO[bytes]
        :return: An instance of LROPoller that returns either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.DevToolPortalResource]

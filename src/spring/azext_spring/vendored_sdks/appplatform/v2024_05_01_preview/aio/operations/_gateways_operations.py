...
class GatewaysOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.GatewayResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.GatewayResource
        ...
        :return: An instance of AsyncLROPoller that returns either GatewayResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.GatewayResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.GatewayResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GatewayResource or the result of
         cls(response)
        :rtype:
    ...
    async def begin_update_capacity(
        ...
        **kwargs: Any
        ...
        :type gateway_capacity_resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.SkuObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either GatewayResource or the result of
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.GatewayResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type deployment_resource:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource
        ...
        :return: An instance of LROPoller that returns either DeploymentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type deployment_resource:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource or IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.DeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_enable_remote_debugging(
        ...
        **kwargs: Any
        ...
        :type remote_debugging_payload:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.RemoteDebuggingPayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either RemoteDebugging or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.RemoteDebugging]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_enable_remote_debugging(
        ...
        **kwargs: Any
        ...
        :type remote_debugging_payload:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.RemoteDebuggingPayload or IO[bytes]
        :return: An instance of LROPoller that returns either RemoteDebugging or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.RemoteDebugging]
    ...
    def get_remote_debugging_config(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.RemoteDebugging
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_log_file_url(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.LogFileUrlResponse or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_generate_heap_dump(
        ...
        **kwargs: Any
        ...
        :type diagnostic_parameters:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.DiagnosticParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
    ...
    def begin_generate_heap_dump(
        ...
        **kwargs: Any
        ...
        :type diagnostic_parameters:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.DiagnosticParameters or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

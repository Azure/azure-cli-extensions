...
class ServiceRegistriesOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceRegistryResource
    ...
    def begin_create_or_update(
        ...
        :return: An instance of LROPoller that returns either ServiceRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        :return: An iterator like instance of either ServiceRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

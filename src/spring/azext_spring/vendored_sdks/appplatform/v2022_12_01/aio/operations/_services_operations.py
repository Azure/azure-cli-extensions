...
class ServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        :type resource: ~azure.mgmt.appplatform.v2022_12_01.models.ServiceResource or IO
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2022_12_01.models.RegenerateTestKeyRequestPayload or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def check_name_availability(
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2022_12_01.models.NameAvailabilityParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response

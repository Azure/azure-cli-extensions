...
class ConfigurationServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.v2022_04_01.models.ConfigurationServiceResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConfigurationServiceResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_04_01.models.ConfigurationServiceResource]
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type settings: ~azure.mgmt.appplatform.v2022_04_01.models.ConfigurationServiceSettings or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either
         ConfigurationServiceSettingsValidateResult or the result of cls(response)
        :rtype:

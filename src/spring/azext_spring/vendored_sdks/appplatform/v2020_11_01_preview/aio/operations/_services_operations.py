...
class ServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2020_11_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param service_name: The name of the Service resource. Required.
        :type service_name: str
        :param resource: Parameters for the create or update operation. Is either a model type or a IO
         type. Required.
        :type resource: ~azure.mgmt.appplatform.v2020_11_01_preview.models.ServiceResource or IO
    ...
    async def begin_update(
        ...
        :param service_name: The name of the Service resource. Required.
        :type service_name: str
        :param resource: Parameters for the update operation. Is either a model type or a IO type.
         Required.
        :type resource: ~azure.mgmt.appplatform.v2020_11_01_preview.models.ServiceResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2020_11_01_preview.models.RegenerateTestKeyRequestPayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the Service resource. Required.
        :type service_name: str
        :param regenerate_test_key_request: Parameters for the operation. Is either a model type or a
         IO type. Required.
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2020_11_01_preview.models.RegenerateTestKeyRequestPayload or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2020_11_01_preview.models.NameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def check_name_availability(
        ...
        :param location: the region. Required.
        :type location: str
        :param availability_parameters: Parameters supplied to the operation. Is either a model type or
         a IO type. Required.
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2020_11_01_preview.models.NameAvailabilityParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2020_11_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

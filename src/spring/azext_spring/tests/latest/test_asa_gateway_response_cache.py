...
class GatewayResponseCacheTest(ScenarioTest):
    def test_response_cache(self):
        ...
        self.cmd('spring gateway update -g {rg} -s {serviceName} --enable-response-cache --response-cache-scope Route', checks=[
        ...
        self.cmd('spring gateway update -g {rg} -s {serviceName} --enable-response-cache --response-cache-ttl 10s', checks=[
                 self.check('properties.responseCacheProperties.responseCacheType', 'LocalCachePerRoute'),
                 self.check('properties.responseCacheProperties.size', None),
        ...
        self.cmd('spring gateway update -g {rg} -s {serviceName} --response-cache-size 10KB --response-cache-scope Instance', checks=[

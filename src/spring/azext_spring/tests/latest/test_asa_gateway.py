...
class GatewayTest(ScenarioTest):
    ...
    def test_gateway(self):
        ...
        self.cmd('spring gateway update -g {rg} -s {serviceName} '
            ...
            self.check('properties.certificates', ["/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/tx/providers/Microsoft.AppPlatform/Spring/tx-enterprise/certificates/abc"]),
            self.check('properties.certificateVerification', "Disabled"),

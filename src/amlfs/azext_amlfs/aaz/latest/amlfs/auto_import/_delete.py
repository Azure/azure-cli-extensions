...
@register_command(
    "amlfs auto-import delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete an auto import job for deletion.

    :example: autoImportJobs_Delete
        az amlfs auto-import delete --resource-group scgroup --aml-filesystem-name fs1 --auto-import-job-name autojob1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AutoImportJobsDelete(ctx=self.ctx)()
    ...
    class AutoImportJobsDelete(AAZHttpOperation):

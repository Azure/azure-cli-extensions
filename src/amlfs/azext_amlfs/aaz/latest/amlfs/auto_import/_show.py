...
@register_command(
    "amlfs auto-import show",
)
class Show(AAZCommand):
    """Get an auto import job.

    :example: autoImportJobs_Get
        az amlfs auto-import show --resource-group scgroup --aml-filesystem-name fs1 --auto-import-job-name autojob1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AutoImportJobsGet(ctx=self.ctx)()
    ...
    class AutoImportJobsGet(AAZHttpOperation):

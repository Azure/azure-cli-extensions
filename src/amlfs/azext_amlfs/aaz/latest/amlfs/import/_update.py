...
class Update(AAZCommand):
    ...
    :example: importJobs_CreateOrUpdate
        az amlfs import update --resource-group scgroup --aml-filesystem-name fs1 --import-job-name job1 --admin-status Cancel
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.admin_status = AAZStrArg(
            ...
            help="The administrative status of the import job. Possible values: 'Active', 'Cancel'. Passing in a value of 'Cancel' will cancel the current active import job.",
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ImportJobsUpdate(ctx=self.ctx)()
    ...
    class ImportJobsUpdate(AAZHttpOperation):

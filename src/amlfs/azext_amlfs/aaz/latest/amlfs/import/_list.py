...
class List(AAZCommand):
    ...
    :example: importJobs_ListByAmlFilesystem
        az amlfs import list --resource-group scgroup --aml-filesystem-name fs1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ImportJobsListByAmlFilesystem(ctx=self.ctx)()
    ...
    class ImportJobsListByAmlFilesystem(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            import_prefixes = cls._schema_on_200.value.Element.properties.import_prefixes

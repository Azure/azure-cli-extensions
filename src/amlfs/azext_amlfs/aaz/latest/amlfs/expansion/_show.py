...
@register_command(
    "amlfs expansion show",
)
class Show(AAZCommand):
    """Get an expansion job.

    :example: expansionJobs_Get
        az amlfs expansion show --resource-group scgroup --aml-filesystem-name fs1 --expansion-job-name expansionjob1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExpansionJobsGet(ctx=self.ctx)()
    ...
    class ExpansionJobsGet(AAZHttpOperation):

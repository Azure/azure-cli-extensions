...
class Update(AAZCommand):
    ...
    :example: expansionJobs_Update
        az amlfs expansion update --resource-group scgroup --aml-filesystem-name fs1 --expansion-job-name expansionjob1 --tags "{Dept:ContosoFinance}"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpansionJobsUpdate(ctx=self.ctx)()
    ...
    class ExpansionJobsUpdate(AAZHttpOperation):

...
@register_command(
    "amlfs expansion delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete an expansion job.

    :example: expansionJobs_Delete
        az amlfs expansion delete --resource-group scgroup --aml-filesystem-name fs1 --expansion-job-name expansionjob1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpansionJobsDelete(ctx=self.ctx)()
    ...
    class ExpansionJobsDelete(AAZHttpOperation):

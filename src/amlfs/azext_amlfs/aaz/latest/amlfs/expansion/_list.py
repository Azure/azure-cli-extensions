...
@register_command(
    "amlfs expansion list",
)
class List(AAZCommand):
    """List all the expansion jobs the user has access to under an AML File System.

    :example: expansionJobs_ListByAmlFilesystem
        az amlfs expansion list --resource-group scgroup --aml-filesystem-name fs1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExpansionJobsListByAmlFilesystem(ctx=self.ctx)()
    ...
    class ExpansionJobsListByAmlFilesystem(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageCache/amlFilesystems/{amlFilesystemName}/expansionJobs",
                **self.url_parameters
            )

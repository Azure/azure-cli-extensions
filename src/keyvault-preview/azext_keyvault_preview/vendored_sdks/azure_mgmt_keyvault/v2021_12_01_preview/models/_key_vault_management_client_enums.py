...
class GeoReplicationRegionProvisioningState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ManagedHsmSkuName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):

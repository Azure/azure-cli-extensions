...
class PackagesOperations(object):
    ...
    def list_by_test_base_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.PackageListResult"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PackageListResult"]
        error_map = {
    ...
    def _create_initial(
        ...
        parameters,  # type: "models.PackageResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.PackageResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PackageResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.PackageResource"]
    ...
    def _update_initial(
        ...
        test_base_account_name,  # type: str
        package_name,  # type: str
        parameters,  # type: "models.PackageUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.PackageResource"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.PackageResource"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def get_download_url(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DownloadUrlResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DownloadUrlResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

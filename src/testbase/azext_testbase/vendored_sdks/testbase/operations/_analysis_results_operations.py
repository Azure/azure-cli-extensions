...
class AnalysisResultsOperations(object):
    ...
    def list(
        ...
        analysis_result_type,  # type: Union[str, "models.AnalysisResultType"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.AnalysisResultListResult"]
    ...
    def get(
        ...
        package_name,  # type: str
        test_result_name,  # type: str
        analysis_result_name,  # type: Union[str, "models.AnalysisResultName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AnalysisResultSingletonResource"

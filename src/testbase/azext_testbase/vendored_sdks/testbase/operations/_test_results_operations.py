...
class TestResultsOperations(object):
    ...
    def list(
        ...
        os_update_type,  # type: Union[str, "models.OsUpdateType"]
        filter=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.TestResultListResult"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestResultListResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.TestResultResource"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestResultResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

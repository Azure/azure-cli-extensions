...
class CustomerEventsOperations(object):
    ...
    def list_by_test_base_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CustomerEventListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~test_base.models.CustomerEventListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomerEventListResult"]
        error_map = {
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        customer_event_name,  # type: str
        parameters,  # type: "models.CustomerEventResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomerEventResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomerEventResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.CustomerEventResource"]
        ...
        :return: An instance of LROPoller that returns either CustomerEventResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~test_base.models.CustomerEventResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
class FavoriteProcessesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.FavoriteProcessListResult"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FavoriteProcessListResult"]
        error_map = {
    ...
    def create(
        ...
        parameters,  # type: "models.FavoriteProcessResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.FavoriteProcessResource"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FavoriteProcessResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        path_format_arguments = {
            ...
            'testBaseAccountName': self._serialize.url("test_base_account_name", test_base_account_name, 'str'),
            'packageName': self._serialize.url("package_name", package_name, 'str'),
            'favoriteProcessResourceName': self._serialize.url("favorite_process_resource_name", favorite_process_resource_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(parameters, 'FavoriteProcessResource')

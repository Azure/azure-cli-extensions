...
class TestBaseAccountsOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.TestBaseAccountListResult"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestBaseAccountListResult"]
        error_map = {
    ...
    def _create_initial(
        ...
        parameters,  # type: "models.TestBaseAccountResource"
        restore=None,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.TestBaseAccountResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestBaseAccountResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.TestBaseAccountResource"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        parameters,  # type: "models.TestBaseAccountUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.TestBaseAccountResource"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.TestBaseAccountResource"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def get_file_upload_url(
        ...
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        parameters=None,  # type: Optional["models.GetFileUploadUrlParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.FileUploadUrlResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FileUploadUrlResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def check_package_name_availability(
        ...
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        parameters,  # type: "models.PackageCheckNameAvailabilityParameters"
        **kwargs  # type: Any
    ):

...
class OsUpdatesOperations:
    ...
    def list(
        ...
        package_name: str,
        os_update_type: Union[str, "models.OsUpdateType"],
        **kwargs
    ) -> AsyncIterable["models.OsUpdateListResult"]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.OsUpdateListResult"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.OsUpdateResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

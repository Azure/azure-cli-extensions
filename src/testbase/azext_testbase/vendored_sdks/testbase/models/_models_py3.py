...
class AnalysisResultSingletonResource(Resource):
...
class AvailableOsResource(Resource):
...
class EmailEventResource(Resource):
...
class FavoriteProcessResource(Resource):
...
class FlightingRingResource(Resource):
...
class OsUpdateResource(Resource):
    """An OS Update.
...
class TestSummaryResource(Resource):
    """Summary of a Test.
...
class TestTypeResource(Resource):

...
helps['testbase account wait'] = """
    ...
    examples:
      ...
      - name: Pause executing next line of CLI script until the testbase account is successfully deleted.
        text: |-
               az testbase account wait --resource-group "contoso-rg1" --name "contoso-testBaseAccount1" --deleted
"""

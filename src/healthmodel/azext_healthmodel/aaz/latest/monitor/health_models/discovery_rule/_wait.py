...
@register_command(
    "monitor health-models discovery-rule wait",
)
class Wait(AAZWaitCommand):
    ...
    class DiscoveryRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            context = cls._schema_on_200.properties.error.context
            ...
            disc_application_insights_topology = cls._schema_on_200.properties.specification.discriminate_by("kind", "ApplicationInsightsTopology")
            ...
            disc_resource_graph_query = cls._schema_on_200.properties.specification.discriminate_by("kind", "ResourceGraphQuery")

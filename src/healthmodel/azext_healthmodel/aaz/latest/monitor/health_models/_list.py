...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.HealthModelsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.HealthModelsListByResourceGroup(ctx=self.ctx)()
    ...
    class HealthModelsListBySubscription(AAZHttpOperation):
    ...
    class HealthModelsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"

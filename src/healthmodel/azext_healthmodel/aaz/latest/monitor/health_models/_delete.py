...
class Delete(AAZCommand):
    ...
    :example: Delete a health model
        az monitor health-models delete --resource-group myRG --name myModel --yes
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.HealthModelsDelete(ctx=self.ctx)()
    ...
    class HealthModelsDelete(AAZHttpOperation):

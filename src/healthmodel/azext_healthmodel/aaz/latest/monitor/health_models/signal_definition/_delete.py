...
class Delete(AAZCommand):
    ...
    :example: Delete a signal definition
        az monitor health-models signal-definition delete --resource-group myRG --health-model-name myModel --name cpuPressure --yes
    """

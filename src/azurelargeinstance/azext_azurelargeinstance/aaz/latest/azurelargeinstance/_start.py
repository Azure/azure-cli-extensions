...
class Start(AAZCommand):
    ...
    :example: Start an Azure Large Instance
        az shutdown --subscription $SUBSCRIPTIONID --resource-group $RESOURCE_GROUP --instance-name $INSTANCE_NAME
    """

    _aaz_info = {
        "version": "2023-07-20-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.azurelargeinstance/azurelargeinstance/{}/start", "2023-07-20-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureLargeInstanceStart(ctx=self.ctx)()
    ...
    class AzureLargeInstanceStart(AAZHttpOperation):

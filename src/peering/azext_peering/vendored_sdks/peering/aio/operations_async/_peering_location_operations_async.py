...
class PeeringLocationOperations:
    """PeeringLocationOperations async operations.
    ...
    def list(
        self,
        kind: Union[str, "models.Enum14"],
        direct_peering_type: Optional[Union[str, "models.Enum15"]] = None,
        **kwargs
    ) -> AsyncIterable["models.PeeringLocationListResult"]:

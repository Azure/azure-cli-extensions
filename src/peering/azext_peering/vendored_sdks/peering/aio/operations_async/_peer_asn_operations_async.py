...
class PeerAsnOperations:
    """PeerAsnOperations async operations.
    ...
    async def create_or_update(
        ...
        peer_contact_detail: Optional[List["models.ContactDetail"]] = None,
        peer_name: Optional[str] = None,
        validation_state: Optional[Union[str, "models.ValidationState"]] = None,
        **kwargs
    ) -> "models.PeerAsn":
        ...
        :type peer_name: str
        :param validation_state: The validation state of the ASN associated with the peer.
        ...
        body_content = self._serialize.body(_peer_asn, 'PeerAsn')
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.PeerAsnListResult"]:
        """Lists all of the peer ASNs under the given subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of PeerAsnListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.PeerAsnListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class PeeringServiceLocationOperations:
    """PeeringServiceLocationOperations async operations.
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.PeeringServiceLocationListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.PeeringServiceLocationListResult]

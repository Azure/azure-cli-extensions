...
class ReceivedRouteOperations:
    """ReceivedRouteOperations async operations.
    ...
    def list_by_peering(
        ...
        **kwargs
    ) -> "models.PeeringReceivedRouteListResult":
     ...
     result.
        ...
        :return: PeeringReceivedRouteListResult or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringReceivedRouteListResult

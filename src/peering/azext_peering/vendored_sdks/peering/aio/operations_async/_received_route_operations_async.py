...
class ReceivedRouteOperations:
    ...
    def list_by_peering(
        ...
        **kwargs
    ) -> AsyncIterable["models.PeeringReceivedRouteListResult"]:
     ...
     result.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.PeeringReceivedRouteListResult]

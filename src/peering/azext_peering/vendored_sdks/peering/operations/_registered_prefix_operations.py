...
class RegisteredPrefixOperations(object):
    """RegisteredPrefixOperations operations.
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.PeeringRegisteredPrefix"
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PeeringRegisteredPrefix or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringRegisteredPrefix or ~azure.mgmt.peering.models.PeeringRegisteredPrefix
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PeeringRegisteredPrefix"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def list_by_peering(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.PeeringRegisteredPrefixListResult"
        ...
        :type peering_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PeeringRegisteredPrefixListResult or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringRegisteredPrefixListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
class PeeringOperations(object):
    """PeeringOperations operations.
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        peering_name,  # type: str
        sku,  # type: "models.PeeringSku"
        kind,  # type: Union[str, "models.Kind"]
        location,  # type: str
        tags=None,  # type: Optional[Dict[str, str]]
        direct=None,  # type: Optional["models.PeeringPropertiesDirect"]
        exchange=None,  # type: Optional["models.PeeringPropertiesExchange"]
        peering_location=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Peering"

...
class PeeringLocationOperations(object):
    """PeeringLocationOperations operations.
    ...
    def list(
        self,
        kind,  # type: Union[str, "models.Enum14"]
        ...
        **kwargs  # type: Any
        ...
        :type kind: str or ~azure.mgmt.peering.models.Enum14
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('PeeringLocationListResult', pipeline_response)

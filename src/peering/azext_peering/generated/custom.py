...
def peering_peer_asn_list(cmd, client):
    return client.list_by_subscription()


def peering_peer_asn_show(cmd, client,
                          peer_asn_name):
    return client.get(peer_asn_name=peer_asn_name)


def peering_peer_asn_create(cmd, client,
                            peer_asn_name,
                            peer_asn=None,
...
def peering_peer_asn_update(instance, cmd,
                            peer_asn_name,
                            peer_asn=None,
                            peer_contact_detail=None,
                            peer_name=None,
...
def peering_peer_asn_delete(cmd, client,
                            peer_asn_name):

...
def asn_check_service_provider_availability(cmd, client,
...
def asn_show(cmd, client,
             peer_asn_name):
    return client.get(peer_asn_name=peer_asn_name)


def asn_create(cmd, client,
               peer_asn_name,
               peer_asn=None,

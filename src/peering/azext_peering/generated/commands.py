...
def load_command_table(self, _):
    ...
    with self.command_group('peering peer-asn', peering_peer_asn, client_factory=cf_peer_asn,
                            is_experimental=True) as g:
        g.custom_command('list', 'peering_peer_asn_list')
        g.custom_show_command('show', 'peering_peer_asn_show')
        g.custom_command('create', 'peering_peer_asn_create')
        g.generic_update_command('update', setter_arg_name = 'peer_contact_detail', custom_func_name = 'peering_peer_as'
                                 'n_update')
        g.custom_command('delete', 'peering_peer_asn_delete')
    ...
    with self.command_group('peering peering-service-country', peering_peering_service_country,
                            client_factory=cf_peering_service_country, is_experimental=True) as g:
    ...
    with self.command_group('peering peering-service', peering_peering_service, client_factory=cf_peering_service,
                            is_experimental=True) as g:

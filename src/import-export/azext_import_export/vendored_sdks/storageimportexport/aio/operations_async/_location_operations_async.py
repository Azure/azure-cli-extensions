...
class LocationOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~storage_import_export.models.LocationsResponse
        :raises: ~storage_import_export.models.ErrorResponseException:
        """
        cls: ClsType["models.LocationsResponse"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~storage_import_export.models.ErrorResponseException:
        """
        cls: ClsType["models.Location"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2016-11-01"

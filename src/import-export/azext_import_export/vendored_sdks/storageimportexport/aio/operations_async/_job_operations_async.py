...
class JobOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.ListJobsResponse"] = kwargs.pop('cls', None )
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~storage_import_export.models.ErrorResponseException:
        """
        cls: ClsType["models.JobResponse"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
        api_version = "2016-11-01"
    ...
    async def update(
        ...
        job_name: str,
        resource_group_name: str,
        tags: Optional["models.UpdateJobParametersTags"] = None,
    ...
    async def create(
        ...
        tags: Optional["models.PutJobParametersTags"] = None,

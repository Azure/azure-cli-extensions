...
class Show(AAZCommand):
    ...
    class SnapshotGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_system_data_read(properties.report_system_data)
            properties.snapshot_name = AAZStrType(
                serialized_name="snapshotName",
                flags={"read_only": True},
            )

            compliance_results = cls._schema_on_200.properties.compliance_results
            compliance_results.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element
            ...
            categories = cls._schema_on_200.properties.compliance_results.Element.categories
            categories.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element
            ...
            control_families = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families
            control_families.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element
            ...
            controls = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls
            controls.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element
            ...
            responsibilities = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities
            responsibilities.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element
            ...
            evidence_files = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.evidence_files
            evidence_files.Element = AAZStrType()

            recommendation_list = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.recommendation_list
            recommendation_list.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.recommendation_list.Element
            ...
            recommendation_solutions = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.recommendation_list.Element.recommendation_solutions
            recommendation_solutions.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.recommendation_list.Element.recommendation_solutions.Element
            ...
            resource_list = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.resource_list
            resource_list.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.resource_list.Element
            ...
            recommendation_ids = cls._schema_on_200.properties.compliance_results.Element.categories.Element.control_families.Element.controls.Element.responsibilities.Element.resource_list.Element.recommendation_ids
            recommendation_ids.Element = AAZStrType()

            report_properties = cls._schema_on_200.properties.report_properties
            ...
            cert_records = cls._schema_on_200.properties.report_properties.cert_records
            cert_records.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.report_properties.cert_records.Element
            ...
            controls = cls._schema_on_200.properties.report_properties.cert_records.Element.controls
            controls.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.report_properties.cert_records.Element.controls.Element
            _element.control_id = AAZStrType(
                serialized_name="controlId",
            )
            _element.control_status = AAZStrType(
            ...
            compliance_status = cls._schema_on_200.properties.report_properties.compliance_status
            compliance_status.m365 = AAZObjectType(
                flags={"read_only": True},
            )

            m365 = cls._schema_on_200.properties.report_properties.compliance_status.m365
            ...
            errors = cls._schema_on_200.properties.report_properties.errors
            errors.Element = AAZStrType()

            resources = cls._schema_on_200.properties.report_properties.resources
            resources.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.report_properties.resources.Element
            _element.account_id = AAZStrType(
                serialized_name="accountId",
            )
            _element.resource_id = AAZStrType(
            ...
            storage_info = cls._schema_on_200.properties.report_properties.storage_info
            ...
            subscriptions = cls._schema_on_200.properties.report_properties.subscriptions

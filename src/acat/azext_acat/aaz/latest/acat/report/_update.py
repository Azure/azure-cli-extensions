...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ReportUpdate(ctx=self.ctx)()
    ...
    class ReportUpdate(AAZHttpOperation):

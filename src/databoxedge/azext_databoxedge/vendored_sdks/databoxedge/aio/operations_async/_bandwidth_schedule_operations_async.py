...
class BandwidthScheduleOperations:
    """BandwidthScheduleOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        stop: str,
        rate_in_mbps: int,
        days: List[Union[str, "models.DayOfWeek"]],
        **kwargs
    ) -> "models.BandwidthSchedule":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BandwidthSchedule"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/bandwidthSchedules/{name}'}  # type: ignore
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/bandwidthSchedules/{name}'}  # type: ignore

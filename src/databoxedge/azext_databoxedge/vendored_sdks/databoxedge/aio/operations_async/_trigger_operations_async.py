...
class TriggerOperations:
    ...
    def list_by_data_box_edge_device(
     ...
     tag property.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_box_edge_management_client.models.TriggerList]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~data_box_edge_management_client.models.Trigger
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type trigger: ~data_box_edge_management_client.models.Trigger
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggers/{name}'}  # type: ignore
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggers/{name}'}  # type: ignore

...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs
    ) -> "models.StorageAccountCredentialList":
        ...
        :return: StorageAccountCredentialList or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.models.StorageAccountCredentialList
    ...
    async def create_or_update(
     ...
     username and account key are not specified.
        ...
        :return: An instance of LROPoller that returns StorageAccountCredential

...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs
    ) -> AsyncIterable["models.StorageAccountCredentialList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_box_edge_management_client.models.StorageAccountCredentialList]
    ...
    async def get(
        ...
        resource_group_name: str,
        **kwargs
    ) -> "models.StorageAccountCredential":
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        alias: str,
        ssl_status: Union[str, "models.SSLStatus"],
        account_type: Union[str, "models.AccountType"],
        user_name: Optional[str] = None,
        account_key: Optional["models.AsymmetricEncryptedSecret"] = None,
        connection_string: Optional[str] = None,
        blob_domain_name: Optional[str] = None,
        storage_account_id: Optional[str] = None,
        **kwargs
    ) -> Optional["models.StorageAccountCredential"]:
        ...
        storage_account_credential = models.StorageAccountCredential(alias=alias, user_name=user_name, account_key=account_key, connection_string=connection_string, ssl_status=ssl_status, blob_domain_name=blob_domain_name, account_type=account_type, storage_account_id=storage_account_id)
        api_version = "2019-08-01"
    ...
    async def begin_create_or_update(
        ...
        storage_account_id: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.StorageAccountCredential"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~data_box_edge_management_client.models.StorageAccountCredential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

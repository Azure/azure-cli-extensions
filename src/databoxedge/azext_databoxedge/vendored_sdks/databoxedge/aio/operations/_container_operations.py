...
class ContainerOperations:
    ...
    def list_by_storage_account(
        ...
        **kwargs
    ) -> AsyncIterable["models.ContainerList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_box_edge_management_client.models.ContainerList]
    ...
    async def _create_or_update_initial(
        ...
        container_name: str,
        resource_group_name: str,
        data_format: Union[str, "models.AzureContainerDataFormat"],
        **kwargs
    ) -> Optional["models.Container"]:
        ...
        container = models.Container(data_format=data_format)
        api_version = "2019-08-01"
    ...
    async def begin_create_or_update(
        ...
        data_format: Union[str, "models.AzureContainerDataFormat"],
        **kwargs
    ) -> AsyncLROPoller["models.Container"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~data_box_edge_management_client.models.Container]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

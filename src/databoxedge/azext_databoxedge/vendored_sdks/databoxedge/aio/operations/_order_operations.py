...
class OrderOperations:
    """OrderOperations async operations.
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs
    ) -> AsyncIterable["models.OrderList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~data_box_edge_management_client.models.OrderList]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~data_box_edge_management_client.models.Order
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.Order"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        order = models.Order(contact_information=contact_information, shipping_address=shipping_address, status=status, comments=comments)
        api_version = "2019-08-01"
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~data_box_edge_management_client.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

...
class OrderOperations(object):
    ...
    def _create_or_update_initial(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        contact_information=None,  # type: Optional["models.ContactDetails"]
        shipping_address=None,  # type: Optional["models.Address"]
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(_order, 'Order')

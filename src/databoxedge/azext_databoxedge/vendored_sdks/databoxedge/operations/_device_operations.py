...
class DeviceOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DataBoxEdgeDeviceList"
     ...
     Specify $skipToken=:code:`<token>` to populate the next page in the list.
        ...
        :return: DataBoxEdgeDeviceList or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.models.DataBoxEdgeDeviceList
    ...
    def _create_or_update_initial(
        ...
        data_box_edge_device_status=None,  # type: Optional[Union[str, "models.DataBoxEdgeDeviceStatus"]]
        description=None,  # type: Optional[str]
        model_description=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        _data_box_edge_device = models.DataBoxEdgeDevice(location=location, tags=tags, sku=sku, etag=etag, data_box_edge_device_status=data_box_edge_device_status, description=description, model_description=model_description, friendly_name=friendly_name)
        api_version = "2019-08-01"
        ...
        body_content = self._serialize.body(_data_box_edge_device, 'DataBoxEdgeDevice')
    ...
    def begin_create_or_update(
     ...
     group this device (across resource groups).
        ...
        :type data_box_edge_device_status: str or ~azure.mgmt.databoxedge.models.DataBoxEdgeDeviceStatus
        ...
        :return: An instance of LROPoller that returns DataBoxEdgeDevice
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'DataBoxEdgeDevicePatch')
        body_content_kwargs['content'] = body_content
    ...
    def _download_update_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._download_update_initial.metadata['url']
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
    ...
    _download_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/downloadUpdates'}
    ...
    def begin_download_update(
        ...
        **kwargs  # type: Any
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        raw_result = self._download_update_initial(
            device_name=device_name,
            resource_group_name=resource_group_name,
            cls=lambda x,y,z: x,
            **kwargs
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_download_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/downloadUpdates'}
    ...
    def _install_update_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._install_update_initial.metadata['url']
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
    ...
    _install_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/installUpdates'}

    def begin_install_update(
        self,
        device_name,  # type: str
        resource_group_name,  # type: str
        **kwargs  # type: Any
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        raw_result = self._install_update_initial(
            device_name=device_name,
            resource_group_name=resource_group_name,
            cls=lambda x,y,z: x,
            **kwargs
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_install_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/installUpdates'}
    ...
    def get_network_setting(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_network_setting.metadata['url']
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
        ...
        return deserialized
    get_network_setting.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/networkSettings/default'}

    def _scan_for_update_initial(
        self,
        device_name,  # type: str
        resource_group_name,  # type: str
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._scan_for_update_initial.metadata['url']
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
    ...
    _scan_for_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/scanForUpdates'}

    def begin_scan_for_update(
        self,
        device_name,  # type: str
        resource_group_name,  # type: str
        **kwargs  # type: Any
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        raw_result = self._scan_for_update_initial(
            device_name=device_name,
            resource_group_name=resource_group_name,
            cls=lambda x,y,z: x,
            **kwargs
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_scan_for_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/scanForUpdates'}

    def _create_or_update_security_setting_initial(
        self,
        device_name,  # type: str
        resource_group_name,  # type: str
        device_admin_password,  # type: "models.AsymmetricEncryptedSecret"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        # Construct URL
        url = self._create_or_update_security_setting_initial.metadata['url']
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_security_settings, 'SecuritySettings')
        body_content_kwargs['content'] = body_content
    ...
    _create_or_update_security_setting_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/securitySettings/default/update'}

    def begin_create_or_update_security_setting(
        self,
        device_name,  # type: str
        resource_group_name,  # type: str
        device_admin_password,  # type: "models.AsymmetricEncryptedSecret"
     ...
     special characters.
        ...
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        raw_result = self._create_or_update_security_setting_initial(
            device_name=device_name,
            resource_group_name=resource_group_name,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update_security_setting.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/securitySettings/default/update'}
    ...
    def upload_certificate(
        ...
        authentication_type=None,  # type: Optional[Union[str, "models.AuthenticationType"]]
        **kwargs  # type: Any
    ):
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'UploadCertificateRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)

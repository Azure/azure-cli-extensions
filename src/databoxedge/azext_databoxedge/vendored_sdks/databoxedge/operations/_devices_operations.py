...
class DevicesOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.DataBoxEdgeDeviceList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_box_edge_management_client.models.DataBoxEdgeDeviceList]
    ...
    def _create_or_update_initial(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        data_box_edge_device,  # type: "models.DataBoxEdgeDevice"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DataBoxEdgeDevice"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataBoxEdgeDevice"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.DataBoxEdgeDevice"]
        ...
        :type data_box_edge_device: ~data_box_edge_management_client.models.DataBoxEdgeDevice
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~data_box_edge_management_client.models.DataBoxEdgeDevice]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "models.DataBoxEdgeDevicePatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DataBoxEdgeDevice"
        ...
        :type parameters: ~data_box_edge_management_client.models.DataBoxEdgeDevicePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataBoxEdgeDevice, or the result of cls(response)
        :rtype: ~data_box_edge_management_client.models.DataBoxEdgeDevice
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_extended_information(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DataBoxEdgeDeviceExtendedInfo"
    ...
    def _create_or_update_security_settings_initial(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        security_settings,  # type: "models.SecuritySettings"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def begin_create_or_update_security_settings(
        ...
        **kwargs  # type: Any
        ...
        :type security_settings: ~data_box_edge_management_client.models.SecuritySettings
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def upload_certificate(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "models.UploadCertificateRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.UploadCertificateResponse"
        ...
        :type parameters: ~data_box_edge_management_client.models.UploadCertificateRequest
        :keyword callable cls: A custom type or function that will be passed the direct response

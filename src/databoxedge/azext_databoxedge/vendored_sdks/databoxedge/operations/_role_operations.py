...
class RoleOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs  # type: Any
        ...
        :return: RoleList or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.models.RoleList
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns Role

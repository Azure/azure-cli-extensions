...
class Order(ArmBaseModel):
    ...
    :type country: str
    :param contact_person: The contact person name.
    :type contact_person: str
    :param company_name: The name of the company.
    :type company_name: str
    :param phone: The phone number.
    :type phone: str
    :param email_list: The email list.
    ...
    _attribute_map = {
        ...
        'address_line1': {'key': 'properties.shippingAddress.addressLine1', 'type': 'str'},
        'address_line2': {'key': 'properties.shippingAddress.addressLine2', 'type': 'str'},
        'address_line3': {'key': 'properties.shippingAddress.addressLine3', 'type': 'str'},
        'postal_code': {'key': 'properties.shippingAddress.postalCode', 'type': 'str'},
        'city': {'key': 'properties.shippingAddress.city', 'type': 'str'},
        'state': {'key': 'properties.shippingAddress.state', 'type': 'str'},
        'country': {'key': 'properties.shippingAddress.country', 'type': 'str'},
        'contact_person': {'key': 'properties.contactInformation.contactPerson', 'type': 'str'},
        'company_name': {'key': 'properties.contactInformation.companyName', 'type': 'str'},
        'phone': {'key': 'properties.contactInformation.phone', 'type': 'str'},
        'email_list': {'key': 'properties.contactInformation.emailList', 'type': '[str]'},
    }

    def __init__(
        self,
        *,
        status: Optional[Union[str, "OrderState"]] = None,

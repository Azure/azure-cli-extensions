...
class StorageAccountOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        storage_account = models.StorageAccount(description=description, storage_account_status=storage_account_status, data_policy=data_policy, storage_account_credential_id=storage_account_credential_id)
        api_version = "2019-08-01"
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~data_box_edge_management_client.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

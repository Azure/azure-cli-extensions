...
class OrderOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.OrderList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_box_edge_management_client.models.OrderList]
    ...
    def _create_or_update_initial(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        status=None,  # type: Optional[Union[str, "models.OrderState"]]
        comments=None,  # type: Optional[str]
        address_line1=None,  # type: Optional[str]
        ...
        contact_person=None,  # type: Optional[str]
        company_name=None,  # type: Optional[str]
        phone=None,  # type: Optional[str]
        email_list=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.Order"]
        ...
        order = models.Order(status=status, comments=comments, address_line1=address_line1, address_line2=address_line2, address_line3=address_line3, postal_code=postal_code, city=city, state=state, country=country, contact_person=contact_person, company_name=company_name, phone=phone, email_list=email_list)
        api_version = "2019-08-01"
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~data_box_edge_management_client.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

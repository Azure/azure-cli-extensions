...
class DataBoxEdgeManagementClient(object):
    ...
    :vartype operations: data_box_edge_management_client.operations.Operations
    :ivar devices: DevicesOperations operations
    :vartype devices: data_box_edge_management_client.operations.DevicesOperations
    :ivar alerts: AlertsOperations operations
    :vartype alerts: data_box_edge_management_client.operations.AlertsOperations
    :ivar bandwidth_schedules: BandwidthSchedulesOperations operations
    :vartype bandwidth_schedules: data_box_edge_management_client.operations.BandwidthSchedulesOperations
    :ivar jobs: JobsOperations operations
    :vartype jobs: data_box_edge_management_client.operations.JobsOperations
    :ivar nodes: NodesOperations operations
    :vartype nodes: data_box_edge_management_client.operations.NodesOperations
    :ivar operations_status: OperationsStatusOperations operations
    :vartype operations_status: data_box_edge_management_client.operations.OperationsStatusOperations
    :ivar orders: OrdersOperations operations
    :vartype orders: data_box_edge_management_client.operations.OrdersOperations
    :ivar roles: RolesOperations operations
    :vartype roles: data_box_edge_management_client.operations.RolesOperations
    :ivar shares: SharesOperations operations
    :vartype shares: data_box_edge_management_client.operations.SharesOperations
    ...
    :vartype storage_accounts: data_box_edge_management_client.operations.StorageAccountsOperations
    :ivar containers: ContainersOperations operations
    :vartype containers: data_box_edge_management_client.operations.ContainersOperations
    :ivar triggers: TriggersOperations operations
    :vartype triggers: data_box_edge_management_client.operations.TriggersOperations
    :ivar users: UsersOperations operations
    :vartype users: data_box_edge_management_client.operations.UsersOperations
    :ivar skus: SkusOperations operations
    :vartype skus: data_box_edge_management_client.operations.SkusOperations

...
class Alert(ArmBaseModel):
    ...
    :vartype error_details: ~data_box_edge_management_client.models.AlertErrorDetails
...
class AlertList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Alert]
...
class AsymmetricEncryptedSecret(msrest.serialization.Model):
    ...
    :type encryption_algorithm: str or ~data_box_edge_management_client.models.EncryptionAlgorithm
    """
...
class Authentication(msrest.serialization.Model):
    ...
    :type symmetric_key: ~data_box_edge_management_client.models.SymmetricKey
    """
...
class AzureContainerInfo(msrest.serialization.Model):
    ...
    :type data_format: str or ~data_box_edge_management_client.models.AzureContainerDataFormat
    """
...
class BandwidthSchedule(ArmBaseModel):
    ...
    :type days: list[str or ~data_box_edge_management_client.models.DayOfWeek]
    """
...
class BandwidthSchedulesList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.BandwidthSchedule]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class ClientAccessRight(msrest.serialization.Model):
    ...
    :type access_permission: str or ~data_box_edge_management_client.models.ClientPermissionType
    """
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~data_box_edge_management_client.models.CloudErrorBody]
    """
...
class Container(ArmBaseModel):
    ...
    :vartype container_status: str or ~data_box_edge_management_client.models.ContainerStatus
    ...
    :vartype refresh_details: ~data_box_edge_management_client.models.RefreshDetails
...
class ContainerList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Container]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class DataBoxEdgeDevice(ArmBaseModel):
    ...
    :type data_box_edge_device_status: str or
     ~data_box_edge_management_client.models.DataBoxEdgeDeviceStatus
    ...
    :ivar device_type: The type of the Data Box Edge/Gateway device. Possible values include:
     "DataBoxEdgeDevice".
    :vartype device_type: str or ~data_box_edge_management_client.models.DeviceType
...
class DataBoxEdgeDeviceList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.DataBoxEdgeDevice]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class Trigger(ArmBaseModel):
    ...
    :type kind: str or ~data_box_edge_management_client.models.TriggerEventType
    """
...
class FileEventTrigger(Trigger):
    ...
    _attribute_map = {
        ...
        'role_id': {'key': 'sinkInfo.roleId', 'type': 'str'},
        'share_id': {'key': 'sourceInfo.shareId', 'type': 'str'},
    }
...
class Role(ArmBaseModel):
    ...
    :type kind: str or ~data_box_edge_management_client.models.RoleTypes
    """
...
class IoTRole(Role):
    ...
    :param host_platform: Host OS supported by the IoT role. Possible values include: "Windows",
     "Linux".
    :type host_platform: str or ~data_box_edge_management_client.models.PlatformType
    :param io_t_device_details: IoT device metadata to which data box edge device needs to be
     connected.
    :type io_t_device_details: ~data_box_edge_management_client.models.IoTDeviceInfo
...
class Job(msrest.serialization.Model):
    ...
    :vartype status: str or ~data_box_edge_management_client.models.JobStatus
    ...
    :vartype current_stage: str or ~data_box_edge_management_client.models.UpdateOperationStage
    :ivar download_progress: The download progress.
    :vartype download_progress: ~data_box_edge_management_client.models.UpdateDownloadProgress
    :ivar install_progress: The install progress.
    :vartype install_progress: ~data_box_edge_management_client.models.UpdateInstallProgress
...
class JobErrorDetails(msrest.serialization.Model):
    ...
    :vartype error_details: list[~data_box_edge_management_client.models.JobErrorItem]
...
class MetricSpecificationV1(msrest.serialization.Model):
    ...
    :type unit: str or ~data_box_edge_management_client.models.MetricUnit
    ...
    :type aggregation_type: str or ~data_box_edge_management_client.models.MetricAggregationType
    :param dimensions: Metric dimensions, other than default dimension which is resource.
    :type dimensions: list[~data_box_edge_management_client.models.MetricDimensionV1]
    ...
    :type category: str or ~data_box_edge_management_client.models.MetricCategory
...
class NetworkAdapter(msrest.serialization.Model):
    ...
    :vartype adapter_position: ~data_box_edge_management_client.models.NetworkAdapterPosition
    ...
    :ivar status: Value indicating whether this adapter is valid. Possible values include:
     "Inactive", "Active".
    :vartype status: str or ~data_box_edge_management_client.models.NetworkAdapterStatus
    :param rdma_status: Value indicating whether this adapter is RDMA capable. Possible values
     include: "Incapable", "Capable".
    :type rdma_status: str or ~data_box_edge_management_client.models.NetworkAdapterRdmaStatus
    :param dhcp_status: Value indicating whether this adapter has DHCP enabled. Possible values
     include: "Disabled", "Enabled".
    :type dhcp_status: str or ~data_box_edge_management_client.models.NetworkAdapterDhcpStatus
    :ivar ipv4_configuration: The IPv4 configuration of the network adapter.
    :vartype ipv4_configuration: ~data_box_edge_management_client.models.Ipv4Config
    :ivar ipv6_configuration: The IPv6 configuration of the network adapter.
    :vartype ipv6_configuration: ~data_box_edge_management_client.models.Ipv6Config
...
class NetworkAdapterPosition(msrest.serialization.Model):
    ...
    :vartype network_group: str or ~data_box_edge_management_client.models.NetworkGroup
    :ivar port: The port.
    :vartype port: int
    """
...
class NetworkSettings(ArmBaseModel):
    ...
    :vartype network_adapters: list[~data_box_edge_management_client.models.NetworkAdapter]
    """
...
Multi-node Edge devices will have more than 1 nodes.
    ...
    :vartype node_status: str or ~data_box_edge_management_client.models.NodeStatus
...
class NodeList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Node]
    """
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~data_box_edge_management_client.models.OperationDisplay
    :param origin: Origin of the operation.
    :type origin: str
    :param service_specification: Service specification.
    :type service_specification: ~data_box_edge_management_client.models.ServiceSpecification
    """
...
class OperationsList(msrest.serialization.Model):
    ...
    :type value: list[~data_box_edge_management_client.models.Operation]
...
class Order(ArmBaseModel):
    ...
    :vartype order_history: list[~data_box_edge_management_client.models.OrderStatus]
    ...
    :vartype delivery_tracking_info: list[~data_box_edge_management_client.models.TrackingInfo]
    ...
    _attribute_map = {
        ...
        'status': {'key': 'currentStatus.status', 'type': 'str'},
        'update_date_time': {'key': 'currentStatus.updateDateTime', 'type': 'iso-8601'},
        'comments': {'key': 'currentStatus.comments', 'type': 'str'},
        'additional_order_details': {'key': 'currentStatus.additionalOrderDetails', 'type': '{str}'},
    }
...
class OrderList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Order]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class PeriodicTimerEventTrigger(Trigger):
    ...
    _attribute_map = {
        ...
        'custom_context_tag': {'key': 'properties.customContextTag', 'type': 'str'},
        'role_id': {'key': 'sinkInfo.roleId', 'type': 'str'},
        'start_time': {'key': 'sourceInfo.startTime', 'type': 'iso-8601'},
        'schedule': {'key': 'sourceInfo.schedule', 'type': 'str'},
        'topic': {'key': 'sourceInfo.topic', 'type': 'str'},
    }
...
class ResourceTypeSku(msrest.serialization.Model):
    ...
    :vartype tier: str or ~data_box_edge_management_client.models.SkuTier
...
class RoleList(msrest.serialization.Model):
    ...
    :ivar value: The Value.
    :vartype value: list[~data_box_edge_management_client.models.Role]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class ServiceSpecification(msrest.serialization.Model):
    ...
    :type metric_specifications:
     list[~data_box_edge_management_client.models.MetricSpecificationV1]
    """
...
class Share(ArmBaseModel):
    ...
    :vartype share_mappings: list[~data_box_edge_management_client.models.MountPointMap]
...
class ShareAccessRight(msrest.serialization.Model):
    ...
    :type access_type: str or ~data_box_edge_management_client.models.ShareAccessType
    """
...
class ShareList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Share]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class Sku(msrest.serialization.Model):
    ...
    :param name: SKU name. Possible values include: "Gateway", "Edge", "TEA_1Node",
     "TEA_1Node_UPS", "TEA_1Node_Heater", "TEA_1Node_UPS_Heater", "TEA_4Node_Heater",
     "TEA_4Node_UPS_Heater", "TMA".
    :type name: str or ~data_box_edge_management_client.models.SkuName
    :param tier: The SKU tier. This is based on the SKU name. Possible values include: "Standard".
    :type tier: str or ~data_box_edge_management_client.models.SkuTier
    """
...
class SkuRestriction(msrest.serialization.Model):
    ...
    :vartype reason_code: str or ~data_box_edge_management_client.models.SkuRestrictionReasonCode
    :ivar restriction_info: Restriction of the SKU for the location/zone.
    :vartype restriction_info: ~data_box_edge_management_client.models.SkuRestrictionInfo
    """
...
class StorageAccountCredentialList(msrest.serialization.Model):
    ...
    :ivar value: The value.
    :vartype value: list[~data_box_edge_management_client.models.StorageAccountCredential]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class StorageAccountList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.StorageAccount]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class SymmetricKey(msrest.serialization.Model):
    ...
    :type connection_string: ~data_box_edge_management_client.models.AsymmetricEncryptedSecret
    """
...
class TriggerList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.Trigger]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """
...
class UpdateDownloadProgress(msrest.serialization.Model):
    ...
    :vartype download_phase: str or ~data_box_edge_management_client.models.DownloadPhase
...
class UpdateSummary(ArmBaseModel):
    ...
    :vartype reboot_behavior: str or ~data_box_edge_management_client.models.InstallRebootBehavior
    ...
    :vartype ongoing_update_operation: str or
     ~data_box_edge_management_client.models.UpdateOperation
...
class UploadCertificateResponse(msrest.serialization.Model):
    ...
    :param auth_type: Specifies authentication type. Possible values include: "Invalid",
     "AzureActiveDirectory".
    :type auth_type: str or ~data_box_edge_management_client.models.AuthenticationType
...
class UserList(msrest.serialization.Model):
    ...
    :vartype value: list[~data_box_edge_management_client.models.User]
    :ivar next_link: Link to the next set of results.
    :vartype next_link: str
    """

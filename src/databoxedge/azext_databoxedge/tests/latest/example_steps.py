...
def step_device_create(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device create '
             '--location "eastus" '
...
def step_device_show(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device show '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_list(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device list '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_show_update_summary(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device show-update-summary '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device update '
             '--name "{myDevice}" '
...
def step_device_download_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device download-update '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_install_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device install-update '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_scan_for_update(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device scan-for-update '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_alert_show(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge alert show '
...
def step_alert_list(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge alert list '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_bandwidth_schedule_create(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge bandwidth-schedule create '
             '--name "bandwidth-1" '
             '--device-name "{myDevice}" '
             '--days "Sunday" '
             '--days "Monday" '
...
def step_bandwidth_schedule_show(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge bandwidth-schedule show '
             '--name "bandwidth-1" '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_bandwidth_schedule_list(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge bandwidth-schedule list '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_bandwidth_schedule_delete(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge bandwidth-schedule delete -y '
             '--name "bandwidth-1" '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_show_job(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge show-job '
             '--name "159a00c7-8543-4343-9435-263ac87df3bb" '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_list_node(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge list-node '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_order_create(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge order create '
             '--device-name "{myDevice}" '
...
def step_order_show(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge order show '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_order_list(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge order list '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_order_delete(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge order delete -y '
             '--device-name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_device_delete(test, rg, checks=None):
    if checks is None:
        checks = []
    test.cmd('az data-box-edge device delete -y '
             '--name "{myDevice}" '
             '--resource-group "{rg}"',
             checks=checks)

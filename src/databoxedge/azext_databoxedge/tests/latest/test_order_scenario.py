...
def call_scenario(test, rg):
    ...
    step_order_create(test, rg, checks=[
        test.check("companyName", "Microsoft", case_sensitive=False),
        test.check("contactPerson", "John Mcclane", case_sensitive=False),
        test.check("country", "United States", case_sensitive=False),
    ])

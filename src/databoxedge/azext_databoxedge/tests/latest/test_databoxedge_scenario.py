...
@try_manual
def step_databoxedgedeviceput(test, rg, rg_2):
...
# EXAMPLE: SharePut
@try_manual
def step_shareput(test, rg, rg_2):
...
# EXAMPLE: OrderPut
@try_manual
def step_orderput(test, rg, rg_2):
...
# EXAMPLE: TriggerPut
@try_manual
def step_triggerput(test, rg, rg_2):
...
@try_manual
def step_storageaccountput(test, rg, rg_2):
    # EXAMPLE NOT FOUND!
    pass
...
@try_manual
def step_bandwidthscheduleput(test, rg, rg_2):
...
@try_manual
def step_containerput(test, rg, rg_2):
...
@try_manual
def step_containerget(test, rg, rg_2):
...
@try_manual
def step_containerlistallindevice(test, rg, rg_2):
...
@try_manual
def step_bandwidthscheduleget(test, rg, rg_2):
...
@try_manual
def step_operationsstatusget(test, rg, rg_2):
...
@try_manual
def step_storageaccountget(test, rg, rg_2):
...
@try_manual
def step_networksettingsget(test, rg, rg_2):
...
@try_manual
def step_updatesummaryget(test, rg, rg_2):
...
# EXAMPLE: TriggerGet
@try_manual
def step_triggerget(test, rg, rg_2):
...
@try_manual
def step_sacgetallindevice(test, rg, rg_2):
...
# EXAMPLE: AlertGet
@try_manual
def step_alertget(test, rg, rg_2):
...
# EXAMPLE: ShareGet
@try_manual
def step_shareget(test, rg, rg_2):
...
# EXAMPLE: OrderGet
@try_manual
def step_orderget(test, rg, rg_2):
...
@try_manual
def step_bandwidthschedulegetallindevice(test, rg, rg_2):
...
@try_manual
def step_storageaccountgetallindevice(test, rg, rg_2):
...
@try_manual
def step_triggergetallindevice(test, rg, rg_2):
...
@try_manual
def step_ordergetallindevice(test, rg, rg_2):
...
@try_manual
def step_alertgetallindevice(test, rg, rg_2):
...
@try_manual
def step_sharegetallindevice(test, rg, rg_2):
...
@try_manual
def step_nodesgetallindevice(test, rg, rg_2):
...
@try_manual
def step_rolegetallindevice(test, rg, rg_2):
...
@try_manual
def step_usergetallindevice(test, rg, rg_2):
...
@try_manual
def step_databoxedgedevicegetbyname(test, rg, rg_2):
...
@try_manual
def step_databoxedgedevicegetbyresourcegroup(test, rg, rg_2):
...
@try_manual
def step_databoxedgedevicegetbysubscription(test, rg, rg_2):
    test.cmd('az databoxedge device list '
             '-g ""',
             checks=[
                 test.check('length(@)', 1),
...
# EXAMPLE: ListSkus
@try_manual
def step_listskus(test, rg, rg_2):
...
@try_manual
def step_listavailableskus(test, rg, rg_2):
    # EXAMPLE NOT FOUND!
    pass
...
@try_manual
def step_operationsget(test, rg, rg_2):
    # EXAMPLE NOT FOUND!
    pass
...
@try_manual
def step_containerrefresh(test, rg, rg_2):
...
@try_manual
def step_createorupdatesecuritysettings(test, rg, rg_2):
...
@try_manual
def step_sharerefreshpost(test, rg, rg_2):
...
@try_manual
def step_extendedinfopost(test, rg, rg_2):
...
@try_manual
def step_uploadcertificatepost(test, rg, rg_2):
...
@try_manual
def step_downloadupdatespost(test, rg, rg_2):
...
@try_manual
def step_scanforupdatespost(test, rg, rg_2):
...
@try_manual
def step_installupdatespost(test, rg, rg_2):
...
@try_manual
def step_databoxedgedevicepatch(test, rg, rg_2):
...
@try_manual
def step_containerdelete(test, rg, rg_2):
...
# EXAMPLE: SACDelete
@try_manual
def step_sacdelete(test, rg, rg_2):
...
@try_manual
def step_bandwidthscheduledelete(test, rg, rg_2):
...
@try_manual
def step_storageaccountdelete(test, rg, rg_2):
...
@try_manual
def step_triggerdelete(test, rg, rg_2):
...
# EXAMPLE: ShareDelete
@try_manual
def step_sharedelete(test, rg, rg_2):
...
# EXAMPLE: OrderDelete
@try_manual
def step_orderdelete(test, rg, rg_2):
...
# EXAMPLE: UserDelete
@try_manual
def step_userdelete(test, rg, rg_2):
...
@try_manual
def step_databoxedgedevicedelete(test, rg, rg_2):
...
def call_scenario(test, rg, rg_2):
    setup(test, rg, rg_2)
    step_databoxedgedeviceput(test, rg, rg_2)
    step_userput(test, rg, rg_2)
    step_roleput(test, rg, rg_2)
    step_shareput(test, rg, rg_2)
    step_orderput(test, rg, rg_2)
    step_triggerput(test, rg, rg_2)
    step_storageaccountput(test, rg, rg_2)
    step_bandwidthscheduleput(test, rg, rg_2)
    step_sacput(test, rg, rg_2)
    step_containerput(test, rg, rg_2)
    step_containerget(test, rg, rg_2)
    step_sacget(test, rg, rg_2)
    step_containerlistallindevice(test, rg, rg_2)
    step_bandwidthscheduleget(test, rg, rg_2)
    step_operationsstatusget(test, rg, rg_2)
    step_storageaccountget(test, rg, rg_2)
    step_networksettingsget(test, rg, rg_2)
    step_updatesummaryget(test, rg, rg_2)
    step_triggerget(test, rg, rg_2)
    step_sacgetallindevice(test, rg, rg_2)
    step_alertget(test, rg, rg_2)
    step_shareget(test, rg, rg_2)
    step_orderget(test, rg, rg_2)
    step_userget(test, rg, rg_2)
    step_roleget(test, rg, rg_2)
    step_jobsget(test, rg, rg_2)
    step_bandwidthschedulegetallindevice(test, rg, rg_2)
    step_storageaccountgetallindevice(test, rg, rg_2)
    step_triggergetallindevice(test, rg, rg_2)
    step_ordergetallindevice(test, rg, rg_2)
    step_alertgetallindevice(test, rg, rg_2)
    step_sharegetallindevice(test, rg, rg_2)
    step_nodesgetallindevice(test, rg, rg_2)
    step_rolegetallindevice(test, rg, rg_2)
    step_usergetallindevice(test, rg, rg_2)
    step_databoxedgedevicegetbyname(test, rg, rg_2)
    step_databoxedgedevicegetbyresourcegroup(test, rg, rg_2)
    step_databoxedgedevicegetbysubscription(test, rg, rg_2)
    step_listskus(test, rg, rg_2)
    step_listavailableskus(test, rg, rg_2)
    step_operationsget(test, rg, rg_2)
    step_containerrefresh(test, rg, rg_2)
    step_createorupdatesecuritysettings(test, rg, rg_2)
    step_sharerefreshpost(test, rg, rg_2)
    step_extendedinfopost(test, rg, rg_2)
    step_uploadcertificatepost(test, rg, rg_2)
    step_downloadupdatespost(test, rg, rg_2)
    step_scanforupdatespost(test, rg, rg_2)
    step_installupdatespost(test, rg, rg_2)
    step_databoxedgedevicepatch(test, rg, rg_2)
    step_containerdelete(test, rg, rg_2)
    step_sacdelete(test, rg, rg_2)
    step_bandwidthscheduledelete(test, rg, rg_2)
    step_storageaccountdelete(test, rg, rg_2)
    step_triggerdelete(test, rg, rg_2)
    step_sharedelete(test, rg, rg_2)
    step_orderdelete(test, rg, rg_2)
    step_userdelete(test, rg, rg_2)
    step_roledelete(test, rg, rg_2)
    step_databoxedgedevicedelete(test, rg, rg_2)
...
class DataBoxEdgeManagementClientScenarioTest(ScenarioTest):
    ...
    @StorageAccountPreparer(name_prefix='clitestdataboxedge_storageaccount1'[:7], key='sa_2',
                            resource_group_parameter_name='rg')
    def test_databoxedge(self, rg, rg_2):

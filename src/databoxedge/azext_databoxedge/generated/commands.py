...
def load_command_table(self, _):
    ...
    with self.command_group('databoxedge device', databoxedge_device, client_factory=cf_device,
        ...
        g.custom_command('delete', 'databoxedge_device_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge bandwidth-schedule', databoxedge_bandwidth_schedule,
        ...
        g.generic_update_command('update', setter_arg_name='days', setter_name='begin_create_or_update',
                                 custom_func_name='databoxedge_bandwidth_schedule_update', supports_no_wait=True)
        g.custom_command('delete', 'databoxedge_bandwidth_schedule_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge role', databoxedge_role, client_factory=cf_role, is_experimental=True) as g:
        ...
        g.custom_command('delete', 'databoxedge_role_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge share', databoxedge_share, client_factory=cf_share,
        ...
        g.custom_command('delete', 'databoxedge_share_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge storage-account-credentials', databoxedge_storage_account_credentials,
        ...
        g.generic_update_command('update', setter_arg_name='account_key', setter_name='begin_create_or_update',
                                 custom_func_name='databoxedge_storage_account_credentials_update',
                                 supports_no_wait=True)
    ...
    with self.command_group('databoxedge storage-account', databoxedge_storage_account,
        ...
        g.custom_command('delete', 'databoxedge_storage_account_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge container', databoxedge_container, client_factory=cf_container,
        ...
        g.custom_command('delete', 'databoxedge_container_delete', supports_no_wait=True)
    ...
    with self.command_group('databoxedge trigger', databoxedge_trigger, client_factory=cf_trigger,
        ...
        g.custom_command('delete', 'databoxedge_trigger_delete', supports_no_wait=True)

...
def load_arguments(self, _):
    ...
    with self.argument_context('databoxedge device show-network-setting') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('databoxedge storage-account show') as c:
        c.argument('device_name', type=str, help='The device name.', id_part='name')
        c.argument('storage_account_name', options_list=['--name', '-n', '--storage-account-name'], type=str,
                   help='The storage account name.', id_part='child_name_1')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('databoxedge storage-account delete') as c:
        c.argument('device_name', type=str, help='The device name.', id_part='name')
        c.argument('storage_account_name', options_list=['--name', '-n', '--storage-account-name'], type=str,
                   help='The StorageAccount name.', id_part='child_name_1')
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('databoxedge trigger list') as c:
        c.argument('device_name', type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('filter_', options_list=['--filter'], type=str, help='Specify $filter=\'CustomContextTag eq <tag>\' '
                   'to filter on custom context tag property')
    ...
    with self.argument_context('databoxedge trigger create') as c:
        ...
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('file_event_trigger', action=AddFileEventTrigger, nargs='+', help='Trigger details.',
                   arg_group='Trigger')
    ...
    with self.argument_context('databoxedge user list') as c:
        c.argument('device_name', type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('filter_', options_list=['--filter'], type=str, help='Specify $filter=\'UserType eq <type>\' to '
                   'filter on user type property')

...
from azext_databoxedge.action import AddSku


def load_arguments(self, _):

    with self.argument_context('data-box-edge device list') as c:
    ...
    with self.argument_context('data-box-edge device show') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device create') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('data-box-edge device update') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('tags', tags_type)

    with self.argument_context('data-box-edge device delete') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device download-update') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device install-update') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device scan-for-update') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device show-update-summary') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge device wait') as c:
        c.argument('device_name', options_list=['--name', '-n', '--device-name'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge alert list') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge alert show') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('name', options_list=['--name', '-n'], type=str, help='The alert name.', id_part='child_name_1')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge bandwidth-schedule list') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge bandwidth-schedule show') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
    ...
    with self.argument_context('data-box-edge bandwidth-schedule create') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.')
    ...
    with self.argument_context('data-box-edge bandwidth-schedule update') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('name', options_list=['--name', '-n'], type=str, help='The bandwidth schedule name which needs to '
    ...
    with self.argument_context('data-box-edge bandwidth-schedule delete') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('name', options_list=['--name', '-n'], type=str, help='The bandwidth schedule name.',
                   id_part='child_name_1')
    ...
    with self.argument_context('data-box-edge bandwidth-schedule wait') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('name', options_list=['--name', '-n'], type=str, help='The bandwidth schedule name.',
                   id_part='child_name_1')
    ...
    with self.argument_context('data-box-edge show-job') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('name', options_list=['--name', '-n'], type=str, help='The job name.', id_part='child_name_1')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge list-node') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge order list') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge order show') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge order create') as c:
    ...
    with self.argument_context('data-box-edge order update') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str,
    ...
    with self.argument_context('data-box-edge order delete') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge order wait') as c:
        c.argument('device_name', options_list=['--device-name', '-d'], type=str, help='The device name.',
                   id_part='name')
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('data-box-edge list-sku') as c:

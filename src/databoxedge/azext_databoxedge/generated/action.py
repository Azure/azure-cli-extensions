    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'value':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter device_admin_password. All possible keys '
                               'are: value, encryption-cert-thumbprint, encryption-algorithm'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'contact-person':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter contact_information. All possible keys '
                               'are: contact-person, company-name, phone, email-list'.format(k))
        return d
        ...
        for k in properties:
            ...
            if kl == 'address-line1':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter shipping_address. All possible keys are: '
                               'address-line1, address-line2, address-line3, postal-code, city, state, country'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'storage-account-credential-id':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter azure_container_info. All possible keys '
                               'are: storage-account-credential-id, container-name, data-format'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'user-id':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter user_access_rights. All possible keys '
                               'are: user-id, access-type'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'client':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter client_access_rights. All possible keys '
                               'are: client, access-permission'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'in-progress-refresh-job-id':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter refresh_details. All possible keys are: '
                               'in-progress-refresh-job-id, last-completed-refresh-job-time-in-utc, '
                               'error-manifest-file, last-job'.format(k))
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'custom-context-tag':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter file_event_trigger. All possible keys '
                               'are: custom-context-tag, role-id, share-id'.format(k))
        d['kind'] = 'FileEvent'
        return d
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'custom-context-tag':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter periodic_timer_event_trigger. All '
                               'possible keys are: custom-context-tag, role-id, start-time, schedule, topic'.format(k))
    ...
    def get_action(self, values, option_string):  # pylint: disable=no-self-use
        ...
        for k in properties:
            ...
            if kl == 'share-id':
                ...
                raise CLIError('Unsupported Key {} is provided for parameter share_access_rights. All possible keys '
                               'are: share-id, access-type'.format(k))
        return d

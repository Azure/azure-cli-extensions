...
helps['databoxedge device create-or-update-security-setting'] = """
    ...
    parameters:
      - name: --device-admin-password
        short-summary: Device administrator password as an encrypted string (encrypted using RSA PKCS #1) is used to si\
gn into the  local web UI of the device. The Actual password should have at least 8 characters that are a combination o\
f  uppercase, lowercase, numeric, and special characters.
        long-summary: |
...
it will be null.
    ...
    examples:
      - name: CreateOrUpdateSecuritySettings
        text: |-
               az databoxedge device create-or-update-security-setting --name "testedgedevice" --resource-group "AzureV\
M" --device-admin-password encryption-algorithm="AES256" encryption-cert-thumbprint="7DCBDFC44ED968D232C9A998FC105B5C70\
E84BE0" value="jJ5MvXa/AEWvwxviS92uCjatCXeyLYTy8jx/k105MjQRXT7i6Do8qpEcQ8d+OBbwmQTnwKW0CYyzzVRCc0uZcPCf6PsWtP4l6wvcKGAP\
66PwK68eEkTUOmp+wUHc4hk02kWmTWeAjBZkuDBP3xK1RnZo95g2RE4i1UgKNP5BEKCLd71O104DW3AWW41mh9XLWNOaxw+VjQY7wmvlE6XkvpkMhcGuha2\
u7lx8zi9ZkcMvJVYDYK36Fb/K3KhBAmDjjDmVq04jtBlcSTXQObt0nlj4BwGGtdrpeIpr67zqr5i3cPm6e6AleIaIhp6sI/uyGSMiT3oev2eg49u2ii7kVA\
=="
"""
...
helps['databoxedge device get-extended-information'] = """
    ...
    examples:
      - name: ExtendedInfoPost
        text: |-
               az databoxedge device get-extended-information --name "testedgedevice" --resource-group "GroupForEdgeAut\
omation"
"""
...
helps['databoxedge device get-network-setting'] = """
    ...
    examples:
      - name: NetworkSettingsGet
        text: |-
               az databoxedge device get-network-setting --name "testedgedevice" --resource-group "GroupForEdgeAutomati\
on"
"""
...
s information about any ongoing download or install jobs on the device.
    examples:
      - name: UpdateSummaryGet
        text: |-
               az databoxedge device get-update-summary --name "testedgedevice" --resource-group "GroupForEdgeAutomatio\
n"
"""
...
helps['databoxedge device upload-certificate'] = """
    ...
    examples:
      - name: UploadCertificatePost
        text: |-
               az databoxedge device upload-certificate --name "testedgedevice" --certificate "MIIC9DCCAdygAwIBAgIQWJae\
7GNjiI9Mcv/gJyrOPTANBgkqhkiG9w0BAQUFADASMRAwDgYDVQQDDAdXaW5kb3dzMB4XDTE4MTEyNzAwMTA0NVoXDTIxMTEyODAwMTA0NVowEjEQMA4GA1U\
EAwwHV2luZG93czCCASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBAKxkRExqxf0qH1avnyORptIbRC2yQwqe3EIbJ2FPKr5jtAppGeX/dGKrFSnX+7\
/0HFr77aJHafdpEAtOiLyJ4zCAVs0obZCCIq4qJdmjYUTU0UXH/w/YzXfQA0d9Zh9AN+NJBX9xj05NzgsT24fkgsK2v6mWJQXT7YcWAsl5sEYPnx1e+Mrup\
NyVSL/RUJmrS+etJSysHtFeWRhsUhVAs1DD5ExJvBLU3WH0IsojEvpXcjrutB5/MDQNrd/StGI6WovoSSPH7FyT9tgERx+q+Yg3YUGzfaIPCctlrRGehcdt\
zdNoKd0rsX62yCq0U6POoSfwe22NJu41oAUMd7e6R8cCAwEAAaNGMEQwEwYDVR0lBAwwCgYIKwYBBQUHAwIwHQYDVR0OBBYEFDd0VxnS3LnMIfwc7xW4b4I\
ZWG5GMA4GA1UdDwEB/wQEAwIFIDANBgkqhkiG9w0BAQUFAAOCAQEAPQRby2u9celvtvL/DLEb5Vt3/tPStRQC5MyTD62L5RT/q8E6EMCXVZNkXF5WlWucLJ\
i/18tY+9PNgP9xWLJh7kpSWlWdi9KPtwMqKDlEH8L2TnQdjimt9XuiCrTnoFy/1X2BGLY/rCaUJNSd15QCkz2xeW+Z+YSk2GwAc/A/4YfNpqSIMfNuPrT76\
o02VdD9WmJUA3fS/HY0sU9qgQRS/3F5/0EPS+HYQ0SvXCK9tggcCd4O050ytNBMJC9qMOJ7yE0iOrFfOJSCfDAuPhn/rHFh79Kn1moF+/CE+nc0/2RPiLC8\
r54/rt5dYyyxJDfXg0a3VrrX39W69WZGW5OXiw==" --resource-group "GroupForEdgeAutomation"
"""
...
helps['databoxedge bandwidth-schedule wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge bandwidth-schedule is successfully created.
        text: |-
               az databoxedge bandwidth-schedule wait --name "bandwidth-1" --device-name "testedgedevice" --resource-gr\
oup "GroupForEdgeAutomation" --created
      - name: Pause executing next line of CLI script until the databoxedge bandwidth-schedule is successfully deleted.
        text: |-
               az databoxedge bandwidth-schedule wait --name "bandwidth-1" --device-name "testedgedevice" --resource-gr\
oup "GroupForEdgeAutomation" --deleted
"""
...
helps['databoxedge order wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge order is successfully created.
        text: |-
               az databoxedge order wait --device-name "testedgedevice" --resource-group "GroupForEdgeAutomation" --cre\
ated
...
helps['databoxedge role wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge role is successfully created.
        text: |-
               az databoxedge role wait --name "IoTRole1" --device-name "testedgedevice" --resource-group "GroupForEdge\
Automation" --created
    ...
    parameters:
      - name: --azure-container-info
        ...
        long-summary: |
            ...
            container-name: Required. Container name (Based on the data format specified, this represents the name of A\
zure Files/Page blob/Block blob).
      ...
      - name: --refresh-details
        ...
        long-summary: |
            Usage: --refresh-details in-progress-refresh-job-id=XX last-completed-refresh-job-time-in-utc=XX error-mani\
fest-file=XX last-job=XX

            in-progress-refresh-job-id: If a refresh job is currently in progress on this share or container, this fiel\
d indicates the ARM resource ID of that job. The field is empty if no job is in progress.
            last-completed-refresh-job-time-in-utc: Indicates the completed time for the last refresh job on this parti\
cular share or container, if any.This could be a failed job or a successful job.
            error-manifest-file: Indicates the relative path of the error xml for the last refresh job on this particul\
ar share or container, if any. This could be a failed job or a successful job.
            last-job: Indicates the id of the last refresh job on this particular share or container,if any. This could\
...
helps['databoxedge share wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge share is successfully created.
        text: |-
               az databoxedge share wait --name "smbshare" --device-name "testedgedevice" --resource-group "GroupForEdg\
eAutomation" --created
...
helps['databoxedge storage-account-credentials wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the databoxedge storage-account-credentials is\
 met.
    examples:
      - name: Pause executing next line of CLI script until the databoxedge storage-account-credentials is successfully\
 created.
        text: |-
               az databoxedge storage-account-credentials wait --name "sac1" --device-name "testedgedevice" --resource-\
group "GroupForEdgeAutomation" --created
      - name: Pause executing next line of CLI script until the databoxedge storage-account-credentials is successfully\
 deleted.
        text: |-
               az databoxedge storage-account-credentials wait --name "sac1" --device-name "testedgedevice" --resource-\
group "GroupForEdgeAutomation" --deleted
"""
...
e/dataBoxEdgeDevices/testedgedevice/storageAccountCredentials/cisbvt" --storage-account-status "OK" --name "blobstorage\
account1"
"""
...
helps['databoxedge storage-account wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge storage-account is successfully created.
        text: |-
               az databoxedge storage-account wait --device-name "testedgedevice" --resource-group "GroupForEdgeAutomat\
ion" --name "blobstorageaccount1" --created
      - name: Pause executing next line of CLI script until the databoxedge storage-account is successfully deleted.
        text: |-
               az databoxedge storage-account wait --device-name "testedgedevice" --resource-group "GroupForEdgeAutomat\
ion" --name "blobstorageaccount1" --deleted
"""
...
helps['databoxedge container show'] = """
    ...
    examples:
      - name: ContainerGet
        text: |-
               az databoxedge container show --name "blobcontainer1" --device-name "testedgedevice" --resource-group "G\
roupForEdgeAutomation" --storage-account-name "storageaccount1"
"""
...
helps['databoxedge container create'] = """
    ...
    examples:
      - name: ContainerPut
        text: |-
               az databoxedge container create --data-format "BlockBlob" --name "blobcontainer1" --device-name "testedg\
edevice" --resource-group "GroupForEdgeAutomation" --storage-account-name "storageaccount1"
"""
...
helps['databoxedge container update'] = """
    ...
    examples:
      - name: ContainerPut
        text: |-
               az databoxedge container update --data-format "BlockBlob" --name "blobcontainer1" --device-name "testedg\
edevice" --resource-group "GroupForEdgeAutomation" --storage-account-name "storageaccount1"
"""
...
helps['databoxedge container wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge container is successfully created.
        text: |-
               az databoxedge container wait --name "blobcontainer1" --device-name "testedgedevice" --resource-group "G\
roupForEdgeAutomation" --storage-account-name "storageaccount1" --created
      - name: Pause executing next line of CLI script until the databoxedge container is successfully deleted.
        text: |-
               az databoxedge container wait --name "blobcontainer1" --device-name "testedgedevice" --resource-group "G\
roupForEdgeAutomation" --storage-account-name "storageaccount1" --deleted
"""
    ...
    parameters:
      - name: --file-event-trigger
        ...
        long-summary: |
            ...
            custom-context-tag: A custom context tag typically used to correlate the trigger against its usage. For exa\
mple, if a periodic timer trigger is intended for certain specific IoT modules in the device, the tag can be the name o\
r the image URL of the module.
      ...
      - name: --periodic-timer-event-trigger
        short-summary: Trigger details.
        long-summary: |
            Usage: --periodic-timer-event-trigger custom-context-tag=XX role-id=XX start-time=XX schedule=XX topic=XX k\
ind=XX
...
r the image URL of the module.
            role-id: Required. Compute role ID.
            start-time: Required. The time of the day that results in a valid trigger. Schedule is computed with refere\
nce to the time specified upto seconds. If timezone is not specified the time will considered to be in device timezone.\
 The value will always be returned as UTC time.
            schedule: Required. Periodic frequency at which timer event needs to be raised. Supports daily, hourly, min\
utes, and seconds.
...
helps['databoxedge trigger wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the databoxedge trigger is successfully created.
        text: |-
               az databoxedge trigger wait --name "trigger1" --device-name "testedgedevice" --resource-group "GroupForE\
dgeAutomation" --created
      - name: Pause executing next line of CLI script until the databoxedge trigger is successfully deleted.
        text: |-
               az databoxedge trigger wait --name "trigger1" --device-name "testedgedevice" --resource-group "GroupForE\
dgeAutomation" --deleted
"""

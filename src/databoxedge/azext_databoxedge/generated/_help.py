...
helps['databoxedge storage-account-credentials create'] = """
    type: command
    short-summary: "Create the storage account credential."
    parameters:
      - name: --account-key
...
helps['databoxedge storage-account-credentials update'] = """
    type: command
    short-summary: "Update the storage account credential."
    parameters:
      - name: --account-key
        short-summary: "Encrypted storage key."
        long-summary: |
...
helps['databoxedge storage-account update'] = """
    type: command
    short-summary: "Update a new StorageAccount or updates an existing StorageAccount on the device."
"""

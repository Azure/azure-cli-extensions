...
helps['databoxedge device show-network-setting'] = """
    type: command
    short-summary: "Gets the network settings of the specified Data Box Edge/Data Box Gateway device."
    examples:
      - name: NetworkSettingsGet
        text: |-
               az databoxedge device show-network-setting --name "testedgedevice" --resource-group \
"GroupForEdgeAutomation"
"""
...
helps['databoxedge operation-status'] = """
    type: group
    short-summary: Manage operation status with databoxedge
"""
...
helps['databoxedge role'] = """
    type: group
    short-summary: Manage role with databoxedge
"""
...
helps['databoxedge share'] = """
    type: group
    short-summary: Manage share with databoxedge
"""
...
helps['databoxedge storage-account-credentials'] = """
    type: group
    short-summary: Manage storage account credentials with databoxedge
"""
...
helps['databoxedge storage-account'] = """
    type: group
    short-summary: Manage storage account with databoxedge
"""
...
helps['databoxedge container'] = """
    type: group
    short-summary: Manage container with databoxedge
"""
...
helps['databoxedge trigger'] = """
    type: group
    short-summary: Manage trigger with databoxedge
"""
...
helps['databoxedge user'] = """
    type: group
    short-summary: Manage user with databoxedge
"""

...
@try_manual
def step_deployment_info_list(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_vm_collection_update(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_vm_host_list(test, rg, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_vm_ingestion_detail(test, rg, checks=None):
    if checks is None:
        checks = []

...
class ListConnectedPartnerResource(AAZCommand):
    ...
    class ConnectedPartnerResourcesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.partner_deployment_name = AAZStrType(
                serialized_name="partnerDeploymentName",
            )
            properties.partner_deployment_uri = AAZStrType(
                serialized_name="partnerDeploymentUri",
            )

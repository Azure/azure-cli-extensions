...
class DeleteTrafficFilter(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TrafficFiltersDelete(ctx=self.ctx)()
    ...
    class TrafficFiltersDelete(AAZHttpOperation):
...
class _DeleteTrafficFilterHelper:
    """Helper class for DeleteTrafficFilter"""

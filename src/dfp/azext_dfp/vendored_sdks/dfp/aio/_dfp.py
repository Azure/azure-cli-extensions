...
from ._configuration import DFPConfiguration
from .operations import InstancesOperations
from .operations import DFPOperationsMixin
from .. import models


class DFP(DFPOperationsMixin):
    ...
    :vartype instances: dfp.aio.operations.InstancesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DFPConfiguration(credential, subscription_id, **kwargs)

...
@register_command(
    "resilience recovery-plan finalize",
)
class Finalize(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/providers/microsoft.management/servicegroups/{}/providers/microsoft.azureresiliencemanagement/recoveryplans/{}/finalize", "2026-08-31-preview"],
        ]
    }

...
@register_command(
    "redisenterprise private-endpoint-connection update",
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.PrivateEndpointConnectionsPut(ctx=self.ctx)()
    ...
    class PrivateEndpointConnectionsPut(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_201(cls):
            ...
            _UpdateHelper._build_schema_private_endpoint_connection_read(cls._schema_on_201)

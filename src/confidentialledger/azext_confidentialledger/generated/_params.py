...
def load_arguments(self, _):
    ...
    with self.argument_context('confidentialledger list') as c:
        ...
        c.argument('filter_', options_list=['--filter'], type=str, help='The filter to apply on the list operation. '
                   'eg. $filter=ledgerType eq \'Public\'')

    with self.argument_context('confidentialledger show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('ledger_name', options_list=['--name', '-n', '--ledger-name'], type=str, help='Name of the '
                   'Confidential Ledger', id_part='name')

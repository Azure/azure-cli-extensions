...
def confidentialledger_list(client,
...
def confidentialledger_show(client,
                            resource_group_name,
                            ledger_name):
...
def confidentialledger_create(client,
                              resource_group_name,
                              ledger_name,
                              location=None,
                              tags=None,
    ...
    if aad_based_security_principals is not None:
        confidential_ledger['properties']['aad_based_security_principals'] = aad_based_security_principals
    if cert_based_security_principals is not None:
        confidential_ledger['properties']['cert_based_security_principals'] = cert_based_security_principals
...
def confidentialledger_update(client,
                              resource_group_name,
                              ledger_name,
                              location=None,
                              tags=None,
...
def confidentialledger_delete(client,
                              resource_group_name,
                              ledger_name,
                              no_wait=False):
    return sdk_no_wait(no_wait,

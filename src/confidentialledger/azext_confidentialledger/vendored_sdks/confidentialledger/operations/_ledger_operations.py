...
class LedgerOperations(object):
    ...
    def get(
        ...
        ledger_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ConfidentialLedger"
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        ledger_name,  # type: str
        confidential_ledger,  # type: "models.ConfidentialLedger"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ConfidentialLedger"]
        cls = kwargs.pop(
            "cls", None
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ConfidentialLedger"]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ConfidentialLedgerList"]

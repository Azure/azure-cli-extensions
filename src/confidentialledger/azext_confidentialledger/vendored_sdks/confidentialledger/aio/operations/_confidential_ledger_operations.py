...
class ConfidentialLedgerOperationsMixin:
    async def check_name_availability(
        self, name_availability_request: "models.CheckNameAvailabilityRequest", **kwargs
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["models.CheckNameAvailabilityResponse"]
        error_map = {
        ...
        deserialized = self._deserialize(
            "CheckNameAvailabilityResponse", pipeline_response
        )

...
class DedicatedHsmOperations(object):
    ...
    def _create_or_update_initial(
        ...
        name,  # type: str
        parameters,  # type: "models.DedicatedHsm"
        **kwargs  # type: Any
    ):
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.OutboundEnvironmentEndpointCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_dedicated_hsm_resource_provider.models.OutboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

...
@register_command(
    "automation account show-linked-workspace",
)
class ShowLinkedWorkspace(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LinkedWorkspaceGet(ctx=self.ctx)()
    ...
    class LinkedWorkspaceGet(AAZHttpOperation):
...
class _ShowLinkedWorkspaceHelper:
    """Helper class for ShowLinkedWorkspace"""


__all__ = ["ShowLinkedWorkspace"]

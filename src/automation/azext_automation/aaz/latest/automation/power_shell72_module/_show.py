...
@register_command(
    "automation power-shell72-module show",
)
class Show(AAZCommand):
    """Get the module identified by module name.

    :example: Get the module identified by module name.
        az automation power-shell72-module show --automation-account-name "MyAutomationAccount" --resource-group "MyResourceGroup" --name "ModuleName"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PowerShell72ModuleGet(ctx=self.ctx)()
    ...
    class PowerShell72ModuleGet(AAZHttpOperation):

...
@register_command(
    "automation power-shell72-module list",
)
class List(AAZCommand):
    """List a list of PowerShell72 modules.

    :example: List a list of PowerShell72 modules.
        az automation power-shell72-module list --automation-account-name "MyAutomationAccount" --resource-group "MyResourceGroup"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PowerShell72ModuleListByAutomationAccount(ctx=self.ctx)()
    ...
    class PowerShell72ModuleListByAutomationAccount(AAZHttpOperation):

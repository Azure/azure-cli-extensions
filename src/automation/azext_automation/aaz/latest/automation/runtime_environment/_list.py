...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RuntimeEnvironmentsListByAutomationAccount(ctx=self.ctx)()
    ...
    class RuntimeEnvironmentsListByAutomationAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            default_packages = cls._schema_on_200.value.Element.properties.default_packages
            default_packages.Element = AAZStrType()

            runtime = cls._schema_on_200.value.Element.properties.runtime

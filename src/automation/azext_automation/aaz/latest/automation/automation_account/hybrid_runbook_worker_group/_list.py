...
@register_command(
    "automation automation-account hybrid-runbook-worker-group list",
)
class List(AAZCommand):
    ...
    class HybridRunbookWorkerGroupListByAutomationAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.credential = AAZObjectType()
            _element.group_type = AAZStrType(
                serialized_name="groupType",
            )
            _element.hybrid_runbook_workers = AAZListType(
            ...
            credential = cls._schema_on_200.value.Element.credential
            credential.name = AAZStrType()

            hybrid_runbook_workers = cls._schema_on_200.value.Element.hybrid_runbook_workers
            hybrid_runbook_workers.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.hybrid_runbook_workers.Element

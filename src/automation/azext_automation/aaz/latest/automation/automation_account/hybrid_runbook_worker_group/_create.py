...
@register_command(
    "automation automation-account hybrid-runbook-worker-group create",
)
class Create(AAZCommand):
    ...
    class HybridRunbookWorkerGroupCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.credential = AAZObjectType()
            _schema_on_200.group_type = AAZStrType(
                serialized_name="groupType",
            )
            _schema_on_200.hybrid_runbook_workers = AAZListType(
            ...
            credential = cls._schema_on_200.credential
            credential.name = AAZStrType()

            hybrid_runbook_workers = cls._schema_on_200.hybrid_runbook_workers
            hybrid_runbook_workers.Element = AAZObjectType()

            _element = cls._schema_on_200.hybrid_runbook_workers.Element

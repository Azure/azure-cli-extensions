...
@register_command(
    "automation automation-account hybrid-runbook-worker-group update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "HybridRunbookWorkerGroupCreationParameters"

        _args_schema = cls._args_schema
        _args_schema.credential = AAZObjectArg(
            options=["--credential"],
            arg_group="HybridRunbookWorkerGroupCreationParameters",
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            _builder.set_prop("credential", AAZObjectType, ".credential")

            credential = _builder.get(".credential")
...
def _build_schema_hybrid_runbook_worker_group_read(_schema):
    ...
    if _schema_hybrid_runbook_worker_group_read is not None:
        _schema.credential = _schema_hybrid_runbook_worker_group_read.credential
        _schema.group_type = _schema_hybrid_runbook_worker_group_read.group_type
        _schema.hybrid_runbook_workers = _schema_hybrid_runbook_worker_group_read.hybrid_runbook_workers
    ...
    hybrid_runbook_worker_group_read.credential = AAZObjectType()
    hybrid_runbook_worker_group_read.group_type = AAZStrType(
        serialized_name="groupType",
    )
    hybrid_runbook_worker_group_read.hybrid_runbook_workers = AAZListType(
    ...
    credential = _schema_hybrid_runbook_worker_group_read.credential
    credential.name = AAZStrType()

    hybrid_runbook_workers = _schema_hybrid_runbook_worker_group_read.hybrid_runbook_workers
    hybrid_runbook_workers.Element = AAZObjectType()

    _element = _schema_hybrid_runbook_worker_group_read.hybrid_runbook_workers.Element
    _element.ip = AAZStrType()
    _element.last_seen_date_time = AAZStrType(
        serialized_name="lastSeenDateTime",
    )
    _element.name = AAZStrType()
    _element.registration_time = AAZStrType(

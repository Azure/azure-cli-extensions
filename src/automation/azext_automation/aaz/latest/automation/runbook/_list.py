...
class List(AAZCommand):
    """List a list of runbooks.

    :example: List a list of runbooks.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RunbookListByAutomationAccount(ctx=self.ctx)()
    ...
    class RunbookListByAutomationAccount(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            draft = cls._schema_on_200.value.Element.properties.draft
            ...
            output_types = cls._schema_on_200.value.Element.properties.draft.output_types
            output_types.Element = AAZStrType()

            parameters = cls._schema_on_200.value.Element.properties.draft.parameters
            parameters.Element = AAZObjectType()
            _ListHelper._build_schema_runbook_parameter_read(parameters.Element)

            output_types = cls._schema_on_200.value.Element.properties.output_types
            output_types.Element = AAZStrType()

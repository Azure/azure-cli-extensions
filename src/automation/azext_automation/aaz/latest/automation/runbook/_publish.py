...
class Publish(AAZCommand):
    ...
    _aaz_info = {
        "version": "2023-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.automation/automationaccounts/{}/runbooks/{}/publish", "2023-11-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.runbook_name = AAZStrArg(
            ...
            help="The parameters supplied to the publish runbook operation.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RunbookPublish(ctx=self.ctx)()
    ...
    class RunbookPublish(AAZHttpOperation):

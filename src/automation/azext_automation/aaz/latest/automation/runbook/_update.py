...
class Update(AAZCommand):
    ...
    :example: Update the runbook identified by runbook name.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_content_link_update(_args_schema.publish_content_link)
        ...
        cls._build_args_content_link_update(draft.draft_content_link)
    ...
    _args_content_link_update = None

    @classmethod
    def _build_args_content_link_update(cls, _schema):
        if cls._args_content_link_update is not None:
            _schema.content_hash = cls._args_content_link_update.content_hash
            _schema.uri = cls._args_content_link_update.uri
            _schema.version = cls._args_content_link_update.version
            return

        cls._args_content_link_update = AAZObjectArg(
            nullable=True,
        )

        content_link_update = cls._args_content_link_update
        content_link_update.content_hash = AAZObjectArg(
            options=["content-hash"],
            help="Sets the hash.",
            nullable=True,
        )
        content_link_update.uri = AAZStrArg(
            options=["uri"],
            help="Sets the uri of the content.",
            nullable=True,
        )
        content_link_update.version = AAZStrArg(
            options=["version"],
            help="Sets the version of the content.",
            nullable=True,
        )

        content_hash = cls._args_content_link_update.content_hash
    ...
    class RunbookGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_runbook_read(cls._schema_on_200)
    ...
    class RunbookCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_runbook_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_content_link_update(properties.set_prop("publishContentLink", AAZObjectType, ".publish_content_link"))
            ...
            if draft is not None:
                ...
                _UpdateHelper._build_schema_content_link_update(draft.set_prop("draftContentLink", AAZObjectType, ".draft_content_link"))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_content_link_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_runbook_read = None

    @classmethod
    def _build_schema_runbook_read(cls, _schema):
        if cls._schema_runbook_read is not None:
            _schema.etag = cls._schema_runbook_read.etag
            _schema.id = cls._schema_runbook_read.id
            _schema.location = cls._schema_runbook_read.location
            _schema.name = cls._schema_runbook_read.name
            _schema.properties = cls._schema_runbook_read.properties
            _schema.tags = cls._schema_runbook_read.tags
            _schema.type = cls._schema_runbook_read.type
            return

        cls._schema_runbook_read = _schema_runbook_read = AAZObjectType()

        runbook_read = _schema_runbook_read
        runbook_read.etag = AAZStrType()
        runbook_read.id = AAZStrType(
            flags={"read_only": True},
        )
        runbook_read.location = AAZStrType()
        runbook_read.name = AAZStrType(
            flags={"read_only": True},
        )
        runbook_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        runbook_read.tags = AAZDictType()
        runbook_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_runbook_read.properties
        ...
        draft = _schema_runbook_read.properties.draft
        ...
        output_types = _schema_runbook_read.properties.draft.output_types
        output_types.Element = AAZStrType()

        parameters = _schema_runbook_read.properties.draft.parameters
        parameters.Element = AAZObjectType()
        cls._build_schema_runbook_parameter_read(parameters.Element)

        output_types = _schema_runbook_read.properties.output_types
        output_types.Element = AAZStrType()

        parameters = _schema_runbook_read.properties.parameters
        parameters.Element = AAZObjectType()
        cls._build_schema_runbook_parameter_read(parameters.Element)

        tags = _schema_runbook_read.tags

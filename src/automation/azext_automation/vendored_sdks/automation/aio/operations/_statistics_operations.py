...
class StatisticsOperations:
    ...
    def list_by_automation_account(
        ...
        **kwargs
    ) -> AsyncIterable["models.StatisticsListResult"]:
        ...
        :return: An iterator like instance of either StatisticsListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~automation_client.models.StatisticsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.StatisticsListResult"]
        error_map = {

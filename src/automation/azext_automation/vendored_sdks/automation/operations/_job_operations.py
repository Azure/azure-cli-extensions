...
class JobOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~automation_client.models.Job
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create(
        ...
        automation_account_name,  # type: str
        job_name,  # type: str
        parameters,  # type: "models.JobCreateParameters"
        client_request_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Job"
        ...
        :type parameters: ~automation_client.models.JobCreateParameters
        :param client_request_id: Identifies this specific client request.
        :type client_request_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Job, or the result of cls(response)
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.JobListResultV2"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~automation_client.models.JobListResultV2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """

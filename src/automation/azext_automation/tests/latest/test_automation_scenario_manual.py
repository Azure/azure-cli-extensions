...
class AutomationScenarioTest(ScenarioTest):
    ...
    def test_automation(self, resource_group):
        self.kwargs.update({
            ...
            'hybrid_worker_group_name' : self.create_random_name(prefix='hwg', length=10)
        })
        ...
        self.cmd('automation automation-account hybrid-runbook-worker-group create --resource-group {rg} --automation-account-name {account_name} --name {hybrid_worker_group_name}',

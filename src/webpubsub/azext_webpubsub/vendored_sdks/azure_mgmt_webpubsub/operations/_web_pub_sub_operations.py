...
class WebPubSubOperations(object):
    ...
    def check_name_availability(
        self,
        location,  # type: str
        parameters,  # type: "_models.NameAvailabilityParameters"
        **kwargs  # type: Any
    ):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.WebPubSubResourceList"]
        """Handles requests to list all resources in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WebPubSubResourceList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.webpubsub.models.WebPubSubResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.WebPubSubResource"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters,  # type: "_models.WebPubSubResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.WebPubSubResource"]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'WebPubSubResource')
        body_content_kwargs['content'] = body_content
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.WebPubSubResource"]
        ...
        :return: An instance of LROPoller that returns either WebPubSubResource or the result of cls(response)
    ...
    def begin_regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.WebPubSubKeys"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either WebPubSubKeys or the result of cls(response)

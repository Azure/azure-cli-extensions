...
class UsagesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SignalRServiceUsageList"]
        """List resource usage quotas by location.

        :param location: the location like "eastus".
        :type location: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SignalRServiceUsageList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.webpubsub.models.SignalRServiceUsageList]

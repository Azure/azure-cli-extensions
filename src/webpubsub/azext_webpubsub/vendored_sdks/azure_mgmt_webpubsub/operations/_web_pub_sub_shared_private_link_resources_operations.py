...
class WebPubSubSharedPrivateLinkResourcesOperations(object):
    """WebPubSubSharedPrivateLinkResourcesOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.webpubsub.models.SharedPrivateLinkResourceList]

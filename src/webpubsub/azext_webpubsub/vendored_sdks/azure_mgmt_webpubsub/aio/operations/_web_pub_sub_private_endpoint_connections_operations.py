...
class WebPubSubPrivateEndpointConnectionsOperations:
    """WebPubSubPrivateEndpointConnectionsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.webpubsub.models.PrivateEndpointConnectionList]

...
class WebPubSubPrivateLinkResourcesOperations:
    """WebPubSubPrivateLinkResourcesOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.webpubsub.models.PrivateLinkResourceList]

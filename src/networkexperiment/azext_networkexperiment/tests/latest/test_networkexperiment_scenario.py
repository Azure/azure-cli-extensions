...
# create_or_update -- create
        self.cmd('networkexperiment experiment create  --resource-group "rg1" --profile-name "Profile1" --name "Experiment1" --description "this is my first experiment!" --enabled-state "Enabled"', checks=[
        ])
...
# create_or_update -- update
        self.cmd('networkexperiment experiment update  --resource-group "rg1" --profile-name "Profile1" --name "Experiment1" --description "this is my first experiment!" --enabled-state "Enabled"', checks=[
        ])

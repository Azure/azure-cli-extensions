...
class UsageOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.TestBaseAccountUsageDataList"]
        ...
        :return: An iterator like instance of either TestBaseAccountUsageDataList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~test_base.models.TestBaseAccountUsageDataList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestBaseAccountUsageDataList"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('TestBaseAccountUsageDataList', pipeline_response)
